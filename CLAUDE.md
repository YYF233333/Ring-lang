...
│   │   │   ├── codes.ts                错误码目录（E0101-E0601，E0104/E0401 已清理）
...
- E2E 测试通过 `npm run test:e2e` 运行（271 tests），`npm run test:all` 运行全部（233 单元 + 271 E2E）
