...
**当前状态：Phase 2 Session 2 完成** — 编译器支持 evidence passing effect system + trait 系统。100 个单元测试 + 42 个端到端测试全部通过。详见 `docs/superpowers/specs/2026-05-17-phase2-session2-evidence-passing.md`。
...
- Evidence passing 不支持 one-shot resume（handler 无法在"提供值后继续执行"之后再做额外工作）
