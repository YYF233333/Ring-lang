...
function unify_error(t1, t2, detail, __ring_ev_fail) {
  ...
  let __ring_blk0;
  __ring_match6: {
    const __ring_m6 = detail;
    if (__ring_m6._tag === "some") {
      const d = __ring_m6._0;
      __ring_blk0 = `${base} — ${d}`;
      break __ring_match6;
    }
...
function occurs_in_row(var_id, row, subst) {
  let __ring_blk2;
  __ring_match9: {
    const __ring_m9 = row.tail;
    if (__ring_m9._tag === "some") {
      const t_id = __ring_m9._0;
      __ring_blk2 = occurs_in(var_id, types$Type_TypeVar(t_id, Option_none), subst);
      break __ring_match9;
    }
...
function unify_effect_params(a, b, subst, env, __ring_ev_fail) {
  __ring_match11: {
    const __ring_m11 = [a, b];
    if (Array.isArray(__ring_m11) && __ring_m11.length === 2 && __ring_m11[0]._tag === "FailEffect" && __ring_m11[1]._tag === "FailEffect") {
      const et_a = __ring_m11[0].error_type; const et_b = __ring_m11[1].error_type;
      return unify(et_a, et_b, subst, env, __ring_ev_fail);
      break __ring_match11;
    }
    if (Array.isArray(__ring_m11) && __ring_m11.length === 2 && __ring_m11[0]._tag === "MutEffect" && __ring_m11[1]._tag === "MutEffect") {
      const sa = __ring_m11[0].state_type; const sb = __ring_m11[1].state_type;
      return unify(sa, sb, subst, env, __ring_ev_fail);
      break __ring_match11;
    }
    if (Array.isArray(__ring_m11) && __ring_m11.length === 2 && __ring_m11[0]._tag === "CustomEffect" && __ring_m11[1]._tag === "CustomEffect") {
      const name = __ring_m11[0].name; const ta_a = __ring_m11[0].type_args; const ta_b = __ring_m11[1].type_args;
...
function unify_effect_rows(a, b, subst, env, __ring_ev_fail) {
  ...
  while ((ai < List_len(ra.effects))) {
    ...
    while ((bi < List_len(rb.effects))) {
      if ((!_Set_contains(b_matched, bi, __Int_Eq))) {
        __ring_match12: {
          const __ring_m12 = [List_get(ra.effects, ai), List_get(rb.effects, bi)];
          if (Array.isArray(__ring_m12) && __ring_m12.length === 2 && __ring_m12[0]._tag === "some" && __ring_m12[1]._tag === "some") {
            const eff_a = __ring_m12[0]._0; const eff_b = __ring_m12[1]._0;
  ...
  __ring_match13: {
    const __ring_m13 = [ra.tail, rb.tail];
    ...
    if (Array.isArray(__ring_m13) && __ring_m13.length === 2 && __ring_m13[0]._tag === "none" && __ring_m13[1]._tag === "some") {
      const tb = __ring_m13[1]._0;
      if ((List_len(a_unmatched) > 0)) {
    ...
    if (Array.isArray(__ring_m13) && __ring_m13.length === 2 && __ring_m13[0]._tag === "some" && __ring_m13[1]._tag === "none") {
      const ta = __ring_m13[0]._0;
      if ((List_len(b_unmatched) > 0)) {
    ...
    if (Array.isArray(__ring_m13) && __ring_m13.length === 2 && __ring_m13[0]._tag === "none" && __ring_m13[1]._tag === "none") {
      break __ring_match13;
    }
...
function unify_record_rows(ra, rb, subst, env, __ring_ev_fail) {
  __ring_match14: {
    const __ring_m14 = [ra, rb];
    if (Array.isArray(__ring_m14) && __ring_m14.length === 2 && __ring_m14[0]._tag === "RecordType" && __ring_m14[1]._tag === "RecordType") {
      const a_fields = __ring_m14[0].fields; const a_tail = __ring_m14[0].tail; const b_fields = __ring_m14[1].fields; const b_tail = __ring_m14[1].tail;
      let s = subst;
      ...
      if (((((List_len(a_only) > 0) && (List_len(b_only) > 0)) && Option_is_some(a_tail)) && Option_is_some(b_tail))) {
        ...
        __ring_match18: {
          const __ring_m18 = b_tail;
          if (__ring_m18._tag === "some") {
            const tb = __ring_m18._0;
...
function unify_struct_with_record(st, rt, subst, env, __ring_ev_fail) {
  __ring_match20: {
    const __ring_m20 = [st, rt];
    if (Array.isArray(__ring_m20) && __ring_m20.length === 2 && __ring_m20[0]._tag === "StructType" && __ring_m20[1]._tag === "RecordType") {
      const name = __ring_m20[0].name; const struct_fields = __ring_m20[0].fields; const record_fields = __ring_m20[1].fields; const record_tail = __ring_m20[1].tail;
      let s = {value: subst};
      ...
      __ring_match22: {
        const __ring_m22 = record_tail;
        if (__ring_m22._tag === "some") {
          const tail_id = __ring_m22._0;
