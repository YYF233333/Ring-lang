...
function zonk_expr(ctx, expr) {
  const z_ty = zonk_type(ctx, expr_type(expr));
  const z_eff = zonk_row(ctx, expr_effects(expr));
  const z_span = expr_span(expr);
  __ring_match5: {
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m5._tag === "OptionUnwrap") {
      const expr = __ring_m5.expr;
      return hir$HExpr_OptionUnwrap(zonk_expr(ctx, expr), z_ty, z_eff, z_span);
      break __ring_match5;
    }
    if (__ring_m5._tag === "TryBlock") {
      const body = __ring_m5.body;
      return hir$HExpr_TryBlock(zonk_expr(ctx, body), z_ty, z_eff, z_span);
      break __ring_match5;
    }
    if (__ring_m5._tag === "OptionOr") {
      const expr = __ring_m5.expr; const default_value = __ring_m5.default_value;
      return hir$HExpr_OptionOr(zonk_expr(ctx, expr), zonk_expr(ctx, default_value), z_ty, z_eff, z_span);
      break __ring_match5;
    }
...
function expr_type(e) {
  __ring_match6: {
    ...
    if (__ring_m6._tag === "OptionUnwrap") {
      const ty = __ring_m6.ty;
      return ty;
      break __ring_match6;
    }
    if (__ring_m6._tag === "TryBlock") {
      const ty = __ring_m6.ty;
      return ty;
      break __ring_match6;
    }
    if (__ring_m6._tag === "OptionOr") {
      const ty = __ring_m6.ty;
      return ty;
      break __ring_match6;
    }
...
function expr_effects(e) {
  __ring_match7: {
    ...
    if (__ring_m7._tag === "OptionUnwrap") {
      const effects = __ring_m7.effects;
      return effects;
      break __ring_match7;
    }
    if (__ring_m7._tag === "TryBlock") {
      const effects = __ring_m7.effects;
      return effects;
      break __ring_match7;
    }
    if (__ring_m7._tag === "OptionOr") {
      const effects = __ring_m7.effects;
      return effects;
      break __ring_match7;
    }
...
function expr_span(e) {
  __ring_match8: {
    ...
    if (__ring_m8._tag === "OptionUnwrap") {
      const span = __ring_m8.span;
      return span;
      break __ring_match8;
    }
    if (__ring_m8._tag === "TryBlock") {
      const span = __ring_m8.span;
      return span;
      break __ring_match8;
    }
    if (__ring_m8._tag === "OptionOr") {
      const span = __ring_m8.span;
      return span;
      break __ring_match8;
    }
