...
function tarjan_scc(graph) {
  ...
  sorted_graph.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
...
export { collect_registered_fn_names, build_call_graph, collect_self_method_callees, tarjan_scc };