...
function new_codegen_ctx(skip_preamble, skip_main_call) {
  return new CodegenCtx([], 0, map_new(), map_new(), map_new(), 0, 0, 0, Option_none, Option_none, skip_preamble, skip_main_call, set_new(), map_new(), Option_none, false, Option_none, Option_none, set_new(), map_new(), map_new());
}
