...
function perceus_transform_mutated(program, mutate) {
  ...
  return new hir$HProgram(mutated_decls, anf_program.derived_impls, anf_program.boxed_vars);
}
...
function anf_expr(expr, hoists, externs, counter) {
  __ring_match17: {
    ...
    if (__ring_m17._tag === "Call") {
      ...
      const arg_returning = hir$is_arg_returning_call(new_callee);
      let new_args = [];
...
function transform_decl(decl, boxed, externs) {
  __ring_match20: {
    ...
    if (__ring_m20._tag === "Fn") {
      const name = __ring_m20.name; const def_id = __ring_m20.def_id; const type_params = __ring_m20.type_params; const params = __ring_m20.params; const return_type = __ring_m20.return_type; const effects = __ring_m20.effects; const body = __ring_m20.body; const is_pub = __ring_m20.is_pub; const trait_bounds = __ring_m20.trait_bounds; const span = __ring_m20.span;
    ...
    if (__ring_m20._tag === "Impl") {
      const target_type = __ring_m20.target_type; const type_params = __ring_m20.type_params; const trait_name = __ring_m20.trait_name; const methods = __ring_m20.methods; const assoc_types = __ring_m20.assoc_types; const span = __ring_m20.span;
      const new_methods = transform_decls(methods, boxed, externs);
      return hir$HDecl_Impl(target_type, type_params, trait_name, new_methods, assoc_types, span);
      break __ring_match20;
    }
    if (__ring_m20._tag === "Test") {
      const description = __ring_m20.description; const body = __ring_m20.body; const span = __ring_m20.span;
      const new_body = transform_fn_body([], body, boxed, externs);
      return hir$HDecl_Test(description, new_body, span);
      break __ring_match20;
    }
    if (__ring_m20._tag === "Const") {
    ...
    if (__ring_m20._tag === "ModBlock") {
      const name = __ring_m20.name; const mod_decls = __ring_m20.decls; const is_pub = __ring_m20.is_pub; const span = __ring_m20.span;
    ...
    if (__ring_m20._tag === "Effect") {
      return decl;
      break __ring_match20;
    }
    if (__ring_m20._tag === "Trait") {
      return decl;
      break __ring_match20;
    }
    if (__ring_m20._tag === "ExternFn") {
      return decl;
      break __ring_match20;
    }
    if (__ring_m20._tag === "ExternType") {
      return decl;
      break __ring_match20;
    }
    if (__ring_m20._tag === "TypeAlias") {
      return decl;
      break __ring_match20;
    }
    if (__ring_m20._tag === "Sig") {
      return decl;
      break __ring_match20;
    }
...
function is_owner_bearing(expr) {
  __ring_match21: {
    ...
    if (__ring_m21._tag === "IndexExpr") {
      const receiver = __ring_m21.receiver;
      return (is_str_index(receiver) === false);
      break __ring_match21;
    }
    if (__ring_m21._tag === "Call") {
      const callee = __ring_m21.callee;
...
function is_droppable_init(init, externs) {
  ...
  __ring_match25: {
    ...
    if (__ring_m25._tag === "IntLit") {
      return true;
      break __ring_match25;
    }
    if (__ring_m25._tag === "FloatLit") {
      return true;
      break __ring_match25;
    }
    if (__ring_m25._tag === "StrLit") {
      return true;
      break __ring_match25;
    }
    if (__ring_m25._tag === "BoolLit") {
      return true;
      break __ring_match25;
    }
    if (__ring_m25._tag === "Clone") {
      return true;
      break __ring_match25;
    }
    ...
    if (__ring_m25._tag === "BinOp") {
      const op = __ring_m25.op;
      __ring_match26: {
        const __ring_m26 = op;
        if (__ring_m26._tag === "And") {
          return false;
          break __ring_match26;
        }
        if (__ring_m26._tag === "Or") {
          return false;
          break __ring_match26;
        }
        return true;
    ...
    if (__ring_m25._tag === "IfExpr") {
      const then_branch = __ring_m25.then_branch; const else_branch = __ring_m25.else_branch;
      __ring_match27: {
...
function is_droppable_branch_value(body, externs) {
  if (expr_diverges(body)) {
    ...
    __ring_match29: {
      const __ring_m29 = body;
      if (__ring_m29._tag === "Block") {
        const tail = __ring_m29.tail;
        __ring_match30: {
...
function scalar_reassign_drop_name(target, boxed) {
  __ring_match32: {
    ...
    if (__ring_m32._tag === "Ident") {
      const name = __ring_m32.name; const def_id = __ring_m32.def_id; const ty = __ring_m32.ty;
...
function rc_stmt(stmt, owned, boxed, externs, gensym) {
  __ring_match34: {
    ...
    if (__ring_m34._tag === "Return") {
      const value = __ring_m34.value; const span = __ring_m34.span;
      __ring_match36: {
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m34._tag === "Drop") {
      return [stmt];
      break __ring_match34;
    }
    if (__ring_m34._tag === "Dup") {
      return [stmt];
      break __ring_match34;
    }
...
function is_variant_constructor_call(callee, result_ty) {
  __ring_match40: {
    ...
    if (__ring_m40._tag === "Ident") {
      const resolved_name = __ring_m40.resolved_name;
      __ring_match41: {
        const __ring_m41 = resolved_name;
        if (__ring_m41._tag === "some") {
          const rn = __ring_m41._0;
          __ring_match42: {
            const __ring_m42 = result_ty;
...
function stmt_diverges(stmt) {
  __ring_match43: {
    const __ring_m43 = stmt;
    if (__ring_m43._tag === "Return") {
      return true;
      break __ring_match43;
    }
    if (__ring_m43._tag === "Break") {
      return true;
      break __ring_match43;
    }
    if (__ring_m43._tag === "Continue") {
      return true;
      break __ring_match43;
    }
    if (__ring_m43._tag === "ExprStmt") {
      const expr = __ring_m43.expr;
...
function expr_diverges(expr) {
  __ring_match44: {
    ...
    if (__ring_m44._tag === "IfExpr") {
      const then_branch = __ring_m44.then_branch; const else_branch = __ring_m44.else_branch;
      __ring_match46: {
        const __ring_m46 = else_branch;
        if (__ring_m46._tag === "some") {
          const eb = __ring_m46._0;
