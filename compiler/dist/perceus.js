  ...
  __ring_match18: {
    ...
    if (__ring_m18._tag === "TryCatch") {
      ...
      while (true) {
        ...
        let __ring_blk5;
        __ring_match25: {
          const __ring_m25 = arm.guard;
          if (__ring_m25._tag === "some") {
            const g = __ring_m25._0;
            __ring_blk5 = Option_some(anf_cond_in_own_scope(g, externs, counter));
        ...
        const new_guard = __ring_blk5;
        const new_body_arm = anf_block_expr(arm.body, externs, counter);
        List_push(new_arms, new hir$HMatchArm(arm.pattern, new_guard, new_body_arm, arm.span));
      }
...
function anf_stmt(stmt, externs, counter) {
  __ring_match27: {
    ...
    if (__ring_m27._tag === "Let") {
      const name = __ring_m27.name; const name_span = __ring_m27.name_span; const def_id = __ring_m27.def_id; const ty = __ring_m27.ty; const init = __ring_m27.init; const span = __ring_m27.span;
      let hoists = [];
    ...
    if (__ring_m27._tag === "Assign") {
      const target = __ring_m27.target; const value = __ring_m27.value; const span = __ring_m27.span;
      let hoists = [];
    ...
    if (__ring_m27._tag === "ExprStmt") {
      const expr = __ring_m27.expr; const span = __ring_m27.span;
      let hoists = [];
    ...
    if (__ring_m27._tag === "Return") {
      const value = __ring_m27.value; const span = __ring_m27.span;
      __ring_match28: {
    ...
    if (__ring_m27._tag === "While") {
      const condition = __ring_m27.condition; const body = __ring_m27.body; const span = __ring_m27.span;
    ...
    if (__ring_m27._tag === "ForIn") {
      const binding = __ring_m27.binding; const binding_span = __ring_m27.binding_span; const def_id = __ring_m27.def_id; const destructure = __ring_m27.destructure; const iterable = __ring_m27.iterable; const body = __ring_m27.body; const iterable_type_name = __ring_m27.iterable_type_name; const iter_type_name = __ring_m27.iter_type_name; const span = __ring_m27.span;
      let hoists = [];
      let __ring_blk6;
      __ring_match29: {
        const __ring_m29 = iterable;
        if (__ring_m29._tag === "RangeExpr") {
          __ring_blk6 = anf_expr(iterable, hoists, externs, counter);
          break __ring_match29;
        }
        __ring_blk6 = anf_operand(iterable, hoists, externs, counter);
        break __ring_match29;
      }
      const new_iter = __ring_blk6;
      const new_body = anf_block_expr(body, externs, counter);
    ...
    if (__ring_m27._tag === "LetDestructure") {
      const pattern = __ring_m27.pattern; const bindings = __ring_m27.bindings; const init = __ring_m27.init; const span = __ring_m27.span;
      let hoists = [];
    ...
    if (__ring_m27._tag === "IfLet") {
      const pattern = __ring_m27.pattern; const expr = __ring_m27.expr; const then_block = __ring_m27.then_block; const else_block = __ring_m27.else_block; const span = __ring_m27.span;
      let hoists = [];
      const new_expr = anf_operand(expr, hoists, externs, counter);
      ...
      __ring_match30: {
        ...
        if (__ring_m30._tag === "some") {
          ...
          __ring_blk7 = Option_some(anf_block_expr(eb, externs, counter));
...
function anf_block_expr(body, externs, counter) {
  __ring_match31: {
    const __ring_m31 = body;
    if (__ring_m31._tag === "Block") {
      const stmts = __ring_m31.stmts; const tail = __ring_m31.tail; const ty = __ring_m31.ty; const effects = __ring_m31.effects; const span = __ring_m31.span;
      ...
      __ring_match32: {
        ...
        if (__ring_m32._tag === "some") {
          ...
          __ring_blk8 = ((List_len(tail_hoists) === 0) ? [new_stmts, Option_some(nt)] : (function() {
  ...
  return [merged, Option_some(nt)];
        ...
        if (__ring_m32._tag === "none") {
          __ring_blk8 = [new_stmts, Option_none];
          break __ring_match32;
        }
        __match_fail(__ring_m32);
      }
      const new_tail = __ring_blk8;
...
function anf_decl(decl, externs, counter) {
  __ring_match33: {
    ...
    if (__ring_m33._tag === "Fn") {
      const name = __ring_m33.name; const def_id = __ring_m33.def_id; const type_params = __ring_m33.type_params; const params = __ring_m33.params; const return_type = __ring_m33.return_type; const effects = __ring_m33.effects; const body = __ring_m33.body; const is_pub = __ring_m33.is_pub; const trait_bounds = __ring_m33.trait_bounds; const span = __ring_m33.span;
    ...
    if (__ring_m33._tag === "Impl") {
      const target_type = __ring_m33.target_type; const type_params = __ring_m33.type_params; const trait_name = __ring_m33.trait_name; const methods = __ring_m33.methods; const assoc_types = __ring_m33.assoc_types; const span = __ring_m33.span;
      let new_methods = [];
    ...
    if (__ring_m33._tag === "Test") {
      const description = __ring_m33.description; const body = __ring_m33.body; const span = __ring_m33.span;
      return hir$HDecl_Test(description, anf_fn_body(body, externs, counter), span);
      break __ring_match33;
    }
    if (__ring_m33._tag === "Const") {
      const name = __ring_m33.name; const def_id = __ring_m33.def_id; const ty = __ring_m33.ty; const init = __ring_m33.init; const is_pub = __ring_m33.is_pub; const span = __ring_m33.span;
      return hir$HDecl_Const(name, def_id, ty, anf_value_in_own_scope(init, externs, counter), is_pub, span);
      break __ring_match33;
    }
    if (__ring_m33._tag === "ModBlock") {
      const name = __ring_m33.name; const mod_decls = __ring_m33.decls; const is_pub = __ring_m33.is_pub; const span = __ring_m33.span;
      let new_mod = [];
    ...
    if (__ring_m33._tag === "Struct") {
      return decl;
      break __ring_match33;
    }
    if (__ring_m33._tag === "Enum") {
      return decl;
      break __ring_match33;
    }
    if (__ring_m33._tag === "Effect") {
      return decl;
      break __ring_match33;
    }
    if (__ring_m33._tag === "Trait") {
      return decl;
      break __ring_match33;
    }
    ...
    if (__ring_m33._tag === "ExternType") {
      return decl;
      break __ring_match33;
    }
    if (__ring_m33._tag === "TypeAlias") {
      return decl;
      break __ring_match33;
    }
    if (__ring_m33._tag === "Sig") {
      return decl;
      break __ring_match33;
    }
...
function block_diverges(stmts, tail) {
  ...
  __ring_match34: {
    const __ring_m34 = tail;
    if (__ring_m34._tag === "some") {
      const t = __ring_m34._0;
      return expr_diverges(t);
...
function is_droppable_branch_value(body, externs) {
  if (expr_diverges(body)) {
    ...
    __ring_match35: {
      const __ring_m35 = body;
      if (__ring_m35._tag === "Block") {
        const tail = __ring_m35.tail;
        __ring_match36: {
...
function is_droppable_init(init, externs) {
  ...
  __ring_match37: {
    ...
    if (__ring_m37._tag === "IntLit") {
      return true;
      break __ring_match37;
    }
    if (__ring_m37._tag === "FloatLit") {
      return true;
      break __ring_match37;
    }
    if (__ring_m37._tag === "StrLit") {
      return true;
      break __ring_match37;
    }
    if (__ring_m37._tag === "BoolLit") {
      return true;
      break __ring_match37;
    }
    ...
    if (__ring_m37._tag === "IfExpr") {
      const then_branch = __ring_m37.then_branch; const else_branch = __ring_m37.else_branch;
      __ring_match38: {
    ...
    if (__ring_m37._tag === "Block") {
      const tail = __ring_m37.tail;
      __ring_match39: {
        const __ring_m39 = tail;
    ...
    if (__ring_m37._tag === "DictConstruct") {
      return true;
      break __ring_match37;
    }
    return false;
...
function fresh_scope_tmp(gensym) {
  let __ring_blk9;
  __ring_match41: {
    const __ring_m41 = List_get(gensym, 0);
...
function is_variant_constructor_call(callee, result_ty) {
  __ring_match44: {
    const __ring_m44 = callee;
    if (__ring_m44._tag === "Ident") {
      const resolved_name = __ring_m44.resolved_name;
      __ring_match45: {
        const __ring_m45 = resolved_name;
        if (__ring_m45._tag === "some") {
          const rn = __ring_m45._0;
          __ring_match46: {
            const __ring_m46 = result_ty;
            if (__ring_m46._tag === "EnumType") {
              const name = __ring_m46.name;
...
function mutate_append_param_drops(body, params) {
  __ring_match47: {
    const __ring_m47 = body;
    if (__ring_m47._tag === "Block") {
      const stmts = __ring_m47.stmts; const tail = __ring_m47.tail; const ty = __ring_m47.ty; const effects = __ring_m47.effects; const span = __ring_m47.span;
  ...
  while (true) {
    ...
    __ring_match48: {
      ...
      if (__ring_m48._tag === "Fn") {
        const name = __ring_m48.name; const def_id = __ring_m48.def_id; const type_params = __ring_m48.type_params; const params = __ring_m48.params; const return_type = __ring_m48.return_type; const effects = __ring_m48.effects; const body = __ring_m48.body; const is_pub = __ring_m48.is_pub; const trait_bounds = __ring_m48.trait_bounds; const span = __ring_m48.span;
...
function scalar_reassign_drop_name(target, boxed) {
  __ring_match49: {
    const __ring_m49 = target;
    if (__ring_m49._tag === "Ident") {
      const name = __ring_m49.name; const def_id = __ring_m49.def_id; const ty = __ring_m49.ty;
      let __ring_blk10;
      __ring_match50: {
        const __ring_m50 = def_id;
        if (__ring_m50._tag === "some") {
          const did = __ring_m50._0;
          __ring_blk10 = (_Set_contains(boxed, did, __Int_Eq) === false);
...
function sink_arg_indices(callee, arg_count) {
  __ring_match51: {
    const __ring_m51 = callee;
    if (__ring_m51._tag === "FieldAccess") {
      const receiver = __ring_m51.receiver; const field = __ring_m51.field;
      const recv_ty = hir$hexpr_type(receiver);
      let __ring_blk11;
      __ring_match52: {
        const __ring_m52 = recv_ty;
        if (__ring_m52._tag === "StructType") {
          const name = __ring_m52.name;
          __ring_blk11 = ((name === "Set") ? true : (name === "StringBuilder"));
          break __ring_match52;
        }
        __ring_blk11 = false;
        break __ring_match52;
      }
      const is_copy_receiver = __ring_blk11;
      if (is_copy_receiver) {
        return [];
      } else {
...
function rc_block_root(body, escape, owned, boxed, externs, gensym, loop_base) {
  __ring_match53: {
    const __ring_m53 = body;
    if (__ring_m53._tag === "Block") {
      const stmts = __ring_m53.stmts; const tail = __ring_m53.tail; const ty = __ring_m53.ty; const effects = __ring_m53.effects; const span = __ring_m53.span;
...
function rc_stmt(stmt, owned, boxed, externs, gensym, loop_base) {
  __ring_match54: {
    ...
    if (__ring_m54._tag === "Let") {
      const name = __ring_m54.name; const name_span = __ring_m54.name_span; const def_id = __ring_m54.def_id; const ty = __ring_m54.ty; const init = __ring_m54.init; const span = __ring_m54.span;
    ...
    if (__ring_m54._tag === "Assign") {
      const target = __ring_m54.target; const value = __ring_m54.value; const span = __ring_m54.span;
      const new_value = rc_escape(value, owned, boxed, externs, gensym, loop_base);
      let __ring_blk12;
      __ring_match55: {
        const __ring_m55 = scalar_reassign_drop_name(target, boxed);
        if (__ring_m55._tag === "some") {
          const dn = __ring_m55._0;
          __ring_blk12 = (List_contains(owned, dn, __Str_Eq) ? Option_some(dn) : Option_none);
      ...
      const w4_target = __ring_blk12;
      __ring_match56: {
        const __ring_m56 = w4_target;
        if (__ring_m56._tag === "some") {
          const dname = __ring_m56._0;
    ...
    if (__ring_m54._tag === "ExprStmt") {
      const expr = __ring_m54.expr; const span = __ring_m54.span;
    ...
    if (__ring_m54._tag === "Return") {
      const value = __ring_m54.value; const span = __ring_m54.span;
      __ring_match57: {
        const __ring_m57 = value;
        if (__ring_m57._tag === "some") {
          const v = __ring_m57._0;
    ...
    if (__ring_m54._tag === "While") {
      const condition = __ring_m54.condition; const body = __ring_m54.body; const span = __ring_m54.span;
    ...
    if (__ring_m54._tag === "ForIn") {
      const binding = __ring_m54.binding; const binding_span = __ring_m54.binding_span; const def_id = __ring_m54.def_id; const destructure = __ring_m54.destructure; const iterable = __ring_m54.iterable; const body = __ring_m54.body; const iterable_type_name = __ring_m54.iterable_type_name; const iter_type_name = __ring_m54.iter_type_name; const span = __ring_m54.span;
    ...
    if (__ring_m54._tag === "Break") {
      const span = __ring_m54.span;
      let out = [];
    ...
    if (__ring_m54._tag === "LetDestructure") {
      const pattern = __ring_m54.pattern; const bindings = __ring_m54.bindings; const init = __ring_m54.init; const span = __ring_m54.span;
    ...
    if (__ring_m54._tag === "IfLet") {
      const pattern = __ring_m54.pattern; const expr = __ring_m54.expr; const then_block = __ring_m54.then_block; const else_block = __ring_m54.else_block; const span = __ring_m54.span;
      const new_expr = rc_expr(expr, false, owned, boxed, externs, gensym, loop_base);
      const new_then = rc_block_root(then_block, false, owned, boxed, externs, gensym, loop_base);
      let __ring_blk13;
      __ring_match58: {
        const __ring_m58 = else_block;
        if (__ring_m58._tag === "some") {
          const eb = __ring_m58._0;
          __ring_blk13 = Option_some(rc_block_root(eb, false, owned, boxed, externs, gensym, loop_base));
      ...
      const new_else = __ring_blk13;
      return [hir$HStmt_IfLet(pattern, new_expr, new_then, new_else, span)];
      break __ring_match54;
    }
    if (__ring_m54._tag === "Drop") {
      return [stmt];
      break __ring_match54;
    }
    if (__ring_m54._tag === "Dup") {
      return [stmt];
      break __ring_match54;
    }
...
function rc_block_inner(stmts, tail, escape, owned, boxed, externs, gensym, loop_base) {
  ...
  __ring_match59: {
    ...
    if (__ring_m59._tag === "some") {
      ...
      __ring_blk14 = Option_some(rc_escape_or_value(t, tail_escape, visible_owned, boxed, externs, gensym, loop_base));
...
function rc_expr(expr, escape, owned, boxed, externs, gensym, loop_base) {
  __ring_match61: {
    ...
    if (__ring_m61._tag === "Ident") {
      const name = __ring_m61.name; const resolved_name = __ring_m61.resolved_name; const def_id = __ring_m61.def_id; const dict_closure_dicts = __ring_m61.dict_closure_dicts; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      return hir$HExpr_Ident(name, resolved_name, def_id, dict_closure_dicts, ty, effects, span);
      break __ring_match61;
    }
    if (__ring_m61._tag === "IntLit") {
      const value = __ring_m61.value; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      return hir$HExpr_IntLit(value, ty, effects, span);
      break __ring_match61;
    }
    ...
    if (__ring_m61._tag === "DictConstruct") {
      const base_dict = __ring_m61.base_dict; const trait_name = __ring_m61.trait_name; const inner = __ring_m61.inner; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      return hir$HExpr_DictConstruct(base_dict, trait_name, inner, ty, effects, span);
      break __ring_match61;
    }
    if (__ring_m61._tag === "BinOp") {
      const op = __ring_m61.op; const left = __ring_m61.left; const right = __ring_m61.right; const eq_dispatch = __ring_m61.eq_dispatch; const ord_dispatch = __ring_m61.ord_dispatch; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
    ...
    if (__ring_m61._tag === "UnaryOp") {
      const op = __ring_m61.op; const operand = __ring_m61.operand; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
    ...
    if (__ring_m61._tag === "Call") {
      const callee = __ring_m61.callee; const args = __ring_m61.args; const type_args = __ring_m61.type_args; const resolved_dicts = __ring_m61.resolved_dicts; const dict_dispatch = __ring_m61.dict_dispatch; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
    ...
    if (__ring_m61._tag === "FieldAccess") {
      const receiver = __ring_m61.receiver; const field = __ring_m61.field; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
    ...
    if (__ring_m61._tag === "StructLit") {
      const name = __ring_m61.name; const type_args = __ring_m61.type_args; const fields = __ring_m61.fields; const spread = __ring_m61.spread; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      let new_fields = [];
    ...
    if (__ring_m61._tag === "NamedVariantConstruct") {
      const enum_name = __ring_m61.enum_name; const variant_name = __ring_m61.variant_name; const fields = __ring_m61.fields; const spread = __ring_m61.spread; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      let new_fields = [];
      ...
      __ring_match63: {
        ...
        if (__ring_m63._tag === "some") {
          const s = __ring_m63._0;
          __ring_blk16 = Option_some(rc_expr(s, false, owned, boxed, externs, gensym, loop_base));
      ...
      const new_spread = __ring_blk16;
      return hir$HExpr_NamedVariantConstruct(enum_name, variant_name, new_fields, new_spread, ty, effects, span);
      break __ring_match61;
    }
    if (__ring_m61._tag === "Block") {
      const stmts = __ring_m61.stmts; const tail = __ring_m61.tail; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      const res = rc_block_inner(stmts, tail, escape, owned, boxed, externs, gensym, loop_base);
      return hir$HExpr_Block(res[0], res[1], ty, effects, span);
      break __ring_match61;
    }
    if (__ring_m61._tag === "IfExpr") {
      const condition = __ring_m61.condition; const then_branch = __ring_m61.then_branch; const else_branch = __ring_m61.else_branch; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      const new_cond = rc_expr(condition, false, owned, boxed, externs, gensym, loop_base);
      ...
      __ring_match64: {
        ...
        if (__ring_m64._tag === "some") {
          ...
          __ring_blk17 = Option_some(rc_block_root(eb, escape, owned, boxed, externs, gensym, loop_base));
      ...
      const new_else = __ring_blk17;
      return hir$HExpr_IfExpr(new_cond, new_then, new_else, ty, effects, span);
      break __ring_match61;
    }
    if (__ring_m61._tag === "MatchExpr") {
      const scrutinee = __ring_m61.scrutinee; const arms = __ring_m61.arms; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      ...
      while (true) {
        ...
        let __ring_blk18;
        __ring_match65: {
          const __ring_m65 = arm.guard;
          if (__ring_m65._tag === "some") {
            const g = __ring_m65._0;
            __ring_blk18 = Option_some(rc_expr(g, false, owned, boxed, externs, gensym, loop_base));
    ...
    if (__ring_m61._tag === "StringInterp") {
      const parts = __ring_m61.parts; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      let new_parts = [];
      ...
      while (true) {
        ...
        __ring_match66: {
          const __ring_m66 = p;
          if (__ring_m66._tag === "Expression") {
            const e = __ring_m66._0;
    ...
    if (__ring_m61._tag === "TryCatch") {
      const body = __ring_m61.body; const arms = __ring_m61.arms; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      ...
      while (true) {
        ...
        __ring_match67: {
          ...
          if (__ring_m67._tag === "some") {
            ...
            __ring_blk19 = Option_some(rc_expr(g, false, owned, boxed, externs, gensym, loop_base));
    ...
    if (__ring_m61._tag === "HandleExpr") {
      const body = __ring_m61.body; const handlers = __ring_m61.handlers; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      const new_body = rc_block_root(body, escape, owned, boxed, externs, gensym, loop_base);
      let new_handlers = [];
    ...
    if (__ring_m61._tag === "Lambda") {
      const params = __ring_m61.params; const return_type = __ring_m61.return_type; const body = __ring_m61.body; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
    ...
    if (__ring_m61._tag === "EffectOp") {
      const effect_name = __ring_m61.effect_name; const op_name = __ring_m61.op_name; const args = __ring_m61.args; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      let new_args = [];
    ...
    if (__ring_m61._tag === "RangeExpr") {
      const start = __ring_m61.start; const end = __ring_m61.end; const inclusive = __ring_m61.inclusive; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
    ...
    if (__ring_m61._tag === "ListLit") {
      const elements = __ring_m61.elements; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      let new_elems = [];
    ...
    if (__ring_m61._tag === "IndexExpr") {
      const receiver = __ring_m61.receiver; const index = __ring_m61.index; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
    ...
    if (__ring_m61._tag === "Clone") {
      const inner = __ring_m61.inner; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      return hir$HExpr_Clone(inner, ty, effects, span);
      break __ring_match61;
    }
    if (__ring_m61._tag === "ReturnExpr") {
      const value = __ring_m61.value; const ty = __ring_m61.ty; const effects = __ring_m61.effects; const span = __ring_m61.span;
      __ring_match68: {
        const __ring_m68 = value;
...
function transform_decl(decl, boxed, externs) {
  __ring_match69: {
    const __ring_m69 = decl;
    if (__ring_m69._tag === "Fn") {
      const name = __ring_m69.name; const def_id = __ring_m69.def_id; const type_params = __ring_m69.type_params; const params = __ring_m69.params; const return_type = __ring_m69.return_type; const effects = __ring_m69.effects; const body = __ring_m69.body; const is_pub = __ring_m69.is_pub; const trait_bounds = __ring_m69.trait_bounds; const span = __ring_m69.span;
    ...
    if (__ring_m69._tag === "Impl") {
      const target_type = __ring_m69.target_type; const type_params = __ring_m69.type_params; const trait_name = __ring_m69.trait_name; const methods = __ring_m69.methods; const assoc_types = __ring_m69.assoc_types; const span = __ring_m69.span;
      const new_methods = transform_decls(methods, boxed, externs);
      return hir$HDecl_Impl(target_type, type_params, trait_name, new_methods, assoc_types, span);
      break __ring_match69;
    }
    if (__ring_m69._tag === "Test") {
      const description = __ring_m69.description; const body = __ring_m69.body; const span = __ring_m69.span;
      const new_body = transform_fn_body([], body, boxed, externs);
      return hir$HDecl_Test(description, new_body, span);
      break __ring_match69;
    }
    if (__ring_m69._tag === "Const") {
      const name = __ring_m69.name; const def_id = __ring_m69.def_id; const ty = __ring_m69.ty; const init = __ring_m69.init; const is_pub = __ring_m69.is_pub; const span = __ring_m69.span;
      const owned = [];
      let gensym = [0];
    ...
    if (__ring_m69._tag === "ModBlock") {
      const name = __ring_m69.name; const mod_decls = __ring_m69.decls; const is_pub = __ring_m69.is_pub; const span = __ring_m69.span;
      return hir$HDecl_ModBlock(name, transform_decls(mod_decls, boxed, externs), is_pub, span);
      break __ring_match69;
    }
    if (__ring_m69._tag === "Struct") {
      return decl;
      break __ring_match69;
    }
    if (__ring_m69._tag === "Enum") {
      return decl;
      break __ring_match69;
    }
    if (__ring_m69._tag === "Effect") {
      return decl;
      break __ring_match69;
    }
    if (__ring_m69._tag === "Trait") {
      return decl;
      break __ring_match69;
    }
    ...
    if (__ring_m69._tag === "ExternType") {
      return decl;
      break __ring_match69;
    }
    if (__ring_m69._tag === "TypeAlias") {
      return decl;
      break __ring_match69;
    }
    if (__ring_m69._tag === "Sig") {
      return decl;
      break __ring_match69;
    }
