...
function inject_module_exports(ctx, exports) {
  ...
  while (true) {
    ...
    sorted_effects.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
    ...
    sorted_aliases.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
    ...
    sorted_traits.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
    ...
    sorted_impl_methods.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
    ...
    while (true) {
      ...
      __ring_match15: {
        ...
        if (__ring_m15._tag === "some") {
          ...
          sorted_meths.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
    ...
    sorted_mut.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
        ...
        __ring_match18: {
          ...
          if (__ring_m18._tag === "NamedItems") {
            ...
            while (true) {
              ...
              let found = false;
              __ring_match20: {
                const __ring_m20 = _Map_get(import_origins, local_name);
                if (__ring_m20._tag === "some") {
                  const prev_mod = __ring_m20._0;
                  if ((prev_mod !== mod_key)) {
                    const d = diagnostics$make_diag(codes$E0707, diagnostics$Severity_SevError, `Ambiguous name '${local_name}': imported from both module '${prev_mod}' and module '${mod_key}'. Use qualified name (${prev_mod}::${local_name} / ${mod_key}::${local_name}) to disambiguate`, item.span, diagnostics$DiagnosticContext_OtherContext(Option_some("ambiguous import")));
                    diagnostics$CollectingSink_report(ctx.sink, d);
                    continue;
                  }
              ...
              __ring_match21: {
                const __ring_m21 = _Map_get(mod_.values, item.name);
              ...
              __ring_match22: {
                const __ring_m22 = _Map_get(mod_.types, item.name);
                if (__ring_m22._tag === "some") {
                  const tdef = __ring_m22._0;
                  found = true;
                  __ring_match23: {
              ...
              if ((found === false)) {
                ...
                _Map_insert(import_origins, local_name, mod_key);
              }
            }
          ...
          if (__ring_m18._tag === "Module") {
            ...
            sorted_mod_values.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
            ...
            while (true) {
              ...
              __ring_match25: {
                const __ring_m25 = _Map_get(import_origins, name);
                if (__ring_m25._tag === "some") {
                  const prev_mod = __ring_m25._0;
                  if ((prev_mod !== mod_key)) {
                    const d = diagnostics$make_diag(codes$E0707, diagnostics$Severity_SevError, `Ambiguous name '${name}': imported from both module '${prev_mod}' and module '${mod_key}'. Use qualified name to disambiguate`, use_decl.path.span, diagnostics$DiagnosticContext_OtherContext(Option_some("ambiguous import")));
                    diagnostics$CollectingSink_report(ctx.sink, d);
                    continue;
                  }
              ...
              _Map_insert(import_origins, name, mod_key);
            }
            let sorted_mod_types = _Map_entries(mod_.types);
            sorted_mod_types.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
              ...
              __ring_match26: {
                ...
                if (__ring_m26._tag === "EnumDef_") {
                  ...
                  while (true) {
                    ...
                    __ring_match27: {
                      const __ring_m27 = _Map_get(mod_.values, v.name);
                      if (__ring_m27._tag === "some") {
                        const vscheme = __ring_m27._0;
                        env$TypeEnv_bind(ctx.env, v.name, vscheme);
