...
function emit_const_body(ctx, name, init) {
  ...
  __ring_match9: {
    const __ring_m9 = _Map_get(ctx.functions, const_fn_name);
    if (__ring_m9._tag === "some") {
      const fn_val = __ring_m9._0;
      let __ring_blk1;
      __ring_match10: {
        const __ring_m10 = hir$hexpr_type(init);
...
function resolve_dict_for_derived(ctx, name) {
  ...
  __ring_match11: {
    const __ring_m11 = _Map_get(ctx.functions, init_fn_name);
    if (__ring_m11._tag === "some") {
      const init_fn = __ring_m11._0;
      let __ring_blk2;
      __ring_match12: {
        const __ring_m12 = _Map_get(ctx.fn_types, init_fn_name);
    ...
    if (__ring_m11._tag === "none") {
      __ring_match13: {
        const __ring_m13 = _Map_get(ctx.dict_globals, name);
        if (__ring_m13._tag === "some") {
          const getter_fn = __ring_m13._0;
...
function emit_tuple_debug_str(ctx, val, element_actions) {
  ...
  const __ring_end2 = List_len(element_actions);
...
function emit_debug_field_to_str(ctx, val, action) {
  __ring_match15: {
    const __ring_m15 = action;
    if (__ring_m15._tag === "Identity") {
      return emit_identity_to_debug_str(ctx, val);
      break __ring_match15;
    }
    if (__ring_m15._tag === "Call") {
      const dict_name = __ring_m15.dict_name; const extra_dicts = __ring_m15.extra_dicts;
      return emit_dict_debug_call(ctx, val, dict_name);
      break __ring_match15;
    }
    if (__ring_m15._tag === "Tuple") {
      const element_actions = __ring_m15.element_actions;
      return emit_tuple_debug_str(ctx, val, element_actions);
      break __ring_match15;
    }
    if (__ring_m15._tag === "FnLiteral") {
...
function emit_default_method_stubs(ctx, target_type, trait_name, impl_methods) {
  ...
  const __ring_iter_3 = __List_Iterable.iter(impl_methods);
  while (true) {
  ...
  let __ring_blk4;
  __ring_match17: {
    const __ring_m17 = _Map_get(ctx.trait_method_order, trait_name);
    if (__ring_m17._tag === "some") {
      const order = __ring_m17._0;
      __ring_blk4 = order;
  ...
  while (true) {
    ...
    __ring_match18: {
      ...
      if (__ring_m18._tag === "some") {
        ...
        const stub_arity = (default_arity - 1);
        let stub_param_types = [];
        const __ring_end5 = stub_arity;
        ...
        __ring_match19: {
          const __ring_m19 = _Map_get(ctx.fn_evidence_params, default_fn_name);
          if (__ring_m19._tag === "some") {
            const ev_params = __ring_m19._0;
        ...
        let __ring_blk5;
        __ring_match20: {
          const __ring_m20 = _Map_get(ctx.fn_types, default_fn_name);
          ...
          if (__ring_m20._tag === "none") {
            let pts = [];
            const __ring_end6 = default_arity;
...
function emit_default_method_thunk(ctx, default_fn_name, default_fn) {
  const thunk_name = `${default_fn_name}__defaultthunk`;
  __ring_match21: {
    const __ring_m21 = _Map_get(ctx.functions, thunk_name);
  ...
  __ring_match22: {
    ...
    if (__ring_m22._tag === "none") {
      let pts = [];
      const __ring_end9 = default_arity;
...
function emit_dict_method_thunk(ctx, mangled, method_fn) {
  ...
  let __ring_blk7;
  __ring_match24: {
    const __ring_m24 = _Map_get(ctx.fn_types, mangled);
...
function emit_dict_method_slot(ctx, target_type, trait_name, method_name, dict_struct_ty, dict_ptr, closure_ty, closure_size, alloc_fn, alloc_ty, slot_idx) {
  ...
  __ring_match25: {
    ...
    if (__ring_m25._tag === "none") {
      const default_fn_name = `__${trait_name}_${method_name}`;
      __ring_match26: {
        const __ring_m26 = _Map_get(ctx.functions, default_fn_name);
        if (__ring_m26._tag === "some") {
          const default_fn = __ring_m26._0;
          const thunk_fn = emit_default_method_thunk(ctx, default_fn_name, default_fn);
          const closure_ptr = LLVMBuildCall2(ctx.builder, alloc_ty, alloc_fn, [closure_size, closure_typeid], codegen_llvm_ctx$fresh_name(ctx, "cls"));
          const fn_slot = LLVMBuildStructGEP2(ctx.builder, closure_ty, closure_ptr, 0, codegen_llvm_ctx$fresh_name(ctx, "fps"));
          LLVMBuildStore(ctx.builder, thunk_fn, fn_slot);
          const env_slot = LLVMBuildStructGEP2(ctx.builder, closure_ty, closure_ptr, 1, codegen_llvm_ctx$fresh_name(ctx, "eps"));
...
function emit_derived_trait_dict(ctx, target_type, trait_name) {
  ...
  let __ring_blk8;
  __ring_match27: {
    const __ring_m27 = _Map_get(ctx.trait_method_order, trait_name);
    if (__ring_m27._tag === "some") {
      const order = __ring_m27._0;
      __ring_blk8 = order;
  ...
  __ring_match28: {
    const __ring_m28 = _Map_get(ctx.functions, build_fn_name);
  ...
  for (let i = 0; i < __ring_end15; i++) {
    __ring_match29: {
      const __ring_m29 = List_get(method_order, i);
      if (__ring_m29._tag === "some") {
        const method_name = __ring_m29._0;
...
function emit_enum_variant_debug_str(ctx, self_val, type_name, variant, enum_info) {
  ...
  const __ring_end16 = List_len(variant.fields);
  for (let fi = 0; fi < __ring_end16; fi++) {
...
function emit_enum_debug_fn(ctx, type_name, variants) {
  ...
  __ring_match30: {
    const __ring_m30 = _Map_get(ctx.functions, mangled);
  ...
  let __ring_blk9;
  __ring_match31: {
    const __ring_m31 = _Map_get(ctx.enum_types, type_name);
  ...
  let incoming_vals = [];
  let incoming_bbs = [];
  const __ring_end17 = List_len(variants);
  for (let vi = 0; vi < __ring_end17; vi++) {
    const variant = __ring_index(variants, vi);
    let __ring_blk10;
    __ring_match32: {
      const __ring_m32 = _Map_get(enum_info.variants, variant.name);
      if (__ring_m32._tag === "some") {
        const vinfo = __ring_m32._0;
...
function find_field_index(field_names, target) {
  const __ring_end18 = List_len(field_names);
...
function emit_struct_debug_fn(ctx, type_name, fields) {
  ...
  let __ring_blk11;
  __ring_match34: {
    const __ring_m34 = _Map_get(ctx.struct_types, type_name);
  ...
  for (let fi = 0; fi < __ring_end19; fi++) {
...
function emit_derived_debug_llvm(ctx, di) {
  const type_name = di.type_name;
  __ring_match35: {
    const __ring_m35 = di.type_kind;
    if (__ring_m35._tag === "StructKind") {
      __ring_match36: {
        const __ring_m36 = di.struct_fields;
        if (__ring_m36._tag === "some") {
          const fields = __ring_m36._0;
    ...
    if (__ring_m35._tag === "EnumKind") {
      __ring_match37: {
        const __ring_m37 = di.enum_variants;
        if (__ring_m37._tag === "some") {
          const variants = __ring_m37._0;
...
function emit_enum_eq_fn(ctx, type_name, variants) {
  ...
  __ring_match38: {
    const __ring_m38 = _Map_get(ctx.functions, mangled);
  ...
  let __ring_blk12;
  __ring_match39: {
    const __ring_m39 = _Map_get(ctx.enum_types, type_name);
    if (__ring_m39._tag === "some") {
      const info = __ring_m39._0;
      __ring_blk12 = info;
...
function emit_tuple_eq_cmp(ctx, lhs, rhs, element_actions) {
  ...
  const __ring_end21 = List_len(element_actions);
...
function emit_field_eq_cmp(ctx, lhs, rhs, action) {
  __ring_match42: {
    const __ring_m42 = action;
    if (__ring_m42._tag === "Identity") {
      return emit_identity_eq_cmp(ctx, lhs, rhs);
      break __ring_match42;
    }
    if (__ring_m42._tag === "Call") {
      const dict_name = __ring_m42.dict_name; const extra_dicts = __ring_m42.extra_dicts;
      return emit_dict_eq_call(ctx, lhs, rhs, dict_name, extra_dicts);
      break __ring_match42;
    }
    if (__ring_m42._tag === "Tuple") {
      const element_actions = __ring_m42.element_actions;
      return emit_tuple_eq_cmp(ctx, lhs, rhs, element_actions);
      break __ring_match42;
    }
    if (__ring_m42._tag === "FnLiteral") {
...
function emit_derived_impls_llvm(ctx, derived_impls) {
  const __ring_iter_23 = __List_Iterable.iter(derived_impls);
  while (true) {
    ...
    __ring_match51: {
      const __ring_m51 = di.trait_name;
      if (__ring_m51 === "Eq") {
...
function emit_enum_constructors(ctx, name, variants) {
  let __ring_blk18;
  __ring_match52: {
    const __ring_m52 = _Map_get(ctx.enum_types, name);
    if (__ring_m52._tag === "some") {
      const info = __ring_m52._0;
      __ring_blk18 = info;
      break __ring_match52;
    }
    if (__ring_m52._tag === "none") {
      __ring_blk18 = panic(`LLVM codegen: enum '${name}' not registered`);
      break __ring_match52;
    }
  ...
  while (true) {
    ...
    let __ring_blk19;
    __ring_match53: {
      const __ring_m53 = _Map_get(enum_info.variants, v.name);
      if (__ring_m53._tag === "some") {
        const vi = __ring_m53._0;
        __ring_blk19 = vi;
        break __ring_match53;
      }
      if (__ring_m53._tag === "none") {
        __ring_blk19 = panic(`LLVM codegen: variant '${v.name}' not found in enum '${name}'`);
        break __ring_match53;
      }
      __match_fail(__ring_m53);
    }
    const variant_info = __ring_blk19;
    let __ring_blk20;
    __ring_match54: {
      const __ring_m54 = _Map_get(ctx.functions, ctor_name);
      if (__ring_m54._tag === "some") {
        const fv = __ring_m54._0;
        __ring_blk20 = fv;
        break __ring_match54;
      }
      if (__ring_m54._tag === "none") {
        __ring_blk20 = panic(`LLVM codegen: enum ctor '${ctor_name}' not forward-declared`);
        break __ring_match54;
      }
      __match_fail(__ring_m54);
    }
    const fn_val = __ring_blk20;
    const saved_fn = ctx.current_fn;
    ctx.current_fn = Option_some(fn_val);
    const entry = LLVMAppendBasicBlockInContext(ctx.context, fn_val, "entry");
    LLVMPositionBuilderAtEnd(ctx.builder, entry);
    ...
    const __ring_end25 = List_len(v.fields);
...
function emit_fn_body(ctx, name, params, effects, body, trait_bounds, impl_type) {
  let __ring_blk21;
  __ring_match55: {
    const __ring_m55 = impl_type;
    if (__ring_m55._tag === "some") {
      const t = __ring_m55._0;
      __ring_blk21 = codegen_llvm_ctx$llvm_mangle_method(t, name);
      break __ring_match55;
    }
    if (__ring_m55._tag === "none") {
      let __ring_blk22;
      __ring_match56: {
        const __ring_m56 = ctx.module_prefix;
        if (__ring_m56._tag === "some") {
          const prefix = __ring_m56._0;
          __ring_blk22 = codegen_llvm_ctx$llvm_mangle_fn_with_prefix(prefix, name);
          break __ring_match56;
        }
        if (__ring_m56._tag === "none") {
          __ring_blk22 = codegen_llvm_ctx$llvm_mangle_fn(name);
          break __ring_match56;
        }
  ...
  __ring_match57: {
    ...
    if (__ring_m57._tag === "none") {
      __ring_blk23 = panic(`LLVM codegen: function '${mangled}' not forward-declared`);
      break __ring_match57;
    }
...
function emit_struct_constructor(ctx, name, fields) {
  ...
  __ring_match59: {
    const __ring_m59 = _Map_get(ctx.functions, ctor_name);
  ...
  let __ring_blk25;
  __ring_match60: {
    const __ring_m60 = _Map_get(ctx.struct_types, name);
    ...
    if (__ring_m60._tag === "none") {
      __ring_blk25 = panic(`LLVM codegen: struct '${name}' not registered`);
      break __ring_match60;
    }
    __match_fail(__ring_m60);
  }
  const struct_info = __ring_blk25;
...
function emit_one_default_method(ctx, fn_val, default_fn_name, trait_name, method, body) {
  ...
  param_idx = (param_idx + 1);
  const __ring_iter_31 = __List_Iterable.iter(method.params);
  while (true) {
...
function emit_trait_default_methods(ctx, trait_name, methods) {
  ...
  while (true) {
    ...
    __ring_match61: {
      const __ring_m61 = method.body;
      if (__ring_m61._tag === "some") {
        const body = __ring_m61._0;
        const default_fn_name = `__${trait_name}_${method.name}`;
        __ring_match62: {
          const __ring_m62 = _Map_get(ctx.functions, default_fn_name);
...
function emit_trait_dict(ctx, target_type, trait_name, methods) {
  ...
  __ring_match64: {
    ...
    if (__ring_m64._tag === "none") {
      __ring_blk26 = impl_methods;
      break __ring_match64;
    }
    __match_fail(__ring_m64);
  }
  const method_order = __ring_blk26;
  const method_count = List_len(method_order);
  if ((method_count === 0)) {
    return;
  }
  ...
  for (let i = 0; i < __ring_end36; i++) {
    __ring_match65: {
      const __ring_m65 = List_get(method_order, i);
      if (__ring_m65._tag === "some") {
        const method_name = __ring_m65._0;
        const _ = emit_dict_method_slot(ctx, target_type, trait_name, method_name, dict_struct_ty, dict_ptr, closure_ty, closure_size, alloc_fn, alloc_ty, i);
...
function emit_llvm_decl(ctx, decl) {
  __ring_match66: {
    ...
    if (__ring_m66._tag === "Fn") {
      const name = __ring_m66.name; const params = __ring_m66.params; const effects = __ring_m66.effects; const body = __ring_m66.body; const trait_bounds = __ring_m66.trait_bounds;
      return emit_fn_body(ctx, name, params, effects, body, trait_bounds, Option_none);
      break __ring_match66;
    }
    if (__ring_m66._tag === "Struct") {
      const name = __ring_m66.name; const fields = __ring_m66.fields;
      return emit_struct_constructor(ctx, name, fields);
      break __ring_match66;
    }
    if (__ring_m66._tag === "Enum") {
      const name = __ring_m66.name; const variants = __ring_m66.variants;
      return emit_enum_constructors(ctx, name, variants);
      break __ring_match66;
    }
    if (__ring_m66._tag === "Impl") {
      const target_type = __ring_m66.target_type; const trait_name = __ring_m66.trait_name; const methods = __ring_m66.methods;
      const __ring_iter_37 = __List_Iterable.iter(methods);
      while (true) {
        ...
        __ring_match67: {
          ...
          if (__ring_m67._tag === "Fn") {
            const mn = __ring_m67.name; const mp = __ring_m67.params; const me = __ring_m67.effects; const mb = __ring_m67.body; const mtb = __ring_m67.trait_bounds;
      ...
      __ring_match68: {
        const __ring_m68 = trait_name;
        if (__ring_m68._tag === "some") {
          const tn = __ring_m68._0;
    ...
    if (__ring_m66._tag === "Trait") {
      const trait_name = __ring_m66.name; const trait_methods = __ring_m66.methods;
    ...
    if (__ring_m66._tag === "Const") {
      const name = __ring_m66.name; const init = __ring_m66.init;
      return emit_const_body(ctx, name, init);
      break __ring_match66;
    }
    if (__ring_m66._tag === "ModBlock") {
      const mod_decls = __ring_m66.decls;
      const __ring_iter_38 = __List_Iterable.iter(mod_decls);
      while (true) {
        const __ring_next_38 = __ListIterator_Iterator.next(__ring_iter_38);
        if (__ring_next_38._tag === "none") break;
        const subdecl = __ring_next_38._0;
...
function register_enum_info(ctx, name, variants) {
  ...
  while (true) {
    ...
    let __ring_blk27;
    __ring_match69: {
      const __ring_m69 = v.field_names;
      if (__ring_m69._tag === "some") {
        const names = __ring_m69._0;
        __ring_blk27 = names;
        break __ring_match69;
      }
      if (__ring_m69._tag === "none") {
        let ns = [];
        const __ring_end40 = fc;
    ...
    const fnames = __ring_blk27;
    let frs = [];
    const __ring_iter_41 = __List_Iterable.iter(v.fields);
    while (true) {
      const __ring_next_41 = __ListIterator_Iterator.next(__ring_iter_41);
      if (__ring_next_41._tag === "none") break;
      const ft = __ring_next_41._0;
