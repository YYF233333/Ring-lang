...
function resolve_type_expr(ctx, texpr) {
      ...
      __ring_match45: {
        ...
        if (__ring_m45._tag === "some") {
          ...
          if (((q === "self") || Str_starts_with(q, "super"))) {
            __ring_match46: {
              const __ring_m46 = resolve_relative_qualifier(q, ctx.mod_path_stack);
  ...
  return new types$EffectRow([], Option_some(tail_id));
    ...
    if (__ring_m44._tag === "RecordType") {
      ...
      __ring_match47: {
        const __ring_m47 = rest;
        if (__ring_m47._tag === "some") {
          const rest_name = __ring_m47._0;
          const tail_var = env$TypeEnv_fresh_var(ctx.env);
          __ring_match48: {
            const __ring_m48 = tail_var;
...
function resolve_named_type(ctx, name, type_args, span) {
  ...
  __ring_match49: {
    const __ring_m49 = _Map_get(ctx.type_param_scope, name);
    if (__ring_m49._tag === "some") {
      const tp = __ring_m49._0;
      return tp;
  ...
  if (((name === hir$BUILTIN_OPTION) && (List_len(type_args) === 1))) {
    __ring_match50: {
      const __ring_m50 = List_get(type_args, 0);
  ...
  if (_Map_contains_key(ctx.env.types.structs, name)) {
    __ring_match51: {
      const __ring_m51 = _Map_get(ctx.env.types.structs, name);
  ...
  if (_Map_contains_key(ctx.env.types.enums, name)) {
    __ring_match52: {
      const __ring_m52 = _Map_get(ctx.env.types.enums, name);
  ...
  __ring_match53: {
    const __ring_m53 = _Map_get(ctx.env.types.type_aliases, name);
    if (__ring_m53._tag === "some") {
      const alias = __ring_m53._0;
      ...
      while ((i < limit)) {
        __ring_match54: {
          const __ring_m54 = [List_get(alias.type_param_vars, i), List_get(resolved_args, i)];
          if (Array.isArray(__ring_m54) && __ring_m54.length === 2 && __ring_m54[0]._tag === "some" && __ring_m54[1]._tag === "some") {
            const var_id = __ring_m54[0]._0; const arg = __ring_m54[1]._0;
...
function bind_pattern(ctx, pattern, expected_type, subst) {
  __ring_match55: {
    ...
    if (__ring_m55._tag === "Binding") {
      ...
      __ring_match56: {
        ...
        if (__ring_m56._tag === "some") {
          ...
          __ring_match57: {
            const __ring_m57 = scheme.def_id;
    ...
    if (__ring_m55._tag === "Constructor") {
      const name = __ring_m55.name; const qualifier = __ring_m55.qualifier; const fields = __ring_m55.fields; const span = __ring_m55.span;
      return bind_constructor_pattern(ctx, name, qualifier, fields, expected_type, subst, span);
      break __ring_match55;
    }
    if (__ring_m55._tag === "Literal") {
      break __ring_match55;
    }
    ...
    if (__ring_m55._tag === "TuplePattern") {
      const elements = __ring_m55.elements; const span = __ring_m55.span;
      const resolved = env$apply_subst(subst, expected_type);
      __ring_match58: {
        const __ring_m58 = resolved;
        if (__ring_m58._tag === "TupleType") {
          const type_elems = __ring_m58.elements;
          ...
          while ((i < List_len(elements))) {
            __ring_match59: {
              const __ring_m59 = [List_get(elements, i), List_get(type_elems, i)];
              if (Array.isArray(__ring_m59) && __ring_m59.length === 2 && __ring_m59[0]._tag === "some" && __ring_m59[1]._tag === "some") {
                const pat = __ring_m59[0]._0; const ty = __ring_m59[1]._0;
...
function bind_constructor_pattern(ctx, name, qualifier, fields, expected_type, subst, span) {
  ...
  __ring_match60: {
    ...
    if (__ring_m60._tag === "some") {
      ...
      __ring_match61: {
        const __ring_m61 = _Map_get(ctx.env.types.enums, ename);
          ...
          __ring_match62: {
            ...
            if (__ring_m62._tag === "some") {
              ...
              while (((i < List_len(fields)) && (i < List_len(v.fields)))) {
                __ring_match64: {
                  const __ring_m64 = [List_get(fields, i), List_get(v.fields, i)];
                  if (Array.isArray(__ring_m64) && __ring_m64.length === 2 && __ring_m64[0]._tag === "some" && __ring_m64[1]._tag === "some") {
                    const fpat = __ring_m64[0]._0; const ftype = __ring_m64[1]._0;
...
function bind_named_constructor_pattern(ctx, name, qualifier, fields, expected_type, subst, span) {
  ...
  __ring_match65: {
    ...
    if (__ring_m65._tag === "some") {
      ...
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match66: {
          const __ring_m66 = resolve_relative_qualifier(q, ctx.mod_path_stack);
        ...
        if (__ring_m68._tag === "some") {
          ...
          __ring_match69: {
            ...
            if (__ring_m69._tag === "some") {
              ...
              __ring_match70: {
                const __ring_m70 = v.field_names;
                if (__ring_m70._tag === "some") {
                  const vfield_names = __ring_m70._0;
                  const resolved_expected = env$apply_subst(subst, expected_type);
                  __ring_match71: {
                    const __ring_m71 = resolved_expected;
                    if (__ring_m71._tag === "EnumType") {
                      const rname = __ring_m71.name;
                      if ((rname !== ename)) {
                        const _ = type_error(ctx.sink, codes$E0301, `variant '${name}' belongs to enum '${ename}', not '${rname}'`, span, diagnostics$DiagnosticContext_TypeMismatch(rname, ename, Option_none));
                      }
                  ...
                  for (const field of fields) {
                    ...
                    __ring_match72: {
                      const __ring_m72 = field_idx;
                      if (__ring_m72._tag === "some") {
                        const idx = __ring_m72._0;
                        __ring_match73: {
                          const __ring_m73 = List_get(v.fields, idx);
                          if (__ring_m73._tag === "some") {
                            const ftype = __ring_m73._0;
                            const field_type = ((_Map_len(inst_map) > 0) ? env$apply_subst_map(inst_map, ftype) : ftype);
...
function try_resolve_pattern_enum(ctx, variant_name, qualifier) {
  __ring_match78: {
    ...
    if (__ring_m78._tag === "some") {
      ...
      __ring_match79: {
        const __ring_m79 = direct;
        if (__ring_m79._tag === "some") {
          const enum_def = __ring_m79._0;
      ...
      if ((List_len(ctx.mod_path_stack) > 0)) {
        ...
        __ring_match80: {
          const __ring_m80 = fallback;
          if (__ring_m80._tag === "some") {
            const enum_def2 = __ring_m80._0;
...
function resolve_pattern_enum(ctx, variant_name, qualifier, span) {
  __ring_match81: {
    const __ring_m81 = qualifier;
    if (__ring_m81._tag === "some") {
      const q = __ring_m81._0;
      const direct = _Map_get(ctx.env.types.enums, q);
      __ring_match82: {
        const __ring_m82 = direct;
        if (__ring_m82._tag === "some") {
          const enum_def = __ring_m82._0;
          if (enum_def.variants.some((function(v) { return (v.name === variant_name); }))) {
            return Option_some(enum_def.name);
          }
      ...
      if ((List_len(ctx.mod_path_stack) > 0)) {
        ...
        const fallback = _Map_get(ctx.env.types.enums, full_q);
        __ring_match83: {
          const __ring_m83 = fallback;
          if (__ring_m83._tag === "some") {
            const enum_def2 = __ring_m83._0;
            if (enum_def2.variants.some((function(v) { return (v.name === variant_name); }))) {
              return Option_some(enum_def2.name);
            }
...
function build_instantiation_map(type_param_vars, resolved_expected) {
  ...
  __ring_match84: {
    ...
    if (__ring_m84._tag === "EnumType") {
      const type_params = __ring_m84.type_params;
      let i = 0;
      while (((i < List_len(type_param_vars)) && (i < List_len(type_params)))) {
        __ring_match85: {
          const __ring_m85 = [List_get(type_param_vars, i), List_get(type_params, i)];
    ...
    if (__ring_m84._tag === "StructType") {
      ...
      while (((i < List_len(type_param_vars)) && (i < List_len(type_params)))) {
        __ring_match86: {
          const __ring_m86 = [List_get(type_param_vars, i), List_get(type_params, i)];
