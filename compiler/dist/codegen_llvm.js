  ...
  while (true) {
    ...
    __ring_match7: {
      ...
      if (__ring_m7._tag === "Fn") {
        const name = __ring_m7.name; const params = __ring_m7.params; const effects = __ring_m7.effects; const trait_bounds = __ring_m7.trait_bounds;
      ...
      if (__ring_m7._tag === "Impl") {
        ...
        while (true) {
          ...
          const method = __ring_next_11._0;
          __ring_match8: {
            const __ring_m8 = method;
            if (__ring_m8._tag === "Fn") {
              const mn = __ring_m8.name; const mp = __ring_m8.params; const me = __ring_m8.effects; const mtb = __ring_m8.trait_bounds;
      ...
      if (__ring_m7._tag === "Struct") {
        const name = __ring_m7.name; const fields = __ring_m7.fields;
        ...
        while (true) {
          ...
          __ring_match10: {
            ...
            if (__ring_m10._tag === "Fn") {
              const mn = __ring_m10.name; const me = __ring_m10.effects;
  ...
  while (true) {
    ...
    __ring_match11: {
      ...
      if (__ring_m11._tag === "Trait") {
        const name = __ring_m11.name; const methods = __ring_m11.methods;
        let method_names = [];
  ...
  while (true) {
    ...
    __ring_match12: {
      ...
      if (__ring_m12._tag === "Effect") {
        const name = __ring_m12.name; const ops = __ring_m12.ops;
  ...
  while (true) {
    ...
    __ring_match14: {
      ...
      if (__ring_m14._tag === "Fn") {
        const name = __ring_m14.name; const params = __ring_m14.params;
        _Map_insert(fn_mut_params, name, mut_param_flags(params));
        break __ring_match14;
      }
      if (__ring_m14._tag === "Impl") {
        const target_type = __ring_m14.target_type; const methods = __ring_m14.methods;
        ...
        while (true) {
          ...
          __ring_match15: {
            ...
            if (__ring_m15._tag === "Fn") {
              const mn = __ring_m15.name; const mp = __ring_m15.params;
...
function emit_drop_registrations(ctx) {
  ...
  while (true) {
    ...
    const drop_name = `ring_drop_${ename}`;
    __ring_match20: {
      const __ring_m20 = _Map_get(ctx.dict_globals, drop_name);
      if (__ring_m20._tag === "some") {
        const drop_fn_val = __ring_m20._0;
...
function emit_c_main(ctx) {
  ...
  __ring_match21: {
    const __ring_m21 = _Map_get(ctx.functions, init_name);
    if (__ring_m21._tag === "some") {
      const init_fn = __ring_m21._0;
...
function emit_c_main_project(ctx, entry_prefix) {
  ...
  __ring_match26: {
    const __ring_m26 = _Map_get(ctx.functions, ring_main_name);
    if (__ring_m26._tag === "some") {
      const ring_main_fn = __ring_m26._0;
      let call_args = [];
      __ring_match27: {
        const __ring_m27 = _Map_get(ctx.fn_evidence_params, ring_main_name);
