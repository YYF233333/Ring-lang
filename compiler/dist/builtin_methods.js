...
const LIST_NON_HOF_METHODS = ["len", "get", "set", "first", "last", "is_empty", "push", "pop", "concat", "extend", "slice", "reverse", "join", "sort", "shift", "clear"];
...
const SET_NON_HOF_METHODS = ["len", "is_empty", "to_list", "insert", "remove", "clear", "union", "intersect", "difference"];
...
const STRINGBUILDER_METHODS = ["add", "line", "add_int", "to_str", "len"];
...
export { CELL_METHODS, STR_METHODS, INT_METHODS, FLOAT_METHODS, LIST_NON_HOF_METHODS, LIST_HOF_METHODS, MAP_NON_HOF_METHODS, MAP_HOF_METHODS, SET_NON_HOF_METHODS, SET_HOF_METHODS, OPTION_NON_HOF_METHODS, OPTION_HOF_METHODS, STRINGBUILDER_METHODS };