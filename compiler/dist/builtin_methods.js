...
function CELL_METHODS() {
  return ["get", "set", "update"];
}

function STR_METHODS() {
  return ["len", "contains", "starts_with", "ends_with", "slice", "trim", "to_upper", "to_lower", "replace", "split", "char_at", "index_of", "pad_start", "pad_end", "repeat", "char_code_at"];
}

function INT_METHODS() {
  return ["to_str"];
}

function FLOAT_METHODS() {
  return ["to_str"];
}

function LIST_NON_HOF_METHODS() {
  return ["len", "get", "first", "last", "contains", "is_empty", "push", "pop", "concat", "extend", "slice", "reverse", "join", "sort", "shift", "clear", "index_of"];
}

function LIST_HOF_METHODS() {
  return ["map", "filter", "flat_map", "fold", "any", "all", "find", "find_index", "sort_by"];
}

function MAP_NON_HOF_METHODS() {
  return ["len", "get", "contains_key", "is_empty", "keys", "values", "entries", "insert", "remove", "clear"];
}

function MAP_HOF_METHODS() {
  return ["map_values", "filter", "any", "fold"];
}

function SET_NON_HOF_METHODS() {
  return ["len", "contains", "is_empty", "to_list", "insert", "remove", "clear", "union", "intersect", "difference"];
}

function SET_HOF_METHODS() {
  return ["filter", "fold", "any", "all"];
}

function OPTION_NON_HOF_METHODS() {
  return ["is_some", "is_none", "unwrap_or", "unwrap", "to_fail"];
}
