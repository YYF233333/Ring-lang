...
function build_module_graph(entry_file, error_format, __ring_ev_fail) {
  ...
  sorted_dependencies.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
  ...
  sorted_dep_count.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
  ...
  if ((List_len(topo_order) !== _Map_len(modules))) {
    ...
    sorted_modules.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
