...
function chase_type_var_map(subst, id, depth) {
  ...
  __ring_match4: {
    const __ring_m4 = _Map_get(subst, id);
    if (__ring_m4._tag === "some") {
      const resolved = __ring_m4._0;
      __ring_match5: {
        const __ring_m5 = resolved;
        if (__ring_m5._tag === "TypeVar") {
          const next_id = __ring_m5.id;
    ...
    if (__ring_m6._tag === "RecordType") {
      ...
      __ring_match7: {
        ...
        if (__ring_m7._tag === "some") {
          ...
          __ring_match8: {
            const __ring_m8 = _Map_get(subst, t_id);
            if (__ring_m8._tag === "some") {
              const resolved = __ring_m8._0;
              const chased = apply_subst_map(subst, resolved);
              __ring_match9: {
                const __ring_m9 = chased;
                if (__ring_m9._tag === "TypeVar") {
                  const new_id = __ring_m9.id; const new_name = __ring_m9.name;
...
function apply_subst_row_map(subst, row) {
  ...
  __ring_match11: {
    const __ring_m11 = row.tail;
    if (__ring_m11._tag === "some") {
      const t_id = __ring_m11._0;
      __ring_match12: {
        const __ring_m12 = _Map_get(subst, t_id);
        if (__ring_m12._tag === "some") {
          const resolved = __ring_m12._0;
          const chased = apply_subst_map(subst, resolved);
          __ring_match13: {
            const __ring_m13 = chased;
...
function apply_subst(subst, t) {
  __ring_match14: {
    ...
    if (__ring_m14._tag === "TypeVar") {
      ...
      __ring_match15: {
        const __ring_m15 = union_find$uf_lookup(subst, id);
        if (__ring_m15._tag === "some") {
          const resolved = __ring_m15._0;
    ...
    if (__ring_m14._tag === "FnType") {
      const params = __ring_m14.params; const return_type = __ring_m14.return_type; const effects = __ring_m14.effects;
    ...
    if (__ring_m14._tag === "GenericType") {
      const base = __ring_m14.base; const args = __ring_m14.args;
    ...
    if (__ring_m14._tag === "RecordType") {
      const fields = __ring_m14.fields; const tail = __ring_m14.tail; const tail_name = __ring_m14.tail_name;
      ...
      __ring_match16: {
        ...
        if (__ring_m16._tag === "some") {
          ...
          __ring_match17: {
            const __ring_m17 = union_find$uf_lookup(subst, root_id);
    ...
    if (__ring_m14._tag === "EffectRowType") {
      const effects = __ring_m14.effects; const tail = __ring_m14.tail;
