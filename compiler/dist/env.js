...
class TypeRegistry {
  constructor(structs, enums, effects, variant_to_enum, type_aliases, sigs) {
...
function TypeEnv_bind(self, name, scheme) {
  ...
  __ring_match1: {
    const __ring_m1 = List_get(self.scope.scopes, idx);
...
function TypeEnv_rebind(self, name, scheme) {
  ...
  while ((i >= 0)) {
    __ring_match2: {
      const __ring_m2 = List_get(self.scope.scopes, i);
      if (__ring_m2._tag === "some") {
        const scope = __ring_m2._0;
...
function TypeEnv_instantiate(self, scheme) {
  ...
  for (const bound of scheme.bounds) {
    __ring_match3: {
      const __ring_m3 = _Map_get(mapping, bound.type_var);
      if (__ring_m3._tag === "some") {
        const fresh = __ring_m3._0;
        __ring_match4: {
          const __ring_m4 = fresh;
...
function chase_type_var_map(subst, id, depth) {
  ...
  __ring_match5: {
    ...
    if (__ring_m5._tag === "some") {
      ...
      __ring_match6: {
        const __ring_m6 = resolved;
        if (__ring_m6._tag === "TypeVar") {
          const next_id = __ring_m6.id;
    ...
    if (__ring_m7._tag === "RecordType") {
      ...
      __ring_match8: {
        ...
        if (__ring_m8._tag === "some") {
          ...
          __ring_match9: {
            const __ring_m9 = _Map_get(subst, t_id);
            if (__ring_m9._tag === "some") {
              const resolved = __ring_m9._0;
              const chased = apply_subst_map(subst, resolved);
              __ring_match10: {
                const __ring_m10 = chased;
                if (__ring_m10._tag === "TypeVar") {
                  const new_id = __ring_m10.id; const new_name = __ring_m10.name;
                  return types$Type_RecordType(mapped_fields, Option_some(new_id), new_name);
                  break __ring_match10;
                }
                if (__ring_m10._tag === "RecordType") {
                  const extra_fields = __ring_m10.fields; const extra_tail = __ring_m10.tail; const extra_tn = __ring_m10.tail_name;
...
function apply_subst_row_map(subst, row) {
  ...
  __ring_match12: {
    ...
    if (__ring_m12._tag === "some") {
      ...
      __ring_match13: {
        const __ring_m13 = _Map_get(subst, t_id);
...
function apply_subst_row(subst, row) {
  ...
  __ring_match21: {
    ...
    if (__ring_m21._tag === "some") {
      ...
      const root_id = union_find$uf_find(subst, t_id);
      __ring_match22: {
        const __ring_m22 = union_find$uf_lookup(subst, root_id);
