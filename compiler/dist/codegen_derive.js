...
function gen_action_clone(expr, action) {
  __ring_match7: {
    ...
    if (__ring_m7._tag === "FloatIdentity") {
      return expr;
      break __ring_match7;
    }
    if (__ring_m7._tag === "BoolIdentity") {
      return expr;
      break __ring_match7;
    }
...
function gen_action_debug(expr, action) {
  __ring_match12: {
    ...
    if (__ring_m12._tag === "FloatIdentity") {
      return `String(${expr})`;
      break __ring_match12;
    }
    if (__ring_m12._tag === "BoolIdentity") {
      return `String(${expr})`;
      break __ring_match12;
    }
...
function gen_action_eq(left, right, action) {
  __ring_match17: {
    ...
    if (__ring_m17._tag === "FloatIdentity") {
      return `(${left} === ${right})`;
      break __ring_match17;
    }
    if (__ring_m17._tag === "BoolIdentity") {
      return `(${left} === ${right})`;
      break __ring_match17;
    }
...
function gen_action_cmp(left, right, action) {
  __ring_match22: {
    ...
    if (__ring_m22._tag === "FloatIdentity") {
      return `(${left} < ${right} ? -1 : ${left} > ${right} ? 1 : 0)`;
      break __ring_match22;
    }
    if (__ring_m22._tag === "BoolIdentity") {
      return `(${left} < ${right} ? -1 : ${left} > ${right} ? 1 : 0)`;
      break __ring_match22;
    }
