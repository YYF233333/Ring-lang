...
function register_const(ctx, name, type_annotation, span) {
  ...
  __ring_match45: {
    const __ring_m45 = env$TypeEnv_lookup(ctx.env, name);
...
function register_decl(ctx, decl) {
  __ring_match47: {
    ...
    if (__ring_m47._tag === "Struct") {
      const name = __ring_m47.name; const type_params = __ring_m47.type_params; const fields = __ring_m47.fields; const span = __ring_m47.span;
      preregister_struct(ctx, name, type_params);
      return complete_struct_fields(ctx, name, fields);
      break __ring_match47;
    }
    if (__ring_m47._tag === "Enum") {
      const name = __ring_m47.name; const type_params = __ring_m47.type_params; const variants = __ring_m47.variants; const span = __ring_m47.span;
      preregister_enum(ctx, name, type_params);
      return complete_enum_variants(ctx, name, type_params, variants);
      break __ring_match47;
    }
    if (__ring_m47._tag === "Effect") {
      const name = __ring_m47.name; const type_params = __ring_m47.type_params; const ops = __ring_m47.ops;
    ...
    if (__ring_m47._tag === "Trait") {
      const name = __ring_m47.name; const type_params = __ring_m47.type_params; const methods = __ring_m47.methods;
    ...
    if (__ring_m47._tag === "ExternType") {
      const name = __ring_m47.name; const type_params = __ring_m47.type_params;
      return register_extern_type(ctx, name, type_params);
      break __ring_match47;
    }
    if (__ring_m47._tag === "TypeAlias") {
      const name = __ring_m47.name; const type_params = __ring_m47.type_params; const type_expr = __ring_m47.type_expr;
