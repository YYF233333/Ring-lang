...
function register_phase1(ctx, decl, deferred_struct_names, deferred_enum_names, __ring_ev_fail) {
  __ring_match0: {
    ...
    if (__ring_m0._tag === "Struct") {
      const name = __ring_m0.name; const type_params = __ring_m0.type_params; const fields = __ring_m0.fields; const span = __ring_m0.span;
      preregister_struct(ctx, name, type_params);
      return List_push(deferred_struct_names, name);
      break __ring_match0;
    }
    if (__ring_m0._tag === "Enum") {
      const name = __ring_m0.name; const type_params = __ring_m0.type_params; const variants = __ring_m0.variants; const span = __ring_m0.span;
...
function register_phase2_enum(ctx, decl) {
  __ring_match2: {
    ...
    if (__ring_m2._tag === "Enum") {
      const name = __ring_m2.name; const type_params = __ring_m2.type_params; const variants = __ring_m2.variants; const span = __ring_m2.span;
...
function complete_struct_fields(ctx, name, fields) {
  __ring_match4: {
    const __ring_m4 = _Map_get(ctx.env.structs, name);
...
function complete_enum_variants(ctx, name, type_params, variants) {
  __ring_match7: {
    const __ring_m7 = _Map_get(ctx.env.enums, name);
    if (__ring_m7._tag === "some") {
      ...
      for (const v of variants) {
        __ring_match9: {
          const __ring_m9 = v.named_fields;
          if (__ring_m9._tag === "some") {
            const nf = __ring_m9._0;
            if ((List_len(nf) > 0)) {
              let field_types = [];
              let field_names = [];
              for (const f of nf) {
  ...
  for (const method of methods) {
    __ring_match12: {
      ...
      if (__ring_m12._tag === "Fn") {
        const mname = __ring_m12.name; const params = __ring_m12.params; const return_type = __ring_m12.return_type; const is_abstract = __ring_m12.is_abstract;
        let param_types = [];
        for (const p of params) {
          if ((p.name === "self")) {
            ...
            __ring_match13: {
              const __ring_m13 = p.type_annotation;
...
function register_impl(ctx, target_type, type_params, trait_name, methods, span, __ring_ev_fail) {
  ...
  for (const method of methods) {
    __ring_match15: {
      ...
      if (__ring_m15._tag === "Fn") {
        const mname = __ring_m15.name; const mtps = __ring_m15.type_params; const params = __ring_m15.params; const return_type = __ring_m15.return_type;
  ...
  __ring_match16: {
    const __ring_m16 = trait_name;
    if (__ring_m16._tag === "some") {
      const tname = __ring_m16._0;
      __ring_match17: {
        const __ring_m17 = _Map_get(ctx.env.traits, tname);
        if (__ring_m17._tag === "some") {
          const trait_def = __ring_m17._0;
...
function check_duplicate_def(ctx, name, span, __ring_ev_fail) {
  __ring_match25: {
    ...
    if (__ring_m25._tag === "some") {
      ...
      __ring_match26: {
        const __ring_m26 = existing.def_id;
        if (__ring_m26._tag === "some") {
          const did = __ring_m26._0;
          __ring_match27: {
...
function register_fn(ctx, name, type_params, params, return_type, span, __ring_ev_fail) {
  ...
  __ring_match33: {
    const __ring_m33 = env$TypeEnv_lookup(ctx.env, name);
...
function register_extern_fn(ctx, name, type_params, params, return_type, span, __ring_ev_fail) {
  ...
  for (const p of params) {
    __ring_match36: {
      const __ring_m36 = p.type_annotation;
      if (__ring_m36._tag === "some") {
        const ta = __ring_m36._0;
        List_push(param_types, infer_ctx$resolve_type_expr(ctx, ta));
...
function register_extern_type(ctx, name, type_params) {
  ...
  ctx.type_param_scope = saved;
  return _Map_insert(ctx.env.structs, name, new env$StructDef(name, tp_names, tp_vars, []));
}
...
function register_decl(ctx, decl, __ring_ev_fail) {
  __ring_match44: {
    ...
    if (__ring_m44._tag === "Struct") {
      const name = __ring_m44.name; const type_params = __ring_m44.type_params; const fields = __ring_m44.fields; const span = __ring_m44.span;
      preregister_struct(ctx, name, type_params);
      return complete_struct_fields(ctx, name, fields);
      break __ring_match44;
    }
    if (__ring_m44._tag === "Enum") {
      const name = __ring_m44.name; const type_params = __ring_m44.type_params; const variants = __ring_m44.variants; const span = __ring_m44.span;
      preregister_enum(ctx, name, type_params);
      return complete_enum_variants(ctx, name, type_params, variants);
      break __ring_match44;
    }
    if (__ring_m44._tag === "Effect") {
      const name = __ring_m44.name; const type_params = __ring_m44.type_params; const ops = __ring_m44.ops;
      return register_effect(ctx, name, type_params, ops);
      break __ring_match44;
    }
    if (__ring_m44._tag === "Impl") {
      const target_type = __ring_m44.target_type; const type_params = __ring_m44.type_params; const trait_name = __ring_m44.trait_name; const methods = __ring_m44.methods; const span = __ring_m44.span;
      return register_impl(ctx, target_type, type_params, trait_name, methods, span, __ring_ev_fail);
      break __ring_match44;
    }
    if (__ring_m44._tag === "Fn") {
      const name = __ring_m44.name; const type_params = __ring_m44.type_params; const params = __ring_m44.params; const return_type = __ring_m44.return_type; const span = __ring_m44.span;
    ...
    if (__ring_m44._tag === "Trait") {
      const name = __ring_m44.name; const type_params = __ring_m44.type_params; const methods = __ring_m44.methods;
    ...
    if (__ring_m44._tag === "TypeAlias") {
      const name = __ring_m44.name; const type_params = __ring_m44.type_params; const type_expr = __ring_m44.type_expr;
