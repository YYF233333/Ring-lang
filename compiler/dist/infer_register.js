...
function complete_struct_fields(ctx, name, fields) {
  __ring_match4: {
    const __ring_m4 = _Map_get(ctx.env.types.structs, name);
...
function complete_enum_variants(ctx, name, type_params, variants) {
  __ring_match7: {
    const __ring_m7 = _Map_get(ctx.env.types.enums, name);
...
function register_impl(ctx, target_type, type_params, trait_name, methods, span) {
  ...
  for (const method of methods) {
    __ring_match15: {
      ...
      if (__ring_m15._tag === "Fn") {
        const mname = __ring_m15.name; const mtps = __ring_m15.type_params; const params = __ring_m15.params; const return_type = __ring_m15.return_type; const declared_effects = __ring_m15.declared_effects;
  ...
  __ring_match16: {
    ...
    if (__ring_m16._tag === "some") {
      ...
      __ring_match17: {
        const __ring_m17 = _Map_get(ctx.env.trait_reg.traits, tname);
    ...
    if (__ring_m25._tag === "some") {
      ...
      __ring_match26: {
        ...
        if (__ring_m26._tag === "some") {
          ...
          __ring_match27: {
            const __ring_m27 = _Map_get(ctx.env.scope.def_spans, did);
...
function register_decl(ctx, decl) {
  __ring_match47: {
    ...
    if (__ring_m47._tag === "Fn") {
      const name = __ring_m47.name; const type_params = __ring_m47.type_params; const params = __ring_m47.params; const return_type = __ring_m47.return_type; const declared_effects = __ring_m47.declared_effects; const span = __ring_m47.span;
...
export { register_decl_public, register_decls_two_phase, resolve_effect_expr, resolve_declared_effects };