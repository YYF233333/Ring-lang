  ...
  for (const method of methods) {
    __ring_match29: {
      ...
      if (__ring_m29._tag === "Fn") {
        const mname = __ring_m29.name; const params = __ring_m29.params; const return_type = __ring_m29.return_type; const is_abstract = __ring_m29.is_abstract;
        let param_types = [];
...
function register_impl(ctx, target_type, type_params, trait_name, methods, span) {
  ...
  for (const method of methods) {
    __ring_match32: {
      ...
      if (__ring_m32._tag === "Fn") {
        const mname = __ring_m32.name; const mtps = __ring_m32.type_params; const params = __ring_m32.params; const return_type = __ring_m32.return_type; const declared_effects = __ring_m32.declared_effects;
  ...
  __ring_match33: {
    const __ring_m33 = trait_name;
    if (__ring_m33._tag === "some") {
      const tname = __ring_m33._0;
      __ring_match34: {
        const __ring_m34 = _Map_get(ctx.env.trait_reg.traits, tname);
        if (__ring_m34._tag === "some") {
          const trait_def = __ring_m34._0;
...
function register_impl_method(ctx, methods_map, impl_tv_ids, target_type, mname, mtps, params, return_type, declared_effects, impl_scheme_bounds, outer_saved, impl_type_params) {
  ...
  if ((List_len(params) > 0)) {
    __ring_match43: {
      const __ring_m43 = List_first(params);
      if (__ring_m43._tag === "some") {
        const first_p = __ring_m43._0;
...
function expand_effect_exprs(ctx, decl_effects, expanding) {
  ...
  for (const eff of decl_effects) {
    __ring_match47: {
      const __ring_m47 = _Map_get(ctx.env.types.effect_aliases, eff.name);
      if (__ring_m47._tag === "some") {
        const alias_def = __ring_m47._0;
        if (_Set_contains(expanding, eff.name, __Str_Eq)) {
          ...
          while (((i < List_len(alias_def.type_params)) && (i < List_len(eff.type_args)))) {
            __ring_match48: {
              const __ring_m48 = List_get(alias_def.type_params, i);
              if (__ring_m48._tag === "some") {
                const tp_name = __ring_m48._0;
                __ring_match49: {
                  const __ring_m49 = List_get(eff.type_args, i);
...
function subst_type_expr(te, subst_map) {
  __ring_match50: {
    const __ring_m50 = te;
    if (__ring_m50._tag === "Named") {
      const name = __ring_m50.name; const type_args = __ring_m50.type_args; const span = __ring_m50.span;
      if ((List_len(type_args) === 0)) {
        __ring_match51: {
          const __ring_m51 = _Map_get(subst_map, name);
          if (__ring_m51._tag === "some") {
            const replacement = __ring_m51._0;
            return replacement;
...
function check_duplicate_def(ctx, name, span) {
  __ring_match52: {
    ...
    if (__ring_m52._tag === "some") {
      ...
      __ring_match53: {
        const __ring_m53 = existing.def_id;
        if (__ring_m53._tag === "some") {
          const did = __ring_m53._0;
          __ring_match54: {
            const __ring_m54 = _Map_get(ctx.env.scope.def_spans, did);
...
function register_fn(ctx, name, type_params, params, return_type, declared_effects, span) {
  ...
  for (const p of params) {
    __ring_match56: {
      const __ring_m56 = p.type_annotation;
      if (__ring_m56._tag === "some") {
        const ta = __ring_m56._0;
        List_push(param_types, infer_ctx$resolve_type_expr(ctx, ta));
...
function register_extern_fn(ctx, name, type_params, params, return_type, declared_effects, span) {
  ...
  __ring_match67: {
    ...
    if (__ring_m67._tag === "some") {
      const s = __ring_m67._0;
      __ring_match68: {
        const __ring_m68 = s.def_id;
...
function register_const(ctx, name, type_annotation, span) {
  check_duplicate_def(ctx, name, span);
  __ring_match71: {
    const __ring_m71 = type_annotation;
    if (__ring_m71._tag === "some") {
      const texpr = __ring_m71._0;
...
function register_decl(ctx, decl) {
  __ring_match76: {
    ...
    if (__ring_m76._tag === "Struct") {
      const name = __ring_m76.name; const type_params = __ring_m76.type_params; const fields = __ring_m76.fields; const span = __ring_m76.span;
      preregister_struct(ctx, name, type_params);
      return complete_struct_fields(ctx, name, fields);
      break __ring_match76;
    }
    if (__ring_m76._tag === "Enum") {
      const name = __ring_m76.name; const type_params = __ring_m76.type_params; const variants = __ring_m76.variants; const span = __ring_m76.span;
      preregister_enum(ctx, name, type_params);
      return complete_enum_variants(ctx, name, type_params, variants);
      break __ring_match76;
    }
    if (__ring_m76._tag === "Effect") {
      const name = __ring_m76.name; const type_params = __ring_m76.type_params; const ops = __ring_m76.ops;
    ...
    if (__ring_m76._tag === "Fn") {
      const name = __ring_m76.name; const type_params = __ring_m76.type_params; const params = __ring_m76.params; const return_type = __ring_m76.return_type; const declared_effects = __ring_m76.declared_effects; const span = __ring_m76.span;
    ...
    if (__ring_m76._tag === "Trait") {
      const name = __ring_m76.name; const type_params = __ring_m76.type_params; const methods = __ring_m76.methods;
    ...
    if (__ring_m76._tag === "TypeAlias") {
      const name = __ring_m76.name; const type_params = __ring_m76.type_params; const type_expr = __ring_m76.type_expr;
      return register_type_alias(ctx, name, type_params, type_expr);
      break __ring_match76;
    }
    if (__ring_m76._tag === "Const") {
      const name = __ring_m76.name; const type_annotation = __ring_m76.type_annotation; const span = __ring_m76.span;
      return register_const(ctx, name, type_annotation, span);
      break __ring_match76;
    }
    if (__ring_m76._tag === "Sig") {
      const name = __ring_m76.name; const members = __ring_m76.members; const is_pub = __ring_m76.is_pub;
      return register_sig(ctx, name, members, is_pub);
      break __ring_match76;
    }
    if (__ring_m76._tag === "EffectAlias") {
      const name = __ring_m76.name; const type_params = __ring_m76.type_params; const effects = __ring_m76.effects; const span = __ring_m76.span;
      return register_effect_alias(ctx, name, type_params, effects, span);
      break __ring_match76;
    }
    if (__ring_m76._tag === "ModBlock") {
      const mod_name = __ring_m76.name; const mod_decls = __ring_m76.decls;
      for (const d of mod_decls) {
        __ring_match77: {
          const __ring_m77 = d;
      ...
      for (const d of mod_decls) {
        __ring_match78: {
          ...
          if (__ring_m78._tag === "EffectAlias") {
            const prefixed = prefix_decl_name(mod_name, d);
            register_decl(ctx, prefixed);
            break __ring_match78;
          }
      ...
      for (const d of mod_decls) {
        __ring_match79: {
          const __ring_m79 = d;
          if (__ring_m79._tag === "Struct") {
            break __ring_match79;
          }
          if (__ring_m79._tag === "Enum") {
            break __ring_match79;
          }
          if (__ring_m79._tag === "Trait") {
            break __ring_match79;
          }
