...
function compile_phases(entry_file, error_format, __ring_ev_fail) {
  __ring_match6: {
    const __ring_m6 = resolver$build_module_graph(entry_file, error_format, __ring_ev_fail);
    ...
    if (__ring_m6._tag === "some") {
        ...
        if (check_ok) {
          __ring_match8: {
            ...
            if (__ring_m8._tag === "some") {
              ...
              let __ring_blk0;
              __ring_match9: {
                const __ring_m9 = _Map_get(graph.dependencies, key);
                if (__ring_m9._tag === "some") {
                  const dk = __ring_m9._0;
                  __ring_blk0 = dk;
                  break __ring_match9;
                }
              ...
              while (true) {
                ...
                __ring_match10: {
                  const __ring_m10 = _Map_get(module_exports_map, dk);
              ...
              if (diagnostics$CollectingSink_has_errors(sink)) {
                let __ring_blk1;
                __ring_match11: {
                  const __ring_m11 = _Map_get(graph.modules, key);
                  if (__ring_m11._tag === "some") {
                    const m = __ring_m11._0;
                    __ring_blk1 = m.file_path;
                ...
                if ((List_len(sink.items) > 0)) {
                  let __ring_blk2;
                  __ring_match12: {
                    const __ring_m12 = _Map_get(graph.modules, key);
                    if (__ring_m12._tag === "some") {
                      const m = __ring_m12._0;
                      __ring_blk2 = m.file_path;
                ...
                __ring_match13: {
                  const __ring_m13 = _Map_get(graph.modules, key);
                  if (__ring_m13._tag === "some") {
                    const mod_ = __ring_m13._0;
      ...
      const __ring_iter_5 = __List_Iterable.iter(graph.topo_order);
      while (true) {
        const __ring_next_5 = __ListIterator_Iterator.next(__ring_iter_5);
        if (__ring_next_5._tag === "none") break;
        const key = __ring_next_5._0;
        __ring_match14: {
          const __ring_m14 = _Map_get(module_hirs, key);
          if (__ring_m14._tag === "some") {
            const hir = __ring_m14._0;
            const __ring_iter_6 = ___Set_Iterable.iter(hir.extern_type_names);
            while (true) {
              const __ring_next_6 = __SetIterator_Iterator.next(__ring_iter_6);
      ...
      const __ring_iter_7 = __List_Iterable.iter(graph.topo_order);
      while (true) {
        const __ring_next_7 = __ListIterator_Iterator.next(__ring_iter_7);
        if (__ring_next_7._tag === "none") break;
        const key = __ring_next_7._0;
        __ring_match15: {
          const __ring_m15 = [_Map_get(module_hirs, key), _Map_get(module_envs, key)];
          if (Array.isArray(__ring_m15) && __ring_m15.length === 2 && __ring_m15[0]._tag === "some" && __ring_m15[1]._tag === "some") {
            const hir = __ring_m15[0]._0; const env = __ring_m15[1]._0;
            let filtered = set_new();
            const __ring_iter_8 = ___Set_Iterable.iter(global_externs);
            while (true) {
              const __ring_next_8 = __SetIterator_Iterator.next(__ring_iter_8);
              if (__ring_next_8._tag === "none") break;
              const en = __ring_next_8._0;
              __ring_match16: {
                const __ring_m16 = _Map_get(env.types.structs, en);
                if (__ring_m16._tag === "some") {
                  const sdef = __ring_m16._0;
                  if (sdef.is_extern) {
...
function compile_project(entry_file, error_format, __ring_ev_fail) {
  __ring_match17: {
    const __ring_m17 = compile_phases(entry_file, error_format, __ring_ev_fail);
    if (__ring_m17._tag === "none") {
      return new CompileProjectResult("", false);
      break __ring_match17;
    }
    if (__ring_m17._tag === "some") {
      return new CompileProjectResult("", true);
      break __ring_match17;
    }
...
function compile_project_llvm(entry_file, output_path, error_format, __ring_ev_fail, __ring_ev_io) {
  __ring_match18: {
    const __ring_m18 = compile_phases(entry_file, error_format, __ring_ev_fail);
    if (__ring_m18._tag === "none") {
      return new LlvmCompileResult(false);
      break __ring_match18;
    }
    if (__ring_m18._tag === "some") {
      const phases = __ring_m18._0;
      ...
      while (true) {
        ...
        __ring_match19: {
          const __ring_m19 = [_Map_get(phases.graph.modules, key), _Map_get(phases.module_hirs, key), _Map_get(phases.module_asts, key)];
          if (Array.isArray(__ring_m19) && __ring_m19.length === 3 && __ring_m19[0]._tag === "some" && __ring_m19[1]._tag === "some" && __ring_m19[2]._tag === "some") {
            const mod_ = __ring_m19[0]._0; const hir = __ring_m19[1]._0; const ast = __ring_m19[2]._0;
            const prefix = resolver$module_prefix(mod_.path_segments);
          ...
          if (Array.isArray(__ring_m19) && __ring_m19.length === 3 && __ring_m19[0]._tag === "some" && __ring_m19[1]._tag === "some" && __ring_m19[2]._tag === "none") {
            const mod_ = __ring_m19[0]._0; const hir = __ring_m19[1]._0;
            const prefix = resolver$module_prefix(mod_.path_segments);
            const rc_hir = perceus$perceus_transform(hir);
...
function verify_project_rc(entry_file, mutate, strict, error_format, __ring_ev_fail) {
  __ring_match20: {
    const __ring_m20 = compile_phases(entry_file, error_format, __ring_ev_fail);
    if (__ring_m20._tag === "none") {
      return new RcProjectVerifyResult(false, 0, 0, "");
      break __ring_match20;
    }
    if (__ring_m20._tag === "some") {
      const phases = __ring_m20._0;
      let all = [];
      const __ring_iter_10 = __List_Iterable.iter(phases.graph.topo_order);
      while (true) {
        const __ring_next_10 = __ListIterator_Iterator.next(__ring_iter_10);
        if (__ring_next_10._tag === "none") break;
        const key = __ring_next_10._0;
        __ring_match21: {
          const __ring_m21 = _Map_get(phases.module_hirs, key);
          if (__ring_m21._tag === "some") {
            const hir = __ring_m21._0;
            const rc_hir = perceus$perceus_transform_mutated(hir, mutate);
            const __ring_iter_11 = __List_Iterable.iter(verify_rc$verify_rc_program(rc_hir));
            while (true) {
...
export { CompileProjectResult, compile_project, LlvmCompileResult, compile_project_llvm, RcProjectVerifyResult, verify_project_rc, __CompileProjectResult_Eq, __LlvmCompileResult_Eq, __RcProjectVerifyResult_Eq, __CompileProjectResult_Clone, __LlvmCompileResult_Clone, __RcProjectVerifyResult_Clone, __CompileProjectResult_Ord, __LlvmCompileResult_Ord, __RcProjectVerifyResult_Ord, __CompileProjectResult_Debug, __LlvmCompileResult_Debug, __RcProjectVerifyResult_Debug };