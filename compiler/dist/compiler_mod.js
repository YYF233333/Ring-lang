...
function build_dep_import_pairs(dep_exports, dep_prefix) {
  ...
  sorted_types.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
  ...
  sorted_values.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
  ...
  sorted_inherent.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
      ...
      while (true) {
        ...
        __ring_match17: {
          ...
          if (__ring_m17._tag === "some") {
            ...
            sorted_fmp.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
      ...
      while (true) {
        ...
        __ring_match19: {
          ...
          if (__ring_m19._tag === "some") {
            ...
            sorted_impl.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
            ...
            while (true) {
              ...
              sorted_methods.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
      ...
      while (true) {
        ...
        __ring_match21: {
          ...
          if (__ring_m21._tag === "some") {
            ...
            sorted_sfo.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
      ...
      while (true) {
        ...
        __ring_match23: {
          ...
          if (__ring_m23._tag === "some") {
            ...
            sorted_dep_types.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
            ...
            sorted_dep_values.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
...
function compile_phases(entry_file, error_format, __ring_ev_fail) {
  __ring_match32: {
    ...
    if (__ring_m32._tag === "some") {
          ...
          __ring_match34: {
            ...
            if (__ring_m34._tag === "some") {
              ...
              if (diagnostics$CollectingSink_has_errors(sink)) {
                ...
                _Map_insert(module_envs, key, result.env);
                __ring_match39: {
      ...
      let global_externs = set_new();
      const __ring_iter_43 = __List_Iterable.iter(graph.topo_order);
      while (true) {
        ...
        __ring_match40: {
          const __ring_m40 = _Map_get(module_hirs, key);
          if (__ring_m40._tag === "some") {
            const hir = __ring_m40._0;
            const __ring_iter_44 = ___Set_Iterable.iter(hir.extern_type_names);
            while (true) {
      ...
      const __ring_iter_45 = __List_Iterable.iter(graph.topo_order);
      while (true) {
        const __ring_next_45 = __ListIterator_Iterator.next(__ring_iter_45);
        if (__ring_next_45._tag === "none") break;
        const key = __ring_next_45._0;
        __ring_match41: {
          const __ring_m41 = [_Map_get(module_hirs, key), _Map_get(module_envs, key)];
          if (Array.isArray(__ring_m41) && __ring_m41.length === 2 && __ring_m41[0]._tag === "some" && __ring_m41[1]._tag === "some") {
            const hir = __ring_m41[0]._0; const env = __ring_m41[1]._0;
            let filtered = set_new();
            const __ring_iter_46 = ___Set_Iterable.iter(global_externs);
            while (true) {
              ...
              __ring_match42: {
                const __ring_m42 = _Map_get(env.types.structs, en);
                if (__ring_m42._tag === "some") {
                  const sdef = __ring_m42._0;
                  if (sdef.is_extern) {
                    _Set_insert(filtered, en);
                  }
            ...
            _Map_insert(module_hirs, key, new hir$HProgram(hir.decls, hir.derived_impls, hir.boxed_vars, hir.static_dicts, filtered));
...
function resolve_extern_fn_imports(ast, key, graph, exports_map, imports_map, import_lines) {
  const __ring_iter_50 = __List_Iterable.iter(ast.decls);
  while (true) {
    ...
    __ring_match48: {
      ...
      if (__ring_m48._tag === "ExternFn") {
        const name = __ring_m48.name;
        if ((!_Map_contains_key(imports_map, name))) {
          let sorted_exports = _Map_entries(exports_map);
          sorted_exports.sort((function(__ring_a0, __ring_a1) { return hir$compare_by_first(__ring_a0, __ring_a1); }));
          const __ring_iter_51 = __List_Iterable.iter(sorted_exports);
          while (true) {
            const __ring_next_51 = __ListIterator_Iterator.next(__ring_iter_51);
            if (__ring_next_51._tag === "none") break;
            const eentry = __ring_next_51._0;
            ...
            if ((((other_key !== key) ? _Map_contains_key(other_exports.values, name) : false) ? (!_Set_contains(other_exports.extern_values, name, __Str_Eq)) : false)) {
              __ring_match49: {
                const __ring_m49 = _Map_get(graph.modules, other_key);
                if (__ring_m49._tag === "some") {
                  const other_mod = __ring_m49._0;
...
function compile_project_esm(entry_file, out_dir, error_format, __ring_ev_fail) {
  __ring_match50: {
    const __ring_m50 = compile_phases(entry_file, error_format, __ring_ev_fail);
    if (__ring_m50._tag === "none") {
      return new EsmCompileResult(false, "");
      break __ring_match50;
    }
    if (__ring_m50._tag === "some") {
      const phases = __ring_m50._0;
      const entry_key = resolver$module_key(phases.graph.entry.path_segments);
      const runtime_path = path_join(out_dir, "__ring_runtime.js");
      write_file(runtime_path, runtime$runtime_esm_code());
      let entry_js_path = "";
      const __ring_iter_52 = __List_Iterable.iter(phases.graph.topo_order);
      while (true) {
        const __ring_next_52 = __ListIterator_Iterator.next(__ring_iter_52);
        if (__ring_next_52._tag === "none") break;
        const key = __ring_next_52._0;
        __ring_match51: {
          const __ring_m51 = [_Map_get(phases.graph.modules, key), _Map_get(phases.module_hirs, key), _Map_get(phases.module_asts, key)];
          if (Array.isArray(__ring_m51) && __ring_m51.length === 3 && __ring_m51[0]._tag === "some" && __ring_m51[1]._tag === "some" && __ring_m51[2]._tag === "some") {
            const mod_ = __ring_m51[0]._0; const hir = __ring_m51[1]._0; const ast = __ring_m51[2]._0;
...
function compile_project_llvm(entry_file, output_path, error_format, __ring_ev_fail, __ring_ev_io) {
  __ring_match52: {
    const __ring_m52 = compile_phases(entry_file, error_format, __ring_ev_fail);
    if (__ring_m52._tag === "none") {
      return new LlvmCompileResult(false);
      break __ring_match52;
    }
    if (__ring_m52._tag === "some") {
      const phases = __ring_m52._0;
      const entry_key = resolver$module_key(phases.graph.entry.path_segments);
      let modules = [];
      let entry_prefix = "";
      const __ring_iter_54 = __List_Iterable.iter(phases.graph.topo_order);
      while (true) {
        const __ring_next_54 = __ListIterator_Iterator.next(__ring_iter_54);
        if (__ring_next_54._tag === "none") break;
        const key = __ring_next_54._0;
        __ring_match53: {
          const __ring_m53 = [_Map_get(phases.graph.modules, key), _Map_get(phases.module_hirs, key), _Map_get(phases.module_asts, key)];
          if (Array.isArray(__ring_m53) && __ring_m53.length === 3 && __ring_m53[0]._tag === "some" && __ring_m53[1]._tag === "some" && __ring_m53[2]._tag === "some") {
            const mod_ = __ring_m53[0]._0; const hir = __ring_m53[1]._0; const ast = __ring_m53[2]._0;
            const prefix = resolver$module_prefix(mod_.path_segments);
          ...
          if (Array.isArray(__ring_m53) && __ring_m53.length === 3 && __ring_m53[0]._tag === "some" && __ring_m53[1]._tag === "some" && __ring_m53[2]._tag === "none") {
            const mod_ = __ring_m53[0]._0; const hir = __ring_m53[1]._0;
            const prefix = resolver$module_prefix(mod_.path_segments);
            const rc_hir = perceus$perceus_transform(hir);
...
function verify_project_rc(entry_file, mutate, strict, error_format, __ring_ev_fail) {
  __ring_match54: {
    const __ring_m54 = compile_phases(entry_file, error_format, __ring_ev_fail);
    if (__ring_m54._tag === "none") {
      return new RcProjectVerifyResult(false, 0, 0, "");
      break __ring_match54;
    }
    if (__ring_m54._tag === "some") {
      const phases = __ring_m54._0;
      let all = [];
      const __ring_iter_55 = __List_Iterable.iter(phases.graph.topo_order);
      while (true) {
        const __ring_next_55 = __ListIterator_Iterator.next(__ring_iter_55);
        if (__ring_next_55._tag === "none") break;
        const key = __ring_next_55._0;
        __ring_match55: {
          const __ring_m55 = _Map_get(phases.module_hirs, key);
          if (__ring_m55._tag === "some") {
            const hir = __ring_m55._0;
            const rc_hir = perceus$perceus_transform_mutated(hir, mutate);
            const __ring_iter_56 = __List_Iterable.iter(verify_rc$verify_rc_program(rc_hir));
            while (true) {
