  ...
  __ring_match15: {
    ...
    if (__ring_m15._tag === "some") {
      ...
      while (true) {
        ...
        __ring_match16: {
          const __ring_m16 = [_Map_get(phases.graph.modules, key), _Map_get(phases.module_hirs, key), _Map_get(phases.module_asts, key)];
          if (Array.isArray(__ring_m16) && __ring_m16.length === 3 && __ring_m16[0]._tag === "some" && __ring_m16[1]._tag === "some" && __ring_m16[2]._tag === "some") {
            const mod_ = __ring_m16[0]._0; const hir = __ring_m16[1]._0; const ast = __ring_m16[2]._0;
...
function build_esm_import_lines(graph, exports_map, key) {
  ...
  while (true) {
    ...
    const dk = __ring_next_9._0;
    __ring_match17: {
      const __ring_m17 = [_Map_get(exports_map, dk), _Map_get(graph.modules, dk)];
      if (Array.isArray(__ring_m17) && __ring_m17.length === 2 && __ring_m17[0]._tag === "some" && __ring_m17[1]._tag === "some") {
        const dep_exports = __ring_m17[0]._0; const dep_mod = __ring_m17[1]._0;
...
function build_dep_import_pairs(dep_exports, dep_prefix) {
  ...
  const __ring_iter_10 = __List_Iterable.iter(_Map_entries(dep_exports.types));
  while (true) {
    const __ring_next_10 = __ListIterator_Iterator.next(__ring_iter_10);
    if (__ring_next_10._tag === "none") break;
    const tentry = __ring_next_10._0;
    const __ring_dt0 = tentry;
    const tdef = __ring_dt0[1];
    __ring_match18: {
      const __ring_m18 = tdef;
      if (__ring_m18._tag === "EnumDef_") {
  ...
  const __ring_iter_12 = __List_Iterable.iter(_Map_entries(dep_exports.values));
  while (true) {
    const __ring_next_12 = __ListIterator_Iterator.next(__ring_iter_12);
    if (__ring_next_12._tag === "none") break;
    const ventry = __ring_next_12._0;
  ...
  const __ring_iter_13 = __List_Iterable.iter(_Map_entries(dep_exports.types));
  while (true) {
    const __ring_next_13 = __ListIterator_Iterator.next(__ring_iter_13);
    if (__ring_next_13._tag === "none") break;
    const tentry = __ring_next_13._0;
  ...
  const __ring_iter_15 = __List_Iterable.iter(dep_exports.trait_impls);
  while (true) {
...
function register_use_aliases(ast, imports_map) {
  const __ring_iter_18 = __List_Iterable.iter(ast.uses);
  while (true) {
        ...
        while (true) {
          ...
          __ring_match21: {
            ...
            if (__ring_m21._tag === "some") {
              const alias = __ring_m21._0;
              __ring_match22: {
                const __ring_m22 = _Map_get(imports_map, item.name);
...
function resolve_extern_fn_imports(ast, key, graph, exports_map, imports_map, import_lines) {
  const __ring_iter_20 = __List_Iterable.iter(ast.decls);
  while (true) {
        ...
        if ((!_Map_contains_key(imports_map, name))) {
          ...
          while (true) {
            ...
            if ((((other_key !== key) && _Map_contains_key(other_exports.values, name)) && (!_Set_contains(other_exports.extern_values, name, __Str_Eq)))) {
              __ring_match24: {
                const __ring_m24 = _Map_get(graph.modules, other_key);
                if (__ring_m24._tag === "some") {
                  const other_mod = __ring_m24._0;
...
function build_esm_export_names(ast, hir) {
  ...
  const __ring_iter_23 = __List_Iterable.iter(ast.decls);
  while (true) {
  ...
  while (true) {
    ...
    __ring_match25: {
      ...
      if (__ring_m25._tag === "Struct") {
        const dn = __ring_m25.name; const dp = __ring_m25.is_pub;
        if (((dn === type_name) && dp)) {
          result = true;
        }
          ...
          while (true) {
            ...
            __ring_match26: {
              ...
              if (__ring_m26._tag === "Enum") {
                const en = __ring_m26.name; const ep = __ring_m26.is_pub;
                if (((en === type_name) && ep)) {
                  result = true;
                }
                break __ring_match26;
...
function collect_pub_decl_exports(decl, export_names) {
  __ring_match27: {
    ...
    if (__ring_m27._tag === "Fn") {
      const name = __ring_m27.name; const is_pub = __ring_m27.is_pub;
      if (is_pub) {
    ...
    if (__ring_m27._tag === "Enum") {
      const name = __ring_m27.name; const is_pub = __ring_m27.is_pub; const variants = __ring_m27.variants;
      if (is_pub) {
    ...
    if (__ring_m27._tag === "ModBlock") {
      ...
      if (mpub) {
        ...
        while (true) {
          ...
          const subdecl = __ring_next_28._0;
...
function collect_impl_exports(decl, all_decls, export_names) {
  __ring_match28: {
    ...
    if (__ring_m28._tag === "Impl") {
      const target_type = __ring_m28.target_type; const impl_trait = __ring_m28.trait_name; const methods = __ring_m28.methods;
      if (is_pub_type_in_decls(target_type, all_decls)) {
        __ring_match29: {
          const __ring_m29 = impl_trait;
          if (__ring_m29._tag === "some") {
            const tn = __ring_m29._0;
    ...
    if (__ring_m28._tag === "ModBlock") {
      const mod_name = __ring_m28.name; const mod_decls = __ring_m28.decls; const mpub = __ring_m28.is_pub;
      if (mpub) {
...
function collect_named_reexports(names, src_exports, src_prefix, export_names, reexport_aliases) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match33: {
      const __ring_m33 = _Map_get(src_exports.types, item.name);
      if (__ring_m33._tag === "some") {
        const tdef = __ring_m33._0;
        __ring_match34: {
          const __ring_m34 = tdef;
          if (__ring_m34._tag === "EnumDef_") {
            const edef = __ring_m34._0;
            const __ring_iter_33 = __List_Iterable.iter(edef.variants);
            while (true) {
...
function collect_module_reexports(src_exports, src_prefix, export_names, reexport_aliases) {
  const __ring_iter_34 = __List_Iterable.iter(_Map_entries(src_exports.values));
  while (true) {
  ...
  const __ring_iter_35 = __List_Iterable.iter(_Map_entries(src_exports.types));
  while (true) {
    ...
    List_push(export_names, local_js);
    __ring_match35: {
      const __ring_m35 = tdef;
      if (__ring_m35._tag === "EnumDef_") {
        const edef = __ring_m35._0;
...
function build_imports_map(graph, exports_map, key) {
  ...
  __ring_match36: {
    const __ring_m36 = _Map_get(graph.dependencies, key);
    if (__ring_m36._tag === "some") {
      const deps = __ring_m36._0;
      const __ring_iter_37 = __List_Iterable.iter(deps);
      while (true) {
        const __ring_next_37 = __ListIterator_Iterator.next(__ring_iter_37);
        if (__ring_next_37._tag === "none") break;
        const dk = __ring_next_37._0;
        __ring_match37: {
          const __ring_m37 = _Map_get(exports_map, dk);
          if (__ring_m37._tag === "some") {
            const dep_exports = __ring_m37._0;
            const dep_prefix = dep_exports.module_prefix;
            let bare_variants = set_new();
            const __ring_iter_38 = __List_Iterable.iter(_Map_entries(dep_exports.types));
            while (true) {
              const __ring_next_38 = __ListIterator_Iterator.next(__ring_iter_38);
              if (__ring_next_38._tag === "none") break;
              const tentry = __ring_next_38._0;
              const __ring_dt7 = tentry;
              const tdef = __ring_dt7[1];
              __ring_match38: {
                const __ring_m38 = tdef;
                if (__ring_m38._tag === "EnumDef_") {
                  const edef = __ring_m38._0;
                  const __ring_iter_39 = __List_Iterable.iter(edef.variants);
                  while (true) {
            ...
            const __ring_iter_40 = __List_Iterable.iter(_Map_entries(dep_exports.values));
            while (true) {
            ...
            const __ring_iter_41 = __List_Iterable.iter(_Map_entries(dep_exports.types));
            while (true) {
              ...
              _Map_insert(imports_map, name, `${dep_prefix}$${si}`);
              __ring_match39: {
                const __ring_m39 = type_def;
                if (__ring_m39._tag === "EnumDef_") {
                  const edef = __ring_m39._0;
                  const __ring_iter_42 = __List_Iterable.iter(edef.variants);
                  while (true) {
      ...
      while (true) {
        ...
        __ring_match43: {
          ...
          if (__ring_m43._tag === "some") {
            ...
            const dep_prefix = dep_exports.module_prefix;
            const __ring_iter_47 = __List_Iterable.iter(_Map_entries(dep_exports.impl_methods));
            while (true) {
...
export { CompileProjectResult, EsmCompileResult, compile_project, LlvmCompileResult, compile_project_llvm, compile_project_esm, __CompileProjectResult_Eq, __EsmCompileResult_Eq, __LlvmCompileResult_Eq, __CompileProjectResult_Clone, __EsmCompileResult_Clone, __LlvmCompileResult_Clone, __CompileProjectResult_Ord, __EsmCompileResult_Ord, __LlvmCompileResult_Ord, __CompileProjectResult_Debug, __EsmCompileResult_Debug, __LlvmCompileResult_Debug };