...
import { register_decl_public as infer_register$register_decl_public, register_decls_two_phase as infer_register$register_decls_two_phase, resolve_effect_expr as infer_register$resolve_effect_expr, resolve_declared_effects as infer_register$resolve_declared_effects } from "./infer_register.js";
  ...
  for (const method of methods) {
    __ring_match3: {
      ...
      if (__ring_m3._tag === "ExternFn") {
        const name = __ring_m3.name; const mtps = __ring_m3.type_params; const params = __ring_m3.params; const return_type = __ring_m3.return_type; const declared_effects = __ring_m3.declared_effects; const is_pub = __ring_m3.is_pub; const mspan = __ring_m3.span;
      ...
      if (__ring_m3._tag === "Fn") {
        const name = __ring_m3.name; const mtps = __ring_m3.type_params; const params = __ring_m3.params; const return_type = __ring_m3.return_type; const declared_effects = __ring_m3.declared_effects; const body = __ring_m3.body; const is_pub = __ring_m3.is_pub; const mspan = __ring_m3.span;
...
function effects_match_kind(a, b) {
  __ring_match17: {
    ...
    if (__ring_m17._tag === "CustomEffect") {
      const na = __ring_m17.name;
      __ring_match21: {
        const __ring_m21 = b;
        if (__ring_m21._tag === "CustomEffect") {
          const nb = __ring_m21.name;
          return (na === nb);
...
function check_one_decl(ctx, decl, hdecls, __ring_ev_fail) {
  ...
  __ring_match27: {
    ...
    if (__ring_m27._tag === "Fn") {
      const name = __ring_m27.name; const effects = __ring_m27.effects;
