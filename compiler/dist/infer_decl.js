  ...
  while (true) {
    ...
    __ring_match64: {
      ...
      if (__ring_m64._tag === "Fn") {
        ...
        const qual_key = `${target_type}_${name}`;
        __ring_match65: {
          const __ring_m65 = _Map_get(ctx.fn_mut_params, name);
          if (__ring_m65._tag === "some") {
            const flags = __ring_m65._0;
            _Map_insert(ctx.fn_mut_params, qual_key, flags);
