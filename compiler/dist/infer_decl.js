...
import { collect_registered_fn_names as scc$collect_registered_fn_names, build_call_graph as scc$build_call_graph, tarjan_scc as scc$tarjan_scc } from "./scc.js";
...
function check_struct_decl(ctx, name, type_params, is_pub, span, __ring_ev_fail) {
  ...
  let hfields = [];
  const __ring_iter_2 = __List_Iterable.iter(def.fields);
  while (true) {
...
function check_enum_decl(ctx, name, type_params, is_pub, span, __ring_ev_fail) {
  ...
  let hvariants = [];
  const __ring_iter_3 = __List_Iterable.iter(def.variants);
  while (true) {
...
function check_effect_decl(ctx, name, type_params, ast_ops, is_pub, span, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match6: {
      const __ring_m6 = ast_op_opt;
      if (__ring_m6._tag === "some") {
        const ast_op = __ring_m6._0;
        __ring_match7: {
          const __ring_m7 = ast_op.body;
          if (__ring_m7._tag === "some") {
            const body_expr = __ring_m7._0;
            env$TypeEnv_push_scope(ctx.env);
            const __ring_iter_6 = __List_Iterable.iter(op_params);
            while (true) {
              const __ring_next_6 = __ListIterator_Iterator.next(__ring_iter_6);
              if (__ring_next_6._tag === "none") break;
              const p = __ring_next_6._0;
...
function check_fn_body(ctx, type_params, hparams, expected_ret, body, saved_tp_scope, span, __ring_ev_fail) {
  ...
  const __ring_iter_11 = __List_Iterable.iter(type_params);
  while (true) {
    const __ring_next_11 = __ListIterator_Iterator.next(__ring_iter_11);
    if (__ring_next_11._tag === "none") break;
    const tp = __ring_next_11._0;
    __ring_match11: {
      const __ring_m11 = _Map_get(ctx.type_param_scope, tp.name);
      if (__ring_m11._tag === "some") {
        const tv = __ring_m11._0;
        __ring_match12: {
          const __ring_m12 = tv;
  ...
  const __ring_iter_12 = __List_Iterable.iter(type_params);
  while (true) {
    const __ring_next_12 = __ListIterator_Iterator.next(__ring_iter_12);
    if (__ring_next_12._tag === "none") break;
    const tp = __ring_next_12._0;
    _Set_insert(declared_names, tp.name);
  }
  const __ring_iter_13 = __List_Iterable.iter(_Map_entries(ctx.type_param_scope));
  while (true) {
...
function check_fn_decl(ctx, name, type_params, params, return_type, declared_effects, body, is_pub, span, self_type, __ring_ev_fail) {
  ...
  let hparams = [];
  const __ring_iter_22 = __List_Iterable.iter(params);
  while (true) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match20: {
      const __ring_m20 = param_scheme;
      if (__ring_m20._tag === "some") {
        const ps = __ring_m20._0;
        __ring_match21: {
          const __ring_m21 = ps.def_id;
  ...
  const __ring_iter_23 = __List_Iterable.iter(inferred_effects.effects);
  while (true) {
    const __ring_next_23 = __ListIterator_Iterator.next(__ring_iter_23);
    if (__ring_next_23._tag === "none") break;
    const inferred_eff = __ring_next_23._0;
    let found = false;
    const __ring_iter_24 = __List_Iterable.iter(declared_row.effects);
    while (true) {
      const __ring_next_24 = __ListIterator_Iterator.next(__ring_iter_24);
      if (__ring_next_24._tag === "none") break;
      const declared_eff = __ring_next_24._0;
      if (types$effects_match_kind(inferred_eff, declared_eff)) {
        found = true;
        __ring_match22: {
          const __ring_m22 = [inferred_eff, declared_eff];
          if (Array.isArray(__ring_m22) && __ring_m22.length === 2 && __ring_m22[0]._tag === "FailEffect" && __ring_m22[1]._tag === "FailEffect") {
            const ie = __ring_m22[0].error_type; const de = __ring_m22[1].error_type;
            ctx.subst = infer_ctx$unify_at(ctx.sink, ctx.env, ie, de, ctx.subst, span);
            break __ring_match22;
          }
          if (Array.isArray(__ring_m22) && __ring_m22.length === 2 && __ring_m22[0]._tag === "MutEffect" && __ring_m22[1]._tag === "MutEffect") {
            const is = __ring_m22[0].state_type; const ds = __ring_m22[1].state_type;
            ctx.subst = infer_ctx$unify_at(ctx.sink, ctx.env, is, ds, ctx.subst, span);
            break __ring_match22;
          }
          if (Array.isArray(__ring_m22) && __ring_m22.length === 2 && __ring_m22[0]._tag === "CustomEffect" && __ring_m22[1]._tag === "CustomEffect") {
            const ia = __ring_m22[0].type_args; const da = __ring_m22[1].type_args;
            let i = 0;
  ...
  if ((name === "main")) {
    const __ring_iter_25 = __List_Iterable.iter(final_effects.effects);
    while (true) {
      const __ring_next_25 = __ListIterator_Iterator.next(__ring_iter_25);
      if (__ring_next_25._tag === "none") break;
      const eff = __ring_next_25._0;
      __ring_match23: {
        const __ring_m23 = eff;
        if (__ring_m23._tag === "CustomEffect") {
          const eff_name = __ring_m23.name;
          let skip = false;
          __ring_match24: {
            const __ring_m24 = _Map_get(ctx.env.types.effects, eff_name);
  ...
  while (true) {
    ...
    if (((p.name === "self") ? true : (!p.is_mutable))) {
      ...
      __ring_match26: {
        const __ring_m26 = List_get(final_params, fi);
...
function update_impl_method_effects(ctx, target_type, method_name, effects) {
  __ring_match27: {
    const __ring_m27 = _Map_get(ctx.env.trait_reg.impl_methods, target_type);
    if (__ring_m27._tag === "some") {
      const methods_map = __ring_m27._0;
      __ring_match28: {
        const __ring_m28 = _Map_get(methods_map, method_name);
        if (__ring_m28._tag === "some") {
          const scheme = __ring_m28._0;
          __ring_match29: {
            const __ring_m29 = scheme.ty;
            if (__ring_m29._tag === "FnType") {
              const params = __ring_m29.params; const return_type = __ring_m29.return_type;
...
function check_impl_decl(ctx, target_type, type_params, trait_name, methods, span, __ring_ev_fail) {
  ...
  let hassoc_types = [];
  const __ring_iter_33 = __List_Iterable.iter(methods);
  while (true) {
    const __ring_next_33 = __ListIterator_Iterator.next(__ring_iter_33);
    if (__ring_next_33._tag === "none") break;
    const method = __ring_next_33._0;
    __ring_match35: {
      const __ring_m35 = method;
      if (__ring_m35._tag === "AssocType") {
        const aname = __ring_m35.name; const abounds = __ring_m35.bounds; const avalue = __ring_m35.value;
        let bound_names = [];
        const __ring_iter_34 = __List_Iterable.iter(abounds);
        while (true) {
  ...
  __match_fail(__ring_m);
        ...
        __ring_match36: {
          const __ring_m36 = concrete;
          if (__ring_m36._tag === "some") {
            const ct = __ring_m36._0;
  ...
  let hmethods = [];
  const __ring_iter_35 = __List_Iterable.iter(methods);
  while (true) {
    const __ring_next_35 = __ListIterator_Iterator.next(__ring_iter_35);
    if (__ring_next_35._tag === "none") break;
    const method = __ring_next_35._0;
    __ring_match37: {
      const __ring_m37 = method;
      if (__ring_m37._tag === "ExternFn") {
        const name = __ring_m37.name; const mtps = __ring_m37.type_params; const params = __ring_m37.params; const return_type = __ring_m37.return_type; const declared_effects = __ring_m37.declared_effects; const is_pub = __ring_m37.is_pub; const mspan = __ring_m37.span;
      ...
      if (__ring_m37._tag === "Fn") {
        const name = __ring_m37.name; const mtps = __ring_m37.type_params; const params = __ring_m37.params; const return_type = __ring_m37.return_type; const declared_effects = __ring_m37.declared_effects; const body = __ring_m37.body; const is_pub = __ring_m37.is_pub; const mspan = __ring_m37.span;
        ...
        __ring_match38: {
          const __ring_m38 = hdecl;
          if (__ring_m38._tag === "Fn") {
            const mname = __ring_m38.name; const inferred_effects = __ring_m38.effects;
      ...
      if (__ring_m37._tag === "Delegate") {
        break __ring_match37;
      }
      if (__ring_m37._tag === "AssocType") {
        break __ring_match37;
      }
      break __ring_match37;
    }
...
function check_trait_default_body(ctx, trait_name, self_var, hparams, body) {
  ...
  __ring_match40: {
    const __ring_m40 = _Map_get(ctx.env.trait_reg.traits, trait_name);
    if (__ring_m40._tag === "some") {
      const tdef = __ring_m40._0;
      const __ring_iter_37 = __List_Iterable.iter(tdef.assoc_types);
      while (true) {
        const __ring_next_37 = __ListIterator_Iterator.next(__ring_iter_37);
        if (__ring_next_37._tag === "none") break;
        const atdef = __ring_next_37._0;
        __ring_match41: {
          const __ring_m41 = _Map_get(ctx.type_param_scope, atdef.name);
          if (__ring_m41._tag === "some") {
            const at_ty = __ring_m41._0;
  ...
  const __ring_iter_38 = __List_Iterable.iter(hparams);
  while (true) {
    ...
    if (p.is_mutable) {
      __ring_match42: {
        const __ring_m42 = env$TypeEnv_lookup(ctx.env, p.name);
        if (__ring_m42._tag === "some") {
          const ps = __ring_m42._0;
          __ring_match43: {
            const __ring_m43 = ps.def_id;
...
function check_trait_decl(ctx, name, type_params, ast_methods, is_pub, span, __ring_ev_fail) {
  ...
  if ((List_len(trait_def.methods) > 0)) {
    __ring_match44: {
      const __ring_m44 = List_first(trait_def.methods);
      if (__ring_m44._tag === "some") {
        const first_method = __ring_m44._0;
        __ring_match45: {
          const __ring_m45 = first_method.ty;
          if (__ring_m45._tag === "FnType") {
            const fps = __ring_m45.params;
            if ((List_len(fps) > 0)) {
              __ring_match46: {
                const __ring_m46 = List_first(fps);
                if (__ring_m46._tag === "some") {
                  const fp = __ring_m46._0;
                  self_var = fp;
  ...
  let hmethods = [];
  const __ring_iter_39 = __List_Iterable.iter(trait_def.methods);
  while (true) {
  ...
  __match_fail(__ring_m);
    ...
    if (m.has_default) {
      __ring_match47: {
        const __ring_m47 = ast_method;
        if (__ring_m47._tag === "some") {
          const am = __ring_m47._0;
          __ring_match48: {
            const __ring_m48 = am;
            if (__ring_m48._tag === "Fn") {
              const abody = __ring_m48.body;
...
function check_const_decl(ctx, name, type_annotation, init, is_pub, span, __ring_ev_fail) {
  ...
  __ring_match49: {
    const __ring_m49 = type_annotation;
    if (__ring_m49._tag === "some") {
      const texpr = __ring_m49._0;
  ...
  __ring_match50: {
    const __ring_m50 = expected_ty;
    if (__ring_m50._tag === "some") {
      const ann_ty = __ring_m50._0;
...
function resolve_mod_uses(ctx, uses) {
  ...
  while (true) {
    ...
    __ring_match51: {
      ...
      if (__ring_m51._tag === "some") {
        const prefix = __ring_m51._0;
        __ring_match52: {
          const __ring_m52 = use_decl.imports;
          if (__ring_m52._tag === "NamedItems") {
            const names = __ring_m52.names;
            const __ring_iter_43 = __List_Iterable.iter(names);
            while (true) {
              const __ring_next_43 = __ListIterator_Iterator.next(__ring_iter_43);
              if (__ring_next_43._tag === "none") break;
              const item = __ring_next_43._0;
  ...
  __match_fail(__ring_m);
              ...
              __ring_match53: {
                const __ring_m53 = env$TypeEnv_lookup(ctx.env, qualified_name);
          ...
          if (__ring_m52._tag === "Module") {
            if ((name_start_idx < List_len(segments))) {
              ...
              __ring_match54: {
                const __ring_m54 = env$TypeEnv_lookup(ctx.env, qualified_name);
                if (__ring_m54._tag === "some") {
                  const scheme = __ring_m54._0;
...
function check_capability(ctx, decl, cap, mod_span) {
  __ring_match55: {
    const __ring_m55 = decl;
    if (__ring_m55._tag === "Fn") {
      const name = __ring_m55.name; const effects = __ring_m55.effects; const span = __ring_m55.span;
      return check_effects_capability(ctx, name, effects, cap, span);
      break __ring_match55;
    }
    if (__ring_m55._tag === "Impl") {
      const methods = __ring_m55.methods;
      ...
      while (true) {
        ...
        __ring_match56: {
          ...
          if (__ring_m56._tag === "Fn") {
            const name = __ring_m56.name; const effects = __ring_m56.effects; const span = __ring_m56.span;
...
function expand_delegate_impls(ctx, target_type, type_params, field, trait_names, span) {
  ...
  __ring_match60: {
    const __ring_m60 = _Map_get(ctx.env.types.structs, target_type);
    if (__ring_m60._tag === "some") {
      const def = __ring_m60._0;
      return types$Type_StructType(def.name, impl_tp_types, def.fields);
      break __ring_match60;
    }
    if (__ring_m60._tag === "none") {
      __ring_match61: {
        const __ring_m61 = _Map_get(ctx.env.types.enums, target_type);
  ...
  __match_fail(__ring_m);
          ...
          const __ring_iter_50 = __List_Iterable.iter(all_traits);
          while (true) {
            const __ring_next_50 = __ListIterator_Iterator.next(__ring_iter_50);
            if (__ring_next_50._tag === "none") break;
            const tname = __ring_next_50._0;
            __ring_match62: {
              const __ring_m62 = _Map_get(ctx.env.trait_reg.traits, tname);
              if (__ring_m62._tag === "none") {
                break __ring_match62;
              }
              if (__ring_m62._tag === "some") {
                const trait_def = __ring_m62._0;
                let field_assoc_map = map_new();
                __ring_match63: {
                  const __ring_m63 = field_type_name;
                  if (__ring_m63._tag === "some") {
                    const ftn = __ring_m63._0;
                    __ring_match64: {
                      const __ring_m64 = env$find_impl(ctx.env.trait_reg, ftn, tname);
                      if (__ring_m64._tag === "some") {
                        const field_impl = __ring_m64._0;
                ...
                let trait_hmethods = [];
                const __ring_iter_51 = __List_Iterable.iter(trait_def.methods);
                while (true) {
  ...
  __match_fail(__ring_m);
                  ...
                  __ring_match65: {
                    const __ring_m65 = tm.ty;
                    if (__ring_m65._tag === "FnType") {
                      const trait_params = __ring_m65.params; const trait_ret_ty = __ring_m65.return_type; const trait_eff = __ring_m65.effects;
  ...
  return Option_none;
                        ...
                        __ring_match66: {
                          const __ring_m66 = ftn;
                          if (__ring_m66._tag === "some") {
                            const field_tn = __ring_m66._0;
                            let has_explicit = false;
                            __ring_match67: {
                              const __ring_m67 = _Map_get(ctx.env.trait_reg.impl_methods, field_tn);
                              if (__ring_m67._tag === "some") {
                                const methods_map = __ring_m67._0;
  ...
  return hir$HExpr_Call(method_access, forward_args, [], [], Option_none, ret_ty, eff, span);
                ...
                let h_assoc_types = [];
                const __ring_iter_52 = __List_Iterable.iter(_Map_entries(field_assoc_map));
                while (true) {
...
function check_sig_decl(ctx, name, members, is_pub, span) {
  let hmembers = [];
  __ring_match68: {
    const __ring_m68 = _Map_get(ctx.env.types.sigs, name);
    if (__ring_m68._tag === "some") {
      const sig_def = __ring_m68._0;
      const __ring_iter_53 = __List_Iterable.iter(members);
      while (true) {
        ...
        __ring_match69: {
          const __ring_m69 = _Map_get(sig_def.members, m.name);
          if (__ring_m69._tag === "some") {
            const scheme = __ring_m69._0;
...
function check_mod_decl(ctx, mod_name, uses, decls, required_effects, is_pub, span, __ring_ev_fail) {
  ...
  __ring_match70: {
    const __ring_m70 = required_effects;
    if (__ring_m70._tag === "some") {
      const req_effs = __ring_m70._0;
  ...
  while (true) {
    ...
    __ring_match71: {
      const __ring_m71 = result;
      if (__ring_m71._tag === "some") {
        const hd = __ring_m71._0;
        __ring_match72: {
          const __ring_m72 = hd;
        ...
        __ring_match73: {
          const __ring_m73 = cap_row;
          if (__ring_m73._tag === "some") {
            const cap = __ring_m73._0;
    ...
    __ring_match74: {
      const __ring_m74 = prefixed;
      if (__ring_m74._tag === "Impl") {
        const target_type = __ring_m74.target_type; const impl_tps = __ring_m74.type_params; const methods = __ring_m74.methods; const impl_span = __ring_m74.span;
        const __ring_iter_55 = __List_Iterable.iter(methods);
        while (true) {
          ...
          __ring_match75: {
            const __ring_m75 = m;
            if (__ring_m75._tag === "Delegate") {
              const field = __ring_m75.field; const trait_names = __ring_m75.trait_names; const dspan = __ring_m75.span;
              const delegate_impls = expand_delegate_impls(ctx, target_type, impl_tps, field, trait_names, dspan);
              const __ring_iter_56 = __List_Iterable.iter(delegate_impls);
              while (true) {
                const __ring_next_56 = __ListIterator_Iterator.next(__ring_iter_56);
                if (__ring_next_56._tag === "none") break;
                const di = __ring_next_56._0;
                __ring_match76: {
                  const __ring_m76 = cap_row;
                  if (__ring_m76._tag === "some") {
                    const cap = __ring_m76._0;
...
function check_decl(ctx, decl, __ring_ev_fail) {
  __ring_match77: {
    ...
    if (__ring_m77._tag === "Struct") {
      const name = __ring_m77.name; const type_params = __ring_m77.type_params; const is_pub = __ring_m77.is_pub; const span = __ring_m77.span;
    ...
    if (__ring_m77._tag === "Effect") {
      const name = __ring_m77.name; const type_params = __ring_m77.type_params; const ops = __ring_m77.ops; const is_pub = __ring_m77.is_pub; const span = __ring_m77.span;
      return check_effect_decl(ctx, name, type_params, ops, is_pub, span, __ring_ev_fail);
      break __ring_match77;
    }
    if (__ring_m77._tag === "Impl") {
      const target_type = __ring_m77.target_type; const type_params = __ring_m77.type_params; const trait_name = __ring_m77.trait_name; const methods = __ring_m77.methods; const span = __ring_m77.span;
      return check_impl_decl(ctx, target_type, type_params, trait_name, methods, span, __ring_ev_fail);
      break __ring_match77;
    }
    if (__ring_m77._tag === "Fn") {
      const name = __ring_m77.name; const type_params = __ring_m77.type_params; const params = __ring_m77.params; const return_type = __ring_m77.return_type; const declared_effects = __ring_m77.declared_effects; const body = __ring_m77.body; const is_pub = __ring_m77.is_pub; const span = __ring_m77.span;
    ...
    if (__ring_m77._tag === "Test") {
      const description = __ring_m77.description; const body = __ring_m77.body; const span = __ring_m77.span;
      return check_test_decl(ctx, description, body, span, __ring_ev_fail);
      break __ring_match77;
    }
    if (__ring_m77._tag === "Trait") {
      const name = __ring_m77.name; const type_params = __ring_m77.type_params; const methods = __ring_m77.methods; const is_pub = __ring_m77.is_pub; const span = __ring_m77.span;
      return check_trait_decl(ctx, name, type_params, methods, is_pub, span, __ring_ev_fail);
      break __ring_match77;
    }
    if (__ring_m77._tag === "ExternFn") {
      const name = __ring_m77.name; const type_params = __ring_m77.type_params; const params = __ring_m77.params; const return_type = __ring_m77.return_type; const declared_effects = __ring_m77.declared_effects; const is_pub = __ring_m77.is_pub; const span = __ring_m77.span;
    ...
    if (__ring_m77._tag === "TypeAlias") {
      const name = __ring_m77.name; const is_pub = __ring_m77.is_pub; const span = __ring_m77.span;
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m77._tag === "Const") {
      const name = __ring_m77.name; const type_annotation = __ring_m77.type_annotation; const init = __ring_m77.init; const is_pub = __ring_m77.is_pub; const span = __ring_m77.span;
      return check_const_decl(ctx, name, type_annotation, init, is_pub, span, __ring_ev_fail);
      break __ring_match77;
    }
    if (__ring_m77._tag === "ModBlock") {
      const name = __ring_m77.name; const uses = __ring_m77.uses; const decls = __ring_m77.decls; const required_effects = __ring_m77.required_effects; const is_pub = __ring_m77.is_pub; const span = __ring_m77.span;
      return check_mod_decl(ctx, name, uses, decls, required_effects, is_pub, span);
      break __ring_match77;
    }
    if (__ring_m77._tag === "Sig") {
      const name = __ring_m77.name; const members = __ring_m77.members; const is_pub = __ring_m77.is_pub; const span = __ring_m77.span;
      return check_sig_decl(ctx, name, members, is_pub, span);
      break __ring_match77;
    }
    if (__ring_m77._tag === "EffectAlias") {
      const name = __ring_m77.name; const is_pub = __ring_m77.is_pub; const span = __ring_m77.span;
      return hir$HDecl_TypeAlias(name, types$UNIT, is_pub, span);
      break __ring_match77;
    }
    if (__ring_m77._tag === "Delegate") {
      const span = __ring_m77.span;
      return hir$HDecl_TypeAlias("<delegate>", types$UNIT, false, span);
      break __ring_match77;
    }
    if (__ring_m77._tag === "AssocType") {
      const span = __ring_m77.span;
...
function check_one_decl(ctx, decl, hdecls, __ring_ev_fail) {
  ...
  __ring_match78: {
    ...
    if (__ring_m78._tag === "Fn") {
      const name = __ring_m78.name; const effects = __ring_m78.effects;
      if ((List_len(effects.effects) > 0)) {
        infer_ctx$update_fn_effects(ctx.env, name, effects);
      }
  ...
  let delegate_decls = [];
  __ring_match79: {
    const __ring_m79 = decl;
    if (__ring_m79._tag === "Impl") {
      const target_type = __ring_m79.target_type; const type_params = __ring_m79.type_params; const methods = __ring_m79.methods; const span = __ring_m79.span;
      ...
      while (true) {
        ...
        __ring_match80: {
          const __ring_m80 = m;
          if (__ring_m80._tag === "Delegate") {
            const field = __ring_m80.field; const trait_names = __ring_m80.trait_names; const dspan = __ring_m80.span;
            const delegate_impls = expand_delegate_impls(ctx, target_type, type_params, field, trait_names, dspan);
            const __ring_iter_58 = __List_Iterable.iter(delegate_impls);
            while (true) {
              const __ring_next_58 = __ListIterator_Iterator.next(__ring_iter_58);
              if (__ring_next_58._tag === "none") break;
              const di = __ring_next_58._0;
...
function build_var_mapping(check_ty, reg_ty, mapping) {
  __ring_match81: {
    const __ring_m81 = [check_ty, reg_ty];
    if (Array.isArray(__ring_m81) && __ring_m81.length === 2 && __ring_m81[0]._tag === "TypeVar") {
      const check_id = __ring_m81[0].id;
      if ((!_Map_contains_key(mapping, check_id))) {
        return _Map_insert(mapping, check_id, reg_ty);
      }
      break __ring_match81;
    }
    if (Array.isArray(__ring_m81) && __ring_m81.length === 2 && __ring_m81[0]._tag === "FnType" && __ring_m81[1]._tag === "FnType") {
      const cp = __ring_m81[0].params; const cr = __ring_m81[0].return_type; const rp = __ring_m81[1].params; const rr = __ring_m81[1].return_type;
      let i = 0;
      const __ring_iter_60 = __List_Iterable.iter(cp);
      while (true) {
        ...
        __ring_match82: {
          const __ring_m82 = List_get(rp, i);
          if (__ring_m82._tag === "some") {
            const r = __ring_m82._0;
    ...
    if (Array.isArray(__ring_m81) && __ring_m81.length === 2 && __ring_m81[0]._tag === "StructType" && __ring_m81[1]._tag === "StructType") {
      const ct = __ring_m81[0].type_params; const rt = __ring_m81[1].type_params;
      let i = 0;
      const __ring_iter_61 = __List_Iterable.iter(ct);
      while (true) {
        const __ring_next_61 = __ListIterator_Iterator.next(__ring_iter_61);
        if (__ring_next_61._tag === "none") break;
        const c = __ring_next_61._0;
        __ring_match83: {
          const __ring_m83 = List_get(rt, i);
          if (__ring_m83._tag === "some") {
            const r = __ring_m83._0;
            build_var_mapping(c, r, mapping);
    ...
    if (Array.isArray(__ring_m81) && __ring_m81.length === 2 && __ring_m81[0]._tag === "EnumType" && __ring_m81[1]._tag === "EnumType") {
      const ct = __ring_m81[0].type_params; const rt = __ring_m81[1].type_params;
      let i = 0;
      const __ring_iter_62 = __List_Iterable.iter(ct);
      while (true) {
        const __ring_next_62 = __ListIterator_Iterator.next(__ring_iter_62);
        if (__ring_next_62._tag === "none") break;
        const c = __ring_next_62._0;
        __ring_match84: {
          const __ring_m84 = List_get(rt, i);
          if (__ring_m84._tag === "some") {
            const r = __ring_m84._0;
            build_var_mapping(c, r, mapping);
    ...
    if (Array.isArray(__ring_m81) && __ring_m81.length === 2 && __ring_m81[0]._tag === "TupleType" && __ring_m81[1]._tag === "TupleType") {
      const ce = __ring_m81[0].elements; const re = __ring_m81[1].elements;
      let i = 0;
      const __ring_iter_63 = __List_Iterable.iter(ce);
      while (true) {
        ...
        __ring_match85: {
          const __ring_m85 = List_get(re, i);
          if (__ring_m85._tag === "some") {
            const r = __ring_m85._0;
            build_var_mapping(c, r, mapping);
...
function map_effect_row(row, mapping) {
  ...
  let mapped_effects = [];
  const __ring_iter_64 = __List_Iterable.iter(row.effects);
  while (true) {
    const __ring_next_64 = __ListIterator_Iterator.next(__ring_iter_64);
    if (__ring_next_64._tag === "none") break;
    const eff = __ring_next_64._0;
    __ring_match86: {
      const __ring_m86 = eff;
      if (__ring_m86._tag === "FailEffect") {
        const error_type = __ring_m86.error_type;
        List_push(mapped_effects, types$Effect_FailEffect(apply_var_mapping(error_type, mapping)));
        break __ring_match86;
      }
      if (__ring_m86._tag === "MutEffect") {
        const state_type = __ring_m86.state_type;
        List_push(mapped_effects, types$Effect_MutEffect(apply_var_mapping(state_type, mapping)));
        break __ring_match86;
      }
      if (__ring_m86._tag === "CustomEffect") {
        const name = __ring_m86.name; const type_args = __ring_m86.type_args;
        let mapped_args = [];
        const __ring_iter_65 = __List_Iterable.iter(type_args);
        while (true) {
...
function apply_var_mapping(ty, mapping) {
  __ring_match87: {
    ...
    if (__ring_m87._tag === "TypeVar") {
      ...
      __ring_match88: {
        const __ring_m88 = _Map_get(mapping, id);
        if (__ring_m88._tag === "some") {
          const mapped = __ring_m88._0;
          return mapped;
    ...
    if (__ring_m87._tag === "FnType") {
      const params = __ring_m87.params; const return_type = __ring_m87.return_type; const effects = __ring_m87.effects;
      let mapped_params = [];
    ...
    if (__ring_m87._tag === "EnumType") {
      const name = __ring_m87.name; const type_params = __ring_m87.type_params; const variants = __ring_m87.variants;
      let mapped_tps = [];
      const __ring_iter_68 = __List_Iterable.iter(type_params);
      while (true) {
        const __ring_next_68 = __ListIterator_Iterator.next(__ring_iter_68);
        if (__ring_next_68._tag === "none") break;
        const tp = __ring_next_68._0;
        List_push(mapped_tps, apply_var_mapping(tp, mapping));
      }
      return types$Type_EnumType(name, mapped_tps, variants);
      break __ring_match87;
    }
    if (__ring_m87._tag === "TupleType") {
      const elements = __ring_m87.elements;
      let mapped_els = [];
      const __ring_iter_69 = __List_Iterable.iter(elements);
      while (true) {
        const __ring_next_69 = __ListIterator_Iterator.next(__ring_iter_69);
        if (__ring_next_69._tag === "none") break;
        const e = __ring_next_69._0;
        List_push(mapped_els, apply_var_mapping(e, mapping));
      }
      return types$Type_TupleType(mapped_els);
      break __ring_match87;
    }
    if (__ring_m87._tag === "GenericType") {
      const base = __ring_m87.base; const args = __ring_m87.args;
      let mapped_args = [];
...
function rebind_fn_type(ctx, name, params, return_type, effects) {
  __ring_match89: {
    const __ring_m89 = env$TypeEnv_lookup(ctx.env, name);
    if (__ring_m89._tag === "some") {
      const scheme = __ring_m89._0;
      __ring_match90: {
        const __ring_m90 = scheme.ty;
        if (__ring_m90._tag === "FnType") {
          const reg_params = __ring_m90.params; const reg_ret = __ring_m90.return_type;
          ...
          while (true) {
            ...
            __ring_match91: {
              const __ring_m91 = List_get(reg_params, pi);
              if (__ring_m91._tag === "some") {
                const reg_p = __ring_m91._0;
...
function check_one_decl_with_rebind(ctx, decl, hdecls, __ring_ev_fail) {
  ...
  __ring_match92: {
    const __ring_m92 = hd;
    if (__ring_m92._tag === "Fn") {
      const name = __ring_m92.name; const params = __ring_m92.params; const return_type = __ring_m92.return_type; const effects = __ring_m92.effects;
      if ((List_len(effects.effects) > 0)) {
        infer_ctx$update_fn_effects(ctx.env, name, effects);
      }
    ...
    if (__ring_m92._tag === "Impl") {
      const methods = __ring_m92.methods;
      ...
      while (true) {
        ...
        const method = __ring_next_72._0;
        __ring_match93: {
          const __ring_m93 = method;
          if (__ring_m93._tag === "Fn") {
            const mname = __ring_m93.name; const mparams = __ring_m93.params; const mret = __ring_m93.return_type; const meff = __ring_m93.effects;
  ...
  let delegate_decls = [];
  __ring_match94: {
    const __ring_m94 = decl;
    if (__ring_m94._tag === "Impl") {
      const target_type = __ring_m94.target_type; const type_params = __ring_m94.type_params; const methods = __ring_m94.methods; const span = __ring_m94.span;
      ...
      while (true) {
        ...
        __ring_match95: {
          ...
          if (__ring_m95._tag === "Delegate") {
            ...
            const delegate_impls = expand_delegate_impls(ctx, target_type, type_params, field, trait_names, dspan);
            const __ring_iter_74 = __List_Iterable.iter(delegate_impls);
            while (true) {
...
function dfs_detect_cycle(ctx, name, state, path, effect_spans) {
  ...
  List_push(path, name);
  __ring_match97: {
    const __ring_m97 = _Map_get(ctx.effect_default_deps, name);
    if (__ring_m97._tag === "some") {
      const deps = __ring_m97._0;
      const __ring_iter_77 = __List_Iterable.iter(deps);
      while (true) {
        const __ring_next_77 = __ListIterator_Iterator.next(__ring_iter_77);
        if (__ring_next_77._tag === "none") break;
        const dep = __ring_next_77._0;
        __ring_match98: {
          const __ring_m98 = _Map_get(state, dep);
          if (__ring_m98._tag === "some") {
            const s = __ring_m98._0;
            if ((s === 1)) {
              let cycle_parts = [];
              let found_start = false;
              const __ring_iter_78 = __List_Iterable.iter(path);
              while (true) {
                const __ring_next_78 = __ListIterator_Iterator.next(__ring_iter_78);
                if (__ring_next_78._tag === "none") break;
                const p = __ring_next_78._0;
                if ((p === dep)) {
                  found_start = true;
                }
                if (found_start) {
...
function check_default_effect_cycles(ctx, decls) {
  ...
  let state = map_new();
  let path = [];
  const __ring_iter_79 = __List_Iterable.iter(_Map_entries(ctx.effect_default_deps));
  while (true) {
...
function check(ctx, program, __ring_ev_fail) {
  ...
  while (true) {
    ...
    __ring_match99: {
      ...
      if (__ring_m99._tag === "Impl") {
        const target_type = __ring_m99.target_type; const type_params = __ring_m99.type_params; const trait_name = __ring_m99.trait_name; const methods = __ring_m99.methods; const span = __ring_m99.span;
  ...
  while (true) {
    ...
    __ring_match100: {
      const __ring_m100 = decl;
      if (__ring_m100._tag === "Fn") {
        const name = __ring_m100.name;
        _Map_insert(fn_name_to_idx, name, idx);
        break __ring_match100;
      }
      if (__ring_m100._tag === "Impl") {
        const target_type = __ring_m100.target_type; const trait_name = __ring_m100.trait_name;
  ...
  while (true) {
    ...
    __ring_match101: {
      const __ring_m101 = decl;
      if (__ring_m101._tag === "Fn") {
        break __ring_match101;
      }
      if (__ring_m101._tag === "Impl") {
        break __ring_match101;
      }
  ...
  while (true) {
    ...
    __ring_match102: {
      const __ring_m102 = decl;
      if (__ring_m102._tag === "Impl") {
