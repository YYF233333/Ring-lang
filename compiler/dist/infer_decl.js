...
function check_sig_decl(ctx, name, members, is_pub, span) {
  ...
  __ring_match16: {
    ...
    if (__ring_m16._tag === "some") {
      ...
      const __ring_iter_7 = __List_Iterable.iter(members);
      while (true) {
...
function resolve_mod_uses(ctx, uses) {
  ...
  while (true) {
    ...
    const use_decl = __ring_next_8._0;
...
function check_struct_decl(ctx, name, type_params, is_pub, span, __ring_ev_fail) {
  ...
  let hfields = [];
  const __ring_iter_10 = __List_Iterable.iter(def.fields);
  while (true) {
...
function check_enum_decl(ctx, name, type_params, is_pub, span, __ring_ev_fail) {
  ...
  let hvariants = [];
  const __ring_iter_11 = __List_Iterable.iter(def.variants);
  while (true) {
      ...
      if (__ring_m24._tag === "some") {
        ...
        __ring_match25: {
          ...
          if (__ring_m25._tag === "some") {
            ...
            const __ring_iter_14 = __List_Iterable.iter(op_params);
            while (true) {
...
function check_impl_decl(ctx, target_type, type_params, trait_name, methods, span, __ring_ev_fail) {
  ...
  while (true) {
    ...
    const method = __ring_next_23._0;
    __ring_match36: {
      ...
      if (__ring_m36._tag === "AssocType") {
        ...
        let bound_names = [];
        const __ring_iter_24 = __List_Iterable.iter(abounds);
        while (true) {
  ...
  while (true) {
    ...
    const method = __ring_next_25._0;
    __ring_match38: {
...
function expand_delegate_impls(ctx, target_type, type_params, field, trait_names, span) {
          ...
          while (true) {
            ...
            __ring_match45: {
              ...
              if (__ring_m45._tag === "some") {
                ...
                __ring_match46: {
                  const __ring_m46 = field_type_name;
                  if (__ring_m46._tag === "some") {
                    const ftn = __ring_m46._0;
                    __ring_match47: {
                      const __ring_m47 = env$find_impl(ctx.env.trait_reg, ftn, tname);
                      if (__ring_m47._tag === "some") {
                        const field_impl = __ring_m47._0;
  ...
  __match_fail(__ring_m);
                  ...
                  __ring_match48: {
                    const __ring_m48 = tm.ty;
                    if (__ring_m48._tag === "FnType") {
                      const trait_params = __ring_m48.params; const trait_ret_ty = __ring_m48.return_type; const trait_eff = __ring_m48.effects;
  ...
  return Option_none;
                        ...
                        __ring_match49: {
                          const __ring_m49 = ftn;
                          if (__ring_m49._tag === "some") {
                            const field_tn = __ring_m49._0;
                            let has_explicit = false;
                            __ring_match50: {
                              const __ring_m50 = _Map_get(ctx.env.trait_reg.impl_methods, field_tn);
  ...
  return hir$HExpr_Call(method_access, forward_args, [], [], Option_none, ret_ty, eff, span);
                ...
                let h_assoc_types = [];
                const __ring_iter_32 = __List_Iterable.iter(_Map_entries(field_assoc_map));
                while (true) {
...
function check_trait_decl(ctx, name, type_params, ast_methods, is_pub, span, __ring_ev_fail) {
  ...
  if ((List_len(trait_def.methods) > 0)) {
    __ring_match51: {
      const __ring_m51 = List_first(trait_def.methods);
      if (__ring_m51._tag === "some") {
        const first_method = __ring_m51._0;
        __ring_match52: {
          const __ring_m52 = first_method.ty;
          if (__ring_m52._tag === "FnType") {
            const fps = __ring_m52.params;
            if ((List_len(fps) > 0)) {
              __ring_match53: {
                const __ring_m53 = List_first(fps);
                if (__ring_m53._tag === "some") {
                  const fp = __ring_m53._0;
                  self_var = fp;
  ...
  __match_fail(__ring_m);
    ...
    if (m.has_default) {
      __ring_match54: {
        const __ring_m54 = ast_method;
        if (__ring_m54._tag === "some") {
          const am = __ring_m54._0;
          __ring_match55: {
            const __ring_m55 = am;
  ...
  let hassoc_types = [];
  const __ring_iter_35 = __List_Iterable.iter(trait_def.assoc_types);
  while (true) {
...
function check_trait_default_body(ctx, trait_name, self_var, hparams, body) {
  ...
  __ring_match57: {
    const __ring_m57 = _Map_get(ctx.env.trait_reg.traits, trait_name);
    if (__ring_m57._tag === "some") {
      const tdef = __ring_m57._0;
      ...
      while (true) {
        ...
        __ring_match58: {
          const __ring_m58 = _Map_get(ctx.type_param_scope, atdef.name);
          if (__ring_m58._tag === "some") {
            const at_ty = __ring_m58._0;
  ...
  while (true) {
    ...
    if (p.is_mutable) {
      __ring_match59: {
        const __ring_m59 = env$TypeEnv_lookup(ctx.env, p.name);
        if (__ring_m59._tag === "some") {
          const ps = __ring_m59._0;
          __ring_match60: {
            const __ring_m60 = ps.def_id;
...
function check_fn_body(ctx, type_params, hparams, expected_ret, body, saved_tp_scope, span, __ring_ev_fail) {
  ...
  const __ring_iter_40 = __List_Iterable.iter(type_params);
  while (true) {
    const __ring_next_40 = __ListIterator_Iterator.next(__ring_iter_40);
    if (__ring_next_40._tag === "none") break;
    const tp = __ring_next_40._0;
    __ring_match61: {
      const __ring_m61 = _Map_get(ctx.type_param_scope, tp.name);
      if (__ring_m61._tag === "some") {
        const tv = __ring_m61._0;
        __ring_match62: {
          const __ring_m62 = tv;
  ...
  const __ring_iter_41 = __List_Iterable.iter(type_params);
  while (true) {
    const __ring_next_41 = __ListIterator_Iterator.next(__ring_iter_41);
    if (__ring_next_41._tag === "none") break;
    const tp = __ring_next_41._0;
    _Set_insert(declared_names, tp.name);
  }
  const __ring_iter_42 = __List_Iterable.iter(_Map_entries(ctx.type_param_scope));
  while (true) {
      ...
      if (__ring_m66._tag === "some") {
        ...
        while (true) {
          ...
          if ((!_Map_contains_key(local_names, atdef.var_id))) {
            ...
            __ring_match67: {
              const __ring_m67 = resolved;
              if (__ring_m67._tag === "TypeVar") {
                const rid = __ring_m67.id;
...
function check_fn_decl(ctx, name, type_params, params, return_type, declared_effects, body, is_pub, span, self_type, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match71: {
      const __ring_m71 = param_scheme;
      if (__ring_m71._tag === "some") {
        const ps = __ring_m71._0;
        __ring_match72: {
          const __ring_m72 = ps.def_id;
  ...
  const __ring_iter_52 = __List_Iterable.iter(inferred_effects.effects);
  while (true) {
    const __ring_next_52 = __ListIterator_Iterator.next(__ring_iter_52);
    if (__ring_next_52._tag === "none") break;
    const inferred_eff = __ring_next_52._0;
    let found = false;
    const __ring_iter_53 = __List_Iterable.iter(declared_row.effects);
    while (true) {
      const __ring_next_53 = __ListIterator_Iterator.next(__ring_iter_53);
      if (__ring_next_53._tag === "none") break;
      const declared_eff = __ring_next_53._0;
      if (types$effects_match_kind(inferred_eff, declared_eff)) {
        found = true;
        __ring_match73: {
          const __ring_m73 = [inferred_eff, declared_eff];
          if (Array.isArray(__ring_m73) && __ring_m73.length === 2 && __ring_m73[0]._tag === "FailEffect" && __ring_m73[1]._tag === "FailEffect") {
            const ie = __ring_m73[0].error_type; const de = __ring_m73[1].error_type;
            ctx.subst = infer_ctx$unify_at(ctx.sink, ctx.env, ie, de, ctx.subst, span);
            break __ring_match73;
          }
          if (Array.isArray(__ring_m73) && __ring_m73.length === 2 && __ring_m73[0]._tag === "MutEffect" && __ring_m73[1]._tag === "MutEffect") {
            const is = __ring_m73[0].state_type; const ds = __ring_m73[1].state_type;
  ...
  if ((name === "main")) {
    const __ring_iter_54 = __List_Iterable.iter(final_effects.effects);
    while (true) {
      const __ring_next_54 = __ListIterator_Iterator.next(__ring_iter_54);
      if (__ring_next_54._tag === "none") break;
      const eff = __ring_next_54._0;
      __ring_match74: {
        const __ring_m74 = eff;
        if (__ring_m74._tag === "CustomEffect") {
          const eff_name = __ring_m74.name;
          let skip = false;
          __ring_match75: {
  ...
  let mut_flags = [];
  let fi = 0;
  const __ring_iter_56 = __List_Iterable.iter(params);
  while (true) {
    ...
    if (((p.name === "self") || (!p.is_mutable))) {
      ...
      __ring_match77: {
        const __ring_m77 = List_get(final_params, fi);
        if (__ring_m77._tag === "some") {
          const fp = __ring_m77._0;
...
function check_default_effect_cycles(ctx, decls) {
  ...
  let state = map_new();
  let path = [];
  const __ring_iter_60 = __List_Iterable.iter(_Map_entries(ctx.effect_default_deps));
  while (true) {
...
function collect_effect_spans(decls, spans) {
  const __ring_iter_61 = __List_Iterable.iter(decls);
  while (true) {
    ...
    __ring_match81: {
      ...
      if (__ring_m81._tag === "Effect") {
        const name = __ring_m81.name; const span = __ring_m81.span;
        _Map_insert(spans, name, span);
        break __ring_match81;
      }
      if (__ring_m81._tag === "ModBlock") {
        const mod_decls = __ring_m81.decls;
...
function dfs_detect_cycle(ctx, name, state, path, effect_spans) {
  ...
  List_push(path, name);
  __ring_match82: {
    const __ring_m82 = _Map_get(ctx.effect_default_deps, name);
    if (__ring_m82._tag === "some") {
      const deps = __ring_m82._0;
      const __ring_iter_62 = __List_Iterable.iter(deps);
      while (true) {
        const __ring_next_62 = __ListIterator_Iterator.next(__ring_iter_62);
        if (__ring_next_62._tag === "none") break;
        const dep = __ring_next_62._0;
        __ring_match83: {
          const __ring_m83 = _Map_get(state, dep);
          if (__ring_m83._tag === "some") {
            const s = __ring_m83._0;
            if ((s === 1)) {
              let cycle_parts = [];
              let found_start = false;
              const __ring_iter_63 = __List_Iterable.iter(path);
              while (true) {
...
function check(ctx, program, __ring_ev_fail) {
  ...
  const __ring_iter_64 = __List_Iterable.iter(program.decls);
  while (true) {
    const __ring_next_64 = __ListIterator_Iterator.next(__ring_iter_64);
    if (__ring_next_64._tag === "none") break;
    const decl = __ring_next_64._0;
    __ring_match84: {
      const __ring_m84 = decl;
      if (__ring_m84._tag === "Impl") {
        const target_type = __ring_m84.target_type; const type_params = __ring_m84.type_params; const trait_name = __ring_m84.trait_name; const methods = __ring_m84.methods; const span = __ring_m84.span;
  ...
  let hdecls = [];
  const __ring_iter_65 = __List_Iterable.iter(program.decls);
  while (true) {
