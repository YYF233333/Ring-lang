  ...
  for (const use_decl of uses) {
    ...
    __ring_match5: {
      ...
      if (__ring_m5._tag === "some") {
        const prefix = __ring_m5._0;
        __ring_match6: {
          const __ring_m6 = use_decl.imports;
          if (__ring_m6._tag === "NamedItems") {
            const names = __ring_m6.names;
  ...
  __match_fail(__ring_m);
          ...
          if (__ring_m6._tag === "Module") {
            if ((name_start_idx < List_len(segments))) {
              ...
              __ring_match8: {
                const __ring_m8 = env$TypeEnv_lookup(ctx.env, qualified_name);
...
function check_const_decl(ctx, name, type_annotation, init, is_pub, span, __ring_ev_fail) {
  ...
  __ring_match10: {
    const __ring_m10 = expected_ty;
    if (__ring_m10._tag === "some") {
      const ann_ty = __ring_m10._0;
  ...
  for (const method of methods) {
    __ring_match11: {
      ...
      if (__ring_m11._tag === "ExternFn") {
        const name = __ring_m11.name; const mtps = __ring_m11.type_params; const params = __ring_m11.params; const return_type = __ring_m11.return_type; const declared_effects = __ring_m11.declared_effects; const is_pub = __ring_m11.is_pub; const mspan = __ring_m11.span;
      ...
      if (__ring_m11._tag === "Fn") {
        const name = __ring_m11.name; const mtps = __ring_m11.type_params; const params = __ring_m11.params; const return_type = __ring_m11.return_type; const declared_effects = __ring_m11.declared_effects; const body = __ring_m11.body; const is_pub = __ring_m11.is_pub; const mspan = __ring_m11.span;
...
function check_trait_decl(ctx, name, type_params, ast_methods, is_pub, span, __ring_ev_fail) {
  ...
  if ((List_len(trait_def.methods) > 0)) {
    __ring_match12: {
      const __ring_m12 = List_first(trait_def.methods);
      if (__ring_m12._tag === "some") {
        const first_method = __ring_m12._0;
        __ring_match13: {
          const __ring_m13 = first_method.ty;
          if (__ring_m13._tag === "FnType") {
            const fps = __ring_m13.params;
            if ((List_len(fps) > 0)) {
              __ring_match14: {
                const __ring_m14 = List_first(fps);
                if (__ring_m14._tag === "some") {
                  const fp = __ring_m14._0;
                  self_var = fp;
  ...
  __match_fail(__ring_m);
    ...
    if (m.has_default) {
      __ring_match15: {
        const __ring_m15 = ast_method;
        if (__ring_m15._tag === "some") {
          const am = __ring_m15._0;
          __ring_match16: {
            const __ring_m16 = am;
            if (__ring_m16._tag === "Fn") {
              const abody = __ring_m16.body;
...
function check_trait_default_body(ctx, trait_name, self_var, hparams, body) {
  ...
  for (const p of hparams) {
    ...
    if (p.is_mutable) {
      __ring_match18: {
        const __ring_m18 = env$TypeEnv_lookup(ctx.env, p.name);
        if (__ring_m18._tag === "some") {
          const ps = __ring_m18._0;
          __ring_match19: {
            const __ring_m19 = ps.def_id;
...
function effects_match_kind(a, b) {
  __ring_match25: {
    ...
    if (__ring_m25._tag === "CustomEffect") {
      const na = __ring_m25.name;
      __ring_match29: {
        const __ring_m29 = b;
        if (__ring_m29._tag === "CustomEffect") {
          const nb = __ring_m29.name;
          return (na === nb);
...
function check_fn_decl(ctx, name, type_params, params, return_type, declared_effects, body, is_pub, span, self_type, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match32: {
      const __ring_m32 = param_scheme;
      if (__ring_m32._tag === "some") {
        const ps = __ring_m32._0;
        __ring_match33: {
          const __ring_m33 = ps.def_id;
...
function check_one_decl(ctx, decl, hdecls, __ring_ev_fail) {
  ...
  __ring_match35: {
    ...
    if (__ring_m35._tag === "Fn") {
      const name = __ring_m35.name; const effects = __ring_m35.effects;
