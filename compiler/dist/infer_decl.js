...
function check_decl(ctx, decl, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m0._tag === "ModBlock") {
      const name = __ring_m0.name; const decls = __ring_m0.decls; const is_pub = __ring_m0.is_pub; const span = __ring_m0.span;
      return check_mod_decl(ctx, name, decls, is_pub, span, __ring_ev_fail);
      break __ring_match0;
    }
...
function check_mod_decl(ctx, mod_name, decls, is_pub, span, __ring_ev_fail) {
...
function check_const_decl(ctx, name, type_annotation, init, is_pub, span, __ring_ev_fail) {
  ...
  __ring_match6: {
    const __ring_m6 = expected_ty;
    if (__ring_m6._tag === "some") {
      const ann_ty = __ring_m6._0;
  ...
  for (const method of methods) {
    __ring_match7: {
      ...
      if (__ring_m7._tag === "ExternFn") {
        const name = __ring_m7.name; const mtps = __ring_m7.type_params; const params = __ring_m7.params; const return_type = __ring_m7.return_type; const declared_effects = __ring_m7.declared_effects; const is_pub = __ring_m7.is_pub; const mspan = __ring_m7.span;
      ...
      if (__ring_m7._tag === "Fn") {
        const name = __ring_m7.name; const mtps = __ring_m7.type_params; const params = __ring_m7.params; const return_type = __ring_m7.return_type; const declared_effects = __ring_m7.declared_effects; const body = __ring_m7.body; const is_pub = __ring_m7.is_pub; const mspan = __ring_m7.span;
...
function check_trait_decl(ctx, name, type_params, ast_methods, is_pub, span, __ring_ev_fail) {
  ...
  if ((List_len(trait_def.methods) > 0)) {
    __ring_match8: {
      const __ring_m8 = List_first(trait_def.methods);
      if (__ring_m8._tag === "some") {
        const first_method = __ring_m8._0;
        __ring_match9: {
          const __ring_m9 = first_method.ty;
          if (__ring_m9._tag === "FnType") {
            const fps = __ring_m9.params;
            if ((List_len(fps) > 0)) {
              __ring_match10: {
                const __ring_m10 = List_first(fps);
                if (__ring_m10._tag === "some") {
                  const fp = __ring_m10._0;
                  self_var = fp;
  ...
  __match_fail(__ring_m);
    ...
    if (m.has_default) {
      __ring_match11: {
        const __ring_m11 = ast_method;
        if (__ring_m11._tag === "some") {
          const am = __ring_m11._0;
          __ring_match12: {
            const __ring_m12 = am;
            if (__ring_m12._tag === "Fn") {
              const abody = __ring_m12.body;
...
function check_trait_default_body(ctx, trait_name, self_var, hparams, body) {
  ...
  for (const p of hparams) {
    ...
    if (p.is_mutable) {
      __ring_match14: {
        const __ring_m14 = env$TypeEnv_lookup(ctx.env, p.name);
        if (__ring_m14._tag === "some") {
          const ps = __ring_m14._0;
          __ring_match15: {
            const __ring_m15 = ps.def_id;
    ...
    if (((!_Map_contains_key(saved_tp_scope, tpname)) && (!_Set_contains(declared_names, tpname)))) {
      __ring_match19: {
        ...
        if (__ring_m19._tag === "TypeVar") {
          const resolved = env$apply_subst(ctx.subst, tv);
          __ring_match20: {
            const __ring_m20 = resolved;
            if (__ring_m20._tag === "TypeVar") {
              const rid = __ring_m20.id;
...
function effects_match_kind(a, b) {
  __ring_match21: {
    ...
    if (__ring_m21._tag === "CustomEffect") {
      const na = __ring_m21.name;
      __ring_match25: {
        const __ring_m25 = b;
        if (__ring_m25._tag === "CustomEffect") {
          const nb = __ring_m25.name;
          return (na === nb);
...
function check_fn_decl(ctx, name, type_params, params, return_type, declared_effects, body, is_pub, span, self_type, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match28: {
      const __ring_m28 = param_scheme;
      if (__ring_m28._tag === "some") {
        const ps = __ring_m28._0;
        __ring_match29: {
          const __ring_m29 = ps.def_id;
