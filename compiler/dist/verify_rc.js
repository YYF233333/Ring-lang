...
function v_assign(target, value, span, ctx) {
  __ring_match34: {
    const __ring_m34 = target;
    if (__ring_m34._tag === "Ident") {
      const name = __ring_m34.name; const def_id = __ring_m34.def_id; const ty = __ring_m34.ty;
      v_consume(value, ctx);
      const idx = v_lookup(ctx, name);
      if ((idx < 0)) {
        return;
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m34._tag === "FieldAccess") {
      const receiver = __ring_m34.receiver; const field = __ring_m34.field; const ty = __ring_m34.ty;
      v_borrow(receiver, "", ctx);
      v_consume(value, ctx);
    ...
    if (__ring_m34._tag === "IndexExpr") {
      const receiver = __ring_m34.receiver; const index = __ring_m34.index;
      v_borrow(receiver, "", ctx);
      v_borrow(index, "", ctx);
