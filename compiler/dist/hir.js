...
const FieldAction_FloatIdentity = Object.freeze({ _tag: "FloatIdentity" });
const FieldAction_BoolIdentity = Object.freeze({ _tag: "BoolIdentity" });
...
function __FieldAction_Clone_clone(self) {
  switch (self._tag) {
    ...
    case "FloatIdentity": return FieldAction_FloatIdentity;
    case "BoolIdentity": return FieldAction_BoolIdentity;
...
function __FieldAction_Debug_debug(self) {
  switch (self._tag) {
    ...
    case "FloatIdentity": return "FloatIdentity";
    case "BoolIdentity": return "BoolIdentity";
