...
function emit_assign(ctx, target, value) {
  ...
  __ring_match6: {
    const __ring_m6 = target;
    if (__ring_m6._tag === "Ident") {
      const name = __ring_m6.name; const resolved_name = __ring_m6.resolved_name; const def_id = __ring_m6.def_id;
      let __ring_blk0;
      __ring_match7: {
      ...
      const lookup = __ring_blk0;
      const boxed = codegen_llvm_expr$is_boxed_def(ctx, def_id);
      __ring_match8: {
        const __ring_m8 = _Map_get(ctx.named_values, lookup);
        ...
        if (__ring_m8._tag === "none") {
          __ring_match9: {
            const __ring_m9 = _Map_get(ctx.named_values, name);
    ...
    if (__ring_m6._tag === "FieldAccess") {
      ...
      let __ring_blk1;
      __ring_match10: {
        const __ring_m10 = recv_type;
        if (__ring_m10._tag === "StructType") {
          const name = __ring_m10.name;
          __ring_blk1 = name;
          break __ring_match10;
        }
        __ring_blk1 = panic("LLVM codegen: field assign on non-struct type");
        break __ring_match10;
      }
      const type_name = __ring_blk1;
      __ring_match11: {
        const __ring_m11 = _Map_get(ctx.struct_types, type_name);
    ...
    if (__ring_m12._tag === "some") {
      ...
      __ring_match13: {
        ...
        if (__ring_m13._tag === "none") {
          __ring_blk2 = panic("LLVM codegen: break outside function");
          break __ring_match13;
        }
        __match_fail(__ring_m13);
      }
      const current_fn_val = __ring_blk2;
    ...
    if (__ring_m14._tag === "some") {
      ...
      __ring_match15: {
        ...
        if (__ring_m15._tag === "none") {
          __ring_blk3 = panic("LLVM codegen: continue outside function");
          break __ring_match15;
        }
        __match_fail(__ring_m15);
      }
      const current_fn_val = __ring_blk3;
...
function emit_for_in_list(ctx, binding, destructure, iterable, body) {
  ...
  let collection_converted = false;
  let __ring_blk5;
  __ring_match17: {
...
})() : (((name === "Map") ? (List_len(type_params) === 2) : false) ? (function() {
  let __ring_blk7;
  __ring_match19: {
    const __ring_m19 = __ring_index(type_params, 0);
  ...
  const is_int_key = __ring_blk7;
  const conv_name = (is_int_key ? "ring_map_int_entries" : "ring_map_entries");
  const conv_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, conv_name, [ctx.ptr_type], ctx.ptr_type);
  const conv_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, conv_name);
  collection_converted = true;
  return LLVMBuildCall2(ctx.builder, conv_ty, conv_fn, [list_val_raw], codegen_llvm_ctx$fresh_name(ctx, "m2l"));
})() : list_val_raw));
...
function emit_for_in_range_direct(ctx, binding, start, end, inclusive, body) {
  ...
  __ring_match22: {
    ...
    if (__ring_m22._tag === "none") {
      __ring_blk8 = panic("LLVM codegen: for-in range outside function");
      break __ring_match22;
    }
...
function emit_for_in_range_var(ctx, binding, iterable, body) {
  let __ring_blk9;
  __ring_match23: {
    const __ring_m23 = ctx.current_fn;
    if (__ring_m23._tag === "some") {
      const f = __ring_m23._0;
      __ring_blk9 = f;
      break __ring_match23;
    }
    if (__ring_m23._tag === "none") {
      __ring_blk9 = panic("LLVM codegen: for-in range var outside function");
      break __ring_match23;
    }
...
function emit_for_in(ctx, binding, destructure, iterable, body, iterable_type_name, iter_type_name) {
  let __ring_blk10;
  __ring_match24: {
    const __ring_m24 = ctx.current_fn;
    if (__ring_m24._tag === "some") {
      const f = __ring_m24._0;
      __ring_blk10 = f;
      break __ring_match24;
    }
    if (__ring_m24._tag === "none") {
      __ring_blk10 = panic("LLVM codegen: for-in outside function");
      break __ring_match24;
    }
  ...
  __ring_match25: {
    const __ring_m25 = iterable;
    if (__ring_m25._tag === "RangeExpr") {
      const start = __ring_m25.start; const end = __ring_m25.end; const inclusive = __ring_m25.inclusive;
  ...
  let __ring_blk11;
  __ring_match26: {
    const __ring_m26 = iter_htype;
    if (__ring_m26._tag === "EnumType") {
      const name = __ring_m26.name;
      __ring_blk11 = (name === hir$BUILTIN_RANGE);
      break __ring_match26;
    }
    __ring_blk11 = false;
    break __ring_match26;
  }
  const is_range = __ring_blk11;
  if (is_range) {
...
function emit_if_let(ctx, pattern, expr, then_block, else_block) {
  let __ring_blk12;
  __ring_match27: {
    const __ring_m27 = ctx.current_fn;
    ...
    if (__ring_m27._tag === "none") {
      __ring_blk12 = panic("LLVM codegen: if-let outside function");
      break __ring_match27;
    }
  ...
  __ring_match28: {
    const __ring_m28 = pattern;
    if (__ring_m28._tag === "Constructor") {
      const name = __ring_m28.name; const fields = __ring_m28.fields;
      let __ring_blk13;
      __ring_match29: {
        const __ring_m29 = scrut_ty;
        if (__ring_m29._tag === "EnumType") {
          const ename = __ring_m29.name;
          __ring_blk13 = ename;
      ...
      const enum_name = __ring_blk13;
      __ring_match30: {
        const __ring_m30 = _Map_get(ctx.enum_types, enum_name);
        if (__ring_m30._tag === "some") {
          const enum_info = __ring_m30._0;
          __ring_match31: {
            const __ring_m31 = _Map_get(enum_info.variants, name);
            if (__ring_m31._tag === "some") {
              const vi = __ring_m31._0;
    ...
    if (__ring_m28._tag === "NamedConstructor") {
      const cname = __ring_m28.name; const qualifier = __ring_m28.qualifier; const nfields = __ring_m28.fields;
      let __ring_blk14;
      __ring_match35: {
        const __ring_m35 = scrut_ty;
        if (__ring_m35._tag === "EnumType") {
          const ename = __ring_m35.name;
          __ring_blk14 = ename;
      ...
      const nc_enum_name = __ring_blk14;
      __ring_match36: {
        const __ring_m36 = _Map_get(ctx.enum_types, nc_enum_name);
        if (__ring_m36._tag === "some") {
          const enum_info = __ring_m36._0;
          __ring_match37: {
            const __ring_m37 = _Map_get(enum_info.variants, cname);
            if (__ring_m37._tag === "some") {
              const vi = __ring_m37._0;
              const tag_ptr = LLVMBuildStructGEP2(ctx.builder, enum_info.llvm_type, scrut_val, 0, codegen_llvm_ctx$fresh_name(ctx, "tp"));
              const tag_val = LLVMBuildLoad2(ctx.builder, ctx.i64_type, tag_ptr, codegen_llvm_ctx$fresh_name(ctx, "tag"));
              const expected_tag = LLVMConstInt(ctx.i64_type, vi.tag, 0);
              const cond = LLVMBuildICmp(ctx.builder, 32, tag_val, expected_tag, codegen_llvm_ctx$fresh_name(ctx, "eq"));
              ...
              for (let i = 0; i < __ring_end5; i++) {
                __ring_match38: {
                  const __ring_m38 = List_get(nfields, i);
                  if (__ring_m38._tag === "some") {
                    const nf = __ring_m38._0;
                    let field_idx = i;
                    const __ring_end6 = List_len(vi.field_names);
                    ...
                    __ring_match39: {
                      const __ring_m39 = nf.pattern;
                      if (__ring_m39._tag === "Binding") {
                        const bname = __ring_m39.name;
...
function emit_let_destructure(ctx, bindings, init) {
  ...
  const get_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_get", [ctx.ptr_type, ctx.i64_type], ctx.ptr_type);
  const get_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_get");
  const __ring_end7 = List_len(bindings);
  for (let i = 0; i < __ring_end7; i++) {
    __ring_match42: {
      const __ring_m42 = List_get(bindings, i);
      if (__ring_m42._tag === "some") {
        const b = __ring_m42._0;
        if ((b.name !== "_")) {
...
function emit_return(ctx, value) {
  ...
  while ((ci >= 0)) {
    __ring_match43: {
      const __ring_m43 = List_get(ctx.handle_cleanup_stack, ci);
      if (__ring_m43._tag === "some") {
        const cleanup = __ring_m43._0;
        ...
        if ((List_len(cleanup.ev_drop_allocas) > 0)) {
          const drop_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_drop", [ctx.ptr_type], ctx.void_type);
          const drop_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_drop");
          const __ring_iter_8 = __List_Iterable.iter(cleanup.ev_drop_allocas);
          while (true) {
  ...
  __ring_match45: {
    const __ring_m45 = ctx.current_fn;
    if (__ring_m45._tag === "some") {
      const f = __ring_m45._0;
...
function emit_while(ctx, condition, body) {
  let __ring_blk15;
  __ring_match46: {
    const __ring_m46 = ctx.current_fn;
    ...
    if (__ring_m46._tag === "none") {
      __ring_blk15 = panic("LLVM codegen: while outside function");
      break __ring_match46;
    }
...
function emit_llvm_stmt(ctx, stmt) {
  __ring_match47: {
    const __ring_m47 = stmt;
    if (__ring_m47._tag === "Let") {
      const name = __ring_m47.name; const init = __ring_m47.init;
      const val = codegen_llvm_expr$gen_llvm_expr(ctx, init);
    ...
    if (__ring_m47._tag === "Var") {
      const name = __ring_m47.name; const def_id = __ring_m47.def_id; const init = __ring_m47.init;
      const val = codegen_llvm_expr$gen_llvm_expr(ctx, init);
    ...
    if (__ring_m47._tag === "Assign") {
      const target = __ring_m47.target; const value = __ring_m47.value;
      return emit_assign(ctx, target, value);
      break __ring_match47;
    }
    if (__ring_m47._tag === "ExprStmt") {
      const expr = __ring_m47.expr;
      return discard(codegen_llvm_expr$gen_llvm_expr(ctx, expr));
      break __ring_match47;
    }
    if (__ring_m47._tag === "Return") {
      const value = __ring_m47.value;
      return emit_return(ctx, value);
      break __ring_match47;
    }
    if (__ring_m47._tag === "While") {
      const condition = __ring_m47.condition; const body = __ring_m47.body;
      return emit_while(ctx, condition, body);
      break __ring_match47;
    }
    if (__ring_m47._tag === "ForIn") {
      const binding = __ring_m47.binding; const destructure = __ring_m47.destructure; const iterable = __ring_m47.iterable; const body = __ring_m47.body; const iterable_type_name = __ring_m47.iterable_type_name; const iter_type_name = __ring_m47.iter_type_name;
      return emit_for_in(ctx, binding, destructure, iterable, body, iterable_type_name, iter_type_name);
      break __ring_match47;
    }
    if (__ring_m47._tag === "Break") {
      return emit_break(ctx);
      break __ring_match47;
    }
    if (__ring_m47._tag === "Continue") {
      return emit_continue(ctx);
      break __ring_match47;
    }
    if (__ring_m47._tag === "LetDestructure") {
      const pattern = __ring_m47.pattern; const bindings = __ring_m47.bindings; const init = __ring_m47.init;
      return emit_let_destructure(ctx, bindings, init);
      break __ring_match47;
    }
    if (__ring_m47._tag === "IfLet") {
      const pattern = __ring_m47.pattern; const expr = __ring_m47.expr; const then_block = __ring_m47.then_block; const else_block = __ring_m47.else_block;
      return emit_if_let(ctx, pattern, expr, then_block, else_block);
      break __ring_match47;
    }
    if (__ring_m47._tag === "Drop") {
      const name = __ring_m47.name;
      __ring_match48: {
        const __ring_m48 = _Map_get(ctx.named_values, name);
        if (__ring_m48._tag === "some") {
          const var_ptr = __ring_m48._0;
