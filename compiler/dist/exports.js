...
function extract_exports(module_key, module_prefix, program, hprogram, env) {
  ...
  __match_fail(__ring_m);
            ...
            __ring_match17: {
              const __ring_m17 = _Map_get(env.types.structs, local_name);
            ...
            __ring_match18: {
              const __ring_m18 = _Map_get(env.types.enums, local_name);
            ...
            __ring_match19: {
              const __ring_m19 = _Map_get(env.types.effects, local_name);
            ...
            __ring_match20: {
              const __ring_m20 = _Map_get(env.trait_reg.traits, local_name);
