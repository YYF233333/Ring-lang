...
function extract_exports(module_key, module_prefix, program, hprogram, env) {
  ...
  __match_fail(__ring_m);
            ...
            __ring_match16: {
              const __ring_m16 = env$TypeEnv_lookup(env, local_name);
            ...
            __ring_match17: {
              const __ring_m17 = _Map_get(env.structs, local_name);
            ...
            __ring_match18: {
              const __ring_m18 = _Map_get(env.enums, local_name);
            ...
            __ring_match19: {
              const __ring_m19 = _Map_get(env.effects, local_name);
              if (__ring_m19._tag === "some") {
                const effdef = __ring_m19._0;
            ...
            __ring_match20: {
              const __ring_m20 = _Map_get(env.traits, local_name);
