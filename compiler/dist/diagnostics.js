...
class Diagnostic {
  constructor(severity, code, message, span, notes, context, suggestions) {
...
function __Diagnostic_Clone_clone(self) {
  return new Diagnostic(__Severity_Clone.clone(self.severity), self.code, self.message, __Span_Clone.clone(self.span), __List_Clone.clone(self.notes, __DiagnosticNote_Clone), __DiagnosticContext_Clone.clone(self.context), __List_Clone.clone(self.suggestions, __Suggestion_Clone));
}
...
function __Diagnostic_Debug_debug(self) {
  return "Diagnostic { " + "severity: " + __Severity_Debug.debug(self.severity) + ", " + "code: " + String(self.code) + ", " + "message: " + String(self.message) + ", " + "span: " + __Span_Debug.debug(self.span) + ", " + "notes: " + __List_Debug.debug(self.notes, __DiagnosticNote_Debug) + ", " + "context: " + __DiagnosticContext_Debug.debug(self.context) + ", " + "suggestions: " + __List_Debug.debug(self.suggestions, __Suggestion_Debug) + " }";
}
