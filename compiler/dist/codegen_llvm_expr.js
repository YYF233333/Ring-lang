...
function is_builtin_collection(ty) {
  __ring_match115: {
    const __ring_m115 = ty;
    if (__ring_m115._tag === "StructType") {
      const name = __ring_m115.name; const type_params = __ring_m115.type_params; const fields = __ring_m115.fields;
      if ((name === "List")) {
...
function ensure_runtime_method(ctx, name, arg_count) {
  __ring_match116: {
    const __ring_m116 = _Map_get(ctx.rt_fns, name);
    if (__ring_m116._tag === "some") {
      const f = __ring_m116._0;
      return f;
...
function gen_method_call(ctx, recv, recv_type, method, args, dict_vals) {
  let __ring_blk21;
  __ring_match117: {
    const __ring_m117 = types$type_to_builtin_name(recv_type);
    if (__ring_m117._tag === "some") {
      const n = __ring_m117._0;
      __ring_blk21 = n;
    ...
    if (__ring_m117._tag === "none") {
      let __ring_blk22;
      __ring_match118: {
        const __ring_m118 = recv_type;
        if (__ring_m118._tag === "StructType") {
          const name = __ring_m118.name;
          __ring_blk22 = name;
          break __ring_match118;
        }
        if (__ring_m118._tag === "EnumType") {
          const name = __ring_m118.name;
          __ring_blk22 = name;
          break __ring_match118;
        }
  ...
  __ring_match119: {
    const __ring_m119 = rt_method;
    if (__ring_m119._tag === "some") {
      const base_rt_name = __ring_m119._0;
      let __ring_blk23;
      __ring_match120: {
        ...
        if (__ring_m120 === "values") {
          __ring_blk23 = "ring_map_int_values";
          break __ring_match120;
        }
        if (__ring_m120 === "entries") {
      ...
      __ring_match121: {
        ...
        if (__ring_m121 === "contains") {
          __ring_blk24 = "ring_set_int_has";
          break __ring_match121;
        }
        if (__ring_m121 === "to_list") {
    ...
    if (__ring_m119._tag === "none") {
      ...
      __ring_match122: {
        const __ring_m122 = _Map_get(ctx.functions, mangled);
        if (__ring_m122._tag === "some") {
          const fn_val = __ring_m122._0;
          ...
          __ring_match123: {
            const __ring_m123 = _Map_get(ctx.fn_evidence_params, mangled);
          ...
          let __ring_blk25;
          __ring_match124: {
            const __ring_m124 = _Map_get(ctx.fn_types, mangled);
...
function gen_literal_pattern_cond(ctx, scrut_val, scrut_ty, value) {
  __ring_match125: {
    const __ring_m125 = value;
    if (__ring_m125._tag === "IntVal") {
    ...
    if (__ring_m125._tag === "BoolVal") {
      const b = __ring_m125._0;
      const raw = unbox_int(ctx, scrut_val);
      const lit = (b ? LLVMConstInt(ctx.i64_type, 1, 0) : LLVMConstInt(ctx.i64_type, 0, 0));
      return LLVMBuildICmp(ctx.builder, 32, raw, lit, codegen_llvm_ctx$fresh_name(ctx, "eq"));
      break __ring_match125;
    }
    if (__ring_m125._tag === "StrVal") {
      const s = __ring_m125._0;
...
function gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, match_bb, miss_bb, current_fn) {
  const ei = find_enum_by_variant(ctx, cname, qualifier);
  __ring_match126: {
    const __ring_m126 = ei;
    if (__ring_m126._tag === "some") {
      const enum_info = __ring_m126._0;
      __ring_match127: {
        const __ring_m127 = _Map_get(enum_info.variants, cname);
        if (__ring_m127._tag === "some") {
          const vi = __ring_m127._0;
...
function tuple_element_type(ty, idx) {
  __ring_match128: {
    ...
    if (__ring_m128._tag === "TupleType") {
      const elements = __ring_m128.elements;
      __ring_match129: {
        const __ring_m129 = List_get(elements, idx);
        if (__ring_m129._tag === "some") {
          const t = __ring_m129._0;
          return t;
...
function gen_index_expr(ctx, receiver, index, ty) {
  ...
  let __ring_blk26;
  __ring_match130: {
    const __ring_m130 = types$type_to_builtin_name(recv_type);
    if (__ring_m130._tag === "some") {
      const n = __ring_m130._0;
      __ring_blk26 = n;
...
function gen_effect_op(ctx, effect_name, op_name, args) {
  if (((effect_name === "fail") ? (op_name === "raise") : false)) {
    ...
    let __ring_blk27;
    __ring_match131: {
      const __ring_m131 = ctx.current_fn;
    ...
    let __ring_blk28;
    __ring_match132: {
      const __ring_m132 = _Map_get(ctx.effect_ops, effect_name);
      if (__ring_m132._tag === "some") {
        const ops = __ring_m132._0;
...
function gen_handle_expr(ctx, body, handlers) {
  ...
  while (true) {
    ...
    __ring_match133: {
      const __ring_m133 = _Map_get(by_effect, h.effect_name);
      if (__ring_m133._tag === "some") {
        const existing = __ring_m133._0;
...
function gen_catch_arms(ctx, error_val, arms) {
  ...
  while (true) {
    ...
    __ring_match134: {
      const __ring_m134 = arm.pattern;
      if (__ring_m134._tag === "Binding") {
      ...
      if (__ring_m134._tag === "Wildcard") {
        return gen_llvm_expr(ctx, arm.body);
        break __ring_match134;
      }
      if (__ring_m134._tag === "Constructor") {
        const name = __ring_m134.name; const fields = __ring_m134.fields;
...
function gen_catch_closure(ctx, arms) {
  ...
  for (let i = 0; i < __ring_end69; i++) {
    __ring_match136: {
      const __ring_m136 = List_get(captures, i);
      if (__ring_m136._tag === "some") {
        const cap_name = __ring_m136._0;
        let __ring_blk29;
        __ring_match137: {
          const __ring_m137 = _Map_get(ctx.named_values, cap_name);
...
function gen_named_variant_construct(ctx, enum_name, variant_name, fields) {
  __ring_match138: {
    const __ring_m138 = _Map_get(ctx.enum_types, enum_name);
    if (__ring_m138._tag === "some") {
      const enum_info = __ring_m138._0;
      __ring_match139: {
        const __ring_m139 = _Map_get(enum_info.variants, variant_name);
        if (__ring_m139._tag === "some") {
          const vi = __ring_m139._0;
          ...
          for (let i = 0; i < __ring_end70; i++) {
            __ring_match140: {
              const __ring_m140 = List_get(fields, i);
              if (__ring_m140._tag === "some") {
                const f = __ring_m140._0;
    ...
    if (__ring_m138._tag === "none") {
      ...
      __ring_match141: {
        const __ring_m141 = _Map_get(ctx.functions, ctor_name);
        if (__ring_m141._tag === "some") {
          ...
          let __ring_blk30;
          __ring_match142: {
            const __ring_m142 = _Map_get(ctx.fn_types, ctor_name);
            if (__ring_m142._tag === "some") {
              const t = __ring_m142._0;
              __ring_blk30 = t;
...
function gen_match_arm_enum(ctx, arm, scrut_val, enum_name, enum_info, switch_val, merge_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match143: {
    ...
    if (__ring_m143._tag === "Constructor") {
      const name = __ring_m143.name; const fields = __ring_m143.fields;
      __ring_match144: {
        const __ring_m144 = _Map_get(enum_info.variants, name);
        if (__ring_m144._tag === "some") {
          const vi = __ring_m144._0;
          ...
          for (let i = 0; i < __ring_end73; i++) {
            __ring_match145: {
              const __ring_m145 = List_get(fields, i);
              if (__ring_m145._tag === "some") {
                const field_pat = __ring_m145._0;
                __ring_match146: {
                  const __ring_m146 = field_pat;
                  if (__ring_m146._tag === "Binding") {
                    const bname = __ring_m146.name;
                    const field_ptr = LLVMBuildStructGEP2(ctx.builder, enum_info.llvm_type, scrut_val, (i + 1), codegen_llvm_ctx$fresh_name(ctx, "ef"));
                    const field_val = LLVMBuildLoad2(ctx.builder, ctx.ptr_type, field_ptr, codegen_llvm_ctx$fresh_name(ctx, bname));
                    const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
                    discard(LLVMBuildStore(ctx.builder, field_val, alloca));
    ...
    if (__ring_m143._tag === "NamedConstructor") {
      const name = __ring_m143.name; const named_fields = __ring_m143.fields;
      __ring_match147: {
        const __ring_m147 = _Map_get(enum_info.variants, name);
        if (__ring_m147._tag === "some") {
          const vi = __ring_m147._0;
          const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.arm.${name}`);
          LLVMAddCase(switch_val, LLVMConstInt(ctx.i64_type, vi.tag, 0), arm_bb);
          LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          ...
          for (let i = 0; i < __ring_end74; i++) {
            __ring_match148: {
              const __ring_m148 = List_get(named_fields, i);
              if (__ring_m148._tag === "some") {
                const nf = __ring_m148._0;
                let field_idx = i;
                ...
                __ring_match149: {
                  const __ring_m149 = nf.pattern;
                  if (__ring_m149._tag === "Binding") {
                    const bname = __ring_m149.name;
                    const field_ptr = LLVMBuildStructGEP2(ctx.builder, enum_info.llvm_type, scrut_val, (field_idx + 1), codegen_llvm_ctx$fresh_name(ctx, "ef"));
                    const field_val = LLVMBuildLoad2(ctx.builder, ctx.ptr_type, field_ptr, codegen_llvm_ctx$fresh_name(ctx, bname));
                    const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
                    discard(LLVMBuildStore(ctx.builder, field_val, alloca));
    ...
    if (__ring_m143._tag === "Wildcard") {
      break __ring_match143;
    }
    if (__ring_m143._tag === "Binding") {
      const bname = __ring_m143.name;
      break __ring_match143;
    }
    if (__ring_m143._tag === "OrPattern") {
      const patterns = __ring_m143.patterns;
      ...
      while (true) {
        ...
        let __ring_blk31;
        __ring_match150: {
          const __ring_m150 = alt;
          if (__ring_m150._tag === "Constructor") {
            const name = __ring_m150.name;
            __ring_blk31 = Option_some(name);
            break __ring_match150;
          }
          if (__ring_m150._tag === "NamedConstructor") {
            const name = __ring_m150.name;
            __ring_blk31 = Option_some(name);
            break __ring_match150;
          }
        ...
        __ring_match151: {
          const __ring_m151 = alt_name;
          if (__ring_m151._tag === "some") {
            const an = __ring_m151._0;
            __ring_match152: {
              const __ring_m152 = _Map_get(enum_info.variants, an);
              if (__ring_m152._tag === "some") {
                const vi = __ring_m152._0;
                LLVMAddCase(switch_val, LLVMConstInt(ctx.i64_type, vi.tag, 0), arm_bb);
...
function gen_match_arm_wildcard(ctx, arm, scrut_val, default_bb, merge_bb, phi_vals, phi_bbs) {
  ...
  __ring_match153: {
    const __ring_m153 = arm.pattern;
    if (__ring_m153._tag === "Binding") {
      const bname = __ring_m153.name;
      const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
...
function emit_match_arm_body(ctx, arm, merge_bb, next_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match154: {
    const __ring_m154 = arm.guard;
    if (__ring_m154._tag === "some") {
      const g = __ring_m154._0;
...
function gen_match_if_else(ctx, scrut_val, scrut_ty, arms, merge_bb, default_bb, current_fn) {
  ...
  for (let i = 0; i < __ring_end77; i++) {
    __ring_match155: {
      const __ring_m155 = List_get(arms, i);
      if (__ring_m155._tag === "some") {
        const arm = __ring_m155._0;
        const is_last = (i === (total - 1));
        let __ring_blk32;
        __ring_match156: {
          const __ring_m156 = arm.guard;
        ...
        __ring_match157: {
          const __ring_m157 = arm.pattern;
          if (__ring_m157._tag === "Wildcard") {
            open_block = false;
          ...
          if (__ring_m157._tag === "Binding") {
            const bname = __ring_m157.name;
            open_block = false;
            const next_bb = ((has_guard ? (is_last === false) : false) ? LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next") : default_bb);
          ...
          if (__ring_m157._tag === "Literal") {
            const value = __ring_m157.value;
          ...
          if (__ring_m157._tag === "Constructor") {
            const cname = __ring_m157.name; const qualifier = __ring_m157.qualifier; const fields = __ring_m157.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
          ...
          if (__ring_m157._tag === "NamedConstructor") {
            const cname = __ring_m157.name; const qualifier = __ring_m157.qualifier; const nfields = __ring_m157.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.ctor.${cname}`);
            gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, arm_bb, next_bb, current_fn);
            LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          ...
          if (__ring_m157._tag === "OrPattern") {
            const patterns = __ring_m157.patterns;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            ...
            for (let k = 0; k < __ring_end78; k++) {
              __ring_match158: {
                const __ring_m158 = List_get(palts, k);
                if (__ring_m158._tag === "some") {
                  const alt = __ring_m158._0;
                  let __ring_blk33;
                  __ring_match159: {
                    const __ring_m159 = alt;
                    if (__ring_m159._tag === "Constructor") {
                      const an = __ring_m159.name; const aq = __ring_m159.qualifier;
                  ...
                  __ring_match160: {
                    const __ring_m160 = alt_ref;
                    if (__ring_m160._tag === "some") {
                      const ar = __ring_m160._0;
                      const __ring_dt4 = ar;
          ...
          if (__ring_m157._tag === "TuplePattern") {
            const elements = __ring_m157.elements;
            const get_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_get", [ctx.ptr_type, ctx.i64_type], ctx.ptr_type);
            const get_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_get");
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            ...
            for (let j = 0; j < __ring_end79; j++) {
              __ring_match161: {
                const __ring_m161 = List_get(elements, j);
                if (__ring_m161._tag === "some") {
                  const elem_pat = __ring_m161._0;
                  let __ring_blk34;
                  __ring_match162: {
                    const __ring_m162 = elem_pat;
                    if (__ring_m162._tag === "Constructor") {
                      const cname = __ring_m162.name; const qualifier = __ring_m162.qualifier;
                      __ring_blk34 = Option_some([cname, qualifier]);
                      break __ring_match162;
                    }
                    if (__ring_m162._tag === "NamedConstructor") {
                      const cname = __ring_m162.name; const qualifier = __ring_m162.qualifier;
                      __ring_blk34 = Option_some([cname, qualifier]);
                      break __ring_match162;
                    }
                  ...
                  __ring_match163: {
                    const __ring_m163 = ctor_ref;
                    if (__ring_m163._tag === "some") {
                      const cref = __ring_m163._0;
                      ...
                      const ei = find_enum_by_variant(ctx, cname, qualifier);
                      __ring_match164: {
                        const __ring_m164 = ei;
                        if (__ring_m164._tag === "some") {
                          const enum_info = __ring_m164._0;
                          __ring_match165: {
                            const __ring_m165 = _Map_get(enum_info.variants, cname);
                            if (__ring_m165._tag === "some") {
                              const vi = __ring_m165._0;
                    ...
                    if (__ring_m163._tag === "none") {
                      __ring_match166: {
                        const __ring_m166 = elem_pat;
                        if (__ring_m166._tag === "Literal") {
                          const value = __ring_m166.value;
                          const idx = LLVMConstInt(ctx.i64_type, j, 0);
            ...
            for (let j = 0; j < __ring_end80; j++) {
              __ring_match167: {
                const __ring_m167 = List_get(elements, j);
                if (__ring_m167._tag === "some") {
                  const elem_pat = __ring_m167._0;
                  __ring_match168: {
                    const __ring_m168 = elem_pat;
...
function gen_match_expr(ctx, scrutinee, arms, result_ty) {
  let __ring_blk35;
  __ring_match169: {
    const __ring_m169 = ctx.current_fn;
    if (__ring_m169._tag === "some") {
      const f = __ring_m169._0;
      __ring_blk35 = f;
  ...
  let __ring_blk36;
  __ring_match170: {
    const __ring_m170 = scrut_ty;
    if (__ring_m170._tag === "EnumType") {
  ...
  __ring_match172: {
    const __ring_m172 = enum_name;
    if (__ring_m172._tag === "some") {
      const ename = __ring_m172._0;
      __ring_match173: {
        const __ring_m173 = _Map_get(ctx.enum_types, ename);
        if (__ring_m173._tag === "some") {
          ...
          while (true) {
            ...
            let __ring_blk37;
            __ring_match174: {
              const __ring_m174 = arm.pattern;
              if (__ring_m174._tag === "Wildcard") {
                __ring_blk37 = true;
                break __ring_match174;
              }
              if (__ring_m174._tag === "Binding") {
                __ring_blk37 = true;
                break __ring_match174;
              }
              __ring_blk37 = false;
...
function gen_if_expr(ctx, condition, then_branch, else_branch) {
  let __ring_blk38;
  __ring_match176: {
    const __ring_m176 = ctx.current_fn;
    if (__ring_m176._tag === "some") {
      const f = __ring_m176._0;
      __ring_blk38 = f;
  ...
  let __ring_blk39;
  __ring_match177: {
    const __ring_m177 = else_branch;
    if (__ring_m177._tag === "some") {
      const eb = __ring_m177._0;
...
function gen_block(ctx, stmts, tail) {
  ...
  __ring_match178: {
    const __ring_m178 = tail;
    if (__ring_m178._tag === "some") {
      const t = __ring_m178._0;
...
function gen_struct_lit(ctx, name, fields, spread) {
  __ring_match179: {
    const __ring_m179 = _Map_get(ctx.struct_types, name);
    if (__ring_m179._tag === "some") {
      const info = __ring_m179._0;
      ...
      __ring_match180: {
        const __ring_m180 = spread;
        if (__ring_m180._tag === "some") {
          const spread_expr = __ring_m180._0;
...
function gen_field_access(ctx, receiver, field, ty) {
  ...
  const recv_type = hir$hexpr_type(receiver);
  __ring_match181: {
    const __ring_m181 = recv_type;
    if (__ring_m181._tag === "TupleType") {
      let __ring_blk40;
      __ring_match182: {
        const __ring_m182 = parse_int(field);
        if (__ring_m182._tag === "some") {
          const n = __ring_m182._0;
          __ring_blk40 = n;
  ...
  let __ring_blk41;
  __ring_match183: {
    const __ring_m183 = recv_type;
    if (__ring_m183._tag === "StructType") {
      const name = __ring_m183.name;
      __ring_blk41 = name;
      break __ring_match183;
    }
    if (__ring_m183._tag === "EnumType") {
      const name = __ring_m183.name;
      __ring_blk41 = name;
      break __ring_match183;
    }
  ...
  __ring_match184: {
    const __ring_m184 = _Map_get(ctx.struct_types, type_name);
...
function gen_mut_arg_llvm(ctx, arg) {
  __ring_match185: {
    const __ring_m185 = arg;
    if (__ring_m185._tag === "Ident") {
      const name = __ring_m185.name; const resolved_name = __ring_m185.resolved_name; const def_id = __ring_m185.def_id;
      if (is_boxed_def(ctx, def_id)) {
        let __ring_blk42;
        __ring_match186: {
          const __ring_m186 = resolved_name;
          if (__ring_m186._tag === "some") {
            const rn = __ring_m186._0;
            __ring_blk42 = rn;
        ...
        __ring_match187: {
          const __ring_m187 = _Map_get(ctx.named_values, lookup_name);
          ...
          if (__ring_m187._tag === "none") {
            __ring_match188: {
              const __ring_m188 = _Map_get(ctx.named_values, name);
              if (__ring_m188._tag === "some") {
                const alloca = __ring_m188._0;
                return LLVMBuildLoad2(ctx.builder, ctx.ptr_type, alloca, codegen_llvm_ctx$fresh_name(ctx, "mcell"));
...
function gen_dict_dispatch_call(ctx, callee, args, dd) {
  ...
  __ring_match189: {
    const __ring_m189 = callee;
    if (__ring_m189._tag === "FieldAccess") {
      const receiver = __ring_m189.receiver;
      recv_val = Option_some(gen_llvm_expr(ctx, receiver));
      break __ring_match189;
    }
    __ring_match190: {
      const __ring_m190 = List_get(args, 0);
      if (__ring_m190._tag === "some") {
        const a = __ring_m190._0;
  ...
  let call_args = [];
  __ring_match191: {
    const __ring_m191 = recv_val;
    if (__ring_m191._tag === "some") {
      const rv = __ring_m191._0;
  ...
  for (let i = other_arg_start; i < __ring_end90; i++) {
    __ring_match192: {
      const __ring_m192 = List_get(args, i);
      if (__ring_m192._tag === "some") {
        const a = __ring_m192._0;
  ...
  let __ring_blk43;
  __ring_match193: {
    const __ring_m193 = _Map_get(ctx.named_values, dd.dict_param);
    if (__ring_m193._tag === "some") {
      const dict_alloca = __ring_m193._0;
...
function gen_call(ctx, callee, args, resolved_dicts, dict_dispatch, result_ty, effects) {
  __ring_match194: {
    const __ring_m194 = dict_dispatch;
    if (__ring_m194._tag === "some") {
      const dd = __ring_m194._0;
  ...
  while (true) {
    ...
    let __ring_blk44;
    __ring_match195: {
      const __ring_m195 = mut_flags;
      if (__ring_m195._tag === "some") {
        const flags = __ring_m195._0;
        let __ring_blk45;
        __ring_match196: {
          const __ring_m196 = List_get(flags, argi);
  ...
  __ring_match197: {
    ...
    if (__ring_m197._tag === "Ident") {
      const name = __ring_m197.name; const resolved_name = __ring_m197.resolved_name;
      let __ring_blk47;
      __ring_match198: {
        const __ring_m198 = resolved_name;
        if (__ring_m198._tag === "some") {
          const rn = __ring_m198._0;
          __ring_blk47 = rn;
    ...
    if (__ring_m197._tag === "FieldAccess") {
      const receiver = __ring_m197.receiver; const field = __ring_m197.field;
      const recv_val = gen_llvm_expr(ctx, receiver);
      const recv_type = hir$hexpr_type(receiver);
...
function gen_ord_dispatch_llvm(ctx, op, left, right, dispatch) {
  ...
  __ring_match202: {
    ...
    if (__ring_m202._tag === "Lt") {
      __ring_blk48 = 40;
      break __ring_match202;
    }
    if (__ring_m202._tag === "Lte") {
      __ring_blk48 = 41;
      break __ring_match202;
    }
    if (__ring_m202._tag === "Gt") {
      __ring_blk48 = 38;
      break __ring_match202;
    }
    if (__ring_m202._tag === "Gte") {
      __ring_blk48 = 39;
      break __ring_match202;
    }
    __ring_blk48 = 32;
...
function gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch, result_ty) {
  ...
  __ring_match205: {
    ...
    if (__ring_m205._tag === "Eq") {
      __ring_blk49 = true;
      break __ring_match205;
    }
    if (__ring_m205._tag === "Neq") {
      __ring_blk49 = true;
      break __ring_match205;
    }
    __ring_blk49 = false;
  ...
  let __ring_blk50;
  __ring_match206: {
    const __ring_m206 = op;
    if (__ring_m206._tag === "Lt") {
      __ring_blk50 = true;
      break __ring_match206;
    }
    if (__ring_m206._tag === "Lte") {
      __ring_blk50 = true;
      break __ring_match206;
    }
    if (__ring_m206._tag === "Gt") {
      __ring_blk50 = true;
      break __ring_match206;
    }
    if (__ring_m206._tag === "Gte") {
      __ring_blk50 = true;
      break __ring_match206;
    }
    __ring_blk50 = false;
  ...
  if (is_eq_op) {
    __ring_match207: {
      const __ring_m207 = eq_dispatch;
      if (__ring_m207._tag === "some") {
        const d = __ring_m207._0;
        __ring_match208: {
          const __ring_m208 = d;
          if (__ring_m208._tag === "Builtin") {
  ...
  if (is_ord_op) {
    __ring_match209: {
      const __ring_m209 = ord_dispatch;
      if (__ring_m209._tag === "some") {
        const d = __ring_m209._0;
        __ring_match210: {
          const __ring_m210 = d;
          if (__ring_m210._tag === "Builtin") {
...
function gen_llvm_expr(ctx, expr) {
  __ring_match211: {
    const __ring_m211 = expr;
    if (__ring_m211._tag === "IntLit") {
      const value = __ring_m211.value;
      return gen_int_lit(ctx, value);
      break __ring_match211;
    }
    if (__ring_m211._tag === "FloatLit") {
      const value = __ring_m211.value;
      return gen_float_lit(ctx, value);
      break __ring_match211;
    }
    if (__ring_m211._tag === "StrLit") {
      const value = __ring_m211.value;
      return gen_str_lit(ctx, value);
      break __ring_match211;
    }
    if (__ring_m211._tag === "BoolLit") {
      const value = __ring_m211.value;
      return gen_bool_lit(ctx, value);
      break __ring_match211;
    }
    if (__ring_m211._tag === "Ident") {
      const name = __ring_m211.name; const resolved_name = __ring_m211.resolved_name; const def_id = __ring_m211.def_id; const dict_closure_dicts = __ring_m211.dict_closure_dicts; const ty = __ring_m211.ty;
      return gen_ident(ctx, name, resolved_name, def_id, dict_closure_dicts, ty);
      break __ring_match211;
    }
    if (__ring_m211._tag === "BinOp") {
      const op = __ring_m211.op; const left = __ring_m211.left; const right = __ring_m211.right; const eq_dispatch = __ring_m211.eq_dispatch; const ord_dispatch = __ring_m211.ord_dispatch; const ty = __ring_m211.ty;
      return gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch, ty);
      break __ring_match211;
    }
    if (__ring_m211._tag === "UnaryOp") {
      const op = __ring_m211.op; const operand = __ring_m211.operand; const ty = __ring_m211.ty;
      return gen_unaryop(ctx, op, operand, ty);
      break __ring_match211;
    }
    if (__ring_m211._tag === "Call") {
      const callee = __ring_m211.callee; const args = __ring_m211.args; const resolved_dicts = __ring_m211.resolved_dicts; const dict_dispatch = __ring_m211.dict_dispatch; const ty = __ring_m211.ty; const effects = __ring_m211.effects;
      return gen_call(ctx, callee, args, resolved_dicts, dict_dispatch, ty, effects);
      break __ring_match211;
    }
    if (__ring_m211._tag === "DictConstruct") {
      const base_dict = __ring_m211.base_dict; const trait_name = __ring_m211.trait_name; const inner = __ring_m211.inner;
      return build_wrapped_dict(ctx, base_dict, trait_name, inner);
      break __ring_match211;
    }
    if (__ring_m211._tag === "FieldAccess") {
      const receiver = __ring_m211.receiver; const field = __ring_m211.field; const ty = __ring_m211.ty;
      return gen_field_access(ctx, receiver, field, ty);
      break __ring_match211;
    }
    if (__ring_m211._tag === "StructLit") {
      const name = __ring_m211.name; const fields = __ring_m211.fields; const spread = __ring_m211.spread;
      return gen_struct_lit(ctx, name, fields, spread);
      break __ring_match211;
    }
    if (__ring_m211._tag === "Block") {
      const stmts = __ring_m211.stmts; const tail = __ring_m211.tail;
      return gen_block(ctx, stmts, tail);
      break __ring_match211;
    }
    if (__ring_m211._tag === "IfExpr") {
      const condition = __ring_m211.condition; const then_branch = __ring_m211.then_branch; const else_branch = __ring_m211.else_branch;
      return gen_if_expr(ctx, condition, then_branch, else_branch);
      break __ring_match211;
    }
    if (__ring_m211._tag === "StringInterp") {
      const parts = __ring_m211.parts;
      return gen_string_interp(ctx, parts);
      break __ring_match211;
    }
    if (__ring_m211._tag === "Lambda") {
      const params = __ring_m211.params; const return_type = __ring_m211.return_type; const body = __ring_m211.body; const ty = __ring_m211.ty;
      return gen_lambda(ctx, params, return_type, body, ty);
      break __ring_match211;
    }
    if (__ring_m211._tag === "MatchExpr") {
      const scrutinee = __ring_m211.scrutinee; const arms = __ring_m211.arms; const ty = __ring_m211.ty;
      return gen_match_expr(ctx, scrutinee, arms, ty);
      break __ring_match211;
    }
    if (__ring_m211._tag === "NamedVariantConstruct") {
      const enum_name = __ring_m211.enum_name; const variant_name = __ring_m211.variant_name; const fields = __ring_m211.fields;
      return gen_named_variant_construct(ctx, enum_name, variant_name, fields);
      break __ring_match211;
    }
    if (__ring_m211._tag === "TryCatch") {
      const body = __ring_m211.body; const arms = __ring_m211.arms;
      return gen_try_catch(ctx, body, arms);
      break __ring_match211;
    }
    if (__ring_m211._tag === "HandleExpr") {
      const body = __ring_m211.body; const handlers = __ring_m211.handlers;
      return gen_handle_expr(ctx, body, handlers);
      break __ring_match211;
    }
    if (__ring_m211._tag === "EffectOp") {
      const effect_name = __ring_m211.effect_name; const op_name = __ring_m211.op_name; const args = __ring_m211.args;
      return gen_effect_op(ctx, effect_name, op_name, args);
      break __ring_match211;
    }
    if (__ring_m211._tag === "RangeExpr") {
      const start = __ring_m211.start; const end = __ring_m211.end; const inclusive = __ring_m211.inclusive;
      return gen_range_expr(ctx, start, end, inclusive);
      break __ring_match211;
    }
    if (__ring_m211._tag === "ListLit") {
      const elements = __ring_m211.elements;
      return gen_list_lit(ctx, elements);
      break __ring_match211;
    }
    if (__ring_m211._tag === "TupleLit") {
      const elements = __ring_m211.elements;
      return gen_tuple_lit(ctx, elements);
      break __ring_match211;
    }
    if (__ring_m211._tag === "IndexExpr") {
      const receiver = __ring_m211.receiver; const index = __ring_m211.index; const ty = __ring_m211.ty;
      return gen_index_expr(ctx, receiver, index, ty);
      break __ring_match211;
    }
    if (__ring_m211._tag === "Clone") {
      const inner = __ring_m211.inner;
      return gen_clone(ctx, inner);
      break __ring_match211;
    }
    if (__ring_m211._tag === "ReturnExpr") {
      const value = __ring_m211.value;
      __ring_match212: {
...
function gen_lambda(ctx, params, return_type, body, ty) {
  ...
  for (let i = 0; i < __ring_end94; i++) {
    __ring_match215: {
      const __ring_m215 = List_get(captures, i);
      if (__ring_m215._tag === "some") {
        const cap_name = __ring_m215._0;
  ...
  for (let i = 0; i < __ring_end95; i++) {
    __ring_match216: {
      const __ring_m216 = List_get(params, i);
      if (__ring_m216._tag === "some") {
        const p = __ring_m216._0;
  ...
  for (let i = 0; i < __ring_end96; i++) {
    __ring_match217: {
      const __ring_m217 = List_get(captures, i);
      if (__ring_m217._tag === "some") {
        const cap_name = __ring_m217._0;
        let __ring_blk52;
        __ring_match218: {
          const __ring_m218 = _Map_get(ctx.named_values, cap_name);
          if (__ring_m218._tag === "some") {
            const alloca = __ring_m218._0;
...
function build_handler_evidence(ctx, effect_name, hs) {
  let __ring_blk53;
  __ring_match219: {
    const __ring_m219 = _Map_get(ctx.effect_ops, effect_name);
    if (__ring_m219._tag === "some") {
      const ops = __ring_m219._0;
...
function emit_memoised_dict_getter(ctx, name, build_fn, build_fn_ty) {
  const fname = `ring_dict_init_${name}`;
  __ring_match220: {
    const __ring_m220 = _Map_get(ctx.functions, fname);
    if (__ring_m220._tag === "some") {
      const existing = __ring_m220._0;
      return existing;
