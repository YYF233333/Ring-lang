...
function gen_llvm_expr(ctx, expr) {
  __ring_match8: {
    ...
    if (__ring_m8._tag === "DictConstruct") {
      const base_dict = __ring_m8.base_dict; const trait_name = __ring_m8.trait_name; const inner = __ring_m8.inner;
...
function resolve_static_dict_by_name(ctx, name) {
  ...
  __match_fail(__ring_m);
          ...
          __ring_match52: {
            const __ring_m52 = inst_def;
            if (__ring_m52._tag === "some") {
              const def = __ring_m52._0;
              let inner_refs = [];
              ...
              return build_wrapped_dict(ctx, def.base_dict, def.trait_name, inner_refs);
...
function build_wrapped_dict(ctx, dict_name, trait_name, inner_dicts) {
  ...
  for (let i = 0; i < __ring_end15; i++) {
    __ring_match53: {
      const __ring_m53 = List_get(method_order, i);
      if (__ring_m53._tag === "some") {
        const method_name = __ring_m53._0;
        const mangled = codegen_llvm_ctx$llvm_mangle_method(target_type, method_name);
        __ring_match54: {
          const __ring_m54 = _Map_get(ctx.functions, mangled);
          if (__ring_m54._tag === "some") {
            const method_fn = __ring_m54._0;
...
function emit_wrapped_method_thunk(ctx, mangled, method_fn, method_name, dispatch_arity, inner_count) {
  ...
  __ring_match55: {
    const __ring_m55 = _Map_get(ctx.functions, thunk_name);
...
function gen_dict_dispatch_call(ctx, callee, args, dd) {
  ...
  __ring_match56: {
    ...
    __ring_match57: {
      const __ring_m57 = List_get(args, 0);
      if (__ring_m57._tag === "some") {
        const a = __ring_m57._0;
  ...
  let call_args = [];
  __ring_match58: {
    const __ring_m58 = recv_val;
    if (__ring_m58._tag === "some") {
      const rv = __ring_m58._0;
  ...
  for (let i = other_arg_start; i < __ring_end23; i++) {
    __ring_match59: {
      const __ring_m59 = List_get(args, i);
      if (__ring_m59._tag === "some") {
        const a = __ring_m59._0;
  ...
  __ring_match60: {
    const __ring_m60 = _Map_get(ctx.named_values, dd.dict_param);
    if (__ring_m60._tag === "some") {
      const dict_alloca = __ring_m60._0;
...
function get_trait_method_index(ctx, dict_param, method) {
  __ring_match61: {
    const __ring_m61 = trait_name_from_dict_param(dict_param);
    if (__ring_m61._tag === "some") {
      const trait_name = __ring_m61._0;
      __ring_match62: {
        const __ring_m62 = _Map_get(ctx.trait_method_order, trait_name);
        if (__ring_m62._tag === "some") {
          const order = __ring_m62._0;
          let idx = 0;
...
function trait_name_from_dict_param(dict_param) {
  ...
  __ring_match63: {
    const __ring_m63 = Str_index_of(rest, "_");
    if (__ring_m63._tag === "some") {
      const us = __ring_m63._0;
...
function gen_direct_call(ctx, name, arg_vals, dict_vals) {
  ...
  __ring_match64: {
    const __ring_m64 = rt_name;
    if (__ring_m64._tag === "some") {
      const rtn = __ring_m64._0;
  ...
  __ring_match65: {
    const __ring_m65 = found_fn;
    if (__ring_m65._tag === "some") {
      const fn_info = __ring_m65._0;
      ...
      __ring_match66: {
        const __ring_m66 = _Map_get(ctx.fn_evidence_params, fn_info.fn_mangled);
    ...
    if (__ring_m65._tag === "none") {
      __ring_match67: {
        ...
        if (__ring_m67._tag === "none") {
          ...
          __ring_match68: {
            const __ring_m68 = _Map_get(ctx.rt_fns, rt_fallback);
...
function find_fn_precise(ctx, name) {
  ...
  __ring_match70: {
    const __ring_m70 = step2;
    if (__ring_m70._tag === "some") {
      const fn_val = __ring_m70._0;
  ...
  __ring_match71: {
    const __ring_m71 = step3;
    if (__ring_m71._tag === "some") {
      const result = __ring_m71._0;
...
function find_function_in_ctx(ctx, mangled, name) {
  __ring_match74: {
    const __ring_m74 = _Map_get(ctx.functions, mangled);
    ...
    if (__ring_m74._tag === "none") {
      ...
      __ring_match75: {
        const __ring_m75 = _Map_get(ctx.functions, bare);
...
function lookup_evidence(ctx, ev_param_name) {
  __ring_match76: {
    const __ring_m76 = _Map_get(ctx.named_values, ev_param_name);
...
function gen_runtime_call(ctx, name, args) {
  __ring_match77: {
    const __ring_m77 = _Map_get(ctx.rt_fns, name);
...
function gen_method_call(ctx, recv, recv_type, method, args, dict_vals) {
  ...
  __ring_match78: {
    const __ring_m78 = rt_method;
    if (__ring_m78._tag === "some") {
      const base_rt_name = __ring_m78._0;
...
function gen_field_access(ctx, receiver, field, ty) {
  ...
  __ring_match83: {
    const __ring_m83 = _Map_get(ctx.struct_types, type_name);
...
function gen_struct_lit(ctx, name, fields, spread) {
  __ring_match84: {
    const __ring_m84 = _Map_get(ctx.struct_types, name);
    if (__ring_m84._tag === "some") {
      const info = __ring_m84._0;
      ...
      __ring_match85: {
        const __ring_m85 = spread;
        if (__ring_m85._tag === "some") {
          const spread_expr = __ring_m85._0;
...
function gen_block(ctx, stmts, tail) {
  ...
  __ring_match86: {
    const __ring_m86 = tail;
    if (__ring_m86._tag === "some") {
      const t = __ring_m86._0;
...
function gen_string_interp(ctx, parts) {
  ...
  while (true) {
    ...
    __ring_match87: {
      const __ring_m87 = part;
      if (__ring_m87._tag === "Literal") {
        const s = __ring_m87._0;
      ...
      if (__ring_m87._tag === "Expression") {
        const e = __ring_m87._0;
...
function gen_match_expr(ctx, scrutinee, arms, result_ty) {
  ...
  __ring_match89: {
    const __ring_m89 = enum_name;
    if (__ring_m89._tag === "some") {
      const ename = __ring_m89._0;
      __ring_match90: {
        const __ring_m90 = _Map_get(ctx.enum_types, ename);
        if (__ring_m90._tag === "some") {
          const enum_info = __ring_m90._0;
...
function gen_match_arm_enum(ctx, arm, scrut_val, enum_name, enum_info, switch_val, merge_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match91: {
    ...
    if (__ring_m91._tag === "Constructor") {
      const name = __ring_m91.name; const fields = __ring_m91.fields;
      __ring_match92: {
        const __ring_m92 = _Map_get(enum_info.variants, name);
        if (__ring_m92._tag === "some") {
          const vi = __ring_m92._0;
          ...
          for (let i = 0; i < __ring_end45; i++) {
            __ring_match93: {
              const __ring_m93 = List_get(fields, i);
              if (__ring_m93._tag === "some") {
                const field_pat = __ring_m93._0;
                __ring_match94: {
                  const __ring_m94 = field_pat;
                  if (__ring_m94._tag === "Binding") {
                    const bname = __ring_m94.name;
    ...
    if (__ring_m91._tag === "NamedConstructor") {
      const name = __ring_m91.name; const named_fields = __ring_m91.fields;
      __ring_match95: {
        const __ring_m95 = _Map_get(enum_info.variants, name);
        if (__ring_m95._tag === "some") {
          const vi = __ring_m95._0;
          const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.arm.${name}`);
          LLVMAddCase(switch_val, LLVMConstInt(ctx.i64_type, vi.tag, 0), arm_bb);
          LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          ...
          for (let i = 0; i < __ring_end46; i++) {
            __ring_match96: {
              const __ring_m96 = List_get(named_fields, i);
              if (__ring_m96._tag === "some") {
                const nf = __ring_m96._0;
                let field_idx = i;
  ...
  return Option_none;
        ...
        __ring_match98: {
          const __ring_m98 = alt_name;
          if (__ring_m98._tag === "some") {
            const an = __ring_m98._0;
            __ring_match99: {
              const __ring_m99 = _Map_get(enum_info.variants, an);
...
function bind_nested_pattern(ctx, val, pat) {
  __ring_match101: {
    ...
    if (__ring_m101._tag === "Constructor") {
      const name = __ring_m101.name; const qualifier = __ring_m101.qualifier; const fields = __ring_m101.fields;
      const enum_info = find_enum_by_variant(ctx, name, qualifier);
      __ring_match102: {
        const __ring_m102 = enum_info;
        if (__ring_m102._tag === "some") {
          const ei = __ring_m102._0;
    ...
    if (__ring_m101._tag === "TuplePattern") {
      const elements = __ring_m101.elements;
      const get_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_get", [ctx.ptr_type, ctx.i64_type], ctx.ptr_type);
      const get_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_get");
    ...
    if (__ring_m101._tag === "NamedConstructor") {
      const name = __ring_m101.name; const qualifier = __ring_m101.qualifier; const fields = __ring_m101.fields;
      const enum_info = find_enum_by_variant(ctx, name, qualifier);
      __ring_match105: {
        const __ring_m105 = enum_info;
        if (__ring_m105._tag === "some") {
          const ei = __ring_m105._0;
  ...
  __match_fail(__ring_m);
          ...
          for (let i = 0; i < __ring_end51; i++) {
            __ring_match106: {
              const __ring_m106 = List_get(fields, i);
              if (__ring_m106._tag === "some") {
                const nf = __ring_m106._0;
                let field_idx = i;
...
function emit_match_arm_body(ctx, arm, merge_bb, next_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match107: {
    const __ring_m107 = arm.guard;
    if (__ring_m107._tag === "some") {
      const g = __ring_m107._0;
...
function gen_match_if_else(ctx, scrut_val, scrut_ty, arms, merge_bb, default_bb, current_fn) {
  ...
  for (let i = 0; i < __ring_end53; i++) {
    __ring_match108: {
      const __ring_m108 = List_get(arms, i);
      if (__ring_m108._tag === "some") {
        const arm = __ring_m108._0;
  ...
  __match_fail(__ring_m);
        ...
        __ring_match109: {
          ...
          if (__ring_m109._tag === "Literal") {
            const value = __ring_m109.value;
          ...
          if (__ring_m109._tag === "Constructor") {
            const cname = __ring_m109.name; const qualifier = __ring_m109.qualifier; const fields = __ring_m109.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
          ...
          if (__ring_m109._tag === "NamedConstructor") {
            const cname = __ring_m109.name; const qualifier = __ring_m109.qualifier; const nfields = __ring_m109.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.ctor.${cname}`);
            gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, arm_bb, next_bb, current_fn);
            LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          ...
          if (__ring_m109._tag === "OrPattern") {
            const patterns = __ring_m109.patterns;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            ...
            for (let k = 0; k < __ring_end54; k++) {
              __ring_match110: {
                const __ring_m110 = List_get(palts, k);
                if (__ring_m110._tag === "some") {
                  const alt = __ring_m110._0;
  ...
  return Option_none;
                  ...
                  __ring_match111: {
                    const __ring_m111 = alt_ref;
                    if (__ring_m111._tag === "some") {
                      const ar = __ring_m111._0;
                      const __ring_dt2 = ar;
          ...
          if (__ring_m109._tag === "TuplePattern") {
            const elements = __ring_m109.elements;
            const get_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_get", [ctx.ptr_type, ctx.i64_type], ctx.ptr_type);
            const get_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_get");
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            ...
            for (let j = 0; j < __ring_end55; j++) {
              __ring_match112: {
                const __ring_m112 = List_get(elements, j);
                if (__ring_m112._tag === "some") {
                  const elem_pat = __ring_m112._0;
  ...
  return Option_none;
                  ...
                  __ring_match113: {
                    const __ring_m113 = ctor_ref;
                    if (__ring_m113._tag === "some") {
                      const cref = __ring_m113._0;
                      ...
                      __ring_match114: {
                        const __ring_m114 = ei;
                        if (__ring_m114._tag === "some") {
                          const enum_info = __ring_m114._0;
                          __ring_match115: {
                            const __ring_m115 = _Map_get(enum_info.variants, cname);
                    ...
                    if (__ring_m113._tag === "none") {
                      __ring_match116: {
                        const __ring_m116 = elem_pat;
                        if (__ring_m116._tag === "Literal") {
                          const value = __ring_m116.value;
                          const idx = LLVMConstInt(ctx.i64_type, j, 0);
            ...
            for (let j = 0; j < __ring_end56; j++) {
              __ring_match117: {
                const __ring_m117 = List_get(elements, j);
                if (__ring_m117._tag === "some") {
                  const elem_pat = __ring_m117._0;
                  __ring_match118: {
                    const __ring_m118 = elem_pat;
...
function gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, match_bb, miss_bb, current_fn) {
  const ei = find_enum_by_variant(ctx, cname, qualifier);
  __ring_match119: {
    const __ring_m119 = ei;
    if (__ring_m119._tag === "some") {
      const enum_info = __ring_m119._0;
      __ring_match120: {
        const __ring_m120 = _Map_get(enum_info.variants, cname);
...
function bind_constructor_fields(ctx, scrut_val, cname, qualifier, fields) {
  const ei = find_enum_by_variant(ctx, cname, qualifier);
  __ring_match121: {
    const __ring_m121 = ei;
    if (__ring_m121._tag === "some") {
      const enum_info = __ring_m121._0;
      const __ring_end57 = List_len(fields);
      for (let i = 0; i < __ring_end57; i++) {
        __ring_match122: {
          const __ring_m122 = List_get(fields, i);
          if (__ring_m122._tag === "some") {
            const field_pat = __ring_m122._0;
            __ring_match123: {
              const __ring_m123 = field_pat;
...
function bind_named_constructor_fields(ctx, scrut_val, cname, qualifier, named_fields) {
  const ei = find_enum_by_variant(ctx, cname, qualifier);
  __ring_match124: {
    const __ring_m124 = ei;
    if (__ring_m124._tag === "some") {
      const enum_info = __ring_m124._0;
      __ring_match125: {
        const __ring_m125 = _Map_get(enum_info.variants, cname);
        if (__ring_m125._tag === "some") {
          const vi = __ring_m125._0;
          const __ring_end58 = List_len(named_fields);
          for (let i = 0; i < __ring_end58; i++) {
            __ring_match126: {
              const __ring_m126 = List_get(named_fields, i);
              if (__ring_m126._tag === "some") {
                const nf = __ring_m126._0;
                let field_idx = i;
...
function find_enum_by_variant(ctx, variant_name, qualifier) {
  __ring_match128: {
    const __ring_m128 = qualifier;
    if (__ring_m128._tag === "some") {
      const q = __ring_m128._0;
      __ring_match129: {
        const __ring_m129 = _Map_get(ctx.enum_types, q);
  ...
  __ring_match130: {
    const __ring_m130 = _Map_get(ctx.enum_types, variant_name);
    if (__ring_m130._tag === "some") {
      const ei = __ring_m130._0;
      return Option_some(ei);
  ...
  while (true) {
    ...
    __ring_match131: {
      const __ring_m131 = _Map_get(einfo.variants, variant_name);
...
function gen_literal_pattern_cond(ctx, scrut_val, scrut_ty, value) {
  __ring_match134: {
    ...
    if (__ring_m134._tag === "BoolVal") {
      const b = __ring_m134._0;
      const unbox_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_unbox_bool", [ctx.ptr_type], ctx.i64_type);
      const unbox_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_unbox_bool");
    ...
    if (__ring_m134._tag === "StrVal") {
      const s = __ring_m134._0;
...
function gen_named_variant_construct(ctx, enum_name, variant_name, fields) {
  __ring_match135: {
    const __ring_m135 = _Map_get(ctx.enum_types, enum_name);
    if (__ring_m135._tag === "some") {
      const enum_info = __ring_m135._0;
      __ring_match136: {
        const __ring_m136 = _Map_get(enum_info.variants, variant_name);
        if (__ring_m136._tag === "some") {
          const vi = __ring_m136._0;
          ...
          for (let i = 0; i < __ring_end62; i++) {
            __ring_match137: {
              const __ring_m137 = List_get(fields, i);
    ...
    if (__ring_m135._tag === "none") {
      ...
      __ring_match138: {
        const __ring_m138 = _Map_get(ctx.functions, ctor_name);
...
function gen_lambda(ctx, params, return_type, body, ty) {
  ...
  for (let i = 0; i < __ring_end69; i++) {
    __ring_match140: {
      const __ring_m140 = List_get(params, i);
      if (__ring_m140._tag === "some") {
        const p = __ring_m140._0;
  ...
  for (let i = 0; i < __ring_end70; i++) {
    __ring_match141: {
      const __ring_m141 = List_get(captures, i);
      if (__ring_m141._tag === "some") {
        const cap_name = __ring_m141._0;
...
function consider_capture_name(ctx, name, resolved_name, params, captures) {
  ...
  __ring_match142: {
    const __ring_m142 = _Map_get(ctx.functions, mangled2);
    ...
    if (__ring_m142._tag === "none") {
      ...
      __ring_match143: {
        const __ring_m143 = _Map_get(ctx.functions, mangled3);
...
function collect_dispatch_dict(ctx, dispatch, params, captures) {
  __ring_match144: {
    const __ring_m144 = dispatch;
    if (__ring_m144._tag === "some") {
      const d = __ring_m144._0;
      __ring_match145: {
        const __ring_m145 = d;
        if (__ring_m145._tag === "Dict") {
          const param = __ring_m145.param;
          return consider_capture_name(ctx, param, Option_none, params, captures);
          break __ring_match145;
        }
        if (__ring_m145._tag === "Direct") {
          const dict = __ring_m145.dict; const extra_dicts = __ring_m145.extra_dicts;
...
function collect_dictref_names(ctx, dr, params, captures) {
  __ring_match146: {
    const __ring_m146 = dr;
    if (__ring_m146._tag === "Simple") {
      const name = __ring_m146._0;
      return consider_capture_name(ctx, name, Option_none, params, captures);
      break __ring_match146;
    }
    if (__ring_m146._tag === "Static") {
      break __ring_match146;
    }
    if (__ring_m146._tag === "Wrapped") {
      const dict = __ring_m146.dict; const inner_dicts = __ring_m146.inner_dicts;
      consider_capture_name(ctx, dict, Option_none, params, captures);
...
function collect_captures(ctx, expr, params, captures) {
  __ring_match147: {
    const __ring_m147 = expr;
    if (__ring_m147._tag === "Ident") {
      const name = __ring_m147.name; const resolved_name = __ring_m147.resolved_name;
      return consider_capture_name(ctx, name, resolved_name, params, captures);
      break __ring_match147;
    }
    if (__ring_m147._tag === "BinOp") {
      const left = __ring_m147.left; const right = __ring_m147.right; const eq_dispatch = __ring_m147.eq_dispatch; const ord_dispatch = __ring_m147.ord_dispatch;
    ...
    if (__ring_m147._tag === "UnaryOp") {
      const operand = __ring_m147.operand;
      return collect_captures(ctx, operand, params, captures);
      break __ring_match147;
    }
    if (__ring_m147._tag === "Call") {
      const callee = __ring_m147.callee; const args = __ring_m147.args; const resolved_dicts = __ring_m147.resolved_dicts; const dict_dispatch = __ring_m147.dict_dispatch;
      ...
      __ring_match148: {
        const __ring_m148 = dict_dispatch;
        if (__ring_m148._tag === "some") {
          const dd = __ring_m148._0;
    ...
    if (__ring_m147._tag === "DictConstruct") {
      const inner = __ring_m147.inner;
    ...
    if (__ring_m147._tag === "Block") {
      const stmts = __ring_m147.stmts; const tail = __ring_m147.tail;
    ...
    if (__ring_m147._tag === "IfExpr") {
      const condition = __ring_m147.condition; const then_branch = __ring_m147.then_branch; const else_branch = __ring_m147.else_branch;
      collect_captures(ctx, condition, params, captures);
      collect_captures(ctx, then_branch, params, captures);
      __ring_match150: {
        const __ring_m150 = else_branch;
        if (__ring_m150._tag === "some") {
          const eb = __ring_m150._0;
    ...
    if (__ring_m147._tag === "MatchExpr") {
      const scrutinee = __ring_m147.scrutinee; const arms = __ring_m147.arms;
    ...
    if (__ring_m147._tag === "StringInterp") {
      const parts = __ring_m147.parts;
      ...
      while (true) {
        ...
        __ring_match151: {
          const __ring_m151 = part;
          if (__ring_m151._tag === "Expression") {
            const e = __ring_m151._0;
    ...
    if (__ring_m147._tag === "StructLit") {
      const fields = __ring_m147.fields; const spread = __ring_m147.spread;
    ...
    if (__ring_m147._tag === "ListLit") {
      const elements = __ring_m147.elements;
    ...
    if (__ring_m147._tag === "IndexExpr") {
      const receiver = __ring_m147.receiver; const index = __ring_m147.index;
      collect_captures(ctx, receiver, params, captures);
      return collect_captures(ctx, index, params, captures);
      break __ring_match147;
    }
    if (__ring_m147._tag === "Lambda") {
      const lb = __ring_m147.body;
      return collect_captures(ctx, lb, params, captures);
      break __ring_match147;
    }
    if (__ring_m147._tag === "NamedVariantConstruct") {
      const nvc_fields = __ring_m147.fields; const nvc_spread = __ring_m147.spread;
      ...
      __ring_match153: {
        const __ring_m153 = nvc_spread;
        if (__ring_m153._tag === "some") {
          const sp = __ring_m153._0;
          return collect_captures(ctx, sp, params, captures);
    ...
    if (__ring_m147._tag === "TryCatch") {
      const tc_body = __ring_m147.body; const tc_arms = __ring_m147.arms;
    ...
    if (__ring_m147._tag === "HandleExpr") {
      const he_body = __ring_m147.body;
      return collect_captures(ctx, he_body, params, captures);
      break __ring_match147;
    }
    if (__ring_m147._tag === "EffectOp") {
      const eo_eff = __ring_m147.effect_name; const eo_args = __ring_m147.args;
    ...
    if (__ring_m147._tag === "RangeExpr") {
      const rs = __ring_m147.start; const re = __ring_m147.end;
      collect_captures(ctx, rs, params, captures);
      return collect_captures(ctx, re, params, captures);
      break __ring_match147;
    }
    if (__ring_m147._tag === "Clone") {
      const inner = __ring_m147.inner;
...
function collect_captures_stmt(ctx, stmt, params, captures) {
  __ring_match154: {
    const __ring_m154 = stmt;
    if (__ring_m154._tag === "Let") {
      const init = __ring_m154.init;
      return collect_captures(ctx, init, params, captures);
      break __ring_match154;
    }
    if (__ring_m154._tag === "Var") {
      const init = __ring_m154.init;
      return collect_captures(ctx, init, params, captures);
      break __ring_match154;
    }
    if (__ring_m154._tag === "Assign") {
      const target = __ring_m154.target; const value = __ring_m154.value;
      collect_captures(ctx, target, params, captures);
      return collect_captures(ctx, value, params, captures);
      break __ring_match154;
    }
    if (__ring_m154._tag === "ExprStmt") {
      const expr = __ring_m154.expr;
      return collect_captures(ctx, expr, params, captures);
      break __ring_match154;
    }
    if (__ring_m154._tag === "Return") {
      const value = __ring_m154.value;
      __ring_match155: {
        const __ring_m155 = value;
        if (__ring_m155._tag === "some") {
          const v = __ring_m155._0;
    ...
    if (__ring_m154._tag === "While") {
      const condition = __ring_m154.condition; const body = __ring_m154.body;
      collect_captures(ctx, condition, params, captures);
      return collect_captures(ctx, body, params, captures);
      break __ring_match154;
    }
    if (__ring_m154._tag === "ForIn") {
      const iterable = __ring_m154.iterable; const body = __ring_m154.body;
      collect_captures(ctx, iterable, params, captures);
      return collect_captures(ctx, body, params, captures);
      break __ring_match154;
    }
    if (__ring_m154._tag === "LetDestructure") {
      const init = __ring_m154.init;
      return collect_captures(ctx, init, params, captures);
      break __ring_match154;
    }
    if (__ring_m154._tag === "IfLet") {
      const expr = __ring_m154.expr; const then_block = __ring_m154.then_block; const else_block = __ring_m154.else_block;
      collect_captures(ctx, expr, params, captures);
      collect_captures(ctx, then_block, params, captures);
      __ring_match156: {
        const __ring_m156 = else_block;
        if (__ring_m156._tag === "some") {
          const eb = __ring_m156._0;
          return collect_captures(ctx, eb, params, captures);
    ...
    if (__ring_m154._tag === "Drop") {
      const name = __ring_m154.name;
      return consider_capture_name(ctx, name, Option_none, params, captures);
      break __ring_match154;
    }
    if (__ring_m154._tag === "Dup") {
      const name = __ring_m154.name;
      return consider_capture_name(ctx, name, Option_none, params, captures);
      break __ring_match154;
    }
...
function gen_catch_closure(ctx, arms) {
  ...
  for (let i = 0; i < __ring_end90; i++) {
    __ring_match158: {
      const __ring_m158 = List_get(captures, i);
      if (__ring_m158._tag === "some") {
        const cap_name = __ring_m158._0;
        const cap_val = (function() {
  const __ring_m = _Map_get(ctx.named_values, cap_name);
  if (__ring_m._tag === "some") { const alloca = __ring_m._0; return LLVMBuildLoad2(ctx.builder, ctx.ptr_type, alloca, codegen_llvm_ctx$fresh_name(ctx, "cv")); }
  if (__ring_m._tag === "none") { return LLVMConstPointerNull(ctx.ptr_type); }
...
function gen_handle_expr(ctx, body, handlers) {
  ...
  while (true) {
    ...
    __ring_match160: {
      const __ring_m160 = _Map_get(by_effect, h.effect_name);
      if (__ring_m160._tag === "some") {
        const existing = __ring_m160._0;
