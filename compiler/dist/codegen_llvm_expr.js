...
function get_or_create_dict_global(ctx, name) {
  __ring_match52: {
    const __ring_m52 = _Map_get(ctx.dict_singletons, name);
    if (__ring_m52._tag === "some") {
      const g = __ring_m52._0;
      return g;
...
function emit_memoised_dict_getter(ctx, name, build_fn, build_fn_ty) {
  ...
  __ring_match53: {
    const __ring_m53 = _Map_get(ctx.functions, fname);
    if (__ring_m53._tag === "some") {
      const existing = __ring_m53._0;
      return existing;
...
function get_or_create_static_dict_getter(ctx, name) {
  const fname = `ring_dict_init_${name}`;
  __ring_match54: {
    const __ring_m54 = _Map_get(ctx.functions, fname);
...
function gen_dict_dispatch_call(ctx, callee, args, dd) {
  ...
  __ring_match58: {
    ...
    __ring_match59: {
      const __ring_m59 = List_get(args, 0);
  ...
  let call_args = [];
  __ring_match60: {
    const __ring_m60 = recv_val;
    if (__ring_m60._tag === "some") {
      const rv = __ring_m60._0;
  ...
  for (let i = other_arg_start; i < __ring_end23; i++) {
    __ring_match61: {
      const __ring_m61 = List_get(args, i);
  ...
  __ring_match62: {
    const __ring_m62 = _Map_get(ctx.named_values, dd.dict_param);
    if (__ring_m62._tag === "some") {
      const dict_alloca = __ring_m62._0;
...
function get_trait_method_index(ctx, dict_param, method) {
  __ring_match63: {
    const __ring_m63 = trait_name_from_dict_param(dict_param);
    if (__ring_m63._tag === "some") {
      const trait_name = __ring_m63._0;
      __ring_match64: {
        const __ring_m64 = _Map_get(ctx.trait_method_order, trait_name);
        if (__ring_m64._tag === "some") {
          const order = __ring_m64._0;
          let idx = 0;
...
function trait_name_from_dict_param(dict_param) {
  ...
  __ring_match65: {
    const __ring_m65 = Str_index_of(rest, "_");
    if (__ring_m65._tag === "some") {
      const us = __ring_m65._0;
...
function gen_direct_call(ctx, name, arg_vals, dict_vals) {
  ...
  __ring_match66: {
    const __ring_m66 = rt_name;
    if (__ring_m66._tag === "some") {
      const rtn = __ring_m66._0;
  ...
  __ring_match67: {
    const __ring_m67 = found_fn;
    if (__ring_m67._tag === "some") {
      const fn_info = __ring_m67._0;
      ...
      __ring_match68: {
        const __ring_m68 = _Map_get(ctx.fn_evidence_params, fn_info.fn_mangled);
        if (__ring_m68._tag === "some") {
          const ev_params = __ring_m68._0;
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m67._tag === "none") {
      __ring_match69: {
        const __ring_m69 = _Map_get(ctx.named_values, name);
        ...
        if (__ring_m69._tag === "none") {
          ...
          __ring_match70: {
            const __ring_m70 = _Map_get(ctx.rt_fns, rt_fallback);
...
function find_fn_precise(ctx, name) {
  ...
  __ring_match71: {
    const __ring_m71 = step1;
    if (__ring_m71._tag === "some") {
      const fn_val = __ring_m71._0;
  ...
  __ring_match73: {
    const __ring_m73 = step3;
    if (__ring_m73._tag === "some") {
      const result = __ring_m73._0;
...
function find_function_in_ctx(ctx, mangled, name) {
  __ring_match76: {
    ...
    if (__ring_m76._tag === "none") {
      ...
      __ring_match77: {
        const __ring_m77 = _Map_get(ctx.functions, bare);
...
function lookup_evidence(ctx, ev_param_name) {
  __ring_match78: {
    const __ring_m78 = _Map_get(ctx.named_values, ev_param_name);
...
function gen_method_call(ctx, recv, recv_type, method, args, dict_vals) {
  ...
  __ring_match80: {
    const __ring_m80 = rt_method;
    if (__ring_m80._tag === "some") {
      const base_rt_name = __ring_m80._0;
...
function ensure_runtime_method(ctx, name, arg_count) {
  __ring_match83: {
    const __ring_m83 = _Map_get(ctx.rt_fns, name);
    if (__ring_m83._tag === "some") {
      const f = __ring_m83._0;
      return f;
...
function gen_field_access(ctx, receiver, field, ty) {
  ...
  __ring_match85: {
    const __ring_m85 = _Map_get(ctx.struct_types, type_name);
    if (__ring_m85._tag === "some") {
      const info = __ring_m85._0;
      let field_idx = (-1);
...
function gen_struct_lit(ctx, name, fields, spread) {
  __ring_match86: {
    const __ring_m86 = _Map_get(ctx.struct_types, name);
    if (__ring_m86._tag === "some") {
      const info = __ring_m86._0;
      ...
      __ring_match87: {
        const __ring_m87 = spread;
        if (__ring_m87._tag === "some") {
          const spread_expr = __ring_m87._0;
...
function gen_block(ctx, stmts, tail) {
  ...
  __ring_match88: {
    const __ring_m88 = tail;
    if (__ring_m88._tag === "some") {
      const t = __ring_m88._0;
...
function gen_string_interp(ctx, parts) {
  ...
  while (true) {
    ...
    __ring_match89: {
      ...
      if (__ring_m89._tag === "Literal") {
        const s = __ring_m89._0;
...
function gen_match_expr(ctx, scrutinee, arms, result_ty) {
  ...
  __ring_match91: {
    const __ring_m91 = enum_name;
    if (__ring_m91._tag === "some") {
      const ename = __ring_m91._0;
      __ring_match92: {
        const __ring_m92 = _Map_get(ctx.enum_types, ename);
        if (__ring_m92._tag === "some") {
          const enum_info = __ring_m92._0;
...
function gen_match_arm_enum(ctx, arm, scrut_val, enum_name, enum_info, switch_val, merge_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match93: {
    const __ring_m93 = arm.pattern;
    if (__ring_m93._tag === "Constructor") {
      const name = __ring_m93.name; const fields = __ring_m93.fields;
      __ring_match94: {
        ...
        if (__ring_m94._tag === "some") {
          ...
          for (let i = 0; i < __ring_end45; i++) {
            __ring_match95: {
              const __ring_m95 = List_get(fields, i);
              if (__ring_m95._tag === "some") {
                const field_pat = __ring_m95._0;
                __ring_match96: {
                  const __ring_m96 = field_pat;
    ...
    if (__ring_m93._tag === "NamedConstructor") {
      const name = __ring_m93.name; const named_fields = __ring_m93.fields;
      __ring_match97: {
        const __ring_m97 = _Map_get(enum_info.variants, name);
        if (__ring_m97._tag === "some") {
          ...
          for (let i = 0; i < __ring_end46; i++) {
            __ring_match98: {
              const __ring_m98 = List_get(named_fields, i);
              if (__ring_m98._tag === "some") {
                const nf = __ring_m98._0;
                let field_idx = i;
    ...
    if (__ring_m93._tag === "OrPattern") {
      const patterns = __ring_m93.patterns;
  ...
  return Option_none;
        ...
        __ring_match100: {
          const __ring_m100 = alt_name;
          if (__ring_m100._tag === "some") {
            const an = __ring_m100._0;
            __ring_match101: {
              const __ring_m101 = _Map_get(enum_info.variants, an);
...
function gen_match_arm_wildcard(ctx, arm, scrut_val, default_bb, merge_bb, phi_vals, phi_bbs) {
  LLVMPositionBuilderAtEnd(ctx.builder, default_bb);
  __ring_match102: {
    const __ring_m102 = arm.pattern;
    if (__ring_m102._tag === "Binding") {
      const bname = __ring_m102.name;
      const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
...
function bind_nested_pattern(ctx, val, pat) {
  __ring_match103: {
    const __ring_m103 = pat;
    if (__ring_m103._tag === "Binding") {
      const name = __ring_m103.name;
    ...
    if (__ring_m103._tag === "Constructor") {
      const name = __ring_m103.name; const qualifier = __ring_m103.qualifier; const fields = __ring_m103.fields;
    ...
    if (__ring_m103._tag === "TuplePattern") {
      ...
      for (let i = 0; i < __ring_end50; i++) {
        __ring_match106: {
          const __ring_m106 = List_get(elements, i);
          if (__ring_m106._tag === "some") {
            const ep = __ring_m106._0;
    ...
    if (__ring_m103._tag === "NamedConstructor") {
      const name = __ring_m103.name; const qualifier = __ring_m103.qualifier; const fields = __ring_m103.fields;
      const enum_info = find_enum_by_variant(ctx, name, qualifier);
      __ring_match107: {
        const __ring_m107 = enum_info;
        if (__ring_m107._tag === "some") {
          const ei = __ring_m107._0;
  ...
  __match_fail(__ring_m);
          ...
          for (let i = 0; i < __ring_end51; i++) {
            __ring_match108: {
              const __ring_m108 = List_get(fields, i);
...
function emit_match_arm_body(ctx, arm, merge_bb, next_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match109: {
    const __ring_m109 = arm.guard;
    if (__ring_m109._tag === "some") {
      const g = __ring_m109._0;
...
function gen_match_if_else(ctx, scrut_val, scrut_ty, arms, merge_bb, default_bb, current_fn) {
  ...
  for (let i = 0; i < __ring_end53; i++) {
    __ring_match110: {
      const __ring_m110 = List_get(arms, i);
      if (__ring_m110._tag === "some") {
        const arm = __ring_m110._0;
  ...
  __match_fail(__ring_m);
        ...
        __ring_match111: {
          const __ring_m111 = arm.pattern;
          if (__ring_m111._tag === "Wildcard") {
            open_block = false;
          ...
          if (__ring_m111._tag === "Binding") {
            const bname = __ring_m111.name;
            open_block = false;
            const next_bb = ((has_guard && (is_last === false)) ? LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next") : default_bb);
          ...
          if (__ring_m111._tag === "Literal") {
            const value = __ring_m111.value;
          ...
          if (__ring_m111._tag === "Constructor") {
            const cname = __ring_m111.name; const qualifier = __ring_m111.qualifier; const fields = __ring_m111.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
          ...
          if (__ring_m111._tag === "NamedConstructor") {
            const cname = __ring_m111.name; const qualifier = __ring_m111.qualifier; const nfields = __ring_m111.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.ctor.${cname}`);
            gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, arm_bb, next_bb, current_fn);
            LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          ...
          if (__ring_m111._tag === "OrPattern") {
            const patterns = __ring_m111.patterns;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            ...
            for (let k = 0; k < __ring_end54; k++) {
              __ring_match112: {
                const __ring_m112 = List_get(palts, k);
                if (__ring_m112._tag === "some") {
                  const alt = __ring_m112._0;
  ...
  return Option_none;
                  ...
                  __ring_match113: {
                    const __ring_m113 = alt_ref;
                    if (__ring_m113._tag === "some") {
                      const ar = __ring_m113._0;
                      const __ring_dt2 = ar;
          ...
          if (__ring_m111._tag === "TuplePattern") {
            const elements = __ring_m111.elements;
            const get_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_get", [ctx.ptr_type, ctx.i64_type], ctx.ptr_type);
            const get_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_get");
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            ...
            for (let j = 0; j < __ring_end55; j++) {
              __ring_match114: {
                const __ring_m114 = List_get(elements, j);
                if (__ring_m114._tag === "some") {
                  const elem_pat = __ring_m114._0;
  ...
  return Option_none;
                  ...
                  __ring_match115: {
                    const __ring_m115 = ctor_ref;
                    if (__ring_m115._tag === "some") {
                      const cref = __ring_m115._0;
                      ...
                      __ring_match116: {
                        const __ring_m116 = ei;
                        if (__ring_m116._tag === "some") {
                          const enum_info = __ring_m116._0;
                          __ring_match117: {
                            const __ring_m117 = _Map_get(enum_info.variants, cname);
                    ...
                    if (__ring_m115._tag === "none") {
                      __ring_match118: {
                        ...
                        if (__ring_m118._tag === "Literal") {
                          const value = __ring_m118.value;
                          const idx = LLVMConstInt(ctx.i64_type, j, 0);
            ...
            for (let j = 0; j < __ring_end56; j++) {
              __ring_match119: {
                const __ring_m119 = List_get(elements, j);
                if (__ring_m119._tag === "some") {
                  const elem_pat = __ring_m119._0;
                  __ring_match120: {
...
function gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, match_bb, miss_bb, current_fn) {
  ...
  __ring_match121: {
    ...
    if (__ring_m121._tag === "some") {
      ...
      __ring_match122: {
        const __ring_m122 = _Map_get(enum_info.variants, cname);
  ...
  __ring_match123: {
    ...
    if (__ring_m123._tag === "some") {
      ...
      for (let i = 0; i < __ring_end57; i++) {
        __ring_match124: {
          const __ring_m124 = List_get(fields, i);
          if (__ring_m124._tag === "some") {
            const field_pat = __ring_m124._0;
            __ring_match125: {
              const __ring_m125 = field_pat;
      ...
      __ring_match127: {
        ...
        if (__ring_m127._tag === "some") {
          ...
          for (let i = 0; i < __ring_end58; i++) {
            __ring_match128: {
              const __ring_m128 = List_get(named_fields, i);
              if (__ring_m128._tag === "some") {
                const nf = __ring_m128._0;
                let field_idx = i;
                ...
                __ring_match129: {
                  const __ring_m129 = nf.pattern;
                  if (__ring_m129._tag === "Binding") {
                    const bname = __ring_m129.name;
                    const field_ptr = LLVMBuildStructGEP2(ctx.builder, enum_info.llvm_type, scrut_val, (field_idx + 1), codegen_llvm_ctx$fresh_name(ctx, "ef"));
                    const field_val = LLVMBuildLoad2(ctx.builder, ctx.ptr_type, field_ptr, codegen_llvm_ctx$fresh_name(ctx, bname));
                    const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
                    discard(LLVMBuildStore(ctx.builder, field_val, alloca));
...
function find_enum_by_variant(ctx, variant_name, qualifier) {
  __ring_match130: {
    const __ring_m130 = qualifier;
    if (__ring_m130._tag === "some") {
      const q = __ring_m130._0;
      __ring_match131: {
        const __ring_m131 = _Map_get(ctx.enum_types, q);
        if (__ring_m131._tag === "some") {
          const ei = __ring_m131._0;
  ...
  __ring_match132: {
    const __ring_m132 = _Map_get(ctx.enum_types, variant_name);
    if (__ring_m132._tag === "some") {
      const ei = __ring_m132._0;
      return Option_some(ei);
  ...
  while (true) {
    ...
    __ring_match133: {
      const __ring_m133 = _Map_get(einfo.variants, variant_name);
...
function tuple_element_type(ty, idx) {
  __ring_match134: {
    ...
    if (__ring_m134._tag === "TupleType") {
      const elements = __ring_m134.elements;
      __ring_match135: {
        const __ring_m135 = List_get(elements, idx);
...
function gen_literal_pattern_cond(ctx, scrut_val, scrut_ty, value) {
  __ring_match136: {
    const __ring_m136 = value;
    if (__ring_m136._tag === "IntVal") {
      const n = __ring_m136._0;
      const unbox_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_unbox_int", [ctx.ptr_type], ctx.i64_type);
      const unbox_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_unbox_int");
    ...
    if (__ring_m136._tag === "BoolVal") {
      const b = __ring_m136._0;
      const unbox_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_unbox_bool", [ctx.ptr_type], ctx.i64_type);
      const unbox_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_unbox_bool");
    ...
    if (__ring_m136._tag === "StrVal") {
      const s = __ring_m136._0;
...
function gen_lambda(ctx, params, return_type, body, ty) {
  ...
  for (let i = 0; i < __ring_end69; i++) {
    __ring_match142: {
      const __ring_m142 = List_get(params, i);
      if (__ring_m142._tag === "some") {
        const p = __ring_m142._0;
...
function consider_capture_name(ctx, name, resolved_name, params, captures) {
  ...
  __ring_match144: {
    const __ring_m144 = _Map_get(ctx.functions, mangled2);
    ...
    if (__ring_m144._tag === "none") {
      ...
      __ring_match145: {
        const __ring_m145 = _Map_get(ctx.functions, mangled3);
...
function collect_dispatch_dict(ctx, dispatch, params, captures) {
  __ring_match146: {
    const __ring_m146 = dispatch;
    if (__ring_m146._tag === "some") {
      const d = __ring_m146._0;
      __ring_match147: {
        const __ring_m147 = d;
        if (__ring_m147._tag === "Dict") {
          const param = __ring_m147.param;
          return consider_capture_name(ctx, param, Option_none, params, captures);
          break __ring_match147;
        }
        if (__ring_m147._tag === "Direct") {
          const dict = __ring_m147.dict; const extra_dicts = __ring_m147.extra_dicts;
...
function collect_dictref_names(ctx, dr, params, captures) {
  __ring_match148: {
    const __ring_m148 = dr;
    if (__ring_m148._tag === "Simple") {
      const name = __ring_m148._0;
      return consider_capture_name(ctx, name, Option_none, params, captures);
      break __ring_match148;
    }
    if (__ring_m148._tag === "Static") {
      break __ring_match148;
    }
    if (__ring_m148._tag === "Wrapped") {
      const dict = __ring_m148.dict; const inner_dicts = __ring_m148.inner_dicts;
      consider_capture_name(ctx, dict, Option_none, params, captures);
...
function collect_captures(ctx, expr, params, captures) {
  __ring_match149: {
    ...
    if (__ring_m149._tag === "BinOp") {
      const left = __ring_m149.left; const right = __ring_m149.right; const eq_dispatch = __ring_m149.eq_dispatch; const ord_dispatch = __ring_m149.ord_dispatch;
    ...
    if (__ring_m149._tag === "UnaryOp") {
      const operand = __ring_m149.operand;
      return collect_captures(ctx, operand, params, captures);
      break __ring_match149;
    }
    if (__ring_m149._tag === "Call") {
      const callee = __ring_m149.callee; const args = __ring_m149.args; const resolved_dicts = __ring_m149.resolved_dicts; const dict_dispatch = __ring_m149.dict_dispatch;
    ...
    if (__ring_m149._tag === "DictConstruct") {
      const inner = __ring_m149.inner;
    ...
    if (__ring_m149._tag === "Block") {
      const stmts = __ring_m149.stmts; const tail = __ring_m149.tail;
    ...
    if (__ring_m149._tag === "IfExpr") {
      const condition = __ring_m149.condition; const then_branch = __ring_m149.then_branch; const else_branch = __ring_m149.else_branch;
    ...
    if (__ring_m149._tag === "MatchExpr") {
      const scrutinee = __ring_m149.scrutinee; const arms = __ring_m149.arms;
    ...
    if (__ring_m149._tag === "StringInterp") {
      const parts = __ring_m149.parts;
      ...
      while (true) {
        ...
        __ring_match153: {
          const __ring_m153 = part;
          if (__ring_m153._tag === "Expression") {
            const e = __ring_m153._0;
    ...
    if (__ring_m149._tag === "StructLit") {
      const fields = __ring_m149.fields; const spread = __ring_m149.spread;
    ...
    if (__ring_m149._tag === "ListLit") {
      const elements = __ring_m149.elements;
    ...
    if (__ring_m149._tag === "IndexExpr") {
      const receiver = __ring_m149.receiver; const index = __ring_m149.index;
      collect_captures(ctx, receiver, params, captures);
      return collect_captures(ctx, index, params, captures);
      break __ring_match149;
    }
    if (__ring_m149._tag === "Lambda") {
      const lb = __ring_m149.body;
      return collect_captures(ctx, lb, params, captures);
      break __ring_match149;
    }
    if (__ring_m149._tag === "NamedVariantConstruct") {
      const nvc_fields = __ring_m149.fields; const nvc_spread = __ring_m149.spread;
      ...
      __ring_match155: {
        const __ring_m155 = nvc_spread;
        if (__ring_m155._tag === "some") {
          const sp = __ring_m155._0;
          return collect_captures(ctx, sp, params, captures);
    ...
    if (__ring_m149._tag === "TryCatch") {
      const tc_body = __ring_m149.body; const tc_arms = __ring_m149.arms;
    ...
    if (__ring_m149._tag === "HandleExpr") {
      const he_body = __ring_m149.body;
      return collect_captures(ctx, he_body, params, captures);
      break __ring_match149;
    }
    if (__ring_m149._tag === "EffectOp") {
      const eo_eff = __ring_m149.effect_name; const eo_args = __ring_m149.args;
    ...
    if (__ring_m149._tag === "RangeExpr") {
      const rs = __ring_m149.start; const re = __ring_m149.end;
      collect_captures(ctx, rs, params, captures);
      return collect_captures(ctx, re, params, captures);
      break __ring_match149;
    }
    if (__ring_m149._tag === "Clone") {
      const inner = __ring_m149.inner;
...
function collect_captures_stmt(ctx, stmt, params, captures) {
  __ring_match156: {
    const __ring_m156 = stmt;
    if (__ring_m156._tag === "Let") {
      const init = __ring_m156.init;
      return collect_captures(ctx, init, params, captures);
      break __ring_match156;
    }
    if (__ring_m156._tag === "Var") {
      const init = __ring_m156.init;
      return collect_captures(ctx, init, params, captures);
      break __ring_match156;
    }
    if (__ring_m156._tag === "Assign") {
      const target = __ring_m156.target; const value = __ring_m156.value;
      collect_captures(ctx, target, params, captures);
      return collect_captures(ctx, value, params, captures);
      break __ring_match156;
    }
    if (__ring_m156._tag === "ExprStmt") {
      const expr = __ring_m156.expr;
      return collect_captures(ctx, expr, params, captures);
      break __ring_match156;
    }
    if (__ring_m156._tag === "Return") {
      const value = __ring_m156.value;
      __ring_match157: {
        const __ring_m157 = value;
        if (__ring_m157._tag === "some") {
          const v = __ring_m157._0;
    ...
    if (__ring_m156._tag === "While") {
      const condition = __ring_m156.condition; const body = __ring_m156.body;
      collect_captures(ctx, condition, params, captures);
      return collect_captures(ctx, body, params, captures);
      break __ring_match156;
    }
    if (__ring_m156._tag === "ForIn") {
      const iterable = __ring_m156.iterable; const body = __ring_m156.body;
      collect_captures(ctx, iterable, params, captures);
      return collect_captures(ctx, body, params, captures);
      break __ring_match156;
    }
    if (__ring_m156._tag === "LetDestructure") {
      const init = __ring_m156.init;
      return collect_captures(ctx, init, params, captures);
      break __ring_match156;
    }
    if (__ring_m156._tag === "IfLet") {
      const expr = __ring_m156.expr; const then_block = __ring_m156.then_block; const else_block = __ring_m156.else_block;
      collect_captures(ctx, expr, params, captures);
      collect_captures(ctx, then_block, params, captures);
      __ring_match158: {
        const __ring_m158 = else_block;
        if (__ring_m158._tag === "some") {
          const eb = __ring_m158._0;
          return collect_captures(ctx, eb, params, captures);
    ...
    if (__ring_m156._tag === "Drop") {
      const name = __ring_m156.name;
      return consider_capture_name(ctx, name, Option_none, params, captures);
      break __ring_match156;
    }
    if (__ring_m156._tag === "Dup") {
      const name = __ring_m156.name;
      return consider_capture_name(ctx, name, Option_none, params, captures);
      break __ring_match156;
    }
...
function gen_catch_closure(ctx, arms) {
  ...
  for (let i = 0; i < __ring_end89; i++) {
    __ring_match159: {
      const __ring_m159 = List_get(captures, i);
      if (__ring_m159._tag === "some") {
        const cap_name = __ring_m159._0;
  ...
  for (let i = 0; i < __ring_end90; i++) {
    __ring_match160: {
      const __ring_m160 = List_get(captures, i);
      if (__ring_m160._tag === "some") {
        const cap_name = __ring_m160._0;
        const cap_val = (function() {
  const __ring_m = _Map_get(ctx.named_values, cap_name);
  if (__ring_m._tag === "some") { const alloca = __ring_m._0; return LLVMBuildLoad2(ctx.builder, ctx.ptr_type, alloca, codegen_llvm_ctx$fresh_name(ctx, "cv")); }
  if (__ring_m._tag === "none") { return LLVMConstPointerNull(ctx.ptr_type); }
...
function gen_handle_expr(ctx, body, handlers) {
  ...
  while (true) {
    ...
    __ring_match162: {
      const __ring_m162 = _Map_get(by_effect, h.effect_name);
      if (__ring_m162._tag === "some") {
        const existing = __ring_m162._0;
