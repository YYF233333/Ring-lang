...
function get_or_declare_setjmp(ctx) {
  ...
  __ring_match109: {
    ...
    if (__ring_m109._tag === "none") {
      const fn_ty = LLVMFunctionType(ctx.i32_type, [ctx.ptr_type], 0);
...
function call_zero_arg_or_return(ctx, fn_val, mangled) {
  __ring_match111: {
    const __ring_m111 = _Map_get(ctx.fn_types, mangled);
    if (__ring_m111._tag === "some") {
      const fn_ty = __ring_m111._0;
...
function gen_dict_closure_wrapper(ctx, lookup_name, name, dict_names, ty) {
  ...
  let __ring_blk21;
  __ring_match112: {
    const __ring_m112 = found;
    if (__ring_m112._tag === "some") {
      const fi = __ring_m112._0;
      __ring_blk21 = fi;
  ...
  let __ring_blk22;
  __ring_match113: {
    const __ring_m113 = _Map_get(ctx.fn_types, fn_info.fn_mangled);
    if (__ring_m113._tag === "some") {
      const t = __ring_m113._0;
      __ring_blk22 = t;
  ...
  let __ring_blk23;
  __ring_match114: {
    const __ring_m114 = ty;
    if (__ring_m114._tag === "FnType") {
      const params = __ring_m114.params;
  ...
  let ev_vals = [];
  __ring_match115: {
    const __ring_m115 = _Map_get(ctx.fn_evidence_params, fn_info.fn_mangled);
...
function gen_ident(ctx, name, resolved_name, def_id, dict_closure_dicts, ty) {
  __ring_match116: {
    const __ring_m116 = dict_closure_dicts;
    if (__ring_m116._tag === "some") {
      const dicts = __ring_m116._0;
      if ((List_len(dicts) > 0)) {
        let __ring_blk24;
        __ring_match117: {
          const __ring_m117 = resolved_name;
          if (__ring_m117._tag === "some") {
            const rn = __ring_m117._0;
            __ring_blk24 = rn;
  ...
  let __ring_blk25;
  __ring_match118: {
    const __ring_m118 = resolved_name;
    if (__ring_m118._tag === "some") {
      const rn = __ring_m118._0;
      __ring_blk25 = rn;
  ...
  __ring_match119: {
    const __ring_m119 = _Map_get(ctx.named_values, lookup_name);
    ...
    if (__ring_m119._tag === "none") {
      __ring_match120: {
        const __ring_m120 = _Map_get(ctx.named_values, name);
        if (__ring_m120._tag === "some") {
          const alloca = __ring_m120._0;
        ...
        if (__ring_m120._tag === "none") {
          ...
          __ring_match121: {
            const __ring_m121 = _Map_get(ctx.functions, mangled_resolved);
            ...
            if (__ring_m121._tag === "none") {
              ...
              __ring_match122: {
                const __ring_m122 = _Map_get(ctx.functions, mangled_bare);
                ...
                if (__ring_m122._tag === "none") {
                  ...
                  __ring_match123: {
                    const __ring_m123 = _Map_get(ctx.functions, mangled_name_resolved);
                    ...
                    if (__ring_m123._tag === "none") {
                      ...
                      __ring_match124: {
                        const __ring_m124 = _Map_get(ctx.functions, mangled_lu);
                        ...
                        if (__ring_m124._tag === "none") {
                          ...
                          __ring_match125: {
                            const __ring_m125 = found;
                            if (__ring_m125._tag === "some") {
                              const fi = __ring_m125._0;
                            ...
                            if (__ring_m125._tag === "none") {
                              ...
                              __ring_match126: {
                                const __ring_m126 = found2;
                                if (__ring_m126._tag === "some") {
                                  const fi2 = __ring_m126._0;
...
function gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, match_bb, miss_bb, current_fn) {
  const ei = find_enum_by_variant(ctx, cname, qualifier);
  __ring_match127: {
    const __ring_m127 = ei;
    if (__ring_m127._tag === "some") {
      const enum_info = __ring_m127._0;
      __ring_match128: {
        const __ring_m128 = _Map_get(enum_info.variants, cname);
        if (__ring_m128._tag === "some") {
          const vi = __ring_m128._0;
...
function gen_literal_pattern_cond(ctx, scrut_val, scrut_ty, value) {
  __ring_match129: {
    const __ring_m129 = value;
    if (__ring_m129._tag === "IntVal") {
    ...
    if (__ring_m129._tag === "BoolVal") {
      const b = __ring_m129._0;
      const raw = unbox_int(ctx, scrut_val);
      const lit = (b ? LLVMConstInt(ctx.i64_type, 1, 0) : LLVMConstInt(ctx.i64_type, 0, 0));
      return LLVMBuildICmp(ctx.builder, 32, raw, lit, codegen_llvm_ctx$fresh_name(ctx, "eq"));
      break __ring_match129;
    }
    if (__ring_m129._tag === "StrVal") {
      const s = __ring_m129._0;
...
function tuple_element_type(ty, idx) {
  __ring_match130: {
    ...
    if (__ring_m130._tag === "TupleType") {
      const elements = __ring_m130.elements;
      __ring_match131: {
        const __ring_m131 = List_get(elements, idx);
...
function gen_unaryop(ctx, op, operand, ty) {
  ...
  __ring_match132: {
    const __ring_m132 = op;
    if (__ring_m132._tag === "Neg") {
      if (is_int_type(ty)) {
        const raw = unbox_int(ctx, val);
...
function gen_try_catch(ctx, body, arms) {
  let __ring_blk26;
  __ring_match134: {
    const __ring_m134 = ctx.current_fn;
    if (__ring_m134._tag === "some") {
      const f = __ring_m134._0;
      __ring_blk26 = f;
  ...
  const sjresult = LLVMBuildCall2(ctx.builder, sj[1], sj[0], [buf_ptr], codegen_llvm_ctx$fresh_name(ctx, "sj"));
...
function gen_struct_lit(ctx, name, fields, spread) {
  __ring_match135: {
    const __ring_m135 = _Map_get(ctx.struct_types, name);
    if (__ring_m135._tag === "some") {
      const info = __ring_m135._0;
      ...
      __ring_match136: {
        const __ring_m136 = spread;
        if (__ring_m136._tag === "some") {
          const spread_expr = __ring_m136._0;
...
function gen_string_interp(ctx, parts) {
  ...
  while (true) {
    ...
    __ring_match137: {
      const __ring_m137 = part;
      if (__ring_m137._tag === "Literal") {
        const s = __ring_m137._0;
      ...
      if (__ring_m137._tag === "Expression") {
        const e = __ring_m137._0;
...
function emit_match_arm_body(ctx, arm, merge_bb, next_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match143: {
    const __ring_m143 = arm.guard;
    if (__ring_m143._tag === "some") {
      const g = __ring_m143._0;
...
function gen_match_if_else(ctx, scrut_val, scrut_ty, arms, merge_bb, default_bb, current_fn) {
  ...
  for (let i = 0; i < __ring_end67; i++) {
    __ring_match144: {
      const __ring_m144 = List_get(arms, i);
      if (__ring_m144._tag === "some") {
        const arm = __ring_m144._0;
        ...
        __ring_match146: {
          ...
          if (__ring_m146._tag === "Literal") {
            const value = __ring_m146.value;
          ...
          if (__ring_m146._tag === "Constructor") {
            const cname = __ring_m146.name; const qualifier = __ring_m146.qualifier; const fields = __ring_m146.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
          ...
          if (__ring_m146._tag === "NamedConstructor") {
            const cname = __ring_m146.name; const qualifier = __ring_m146.qualifier; const nfields = __ring_m146.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.ctor.${cname}`);
            gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, arm_bb, next_bb, current_fn);
            LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          ...
          if (__ring_m146._tag === "OrPattern") {
            const patterns = __ring_m146.patterns;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            ...
            for (let k = 0; k < __ring_end68; k++) {
              __ring_match147: {
                const __ring_m147 = List_get(palts, k);
                if (__ring_m147._tag === "some") {
                  const alt = __ring_m147._0;
                  let __ring_blk29;
                  __ring_match148: {
                    const __ring_m148 = alt;
                    if (__ring_m148._tag === "Constructor") {
                      const an = __ring_m148.name; const aq = __ring_m148.qualifier;
                  ...
                  __ring_match149: {
                    const __ring_m149 = alt_ref;
                    if (__ring_m149._tag === "some") {
                      const ar = __ring_m149._0;
                      const __ring_dt3 = ar;
          ...
          if (__ring_m146._tag === "TuplePattern") {
            const elements = __ring_m146.elements;
            const get_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_get", [ctx.ptr_type, ctx.i64_type], ctx.ptr_type);
            const get_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_get");
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            ...
            for (let j = 0; j < __ring_end69; j++) {
              __ring_match150: {
                const __ring_m150 = List_get(elements, j);
                if (__ring_m150._tag === "some") {
                  const elem_pat = __ring_m150._0;
                  let __ring_blk30;
                  __ring_match151: {
                    const __ring_m151 = elem_pat;
                    if (__ring_m151._tag === "Constructor") {
                      const cname = __ring_m151.name; const qualifier = __ring_m151.qualifier;
                      __ring_blk30 = Option_some([cname, qualifier]);
                      break __ring_match151;
                    }
                    if (__ring_m151._tag === "NamedConstructor") {
                      const cname = __ring_m151.name; const qualifier = __ring_m151.qualifier;
                      __ring_blk30 = Option_some([cname, qualifier]);
                      break __ring_match151;
                    }
                  ...
                  __ring_match152: {
                    const __ring_m152 = ctor_ref;
                    if (__ring_m152._tag === "some") {
                      const cref = __ring_m152._0;
                      ...
                      const ei = find_enum_by_variant(ctx, cname, qualifier);
                      __ring_match153: {
                        const __ring_m153 = ei;
                        if (__ring_m153._tag === "some") {
                          const enum_info = __ring_m153._0;
                          __ring_match154: {
                            const __ring_m154 = _Map_get(enum_info.variants, cname);
                            if (__ring_m154._tag === "some") {
                              const vi = __ring_m154._0;
                    ...
                    if (__ring_m152._tag === "none") {
                      __ring_match155: {
                        const __ring_m155 = elem_pat;
                        if (__ring_m155._tag === "Literal") {
                          const value = __ring_m155.value;
                          const idx = LLVMConstInt(ctx.i64_type, j, 0);
            ...
            for (let j = 0; j < __ring_end70; j++) {
              __ring_match156: {
                const __ring_m156 = List_get(elements, j);
                if (__ring_m156._tag === "some") {
                  const elem_pat = __ring_m156._0;
                  __ring_match157: {
...
function gen_match_arm_wildcard(ctx, arm, scrut_val, default_bb, merge_bb, phi_vals, phi_bbs) {
  ...
  __ring_match158: {
    ...
    if (__ring_m158._tag === "Binding") {
      const bname = __ring_m158.name;
      const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
      discard(LLVMBuildStore(ctx.builder, scrut_val, alloca));
      _Map_insert(ctx.named_values, bname, alloca);
...
function gen_match_arm_enum(ctx, arm, scrut_val, enum_name, enum_info, switch_val, merge_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match159: {
    ...
    if (__ring_m159._tag === "Constructor") {
      ...
      __ring_match160: {
        const __ring_m160 = _Map_get(enum_info.variants, name);
        if (__ring_m160._tag === "some") {
          const vi = __ring_m160._0;
          ...
          for (let i = 0; i < __ring_end71; i++) {
            __ring_match161: {
              const __ring_m161 = List_get(fields, i);
              if (__ring_m161._tag === "some") {
                const field_pat = __ring_m161._0;
                __ring_match162: {
                  const __ring_m162 = field_pat;
                  if (__ring_m162._tag === "Binding") {
                    const bname = __ring_m162.name;
                    const field_ptr = LLVMBuildStructGEP2(ctx.builder, enum_info.llvm_type, scrut_val, (i + 1), codegen_llvm_ctx$fresh_name(ctx, "ef"));
                    const field_val = LLVMBuildLoad2(ctx.builder, ctx.ptr_type, field_ptr, codegen_llvm_ctx$fresh_name(ctx, bname));
                    const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
                    discard(LLVMBuildStore(ctx.builder, field_val, alloca));
    ...
    if (__ring_m159._tag === "NamedConstructor") {
      const name = __ring_m159.name; const named_fields = __ring_m159.fields;
      __ring_match163: {
        const __ring_m163 = _Map_get(enum_info.variants, name);
        if (__ring_m163._tag === "some") {
          const vi = __ring_m163._0;
          const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.arm.${name}`);
          LLVMAddCase(switch_val, LLVMConstInt(ctx.i64_type, vi.tag, 0), arm_bb);
          LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          ...
          for (let i = 0; i < __ring_end72; i++) {
            __ring_match164: {
              const __ring_m164 = List_get(named_fields, i);
              if (__ring_m164._tag === "some") {
                const nf = __ring_m164._0;
                let field_idx = i;
                ...
                __ring_match165: {
                  const __ring_m165 = nf.pattern;
                  if (__ring_m165._tag === "Binding") {
                    const bname = __ring_m165.name;
                    const field_ptr = LLVMBuildStructGEP2(ctx.builder, enum_info.llvm_type, scrut_val, (field_idx + 1), codegen_llvm_ctx$fresh_name(ctx, "ef"));
                    const field_val = LLVMBuildLoad2(ctx.builder, ctx.ptr_type, field_ptr, codegen_llvm_ctx$fresh_name(ctx, bname));
                    const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
                    discard(LLVMBuildStore(ctx.builder, field_val, alloca));
    ...
    if (__ring_m159._tag === "OrPattern") {
      const patterns = __ring_m159.patterns;
      ...
      while (true) {
        ...
        __ring_match167: {
          const __ring_m167 = alt_name;
          if (__ring_m167._tag === "some") {
            const an = __ring_m167._0;
            __ring_match168: {
              const __ring_m168 = _Map_get(enum_info.variants, an);
              if (__ring_m168._tag === "some") {
                const vi = __ring_m168._0;
                LLVMAddCase(switch_val, LLVMConstInt(ctx.i64_type, vi.tag, 0), arm_bb);
...
function gen_index_expr(ctx, receiver, index, ty) {
  ...
  let __ring_blk35;
  __ring_match175: {
    const __ring_m175 = types$type_to_builtin_name(recv_type);
    if (__ring_m175._tag === "some") {
      const n = __ring_m175._0;
      __ring_blk35 = n;
...
function gen_handle_expr(ctx, body, handlers) {
  ...
  while (true) {
    ...
    __ring_match178: {
      const __ring_m178 = _Map_get(by_effect, h.effect_name);
      if (__ring_m178._tag === "some") {
        const existing = __ring_m178._0;
  ...
  if (has_fail_abort) {
    let __ring_blk38;
    __ring_match179: {
      const __ring_m179 = ctx.current_fn;
      if (__ring_m179._tag === "some") {
        const f = __ring_m179._0;
        __ring_blk38 = f;
...
function gen_effect_op(ctx, effect_name, op_name, args) {
  if (((effect_name === "fail") ? (op_name === "raise") : false)) {
    ...
    let __ring_blk42;
    __ring_match185: {
      const __ring_m185 = _Map_get(ctx.effect_ops, effect_name);
      if (__ring_m185._tag === "some") {
        const ops = __ring_m185._0;
...
function gen_mut_arg_llvm(ctx, arg) {
  __ring_match186: {
    const __ring_m186 = arg;
    if (__ring_m186._tag === "Ident") {
      const name = __ring_m186.name; const resolved_name = __ring_m186.resolved_name; const def_id = __ring_m186.def_id;
      if (is_boxed_def(ctx, def_id)) {
        let __ring_blk43;
        __ring_match187: {
          const __ring_m187 = resolved_name;
          if (__ring_m187._tag === "some") {
            const rn = __ring_m187._0;
            __ring_blk43 = rn;
        ...
        __ring_match188: {
          const __ring_m188 = _Map_get(ctx.named_values, lookup_name);
          ...
          if (__ring_m188._tag === "none") {
            __ring_match189: {
              const __ring_m189 = _Map_get(ctx.named_values, name);
              if (__ring_m189._tag === "some") {
                const alloca = __ring_m189._0;
                return LLVMBuildLoad2(ctx.builder, ctx.ptr_type, alloca, codegen_llvm_ctx$fresh_name(ctx, "mcell"));
...
function gen_dict_dispatch_call(ctx, callee, args, dd) {
  ...
  __ring_match190: {
    const __ring_m190 = callee;
    if (__ring_m190._tag === "FieldAccess") {
      const receiver = __ring_m190.receiver;
      recv_val = Option_some(gen_llvm_expr(ctx, receiver));
      break __ring_match190;
    }
    __ring_match191: {
      const __ring_m191 = List_get(args, 0);
  ...
  let call_args = [];
  __ring_match192: {
    const __ring_m192 = recv_val;
    if (__ring_m192._tag === "some") {
      const rv = __ring_m192._0;
  ...
  for (let i = other_arg_start; i < __ring_end85; i++) {
    __ring_match193: {
      const __ring_m193 = List_get(args, i);
  ...
  let __ring_blk44;
  __ring_match194: {
    const __ring_m194 = _Map_get(ctx.named_values, dd.dict_param);
    if (__ring_m194._tag === "some") {
      const dict_alloca = __ring_m194._0;
...
function gen_call(ctx, callee, args, resolved_dicts, dict_dispatch, result_ty, effects) {
  __ring_match195: {
    const __ring_m195 = dict_dispatch;
    if (__ring_m195._tag === "some") {
      const dd = __ring_m195._0;
  ...
  while (true) {
    ...
    let __ring_blk45;
    __ring_match196: {
      const __ring_m196 = mut_flags;
      if (__ring_m196._tag === "some") {
        const flags = __ring_m196._0;
        let __ring_blk46;
        __ring_match197: {
          const __ring_m197 = List_get(flags, argi);
  ...
  let __ring_blk47;
  __ring_match198: {
    const __ring_m198 = callee;
    if (__ring_m198._tag === "Ident") {
      const name = __ring_m198.name; const resolved_name = __ring_m198.resolved_name;
      let __ring_blk48;
      __ring_match199: {
        const __ring_m199 = resolved_name;
        if (__ring_m199._tag === "some") {
          const rn = __ring_m199._0;
          __ring_blk48 = rn;
    ...
    if (__ring_m198._tag === "FieldAccess") {
      const receiver = __ring_m198.receiver; const field = __ring_m198.field;
      const recv_val = gen_llvm_expr(ctx, receiver);
      const recv_type = hir$hexpr_type(receiver);
...
function gen_block(ctx, stmts, tail) {
  ...
  __ring_match202: {
    const __ring_m202 = tail;
    if (__ring_m202._tag === "some") {
      const t = __ring_m202._0;
...
function gen_ord_dispatch_llvm(ctx, op, left, right, dispatch) {
  ...
  __ring_match203: {
    ...
    if (__ring_m203._tag === "Lt") {
      __ring_blk49 = 40;
      break __ring_match203;
    }
    if (__ring_m203._tag === "Lte") {
      __ring_blk49 = 41;
      break __ring_match203;
    }
    if (__ring_m203._tag === "Gt") {
      __ring_blk49 = 38;
      break __ring_match203;
    }
    if (__ring_m203._tag === "Gte") {
      __ring_blk49 = 39;
      break __ring_match203;
    }
    __ring_blk49 = 32;
...
function gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch, result_ty) {
  ...
  __ring_match207: {
    ...
    if (__ring_m207._tag === "Lt") {
      __ring_blk51 = true;
      break __ring_match207;
    }
    if (__ring_m207._tag === "Lte") {
      __ring_blk51 = true;
      break __ring_match207;
    }
    if (__ring_m207._tag === "Gt") {
      __ring_blk51 = true;
      break __ring_match207;
    }
    if (__ring_m207._tag === "Gte") {
      __ring_blk51 = true;
      break __ring_match207;
    }
    __ring_blk51 = false;
  ...
  if (is_ord_op) {
    __ring_match210: {
      const __ring_m210 = ord_dispatch;
...
function gen_llvm_expr(ctx, expr) {
  __ring_match212: {
    const __ring_m212 = expr;
    if (__ring_m212._tag === "IntLit") {
      const value = __ring_m212.value;
      return gen_int_lit(ctx, value);
      break __ring_match212;
    }
    if (__ring_m212._tag === "FloatLit") {
      const value = __ring_m212.value;
      return gen_float_lit(ctx, value);
      break __ring_match212;
    }
    if (__ring_m212._tag === "StrLit") {
      const value = __ring_m212.value;
      return gen_str_lit(ctx, value);
      break __ring_match212;
    }
    if (__ring_m212._tag === "BoolLit") {
      const value = __ring_m212.value;
      return gen_bool_lit(ctx, value);
      break __ring_match212;
    }
    if (__ring_m212._tag === "Ident") {
      const name = __ring_m212.name; const resolved_name = __ring_m212.resolved_name; const def_id = __ring_m212.def_id; const dict_closure_dicts = __ring_m212.dict_closure_dicts; const ty = __ring_m212.ty;
      return gen_ident(ctx, name, resolved_name, def_id, dict_closure_dicts, ty);
      break __ring_match212;
    }
    if (__ring_m212._tag === "BinOp") {
      const op = __ring_m212.op; const left = __ring_m212.left; const right = __ring_m212.right; const eq_dispatch = __ring_m212.eq_dispatch; const ord_dispatch = __ring_m212.ord_dispatch; const ty = __ring_m212.ty;
      return gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch, ty);
      break __ring_match212;
    }
    if (__ring_m212._tag === "UnaryOp") {
      const op = __ring_m212.op; const operand = __ring_m212.operand; const ty = __ring_m212.ty;
      return gen_unaryop(ctx, op, operand, ty);
      break __ring_match212;
    }
    if (__ring_m212._tag === "Call") {
      const callee = __ring_m212.callee; const args = __ring_m212.args; const resolved_dicts = __ring_m212.resolved_dicts; const dict_dispatch = __ring_m212.dict_dispatch; const ty = __ring_m212.ty; const effects = __ring_m212.effects;
      return gen_call(ctx, callee, args, resolved_dicts, dict_dispatch, ty, effects);
      break __ring_match212;
    }
    if (__ring_m212._tag === "DictConstruct") {
      const base_dict = __ring_m212.base_dict; const trait_name = __ring_m212.trait_name; const inner = __ring_m212.inner;
      return build_wrapped_dict(ctx, base_dict, trait_name, inner);
      break __ring_match212;
    }
    if (__ring_m212._tag === "FieldAccess") {
      const receiver = __ring_m212.receiver; const field = __ring_m212.field; const ty = __ring_m212.ty;
      return gen_field_access(ctx, receiver, field, ty);
      break __ring_match212;
    }
    if (__ring_m212._tag === "StructLit") {
      const name = __ring_m212.name; const fields = __ring_m212.fields; const spread = __ring_m212.spread;
      return gen_struct_lit(ctx, name, fields, spread);
      break __ring_match212;
    }
    if (__ring_m212._tag === "Block") {
      const stmts = __ring_m212.stmts; const tail = __ring_m212.tail;
      return gen_block(ctx, stmts, tail);
      break __ring_match212;
    }
    if (__ring_m212._tag === "IfExpr") {
      const condition = __ring_m212.condition; const then_branch = __ring_m212.then_branch; const else_branch = __ring_m212.else_branch;
      return gen_if_expr(ctx, condition, then_branch, else_branch);
      break __ring_match212;
    }
    if (__ring_m212._tag === "StringInterp") {
      const parts = __ring_m212.parts;
      return gen_string_interp(ctx, parts);
      break __ring_match212;
    }
    if (__ring_m212._tag === "Lambda") {
      const params = __ring_m212.params; const return_type = __ring_m212.return_type; const body = __ring_m212.body; const ty = __ring_m212.ty;
      return gen_lambda(ctx, params, return_type, body, ty);
      break __ring_match212;
    }
    if (__ring_m212._tag === "MatchExpr") {
      const scrutinee = __ring_m212.scrutinee; const arms = __ring_m212.arms; const ty = __ring_m212.ty;
      return gen_match_expr(ctx, scrutinee, arms, ty);
      break __ring_match212;
    }
    if (__ring_m212._tag === "NamedVariantConstruct") {
      const enum_name = __ring_m212.enum_name; const variant_name = __ring_m212.variant_name; const fields = __ring_m212.fields;
      return gen_named_variant_construct(ctx, enum_name, variant_name, fields);
      break __ring_match212;
    }
    if (__ring_m212._tag === "TryCatch") {
      const body = __ring_m212.body; const arms = __ring_m212.arms;
      return gen_try_catch(ctx, body, arms);
      break __ring_match212;
    }
    if (__ring_m212._tag === "HandleExpr") {
      const body = __ring_m212.body; const handlers = __ring_m212.handlers;
      return gen_handle_expr(ctx, body, handlers);
      break __ring_match212;
    }
    if (__ring_m212._tag === "EffectOp") {
      const effect_name = __ring_m212.effect_name; const op_name = __ring_m212.op_name; const args = __ring_m212.args;
      return gen_effect_op(ctx, effect_name, op_name, args);
      break __ring_match212;
    }
    if (__ring_m212._tag === "RangeExpr") {
      const start = __ring_m212.start; const end = __ring_m212.end; const inclusive = __ring_m212.inclusive;
      return gen_range_expr(ctx, start, end, inclusive);
      break __ring_match212;
    }
    if (__ring_m212._tag === "ListLit") {
      const elements = __ring_m212.elements;
      return gen_list_lit(ctx, elements);
      break __ring_match212;
    }
    if (__ring_m212._tag === "TupleLit") {
      const elements = __ring_m212.elements;
      return gen_tuple_lit(ctx, elements);
      break __ring_match212;
    }
    if (__ring_m212._tag === "IndexExpr") {
      const receiver = __ring_m212.receiver; const index = __ring_m212.index; const ty = __ring_m212.ty;
      return gen_index_expr(ctx, receiver, index, ty);
      break __ring_match212;
    }
    if (__ring_m212._tag === "Clone") {
      const inner = __ring_m212.inner;
      return gen_clone(ctx, inner);
      break __ring_match212;
    }
    if (__ring_m212._tag === "ReturnExpr") {
      const value = __ring_m212.value;
      __ring_match213: {
        const __ring_m213 = value;
        if (__ring_m213._tag === "some") {
          const v = __ring_m213._0;
...
function gen_lambda(ctx, params, return_type, body, ty) {
  let __ring_blk52;
  __ring_match215: {
    const __ring_m215 = ctx.current_fn;
  ...
  for (let i = 0; i < __ring_end91; i++) {
    __ring_match217: {
      const __ring_m217 = List_get(params, i);
      if (__ring_m217._tag === "some") {
        const p = __ring_m217._0;
  ...
  for (let i = 0; i < __ring_end92; i++) {
    __ring_match218: {
      ...
      if (__ring_m218._tag === "some") {
        ...
        let __ring_blk53;
        __ring_match219: {
          const __ring_m219 = _Map_get(ctx.named_values, cap_name);
          if (__ring_m219._tag === "some") {
            const alloca = __ring_m219._0;
...
function build_handler_evidence(ctx, effect_name, hs) {
  let __ring_blk54;
  __ring_match220: {
    const __ring_m220 = _Map_get(ctx.effect_ops, effect_name);
    if (__ring_m220._tag === "some") {
      const ops = __ring_m220._0;
...
function emit_memoised_dict_getter(ctx, name, build_fn, build_fn_ty) {
  const fname = `ring_dict_init_${name}`;
  __ring_match221: {
    const __ring_m221 = _Map_get(ctx.functions, fname);
    if (__ring_m221._tag === "some") {
      const existing = __ring_m221._0;
      return existing;
