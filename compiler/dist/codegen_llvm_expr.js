...
function gen_literal_pattern_cond(ctx, scrut_val, scrut_ty, value) {
  __ring_match174: {
    const __ring_m174 = value;
    if (__ring_m174._tag === "IntVal") {
      const n = __ring_m174._0;
    ...
    if (__ring_m174._tag === "BoolVal") {
      const b = __ring_m174._0;
      const raw = unbox_int(ctx, scrut_val);
      const lit = (b ? LLVMConstInt(ctx.i64_type, 1, 0) : LLVMConstInt(ctx.i64_type, 0, 0));
      return LLVMBuildICmp(ctx.builder, 32, raw, lit, codegen_llvm_ctx$fresh_name(ctx, "eq"));
      break __ring_match174;
    }
    if (__ring_m174._tag === "StrVal") {
      const s = __ring_m174._0;
    ...
    if (__ring_m174._tag === "FloatVal") {
      const f = __ring_m174._0;
      const unbox_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_unbox_float", [ctx.ptr_type], ctx.double_type);
      const unbox_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_unbox_float");
...
function tuple_element_type(ty, idx) {
  __ring_match175: {
    const __ring_m175 = ty;
    if (__ring_m175._tag === "TupleType") {
      const elements = __ring_m175.elements;
      __ring_match176: {
        const __ring_m176 = List_get(elements, idx);
        if (__ring_m176._tag === "some") {
          const t = __ring_m176._0;
          return t;
...
function gen_unaryop(ctx, op, operand, ty) {
  ...
  __ring_match177: {
    const __ring_m177 = op;
    if (__ring_m177._tag === "Neg") {
      if (is_int_type(ty)) {
        const raw = unbox_int(ctx, val);
...
function gen_catch_arms(ctx, error_val, arms) {
  ...
  const __ring_iter_82 = __List_Iterable.iter(arms);
  while (true) {
    const __ring_next_82 = __ListIterator_Iterator.next(__ring_iter_82);
    if (__ring_next_82._tag === "none") break;
    const arm = __ring_next_82._0;
    __ring_match178: {
      const __ring_m178 = arm.pattern;
      if (__ring_m178._tag === "Constructor") {
        has_constructor = true;
        constructor_count = (constructor_count + 1);
        break __ring_match178;
      }
      if (__ring_m178._tag === "NamedConstructor") {
        has_constructor = true;
        constructor_count = (constructor_count + 1);
        break __ring_match178;
      }
  ...
  if (((!has_constructor) ? true : (List_len(arms) === 1))) {
    ...
    __ring_match179: {
      const __ring_m179 = arm.pattern;
      if (__ring_m179._tag === "Binding") {
        const name = __ring_m179.name;
        const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, name);
      ...
      if (__ring_m179._tag === "Wildcard") {
        return gen_llvm_expr(ctx, arm.body);
        break __ring_match179;
      }
      if (__ring_m179._tag === "Constructor") {
        const name = __ring_m179.name; const fields = __ring_m179.fields;
  ...
  const __ring_iter_83 = __List_Iterable.iter(arms);
  while (true) {
    const __ring_next_83 = __ListIterator_Iterator.next(__ring_iter_83);
    if (__ring_next_83._tag === "none") break;
    const arm = __ring_next_83._0;
    __ring_match180: {
      const __ring_m180 = arm.pattern;
      if (__ring_m180._tag === "Constructor") {
        const name = __ring_m180.name; const qualifier = __ring_m180.qualifier;
        enum_info_opt = find_enum_by_variant(ctx, name, qualifier);
        break __ring_match180;
      }
      if (__ring_m180._tag === "NamedConstructor") {
        const name = __ring_m180.name; const qualifier = __ring_m180.qualifier;
        enum_info_opt = find_enum_by_variant(ctx, name, qualifier);
        break __ring_match180;
      }
    ...
    __ring_match181: {
      const __ring_m181 = enum_info_opt;
  ...
  __ring_match182: {
    const __ring_m182 = enum_info_opt;
  ...
  let __ring_blk45;
  __ring_match183: {
    const __ring_m183 = enum_info_opt;
    if (__ring_m183._tag === "some") {
      const ei = __ring_m183._0;
      __ring_blk45 = ei;
  ...
  let __ring_blk46;
  __ring_match184: {
    const __ring_m184 = ctx.current_fn;
    if (__ring_m184._tag === "some") {
      const f = __ring_m184._0;
      __ring_blk46 = f;
  ...
  while (true) {
    ...
    __ring_match185: {
      ...
      if (__ring_m185._tag === "Constructor") {
        ...
        __ring_match186: {
          const __ring_m186 = _Map_get(enum_info.variants, name);
          if (__ring_m186._tag === "some") {
            ...
            const __ring_end85 = List_len(fields);
            for (let i = 0; i < __ring_end85; i++) {
              __ring_match187: {
                const __ring_m187 = List_get(fields, i);
                if (__ring_m187._tag === "some") {
                  const field_pat = __ring_m187._0;
                  __ring_match188: {
                    const __ring_m188 = field_pat;
                    if (__ring_m188._tag === "Binding") {
                      const bname = __ring_m188.name;
      ...
      if (__ring_m185._tag === "NamedConstructor") {
        const name = __ring_m185.name; const named_fields = __ring_m185.fields;
        __ring_match189: {
          const __ring_m189 = _Map_get(enum_info.variants, name);
          if (__ring_m189._tag === "some") {
            const vi = __ring_m189._0;
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `catch.arm.${name}`);
            LLVMAddCase(switch_val, LLVMConstInt(ctx.i64_type, vi.tag, 0), arm_bb);
            LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
            const __ring_end86 = List_len(named_fields);
            for (let i = 0; i < __ring_end86; i++) {
              __ring_match190: {
                const __ring_m190 = List_get(named_fields, i);
                if (__ring_m190._tag === "some") {
                  const nf = __ring_m190._0;
                  let field_idx = i;
                  const __ring_end87 = List_len(vi.field_names);
                  for (let fi = 0; fi < __ring_end87; fi++) {
                    if ((__ring_index(vi.field_names, fi) === nf.name)) {
                      field_idx = fi;
                    }
                  }
                  __ring_match191: {
                    const __ring_m191 = nf.pattern;
                    if (__ring_m191._tag === "Binding") {
                      const bname = __ring_m191.name;
...
function gen_try_catch(ctx, body, arms) {
  let __ring_blk47;
  __ring_match192: {
    const __ring_m192 = ctx.current_fn;
...
function gen_struct_lit(ctx, name, fields, spread) {
  __ring_match193: {
    const __ring_m193 = _Map_get(ctx.struct_types, name);
    if (__ring_m193._tag === "some") {
      const info = __ring_m193._0;
...
function gen_string_interp(ctx, parts) {
  ...
  const drop_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_drop", [ctx.ptr_type], ctx.void_type);
  const drop_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_drop");
  const __ring_iter_92 = __List_Iterable.iter(parts);
  while (true) {
    const __ring_next_92 = __ListIterator_Iterator.next(__ring_iter_92);
    if (__ring_next_92._tag === "none") break;
    const part = __ring_next_92._0;
    __ring_match195: {
      const __ring_m195 = part;
      if (__ring_m195._tag === "Literal") {
        const s = __ring_m195._0;
      ...
      if (__ring_m195._tag === "Expression") {
        const e = __ring_m195._0;
...
function gen_named_variant_construct(ctx, enum_name, variant_name, fields, spread) {
  __ring_match196: {
    const __ring_m196 = _Map_get(ctx.enum_types, enum_name);
    if (__ring_m196._tag === "some") {
      const enum_info = __ring_m196._0;
      __ring_match197: {
        const __ring_m197 = _Map_get(enum_info.variants, variant_name);
        if (__ring_m197._tag === "some") {
          const vi = __ring_m197._0;
          ...
          __ring_match198: {
            const __ring_m198 = spread;
            if (__ring_m198._tag === "some") {
              const spread_expr = __ring_m198._0;
              let overridden = set_new();
              ...
              const spread_val = gen_llvm_expr(ctx, spread_expr);
              const __ring_end94 = List_len(vi.field_names);
          ...
          const __ring_end95 = List_len(fields);
          for (let i = 0; i < __ring_end95; i++) {
            __ring_match199: {
              ...
              if (__ring_m199._tag === "some") {
                ...
                for (let fi = 0; fi < __ring_end96; fi++) {
    ...
    if (__ring_m196._tag === "none") {
      ...
      __ring_match200: {
        const __ring_m200 = _Map_get(ctx.functions, ctor_name);
        if (__ring_m200._tag === "some") {
          const fn_val = __ring_m200._0;
          let args = [];
          ...
          let __ring_blk48;
          __ring_match201: {
            const __ring_m201 = _Map_get(ctx.fn_types, ctor_name);
            if (__ring_m201._tag === "some") {
              const t = __ring_m201._0;
              __ring_blk48 = t;
...
function emit_match_arm_body(ctx, arm, merge_bb, next_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match202: {
    const __ring_m202 = arm.guard;
    if (__ring_m202._tag === "some") {
      const g = __ring_m202._0;
...
function gen_match_if_else(ctx, scrut_val, scrut_ty, arms, merge_bb, default_bb, current_fn) {
  ...
  const __ring_end98 = total;
  for (let i = 0; i < __ring_end98; i++) {
    __ring_match203: {
      const __ring_m203 = List_get(arms, i);
      if (__ring_m203._tag === "some") {
        const arm = __ring_m203._0;
        const is_last = (i === (total - 1));
        let __ring_blk49;
        __ring_match204: {
          const __ring_m204 = arm.guard;
        ...
        __ring_match205: {
          ...
          if (__ring_m205._tag === "Binding") {
            const bname = __ring_m205.name;
            open_block = false;
            const next_bb = ((has_guard ? (is_last === false) : false) ? LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next") : default_bb);
          ...
          if (__ring_m205._tag === "Literal") {
            const value = __ring_m205.value;
          ...
          if (__ring_m205._tag === "Constructor") {
            const cname = __ring_m205.name; const qualifier = __ring_m205.qualifier; const fields = __ring_m205.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
          ...
          if (__ring_m205._tag === "NamedConstructor") {
            const cname = __ring_m205.name; const qualifier = __ring_m205.qualifier; const nfields = __ring_m205.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.ctor.${cname}`);
            gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, arm_bb, next_bb, current_fn);
            LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          ...
          if (__ring_m205._tag === "OrPattern") {
            const patterns = __ring_m205.patterns;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.or");
            const palts = patterns;
            const nalts = List_len(palts);
            const __ring_end99 = nalts;
            for (let k = 0; k < __ring_end99; k++) {
              __ring_match206: {
                const __ring_m206 = List_get(palts, k);
                if (__ring_m206._tag === "some") {
                  const alt = __ring_m206._0;
                  let __ring_blk50;
                  __ring_match207: {
                    const __ring_m207 = alt;
                    if (__ring_m207._tag === "Constructor") {
                      const an = __ring_m207.name; const aq = __ring_m207.qualifier;
                      __ring_blk50 = Option_some([an, aq]);
                      break __ring_match207;
                    }
                    if (__ring_m207._tag === "NamedConstructor") {
                      const an = __ring_m207.name; const aq = __ring_m207.qualifier;
                      __ring_blk50 = Option_some([an, aq]);
                      break __ring_match207;
                    }
                  ...
                  __ring_match208: {
                    const __ring_m208 = alt_ref;
                    if (__ring_m208._tag === "some") {
                      const ar = __ring_m208._0;
                      const __ring_dt8 = ar;
          ...
          if (__ring_m205._tag === "TuplePattern") {
            const elements = __ring_m205.elements;
            const get_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_get", [ctx.ptr_type, ctx.i64_type], ctx.ptr_type);
            const get_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_get");
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const __ring_end100 = List_len(elements);
            for (let j = 0; j < __ring_end100; j++) {
              __ring_match209: {
                const __ring_m209 = List_get(elements, j);
                if (__ring_m209._tag === "some") {
                  const elem_pat = __ring_m209._0;
                  let __ring_blk51;
                  __ring_match210: {
                    const __ring_m210 = elem_pat;
                    if (__ring_m210._tag === "Constructor") {
                      const cname = __ring_m210.name; const qualifier = __ring_m210.qualifier;
                  ...
                  __ring_match211: {
                    const __ring_m211 = ctor_ref;
                    if (__ring_m211._tag === "some") {
                      const cref = __ring_m211._0;
                      ...
                      const ei = find_enum_by_variant(ctx, cname, qualifier);
                      __ring_match212: {
                        const __ring_m212 = ei;
                        if (__ring_m212._tag === "some") {
                          const enum_info = __ring_m212._0;
                          __ring_match213: {
                            const __ring_m213 = _Map_get(enum_info.variants, cname);
                            if (__ring_m213._tag === "some") {
                              const vi = __ring_m213._0;
                    ...
                    if (__ring_m211._tag === "none") {
                      __ring_match214: {
                        const __ring_m214 = elem_pat;
                        if (__ring_m214._tag === "Literal") {
                          const value = __ring_m214.value;
                          const idx = LLVMConstInt(ctx.i64_type, j, 0);
            ...
            const __ring_end101 = List_len(elements);
            for (let j = 0; j < __ring_end101; j++) {
              __ring_match215: {
                const __ring_m215 = List_get(elements, j);
                if (__ring_m215._tag === "some") {
                  const elem_pat = __ring_m215._0;
                  __ring_match216: {
                    const __ring_m216 = elem_pat;
                    if (__ring_m216._tag === "Binding") {
                      const bname = __ring_m216.name;
                      const idx = LLVMConstInt(ctx.i64_type, j, 0);
...
function gen_match_arm_enum(ctx, arm, scrut_val, enum_name, enum_info, switch_val, merge_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match218: {
    const __ring_m218 = arm.pattern;
    if (__ring_m218._tag === "Constructor") {
      const name = __ring_m218.name; const fields = __ring_m218.fields;
      __ring_match219: {
        const __ring_m219 = _Map_get(enum_info.variants, name);
        if (__ring_m219._tag === "some") {
          const vi = __ring_m219._0;
          ...
          for (let i = 0; i < __ring_end102; i++) {
            __ring_match220: {
              ...
              if (__ring_m220._tag === "some") {
                const field_pat = __ring_m220._0;
                __ring_match221: {
                  const __ring_m221 = field_pat;
                  if (__ring_m221._tag === "Binding") {
                    const bname = __ring_m221.name;
                    const field_ptr = LLVMBuildStructGEP2(ctx.builder, enum_info.llvm_type, scrut_val, (i + 1), codegen_llvm_ctx$fresh_name(ctx, "ef"));
                    const field_val = LLVMBuildLoad2(ctx.builder, ctx.ptr_type, field_ptr, codegen_llvm_ctx$fresh_name(ctx, bname));
                    const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
                    discard(LLVMBuildStore(ctx.builder, field_val, alloca));
    ...
    if (__ring_m218._tag === "NamedConstructor") {
      const name = __ring_m218.name; const named_fields = __ring_m218.fields;
      __ring_match222: {
        const __ring_m222 = _Map_get(enum_info.variants, name);
        if (__ring_m222._tag === "some") {
          const vi = __ring_m222._0;
          const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.arm.${name}`);
          LLVMAddCase(switch_val, LLVMConstInt(ctx.i64_type, vi.tag, 0), arm_bb);
          LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          const __ring_end103 = List_len(named_fields);
          for (let i = 0; i < __ring_end103; i++) {
            __ring_match223: {
              const __ring_m223 = List_get(named_fields, i);
              if (__ring_m223._tag === "some") {
                const nf = __ring_m223._0;
                let field_idx = i;
                ...
                __ring_match224: {
                  const __ring_m224 = nf.pattern;
                  if (__ring_m224._tag === "Binding") {
                    const bname = __ring_m224.name;
                    const field_ptr = LLVMBuildStructGEP2(ctx.builder, enum_info.llvm_type, scrut_val, (field_idx + 1), codegen_llvm_ctx$fresh_name(ctx, "ef"));
                    const field_val = LLVMBuildLoad2(ctx.builder, ctx.ptr_type, field_ptr, codegen_llvm_ctx$fresh_name(ctx, bname));
                    const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
                    discard(LLVMBuildStore(ctx.builder, field_val, alloca));
    ...
    if (__ring_m218._tag === "Wildcard") {
      break __ring_match218;
    }
    if (__ring_m218._tag === "Binding") {
      const bname = __ring_m218.name;
      break __ring_match218;
    }
    if (__ring_m218._tag === "OrPattern") {
      const patterns = __ring_m218.patterns;
      const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.arm.or");
      const __ring_iter_105 = __List_Iterable.iter(patterns);
      while (true) {
        const __ring_next_105 = __ListIterator_Iterator.next(__ring_iter_105);
        if (__ring_next_105._tag === "none") break;
        const alt = __ring_next_105._0;
        let __ring_blk52;
        __ring_match225: {
          const __ring_m225 = alt;
          if (__ring_m225._tag === "Constructor") {
            const name = __ring_m225.name;
            __ring_blk52 = Option_some(name);
            break __ring_match225;
          }
          if (__ring_m225._tag === "NamedConstructor") {
            const name = __ring_m225.name;
            __ring_blk52 = Option_some(name);
            break __ring_match225;
          }
        ...
        __ring_match226: {
          const __ring_m226 = alt_name;
          if (__ring_m226._tag === "some") {
            const an = __ring_m226._0;
            __ring_match227: {
              const __ring_m227 = _Map_get(enum_info.variants, an);
...
function gen_match_expr(ctx, scrutinee, arms, result_ty) {
  let __ring_blk53;
  __ring_match228: {
    const __ring_m228 = ctx.current_fn;
    if (__ring_m228._tag === "some") {
      const f = __ring_m228._0;
      __ring_blk53 = f;
  ...
  let __ring_blk54;
  __ring_match229: {
    const __ring_m229 = scrut_ty;
    if (__ring_m229._tag === "EnumType") {
      const name = __ring_m229.name;
  ...
  let seen_ctors = [];
  const __ring_iter_106 = __List_Iterable.iter(arms);
  while (true) {
    const __ring_next_106 = __ListIterator_Iterator.next(__ring_iter_106);
    if (__ring_next_106._tag === "none") break;
    const arm = __ring_next_106._0;
    __ring_match230: {
      const __ring_m230 = arm.guard;
    ...
    __ring_match232: {
      const __ring_m232 = ctor_name;
      if (__ring_m232._tag === "some") {
        const cn = __ring_m232._0;
  ...
  __ring_match233: {
    const __ring_m233 = enum_name;
    if (__ring_m233._tag === "some") {
      const ename = __ring_m233._0;
      __ring_match234: {
        const __ring_m234 = _Map_get(ctx.enum_types, ename);
        if (__ring_m234._tag === "some") {
          const enum_info = __ring_m234._0;
          const tag_ptr = LLVMBuildStructGEP2(ctx.builder, enum_info.llvm_type, scrut_val, 0, codegen_llvm_ctx$fresh_name(ctx, "tp"));
          const tag_val = LLVMBuildLoad2(ctx.builder, ctx.i64_type, tag_ptr, codegen_llvm_ctx$fresh_name(ctx, "tag"));
          ...
          let phi_bbs = [];
          let has_wildcard = false;
          const __ring_iter_107 = __List_Iterable.iter(arms);
          while (true) {
            const __ring_next_107 = __ListIterator_Iterator.next(__ring_iter_107);
            if (__ring_next_107._tag === "none") break;
            const arm = __ring_next_107._0;
            let __ring_blk56;
            __ring_match235: {
              const __ring_m235 = arm.pattern;
...
function gen_index_expr(ctx, receiver, index, ty) {
  ...
  let __ring_blk57;
  __ring_match236: {
    const __ring_m236 = types$type_to_builtin_name(recv_type);
    if (__ring_m236._tag === "some") {
      const n = __ring_m236._0;
      __ring_blk57 = n;
...
function gen_if_expr(ctx, condition, then_branch, else_branch) {
  let __ring_blk58;
  __ring_match237: {
    const __ring_m237 = ctx.current_fn;
    if (__ring_m237._tag === "some") {
      const f = __ring_m237._0;
      __ring_blk58 = f;
  ...
  let __ring_blk59;
  __ring_match238: {
    const __ring_m238 = else_branch;
    if (__ring_m238._tag === "some") {
      const eb = __ring_m238._0;
...
function build_handler_evidence(ctx, effect_name, hs) {
  let __ring_blk60;
  __ring_match239: {
    const __ring_m239 = _Map_get(ctx.effect_ops, effect_name);
    if (__ring_m239._tag === "some") {
      const ops = __ring_m239._0;
  ...
  __ring_match240: {
    const __ring_m240 = _Map_get(ctx.effect_ops, effect_name);
    if (__ring_m240._tag === "some") {
      const all_ops = __ring_m240._0;
      const __ring_iter_112 = __List_Iterable.iter(all_ops);
      while (true) {
        ...
        if ((op.has_default ? (!_Set_contains(handled_ops, op.name, __Str_Eq)) : false)) {
          __ring_match241: {
            const __ring_m241 = op.default_body;
            if (__ring_m241._tag === "some") {
              const dbody = __ring_m241._0;
...
function gen_handle_expr(ctx, body, handlers) {
  ...
  const __ring_iter_113 = __List_Iterable.iter(handlers);
  while (true) {
    const __ring_next_113 = __ListIterator_Iterator.next(__ring_iter_113);
    if (__ring_next_113._tag === "none") break;
    const h = __ring_next_113._0;
    __ring_match242: {
      const __ring_m242 = _Map_get(by_effect, h.effect_name);
      if (__ring_m242._tag === "some") {
        const existing = __ring_m242._0;
  ...
  while (true) {
    ...
    __ring_match243: {
      const __ring_m243 = _Map_get(ctx.named_values, ev_name);
      if (__ring_m243._tag === "some") {
        const outer_alloca = __ring_m243._0;
...
function gen_field_access(ctx, receiver, field, ty) {
  ...
  const recv_type = hir$hexpr_type(receiver);
  __ring_match245: {
    const __ring_m245 = recv_type;
    if (__ring_m245._tag === "TupleType") {
      let __ring_blk62;
      __ring_match246: {
        const __ring_m246 = parse_int(field);
  ...
  __ring_match247: {
    const __ring_m247 = recv_type;
    if (__ring_m247._tag === "RecordType") {
  ...
  let __ring_blk63;
  __ring_match248: {
    const __ring_m248 = recv_type;
    if (__ring_m248._tag === "StructType") {
  ...
  __ring_match249: {
    const __ring_m249 = _Map_get(ctx.struct_types, type_name);
    if (__ring_m249._tag === "some") {
      const info = __ring_m249._0;
      let field_idx = (-1);
      const __ring_end118 = List_len(info.field_names);
      for (let i = 0; i < __ring_end118; i++) {
...
function gen_effect_op(ctx, effect_name, op_name, args) {
  if (((effect_name === "fail") ? (op_name === "raise") : false)) {
    ...
    let __ring_blk64;
    __ring_match250: {
      const __ring_m250 = ctx.current_fn;
      if (__ring_m250._tag === "some") {
        const f = __ring_m250._0;
        __ring_blk64 = f;
...
function gen_mut_arg_llvm(ctx, arg) {
  __ring_match252: {
    const __ring_m252 = arg;
    if (__ring_m252._tag === "Ident") {
      const name = __ring_m252.name; const resolved_name = __ring_m252.resolved_name; const def_id = __ring_m252.def_id;
      if (is_boxed_def(ctx, def_id)) {
        let __ring_blk66;
        __ring_match253: {
          const __ring_m253 = resolved_name;
          if (__ring_m253._tag === "some") {
            const rn = __ring_m253._0;
            __ring_blk66 = rn;
        ...
        __ring_match254: {
          const __ring_m254 = _Map_get(ctx.named_values, lookup_name);
          if (__ring_m254._tag === "some") {
            const alloca = __ring_m254._0;
          ...
          if (__ring_m254._tag === "none") {
            __ring_match255: {
              const __ring_m255 = _Map_get(ctx.named_values, name);
              if (__ring_m255._tag === "some") {
                const alloca = __ring_m255._0;
                return LLVMBuildLoad2(ctx.builder, ctx.ptr_type, alloca, codegen_llvm_ctx$fresh_name(ctx, "mcell"));
...
function gen_dict_dispatch_call(ctx, callee, args, dd) {
  ...
  __ring_match256: {
    const __ring_m256 = callee;
    if (__ring_m256._tag === "FieldAccess") {
      const receiver = __ring_m256.receiver;
      recv_val = Option_some(gen_llvm_expr(ctx, receiver));
      break __ring_match256;
    }
    __ring_match257: {
      const __ring_m257 = List_get(args, 0);
      if (__ring_m257._tag === "some") {
        const a = __ring_m257._0;
  ...
  let call_args = [];
  __ring_match258: {
    const __ring_m258 = recv_val;
    if (__ring_m258._tag === "some") {
      const rv = __ring_m258._0;
  ...
  const __ring_end122 = List_len(args);
  for (let i = other_arg_start; i < __ring_end122; i++) {
    __ring_match259: {
      const __ring_m259 = List_get(args, i);
      if (__ring_m259._tag === "some") {
        const a = __ring_m259._0;
  ...
  let __ring_blk67;
  __ring_match260: {
    const __ring_m260 = _Map_get(ctx.named_values, dd.dict_param);
    if (__ring_m260._tag === "some") {
      const dict_alloca = __ring_m260._0;
...
function gen_call(ctx, callee, args, resolved_dicts, dict_dispatch, result_ty, effects) {
  __ring_match261: {
    const __ring_m261 = dict_dispatch;
    if (__ring_m261._tag === "some") {
      const dd = __ring_m261._0;
  ...
  let arg_vals = [];
  let argi = 0;
  const __ring_iter_123 = __List_Iterable.iter(args);
  while (true) {
    const __ring_next_123 = __ListIterator_Iterator.next(__ring_iter_123);
    if (__ring_next_123._tag === "none") break;
    const a = __ring_next_123._0;
    let __ring_blk68;
    __ring_match262: {
      const __ring_m262 = mut_flags;
      if (__ring_m262._tag === "some") {
        const flags = __ring_m262._0;
        let __ring_blk69;
        __ring_match263: {
          const __ring_m263 = List_get(flags, argi);
  ...
  let __ring_blk70;
  __ring_match264: {
    const __ring_m264 = callee;
    if (__ring_m264._tag === "Ident") {
      const name = __ring_m264.name; const resolved_name = __ring_m264.resolved_name;
      let __ring_blk71;
      __ring_match265: {
    ...
    if (__ring_m264._tag === "FieldAccess") {
      const receiver = __ring_m264.receiver; const field = __ring_m264.field;
      const recv_val = gen_llvm_expr(ctx, receiver);
      const recv_type = hir$hexpr_type(receiver);
...
function gen_ord_dispatch_llvm(ctx, op, left, right, dispatch) {
  ...
  let __ring_blk72;
  __ring_match269: {
    const __ring_m269 = op;
    if (__ring_m269._tag === "Lt") {
      __ring_blk72 = 40;
      break __ring_match269;
    }
    if (__ring_m269._tag === "Lte") {
      __ring_blk72 = 41;
      break __ring_match269;
    }
    if (__ring_m269._tag === "Gt") {
      __ring_blk72 = 38;
      break __ring_match269;
    }
    if (__ring_m269._tag === "Gte") {
      __ring_blk72 = 39;
      break __ring_match269;
    }
    __ring_blk72 = 32;
...
function gen_eq_dispatch_llvm(ctx, op, left, right, dispatch) {
  ...
  __ring_match270: {
    const __ring_m270 = op;
    if (__ring_m270._tag === "Neq") {
...
function gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch, result_ty) {
  ...
  let __ring_blk73;
  __ring_match272: {
    const __ring_m272 = op;
    if (__ring_m272._tag === "Eq") {
      __ring_blk73 = true;
      break __ring_match272;
    }
    if (__ring_m272._tag === "Neq") {
      __ring_blk73 = true;
      break __ring_match272;
    }
    __ring_blk73 = false;
  ...
  let __ring_blk74;
  __ring_match273: {
    const __ring_m273 = op;
    if (__ring_m273._tag === "Lt") {
      __ring_blk74 = true;
      break __ring_match273;
    }
    if (__ring_m273._tag === "Lte") {
      __ring_blk74 = true;
      break __ring_match273;
    }
    if (__ring_m273._tag === "Gt") {
      __ring_blk74 = true;
      break __ring_match273;
    }
    if (__ring_m273._tag === "Gte") {
      __ring_blk74 = true;
      break __ring_match273;
    }
    __ring_blk74 = false;
  ...
  if (is_eq_op) {
    __ring_match274: {
      const __ring_m274 = eq_dispatch;
      if (__ring_m274._tag === "some") {
        const d = __ring_m274._0;
        __ring_match275: {
          const __ring_m275 = d;
          if (__ring_m275._tag === "Builtin") {
  ...
  if (is_ord_op) {
    __ring_match276: {
      const __ring_m276 = ord_dispatch;
      if (__ring_m276._tag === "some") {
        const d = __ring_m276._0;
        __ring_match277: {
          const __ring_m277 = d;
          if (__ring_m277._tag === "Builtin") {
...
function gen_llvm_expr(ctx, expr) {
  __ring_match278: {
    const __ring_m278 = expr;
    if (__ring_m278._tag === "IntLit") {
      const value = __ring_m278.value;
      return gen_int_lit(ctx, value);
      break __ring_match278;
    }
    if (__ring_m278._tag === "FloatLit") {
      const value = __ring_m278.value;
      return gen_float_lit(ctx, value);
      break __ring_match278;
    }
    if (__ring_m278._tag === "StrLit") {
      const value = __ring_m278.value;
      return gen_str_lit(ctx, value);
      break __ring_match278;
    }
    if (__ring_m278._tag === "BoolLit") {
      const value = __ring_m278.value;
      return gen_bool_lit(ctx, value);
      break __ring_match278;
    }
    if (__ring_m278._tag === "Ident") {
      const name = __ring_m278.name; const resolved_name = __ring_m278.resolved_name; const def_id = __ring_m278.def_id; const dict_closure_dicts = __ring_m278.dict_closure_dicts; const ty = __ring_m278.ty;
      return gen_ident(ctx, name, resolved_name, def_id, dict_closure_dicts, ty);
      break __ring_match278;
    }
    if (__ring_m278._tag === "BinOp") {
      const op = __ring_m278.op; const left = __ring_m278.left; const right = __ring_m278.right; const eq_dispatch = __ring_m278.eq_dispatch; const ord_dispatch = __ring_m278.ord_dispatch; const ty = __ring_m278.ty;
      return gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch, ty);
      break __ring_match278;
    }
    if (__ring_m278._tag === "UnaryOp") {
      const op = __ring_m278.op; const operand = __ring_m278.operand; const ty = __ring_m278.ty;
      return gen_unaryop(ctx, op, operand, ty);
      break __ring_match278;
    }
    if (__ring_m278._tag === "Call") {
      const callee = __ring_m278.callee; const args = __ring_m278.args; const resolved_dicts = __ring_m278.resolved_dicts; const dict_dispatch = __ring_m278.dict_dispatch; const ty = __ring_m278.ty; const effects = __ring_m278.effects;
      return gen_call(ctx, callee, args, resolved_dicts, dict_dispatch, ty, effects);
      break __ring_match278;
    }
    if (__ring_m278._tag === "DictConstruct") {
      const base_dict = __ring_m278.base_dict; const trait_name = __ring_m278.trait_name; const inner = __ring_m278.inner;
      return build_wrapped_dict(ctx, base_dict, trait_name, inner);
      break __ring_match278;
    }
    if (__ring_m278._tag === "FieldAccess") {
      const receiver = __ring_m278.receiver; const field = __ring_m278.field; const ty = __ring_m278.ty;
      return gen_field_access(ctx, receiver, field, ty);
      break __ring_match278;
    }
    if (__ring_m278._tag === "StructLit") {
      const name = __ring_m278.name; const fields = __ring_m278.fields; const spread = __ring_m278.spread;
      return gen_struct_lit(ctx, name, fields, spread);
      break __ring_match278;
    }
    if (__ring_m278._tag === "Block") {
      const stmts = __ring_m278.stmts; const tail = __ring_m278.tail;
      return gen_block(ctx, stmts, tail);
      break __ring_match278;
    }
    if (__ring_m278._tag === "IfExpr") {
      const condition = __ring_m278.condition; const then_branch = __ring_m278.then_branch; const else_branch = __ring_m278.else_branch;
      return gen_if_expr(ctx, condition, then_branch, else_branch);
      break __ring_match278;
    }
    if (__ring_m278._tag === "StringInterp") {
      const parts = __ring_m278.parts;
      return gen_string_interp(ctx, parts);
      break __ring_match278;
    }
    if (__ring_m278._tag === "Lambda") {
      const params = __ring_m278.params; const return_type = __ring_m278.return_type; const body = __ring_m278.body; const ty = __ring_m278.ty;
      return gen_lambda(ctx, params, return_type, body, ty);
      break __ring_match278;
    }
    if (__ring_m278._tag === "MatchExpr") {
      const scrutinee = __ring_m278.scrutinee; const arms = __ring_m278.arms; const ty = __ring_m278.ty;
      return gen_match_expr(ctx, scrutinee, arms, ty);
      break __ring_match278;
    }
    if (__ring_m278._tag === "NamedVariantConstruct") {
      const enum_name = __ring_m278.enum_name; const variant_name = __ring_m278.variant_name; const fields = __ring_m278.fields; const spread = __ring_m278.spread;
      return gen_named_variant_construct(ctx, enum_name, variant_name, fields, spread);
      break __ring_match278;
    }
    if (__ring_m278._tag === "TryCatch") {
      const body = __ring_m278.body; const arms = __ring_m278.arms;
      return gen_try_catch(ctx, body, arms);
      break __ring_match278;
    }
    if (__ring_m278._tag === "HandleExpr") {
      const body = __ring_m278.body; const handlers = __ring_m278.handlers;
      return gen_handle_expr(ctx, body, handlers);
      break __ring_match278;
    }
    if (__ring_m278._tag === "EffectOp") {
      const effect_name = __ring_m278.effect_name; const op_name = __ring_m278.op_name; const args = __ring_m278.args;
      return gen_effect_op(ctx, effect_name, op_name, args);
      break __ring_match278;
    }
    if (__ring_m278._tag === "RangeExpr") {
      const start = __ring_m278.start; const end = __ring_m278.end; const inclusive = __ring_m278.inclusive;
      return gen_range_expr(ctx, start, end, inclusive);
      break __ring_match278;
    }
    if (__ring_m278._tag === "ListLit") {
      const elements = __ring_m278.elements;
      return gen_list_lit(ctx, elements);
      break __ring_match278;
    }
    if (__ring_m278._tag === "TupleLit") {
      const elements = __ring_m278.elements;
      return gen_tuple_lit(ctx, elements);
      break __ring_match278;
    }
    if (__ring_m278._tag === "IndexExpr") {
      const receiver = __ring_m278.receiver; const index = __ring_m278.index; const ty = __ring_m278.ty;
      return gen_index_expr(ctx, receiver, index, ty);
      break __ring_match278;
    }
    if (__ring_m278._tag === "Clone") {
      const inner = __ring_m278.inner;
      return gen_clone(ctx, inner);
      break __ring_match278;
    }
    if (__ring_m278._tag === "ReturnExpr") {
      const value = __ring_m278.value;
      __ring_match279: {
        const __ring_m279 = value;
        if (__ring_m279._tag === "some") {
          const v = __ring_m279._0;
      ...
      __ring_match280: {
        const __ring_m280 = ctx.current_fn;
        if (__ring_m280._tag === "some") {
          const f = __ring_m280._0;
...
function gen_lambda(ctx, params, return_type, body, ty) {
  let __ring_blk75;
  __ring_match281: {
    const __ring_m281 = ctx.current_fn;
    if (__ring_m281._tag === "some") {
      const f = __ring_m281._0;
      __ring_blk75 = f;
  ...
  const __ring_end127 = List_len(captures);
  for (let i = 0; i < __ring_end127; i++) {
    __ring_match282: {
      const __ring_m282 = List_get(captures, i);
      if (__ring_m282._tag === "some") {
        const cap_name = __ring_m282._0;
  ...
  const __ring_end128 = List_len(params);
  for (let i = 0; i < __ring_end128; i++) {
    __ring_match283: {
      const __ring_m283 = List_get(params, i);
      if (__ring_m283._tag === "some") {
        const p = __ring_m283._0;
  ...
  const __ring_end129 = List_len(captures);
  for (let i = 0; i < __ring_end129; i++) {
    __ring_match284: {
      const __ring_m284 = List_get(captures, i);
      if (__ring_m284._tag === "some") {
        const cap_name = __ring_m284._0;
        let __ring_blk76;
        __ring_match285: {
          const __ring_m285 = _Map_get(ctx.named_values, cap_name);
          if (__ring_m285._tag === "some") {
            const alloca = __ring_m285._0;
...
function build_default_evidence_all(ctx) {
  ...
  const __ring_iter_132 = __List_Iterable.iter(effect_names);
  while (true) {
    const __ring_next_132 = __ListIterator_Iterator.next(__ring_iter_132);
    if (__ring_next_132._tag === "none") break;
    const ename = __ring_next_132._0;
    __ring_match286: {
      const __ring_m286 = _Map_get(ctx.effect_ops, ename);
      if (__ring_m286._tag === "some") {
        const ops = __ring_m286._0;
        const n_slots = List_len(ops);
        let slot_types = [ctx.i64_type];
        const __ring_end133 = n_slots;
...
function emit_memoised_dict_getter(ctx, name, build_fn, build_fn_ty) {
  const fname = `ring_dict_init_${name}`;
  __ring_match288: {
    const __ring_m288 = _Map_get(ctx.functions, fname);
    if (__ring_m288._tag === "some") {
      const existing = __ring_m288._0;
      return existing;
