...
function call_zero_arg_or_return(ctx, fn_val, mangled) {
  __ring_match109: {
    const __ring_m109 = _Map_get(ctx.fn_types, mangled);
    if (__ring_m109._tag === "some") {
      const fn_ty = __ring_m109._0;
...
function gen_dict_closure_wrapper(ctx, lookup_name, name, dict_names, ty) {
  ...
  let __ring_blk21;
  __ring_match110: {
    const __ring_m110 = found;
    if (__ring_m110._tag === "some") {
      const fi = __ring_m110._0;
      __ring_blk21 = fi;
  ...
  let __ring_blk22;
  __ring_match111: {
    const __ring_m111 = _Map_get(ctx.fn_types, fn_info.fn_mangled);
    if (__ring_m111._tag === "some") {
      const t = __ring_m111._0;
      __ring_blk22 = t;
  ...
  let __ring_blk23;
  __ring_match112: {
    const __ring_m112 = ty;
    if (__ring_m112._tag === "FnType") {
      const params = __ring_m112.params;
  ...
  let ev_vals = [];
  __ring_match113: {
    const __ring_m113 = _Map_get(ctx.fn_evidence_params, fn_info.fn_mangled);
    if (__ring_m113._tag === "some") {
      const ev_params = __ring_m113._0;
...
function gen_ident(ctx, name, resolved_name, def_id, dict_closure_dicts, ty) {
  __ring_match114: {
    const __ring_m114 = dict_closure_dicts;
    if (__ring_m114._tag === "some") {
      const dicts = __ring_m114._0;
      if ((List_len(dicts) > 0)) {
        let __ring_blk24;
        __ring_match115: {
          const __ring_m115 = resolved_name;
          if (__ring_m115._tag === "some") {
            const rn = __ring_m115._0;
            __ring_blk24 = rn;
  ...
  let __ring_blk25;
  __ring_match116: {
    const __ring_m116 = resolved_name;
    if (__ring_m116._tag === "some") {
      const rn = __ring_m116._0;
      __ring_blk25 = rn;
  ...
  __ring_match117: {
    const __ring_m117 = _Map_get(ctx.named_values, lookup_name);
    if (__ring_m117._tag === "some") {
      const alloca = __ring_m117._0;
    ...
    if (__ring_m117._tag === "none") {
      __ring_match118: {
        ...
        if (__ring_m118._tag === "none") {
          ...
          __ring_match119: {
            const __ring_m119 = _Map_get(ctx.functions, mangled_resolved);
            if (__ring_m119._tag === "some") {
              const fn_val = __ring_m119._0;
            ...
            if (__ring_m119._tag === "none") {
              ...
              __ring_match120: {
                const __ring_m120 = _Map_get(ctx.functions, mangled_bare);
                ...
                if (__ring_m120._tag === "none") {
                  ...
                  __ring_match121: {
                    const __ring_m121 = _Map_get(ctx.functions, mangled_name_resolved);
                    ...
                    if (__ring_m121._tag === "none") {
                      ...
                      __ring_match122: {
                        const __ring_m122 = _Map_get(ctx.functions, mangled_lu);
                        ...
                        if (__ring_m122._tag === "none") {
                          ...
                          __ring_match123: {
                            const __ring_m123 = found;
                            if (__ring_m123._tag === "some") {
                              const fi = __ring_m123._0;
                            ...
                            if (__ring_m123._tag === "none") {
                              ...
                              __ring_match124: {
                                const __ring_m124 = found2;
                                if (__ring_m124._tag === "some") {
                                  const fi2 = __ring_m124._0;
...
function gen_literal_pattern_cond(ctx, scrut_val, scrut_ty, value) {
  __ring_match127: {
    const __ring_m127 = value;
    if (__ring_m127._tag === "IntVal") {
    ...
    if (__ring_m127._tag === "BoolVal") {
      const b = __ring_m127._0;
      const raw = unbox_int(ctx, scrut_val);
      const lit = (b ? LLVMConstInt(ctx.i64_type, 1, 0) : LLVMConstInt(ctx.i64_type, 0, 0));
      return LLVMBuildICmp(ctx.builder, 32, raw, lit, codegen_llvm_ctx$fresh_name(ctx, "eq"));
      break __ring_match127;
    }
    if (__ring_m127._tag === "StrVal") {
      const s = __ring_m127._0;
...
function gen_unaryop(ctx, op, operand, ty) {
  ...
  __ring_match130: {
    const __ring_m130 = op;
    if (__ring_m130._tag === "Neg") {
      if (is_int_type(ty)) {
        const raw = unbox_int(ctx, val);
...
function gen_catch_arms(ctx, error_val, arms) {
  ...
  while (true) {
    ...
    __ring_match131: {
      const __ring_m131 = arm.pattern;
      if (__ring_m131._tag === "Binding") {
        const name = __ring_m131.name;
        const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, name);
      ...
      if (__ring_m131._tag === "Constructor") {
        const name = __ring_m131.name; const fields = __ring_m131.fields;
...
function gen_try_catch(ctx, body, arms) {
  let __ring_blk26;
  __ring_match132: {
    const __ring_m132 = ctx.current_fn;
    if (__ring_m132._tag === "some") {
      const f = __ring_m132._0;
      __ring_blk26 = f;
  ...
  const sjresult = LLVMBuildCall2(ctx.builder, setjmp_ty, setjmp_fn, [frame], codegen_llvm_ctx$fresh_name(ctx, "sj"));
  const zero = LLVMConstInt(ctx.i64_type, 0, 0);
...
function gen_struct_lit(ctx, name, fields, spread) {
  __ring_match133: {
    const __ring_m133 = _Map_get(ctx.struct_types, name);
    if (__ring_m133._tag === "some") {
      const info = __ring_m133._0;
      ...
      __ring_match134: {
        ...
        if (__ring_m134._tag === "some") {
          const spread_expr = __ring_m134._0;
...
function gen_string_interp(ctx, parts) {
  ...
  while (true) {
    ...
    __ring_match135: {
      const __ring_m135 = part;
      if (__ring_m135._tag === "Literal") {
        const s = __ring_m135._0;
      ...
      if (__ring_m135._tag === "Expression") {
        const e = __ring_m135._0;
...
function gen_named_variant_construct(ctx, enum_name, variant_name, fields) {
  __ring_match136: {
    const __ring_m136 = _Map_get(ctx.enum_types, enum_name);
    if (__ring_m136._tag === "some") {
      const enum_info = __ring_m136._0;
      __ring_match137: {
        const __ring_m137 = _Map_get(enum_info.variants, variant_name);
        if (__ring_m137._tag === "some") {
          const vi = __ring_m137._0;
          ...
          for (let i = 0; i < __ring_end64; i++) {
            __ring_match138: {
              const __ring_m138 = List_get(fields, i);
    ...
    if (__ring_m136._tag === "none") {
      ...
      __ring_match139: {
        const __ring_m139 = _Map_get(ctx.functions, ctor_name);
        if (__ring_m139._tag === "some") {
          ...
          let __ring_blk27;
          __ring_match140: {
            const __ring_m140 = _Map_get(ctx.fn_types, ctor_name);
...
function emit_match_arm_body(ctx, arm, merge_bb, next_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match141: {
    const __ring_m141 = arm.guard;
    if (__ring_m141._tag === "some") {
      const g = __ring_m141._0;
...
function gen_match_if_else(ctx, scrut_val, scrut_ty, arms, merge_bb, default_bb, current_fn) {
  ...
  for (let i = 0; i < __ring_end67; i++) {
    __ring_match142: {
      const __ring_m142 = List_get(arms, i);
      if (__ring_m142._tag === "some") {
        const arm = __ring_m142._0;
        ...
        __ring_match144: {
          const __ring_m144 = arm.pattern;
          if (__ring_m144._tag === "Wildcard") {
            open_block = false;
          ...
          if (__ring_m144._tag === "Binding") {
            const bname = __ring_m144.name;
            open_block = false;
            const next_bb = ((has_guard ? (is_last === false) : false) ? LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next") : default_bb);
          ...
          if (__ring_m144._tag === "Literal") {
            const value = __ring_m144.value;
          ...
          if (__ring_m144._tag === "Constructor") {
            const cname = __ring_m144.name; const qualifier = __ring_m144.qualifier; const fields = __ring_m144.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
          ...
          if (__ring_m144._tag === "NamedConstructor") {
            const cname = __ring_m144.name; const qualifier = __ring_m144.qualifier; const nfields = __ring_m144.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.ctor.${cname}`);
            gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, arm_bb, next_bb, current_fn);
            LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          ...
          if (__ring_m144._tag === "OrPattern") {
            const patterns = __ring_m144.patterns;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            ...
            for (let k = 0; k < __ring_end68; k++) {
              __ring_match145: {
                const __ring_m145 = List_get(palts, k);
                if (__ring_m145._tag === "some") {
                  const alt = __ring_m145._0;
                  let __ring_blk29;
                  __ring_match146: {
                    const __ring_m146 = alt;
                    if (__ring_m146._tag === "Constructor") {
                      const an = __ring_m146.name; const aq = __ring_m146.qualifier;
                  ...
                  __ring_match147: {
                    const __ring_m147 = alt_ref;
                    if (__ring_m147._tag === "some") {
                      const ar = __ring_m147._0;
                      const __ring_dt3 = ar;
          ...
          if (__ring_m144._tag === "TuplePattern") {
            const elements = __ring_m144.elements;
            const get_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_get", [ctx.ptr_type, ctx.i64_type], ctx.ptr_type);
            const get_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_get");
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            ...
            for (let j = 0; j < __ring_end69; j++) {
              __ring_match148: {
                const __ring_m148 = List_get(elements, j);
                if (__ring_m148._tag === "some") {
                  const elem_pat = __ring_m148._0;
                  let __ring_blk30;
                  __ring_match149: {
                    const __ring_m149 = elem_pat;
                    if (__ring_m149._tag === "Constructor") {
                      const cname = __ring_m149.name; const qualifier = __ring_m149.qualifier;
                  ...
                  __ring_match150: {
                    const __ring_m150 = ctor_ref;
                    if (__ring_m150._tag === "some") {
                      const cref = __ring_m150._0;
                      ...
                      const ei = find_enum_by_variant(ctx, cname, qualifier);
                      __ring_match151: {
                        const __ring_m151 = ei;
                        if (__ring_m151._tag === "some") {
                          const enum_info = __ring_m151._0;
                          __ring_match152: {
                            const __ring_m152 = _Map_get(enum_info.variants, cname);
                    ...
                    if (__ring_m150._tag === "none") {
                      __ring_match153: {
                        ...
                        if (__ring_m153._tag === "Literal") {
                          const value = __ring_m153.value;
                          const idx = LLVMConstInt(ctx.i64_type, j, 0);
            ...
            for (let j = 0; j < __ring_end70; j++) {
              __ring_match154: {
                const __ring_m154 = List_get(elements, j);
                if (__ring_m154._tag === "some") {
                  const elem_pat = __ring_m154._0;
                  __ring_match155: {
                    const __ring_m155 = elem_pat;
                    if (__ring_m155._tag === "Binding") {
                      const bname = __ring_m155.name;
                      const idx = LLVMConstInt(ctx.i64_type, j, 0);
...
function gen_match_arm_enum(ctx, arm, scrut_val, enum_name, enum_info, switch_val, merge_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match157: {
    ...
    if (__ring_m157._tag === "Constructor") {
      const name = __ring_m157.name; const fields = __ring_m157.fields;
      __ring_match158: {
        const __ring_m158 = _Map_get(enum_info.variants, name);
        if (__ring_m158._tag === "some") {
          const vi = __ring_m158._0;
          ...
          for (let i = 0; i < __ring_end71; i++) {
            __ring_match159: {
              const __ring_m159 = List_get(fields, i);
              if (__ring_m159._tag === "some") {
                const field_pat = __ring_m159._0;
                __ring_match160: {
                  const __ring_m160 = field_pat;
    ...
    if (__ring_m157._tag === "NamedConstructor") {
      const name = __ring_m157.name; const named_fields = __ring_m157.fields;
      __ring_match161: {
        const __ring_m161 = _Map_get(enum_info.variants, name);
        if (__ring_m161._tag === "some") {
          ...
          for (let i = 0; i < __ring_end72; i++) {
            __ring_match162: {
              const __ring_m162 = List_get(named_fields, i);
              if (__ring_m162._tag === "some") {
                const nf = __ring_m162._0;
                let field_idx = i;
                ...
                __ring_match163: {
                  const __ring_m163 = nf.pattern;
                  if (__ring_m163._tag === "Binding") {
                    const bname = __ring_m163.name;
                    const field_ptr = LLVMBuildStructGEP2(ctx.builder, enum_info.llvm_type, scrut_val, (field_idx + 1), codegen_llvm_ctx$fresh_name(ctx, "ef"));
                    const field_val = LLVMBuildLoad2(ctx.builder, ctx.ptr_type, field_ptr, codegen_llvm_ctx$fresh_name(ctx, bname));
                    const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
                    discard(LLVMBuildStore(ctx.builder, field_val, alloca));
    ...
    if (__ring_m157._tag === "OrPattern") {
      ...
      while (true) {
        ...
        let __ring_blk31;
        __ring_match164: {
          const __ring_m164 = alt;
          if (__ring_m164._tag === "Constructor") {
            const name = __ring_m164.name;
        ...
        __ring_match165: {
          const __ring_m165 = alt_name;
          if (__ring_m165._tag === "some") {
            const an = __ring_m165._0;
            __ring_match166: {
              const __ring_m166 = _Map_get(enum_info.variants, an);
...
function gen_match_expr(ctx, scrutinee, arms, result_ty) {
  let __ring_blk32;
  __ring_match167: {
    const __ring_m167 = ctx.current_fn;
    if (__ring_m167._tag === "some") {
      const f = __ring_m167._0;
      __ring_blk32 = f;
  ...
  let __ring_blk33;
  __ring_match168: {
    const __ring_m168 = scrut_ty;
    if (__ring_m168._tag === "EnumType") {
  ...
  __ring_match170: {
    const __ring_m170 = enum_name;
    if (__ring_m170._tag === "some") {
      const ename = __ring_m170._0;
      __ring_match171: {
        const __ring_m171 = _Map_get(ctx.enum_types, ename);
        if (__ring_m171._tag === "some") {
          ...
          while (true) {
            ...
            let __ring_blk34;
            __ring_match172: {
              const __ring_m172 = arm.pattern;
              if (__ring_m172._tag === "Wildcard") {
                __ring_blk34 = true;
                break __ring_match172;
              }
              if (__ring_m172._tag === "Binding") {
                __ring_blk34 = true;
                break __ring_match172;
              }
              __ring_blk34 = false;
...
function gen_index_expr(ctx, receiver, index, ty) {
  ...
  let __ring_blk35;
  __ring_match173: {
    const __ring_m173 = types$type_to_builtin_name(recv_type);
...
function gen_if_expr(ctx, condition, then_branch, else_branch) {
  let __ring_blk36;
  __ring_match174: {
    const __ring_m174 = ctx.current_fn;
  ...
  let __ring_blk37;
  __ring_match175: {
    const __ring_m175 = else_branch;
    if (__ring_m175._tag === "some") {
      const eb = __ring_m175._0;
...
function gen_handle_expr(ctx, body, handlers) {
  ...
  while (true) {
    ...
    __ring_match176: {
      const __ring_m176 = _Map_get(by_effect, h.effect_name);
      if (__ring_m176._tag === "some") {
        const existing = __ring_m176._0;
  ...
  if (has_fail_abort) {
    let __ring_blk38;
    __ring_match177: {
      const __ring_m177 = ctx.current_fn;
      if (__ring_m177._tag === "some") {
        const f = __ring_m177._0;
        __ring_blk38 = f;
...
function gen_field_access(ctx, receiver, field, ty) {
  ...
  const recv_type = hir$hexpr_type(receiver);
  __ring_match178: {
    const __ring_m178 = recv_type;
    if (__ring_m178._tag === "TupleType") {
      let __ring_blk39;
      __ring_match179: {
        const __ring_m179 = parse_int(field);
        if (__ring_m179._tag === "some") {
          const n = __ring_m179._0;
          __ring_blk39 = n;
  ...
  __ring_match180: {
    ...
    if (__ring_m180._tag === "StructType") {
      const name = __ring_m180.name;
      __ring_blk40 = name;
      break __ring_match180;
    }
    if (__ring_m180._tag === "EnumType") {
      const name = __ring_m180.name;
      __ring_blk40 = name;
      break __ring_match180;
    }
  ...
  __ring_match181: {
    const __ring_m181 = _Map_get(ctx.struct_types, type_name);
    if (__ring_m181._tag === "some") {
      const info = __ring_m181._0;
      let field_idx = (-1);
...
function gen_effect_op(ctx, effect_name, op_name, args) {
  if (((effect_name === "fail") ? (op_name === "raise") : false)) {
    ...
    let __ring_blk41;
    __ring_match182: {
      const __ring_m182 = ctx.current_fn;
      if (__ring_m182._tag === "some") {
        const f = __ring_m182._0;
        __ring_blk41 = f;
    ...
    let __ring_blk42;
    __ring_match183: {
      const __ring_m183 = _Map_get(ctx.effect_ops, effect_name);
      if (__ring_m183._tag === "some") {
        const ops = __ring_m183._0;
