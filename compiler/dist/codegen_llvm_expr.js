...
function bind_named_constructor_fields(ctx, scrut_val, cname, qualifier, named_fields) {
  ...
  __ring_match25: {
    ...
    if (__ring_m25._tag === "some") {
      const enum_info = __ring_m25._0;
      __ring_match26: {
        const __ring_m26 = _Map_get(enum_info.variants, cname);
        if (__ring_m26._tag === "some") {
          const vi = __ring_m26._0;
          const __ring_end11 = List_len(named_fields);
          for (let i = 0; i < __ring_end11; i++) {
            __ring_match27: {
              const __ring_m27 = List_get(named_fields, i);
              if (__ring_m27._tag === "some") {
                const nf = __ring_m27._0;
                let field_idx = i;
                const __ring_end12 = List_len(vi.field_names);
                for (let fi = 0; fi < __ring_end12; fi++) {
                  if ((__ring_index(vi.field_names, fi) === nf.name)) {
                    field_idx = fi;
                  }
                }
                __ring_match28: {
                  const __ring_m28 = nf.pattern;
                  if (__ring_m28._tag === "Binding") {
                    const bname = __ring_m28.name;
    ...
    if (__ring_m25._tag === "none") {
      __ring_match29: {
        const __ring_m29 = _Map_get(ctx.struct_types, cname);
        if (__ring_m29._tag === "some") {
          const struct_info = __ring_m29._0;
          const __ring_end13 = List_len(named_fields);
          for (let i = 0; i < __ring_end13; i++) {
            __ring_match30: {
              const __ring_m30 = List_get(named_fields, i);
              if (__ring_m30._tag === "some") {
                const nf = __ring_m30._0;
                let field_idx = i;
                const __ring_end14 = List_len(struct_info.field_names);
                for (let fi = 0; fi < __ring_end14; fi++) {
                  if ((__ring_index(struct_info.field_names, fi) === nf.name)) {
                    field_idx = fi;
                  }
                }
                __ring_match31: {
                  const __ring_m31 = nf.pattern;
                  if (__ring_m31._tag === "Binding") {
                    const bname = __ring_m31.name;
...
function consider_capture_name(ctx, name, resolved_name, params, captures) {
  let __ring_blk1;
  __ring_match32: {
    const __ring_m32 = resolved_name;
    if (__ring_m32._tag === "some") {
      const rn = __ring_m32._0;
      __ring_blk1 = rn;
  ...
  if ((is_param === false)) {
    ...
    __ring_match33: {
      ...
      if (__ring_m33._tag === "none") {
        ...
        let __ring_blk3;
        __ring_match34: {
          const __ring_m34 = _Map_get(ctx.functions, mangled2);
          ...
          if (__ring_m34._tag === "none") {
            ...
            let __ring_blk4;
            __ring_match35: {
              const __ring_m35 = _Map_get(ctx.functions, mangled3);
    ...
    if ((is_fn === false)) {
      let __ring_blk5;
      __ring_match36: {
        const __ring_m36 = _Map_get(ctx.named_values, lookup_name);
        ...
        if (__ring_m36._tag === "none") {
          let __ring_blk6;
          __ring_match37: {
            const __ring_m37 = _Map_get(ctx.named_values, name);
...
function collect_dictref_names(ctx, dr, params, captures) {
  __ring_match38: {
    const __ring_m38 = dr;
    if (__ring_m38._tag === "Simple") {
      const name = __ring_m38._0;
      return consider_capture_name(ctx, name, Option_none, params, captures);
      break __ring_match38;
    }
    if (__ring_m38._tag === "Static") {
      break __ring_match38;
    }
    if (__ring_m38._tag === "Wrapped") {
      const dict = __ring_m38.dict; const inner_dicts = __ring_m38.inner_dicts;
      consider_capture_name(ctx, dict, Option_none, params, captures);
      const __ring_iter_17 = __List_Iterable.iter(inner_dicts);
      while (true) {
        const __ring_next_17 = __ListIterator_Iterator.next(__ring_iter_17);
        if (__ring_next_17._tag === "none") break;
        const inner = __ring_next_17._0;
...
function collect_dispatch_dict(ctx, dispatch, params, captures) {
  __ring_match39: {
    const __ring_m39 = dispatch;
    if (__ring_m39._tag === "some") {
      const d = __ring_m39._0;
      __ring_match40: {
        const __ring_m40 = d;
        if (__ring_m40._tag === "Dict") {
          const param = __ring_m40.param;
          return consider_capture_name(ctx, param, Option_none, params, captures);
          break __ring_match40;
        }
        if (__ring_m40._tag === "Direct") {
          const dict = __ring_m40.dict; const extra_dicts = __ring_m40.extra_dicts;
          consider_capture_name(ctx, dict, Option_none, params, captures);
          const __ring_iter_18 = __List_Iterable.iter(extra_dicts);
          while (true) {
            const __ring_next_18 = __ListIterator_Iterator.next(__ring_iter_18);
            if (__ring_next_18._tag === "none") break;
            const ed = __ring_next_18._0;
            collect_dictref_names(ctx, ed, params, captures);
          }
          break __ring_match40;
        }
        if (__ring_m40._tag === "Builtin") {
          break __ring_match40;
        }
...
function collect_captures_stmt(ctx, stmt, params, captures) {
  __ring_match41: {
    ...
    if (__ring_m41._tag === "Let") {
      const init = __ring_m41.init;
      return collect_captures(ctx, init, params, captures);
      break __ring_match41;
    }
    if (__ring_m41._tag === "Var") {
      const init = __ring_m41.init;
      return collect_captures(ctx, init, params, captures);
      break __ring_match41;
    }
    if (__ring_m41._tag === "Assign") {
      const target = __ring_m41.target; const value = __ring_m41.value;
    ...
    if (__ring_m41._tag === "Return") {
      const value = __ring_m41.value;
      __ring_match42: {
        const __ring_m42 = value;
    ...
    if (__ring_m41._tag === "While") {
      const condition = __ring_m41.condition; const body = __ring_m41.body;
      collect_captures(ctx, condition, params, captures);
      return collect_captures(ctx, body, params, captures);
      break __ring_match41;
    }
    if (__ring_m41._tag === "ForIn") {
      const iterable = __ring_m41.iterable; const body = __ring_m41.body;
      collect_captures(ctx, iterable, params, captures);
      return collect_captures(ctx, body, params, captures);
      break __ring_match41;
    }
    if (__ring_m41._tag === "LetDestructure") {
      const init = __ring_m41.init;
      return collect_captures(ctx, init, params, captures);
      break __ring_match41;
    }
    if (__ring_m41._tag === "IfLet") {
      const expr = __ring_m41.expr; const then_block = __ring_m41.then_block; const else_block = __ring_m41.else_block;
      collect_captures(ctx, expr, params, captures);
      collect_captures(ctx, then_block, params, captures);
      __ring_match43: {
        const __ring_m43 = else_block;
        if (__ring_m43._tag === "some") {
          const eb = __ring_m43._0;
    ...
    if (__ring_m41._tag === "Drop") {
      const name = __ring_m41.name;
      return consider_capture_name(ctx, name, Option_none, params, captures);
      break __ring_match41;
    }
    if (__ring_m41._tag === "Dup") {
      const name = __ring_m41.name;
      return consider_capture_name(ctx, name, Option_none, params, captures);
      break __ring_match41;
    }
...
function collect_captures(ctx, expr, params, captures) {
  __ring_match44: {
    const __ring_m44 = expr;
    if (__ring_m44._tag === "Ident") {
      const name = __ring_m44.name; const resolved_name = __ring_m44.resolved_name;
      return consider_capture_name(ctx, name, resolved_name, params, captures);
      break __ring_match44;
    }
    if (__ring_m44._tag === "BinOp") {
      const left = __ring_m44.left; const right = __ring_m44.right; const eq_dispatch = __ring_m44.eq_dispatch; const ord_dispatch = __ring_m44.ord_dispatch;
    ...
    if (__ring_m44._tag === "UnaryOp") {
      const operand = __ring_m44.operand;
      return collect_captures(ctx, operand, params, captures);
      break __ring_match44;
    }
    if (__ring_m44._tag === "Call") {
      const callee = __ring_m44.callee; const args = __ring_m44.args; const resolved_dicts = __ring_m44.resolved_dicts; const dict_dispatch = __ring_m44.dict_dispatch;
    ...
    if (__ring_m44._tag === "DictConstruct") {
      const inner = __ring_m44.inner;
      const __ring_iter_21 = __List_Iterable.iter(inner);
      while (true) {
    ...
    if (__ring_m44._tag === "FieldAccess") {
      const receiver = __ring_m44.receiver;
    ...
    if (__ring_m44._tag === "IfExpr") {
      const condition = __ring_m44.condition; const then_branch = __ring_m44.then_branch; const else_branch = __ring_m44.else_branch;
      collect_captures(ctx, condition, params, captures);
      collect_captures(ctx, then_branch, params, captures);
      __ring_match47: {
        const __ring_m47 = else_branch;
        if (__ring_m47._tag === "some") {
          const eb = __ring_m47._0;
          return collect_captures(ctx, eb, params, captures);
    ...
    if (__ring_m44._tag === "MatchExpr") {
      const scrutinee = __ring_m44.scrutinee; const arms = __ring_m44.arms;
    ...
    if (__ring_m44._tag === "StringInterp") {
      const parts = __ring_m44.parts;
      const __ring_iter_24 = __List_Iterable.iter(parts);
      while (true) {
        const __ring_next_24 = __ListIterator_Iterator.next(__ring_iter_24);
        if (__ring_next_24._tag === "none") break;
        const part = __ring_next_24._0;
        __ring_match48: {
          const __ring_m48 = part;
          if (__ring_m48._tag === "Expression") {
            const e = __ring_m48._0;
    ...
    if (__ring_m44._tag === "StructLit") {
      const fields = __ring_m44.fields; const spread = __ring_m44.spread;
      ...
      __ring_match49: {
        const __ring_m49 = spread;
        if (__ring_m49._tag === "some") {
          const sp = __ring_m49._0;
    ...
    if (__ring_m44._tag === "ListLit") {
      const elements = __ring_m44.elements;
      const __ring_iter_26 = __List_Iterable.iter(elements);
      while (true) {
    ...
    if (__ring_m44._tag === "IndexExpr") {
      const receiver = __ring_m44.receiver; const index = __ring_m44.index;
      collect_captures(ctx, receiver, params, captures);
      return collect_captures(ctx, index, params, captures);
      break __ring_match44;
    }
    if (__ring_m44._tag === "Lambda") {
      const lb = __ring_m44.body;
      return collect_captures(ctx, lb, params, captures);
      break __ring_match44;
    }
    if (__ring_m44._tag === "NamedVariantConstruct") {
      const nvc_fields = __ring_m44.fields; const nvc_spread = __ring_m44.spread;
      const __ring_iter_28 = __List_Iterable.iter(nvc_fields);
      while (true) {
    ...
    if (__ring_m44._tag === "TryCatch") {
      const tc_body = __ring_m44.body; const tc_arms = __ring_m44.arms;
      collect_captures(ctx, tc_body, params, captures);
      const __ring_iter_29 = __List_Iterable.iter(tc_arms);
      while (true) {
    ...
    if (__ring_m44._tag === "HandleExpr") {
      const he_body = __ring_m44.body;
      return collect_captures(ctx, he_body, params, captures);
      break __ring_match44;
    }
    if (__ring_m44._tag === "EffectOp") {
      const eo_eff = __ring_m44.effect_name; const eo_args = __ring_m44.args;
      const __ring_iter_30 = __List_Iterable.iter(eo_args);
      while (true) {
    ...
    if (__ring_m44._tag === "RangeExpr") {
      const rs = __ring_m44.start; const re = __ring_m44.end;
      collect_captures(ctx, rs, params, captures);
      return collect_captures(ctx, re, params, captures);
      break __ring_match44;
    }
    if (__ring_m44._tag === "Clone") {
      const inner = __ring_m44.inner;
      return collect_captures(ctx, inner, params, captures);
      break __ring_match44;
    }
    if (__ring_m44._tag === "ReturnExpr") {
      const value = __ring_m44.value;
      __ring_match51: {
        const __ring_m51 = value;
        if (__ring_m51._tag === "some") {
          const v = __ring_m51._0;
          return collect_captures(ctx, v, params, captures);
...
function collect_extern_capture_names_stmt(stmt, captures, externs, out) {
  __ring_match52: {
    const __ring_m52 = stmt;
    if (__ring_m52._tag === "Let") {
      const init = __ring_m52.init;
      return collect_extern_capture_names(init, captures, externs, out);
      break __ring_match52;
    }
    if (__ring_m52._tag === "Var") {
      const init = __ring_m52.init;
      return collect_extern_capture_names(init, captures, externs, out);
      break __ring_match52;
    }
    if (__ring_m52._tag === "Assign") {
      const target = __ring_m52.target; const value = __ring_m52.value;
      collect_extern_capture_names(target, captures, externs, out);
      return collect_extern_capture_names(value, captures, externs, out);
      break __ring_match52;
    }
    if (__ring_m52._tag === "ExprStmt") {
      const expr = __ring_m52.expr;
      return collect_extern_capture_names(expr, captures, externs, out);
      break __ring_match52;
    }
    if (__ring_m52._tag === "Return") {
      const value = __ring_m52.value;
      __ring_match53: {
    ...
    if (__ring_m52._tag === "While") {
      const condition = __ring_m52.condition; const body = __ring_m52.body;
      collect_extern_capture_names(condition, captures, externs, out);
      return collect_extern_capture_names(body, captures, externs, out);
      break __ring_match52;
    }
    if (__ring_m52._tag === "ForIn") {
      const iterable = __ring_m52.iterable; const body = __ring_m52.body;
      collect_extern_capture_names(iterable, captures, externs, out);
      return collect_extern_capture_names(body, captures, externs, out);
      break __ring_match52;
    }
    if (__ring_m52._tag === "LetDestructure") {
      const init = __ring_m52.init;
      return collect_extern_capture_names(init, captures, externs, out);
      break __ring_match52;
    }
    if (__ring_m52._tag === "IfLet") {
      const expr = __ring_m52.expr; const then_block = __ring_m52.then_block; const else_block = __ring_m52.else_block;
      collect_extern_capture_names(expr, captures, externs, out);
      collect_extern_capture_names(then_block, captures, externs, out);
      __ring_match54: {
        const __ring_m54 = else_block;
...
function collect_extern_capture_names(expr, captures, externs, out) {
  __ring_match55: {
    const __ring_m55 = expr;
    if (__ring_m55._tag === "Ident") {
      const name = __ring_m55.name; const resolved_name = __ring_m55.resolved_name; const ty = __ring_m55.ty;
      let __ring_blk7;
      __ring_match56: {
        const __ring_m56 = resolved_name;
        if (__ring_m56._tag === "some") {
          const rn = __ring_m56._0;
          __ring_blk7 = rn;
    ...
    if (__ring_m55._tag === "BinOp") {
      const left = __ring_m55.left; const right = __ring_m55.right;
      collect_extern_capture_names(left, captures, externs, out);
      return collect_extern_capture_names(right, captures, externs, out);
      break __ring_match55;
    }
    if (__ring_m55._tag === "UnaryOp") {
      const operand = __ring_m55.operand;
      return collect_extern_capture_names(operand, captures, externs, out);
      break __ring_match55;
    }
    if (__ring_m55._tag === "Call") {
      const callee = __ring_m55.callee; const args = __ring_m55.args;
    ...
    if (__ring_m55._tag === "FieldAccess") {
      const receiver = __ring_m55.receiver;
      return collect_extern_capture_names(receiver, captures, externs, out);
      break __ring_match55;
    }
    if (__ring_m55._tag === "Block") {
      const stmts = __ring_m55.stmts; const tail = __ring_m55.tail;
    ...
    if (__ring_m55._tag === "IfExpr") {
      const condition = __ring_m55.condition; const then_branch = __ring_m55.then_branch; const else_branch = __ring_m55.else_branch;
      collect_extern_capture_names(condition, captures, externs, out);
      collect_extern_capture_names(then_branch, captures, externs, out);
      __ring_match58: {
        const __ring_m58 = else_branch;
        if (__ring_m58._tag === "some") {
          const eb = __ring_m58._0;
          return collect_extern_capture_names(eb, captures, externs, out);
    ...
    if (__ring_m55._tag === "MatchExpr") {
      const scrutinee = __ring_m55.scrutinee; const arms = __ring_m55.arms;
    ...
    if (__ring_m55._tag === "StringInterp") {
      const parts = __ring_m55.parts;
      ...
      while (true) {
        ...
        const part = __ring_next_35._0;
        __ring_match59: {
          const __ring_m59 = part;
          if (__ring_m59._tag === "Expression") {
            const e = __ring_m59._0;
    ...
    if (__ring_m55._tag === "StructLit") {
      const fields = __ring_m55.fields; const spread = __ring_m55.spread;
      ...
      __ring_match60: {
        const __ring_m60 = spread;
        if (__ring_m60._tag === "some") {
          const sp = __ring_m60._0;
    ...
    if (__ring_m55._tag === "ListLit") {
      const elements = __ring_m55.elements;
      ...
      while (true) {
        ...
        const e = __ring_next_37._0;
        collect_extern_capture_names(e, captures, externs, out);
      }
      break __ring_match55;
    }
    if (__ring_m55._tag === "TupleLit") {
      const elements = __ring_m55.elements;
    ...
    if (__ring_m55._tag === "IndexExpr") {
      const receiver = __ring_m55.receiver; const index = __ring_m55.index;
    ...
    if (__ring_m55._tag === "Lambda") {
      const lb = __ring_m55.body;
      return collect_extern_capture_names(lb, captures, externs, out);
      break __ring_match55;
    }
    if (__ring_m55._tag === "NamedVariantConstruct") {
      const nvc_fields = __ring_m55.fields; const nvc_spread = __ring_m55.spread;
      const __ring_iter_39 = __List_Iterable.iter(nvc_fields);
      while (true) {
    ...
    if (__ring_m55._tag === "TryCatch") {
      const tc_body = __ring_m55.body; const tc_arms = __ring_m55.arms;
      collect_extern_capture_names(tc_body, captures, externs, out);
      const __ring_iter_40 = __List_Iterable.iter(tc_arms);
      while (true) {
        const __ring_next_40 = __ListIterator_Iterator.next(__ring_iter_40);
        if (__ring_next_40._tag === "none") break;
        const arm = __ring_next_40._0;
        collect_extern_capture_names(arm.body, captures, externs, out);
      }
      break __ring_match55;
    }
    if (__ring_m55._tag === "HandleExpr") {
      const he_body = __ring_m55.body;
      return collect_extern_capture_names(he_body, captures, externs, out);
      break __ring_match55;
    }
    if (__ring_m55._tag === "EffectOp") {
      const eo_args = __ring_m55.args;
      const __ring_iter_41 = __List_Iterable.iter(eo_args);
      while (true) {
...
function emit_wrapped_method_thunk(ctx, mangled, method_fn, method_name, dispatch_arity, inner_count) {
  ...
  __ring_match63: {
    const __ring_m63 = _Map_get(ctx.functions, thunk_name);
    if (__ring_m63._tag === "some") {
      const existing = __ring_m63._0;
      return existing;
  ...
  const __ring_end42 = dispatch_arity;
  ...
  const __ring_end43 = inner_count;
  for (let j = 0; j < __ring_end43; j++) {
    List_push(env_elem_types, ctx.ptr_type);
  }
  const env_ty = LLVMStructTypeInContext(ctx.context, env_elem_types, 0);
  let __ring_blk8;
  __ring_match64: {
    const __ring_m64 = _Map_get(ctx.fn_types, mangled);
    ...
    if (__ring_m64._tag === "none") {
      let mp = [];
      const __ring_end44 = (dispatch_arity + inner_count);
  ...
  let fwd_args = [];
  const __ring_end45 = dispatch_arity;
  for (let i = 0; i < __ring_end45; i++) {
    List_push(fwd_args, LLVMGetParam(thunk_fn, (i + 1)));
  }
  const __ring_end46 = inner_count;
  for (let j = 0; j < __ring_end46; j++) {
...
function get_or_create_dict_global(ctx, name) {
  __ring_match65: {
    const __ring_m65 = _Map_get(ctx.dict_singletons, name);
    if (__ring_m65._tag === "some") {
      const g = __ring_m65._0;
      return g;
...
function get_or_create_static_dict_getter(ctx, name) {
  ...
  __ring_match66: {
    const __ring_m66 = _Map_get(ctx.functions, fname);
  ...
  let __ring_blk9;
  __ring_match67: {
    const __ring_m67 = _Map_get(ctx.static_dict_defs, name);
    if (__ring_m67._tag === "some") {
      const def = __ring_m67._0;
...
function resolve_static_dict_by_name(ctx, name) {
  ...
  __ring_match69: {
    const __ring_m69 = _Map_get(ctx.functions, init_fn_name);
    if (__ring_m69._tag === "some") {
      const init_fn = __ring_m69._0;
      let __ring_blk11;
      __ring_match70: {
        const __ring_m70 = _Map_get(ctx.fn_types, init_fn_name);
    ...
    if (__ring_m69._tag === "none") {
      __ring_match71: {
        const __ring_m71 = _Map_get(ctx.dict_globals, name);
        if (__ring_m71._tag === "some") {
          const init_fn = __ring_m71._0;
...
function resolve_dict_ref(ctx, dr) {
  __ring_match72: {
    const __ring_m72 = dr;
    if (__ring_m72._tag === "Simple") {
      const name = __ring_m72._0;
      __ring_match73: {
        const __ring_m73 = _Map_get(ctx.named_values, name);
        if (__ring_m73._tag === "some") {
          const alloca = __ring_m73._0;
    ...
    if (__ring_m72._tag === "Static") {
      const name = __ring_m72._0;
      return resolve_static_dict_by_name(ctx, name);
      break __ring_match72;
    }
    if (__ring_m72._tag === "Wrapped") {
      const dict = __ring_m72.dict; const trait_name = __ring_m72.trait_name; const inner_dicts = __ring_m72.inner_dicts;
...
function build_wrapped_dict_typed(ctx, dict_name, trait_name, inner_dicts, dict_tid) {
  let inner_vals = [];
  const __ring_iter_48 = __List_Iterable.iter(inner_dicts);
  while (true) {
  ...
  let __ring_blk12;
  __ring_match74: {
    const __ring_m74 = _Map_get(ctx.trait_method_order, trait_name);
    if (__ring_m74._tag === "some") {
      const order = __ring_m74._0;
      __ring_blk12 = order;
  ...
  const __ring_end49 = method_count;
  ...
  for (let i = 0; i < __ring_end50; i++) {
    __ring_match75: {
      const __ring_m75 = List_get(method_order, i);
      if (__ring_m75._tag === "some") {
        const method_name = __ring_m75._0;
        const mangled = codegen_llvm_ctx$llvm_mangle_method(target_type, method_name);
        __ring_match76: {
          const __ring_m76 = _Map_get(ctx.functions, mangled);
          if (__ring_m76._tag === "some") {
            const method_fn = __ring_m76._0;
            ...
            let env_elem_types = [ctx.i64_type];
            const __ring_end51 = inner_count;
            for (let j = 0; j < __ring_end51; j++) {
              List_push(env_elem_types, ctx.ptr_type);
            }
            const env_ty = LLVMStructTypeInContext(ctx.context, env_elem_types, 0);
...
function resolve_dispatch_dict(ctx, dispatch, trait_name_hint) {
  __ring_match78: {
    const __ring_m78 = dispatch;
    if (__ring_m78._tag === "Dict") {
      const param = __ring_m78.param;
      __ring_match79: {
        const __ring_m79 = _Map_get(ctx.named_values, param);
        if (__ring_m79._tag === "some") {
          const alloca = __ring_m79._0;
    ...
    if (__ring_m78._tag === "Direct") {
      const dict = __ring_m78.dict; const extra_dicts = __ring_m78.extra_dicts;
      if ((List_len(extra_dicts) === 0)) {
        return resolve_dict_ref(ctx, hir$DictRef_Simple(dict));
      } else {
        __ring_match80: {
          const __ring_m80 = trait_name_hint;
          if (__ring_m80._tag === "some") {
            const tn = __ring_m80._0;
...
function trait_name_from_dict_param(dict_param) {
  ...
  __ring_match88: {
    const __ring_m88 = Str_index_of(rest, "_");
    if (__ring_m88._tag === "some") {
      const us = __ring_m88._0;
...
function trait_name_from_static_dict(ctx, dict_param) {
  ...
  let best_len = 0;
  const __ring_iter_55 = __List_Iterable.iter(_Map_entries(ctx.trait_method_order));
  while (true) {
    const __ring_next_55 = __ListIterator_Iterator.next(__ring_iter_55);
    if (__ring_next_55._tag === "none") break;
    const entry = __ring_next_55._0;
    const __ring_dt1 = entry;
    const tn = __ring_dt1[0];
    const _methods = __ring_dt1[1];
    const suffix = `_${tn}`;
...
function get_trait_method_index(ctx, dict_param, method) {
  let __ring_blk13;
  __ring_match89: {
    const __ring_m89 = trait_name_from_dict_param(dict_param);
  ...
  __ring_match90: {
    const __ring_m90 = trait_name_opt;
    if (__ring_m90._tag === "some") {
      const trait_name = __ring_m90._0;
      __ring_match91: {
        const __ring_m91 = _Map_get(ctx.trait_method_order, trait_name);
        if (__ring_m91._tag === "some") {
          const order = __ring_m91._0;
          let idx = 0;
          const __ring_iter_56 = __List_Iterable.iter(order);
          while (true) {
...
function find_fn_by_prefix_enumeration(ctx, name) {
  ...
  const __ring_iter_57 = __List_Iterable.iter(sorted_imports);
  while (true) {
    ...
    const qualified = __ring_dt2[1];
    const maybe_idx = Str_index_of(qualified, "$$_");
    __ring_match92: {
      const __ring_m92 = maybe_idx;
      if (__ring_m92._tag === "some") {
        const sep_idx = __ring_m92._0;
        ...
        if ((!_Set_contains(seen_prefixes, prefix_part, __Str_Eq))) {
          ...
          __ring_match93: {
            const __ring_m93 = found;
            if (__ring_m93._tag === "some") {
              const fn_val = __ring_m93._0;
...
function find_fn_by_suffix(ctx, name) {
  ...
  const __ring_iter_58 = __List_Iterable.iter(sorted_fns);
  while (true) {
    ...
    const fn_name = __ring_dt3[0];
    const fn_val = __ring_dt3[1];
...
function find_fn_precise(ctx, name) {
  ...
  __ring_match96: {
    const __ring_m96 = step3;
    if (__ring_m96._tag === "some") {
      const result = __ring_m96._0;
...
function find_function_in_ctx(ctx, mangled, name) {
  __ring_match97: {
    const __ring_m97 = _Map_get(ctx.functions, mangled);
    if (__ring_m97._tag === "some") {
      const fn_val = __ring_m97._0;
    ...
    if (__ring_m97._tag === "none") {
      ...
      __ring_match98: {
        const __ring_m98 = _Map_get(ctx.functions, bare);
...
function gen_extern_LLVMAddIncoming(ctx, arg_vals, info) {
  let __ring_blk14;
  __ring_match99: {
    const __ring_m99 = List_get(arg_vals, 0);
    if (__ring_m99._tag === "some") {
      const v = __ring_m99._0;
      __ring_blk14 = v;
  ...
  let __ring_blk15;
  __ring_match100: {
    const __ring_m100 = List_get(arg_vals, 1);
  ...
  let __ring_blk16;
  __ring_match101: {
    const __ring_m101 = List_get(arg_vals, 2);
...
function gen_extern_LLVMGetTargetFromTriple(ctx, arg_vals, info) {
  let __ring_blk17;
  __ring_match102: {
    const __ring_m102 = List_get(arg_vals, 0);
...
function gen_extern_LLVMRunPasses(ctx, arg_vals, info) {
  ...
  let __ring_blk19;
  __ring_match104: {
    const __ring_m104 = List_get(arg_vals, 1);
  ...
  let __ring_blk20;
  __ring_match105: {
    const __ring_m105 = List_get(arg_vals, 2);
  ...
  let __ring_blk21;
  __ring_match106: {
    const __ring_m106 = List_get(arg_vals, 3);
...
function gen_extern_LLVMTargetMachineEmitToFile(ctx, arg_vals, info) {
  ...
  let __ring_blk25;
  __ring_match110: {
    const __ring_m110 = List_get(arg_vals, 3);
...
function gen_extern_fn_call(ctx, name, arg_vals, info) {
  ...
  let c_args = [];
  let arg_idx = 0;
  const __ring_iter_59 = __List_Iterable.iter(info.param_marshalls);
  while (true) {
    const __ring_next_59 = __ListIterator_Iterator.next(__ring_iter_59);
    if (__ring_next_59._tag === "none") break;
    const marshall = __ring_next_59._0;
    let __ring_blk28;
    __ring_match113: {
      const __ring_m113 = List_get(arg_vals, arg_idx);
    ...
    __ring_match114: {
      const __ring_m114 = marshall;
      if (__ring_m114._tag === "PassthroughPtr") {
        List_push(c_args, arg_val);
        break __ring_match114;
      }
      if (__ring_m114._tag === "StrToCstr") {
        const cstr_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_str_to_cstr", [ctx.ptr_type], ctx.ptr_type);
        const cstr_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_str_to_cstr");
      ...
      if (__ring_m114._tag === "StrToCstrAndLen") {
        const cstr_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_str_to_cstr", [ctx.ptr_type], ctx.ptr_type);
        const cstr_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_str_to_cstr");
        const cstr = LLVMBuildCall2(ctx.builder, cstr_ty, cstr_fn, [arg_val], codegen_llvm_ctx$fresh_name(ctx, "cstr"));
        List_push(c_args, cstr);
      ...
      if (__ring_m114._tag === "IntToI64") {
        const raw = unbox_int(ctx, arg_val);
        List_push(c_args, raw);
        break __ring_match114;
      }
      if (__ring_m114._tag === "FloatToDouble") {
        const unbox_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_unbox_float", [ctx.ptr_type], ctx.double_type);
        const unbox_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_unbox_float");
      ...
      if (__ring_m114._tag === "ListToDataAndCount") {
        const data_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_data", [ctx.ptr_type], ctx.ptr_type);
        const data_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_data");
      ...
      if (__ring_m114._tag === "ListToDataAndCountI64") {
        const data_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_data", [ctx.ptr_type], ctx.ptr_type);
        const data_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_data");
        const data_ptr = LLVMBuildCall2(ctx.builder, data_ty, data_fn, [arg_val], codegen_llvm_ctx$fresh_name(ctx, "ldata"));
        List_push(c_args, data_ptr);
  ...
  let __ring_blk29;
  __ring_match115: {
    const __ring_m115 = info.ret_marshall;
    if (__ring_m115._tag === "RetVoid") {
      __ring_blk29 = "";
...
function gen_runtime_call(ctx, name, args) {
  __ring_match117: {
    const __ring_m117 = _Map_get(ctx.rt_fns, name);
    if (__ring_m117._tag === "some") {
      const fn_val = __ring_m117._0;
...
function lookup_evidence(ctx, ev_param_name) {
  __ring_match118: {
    const __ring_m118 = _Map_get(ctx.named_values, ev_param_name);
    if (__ring_m118._tag === "some") {
      const alloca = __ring_m118._0;
    ...
    if (__ring_m118._tag === "none") {
      ...
      __ring_match119: {
        const __ring_m119 = _Map_get(ctx.default_evidence, effect_name);
        if (__ring_m119._tag === "some") {
          const def_ev = __ring_m119._0;
          return def_ev;
...
function gen_direct_call(ctx, name, arg_vals, dict_vals) {
  ...
  __ring_match120: {
    const __ring_m120 = rt_name;
    if (__ring_m120._tag === "some") {
      const rtn = __ring_m120._0;
      let param_types = [];
      const __ring_iter_60 = __List_Iterable.iter(arg_vals);
      while (true) {
        const __ring_next_60 = __ListIterator_Iterator.next(__ring_iter_60);
        if (__ring_next_60._tag === "none") break;
        const _ = __ring_next_60._0;
  ...
  __ring_match121: {
    const __ring_m121 = _Map_get(ctx.extern_fn_infos, name);
    if (__ring_m121._tag === "some") {
      const info = __ring_m121._0;
  ...
  __ring_match122: {
    const __ring_m122 = found_fn;
    if (__ring_m122._tag === "some") {
      const fn_info = __ring_m122._0;
      const __ring_iter_61 = __List_Iterable.iter(dict_vals);
      while (true) {
        const __ring_next_61 = __ListIterator_Iterator.next(__ring_iter_61);
        if (__ring_next_61._tag === "none") break;
        const dv = __ring_next_61._0;
        List_push(arg_vals, dv);
      }
      __ring_match123: {
        const __ring_m123 = _Map_get(ctx.fn_evidence_params, fn_info.fn_mangled);
        if (__ring_m123._tag === "some") {
          const ev_params = __ring_m123._0;
          const __ring_iter_62 = __List_Iterable.iter(ev_params);
          while (true) {
            const __ring_next_62 = __ListIterator_Iterator.next(__ring_iter_62);
            if (__ring_next_62._tag === "none") break;
            const ep = __ring_next_62._0;
      ...
      let __ring_blk30;
      __ring_match124: {
        const __ring_m124 = _Map_get(ctx.fn_types, fn_info.fn_mangled);
        if (__ring_m124._tag === "some") {
          const t = __ring_m124._0;
          __ring_blk30 = t;
    ...
    if (__ring_m122._tag === "none") {
      __ring_match125: {
        const __ring_m125 = _Map_get(ctx.named_values, name);
        if (__ring_m125._tag === "some") {
          const alloca = __ring_m125._0;
        ...
        if (__ring_m125._tag === "none") {
          ...
          __ring_match126: {
            const __ring_m126 = _Map_get(ctx.rt_fns, rt_fallback);
...
function ensure_runtime_method(ctx, name, arg_count) {
  __ring_match127: {
    ...
    if (__ring_m127._tag === "none") {
      ...
      let param_types = [];
      const __ring_end63 = arg_count;
      for (let i = 0; i < __ring_end63; i++) {
...
function is_builtin_collection(ty) {
  __ring_match128: {
    const __ring_m128 = ty;
    if (__ring_m128._tag === "StructType") {
      const name = __ring_m128.name; const type_params = __ring_m128.type_params;
      if ((name === "List")) {
  ...
  __ring_match129: {
    ...
    if (__ring_m129._tag === "StructType") {
      ...
      if (((name === "Map") ? (List_len(type_params) === 2) : false)) {
        __ring_match130: {
          const __ring_m130 = __ring_index(type_params, 0);
          if (__ring_m130._tag === "IntType") {
            return true;
...
function is_int_set(ty) {
  __ring_match131: {
    const __ring_m131 = ty;
    if (__ring_m131._tag === "StructType") {
      const name = __ring_m131.name; const type_params = __ring_m131.type_params;
      if (((name === "Set") ? (List_len(type_params) === 1) : false)) {
        __ring_match132: {
          const __ring_m132 = __ring_index(type_params, 0);
          if (__ring_m132._tag === "IntType") {
            return true;
...
function gen_method_call(ctx, recv, recv_type, method, args, dict_vals) {
  let __ring_blk31;
  __ring_match133: {
    const __ring_m133 = types$type_to_builtin_name(recv_type);
    if (__ring_m133._tag === "some") {
      const n = __ring_m133._0;
      __ring_blk31 = n;
    ...
    if (__ring_m133._tag === "none") {
      let __ring_blk32;
      __ring_match134: {
        const __ring_m134 = recv_type;
        if (__ring_m134._tag === "StructType") {
          const name = __ring_m134.name;
          __ring_blk32 = name;
          break __ring_match134;
        }
        if (__ring_m134._tag === "EnumType") {
          const name = __ring_m134.name;
          __ring_blk32 = name;
          break __ring_match134;
        }
  ...
  __ring_match135: {
    const __ring_m135 = rt_method;
    if (__ring_m135._tag === "some") {
      const base_rt_name = __ring_m135._0;
      let __ring_blk33;
      __ring_match136: {
        const __ring_m136 = method;
        if (__ring_m136 === "get") {
          __ring_blk33 = "ring_map_int_get_opt";
          break __ring_match136;
        }
        if (__ring_m136 === "insert") {
          __ring_blk33 = "ring_map_int_set";
          break __ring_match136;
        }
        if (__ring_m136 === "contains_key") {
        ...
        if (__ring_m136 === "values") {
          __ring_blk33 = "ring_map_int_values";
          break __ring_match136;
        }
        if (__ring_m136 === "entries") {
      ...
      __ring_match137: {
        ...
        if (__ring_m137 === "contains") {
          __ring_blk34 = "ring_set_int_has";
          break __ring_match137;
        }
        if (__ring_m137 === "to_list") {
        ...
        if (__ring_m137 === "union") {
          __ring_blk34 = "ring_set_int_union";
          break __ring_match137;
        }
        if (__ring_m137 === "intersect") {
          __ring_blk34 = "ring_set_int_intersect";
          break __ring_match137;
        }
        if (__ring_m137 === "difference") {
    ...
    if (__ring_m135._tag === "none") {
      ...
      __ring_match138: {
        ...
        if (__ring_m138._tag === "some") {
          ...
          let __ring_blk35;
          __ring_match140: {
            const __ring_m140 = _Map_get(ctx.fn_types, mangled);
            if (__ring_m140._tag === "some") {
              const t = __ring_m140._0;
              __ring_blk35 = t;
...
function is_boxed_def(ctx, def_id) {
  __ring_match141: {
    const __ring_m141 = def_id;
    if (__ring_m141._tag === "some") {
      const did = __ring_m141._0;
...
function is_unit_type(ty) {
  __ring_match142: {
    const __ring_m142 = ty;
    if (__ring_m142._tag === "UnitType") {
      return true;
...
function lookup_call_mut_flags(ctx, callee) {
  __ring_match143: {
    const __ring_m143 = callee;
    if (__ring_m143._tag === "Ident") {
      const name = __ring_m143.name; const resolved_name = __ring_m143.resolved_name;
      let __ring_blk36;
      __ring_match144: {
        const __ring_m144 = resolved_name;
        if (__ring_m144._tag === "some") {
          const rn = __ring_m144._0;
          __ring_blk36 = rn;
    ...
    if (__ring_m143._tag === "FieldAccess") {
      const receiver = __ring_m143.receiver; const field = __ring_m143.field;
      const recv_type = hir$hexpr_type(receiver);
      let __ring_blk37;
      __ring_match145: {
        const __ring_m145 = types$type_to_builtin_name(recv_type);
        if (__ring_m145._tag === "some") {
          const n = __ring_m145._0;
          __ring_blk37 = n;
        ...
        if (__ring_m145._tag === "none") {
          let __ring_blk38;
          __ring_match146: {
            const __ring_m146 = recv_type;
            if (__ring_m146._tag === "StructType") {
              const name = __ring_m146.name;
              __ring_blk38 = name;
              break __ring_match146;
            }
            if (__ring_m146._tag === "EnumType") {
              const name = __ring_m146.name;
              __ring_blk38 = name;
              break __ring_match146;
            }
      ...
      if ((type_name === "")) {
        ...
        __ring_match147: {
          const __ring_m147 = _Map_get(ctx.fn_mut_params, ufcs_name);
          if (__ring_m147._tag === "some") {
            const flags = __ring_m147._0;
            let shifted = [];
            let i = 1;
            while ((i < List_len(flags))) {
              __ring_match148: {
                const __ring_m148 = List_get(flags, i);
                if (__ring_m148._tag === "some") {
                  const f = __ring_m148._0;
                  List_push(shifted, f);
...
function gen_record_field_access(ctx, recv_val, field) {
  let __ring_blk39;
  __ring_match149: {
    const __ring_m149 = ctx.current_fn;
  ...
  let candidates = [];
  const __ring_iter_69 = __List_Iterable.iter(_Map_entries(ctx.struct_types));
  while (true) {
    const __ring_next_69 = __ListIterator_Iterator.next(__ring_iter_69);
    if (__ring_next_69._tag === "none") break;
    const entry = __ring_next_69._0;
    const __ring_dt4 = entry;
    const sname = __ring_dt4[0];
    const sinfo = __ring_dt4[1];
    const __ring_end70 = List_len(sinfo.field_names);
  ...
  if ((List_len(candidates) === 1)) {
    const __ring_dt5 = __ring_index(candidates, 0);
    const cname = __ring_dt5[0];
    const cinfo = __ring_dt5[1];
    const cidx = __ring_dt5[2];
  ...
  let phi_vals = [];
  let phi_bbs = [];
  const __ring_iter_71 = __List_Iterable.iter(candidates);
  while (true) {
    ...
    const sinfo = __ring_dt6[1];
    const fidx = __ring_dt6[2];
...
function get_or_declare_frameaddress(ctx) {
  ...
  __ring_match150: {
    const __ring_m150 = _Map_get(ctx.rt_fns, name);
    if (__ring_m150._tag === "some") {
      const f = __ring_m150._0;
      __ring_match151: {
        const __ring_m151 = _Map_get(ctx.rt_fn_types, name);
        if (__ring_m151._tag === "some") {
          const t = __ring_m151._0;
          return [f, t];
...
function get_or_declare_setjmp(ctx) {
  const name = "_setjmp";
  __ring_match152: {
    const __ring_m152 = _Map_get(ctx.rt_fns, name);
    if (__ring_m152._tag === "some") {
      const f = __ring_m152._0;
      __ring_match153: {
        const __ring_m153 = _Map_get(ctx.rt_fn_types, name);
...
function call_zero_arg_or_return(ctx, fn_val, mangled) {
  __ring_match154: {
    const __ring_m154 = _Map_get(ctx.fn_types, mangled);
    if (__ring_m154._tag === "some") {
      const fn_ty = __ring_m154._0;
...
function gen_dict_closure_wrapper(ctx, lookup_name, name, dict_names, ty) {
  ...
  let __ring_blk40;
  __ring_match155: {
    const __ring_m155 = found;
    if (__ring_m155._tag === "some") {
      const fi = __ring_m155._0;
      __ring_blk40 = fi;
  ...
  let __ring_blk41;
  __ring_match156: {
    const __ring_m156 = _Map_get(ctx.fn_types, fn_info.fn_mangled);
  ...
  let __ring_blk42;
  __ring_match157: {
    const __ring_m157 = ty;
    if (__ring_m157._tag === "FnType") {
      const params = __ring_m157.params;
  ...
  let env_elem_types = [ctx.i64_type];
  const __ring_end75 = captured_count;
  for (let i = 0; i < __ring_end75; i++) {
    List_push(env_elem_types, ctx.ptr_type);
  }
  const env_ty = LLVMStructTypeInContext(ctx.context, env_elem_types, 0);
  const thunk_name = codegen_llvm_ctx$fresh_name(ctx, "ring_dictwrap_");
  let thunk_param_types = [ctx.ptr_type];
  const __ring_end76 = param_count;
  ...
  const __ring_end78 = captured_count;
...
function gen_ident(ctx, name, resolved_name, def_id, dict_closure_dicts, ty) {
  __ring_match159: {
    const __ring_m159 = dict_closure_dicts;
    if (__ring_m159._tag === "some") {
      const dicts = __ring_m159._0;
      if ((List_len(dicts) > 0)) {
        let __ring_blk43;
        __ring_match160: {
          const __ring_m160 = resolved_name;
          if (__ring_m160._tag === "some") {
            const rn = __ring_m160._0;
            __ring_blk43 = rn;
  ...
  __ring_match162: {
    const __ring_m162 = _Map_get(ctx.named_values, lookup_name);
    if (__ring_m162._tag === "some") {
      const alloca = __ring_m162._0;
    ...
    if (__ring_m162._tag === "none") {
      __ring_match163: {
        const __ring_m163 = _Map_get(ctx.named_values, name);
        ...
        if (__ring_m163._tag === "none") {
          __ring_match164: {
            const __ring_m164 = ty;
            if (__ring_m164._tag === "FnType") {
          ...
          __ring_match165: {
            const __ring_m165 = _Map_get(ctx.functions, mangled_resolved);
            if (__ring_m165._tag === "some") {
              const fn_val = __ring_m165._0;
            ...
            if (__ring_m165._tag === "none") {
              ...
              __ring_match166: {
                const __ring_m166 = _Map_get(ctx.functions, mangled_bare);
                ...
                if (__ring_m166._tag === "none") {
                  ...
                  __ring_match167: {
                    const __ring_m167 = _Map_get(ctx.functions, mangled_name_resolved);
                    ...
                    if (__ring_m167._tag === "none") {
                      ...
                      __ring_match168: {
                        const __ring_m168 = _Map_get(ctx.functions, mangled_lu);
                        ...
                        if (__ring_m168._tag === "none") {
                          ...
                          __ring_match169: {
                            const __ring_m169 = found;
                            if (__ring_m169._tag === "some") {
                              const fi = __ring_m169._0;
                            ...
                            if (__ring_m169._tag === "none") {
                              ...
                              __ring_match170: {
                                const __ring_m170 = found2;
                                if (__ring_m170._tag === "some") {
                                  const fi2 = __ring_m170._0;
...
function check_nested_ctor_tags(ctx, val, pat, fail_bb, current_fn) {
  __ring_match171: {
    const __ring_m171 = pat;
    if (__ring_m171._tag === "Constructor") {
      const cname = __ring_m171.name; const qualifier = __ring_m171.qualifier; const fields = __ring_m171.fields;
      const ei = find_enum_by_variant(ctx, cname, qualifier);
      __ring_match172: {
        const __ring_m172 = ei;
        if (__ring_m172._tag === "some") {
          const enum_info = __ring_m172._0;
          __ring_match173: {
            const __ring_m173 = _Map_get(enum_info.variants, cname);
            if (__ring_m173._tag === "some") {
              const vi = __ring_m173._0;
              ...
              const __ring_end81 = List_len(fields);
              for (let i = 0; i < __ring_end81; i++) {
                __ring_match174: {
                  const __ring_m174 = List_get(fields, i);
                  if (__ring_m174._tag === "some") {
                    const fp = __ring_m174._0;
    ...
    if (__ring_m171._tag === "NamedConstructor") {
      const cname = __ring_m171.name; const qualifier = __ring_m171.qualifier; const nfields = __ring_m171.fields;
      const ei = find_enum_by_variant(ctx, cname, qualifier);
      __ring_match175: {
        const __ring_m175 = ei;
        if (__ring_m175._tag === "some") {
          const enum_info = __ring_m175._0;
          __ring_match176: {
            const __ring_m176 = _Map_get(enum_info.variants, cname);
            if (__ring_m176._tag === "some") {
              const vi = __ring_m176._0;
              const tag_ptr = LLVMBuildStructGEP2(ctx.builder, enum_info.llvm_type, val, 0, codegen_llvm_ctx$fresh_name(ctx, "ntp"));
              const tag_val = LLVMBuildLoad2(ctx.builder, ctx.i64_type, tag_ptr, codegen_llvm_ctx$fresh_name(ctx, "ntag"));
              const expected = LLVMConstInt(ctx.i64_type, vi.tag, 0);
              const cmp = LLVMBuildICmp(ctx.builder, 32, tag_val, expected, codegen_llvm_ctx$fresh_name(ctx, "ntc"));
              ...
              discard(LLVMBuildCondBr(ctx.builder, cmp, pass_bb, fail_bb));
              LLVMPositionBuilderAtEnd(ctx.builder, pass_bb);
              const __ring_end82 = List_len(nfields);
              for (let i = 0; i < __ring_end82; i++) {
                __ring_match177: {
                  const __ring_m177 = List_get(nfields, i);
                  if (__ring_m177._tag === "some") {
                    const nf = __ring_m177._0;
                    let field_idx = i;
                    const __ring_end83 = List_len(vi.field_names);
                    for (let fi = 0; fi < __ring_end83; fi++) {
                      if ((__ring_index(vi.field_names, fi) === nf.name)) {
                        field_idx = fi;
                      }
                    }
...
function gen_literal_pattern_cond(ctx, scrut_val, scrut_ty, value) {
  __ring_match180: {
    const __ring_m180 = value;
    if (__ring_m180._tag === "IntVal") {
      const n = __ring_m180._0;
    ...
    if (__ring_m180._tag === "BoolVal") {
      const b = __ring_m180._0;
      const raw = unbox_int(ctx, scrut_val);
      const lit = (b ? LLVMConstInt(ctx.i64_type, 1, 0) : LLVMConstInt(ctx.i64_type, 0, 0));
      return LLVMBuildICmp(ctx.builder, 32, raw, lit, codegen_llvm_ctx$fresh_name(ctx, "eq"));
      break __ring_match180;
    }
    if (__ring_m180._tag === "StrVal") {
      const s = __ring_m180._0;
    ...
    if (__ring_m180._tag === "FloatVal") {
      const f = __ring_m180._0;
      const unbox_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_unbox_float", [ctx.ptr_type], ctx.double_type);
      const unbox_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_unbox_float");
...
function tuple_element_type(ty, idx) {
  __ring_match181: {
    const __ring_m181 = ty;
    if (__ring_m181._tag === "TupleType") {
      const elements = __ring_m181.elements;
      __ring_match182: {
        const __ring_m182 = List_get(elements, idx);
        if (__ring_m182._tag === "some") {
          const t = __ring_m182._0;
          return t;
...
function gen_unaryop(ctx, op, operand, ty) {
  ...
  __ring_match183: {
    const __ring_m183 = op;
    if (__ring_m183._tag === "Neg") {
      if (is_int_type(ty)) {
        const raw = unbox_int(ctx, val);
...
function gen_catch_arms(ctx, error_val, arms) {
  ...
  if (((!has_constructor) ? true : (List_len(arms) === 1))) {
    ...
    __ring_match185: {
      ...
      if (__ring_m185._tag === "Constructor") {
        const name = __ring_m185.name; const fields = __ring_m185.fields;
  ...
  while (true) {
    ...
    __ring_match186: {
      ...
      if (__ring_m186._tag === "Constructor") {
        const name = __ring_m186.name; const qualifier = __ring_m186.qualifier;
    ...
    __ring_match187: {
      const __ring_m187 = enum_info_opt;
  ...
  let __ring_blk46;
  __ring_match190: {
    const __ring_m190 = ctx.current_fn;
  ...
  while (true) {
    ...
    __ring_match191: {
      ...
      if (__ring_m191._tag === "Constructor") {
        ...
        __ring_match192: {
          const __ring_m192 = _Map_get(enum_info.variants, name);
          if (__ring_m192._tag === "some") {
            ...
            for (let i = 0; i < __ring_end87; i++) {
              __ring_match193: {
                const __ring_m193 = List_get(fields, i);
                if (__ring_m193._tag === "some") {
                  const field_pat = __ring_m193._0;
                  __ring_match194: {
                    const __ring_m194 = field_pat;
                    if (__ring_m194._tag === "Binding") {
                      const bname = __ring_m194.name;
      ...
      if (__ring_m191._tag === "NamedConstructor") {
        const name = __ring_m191.name; const named_fields = __ring_m191.fields;
        __ring_match195: {
          const __ring_m195 = _Map_get(enum_info.variants, name);
          if (__ring_m195._tag === "some") {
            const vi = __ring_m195._0;
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `catch.arm.${name}`);
            LLVMAddCase(switch_val, LLVMConstInt(ctx.i64_type, vi.tag, 0), arm_bb);
            LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
            const __ring_end88 = List_len(named_fields);
            for (let i = 0; i < __ring_end88; i++) {
              __ring_match196: {
                const __ring_m196 = List_get(named_fields, i);
                if (__ring_m196._tag === "some") {
                  const nf = __ring_m196._0;
                  let field_idx = i;
...
function gen_try_catch(ctx, body, arms) {
  let __ring_blk47;
  __ring_match198: {
    const __ring_m198 = ctx.current_fn;
    if (__ring_m198._tag === "some") {
      const f = __ring_m198._0;
      __ring_blk47 = f;
...
function gen_struct_lit(ctx, name, fields, spread) {
  __ring_match199: {
    const __ring_m199 = _Map_get(ctx.struct_types, name);
    if (__ring_m199._tag === "some") {
      const info = __ring_m199._0;
      ...
      __ring_match200: {
        const __ring_m200 = spread;
        if (__ring_m200._tag === "some") {
          const spread_expr = __ring_m200._0;
          let overridden = set_new();
          const __ring_iter_90 = __List_Iterable.iter(fields);
          while (true) {
          ...
          const __ring_end91 = List_len(info.field_names);
          for (let i = 0; i < __ring_end91; i++) {
...
function gen_string_interp(ctx, parts) {
  ...
  const drop_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_drop", [ctx.ptr_type], ctx.void_type);
  const drop_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_drop");
  const __ring_iter_94 = __List_Iterable.iter(parts);
  while (true) {
    const __ring_next_94 = __ListIterator_Iterator.next(__ring_iter_94);
    if (__ring_next_94._tag === "none") break;
    const part = __ring_next_94._0;
    __ring_match201: {
      const __ring_m201 = part;
      if (__ring_m201._tag === "Literal") {
        const s = __ring_m201._0;
      ...
      if (__ring_m201._tag === "Expression") {
        const e = __ring_m201._0;
...
function gen_named_variant_construct(ctx, enum_name, variant_name, fields, spread) {
  __ring_match202: {
    const __ring_m202 = _Map_get(ctx.enum_types, enum_name);
    if (__ring_m202._tag === "some") {
      const enum_info = __ring_m202._0;
      __ring_match203: {
        const __ring_m203 = _Map_get(enum_info.variants, variant_name);
        if (__ring_m203._tag === "some") {
          ...
          __ring_match204: {
            const __ring_m204 = spread;
            if (__ring_m204._tag === "some") {
              const spread_expr = __ring_m204._0;
              let overridden = set_new();
              const __ring_iter_95 = __List_Iterable.iter(fields);
              while (true) {
                const __ring_next_95 = __ListIterator_Iterator.next(__ring_iter_95);
                if (__ring_next_95._tag === "none") break;
                const f = __ring_next_95._0;
                _Set_insert(overridden, f.name);
              }
              const spread_val = gen_llvm_expr(ctx, spread_expr);
              const __ring_end96 = List_len(vi.field_names);
          ...
          const __ring_end97 = List_len(fields);
          for (let i = 0; i < __ring_end97; i++) {
            __ring_match205: {
              const __ring_m205 = List_get(fields, i);
              if (__ring_m205._tag === "some") {
                const f = __ring_m205._0;
                const val = gen_llvm_expr(ctx, f.value);
                let field_idx = i;
                const __ring_end98 = List_len(vi.field_names);
                for (let fi = 0; fi < __ring_end98; fi++) {
    ...
    if (__ring_m202._tag === "none") {
      ...
      __ring_match206: {
        const __ring_m206 = _Map_get(ctx.functions, ctor_name);
        if (__ring_m206._tag === "some") {
          const fn_val = __ring_m206._0;
          let args = [];
          ...
          let __ring_blk48;
          __ring_match207: {
            const __ring_m207 = _Map_get(ctx.fn_types, ctor_name);
            if (__ring_m207._tag === "some") {
              const t = __ring_m207._0;
              __ring_blk48 = t;
...
function emit_match_arm_body(ctx, arm, merge_bb, next_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match208: {
    const __ring_m208 = arm.guard;
    if (__ring_m208._tag === "some") {
      const g = __ring_m208._0;
...
function gen_match_if_else(ctx, scrut_val, scrut_ty, arms, merge_bb, default_bb, current_fn) {
  ...
  const __ring_end100 = total;
  for (let i = 0; i < __ring_end100; i++) {
    __ring_match209: {
      const __ring_m209 = List_get(arms, i);
      if (__ring_m209._tag === "some") {
        const arm = __ring_m209._0;
        const is_last = (i === (total - 1));
        let __ring_blk49;
        __ring_match210: {
          const __ring_m210 = arm.guard;
        ...
        __ring_match211: {
          const __ring_m211 = arm.pattern;
          if (__ring_m211._tag === "Wildcard") {
            open_block = false;
          ...
          if (__ring_m211._tag === "Binding") {
            const bname = __ring_m211.name;
            open_block = false;
            const next_bb = ((has_guard ? (is_last === false) : false) ? LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next") : default_bb);
          ...
          if (__ring_m211._tag === "Literal") {
            const value = __ring_m211.value;
          ...
          if (__ring_m211._tag === "Constructor") {
            const cname = __ring_m211.name; const qualifier = __ring_m211.qualifier; const fields = __ring_m211.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            ...
            __ring_match212: {
              const __ring_m212 = ei_check;
              if (__ring_m212._tag === "some") {
                const enum_info_c = __ring_m212._0;
                const __ring_end101 = List_len(fields);
                for (let j = 0; j < __ring_end101; j++) {
                  __ring_match213: {
                    const __ring_m213 = List_get(fields, j);
                    if (__ring_m213._tag === "some") {
                      const fp = __ring_m213._0;
          ...
          if (__ring_m211._tag === "NamedConstructor") {
            const cname = __ring_m211.name; const qualifier = __ring_m211.qualifier; const nfields = __ring_m211.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.ctor.${cname}`);
            gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, arm_bb, next_bb, current_fn);
            LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
            const ei_check = find_enum_by_variant(ctx, cname, qualifier);
            __ring_match214: {
              const __ring_m214 = ei_check;
              if (__ring_m214._tag === "some") {
                const enum_info_c = __ring_m214._0;
                __ring_match215: {
                  const __ring_m215 = _Map_get(enum_info_c.variants, cname);
                  if (__ring_m215._tag === "some") {
                    const vi_c = __ring_m215._0;
                    const __ring_end102 = List_len(nfields);
                    for (let j = 0; j < __ring_end102; j++) {
                      __ring_match216: {
                        const __ring_m216 = List_get(nfields, j);
                        if (__ring_m216._tag === "some") {
                          const nf = __ring_m216._0;
                          let fidx = j;
                          const __ring_end103 = List_len(vi_c.field_names);
                          for (let fi = 0; fi < __ring_end103; fi++) {
          ...
          if (__ring_m211._tag === "OrPattern") {
            const patterns = __ring_m211.patterns;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.or");
            const palts = patterns;
            const nalts = List_len(palts);
            const __ring_end104 = nalts;
            for (let k = 0; k < __ring_end104; k++) {
              __ring_match217: {
                const __ring_m217 = List_get(palts, k);
                if (__ring_m217._tag === "some") {
                  const alt = __ring_m217._0;
                  let __ring_blk50;
                  __ring_match218: {
                    const __ring_m218 = alt;
                    if (__ring_m218._tag === "Constructor") {
                      const an = __ring_m218.name; const aq = __ring_m218.qualifier;
                      __ring_blk50 = Option_some([an, aq]);
                      break __ring_match218;
                    }
                    if (__ring_m218._tag === "NamedConstructor") {
                      const an = __ring_m218.name; const aq = __ring_m218.qualifier;
                      __ring_blk50 = Option_some([an, aq]);
                      break __ring_match218;
                    }
                  ...
                  __ring_match219: {
                    const __ring_m219 = alt_ref;
                    if (__ring_m219._tag === "some") {
                      const ar = __ring_m219._0;
                      const __ring_dt7 = ar;
                      const an = __ring_dt7[0];
                      const aq = __ring_dt7[1];
          ...
          if (__ring_m211._tag === "TuplePattern") {
            const elements = __ring_m211.elements;
            const get_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_get", [ctx.ptr_type, ctx.i64_type], ctx.ptr_type);
            const get_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_get");
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const __ring_end105 = List_len(elements);
            for (let j = 0; j < __ring_end105; j++) {
              __ring_match220: {
                const __ring_m220 = List_get(elements, j);
                if (__ring_m220._tag === "some") {
                  const elem_pat = __ring_m220._0;
                  let __ring_blk51;
                  __ring_match221: {
                    const __ring_m221 = elem_pat;
                    if (__ring_m221._tag === "Constructor") {
                      const cname = __ring_m221.name; const qualifier = __ring_m221.qualifier;
                      __ring_blk51 = Option_some([cname, qualifier]);
                      break __ring_match221;
                    }
                    if (__ring_m221._tag === "NamedConstructor") {
                      const cname = __ring_m221.name; const qualifier = __ring_m221.qualifier;
                      __ring_blk51 = Option_some([cname, qualifier]);
                      break __ring_match221;
                    }
                  ...
                  __ring_match222: {
                    const __ring_m222 = ctor_ref;
                    if (__ring_m222._tag === "some") {
                      const cref = __ring_m222._0;
                      ...
                      const ei = find_enum_by_variant(ctx, cname, qualifier);
                      __ring_match223: {
                        const __ring_m223 = ei;
                        if (__ring_m223._tag === "some") {
                          const enum_info = __ring_m223._0;
                          __ring_match224: {
                            const __ring_m224 = _Map_get(enum_info.variants, cname);
                            if (__ring_m224._tag === "some") {
                              const vi = __ring_m224._0;
                    ...
                    if (__ring_m222._tag === "none") {
                      __ring_match225: {
                        const __ring_m225 = elem_pat;
                        if (__ring_m225._tag === "Literal") {
                          const value = __ring_m225.value;
                          const idx = LLVMConstInt(ctx.i64_type, j, 0);
            ...
            for (let j = 0; j < __ring_end106; j++) {
              __ring_match226: {
                const __ring_m226 = List_get(elements, j);
                if (__ring_m226._tag === "some") {
                  const elem_pat = __ring_m226._0;
                  __ring_match227: {
                    const __ring_m227 = elem_pat;
                    if (__ring_m227._tag === "Binding") {
                      const bname = __ring_m227.name;
                      const idx = LLVMConstInt(ctx.i64_type, j, 0);
...
function gen_match_arm_enum(ctx, arm, scrut_val, enum_name, enum_info, switch_val, merge_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match229: {
    ...
    if (__ring_m229._tag === "Constructor") {
      const name = __ring_m229.name; const fields = __ring_m229.fields;
      __ring_match230: {
        const __ring_m230 = _Map_get(enum_info.variants, name);
        if (__ring_m230._tag === "some") {
          const vi = __ring_m230._0;
          ...
          for (let i = 0; i < __ring_end107; i++) {
            __ring_match231: {
              const __ring_m231 = List_get(fields, i);
              if (__ring_m231._tag === "some") {
                const field_pat = __ring_m231._0;
                __ring_match232: {
                  const __ring_m232 = field_pat;
    ...
    if (__ring_m229._tag === "NamedConstructor") {
      const name = __ring_m229.name; const named_fields = __ring_m229.fields;
      __ring_match233: {
        ...
        if (__ring_m233._tag === "some") {
          ...
          LLVMAddCase(switch_val, LLVMConstInt(ctx.i64_type, vi.tag, 0), arm_bb);
          LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          const __ring_end108 = List_len(named_fields);
          for (let i = 0; i < __ring_end108; i++) {
            __ring_match234: {
              const __ring_m234 = List_get(named_fields, i);
              if (__ring_m234._tag === "some") {
                const nf = __ring_m234._0;
                let field_idx = i;
                const __ring_end109 = List_len(vi.field_names);
                ...
                __ring_match235: {
                  const __ring_m235 = nf.pattern;
                  if (__ring_m235._tag === "Binding") {
                    const bname = __ring_m235.name;
                    const field_ptr = LLVMBuildStructGEP2(ctx.builder, enum_info.llvm_type, scrut_val, (field_idx + 1), codegen_llvm_ctx$fresh_name(ctx, "ef"));
                    const field_val = LLVMBuildLoad2(ctx.builder, ctx.ptr_type, field_ptr, codegen_llvm_ctx$fresh_name(ctx, bname));
                    const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
                    discard(LLVMBuildStore(ctx.builder, field_val, alloca));
    ...
    if (__ring_m229._tag === "OrPattern") {
      const patterns = __ring_m229.patterns;
      ...
      while (true) {
        ...
        let __ring_blk52;
        __ring_match236: {
          const __ring_m236 = alt;
          if (__ring_m236._tag === "Constructor") {
            const name = __ring_m236.name;
            __ring_blk52 = Option_some(name);
            break __ring_match236;
          }
          if (__ring_m236._tag === "NamedConstructor") {
            const name = __ring_m236.name;
            __ring_blk52 = Option_some(name);
            break __ring_match236;
          }
        ...
        __ring_match237: {
          const __ring_m237 = alt_name;
          if (__ring_m237._tag === "some") {
            const an = __ring_m237._0;
            __ring_match238: {
              const __ring_m238 = _Map_get(enum_info.variants, an);
...
function gen_match_expr(ctx, scrutinee, arms, result_ty) {
  let __ring_blk53;
  __ring_match239: {
    const __ring_m239 = ctx.current_fn;
  ...
  let __ring_blk54;
  __ring_match240: {
    const __ring_m240 = scrut_ty;
    if (__ring_m240._tag === "EnumType") {
      const name = __ring_m240.name;
  ...
  while (true) {
    ...
    let __ring_blk55;
    __ring_match242: {
      const __ring_m242 = arm.pattern;
      if (__ring_m242._tag === "Constructor") {
        const name = __ring_m242.name;
        __ring_blk55 = Option_some(name);
        break __ring_match242;
      }
      if (__ring_m242._tag === "NamedConstructor") {
        const name = __ring_m242.name;
        __ring_blk55 = Option_some(name);
        break __ring_match242;
      }
    ...
    __ring_match243: {
      const __ring_m243 = ctor_name;
      if (__ring_m243._tag === "some") {
        const cn = __ring_m243._0;
  ...
  __ring_match244: {
    const __ring_m244 = enum_name;
    if (__ring_m244._tag === "some") {
      const ename = __ring_m244._0;
      __ring_match245: {
        const __ring_m245 = _Map_get(ctx.enum_types, ename);
        if (__ring_m245._tag === "some") {
          const enum_info = __ring_m245._0;
          const tag_ptr = LLVMBuildStructGEP2(ctx.builder, enum_info.llvm_type, scrut_val, 0, codegen_llvm_ctx$fresh_name(ctx, "tp"));
          const tag_val = LLVMBuildLoad2(ctx.builder, ctx.i64_type, tag_ptr, codegen_llvm_ctx$fresh_name(ctx, "tag"));
...
function gen_index_expr(ctx, receiver, index, ty) {
  ...
  let __ring_blk57;
  __ring_match247: {
    const __ring_m247 = types$type_to_builtin_name(recv_type);
    if (__ring_m247._tag === "some") {
      const n = __ring_m247._0;
      __ring_blk57 = n;
...
function gen_if_expr(ctx, condition, then_branch, else_branch) {
  let __ring_blk58;
  __ring_match248: {
    const __ring_m248 = ctx.current_fn;
    if (__ring_m248._tag === "some") {
      const f = __ring_m248._0;
      __ring_blk58 = f;
  ...
  let __ring_blk59;
  __ring_match249: {
    const __ring_m249 = else_branch;
    if (__ring_m249._tag === "some") {
      const eb = __ring_m249._0;
    ...
    if (__ring_m251._tag === "some") {
      ...
      while (true) {
        ...
        if ((op.has_default ? (!_Set_contains(handled_ops, op.name, __Str_Eq)) : false)) {
          __ring_match252: {
            const __ring_m252 = op.default_body;
            if (__ring_m252._tag === "some") {
              const dbody = __ring_m252._0;
...
function gen_handle_expr(ctx, body, handlers) {
  ...
  while (true) {
    ...
    __ring_match253: {
      const __ring_m253 = _Map_get(by_effect, h.effect_name);
      if (__ring_m253._tag === "some") {
        const existing = __ring_m253._0;
  ...
  while (true) {
    ...
    __ring_match254: {
      const __ring_m254 = _Map_get(ctx.named_values, ev_name);
      if (__ring_m254._tag === "some") {
        const outer_alloca = __ring_m254._0;
  ...
  if (has_fail_abort) {
    let __ring_blk61;
    __ring_match255: {
      const __ring_m255 = ctx.current_fn;
      if (__ring_m255._tag === "some") {
        const f = __ring_m255._0;
        __ring_blk61 = f;
...
function gen_field_access(ctx, receiver, field, ty) {
  ...
  const recv_type = hir$hexpr_type(receiver);
  __ring_match256: {
    const __ring_m256 = recv_type;
    if (__ring_m256._tag === "TupleType") {
      let __ring_blk62;
      __ring_match257: {
        const __ring_m257 = parse_int(field);
        if (__ring_m257._tag === "some") {
          const n = __ring_m257._0;
          __ring_blk62 = n;
  ...
  __ring_match258: {
    ...
    if (__ring_m258._tag === "RecordType") {
  ...
  __ring_match259: {
    ...
    if (__ring_m259._tag === "StructType") {
      const name = __ring_m259.name;
      __ring_blk63 = name;
      break __ring_match259;
    }
    if (__ring_m259._tag === "EnumType") {
      const name = __ring_m259.name;
      __ring_blk63 = name;
      break __ring_match259;
    }
  ...
  __ring_match260: {
    const __ring_m260 = _Map_get(ctx.struct_types, type_name);
    if (__ring_m260._tag === "some") {
      const info = __ring_m260._0;
      let field_idx = (-1);
...
function gen_effect_op(ctx, effect_name, op_name, args) {
  if (((effect_name === "fail") ? (op_name === "raise") : false)) {
    ...
    let __ring_blk64;
    __ring_match261: {
      const __ring_m261 = ctx.current_fn;
      if (__ring_m261._tag === "some") {
        const f = __ring_m261._0;
        __ring_blk64 = f;
    ...
    let __ring_blk65;
    __ring_match262: {
      const __ring_m262 = _Map_get(ctx.effect_ops, effect_name);
...
function gen_mut_arg_llvm(ctx, arg) {
  __ring_match263: {
    const __ring_m263 = arg;
    if (__ring_m263._tag === "Ident") {
      const name = __ring_m263.name; const resolved_name = __ring_m263.resolved_name; const def_id = __ring_m263.def_id;
      if (is_boxed_def(ctx, def_id)) {
        let __ring_blk66;
        __ring_match264: {
          const __ring_m264 = resolved_name;
          if (__ring_m264._tag === "some") {
            const rn = __ring_m264._0;
            __ring_blk66 = rn;
        ...
        __ring_match265: {
          const __ring_m265 = _Map_get(ctx.named_values, lookup_name);
          ...
          if (__ring_m265._tag === "none") {
            __ring_match266: {
              const __ring_m266 = _Map_get(ctx.named_values, name);
...
function gen_dict_dispatch_call(ctx, callee, args, dd) {
  ...
  __ring_match267: {
    const __ring_m267 = callee;
    if (__ring_m267._tag === "FieldAccess") {
      const receiver = __ring_m267.receiver;
      recv_val = Option_some(gen_llvm_expr(ctx, receiver));
      break __ring_match267;
    }
    __ring_match268: {
      const __ring_m268 = List_get(args, 0);
      if (__ring_m268._tag === "some") {
        const a = __ring_m268._0;
  ...
  let call_args = [];
  __ring_match269: {
    const __ring_m269 = recv_val;
    if (__ring_m269._tag === "some") {
      const rv = __ring_m269._0;
  ...
  for (let i = other_arg_start; i < __ring_end127; i++) {
    __ring_match270: {
      const __ring_m270 = List_get(args, i);
      if (__ring_m270._tag === "some") {
        const a = __ring_m270._0;
  ...
  let __ring_blk67;
  __ring_match271: {
    const __ring_m271 = _Map_get(ctx.named_values, dd.dict_param);
    if (__ring_m271._tag === "some") {
      const dict_alloca = __ring_m271._0;
...
function gen_call(ctx, callee, args, resolved_dicts, dict_dispatch, result_ty, effects) {
  __ring_match272: {
    const __ring_m272 = dict_dispatch;
    if (__ring_m272._tag === "some") {
      const dd = __ring_m272._0;
  ...
  let arg_vals = [];
  let argi = 0;
  const __ring_iter_128 = __List_Iterable.iter(args);
  while (true) {
    const __ring_next_128 = __ListIterator_Iterator.next(__ring_iter_128);
    if (__ring_next_128._tag === "none") break;
    const a = __ring_next_128._0;
    let __ring_blk68;
    __ring_match273: {
      const __ring_m273 = mut_flags;
      if (__ring_m273._tag === "some") {
        const flags = __ring_m273._0;
        let __ring_blk69;
        __ring_match274: {
          const __ring_m274 = List_get(flags, argi);
          if (__ring_m274._tag === "some") {
            const f = __ring_m274._0;
            __ring_blk69 = f;
  ...
  __ring_match275: {
    ...
    if (__ring_m275._tag === "Ident") {
      const name = __ring_m275.name; const resolved_name = __ring_m275.resolved_name;
      let __ring_blk71;
      __ring_match276: {
        const __ring_m276 = resolved_name;
        if (__ring_m276._tag === "some") {
          const rn = __ring_m276._0;
          __ring_blk71 = rn;
    ...
    if (__ring_m275._tag === "FieldAccess") {
      const receiver = __ring_m275.receiver; const field = __ring_m275.field;
      const recv_val = gen_llvm_expr(ctx, receiver);
      const recv_type = hir$hexpr_type(receiver);
...
function gen_ord_dispatch_llvm(ctx, op, left, right, dispatch) {
  ...
  __ring_match280: {
    ...
    if (__ring_m280._tag === "Lt") {
      __ring_blk72 = 40;
      break __ring_match280;
    }
    if (__ring_m280._tag === "Lte") {
      __ring_blk72 = 41;
      break __ring_match280;
    }
    if (__ring_m280._tag === "Gt") {
      __ring_blk72 = 38;
      break __ring_match280;
    }
    if (__ring_m280._tag === "Gte") {
      __ring_blk72 = 39;
      break __ring_match280;
    }
    __ring_blk72 = 32;
...
function gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch, result_ty) {
  ...
  __ring_match283: {
    ...
    if (__ring_m283._tag === "Eq") {
      __ring_blk73 = true;
      break __ring_match283;
    }
    if (__ring_m283._tag === "Neq") {
      __ring_blk73 = true;
      break __ring_match283;
    }
    __ring_blk73 = false;
  ...
  __ring_match284: {
    ...
    if (__ring_m284._tag === "Lt") {
      __ring_blk74 = true;
      break __ring_match284;
    }
    if (__ring_m284._tag === "Lte") {
      __ring_blk74 = true;
      break __ring_match284;
    }
    if (__ring_m284._tag === "Gt") {
      __ring_blk74 = true;
      break __ring_match284;
    }
    if (__ring_m284._tag === "Gte") {
      __ring_blk74 = true;
      break __ring_match284;
    }
    __ring_blk74 = false;
  ...
  if (is_eq_op) {
    __ring_match285: {
      const __ring_m285 = eq_dispatch;
      if (__ring_m285._tag === "some") {
        const d = __ring_m285._0;
        __ring_match286: {
          const __ring_m286 = d;
          if (__ring_m286._tag === "Builtin") {
  ...
  if (is_ord_op) {
    __ring_match287: {
      const __ring_m287 = ord_dispatch;
      if (__ring_m287._tag === "some") {
        const d = __ring_m287._0;
        __ring_match288: {
          const __ring_m288 = d;
          if (__ring_m288._tag === "Builtin") {
...
function gen_llvm_expr(ctx, expr) {
  __ring_match289: {
    const __ring_m289 = expr;
    if (__ring_m289._tag === "IntLit") {
      const value = __ring_m289.value;
      return gen_int_lit(ctx, value);
      break __ring_match289;
    }
    if (__ring_m289._tag === "FloatLit") {
      const value = __ring_m289.value;
      return gen_float_lit(ctx, value);
      break __ring_match289;
    }
    if (__ring_m289._tag === "StrLit") {
      const value = __ring_m289.value;
      return gen_str_lit(ctx, value);
      break __ring_match289;
    }
    if (__ring_m289._tag === "BoolLit") {
      const value = __ring_m289.value;
      return gen_bool_lit(ctx, value);
      break __ring_match289;
    }
    if (__ring_m289._tag === "Ident") {
      const name = __ring_m289.name; const resolved_name = __ring_m289.resolved_name; const def_id = __ring_m289.def_id; const dict_closure_dicts = __ring_m289.dict_closure_dicts; const ty = __ring_m289.ty;
      return gen_ident(ctx, name, resolved_name, def_id, dict_closure_dicts, ty);
      break __ring_match289;
    }
    if (__ring_m289._tag === "BinOp") {
      const op = __ring_m289.op; const left = __ring_m289.left; const right = __ring_m289.right; const eq_dispatch = __ring_m289.eq_dispatch; const ord_dispatch = __ring_m289.ord_dispatch; const ty = __ring_m289.ty;
      return gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch, ty);
      break __ring_match289;
    }
    if (__ring_m289._tag === "UnaryOp") {
      const op = __ring_m289.op; const operand = __ring_m289.operand; const ty = __ring_m289.ty;
      return gen_unaryop(ctx, op, operand, ty);
      break __ring_match289;
    }
    if (__ring_m289._tag === "Call") {
      const callee = __ring_m289.callee; const args = __ring_m289.args; const resolved_dicts = __ring_m289.resolved_dicts; const dict_dispatch = __ring_m289.dict_dispatch; const ty = __ring_m289.ty; const effects = __ring_m289.effects;
      return gen_call(ctx, callee, args, resolved_dicts, dict_dispatch, ty, effects);
      break __ring_match289;
    }
    if (__ring_m289._tag === "DictConstruct") {
      const base_dict = __ring_m289.base_dict; const trait_name = __ring_m289.trait_name; const inner = __ring_m289.inner;
      return build_wrapped_dict(ctx, base_dict, trait_name, inner);
      break __ring_match289;
    }
    if (__ring_m289._tag === "FieldAccess") {
      const receiver = __ring_m289.receiver; const field = __ring_m289.field; const ty = __ring_m289.ty;
      return gen_field_access(ctx, receiver, field, ty);
      break __ring_match289;
    }
    if (__ring_m289._tag === "StructLit") {
      const name = __ring_m289.name; const fields = __ring_m289.fields; const spread = __ring_m289.spread;
      return gen_struct_lit(ctx, name, fields, spread);
      break __ring_match289;
    }
    if (__ring_m289._tag === "Block") {
      const stmts = __ring_m289.stmts; const tail = __ring_m289.tail;
      return gen_block(ctx, stmts, tail);
      break __ring_match289;
    }
    if (__ring_m289._tag === "IfExpr") {
      const condition = __ring_m289.condition; const then_branch = __ring_m289.then_branch; const else_branch = __ring_m289.else_branch;
      return gen_if_expr(ctx, condition, then_branch, else_branch);
      break __ring_match289;
    }
    if (__ring_m289._tag === "StringInterp") {
      const parts = __ring_m289.parts;
      return gen_string_interp(ctx, parts);
      break __ring_match289;
    }
    if (__ring_m289._tag === "Lambda") {
      const params = __ring_m289.params; const return_type = __ring_m289.return_type; const body = __ring_m289.body; const ty = __ring_m289.ty;
      return gen_lambda(ctx, params, return_type, body, ty);
      break __ring_match289;
    }
    if (__ring_m289._tag === "MatchExpr") {
      const scrutinee = __ring_m289.scrutinee; const arms = __ring_m289.arms; const ty = __ring_m289.ty;
      return gen_match_expr(ctx, scrutinee, arms, ty);
      break __ring_match289;
    }
    if (__ring_m289._tag === "NamedVariantConstruct") {
      const enum_name = __ring_m289.enum_name; const variant_name = __ring_m289.variant_name; const fields = __ring_m289.fields; const spread = __ring_m289.spread;
      return gen_named_variant_construct(ctx, enum_name, variant_name, fields, spread);
      break __ring_match289;
    }
    if (__ring_m289._tag === "TryCatch") {
      const body = __ring_m289.body; const arms = __ring_m289.arms;
      return gen_try_catch(ctx, body, arms);
      break __ring_match289;
    }
    if (__ring_m289._tag === "HandleExpr") {
      const body = __ring_m289.body; const handlers = __ring_m289.handlers;
      return gen_handle_expr(ctx, body, handlers);
      break __ring_match289;
    }
    if (__ring_m289._tag === "EffectOp") {
      const effect_name = __ring_m289.effect_name; const op_name = __ring_m289.op_name; const args = __ring_m289.args;
      return gen_effect_op(ctx, effect_name, op_name, args);
      break __ring_match289;
    }
    if (__ring_m289._tag === "RangeExpr") {
      const start = __ring_m289.start; const end = __ring_m289.end; const inclusive = __ring_m289.inclusive;
      return gen_range_expr(ctx, start, end, inclusive);
      break __ring_match289;
    }
    if (__ring_m289._tag === "ListLit") {
      const elements = __ring_m289.elements;
      return gen_list_lit(ctx, elements);
      break __ring_match289;
    }
    if (__ring_m289._tag === "TupleLit") {
      const elements = __ring_m289.elements;
      return gen_tuple_lit(ctx, elements);
      break __ring_match289;
    }
    if (__ring_m289._tag === "IndexExpr") {
      const receiver = __ring_m289.receiver; const index = __ring_m289.index; const ty = __ring_m289.ty;
      return gen_index_expr(ctx, receiver, index, ty);
      break __ring_match289;
    }
    if (__ring_m289._tag === "Clone") {
      const inner = __ring_m289.inner;
      return gen_clone(ctx, inner);
      break __ring_match289;
    }
    if (__ring_m289._tag === "ReturnExpr") {
      const value = __ring_m289.value;
      __ring_match290: {
        const __ring_m290 = value;
        if (__ring_m290._tag === "some") {
          const v = __ring_m290._0;
...
function gen_lambda(ctx, params, return_type, body, ty) {
  ...
  const __ring_end132 = List_len(captures);
  for (let i = 0; i < __ring_end132; i++) {
    __ring_match293: {
      const __ring_m293 = List_get(captures, i);
      if (__ring_m293._tag === "some") {
        const cap_name = __ring_m293._0;
  ...
  const __ring_end133 = List_len(params);
  for (let i = 0; i < __ring_end133; i++) {
    __ring_match294: {
      const __ring_m294 = List_get(params, i);
      if (__ring_m294._tag === "some") {
        const p = __ring_m294._0;
  ...
  for (let i = 0; i < __ring_end134; i++) {
    __ring_match295: {
      ...
      if (__ring_m295._tag === "some") {
        ...
        let __ring_blk76;
        __ring_match296: {
          const __ring_m296 = _Map_get(ctx.named_values, cap_name);
          if (__ring_m296._tag === "some") {
            const alloca = __ring_m296._0;
...
function build_default_evidence_all(ctx) {
  ...
  const __ring_iter_137 = __List_Iterable.iter(effect_names);
  while (true) {
    const __ring_next_137 = __ListIterator_Iterator.next(__ring_iter_137);
    if (__ring_next_137._tag === "none") break;
    const ename = __ring_next_137._0;
    __ring_match297: {
      const __ring_m297 = _Map_get(ctx.effect_ops, ename);
      if (__ring_m297._tag === "some") {
        const ops = __ring_m297._0;
        const n_slots = List_len(ops);
        let slot_types = [ctx.i64_type];
        const __ring_end138 = n_slots;
        for (let i = 0; i < __ring_end138; i++) {
          List_push(slot_types, ctx.ptr_type);
        }
        const ev_ty = LLVMStructTypeInContext(ctx.context, slot_types, 0);
        const ev_size = LLVMSizeOf(ev_ty);
        ...
        while (true) {
          ...
          const idx = ((slot_idx >= 0) ? slot_idx : 0);
          __ring_match298: {
            const __ring_m298 = op.default_body;
            if (__ring_m298._tag === "some") {
              const dbody = __ring_m298._0;
...
function emit_memoised_dict_getter(ctx, name, build_fn, build_fn_ty) {
  const fname = `ring_dict_init_${name}`;
  __ring_match299: {
    const __ring_m299 = _Map_get(ctx.functions, fname);
    if (__ring_m299._tag === "some") {
      const existing = __ring_m299._0;
      return existing;
