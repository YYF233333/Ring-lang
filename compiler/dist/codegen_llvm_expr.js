...
function gen_runtime_call(ctx, name, args) {
  __ring_match79: {
    const __ring_m79 = _Map_get(ctx.rt_fns, name);
...
function gen_direct_call(ctx, name, arg_vals, dict_vals) {
  ...
  __ring_match81: {
    const __ring_m81 = rt_name;
    if (__ring_m81._tag === "some") {
      const rtn = __ring_m81._0;
  ...
  __ring_match82: {
    ...
    if (__ring_m82._tag === "some") {
      ...
      let __ring_blk12;
      __ring_match84: {
        const __ring_m84 = _Map_get(ctx.fn_types, fn_info.fn_mangled);
        if (__ring_m84._tag === "some") {
          const t = __ring_m84._0;
          __ring_blk12 = t;
          break __ring_match84;
        }
        if (__ring_m84._tag === "none") {
          __ring_blk12 = panic(`LLVM codegen: fn type not found for ${fn_info.fn_mangled}`);
          break __ring_match84;
        }
        __match_fail(__ring_m84);
      }
      const fn_ty = __ring_blk12;
    ...
    if (__ring_m82._tag === "none") {
      __ring_match85: {
        const __ring_m85 = _Map_get(ctx.named_values, name);
        if (__ring_m85._tag === "some") {
          const alloca = __ring_m85._0;
        ...
        if (__ring_m85._tag === "none") {
          ...
          __ring_match86: {
            const __ring_m86 = _Map_get(ctx.rt_fns, rt_fallback);
...
function ensure_runtime_method(ctx, name, arg_count) {
  __ring_match87: {
    const __ring_m87 = _Map_get(ctx.rt_fns, name);
    if (__ring_m87._tag === "some") {
      const f = __ring_m87._0;
      return f;
...
function is_builtin_collection(ty) {
  __ring_match88: {
    const __ring_m88 = ty;
    if (__ring_m88._tag === "StructType") {
      const name = __ring_m88.name; const type_params = __ring_m88.type_params; const fields = __ring_m88.fields;
      if ((name === "List")) {
...
function is_int_keyed_map(ty) {
  __ring_match89: {
    const __ring_m89 = ty;
    if (__ring_m89._tag === "StructType") {
      const name = __ring_m89.name; const type_params = __ring_m89.type_params; const fields = __ring_m89.fields;
      if ((((name === "Map") ? (List_len(type_params) === 2) : false) ? (List_len(fields) === 0) : false)) {
        __ring_match90: {
          const __ring_m90 = __ring_index(type_params, 0);
          if (__ring_m90._tag === "IntType") {
            return true;
...
function is_int_set(ty) {
  __ring_match91: {
    const __ring_m91 = ty;
    if (__ring_m91._tag === "StructType") {
      const name = __ring_m91.name; const type_params = __ring_m91.type_params; const fields = __ring_m91.fields;
      if ((((name === "Set") ? (List_len(type_params) === 1) : false) ? (List_len(fields) === 0) : false)) {
        __ring_match92: {
          const __ring_m92 = __ring_index(type_params, 0);
          if (__ring_m92._tag === "IntType") {
            return true;
...
function gen_method_call(ctx, recv, recv_type, method, args, dict_vals) {
  let __ring_blk13;
  __ring_match93: {
    const __ring_m93 = types$type_to_builtin_name(recv_type);
    if (__ring_m93._tag === "some") {
      const n = __ring_m93._0;
      __ring_blk13 = n;
    ...
    if (__ring_m93._tag === "none") {
      let __ring_blk14;
      __ring_match94: {
        const __ring_m94 = recv_type;
        if (__ring_m94._tag === "StructType") {
          const name = __ring_m94.name;
          __ring_blk14 = name;
  ...
  __ring_match95: {
    const __ring_m95 = rt_method;
    if (__ring_m95._tag === "some") {
      const base_rt_name = __ring_m95._0;
      let __ring_blk15;
      __ring_match96: {
        const __ring_m96 = method;
        if (__ring_m96 === "get") {
          __ring_blk15 = "ring_map_int_get_opt";
          break __ring_match96;
        }
        if (__ring_m96 === "insert") {
          __ring_blk15 = "ring_map_int_set";
          break __ring_match96;
        }
        if (__ring_m96 === "contains_key") {
          __ring_blk15 = "ring_map_int_has";
          break __ring_match96;
        }
        if (__ring_m96 === "keys") {
          __ring_blk15 = "ring_map_int_keys";
          break __ring_match96;
        }
        if (__ring_m96 === "values") {
          __ring_blk15 = "ring_map_int_values";
          break __ring_match96;
        }
        if (__ring_m96 === "entries") {
          __ring_blk15 = "ring_map_int_entries";
          break __ring_match96;
        }
        if (__ring_m96 === "len") {
          __ring_blk15 = "ring_map_int_len";
          break __ring_match96;
        }
        if (__ring_m96 === "remove") {
          __ring_blk15 = "ring_map_int_delete";
          break __ring_match96;
        }
        if (__ring_m96 === "for_each") {
          __ring_blk15 = "ring_map_int_for_each";
          break __ring_match96;
        }
        if (__ring_m96 === "clear") {
          __ring_blk15 = "ring_map_int_clear";
          break __ring_match96;
        }
        if (__ring_m96 === "clone") {
          __ring_blk15 = "ring_map_int_clone";
          break __ring_match96;
        }
        if (__ring_m96 === "is_empty") {
          __ring_blk15 = "ring_map_int_is_empty";
          break __ring_match96;
        }
        __ring_blk15 = base_rt_name;
        break __ring_match96;
      }
      let __ring_blk16;
      __ring_match97: {
        const __ring_m97 = method;
        if (__ring_m97 === "add") {
          __ring_blk16 = "ring_set_int_add";
          break __ring_match97;
        }
        if (__ring_m97 === "insert") {
          __ring_blk16 = "ring_set_int_add";
          break __ring_match97;
        }
        if (__ring_m97 === "has") {
          __ring_blk16 = "ring_set_int_has";
          break __ring_match97;
        }
        if (__ring_m97 === "contains") {
          __ring_blk16 = "ring_set_int_has";
          break __ring_match97;
        }
        if (__ring_m97 === "to_list") {
          __ring_blk16 = "ring_set_int_to_list";
          break __ring_match97;
        }
        if (__ring_m97 === "len") {
          __ring_blk16 = "ring_set_int_len";
          break __ring_match97;
        }
        if (__ring_m97 === "from_list") {
          __ring_blk16 = "ring_set_int_from_list";
          break __ring_match97;
        }
        if (__ring_m97 === "for_each") {
          __ring_blk16 = "ring_set_int_for_each";
          break __ring_match97;
        }
        if (__ring_m97 === "remove") {
          __ring_blk16 = "ring_set_int_delete";
          break __ring_match97;
        }
        if (__ring_m97 === "clear") {
          __ring_blk16 = "ring_set_int_clear";
          break __ring_match97;
        }
        if (__ring_m97 === "clone") {
          __ring_blk16 = "ring_set_int_clone";
          break __ring_match97;
        }
        if (__ring_m97 === "is_empty") {
          __ring_blk16 = "ring_set_int_is_empty";
          break __ring_match97;
        }
        if (__ring_m97 === "union") {
          __ring_blk16 = "ring_set_int_union";
          break __ring_match97;
        }
        if (__ring_m97 === "intersect") {
          __ring_blk16 = "ring_set_int_intersect";
          break __ring_match97;
        }
        if (__ring_m97 === "difference") {
          __ring_blk16 = "ring_set_int_difference";
          break __ring_match97;
        }
        __ring_blk16 = base_rt_name;
        break __ring_match97;
      }
      const rt_name = (is_int_keyed_map(recv_type) ? __ring_blk15 : (is_int_set(recv_type) ? __ring_blk16 : base_rt_name));
      let call_args = [];
    ...
    if (__ring_m95._tag === "none") {
      ...
      __ring_match98: {
        ...
        if (__ring_m98._tag === "some") {
          ...
          let __ring_blk17;
          __ring_match100: {
            const __ring_m100 = _Map_get(ctx.fn_types, mangled);
            ...
            if (__ring_m100._tag === "none") {
              __ring_blk17 = panic(`LLVM codegen: fn type not found for method ${mangled}`);
              break __ring_match100;
            }
            __match_fail(__ring_m100);
          }
          const fn_ty = __ring_blk17;
          return LLVMBuildCall2(ctx.builder, fn_ty, fn_val, call_args, codegen_llvm_ctx$fresh_name(ctx, "mc"));
...
function is_boxed_def(ctx, def_id) {
  __ring_match101: {
    const __ring_m101 = def_id;
    if (__ring_m101._tag === "some") {
      const did = __ring_m101._0;
...
function is_unit_type(ty) {
  __ring_match102: {
    const __ring_m102 = ty;
    if (__ring_m102._tag === "UnitType") {
      return true;
...
function lookup_call_mut_flags(ctx, callee) {
  __ring_match103: {
    const __ring_m103 = callee;
    if (__ring_m103._tag === "Ident") {
      const name = __ring_m103.name; const resolved_name = __ring_m103.resolved_name;
      let __ring_blk18;
      __ring_match104: {
        const __ring_m104 = resolved_name;
        if (__ring_m104._tag === "some") {
          const rn = __ring_m104._0;
          __ring_blk18 = rn;
      ...
      const call_name = __ring_blk18;
      return _Map_get(ctx.fn_mut_params, call_name);
      break __ring_match103;
    }
    if (__ring_m103._tag === "FieldAccess") {
      const receiver = __ring_m103.receiver; const field = __ring_m103.field;
      const recv_type = hir$hexpr_type(receiver);
      let __ring_blk19;
      __ring_match105: {
        const __ring_m105 = types$type_to_builtin_name(recv_type);
        if (__ring_m105._tag === "some") {
          const n = __ring_m105._0;
          __ring_blk19 = n;
        ...
        if (__ring_m105._tag === "none") {
          let __ring_blk20;
          __ring_match106: {
            const __ring_m106 = recv_type;
            if (__ring_m106._tag === "StructType") {
              const name = __ring_m106.name;
              __ring_blk20 = name;
              break __ring_match106;
            }
            if (__ring_m106._tag === "EnumType") {
              const name = __ring_m106.name;
              __ring_blk20 = name;
              break __ring_match106;
            }
          ...
          __ring_blk19 = __ring_blk20;
          break __ring_match105;
        }
        __match_fail(__ring_m105);
      }
      const type_name = __ring_blk19;
      if ((type_name === "")) {
        return Option_none;
      } else {
        const ufcs_name = `${type_name}_${field}`;
        __ring_match107: {
          const __ring_m107 = _Map_get(ctx.fn_mut_params, ufcs_name);
          if (__ring_m107._tag === "some") {
            const flags = __ring_m107._0;
            let shifted = [];
            let i = 1;
            while ((i < List_len(flags))) {
              __ring_match108: {
                const __ring_m108 = List_get(flags, i);
                if (__ring_m108._tag === "some") {
                  const f = __ring_m108._0;
                  List_push(shifted, f);
...
function resolve_dict_refs(ctx, dicts) {
  let result = [];
  const __ring_iter_49 = __List_Iterable.iter(dicts);
  while (true) {
...
function get_or_declare_frameaddress(ctx) {
  ...
  __ring_match109: {
    ...
    if (__ring_m109._tag === "some") {
      ...
      __ring_match110: {
        const __ring_m110 = _Map_get(ctx.rt_fn_types, name);
        if (__ring_m110._tag === "some") {
          const t = __ring_m110._0;
          return [f, t];
...
function get_or_declare_setjmp(ctx) {
  const name = "_setjmp";
  __ring_match111: {
    const __ring_m111 = _Map_get(ctx.rt_fns, name);
    if (__ring_m111._tag === "some") {
      const f = __ring_m111._0;
      __ring_match112: {
        const __ring_m112 = _Map_get(ctx.rt_fn_types, name);
...
function call_zero_arg_or_return(ctx, fn_val, mangled) {
  __ring_match113: {
    const __ring_m113 = _Map_get(ctx.fn_types, mangled);
    if (__ring_m113._tag === "some") {
      const fn_ty = __ring_m113._0;
...
function gen_dict_closure_wrapper(ctx, lookup_name, name, dict_names, ty) {
  ...
  let __ring_blk21;
  __ring_match114: {
    const __ring_m114 = found;
    if (__ring_m114._tag === "some") {
      const fi = __ring_m114._0;
      __ring_blk21 = fi;
      break __ring_match114;
    }
    if (__ring_m114._tag === "none") {
      __ring_blk21 = panic(`LLVM codegen: dict-closure wrapper: function '${name}' not found`);
      break __ring_match114;
    }
    __match_fail(__ring_m114);
  }
  const fn_info = __ring_blk21;
  const real_fn = fn_info.fn_val;
  let __ring_blk22;
  __ring_match115: {
    const __ring_m115 = _Map_get(ctx.fn_types, fn_info.fn_mangled);
    if (__ring_m115._tag === "some") {
      const t = __ring_m115._0;
      __ring_blk22 = t;
      break __ring_match115;
    }
    if (__ring_m115._tag === "none") {
      __ring_blk22 = panic(`LLVM codegen: dict-closure wrapper: fn type not found for ${fn_info.fn_mangled}`);
      break __ring_match115;
    }
    __match_fail(__ring_m115);
  }
  const real_fn_ty = __ring_blk22;
  let __ring_blk23;
  __ring_match116: {
    const __ring_m116 = ty;
    if (__ring_m116._tag === "FnType") {
      const params = __ring_m116.params;
      __ring_blk23 = List_len(params);
      break __ring_match116;
    }
    __ring_blk23 = 0;
    break __ring_match116;
  }
  const param_count = __ring_blk23;
  let dict_vals = [];
  const __ring_iter_50 = __List_Iterable.iter(dict_names);
  while (true) {
    const __ring_next_50 = __ListIterator_Iterator.next(__ring_iter_50);
    if (__ring_next_50._tag === "none") break;
    const dn = __ring_next_50._0;
    List_push(dict_vals, resolve_dict_ref(ctx, hir$DictRef_Simple(dn)));
  }
  let ev_vals = [];
  __ring_match117: {
    const __ring_m117 = _Map_get(ctx.fn_evidence_params, fn_info.fn_mangled);
    if (__ring_m117._tag === "some") {
      const ev_params = __ring_m117._0;
  ...
  let env_elem_types = [ctx.i64_type];
  const __ring_end52 = captured_count;
  ...
  let thunk_param_types = [ctx.ptr_type];
  const __ring_end53 = param_count;
  ...
  const __ring_end55 = captured_count;
...
function gen_ident(ctx, name, resolved_name, def_id, dict_closure_dicts, ty) {
  __ring_match118: {
    const __ring_m118 = dict_closure_dicts;
    if (__ring_m118._tag === "some") {
      const dicts = __ring_m118._0;
      if ((List_len(dicts) > 0)) {
        let __ring_blk24;
        __ring_match119: {
          const __ring_m119 = resolved_name;
          if (__ring_m119._tag === "some") {
            const rn = __ring_m119._0;
            __ring_blk24 = rn;
  ...
  const lookup_name = __ring_blk25;
  const boxed = is_boxed_def(ctx, def_id);
  __ring_match121: {
    const __ring_m121 = _Map_get(ctx.named_values, lookup_name);
    if (__ring_m121._tag === "some") {
      const alloca = __ring_m121._0;
    ...
    if (__ring_m121._tag === "none") {
      __ring_match122: {
        const __ring_m122 = _Map_get(ctx.named_values, name);
        if (__ring_m122._tag === "some") {
          const alloca = __ring_m122._0;
        ...
        if (__ring_m122._tag === "none") {
          ...
          __ring_match123: {
            const __ring_m123 = _Map_get(ctx.functions, mangled_resolved);
            if (__ring_m123._tag === "some") {
              const fn_val = __ring_m123._0;
            ...
            if (__ring_m123._tag === "none") {
              ...
              __ring_match124: {
                const __ring_m124 = _Map_get(ctx.functions, mangled_bare);
                if (__ring_m124._tag === "some") {
                  const fn_val = __ring_m124._0;
                ...
                if (__ring_m124._tag === "none") {
                  ...
                  __ring_match125: {
                    const __ring_m125 = _Map_get(ctx.functions, mangled_name_resolved);
                    ...
                    if (__ring_m125._tag === "none") {
                      ...
                      __ring_match126: {
                        const __ring_m126 = _Map_get(ctx.functions, mangled_lu);
                        if (__ring_m126._tag === "some") {
                          const fn_val = __ring_m126._0;
                        ...
                        if (__ring_m126._tag === "none") {
                          ...
                          __ring_match127: {
                            const __ring_m127 = found;
                            if (__ring_m127._tag === "some") {
                              const fi = __ring_m127._0;
                            ...
                            if (__ring_m127._tag === "none") {
                              ...
                              __ring_match128: {
                                const __ring_m128 = found2;
                                if (__ring_m128._tag === "some") {
                                  const fi2 = __ring_m128._0;
...
function gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, match_bb, miss_bb, current_fn) {
  const ei = find_enum_by_variant(ctx, cname, qualifier);
  __ring_match129: {
    const __ring_m129 = ei;
    if (__ring_m129._tag === "some") {
      const enum_info = __ring_m129._0;
      __ring_match130: {
        const __ring_m130 = _Map_get(enum_info.variants, cname);
        if (__ring_m130._tag === "some") {
          const vi = __ring_m130._0;
...
function gen_literal_pattern_cond(ctx, scrut_val, scrut_ty, value) {
  __ring_match131: {
    ...
    if (__ring_m131._tag === "IntVal") {
      const n = __ring_m131._0;
    ...
    if (__ring_m131._tag === "BoolVal") {
      const b = __ring_m131._0;
      const raw = unbox_int(ctx, scrut_val);
      const lit = (b ? LLVMConstInt(ctx.i64_type, 1, 0) : LLVMConstInt(ctx.i64_type, 0, 0));
      return LLVMBuildICmp(ctx.builder, 32, raw, lit, codegen_llvm_ctx$fresh_name(ctx, "eq"));
      break __ring_match131;
    }
    if (__ring_m131._tag === "StrVal") {
      const s = __ring_m131._0;
...
function tuple_element_type(ty, idx) {
  __ring_match132: {
    ...
    if (__ring_m132._tag === "TupleType") {
      const elements = __ring_m132.elements;
      __ring_match133: {
        const __ring_m133 = List_get(elements, idx);
...
function gen_unaryop(ctx, op, operand, ty) {
  ...
  __ring_match134: {
    const __ring_m134 = op;
    if (__ring_m134._tag === "Neg") {
      if (is_int_type(ty)) {
        const raw = unbox_int(ctx, val);
...
function gen_catch_arms(ctx, error_val, arms) {
  ...
  const __ring_iter_58 = __List_Iterable.iter(arms);
  while (true) {
    const __ring_next_58 = __ListIterator_Iterator.next(__ring_iter_58);
    if (__ring_next_58._tag === "none") break;
    const arm = __ring_next_58._0;
    __ring_match135: {
      const __ring_m135 = arm.pattern;
      if (__ring_m135._tag === "Binding") {
      ...
      if (__ring_m135._tag === "Wildcard") {
        return gen_llvm_expr(ctx, arm.body);
        break __ring_match135;
      }
      if (__ring_m135._tag === "Constructor") {
        const name = __ring_m135.name; const fields = __ring_m135.fields;
...
function gen_try_catch(ctx, body, arms) {
  let __ring_blk26;
  __ring_match136: {
    const __ring_m136 = ctx.current_fn;
    if (__ring_m136._tag === "some") {
      const f = __ring_m136._0;
      __ring_blk26 = f;
      break __ring_match136;
    }
    if (__ring_m136._tag === "none") {
      __ring_blk26 = panic("LLVM codegen: try-catch outside function");
      break __ring_match136;
    }
    __match_fail(__ring_m136);
  }
  const current_fn = __ring_blk26;
...
function gen_struct_lit(ctx, name, fields, spread) {
  __ring_match137: {
    const __ring_m137 = _Map_get(ctx.struct_types, name);
    if (__ring_m137._tag === "some") {
      const info = __ring_m137._0;
...
function gen_string_interp(ctx, parts) {
  ...
  const __ring_iter_63 = __List_Iterable.iter(parts);
  while (true) {
    const __ring_next_63 = __ListIterator_Iterator.next(__ring_iter_63);
    if (__ring_next_63._tag === "none") break;
    const part = __ring_next_63._0;
    __ring_match139: {
      const __ring_m139 = part;
      if (__ring_m139._tag === "Literal") {
        const s = __ring_m139._0;
      ...
      if (__ring_m139._tag === "Expression") {
        const e = __ring_m139._0;
...
function gen_named_variant_construct(ctx, enum_name, variant_name, fields) {
  __ring_match140: {
    const __ring_m140 = _Map_get(ctx.enum_types, enum_name);
    if (__ring_m140._tag === "some") {
      const enum_info = __ring_m140._0;
      __ring_match141: {
        const __ring_m141 = _Map_get(enum_info.variants, variant_name);
        if (__ring_m141._tag === "some") {
          const vi = __ring_m141._0;
          ...
          const __ring_end64 = List_len(fields);
          for (let i = 0; i < __ring_end64; i++) {
            __ring_match142: {
              const __ring_m142 = List_get(fields, i);
              if (__ring_m142._tag === "some") {
                const f = __ring_m142._0;
                const val = gen_llvm_expr(ctx, f.value);
                let field_idx = i;
                const __ring_end65 = List_len(vi.field_names);
                for (let fi = 0; fi < __ring_end65; fi++) {
    ...
    if (__ring_m140._tag === "none") {
      ...
      __ring_match143: {
        const __ring_m143 = _Map_get(ctx.functions, ctor_name);
        if (__ring_m143._tag === "some") {
          const fn_val = __ring_m143._0;
          let args = [];
          const __ring_iter_66 = __List_Iterable.iter(fields);
          while (true) {
            const __ring_next_66 = __ListIterator_Iterator.next(__ring_iter_66);
            if (__ring_next_66._tag === "none") break;
            const f = __ring_next_66._0;
            List_push(args, gen_llvm_expr(ctx, f.value));
          }
          let __ring_blk27;
          __ring_match144: {
            const __ring_m144 = _Map_get(ctx.fn_types, ctor_name);
            if (__ring_m144._tag === "some") {
              const t = __ring_m144._0;
              __ring_blk27 = t;
              break __ring_match144;
            }
            if (__ring_m144._tag === "none") {
              __ring_blk27 = panic(`LLVM codegen: fn type not found for ${ctor_name}`);
              break __ring_match144;
            }
            __match_fail(__ring_m144);
          }
          const fn_ty = __ring_blk27;
...
function emit_match_arm_body(ctx, arm, merge_bb, next_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match145: {
    const __ring_m145 = arm.guard;
    if (__ring_m145._tag === "some") {
      const g = __ring_m145._0;
...
function gen_match_if_else(ctx, scrut_val, scrut_ty, arms, merge_bb, default_bb, current_fn) {
  ...
  const __ring_end67 = total;
  for (let i = 0; i < __ring_end67; i++) {
    __ring_match146: {
      const __ring_m146 = List_get(arms, i);
      if (__ring_m146._tag === "some") {
        const arm = __ring_m146._0;
        const is_last = (i === (total - 1));
        let __ring_blk28;
        __ring_match147: {
          const __ring_m147 = arm.guard;
        ...
        const has_guard = __ring_blk28;
        __ring_match148: {
          const __ring_m148 = arm.pattern;
          ...
          if (__ring_m148._tag === "Literal") {
            const value = __ring_m148.value;
          ...
          if (__ring_m148._tag === "Constructor") {
            const cname = __ring_m148.name; const qualifier = __ring_m148.qualifier; const fields = __ring_m148.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
          ...
          if (__ring_m148._tag === "NamedConstructor") {
            const cname = __ring_m148.name; const qualifier = __ring_m148.qualifier; const nfields = __ring_m148.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.ctor.${cname}`);
            gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, arm_bb, next_bb, current_fn);
            LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          ...
          if (__ring_m148._tag === "OrPattern") {
            const patterns = __ring_m148.patterns;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.or");
            const palts = patterns;
            const nalts = List_len(palts);
            const __ring_end68 = nalts;
            for (let k = 0; k < __ring_end68; k++) {
              __ring_match149: {
                const __ring_m149 = List_get(palts, k);
                if (__ring_m149._tag === "some") {
                  const alt = __ring_m149._0;
                  let __ring_blk29;
                  __ring_match150: {
                    const __ring_m150 = alt;
                    if (__ring_m150._tag === "Constructor") {
                      const an = __ring_m150.name; const aq = __ring_m150.qualifier;
                      __ring_blk29 = Option_some([an, aq]);
                  ...
                  const alt_ref = __ring_blk29;
                  __ring_match151: {
                    const __ring_m151 = alt_ref;
                    if (__ring_m151._tag === "some") {
                      const ar = __ring_m151._0;
                      const __ring_dt3 = ar;
          ...
          if (__ring_m148._tag === "TuplePattern") {
            const elements = __ring_m148.elements;
            const get_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_get", [ctx.ptr_type, ctx.i64_type], ctx.ptr_type);
            const get_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_get");
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const __ring_end69 = List_len(elements);
            for (let j = 0; j < __ring_end69; j++) {
              __ring_match152: {
                const __ring_m152 = List_get(elements, j);
                if (__ring_m152._tag === "some") {
                  const elem_pat = __ring_m152._0;
                  let __ring_blk30;
                  __ring_match153: {
                    const __ring_m153 = elem_pat;
                    if (__ring_m153._tag === "Constructor") {
                      const cname = __ring_m153.name; const qualifier = __ring_m153.qualifier;
                      __ring_blk30 = Option_some([cname, qualifier]);
                      break __ring_match153;
                    }
                    if (__ring_m153._tag === "NamedConstructor") {
                      const cname = __ring_m153.name; const qualifier = __ring_m153.qualifier;
                      __ring_blk30 = Option_some([cname, qualifier]);
                      break __ring_match153;
                    }
                    __ring_blk30 = Option_none;
                    break __ring_match153;
                  }
                  const ctor_ref = __ring_blk30;
                  __ring_match154: {
                    const __ring_m154 = ctor_ref;
                    if (__ring_m154._tag === "some") {
                      const cref = __ring_m154._0;
                      ...
                      const ei = find_enum_by_variant(ctx, cname, qualifier);
                      __ring_match155: {
                        const __ring_m155 = ei;
                        if (__ring_m155._tag === "some") {
                          const enum_info = __ring_m155._0;
                          __ring_match156: {
                            const __ring_m156 = _Map_get(enum_info.variants, cname);
                            if (__ring_m156._tag === "some") {
                              const vi = __ring_m156._0;
            ...
            for (let j = 0; j < __ring_end70; j++) {
              __ring_match158: {
                const __ring_m158 = List_get(elements, j);
                if (__ring_m158._tag === "some") {
                  const elem_pat = __ring_m158._0;
                  __ring_match159: {
                    const __ring_m159 = elem_pat;
                    if (__ring_m159._tag === "Binding") {
                      const bname = __ring_m159.name;
                      const idx = LLVMConstInt(ctx.i64_type, j, 0);
...
function gen_match_arm_wildcard(ctx, arm, scrut_val, default_bb, merge_bb, phi_vals, phi_bbs) {
  ...
  __ring_match160: {
    ...
    if (__ring_m160._tag === "Binding") {
      const bname = __ring_m160.name;
      const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
      discard(LLVMBuildStore(ctx.builder, scrut_val, alloca));
      _Map_insert(ctx.named_values, bname, alloca);
...
function gen_match_arm_enum(ctx, arm, scrut_val, enum_name, enum_info, switch_val, merge_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match161: {
    const __ring_m161 = arm.pattern;
    if (__ring_m161._tag === "Constructor") {
      const name = __ring_m161.name; const fields = __ring_m161.fields;
      __ring_match162: {
        const __ring_m162 = _Map_get(enum_info.variants, name);
        if (__ring_m162._tag === "some") {
          const vi = __ring_m162._0;
          ...
          LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          const __ring_end71 = List_len(fields);
          for (let i = 0; i < __ring_end71; i++) {
            __ring_match163: {
              const __ring_m163 = List_get(fields, i);
              if (__ring_m163._tag === "some") {
                const field_pat = __ring_m163._0;
                __ring_match164: {
                  const __ring_m164 = field_pat;
    ...
    if (__ring_m161._tag === "NamedConstructor") {
      const name = __ring_m161.name; const named_fields = __ring_m161.fields;
      __ring_match165: {
        const __ring_m165 = _Map_get(enum_info.variants, name);
        if (__ring_m165._tag === "some") {
          const vi = __ring_m165._0;
          const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.arm.${name}`);
          LLVMAddCase(switch_val, LLVMConstInt(ctx.i64_type, vi.tag, 0), arm_bb);
          LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          const __ring_end72 = List_len(named_fields);
          for (let i = 0; i < __ring_end72; i++) {
            __ring_match166: {
              const __ring_m166 = List_get(named_fields, i);
              if (__ring_m166._tag === "some") {
                const nf = __ring_m166._0;
                let field_idx = i;
                const __ring_end73 = List_len(vi.field_names);
                for (let fi = 0; fi < __ring_end73; fi++) {
                  if ((__ring_index(vi.field_names, fi) === nf.name)) {
                    field_idx = fi;
                  }
                }
                __ring_match167: {
                  const __ring_m167 = nf.pattern;
    ...
    if (__ring_m161._tag === "Wildcard") {
      break __ring_match161;
    }
    if (__ring_m161._tag === "Binding") {
      const bname = __ring_m161.name;
      break __ring_match161;
    }
    if (__ring_m161._tag === "OrPattern") {
      const patterns = __ring_m161.patterns;
      const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.arm.or");
      const __ring_iter_74 = __List_Iterable.iter(patterns);
      while (true) {
        const __ring_next_74 = __ListIterator_Iterator.next(__ring_iter_74);
        if (__ring_next_74._tag === "none") break;
        const alt = __ring_next_74._0;
        let __ring_blk31;
        __ring_match168: {
          const __ring_m168 = alt;
          if (__ring_m168._tag === "Constructor") {
            const name = __ring_m168.name;
        ...
        __ring_match169: {
          const __ring_m169 = alt_name;
          if (__ring_m169._tag === "some") {
            const an = __ring_m169._0;
            __ring_match170: {
              const __ring_m170 = _Map_get(enum_info.variants, an);
              if (__ring_m170._tag === "some") {
                const vi = __ring_m170._0;
                LLVMAddCase(switch_val, LLVMConstInt(ctx.i64_type, vi.tag, 0), arm_bb);
...
function gen_match_expr(ctx, scrutinee, arms, result_ty) {
  let __ring_blk32;
  __ring_match171: {
    const __ring_m171 = ctx.current_fn;
    if (__ring_m171._tag === "some") {
      const f = __ring_m171._0;
      __ring_blk32 = f;
      break __ring_match171;
    }
    if (__ring_m171._tag === "none") {
      __ring_blk32 = panic("LLVM codegen: match expr outside function");
      break __ring_match171;
    }
    __match_fail(__ring_m171);
  }
  const current_fn = __ring_blk32;
  const scrut_val = gen_llvm_expr(ctx, scrutinee);
  const scrut_ty = hir$hexpr_type(scrutinee);
  ctx.match_counter = (ctx.match_counter + 1);
  let __ring_blk33;
  __ring_match172: {
    const __ring_m172 = scrut_ty;
    if (__ring_m172._tag === "EnumType") {
      const name = __ring_m172.name;
      __ring_blk33 = Option_some(name);
      break __ring_match172;
    }
    __ring_blk33 = Option_none;
    break __ring_match172;
  }
  const enum_name = __ring_blk33;
  ...
  __ring_match174: {
    const __ring_m174 = enum_name;
    if (__ring_m174._tag === "some") {
      const ename = __ring_m174._0;
      __ring_match175: {
        const __ring_m175 = _Map_get(ctx.enum_types, ename);
...
function gen_index_expr(ctx, receiver, index, ty) {
  ...
  let __ring_blk35;
  __ring_match177: {
    const __ring_m177 = types$type_to_builtin_name(recv_type);
    if (__ring_m177._tag === "some") {
      const n = __ring_m177._0;
      __ring_blk35 = n;
      break __ring_match177;
    }
    if (__ring_m177._tag === "none") {
      __ring_blk35 = "Unknown";
      break __ring_match177;
    }
...
function gen_if_expr(ctx, condition, then_branch, else_branch) {
  let __ring_blk36;
  __ring_match178: {
    const __ring_m178 = ctx.current_fn;
    ...
    if (__ring_m178._tag === "none") {
      __ring_blk36 = panic("LLVM codegen: if expr outside function");
      break __ring_match178;
    }
    __match_fail(__ring_m178);
  }
  const current_fn = __ring_blk36;
  ...
  let __ring_blk37;
  __ring_match179: {
    const __ring_m179 = else_branch;
    if (__ring_m179._tag === "some") {
      const eb = __ring_m179._0;
      __ring_blk37 = gen_llvm_expr(ctx, eb);
      break __ring_match179;
    }
    if (__ring_m179._tag === "none") {
      __ring_blk37 = LLVMConstPointerNull(ctx.ptr_type);
      break __ring_match179;
    }
    __match_fail(__ring_m179);
  }
  const else_val = __ring_blk37;
...
function gen_handle_expr(ctx, body, handlers) {
  ...
  const __ring_iter_78 = __List_Iterable.iter(handlers);
  while (true) {
    const __ring_next_78 = __ListIterator_Iterator.next(__ring_iter_78);
    if (__ring_next_78._tag === "none") break;
    const h = __ring_next_78._0;
    __ring_match180: {
      const __ring_m180 = _Map_get(by_effect, h.effect_name);
      if (__ring_m180._tag === "some") {
        const existing = __ring_m180._0;
  ...
  if (has_fail_abort) {
    let __ring_blk38;
    __ring_match181: {
      const __ring_m181 = ctx.current_fn;
      ...
      if (__ring_m181._tag === "none") {
        __ring_blk38 = panic("LLVM codegen: handle expr outside function");
        break __ring_match181;
      }
...
function gen_field_access(ctx, receiver, field, ty) {
  ...
  __ring_match182: {
    ...
    if (__ring_m182._tag === "TupleType") {
      let __ring_blk39;
      __ring_match183: {
        const __ring_m183 = parse_int(field);
        if (__ring_m183._tag === "some") {
          const n = __ring_m183._0;
          __ring_blk39 = n;
          break __ring_match183;
        }
        if (__ring_m183._tag === "none") {
          __ring_blk39 = panic(`LLVM codegen: non-numeric tuple field: ${field}`);
          break __ring_match183;
        }
        __match_fail(__ring_m183);
      }
      const field_idx = __ring_blk39;
      const get_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_get", [ctx.ptr_type, ctx.i64_type], ctx.ptr_type);
      const get_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_get");
  ...
  let __ring_blk40;
  __ring_match184: {
    const __ring_m184 = recv_type;
    if (__ring_m184._tag === "StructType") {
      const name = __ring_m184.name;
      __ring_blk40 = name;
      break __ring_match184;
    }
    if (__ring_m184._tag === "EnumType") {
      const name = __ring_m184.name;
      __ring_blk40 = name;
      break __ring_match184;
    }
    __ring_blk40 = panic(`LLVM codegen: field access on non-struct type: ${types$type_to_string(recv_type)}, field: ${field}`);
    break __ring_match184;
  }
  const type_name = __ring_blk40;
  __ring_match185: {
    const __ring_m185 = _Map_get(ctx.struct_types, type_name);
    if (__ring_m185._tag === "some") {
      const info = __ring_m185._0;
      let field_idx = (-1);
      const __ring_end81 = List_len(info.field_names);
...
function gen_effect_op(ctx, effect_name, op_name, args) {
  if (((effect_name === "fail") ? (op_name === "raise") : false)) {
    ...
    let __ring_blk41;
    __ring_match186: {
      const __ring_m186 = ctx.current_fn;
      ...
      if (__ring_m186._tag === "none") {
        __ring_blk41 = panic("LLVM codegen: effect op outside function");
        break __ring_match186;
      }
      __match_fail(__ring_m186);
    }
    const current_fn_val = __ring_blk41;
    ...
    let __ring_blk42;
    __ring_match187: {
      const __ring_m187 = _Map_get(ctx.effect_ops, effect_name);
      if (__ring_m187._tag === "some") {
        const ops = __ring_m187._0;
        __ring_blk42 = List_len(ops);
        break __ring_match187;
      }
      if (__ring_m187._tag === "none") {
        __ring_blk42 = (slot_idx + 1);
        break __ring_match187;
      }
      __match_fail(__ring_m187);
    }
    const n_slots = __ring_blk42;
    const idx = ((slot_idx >= 0) ? slot_idx : 0);
    let slot_types = [];
    const __ring_end84 = n_slots;
...
function gen_mut_arg_llvm(ctx, arg) {
  __ring_match188: {
    const __ring_m188 = arg;
    if (__ring_m188._tag === "Ident") {
      const name = __ring_m188.name; const resolved_name = __ring_m188.resolved_name; const def_id = __ring_m188.def_id;
      if (is_boxed_def(ctx, def_id)) {
        let __ring_blk43;
        __ring_match189: {
          const __ring_m189 = resolved_name;
          if (__ring_m189._tag === "some") {
            const rn = __ring_m189._0;
            __ring_blk43 = rn;
        ...
        const lookup_name = __ring_blk43;
        __ring_match190: {
          const __ring_m190 = _Map_get(ctx.named_values, lookup_name);
          if (__ring_m190._tag === "some") {
            const alloca = __ring_m190._0;
          ...
          if (__ring_m190._tag === "none") {
            __ring_match191: {
              const __ring_m191 = _Map_get(ctx.named_values, name);
              if (__ring_m191._tag === "some") {
                const alloca = __ring_m191._0;
                return LLVMBuildLoad2(ctx.builder, ctx.ptr_type, alloca, codegen_llvm_ctx$fresh_name(ctx, "mcell"));
...
function gen_dict_dispatch_call(ctx, callee, args, dd) {
  ...
  __ring_match192: {
    const __ring_m192 = callee;
    if (__ring_m192._tag === "FieldAccess") {
      const receiver = __ring_m192.receiver;
      recv_val = Option_some(gen_llvm_expr(ctx, receiver));
      break __ring_match192;
    }
    __ring_match193: {
      const __ring_m193 = List_get(args, 0);
      if (__ring_m193._tag === "some") {
        const a = __ring_m193._0;
  ...
  let call_args = [];
  __ring_match194: {
    const __ring_m194 = recv_val;
    if (__ring_m194._tag === "some") {
      const rv = __ring_m194._0;
  ...
  const __ring_end85 = List_len(args);
  for (let i = other_arg_start; i < __ring_end85; i++) {
    __ring_match195: {
      const __ring_m195 = List_get(args, i);
      if (__ring_m195._tag === "some") {
        const a = __ring_m195._0;
  ...
  let __ring_blk44;
  __ring_match196: {
    const __ring_m196 = _Map_get(ctx.named_values, dd.dict_param);
    if (__ring_m196._tag === "some") {
      const dict_alloca = __ring_m196._0;
      __ring_blk44 = LLVMBuildLoad2(ctx.builder, ctx.ptr_type, dict_alloca, codegen_llvm_ctx$fresh_name(ctx, "dp"));
      break __ring_match196;
    }
    if (__ring_m196._tag === "none") {
      __ring_blk44 = resolve_static_dict_by_name(ctx, dd.dict_param);
      break __ring_match196;
    }
    __match_fail(__ring_m196);
  }
  const dict_ptr = __ring_blk44;
...
function gen_call(ctx, callee, args, resolved_dicts, dict_dispatch, result_ty, effects) {
  __ring_match197: {
    const __ring_m197 = dict_dispatch;
    if (__ring_m197._tag === "some") {
      const dd = __ring_m197._0;
  ...
  let arg_vals = [];
  let argi = 0;
  const __ring_iter_86 = __List_Iterable.iter(args);
  while (true) {
    ...
    let __ring_blk45;
    __ring_match198: {
      const __ring_m198 = mut_flags;
      if (__ring_m198._tag === "some") {
        const flags = __ring_m198._0;
        let __ring_blk46;
        __ring_match199: {
          const __ring_m199 = List_get(flags, argi);
  ...
  let __ring_blk47;
  __ring_match200: {
    const __ring_m200 = callee;
    if (__ring_m200._tag === "Ident") {
      const name = __ring_m200.name; const resolved_name = __ring_m200.resolved_name;
      let __ring_blk48;
      __ring_match201: {
        const __ring_m201 = resolved_name;
        if (__ring_m201._tag === "some") {
          const rn = __ring_m201._0;
          __ring_blk48 = rn;
      ...
      __ring_blk47 = gen_direct_call(ctx, final_name, arg_vals, dict_vals);
      break __ring_match200;
    }
    if (__ring_m200._tag === "FieldAccess") {
      const receiver = __ring_m200.receiver; const field = __ring_m200.field;
      const recv_val = gen_llvm_expr(ctx, receiver);
      const recv_type = hir$hexpr_type(receiver);
      __ring_blk47 = gen_method_call(ctx, recv_val, recv_type, field, arg_vals, dict_vals);
      break __ring_match200;
    }
    const closure_val = gen_llvm_expr(ctx, callee);
    __ring_blk47 = gen_closure_call(ctx, closure_val, arg_vals);
    break __ring_match200;
  }
  const raw = __ring_blk47;
  if (is_unit_type(result_ty)) {
    return LLVMConstPointerNull(ctx.ptr_type);
  }
  return raw;
...
function gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch, result_ty) {
  ...
  let __ring_blk50;
  __ring_match208: {
    const __ring_m208 = op;
    if (__ring_m208._tag === "Eq") {
      __ring_blk50 = true;
      break __ring_match208;
    }
    if (__ring_m208._tag === "Neq") {
      __ring_blk50 = true;
      break __ring_match208;
    }
    __ring_blk50 = false;
  ...
  const is_eq_op = __ring_blk50;
  let __ring_blk51;
  __ring_match209: {
    const __ring_m209 = op;
    if (__ring_m209._tag === "Lt") {
      __ring_blk51 = true;
      break __ring_match209;
    }
    if (__ring_m209._tag === "Lte") {
      __ring_blk51 = true;
      break __ring_match209;
    }
    if (__ring_m209._tag === "Gt") {
      __ring_blk51 = true;
      break __ring_match209;
    }
    if (__ring_m209._tag === "Gte") {
      __ring_blk51 = true;
      break __ring_match209;
    }
    __ring_blk51 = false;
  ...
  const is_ord_op = __ring_blk51;
  if (is_eq_op) {
    __ring_match210: {
      const __ring_m210 = eq_dispatch;
      if (__ring_m210._tag === "some") {
        const d = __ring_m210._0;
        __ring_match211: {
          const __ring_m211 = d;
          if (__ring_m211._tag === "Builtin") {
  ...
  if (is_ord_op) {
    __ring_match212: {
      const __ring_m212 = ord_dispatch;
      if (__ring_m212._tag === "some") {
        const d = __ring_m212._0;
        __ring_match213: {
          const __ring_m213 = d;
          if (__ring_m213._tag === "Builtin") {
...
function gen_llvm_expr(ctx, expr) {
  __ring_match214: {
    const __ring_m214 = expr;
    if (__ring_m214._tag === "IntLit") {
      const value = __ring_m214.value;
      return gen_int_lit(ctx, value);
      break __ring_match214;
    }
    if (__ring_m214._tag === "FloatLit") {
      const value = __ring_m214.value;
      return gen_float_lit(ctx, value);
      break __ring_match214;
    }
    if (__ring_m214._tag === "StrLit") {
      const value = __ring_m214.value;
      return gen_str_lit(ctx, value);
      break __ring_match214;
    }
    if (__ring_m214._tag === "BoolLit") {
      const value = __ring_m214.value;
      return gen_bool_lit(ctx, value);
      break __ring_match214;
    }
    if (__ring_m214._tag === "Ident") {
      const name = __ring_m214.name; const resolved_name = __ring_m214.resolved_name; const def_id = __ring_m214.def_id; const dict_closure_dicts = __ring_m214.dict_closure_dicts; const ty = __ring_m214.ty;
      return gen_ident(ctx, name, resolved_name, def_id, dict_closure_dicts, ty);
      break __ring_match214;
    }
    if (__ring_m214._tag === "BinOp") {
      const op = __ring_m214.op; const left = __ring_m214.left; const right = __ring_m214.right; const eq_dispatch = __ring_m214.eq_dispatch; const ord_dispatch = __ring_m214.ord_dispatch; const ty = __ring_m214.ty;
      return gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch, ty);
      break __ring_match214;
    }
    if (__ring_m214._tag === "UnaryOp") {
      const op = __ring_m214.op; const operand = __ring_m214.operand; const ty = __ring_m214.ty;
      return gen_unaryop(ctx, op, operand, ty);
      break __ring_match214;
    }
    if (__ring_m214._tag === "Call") {
      const callee = __ring_m214.callee; const args = __ring_m214.args; const resolved_dicts = __ring_m214.resolved_dicts; const dict_dispatch = __ring_m214.dict_dispatch; const ty = __ring_m214.ty; const effects = __ring_m214.effects;
      return gen_call(ctx, callee, args, resolved_dicts, dict_dispatch, ty, effects);
      break __ring_match214;
    }
    if (__ring_m214._tag === "DictConstruct") {
      const base_dict = __ring_m214.base_dict; const trait_name = __ring_m214.trait_name; const inner = __ring_m214.inner;
      return build_wrapped_dict(ctx, base_dict, trait_name, inner);
      break __ring_match214;
    }
    if (__ring_m214._tag === "FieldAccess") {
      const receiver = __ring_m214.receiver; const field = __ring_m214.field; const ty = __ring_m214.ty;
      return gen_field_access(ctx, receiver, field, ty);
      break __ring_match214;
    }
    if (__ring_m214._tag === "StructLit") {
      const name = __ring_m214.name; const fields = __ring_m214.fields; const spread = __ring_m214.spread;
      return gen_struct_lit(ctx, name, fields, spread);
      break __ring_match214;
    }
    if (__ring_m214._tag === "Block") {
      const stmts = __ring_m214.stmts; const tail = __ring_m214.tail;
      return gen_block(ctx, stmts, tail);
      break __ring_match214;
    }
    if (__ring_m214._tag === "IfExpr") {
      const condition = __ring_m214.condition; const then_branch = __ring_m214.then_branch; const else_branch = __ring_m214.else_branch;
      return gen_if_expr(ctx, condition, then_branch, else_branch);
      break __ring_match214;
    }
    if (__ring_m214._tag === "StringInterp") {
      const parts = __ring_m214.parts;
      return gen_string_interp(ctx, parts);
      break __ring_match214;
    }
    if (__ring_m214._tag === "Lambda") {
      const params = __ring_m214.params; const return_type = __ring_m214.return_type; const body = __ring_m214.body; const ty = __ring_m214.ty;
      return gen_lambda(ctx, params, return_type, body, ty);
      break __ring_match214;
    }
    if (__ring_m214._tag === "MatchExpr") {
      const scrutinee = __ring_m214.scrutinee; const arms = __ring_m214.arms; const ty = __ring_m214.ty;
      return gen_match_expr(ctx, scrutinee, arms, ty);
      break __ring_match214;
    }
    if (__ring_m214._tag === "NamedVariantConstruct") {
      const enum_name = __ring_m214.enum_name; const variant_name = __ring_m214.variant_name; const fields = __ring_m214.fields;
      return gen_named_variant_construct(ctx, enum_name, variant_name, fields);
      break __ring_match214;
    }
    if (__ring_m214._tag === "TryCatch") {
      const body = __ring_m214.body; const arms = __ring_m214.arms;
      return gen_try_catch(ctx, body, arms);
      break __ring_match214;
    }
    if (__ring_m214._tag === "HandleExpr") {
      const body = __ring_m214.body; const handlers = __ring_m214.handlers;
      return gen_handle_expr(ctx, body, handlers);
      break __ring_match214;
    }
    if (__ring_m214._tag === "EffectOp") {
      const effect_name = __ring_m214.effect_name; const op_name = __ring_m214.op_name; const args = __ring_m214.args;
      return gen_effect_op(ctx, effect_name, op_name, args);
      break __ring_match214;
    }
    if (__ring_m214._tag === "RangeExpr") {
      const start = __ring_m214.start; const end = __ring_m214.end; const inclusive = __ring_m214.inclusive;
      return gen_range_expr(ctx, start, end, inclusive);
      break __ring_match214;
    }
    if (__ring_m214._tag === "ListLit") {
      const elements = __ring_m214.elements;
      return gen_list_lit(ctx, elements);
      break __ring_match214;
    }
    if (__ring_m214._tag === "TupleLit") {
      const elements = __ring_m214.elements;
      return gen_tuple_lit(ctx, elements);
      break __ring_match214;
    }
    if (__ring_m214._tag === "IndexExpr") {
      const receiver = __ring_m214.receiver; const index = __ring_m214.index; const ty = __ring_m214.ty;
      return gen_index_expr(ctx, receiver, index, ty);
      break __ring_match214;
    }
    if (__ring_m214._tag === "Clone") {
      const inner = __ring_m214.inner;
      return gen_clone(ctx, inner);
      break __ring_match214;
    }
    if (__ring_m214._tag === "ReturnExpr") {
      const value = __ring_m214.value;
      __ring_match215: {
        const __ring_m215 = value;
        if (__ring_m215._tag === "some") {
          const v = __ring_m215._0;
      ...
      __ring_match216: {
        const __ring_m216 = ctx.current_fn;
        if (__ring_m216._tag === "some") {
          const f = __ring_m216._0;
...
function gen_lambda(ctx, params, return_type, body, ty) {
  let __ring_blk52;
  __ring_match217: {
    const __ring_m217 = ctx.current_fn;
    if (__ring_m217._tag === "some") {
      const f = __ring_m217._0;
      __ring_blk52 = f;
      break __ring_match217;
    }
    if (__ring_m217._tag === "none") {
      __ring_blk52 = panic("LLVM codegen: lambda outside function");
      break __ring_match217;
    }
  ...
  for (let i = 0; i < __ring_end90; i++) {
    __ring_match218: {
      const __ring_m218 = List_get(captures, i);
      if (__ring_m218._tag === "some") {
        const cap_name = __ring_m218._0;
  ...
  const __ring_end91 = List_len(params);
  for (let i = 0; i < __ring_end91; i++) {
    __ring_match219: {
      const __ring_m219 = List_get(params, i);
      if (__ring_m219._tag === "some") {
        const p = __ring_m219._0;
  ...
  const __ring_end92 = List_len(captures);
  for (let i = 0; i < __ring_end92; i++) {
    __ring_match220: {
      const __ring_m220 = List_get(captures, i);
      if (__ring_m220._tag === "some") {
        const cap_name = __ring_m220._0;
        let __ring_blk53;
        __ring_match221: {
          const __ring_m221 = _Map_get(ctx.named_values, cap_name);
          if (__ring_m221._tag === "some") {
            const alloca = __ring_m221._0;
            __ring_blk53 = LLVMBuildLoad2(ctx.builder, ctx.ptr_type, alloca, codegen_llvm_ctx$fresh_name(ctx, "cv"));
...
function build_handler_evidence(ctx, effect_name, hs) {
  let __ring_blk54;
  __ring_match222: {
    const __ring_m222 = _Map_get(ctx.effect_ops, effect_name);
    if (__ring_m222._tag === "some") {
      const ops = __ring_m222._0;
...
function emit_memoised_dict_getter(ctx, name, build_fn, build_fn_ty) {
  const fname = `ring_dict_init_${name}`;
  __ring_match223: {
    const __ring_m223 = _Map_get(ctx.functions, fname);
    if (__ring_m223._tag === "some") {
      const existing = __ring_m223._0;
      return existing;
