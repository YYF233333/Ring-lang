...
function collect_extern_capture_names_stmt(stmt, captures, externs, out) {
  __ring_match46: {
    const __ring_m46 = stmt;
    if (__ring_m46._tag === "Let") {
      const init = __ring_m46.init;
      return collect_extern_capture_names(init, captures, externs, out);
      break __ring_match46;
    }
    if (__ring_m46._tag === "Var") {
      const init = __ring_m46.init;
      return collect_extern_capture_names(init, captures, externs, out);
      break __ring_match46;
    }
    if (__ring_m46._tag === "Assign") {
      const target = __ring_m46.target; const value = __ring_m46.value;
      collect_extern_capture_names(target, captures, externs, out);
      return collect_extern_capture_names(value, captures, externs, out);
      break __ring_match46;
    }
    if (__ring_m46._tag === "ExprStmt") {
      const expr = __ring_m46.expr;
      return collect_extern_capture_names(expr, captures, externs, out);
      break __ring_match46;
    }
    if (__ring_m46._tag === "Return") {
      const value = __ring_m46.value;
      __ring_match47: {
        const __ring_m47 = value;
        if (__ring_m47._tag === "some") {
          const v = __ring_m47._0;
    ...
    if (__ring_m46._tag === "While") {
      const condition = __ring_m46.condition; const body = __ring_m46.body;
      collect_extern_capture_names(condition, captures, externs, out);
      return collect_extern_capture_names(body, captures, externs, out);
      break __ring_match46;
    }
    if (__ring_m46._tag === "ForIn") {
      const iterable = __ring_m46.iterable; const body = __ring_m46.body;
      collect_extern_capture_names(iterable, captures, externs, out);
      return collect_extern_capture_names(body, captures, externs, out);
      break __ring_match46;
    }
    if (__ring_m46._tag === "LetDestructure") {
      const init = __ring_m46.init;
      return collect_extern_capture_names(init, captures, externs, out);
      break __ring_match46;
    }
    if (__ring_m46._tag === "IfLet") {
      const expr = __ring_m46.expr; const then_block = __ring_m46.then_block; const else_block = __ring_m46.else_block;
      collect_extern_capture_names(expr, captures, externs, out);
      collect_extern_capture_names(then_block, captures, externs, out);
      __ring_match48: {
        const __ring_m48 = else_block;
...
function collect_extern_capture_names(expr, captures, externs, out) {
  __ring_match49: {
    ...
    if (__ring_m49._tag === "Ident") {
      const name = __ring_m49.name; const resolved_name = __ring_m49.resolved_name; const ty = __ring_m49.ty;
      let __ring_blk7;
      __ring_match50: {
        const __ring_m50 = resolved_name;
    ...
    if (__ring_m49._tag === "BinOp") {
      const left = __ring_m49.left; const right = __ring_m49.right;
    ...
    if (__ring_m49._tag === "IfExpr") {
      const condition = __ring_m49.condition; const then_branch = __ring_m49.then_branch; const else_branch = __ring_m49.else_branch;
      collect_extern_capture_names(condition, captures, externs, out);
      collect_extern_capture_names(then_branch, captures, externs, out);
      __ring_match52: {
        const __ring_m52 = else_branch;
        if (__ring_m52._tag === "some") {
          const eb = __ring_m52._0;
          return collect_extern_capture_names(eb, captures, externs, out);
    ...
    if (__ring_m49._tag === "MatchExpr") {
      const scrutinee = __ring_m49.scrutinee; const arms = __ring_m49.arms;
    ...
    if (__ring_m49._tag === "StringInterp") {
      const parts = __ring_m49.parts;
      const __ring_iter_32 = __List_Iterable.iter(parts);
      while (true) {
        const __ring_next_32 = __ListIterator_Iterator.next(__ring_iter_32);
        if (__ring_next_32._tag === "none") break;
        const part = __ring_next_32._0;
        __ring_match53: {
          const __ring_m53 = part;
          if (__ring_m53._tag === "Expression") {
    ...
    if (__ring_m49._tag === "StructLit") {
      const fields = __ring_m49.fields; const spread = __ring_m49.spread;
    ...
    if (__ring_m49._tag === "ListLit") {
      const elements = __ring_m49.elements;
    ...
    if (__ring_m49._tag === "IndexExpr") {
      const receiver = __ring_m49.receiver; const index = __ring_m49.index;
    ...
    if (__ring_m49._tag === "Lambda") {
      const lb = __ring_m49.body;
      return collect_extern_capture_names(lb, captures, externs, out);
      break __ring_match49;
    }
    if (__ring_m49._tag === "NamedVariantConstruct") {
      const nvc_fields = __ring_m49.fields; const nvc_spread = __ring_m49.spread;
      const __ring_iter_36 = __List_Iterable.iter(nvc_fields);
      while (true) {
      ...
      __ring_match55: {
        const __ring_m55 = nvc_spread;
        if (__ring_m55._tag === "some") {
          const sp = __ring_m55._0;
          return collect_extern_capture_names(sp, captures, externs, out);
    ...
    if (__ring_m49._tag === "TryCatch") {
      const tc_body = __ring_m49.body; const tc_arms = __ring_m49.arms;
      collect_extern_capture_names(tc_body, captures, externs, out);
      const __ring_iter_37 = __List_Iterable.iter(tc_arms);
      while (true) {
    ...
    if (__ring_m49._tag === "HandleExpr") {
      const he_body = __ring_m49.body;
      return collect_extern_capture_names(he_body, captures, externs, out);
      break __ring_match49;
    }
    if (__ring_m49._tag === "EffectOp") {
      const eo_args = __ring_m49.args;
      const __ring_iter_38 = __List_Iterable.iter(eo_args);
      while (true) {
...
function emit_wrapped_method_thunk(ctx, mangled, method_fn, method_name, dispatch_arity, inner_count) {
  ...
  __ring_match57: {
    const __ring_m57 = _Map_get(ctx.functions, thunk_name);
    if (__ring_m57._tag === "some") {
      const existing = __ring_m57._0;
      return existing;
  ...
  const __ring_end39 = dispatch_arity;
  for (let i = 0; i < __ring_end39; i++) {
  ...
  const __ring_end40 = inner_count;
  for (let j = 0; j < __ring_end40; j++) {
    List_push(env_elem_types, ctx.ptr_type);
  }
  const env_ty = LLVMStructTypeInContext(ctx.context, env_elem_types, 0);
  let __ring_blk8;
  __ring_match58: {
    const __ring_m58 = _Map_get(ctx.fn_types, mangled);
    ...
    if (__ring_m58._tag === "none") {
      let mp = [];
      const __ring_end41 = (dispatch_arity + inner_count);
...
function get_or_create_dict_global(ctx, name) {
  __ring_match59: {
    const __ring_m59 = _Map_get(ctx.dict_singletons, name);
    if (__ring_m59._tag === "some") {
      const g = __ring_m59._0;
      return g;
...
function get_or_create_static_dict_getter(ctx, name) {
  ...
  __ring_match60: {
    const __ring_m60 = _Map_get(ctx.functions, fname);
    if (__ring_m60._tag === "some") {
      const existing = __ring_m60._0;
      return existing;
  ...
  let __ring_blk9;
  __ring_match61: {
    const __ring_m61 = _Map_get(ctx.static_dict_defs, name);
...
function resolve_static_dict_by_name(ctx, name) {
  ...
  __ring_match63: {
    const __ring_m63 = _Map_get(ctx.functions, init_fn_name);
    if (__ring_m63._tag === "some") {
      const init_fn = __ring_m63._0;
      let __ring_blk11;
      __ring_match64: {
        const __ring_m64 = _Map_get(ctx.fn_types, init_fn_name);
    ...
    if (__ring_m63._tag === "none") {
      __ring_match65: {
        const __ring_m65 = _Map_get(ctx.dict_globals, name);
        if (__ring_m65._tag === "some") {
          const init_fn = __ring_m65._0;
...
function resolve_dict_ref(ctx, dr) {
  __ring_match66: {
    const __ring_m66 = dr;
    if (__ring_m66._tag === "Simple") {
      const name = __ring_m66._0;
      __ring_match67: {
        const __ring_m67 = _Map_get(ctx.named_values, name);
        if (__ring_m67._tag === "some") {
          const alloca = __ring_m67._0;
    ...
    if (__ring_m66._tag === "Static") {
      const name = __ring_m66._0;
      return resolve_static_dict_by_name(ctx, name);
      break __ring_match66;
    }
    if (__ring_m66._tag === "Wrapped") {
      const dict = __ring_m66.dict; const trait_name = __ring_m66.trait_name; const inner_dicts = __ring_m66.inner_dicts;
...
function build_wrapped_dict_typed(ctx, dict_name, trait_name, inner_dicts, dict_tid) {
  ...
  const __ring_end46 = method_count;
  ...
  const __ring_end47 = method_count;
  for (let i = 0; i < __ring_end47; i++) {
    __ring_match69: {
      const __ring_m69 = List_get(method_order, i);
      if (__ring_m69._tag === "some") {
        const method_name = __ring_m69._0;
        const mangled = codegen_llvm_ctx$llvm_mangle_method(target_type, method_name);
        __ring_match70: {
          const __ring_m70 = _Map_get(ctx.functions, mangled);
          if (__ring_m70._tag === "some") {
            const method_fn = __ring_m70._0;
...
function resolve_dispatch_dict(ctx, dispatch, trait_name_hint) {
  __ring_match72: {
    const __ring_m72 = dispatch;
    if (__ring_m72._tag === "Dict") {
      const param = __ring_m72.param;
      __ring_match73: {
        const __ring_m73 = _Map_get(ctx.named_values, param);
    ...
    if (__ring_m72._tag === "Direct") {
      const dict = __ring_m72.dict; const extra_dicts = __ring_m72.extra_dicts;
      if ((List_len(extra_dicts) === 0)) {
        return resolve_dict_ref(ctx, hir$DictRef_Simple(dict));
      } else {
        __ring_match74: {
          const __ring_m74 = trait_name_hint;
          if (__ring_m74._tag === "some") {
            const tn = __ring_m74._0;
...
function trait_name_from_dict_param(dict_param) {
  ...
  __ring_match82: {
    const __ring_m82 = Str_index_of(rest, "_");
    if (__ring_m82._tag === "some") {
      const us = __ring_m82._0;
...
function get_trait_method_index(ctx, dict_param, method) {
  __ring_match83: {
    const __ring_m83 = trait_name_from_dict_param(dict_param);
    if (__ring_m83._tag === "some") {
      const trait_name = __ring_m83._0;
      __ring_match84: {
        const __ring_m84 = _Map_get(ctx.trait_method_order, trait_name);
        if (__ring_m84._tag === "some") {
          const order = __ring_m84._0;
          let idx = 0;
          const __ring_iter_52 = __List_Iterable.iter(order);
          while (true) {
    ...
    __ring_match85: {
      ...
      if (__ring_m85._tag === "some") {
        ...
        if ((!_Set_contains(seen_prefixes, prefix_part, __Str_Eq))) {
          ...
          __ring_match86: {
            const __ring_m86 = found;
            if (__ring_m86._tag === "some") {
              const fn_val = __ring_m86._0;
...
function find_fn_by_suffix(ctx, name) {
  ...
  const __ring_iter_54 = __List_Iterable.iter(sorted_fns);
  while (true) {
...
function find_fn_precise(ctx, name) {
  ...
  __ring_match87: {
    const __ring_m87 = step1;
    if (__ring_m87._tag === "some") {
      const fn_val = __ring_m87._0;
  ...
  __ring_match88: {
    const __ring_m88 = step2;
    if (__ring_m88._tag === "some") {
      const fn_val = __ring_m88._0;
  ...
  __ring_match89: {
    const __ring_m89 = step3;
    if (__ring_m89._tag === "some") {
      const result = __ring_m89._0;
...
function find_function_in_ctx(ctx, mangled, name) {
  __ring_match90: {
    const __ring_m90 = _Map_get(ctx.functions, mangled);
    if (__ring_m90._tag === "some") {
      const fn_val = __ring_m90._0;
    ...
    if (__ring_m90._tag === "none") {
      ...
      __ring_match91: {
        const __ring_m91 = _Map_get(ctx.functions, bare);
        if (__ring_m91._tag === "some") {
          const fn_val = __ring_m91._0;
...
function gen_extern_LLVMAddIncoming(ctx, arg_vals, info) {
  let __ring_blk13;
  __ring_match92: {
    const __ring_m92 = List_get(arg_vals, 0);
    ...
    if (__ring_m92._tag === "none") {
      __ring_blk13 = panic("B-099: AddIncoming missing phi");
      break __ring_match92;
    }
    __match_fail(__ring_m92);
  }
  const phi_val = __ring_blk13;
  let __ring_blk14;
  __ring_match93: {
    const __ring_m93 = List_get(arg_vals, 1);
    ...
    if (__ring_m93._tag === "none") {
      __ring_blk14 = panic("B-099: AddIncoming missing vals");
      break __ring_match93;
    }
    __match_fail(__ring_m93);
  }
  const vals_list = __ring_blk14;
  let __ring_blk15;
  __ring_match94: {
    const __ring_m94 = List_get(arg_vals, 2);
    ...
    if (__ring_m94._tag === "none") {
      __ring_blk15 = panic("B-099: AddIncoming missing blocks");
      break __ring_match94;
    }
    __match_fail(__ring_m94);
  }
  const blocks_list = __ring_blk15;
...
function gen_extern_LLVMGetTargetFromTriple(ctx, arg_vals, info) {
  let __ring_blk16;
  __ring_match95: {
    const __ring_m95 = List_get(arg_vals, 0);
    ...
    if (__ring_m95._tag === "none") {
      __ring_blk16 = panic("LLVM codegen B-099: LLVMGetTargetFromTriple missing triple arg");
      break __ring_match95;
    }
    __match_fail(__ring_m95);
  }
  const triple_val = __ring_blk16;
...
function gen_extern_LLVMRunPasses(ctx, arg_vals, info) {
  let __ring_blk17;
  __ring_match96: {
    const __ring_m96 = List_get(arg_vals, 0);
    if (__ring_m96._tag === "some") {
      const v = __ring_m96._0;
      __ring_blk17 = v;
      break __ring_match96;
    }
    if (__ring_m96._tag === "none") {
      __ring_blk17 = panic("B-099: RP missing module");
      break __ring_match96;
    }
    __match_fail(__ring_m96);
  }
  const m_val = __ring_blk17;
  let __ring_blk18;
  __ring_match97: {
    const __ring_m97 = List_get(arg_vals, 1);
    if (__ring_m97._tag === "some") {
      const v = __ring_m97._0;
      __ring_blk18 = v;
      break __ring_match97;
    }
    if (__ring_m97._tag === "none") {
      __ring_blk18 = panic("B-099: RP missing passes");
      break __ring_match97;
    }
    __match_fail(__ring_m97);
  }
  const passes_val = __ring_blk18;
  let __ring_blk19;
  __ring_match98: {
    const __ring_m98 = List_get(arg_vals, 2);
    if (__ring_m98._tag === "some") {
      const v = __ring_m98._0;
      __ring_blk19 = v;
      break __ring_match98;
    }
    if (__ring_m98._tag === "none") {
      __ring_blk19 = panic("B-099: RP missing tm");
      break __ring_match98;
    }
    __match_fail(__ring_m98);
  }
  const tm_val = __ring_blk19;
  let __ring_blk20;
  __ring_match99: {
    const __ring_m99 = List_get(arg_vals, 3);
    ...
    if (__ring_m99._tag === "none") {
      __ring_blk20 = panic("B-099: RP missing opts");
      break __ring_match99;
    }
    __match_fail(__ring_m99);
  }
  const opts_val = __ring_blk20;
  const cstr_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_str_to_cstr", [ctx.ptr_type], ctx.ptr_type);
  const cstr_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_str_to_cstr");
...
function gen_extern_LLVMTargetMachineEmitToFile(ctx, arg_vals, info) {
  ...
  __ring_match100: {
    ...
    if (__ring_m100._tag === "none") {
      __ring_blk21 = panic("B-099: TMEF missing tm");
      break __ring_match100;
    }
    __match_fail(__ring_m100);
  }
  const tm_val = __ring_blk21;
  let __ring_blk22;
  __ring_match101: {
    ...
    if (__ring_m101._tag === "none") {
      __ring_blk22 = panic("B-099: TMEF missing module");
      break __ring_match101;
    }
    __match_fail(__ring_m101);
  }
  const m_val = __ring_blk22;
  let __ring_blk23;
  __ring_match102: {
    ...
    if (__ring_m102._tag === "none") {
      __ring_blk23 = panic("B-099: TMEF missing filename");
      break __ring_match102;
    }
    __match_fail(__ring_m102);
  }
  const filename_val = __ring_blk23;
  let __ring_blk24;
  __ring_match103: {
    const __ring_m103 = List_get(arg_vals, 3);
    ...
    if (__ring_m103._tag === "none") {
      __ring_blk24 = panic("B-099: TMEF missing filetype");
      break __ring_match103;
    }
    __match_fail(__ring_m103);
  }
  const filetype_val = __ring_blk24;
  const cstr_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_str_to_cstr", [ctx.ptr_type], ctx.ptr_type);
  const cstr_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_str_to_cstr");
...
function gen_extern_LLVMVerifyModule(ctx, arg_vals, info) {
  ...
  __ring_match104: {
    ...
    if (__ring_m104._tag === "none") {
      __ring_blk25 = panic("B-099: VM missing module");
      break __ring_match104;
    }
  ...
  __ring_match105: {
    ...
    if (__ring_m105._tag === "none") {
      __ring_blk26 = panic("B-099: VM missing action");
      break __ring_match105;
    }
    __match_fail(__ring_m105);
  }
  const action_val = __ring_blk26;
...
function gen_extern_fn_call(ctx, name, arg_vals, info) {
  ...
  let c_args = [];
  let arg_idx = 0;
  const __ring_iter_55 = __List_Iterable.iter(info.param_marshalls);
  while (true) {
    const __ring_next_55 = __ListIterator_Iterator.next(__ring_iter_55);
    if (__ring_next_55._tag === "none") break;
    const marshall = __ring_next_55._0;
    let __ring_blk27;
    __ring_match106: {
      const __ring_m106 = List_get(arg_vals, arg_idx);
      ...
      if (__ring_m106._tag === "none") {
        __ring_blk27 = panic(`LLVM codegen B-099: arg index ${arg_idx} out of bounds for extern fn '${name}'`);
        break __ring_match106;
      }
      __match_fail(__ring_m106);
    }
    const arg_val = __ring_blk27;
    __ring_match107: {
      const __ring_m107 = marshall;
      if (__ring_m107._tag === "PassthroughPtr") {
        List_push(c_args, arg_val);
        break __ring_match107;
      }
      if (__ring_m107._tag === "StrToCstr") {
        const cstr_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_str_to_cstr", [ctx.ptr_type], ctx.ptr_type);
        const cstr_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_str_to_cstr");
      ...
      if (__ring_m107._tag === "StrToCstrAndLen") {
        const cstr_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_str_to_cstr", [ctx.ptr_type], ctx.ptr_type);
        const cstr_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_str_to_cstr");
        const cstr = LLVMBuildCall2(ctx.builder, cstr_ty, cstr_fn, [arg_val], codegen_llvm_ctx$fresh_name(ctx, "cstr"));
        List_push(c_args, cstr);
      ...
      if (__ring_m107._tag === "IntToI64") {
        const raw = unbox_int(ctx, arg_val);
        List_push(c_args, raw);
        break __ring_match107;
      }
      if (__ring_m107._tag === "FloatToDouble") {
        const unbox_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_unbox_float", [ctx.ptr_type], ctx.double_type);
        const unbox_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_unbox_float");
      ...
      if (__ring_m107._tag === "ListToDataAndCount") {
        const data_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_data", [ctx.ptr_type], ctx.ptr_type);
        const data_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_data");
      ...
      if (__ring_m107._tag === "ListToDataAndCountI64") {
        const data_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_data", [ctx.ptr_type], ctx.ptr_type);
        const data_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_data");
        const data_ptr = LLVMBuildCall2(ctx.builder, data_ty, data_fn, [arg_val], codegen_llvm_ctx$fresh_name(ctx, "ldata"));
        List_push(c_args, data_ptr);
  ...
  let __ring_blk28;
  __ring_match108: {
    const __ring_m108 = info.ret_marshall;
    if (__ring_m108._tag === "RetVoid") {
      __ring_blk28 = "";
      break __ring_match108;
    }
    __ring_blk28 = codegen_llvm_ctx$fresh_name(ctx, "ext");
    break __ring_match108;
  }
  const call_name = __ring_blk28;
  const c_result = LLVMBuildCall2(ctx.builder, info.c_fn_type, info.c_fn_val, c_args, call_name);
  __ring_match109: {
    const __ring_m109 = info.ret_marshall;
    if (__ring_m109._tag === "RetPtr") {
      return c_result;
      break __ring_match109;
    }
    if (__ring_m109._tag === "RetVoid") {
      return LLVMConstPointerNull(ctx.ptr_type);
      break __ring_match109;
    }
    if (__ring_m109._tag === "RetIntToBoxed") {
      const ext = LLVMBuildZExt(ctx.builder, c_result, ctx.i64_type, codegen_llvm_ctx$fresh_name(ctx, "iext"));
      return box_int(ctx, ext);
      break __ring_match109;
    }
    if (__ring_m109._tag === "RetStrFromCstr") {
      const from_cstr_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_str_from_cstr", [ctx.ptr_type], ctx.ptr_type);
      const from_cstr_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_str_from_cstr");
...
function gen_runtime_call(ctx, name, args) {
  __ring_match110: {
    const __ring_m110 = _Map_get(ctx.rt_fns, name);
...
function lookup_evidence(ctx, ev_param_name) {
  __ring_match111: {
    const __ring_m111 = _Map_get(ctx.named_values, ev_param_name);
    if (__ring_m111._tag === "some") {
      const alloca = __ring_m111._0;
    ...
    if (__ring_m111._tag === "none") {
      ...
      __ring_match112: {
        const __ring_m112 = _Map_get(ctx.default_evidence, effect_name);
        if (__ring_m112._tag === "some") {
          const def_ev = __ring_m112._0;
          return def_ev;
...
function gen_direct_call(ctx, name, arg_vals, dict_vals) {
  ...
  __ring_match113: {
    const __ring_m113 = rt_name;
    if (__ring_m113._tag === "some") {
      const rtn = __ring_m113._0;
  ...
  __ring_match114: {
    const __ring_m114 = _Map_get(ctx.extern_fn_infos, name);
    if (__ring_m114._tag === "some") {
      const info = __ring_m114._0;
  ...
  __ring_match115: {
    const __ring_m115 = found_fn;
    if (__ring_m115._tag === "some") {
      const fn_info = __ring_m115._0;
      const __ring_iter_56 = __List_Iterable.iter(dict_vals);
      while (true) {
        const __ring_next_56 = __ListIterator_Iterator.next(__ring_iter_56);
        if (__ring_next_56._tag === "none") break;
        const dv = __ring_next_56._0;
        List_push(arg_vals, dv);
      }
      __ring_match116: {
        const __ring_m116 = _Map_get(ctx.fn_evidence_params, fn_info.fn_mangled);
        if (__ring_m116._tag === "some") {
          const ev_params = __ring_m116._0;
          const __ring_iter_57 = __List_Iterable.iter(ev_params);
          while (true) {
            const __ring_next_57 = __ListIterator_Iterator.next(__ring_iter_57);
            if (__ring_next_57._tag === "none") break;
            const ep = __ring_next_57._0;
      ...
      let __ring_blk29;
      __ring_match117: {
        const __ring_m117 = _Map_get(ctx.fn_types, fn_info.fn_mangled);
        if (__ring_m117._tag === "some") {
          const t = __ring_m117._0;
          __ring_blk29 = t;
          break __ring_match117;
        }
        if (__ring_m117._tag === "none") {
          __ring_blk29 = panic(`LLVM codegen: fn type not found for ${fn_info.fn_mangled}`);
          break __ring_match117;
        }
        __match_fail(__ring_m117);
      }
      const fn_ty = __ring_blk29;
    ...
    if (__ring_m115._tag === "none") {
      __ring_match118: {
        const __ring_m118 = _Map_get(ctx.named_values, name);
        ...
        if (__ring_m118._tag === "none") {
          ...
          __ring_match119: {
            const __ring_m119 = _Map_get(ctx.rt_fns, rt_fallback);
...
function ensure_runtime_method(ctx, name, arg_count) {
  __ring_match120: {
    const __ring_m120 = _Map_get(ctx.rt_fns, name);
    if (__ring_m120._tag === "some") {
      const f = __ring_m120._0;
      return f;
...
function is_builtin_collection(ty) {
  __ring_match121: {
    const __ring_m121 = ty;
    if (__ring_m121._tag === "StructType") {
      const name = __ring_m121.name; const type_params = __ring_m121.type_params;
      if ((name === "List")) {
...
function is_int_keyed_map(ty) {
  __ring_match122: {
    const __ring_m122 = ty;
    if (__ring_m122._tag === "StructType") {
      const name = __ring_m122.name; const type_params = __ring_m122.type_params;
      if (((name === "Map") ? (List_len(type_params) === 2) : false)) {
        __ring_match123: {
          const __ring_m123 = __ring_index(type_params, 0);
          if (__ring_m123._tag === "IntType") {
            return true;
...
function is_int_set(ty) {
  __ring_match124: {
    ...
    if (__ring_m124._tag === "StructType") {
      const name = __ring_m124.name; const type_params = __ring_m124.type_params;
      if (((name === "Set") ? (List_len(type_params) === 1) : false)) {
        __ring_match125: {
          const __ring_m125 = __ring_index(type_params, 0);
          if (__ring_m125._tag === "IntType") {
            return true;
...
function gen_method_call(ctx, recv, recv_type, method, args, dict_vals) {
  ...
  __ring_match126: {
    ...
    if (__ring_m126._tag === "none") {
      let __ring_blk31;
      __ring_match127: {
        const __ring_m127 = recv_type;
        if (__ring_m127._tag === "StructType") {
          const name = __ring_m127.name;
          __ring_blk31 = name;
          break __ring_match127;
        }
        if (__ring_m127._tag === "EnumType") {
          const name = __ring_m127.name;
          __ring_blk31 = name;
          break __ring_match127;
        }
        __ring_blk31 = "Unknown";
        break __ring_match127;
      }
      __ring_blk30 = __ring_blk31;
      break __ring_match126;
    }
    __match_fail(__ring_m126);
  }
  const type_name = __ring_blk30;
  ...
  __ring_match128: {
    const __ring_m128 = rt_method;
    if (__ring_m128._tag === "some") {
      const base_rt_name = __ring_m128._0;
      let __ring_blk32;
      __ring_match129: {
        const __ring_m129 = method;
        if (__ring_m129 === "get") {
          __ring_blk32 = "ring_map_int_get_opt";
          break __ring_match129;
        }
        if (__ring_m129 === "insert") {
          __ring_blk32 = "ring_map_int_set";
          break __ring_match129;
        }
        if (__ring_m129 === "contains_key") {
          __ring_blk32 = "ring_map_int_has";
          break __ring_match129;
        }
        if (__ring_m129 === "keys") {
          __ring_blk32 = "ring_map_int_keys";
          break __ring_match129;
        }
        if (__ring_m129 === "values") {
          __ring_blk32 = "ring_map_int_values";
          break __ring_match129;
        }
        if (__ring_m129 === "entries") {
          __ring_blk32 = "ring_map_int_entries";
          break __ring_match129;
        }
        if (__ring_m129 === "len") {
          __ring_blk32 = "ring_map_int_len";
          break __ring_match129;
        }
        if (__ring_m129 === "remove") {
          __ring_blk32 = "ring_map_int_delete";
          break __ring_match129;
        }
        if (__ring_m129 === "for_each") {
          __ring_blk32 = "ring_map_int_for_each";
          break __ring_match129;
        }
        if (__ring_m129 === "clear") {
          __ring_blk32 = "ring_map_int_clear";
          break __ring_match129;
        }
        if (__ring_m129 === "clone") {
          __ring_blk32 = "ring_map_int_clone";
          break __ring_match129;
        }
        if (__ring_m129 === "is_empty") {
          __ring_blk32 = "ring_map_int_is_empty";
          break __ring_match129;
        }
      ...
      let __ring_blk33;
      __ring_match130: {
        const __ring_m130 = method;
        if (__ring_m130 === "add") {
          __ring_blk33 = "ring_set_int_add";
          break __ring_match130;
        }
        if (__ring_m130 === "insert") {
          __ring_blk33 = "ring_set_int_add";
          break __ring_match130;
        }
        if (__ring_m130 === "has") {
          __ring_blk33 = "ring_set_int_has";
          break __ring_match130;
        }
        if (__ring_m130 === "contains") {
          __ring_blk33 = "ring_set_int_has";
          break __ring_match130;
        }
        if (__ring_m130 === "to_list") {
          __ring_blk33 = "ring_set_int_to_list";
          break __ring_match130;
        }
        if (__ring_m130 === "len") {
          __ring_blk33 = "ring_set_int_len";
          break __ring_match130;
        }
        if (__ring_m130 === "from_list") {
          __ring_blk33 = "ring_set_int_from_list";
          break __ring_match130;
        }
        if (__ring_m130 === "for_each") {
          __ring_blk33 = "ring_set_int_for_each";
          break __ring_match130;
        }
        if (__ring_m130 === "remove") {
          __ring_blk33 = "ring_set_int_delete";
          break __ring_match130;
        }
        if (__ring_m130 === "clear") {
          __ring_blk33 = "ring_set_int_clear";
          break __ring_match130;
        }
        if (__ring_m130 === "clone") {
          __ring_blk33 = "ring_set_int_clone";
          break __ring_match130;
        }
        if (__ring_m130 === "is_empty") {
          __ring_blk33 = "ring_set_int_is_empty";
          break __ring_match130;
        }
        if (__ring_m130 === "union") {
          __ring_blk33 = "ring_set_int_union";
          break __ring_match130;
        }
        if (__ring_m130 === "intersect") {
          __ring_blk33 = "ring_set_int_intersect";
          break __ring_match130;
        }
        if (__ring_m130 === "difference") {
          __ring_blk33 = "ring_set_int_difference";
          break __ring_match130;
        }
        __ring_blk33 = base_rt_name;
        break __ring_match130;
      }
      const rt_name = (is_int_keyed_map(recv_type) ? __ring_blk32 : (is_int_set(recv_type) ? __ring_blk33 : base_rt_name));
      let call_args = [];
      ...
      let ai_idx = 0;
      const __ring_iter_59 = __List_Iterable.iter(args);
      while (true) {
    ...
    if (__ring_m128._tag === "none") {
      ...
      __ring_match131: {
        ...
        if (__ring_m131._tag === "some") {
          ...
          __ring_match132: {
            const __ring_m132 = _Map_get(ctx.fn_evidence_params, mangled);
            if (__ring_m132._tag === "some") {
              const ev_params = __ring_m132._0;
          ...
          let __ring_blk34;
          __ring_match133: {
            const __ring_m133 = _Map_get(ctx.fn_types, mangled);
            if (__ring_m133._tag === "some") {
              const t = __ring_m133._0;
              __ring_blk34 = t;
              break __ring_match133;
            }
            if (__ring_m133._tag === "none") {
              __ring_blk34 = panic(`LLVM codegen: fn type not found for method ${mangled}`);
              break __ring_match133;
            }
            __match_fail(__ring_m133);
          }
          const fn_ty = __ring_blk34;
          return LLVMBuildCall2(ctx.builder, fn_ty, fn_val, call_args, codegen_llvm_ctx$fresh_name(ctx, "mc"));
...
function is_boxed_def(ctx, def_id) {
  __ring_match134: {
    const __ring_m134 = def_id;
    if (__ring_m134._tag === "some") {
      const did = __ring_m134._0;
...
function lookup_call_mut_flags(ctx, callee) {
  __ring_match136: {
    const __ring_m136 = callee;
    if (__ring_m136._tag === "Ident") {
      const name = __ring_m136.name; const resolved_name = __ring_m136.resolved_name;
      let __ring_blk35;
      __ring_match137: {
        const __ring_m137 = resolved_name;
        if (__ring_m137._tag === "some") {
          const rn = __ring_m137._0;
          __ring_blk35 = rn;
      ...
      const call_name = __ring_blk35;
      return _Map_get(ctx.fn_mut_params, call_name);
      break __ring_match136;
    }
    if (__ring_m136._tag === "FieldAccess") {
      const receiver = __ring_m136.receiver; const field = __ring_m136.field;
      const recv_type = hir$hexpr_type(receiver);
      let __ring_blk36;
      __ring_match138: {
        const __ring_m138 = types$type_to_builtin_name(recv_type);
        ...
        if (__ring_m138._tag === "none") {
          let __ring_blk37;
          __ring_match139: {
            const __ring_m139 = recv_type;
            if (__ring_m139._tag === "StructType") {
              const name = __ring_m139.name;
              __ring_blk37 = name;
              break __ring_match139;
            }
            if (__ring_m139._tag === "EnumType") {
              const name = __ring_m139.name;
              __ring_blk37 = name;
              break __ring_match139;
            }
          ...
          __ring_blk36 = __ring_blk37;
          break __ring_match138;
        }
        __match_fail(__ring_m138);
      }
      const type_name = __ring_blk36;
      if ((type_name === "")) {
        return Option_none;
      } else {
        const ufcs_name = `${type_name}_${field}`;
        __ring_match140: {
          const __ring_m140 = _Map_get(ctx.fn_mut_params, ufcs_name);
          if (__ring_m140._tag === "some") {
            const flags = __ring_m140._0;
            let shifted = [];
            let i = 1;
            while ((i < List_len(flags))) {
              __ring_match141: {
                const __ring_m141 = List_get(flags, i);
...
function get_or_declare_frameaddress(ctx) {
  ...
  __ring_match142: {
    const __ring_m142 = _Map_get(ctx.rt_fns, name);
    if (__ring_m142._tag === "some") {
      const f = __ring_m142._0;
      __ring_match143: {
        const __ring_m143 = _Map_get(ctx.rt_fn_types, name);
        if (__ring_m143._tag === "some") {
          const t = __ring_m143._0;
          return [f, t];
...
function get_or_declare_setjmp(ctx) {
  const name = "_setjmp";
  __ring_match144: {
    const __ring_m144 = _Map_get(ctx.rt_fns, name);
    if (__ring_m144._tag === "some") {
      const f = __ring_m144._0;
      __ring_match145: {
        const __ring_m145 = _Map_get(ctx.rt_fn_types, name);
        if (__ring_m145._tag === "some") {
          const t = __ring_m145._0;
          return [f, t];
...
function gen_dict_closure_wrapper(ctx, lookup_name, name, dict_names, ty) {
  ...
  let __ring_blk38;
  __ring_match147: {
    const __ring_m147 = found;
    if (__ring_m147._tag === "some") {
      const fi = __ring_m147._0;
      __ring_blk38 = fi;
      break __ring_match147;
    }
    if (__ring_m147._tag === "none") {
      __ring_blk38 = panic(`LLVM codegen: dict-closure wrapper: function '${name}' not found`);
      break __ring_match147;
    }
    __match_fail(__ring_m147);
  }
  const fn_info = __ring_blk38;
  const real_fn = fn_info.fn_val;
  let __ring_blk39;
  __ring_match148: {
    const __ring_m148 = _Map_get(ctx.fn_types, fn_info.fn_mangled);
    ...
    if (__ring_m148._tag === "none") {
      __ring_blk39 = panic(`LLVM codegen: dict-closure wrapper: fn type not found for ${fn_info.fn_mangled}`);
      break __ring_match148;
    }
    __match_fail(__ring_m148);
  }
  const real_fn_ty = __ring_blk39;
  let __ring_blk40;
  __ring_match149: {
    const __ring_m149 = ty;
    if (__ring_m149._tag === "FnType") {
      const params = __ring_m149.params;
      __ring_blk40 = List_len(params);
      break __ring_match149;
    }
    __ring_blk40 = 0;
    break __ring_match149;
  }
  const param_count = __ring_blk40;
  let dict_vals = [];
  const __ring_iter_65 = __List_Iterable.iter(dict_names);
  while (true) {
    const __ring_next_65 = __ListIterator_Iterator.next(__ring_iter_65);
    if (__ring_next_65._tag === "none") break;
    const dn = __ring_next_65._0;
    List_push(dict_vals, resolve_dict_ref(ctx, hir$DictRef_Simple(dn)));
  }
  let ev_vals = [];
  __ring_match150: {
    const __ring_m150 = _Map_get(ctx.fn_evidence_params, fn_info.fn_mangled);
    if (__ring_m150._tag === "some") {
      const ev_params = __ring_m150._0;
      const __ring_iter_66 = __List_Iterable.iter(ev_params);
      while (true) {
        const __ring_next_66 = __ListIterator_Iterator.next(__ring_iter_66);
        if (__ring_next_66._tag === "none") break;
        const ep = __ring_next_66._0;
  ...
  let env_elem_types = [ctx.i64_type];
  const __ring_end67 = captured_count;
  for (let i = 0; i < __ring_end67; i++) {
    List_push(env_elem_types, ctx.ptr_type);
  }
  const env_ty = LLVMStructTypeInContext(ctx.context, env_elem_types, 0);
  const thunk_name = codegen_llvm_ctx$fresh_name(ctx, "ring_dictwrap_");
  let thunk_param_types = [ctx.ptr_type];
  const __ring_end68 = param_count;
...
function gen_ident(ctx, name, resolved_name, def_id, dict_closure_dicts, ty) {
  __ring_match151: {
    const __ring_m151 = dict_closure_dicts;
    if (__ring_m151._tag === "some") {
      const dicts = __ring_m151._0;
      if ((List_len(dicts) > 0)) {
        let __ring_blk41;
        __ring_match152: {
  ...
  let __ring_blk42;
  __ring_match153: {
    const __ring_m153 = resolved_name;
    if (__ring_m153._tag === "some") {
      const rn = __ring_m153._0;
      __ring_blk42 = rn;
  ...
  const lookup_name = __ring_blk42;
  const boxed = is_boxed_def(ctx, def_id);
  __ring_match154: {
    const __ring_m154 = _Map_get(ctx.named_values, lookup_name);
    if (__ring_m154._tag === "some") {
      const alloca = __ring_m154._0;
    ...
    if (__ring_m154._tag === "none") {
      __ring_match155: {
        const __ring_m155 = _Map_get(ctx.named_values, name);
        if (__ring_m155._tag === "some") {
          const alloca = __ring_m155._0;
        ...
        if (__ring_m155._tag === "none") {
          __ring_match156: {
            const __ring_m156 = ty;
            if (__ring_m156._tag === "FnType") {
          ...
          __ring_match157: {
            const __ring_m157 = _Map_get(ctx.functions, mangled_resolved);
            if (__ring_m157._tag === "some") {
              const fn_val = __ring_m157._0;
            ...
            if (__ring_m157._tag === "none") {
              ...
              __ring_match158: {
                const __ring_m158 = _Map_get(ctx.functions, mangled_bare);
                if (__ring_m158._tag === "some") {
                  const fn_val = __ring_m158._0;
                ...
                if (__ring_m158._tag === "none") {
                  ...
                  __ring_match159: {
                    const __ring_m159 = _Map_get(ctx.functions, mangled_name_resolved);
                    if (__ring_m159._tag === "some") {
                      const fn_val = __ring_m159._0;
                    ...
                    if (__ring_m159._tag === "none") {
                      ...
                      __ring_match160: {
                        const __ring_m160 = _Map_get(ctx.functions, mangled_lu);
                        if (__ring_m160._tag === "some") {
                          const fn_val = __ring_m160._0;
                        ...
                        if (__ring_m160._tag === "none") {
                          ...
                          __ring_match161: {
                            ...
                            if (__ring_m161._tag === "none") {
                              ...
                              __ring_match162: {
                                const __ring_m162 = found2;
                                if (__ring_m162._tag === "some") {
                                  const fi2 = __ring_m162._0;
...
function gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, match_bb, miss_bb, current_fn) {
  const ei = find_enum_by_variant(ctx, cname, qualifier);
  __ring_match163: {
    const __ring_m163 = ei;
    if (__ring_m163._tag === "some") {
      const enum_info = __ring_m163._0;
      __ring_match164: {
        const __ring_m164 = _Map_get(enum_info.variants, cname);
        if (__ring_m164._tag === "some") {
          const vi = __ring_m164._0;
...
function gen_literal_pattern_cond(ctx, scrut_val, scrut_ty, value) {
  __ring_match165: {
    const __ring_m165 = value;
    if (__ring_m165._tag === "IntVal") {
      const n = __ring_m165._0;
    ...
    if (__ring_m165._tag === "BoolVal") {
      const b = __ring_m165._0;
      const raw = unbox_int(ctx, scrut_val);
      const lit = (b ? LLVMConstInt(ctx.i64_type, 1, 0) : LLVMConstInt(ctx.i64_type, 0, 0));
      return LLVMBuildICmp(ctx.builder, 32, raw, lit, codegen_llvm_ctx$fresh_name(ctx, "eq"));
      break __ring_match165;
    }
    if (__ring_m165._tag === "StrVal") {
      const s = __ring_m165._0;
    ...
    if (__ring_m165._tag === "FloatVal") {
      const f = __ring_m165._0;
      const unbox_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_unbox_float", [ctx.ptr_type], ctx.double_type);
      const unbox_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_unbox_float");
...
function tuple_element_type(ty, idx) {
  __ring_match166: {
    const __ring_m166 = ty;
    if (__ring_m166._tag === "TupleType") {
      const elements = __ring_m166.elements;
      __ring_match167: {
        const __ring_m167 = List_get(elements, idx);
        if (__ring_m167._tag === "some") {
          const t = __ring_m167._0;
          return t;
...
function gen_unaryop(ctx, op, operand, ty) {
  ...
  __ring_match168: {
    const __ring_m168 = op;
    if (__ring_m168._tag === "Neg") {
      if (is_int_type(ty)) {
        const raw = unbox_int(ctx, val);
...
function gen_catch_arms(ctx, error_val, arms) {
  ...
  const __ring_iter_73 = __List_Iterable.iter(arms);
  while (true) {
    const __ring_next_73 = __ListIterator_Iterator.next(__ring_iter_73);
    if (__ring_next_73._tag === "none") break;
    const arm = __ring_next_73._0;
    __ring_match169: {
      const __ring_m169 = arm.pattern;
      if (__ring_m169._tag === "Constructor") {
        has_constructor = true;
        constructor_count = (constructor_count + 1);
        break __ring_match169;
      }
      if (__ring_m169._tag === "NamedConstructor") {
        has_constructor = true;
        constructor_count = (constructor_count + 1);
        break __ring_match169;
      }
  ...
  if (((!has_constructor) ? true : (List_len(arms) === 1))) {
    ...
    __ring_match170: {
      const __ring_m170 = arm.pattern;
      if (__ring_m170._tag === "Binding") {
        const name = __ring_m170.name;
        const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, name);
      ...
      if (__ring_m170._tag === "Wildcard") {
        return gen_llvm_expr(ctx, arm.body);
        break __ring_match170;
      }
      if (__ring_m170._tag === "Constructor") {
        const name = __ring_m170.name; const fields = __ring_m170.fields;
        bind_nested_pattern(ctx, error_val, arm.pattern);
        return gen_llvm_expr(ctx, arm.body);
        break __ring_match170;
      }
      if (__ring_m170._tag === "NamedConstructor") {
        const name = __ring_m170.name; const fields = __ring_m170.fields;
        bind_nested_pattern(ctx, error_val, arm.pattern);
        return gen_llvm_expr(ctx, arm.body);
        break __ring_match170;
  ...
  const __ring_iter_74 = __List_Iterable.iter(arms);
  while (true) {
    const __ring_next_74 = __ListIterator_Iterator.next(__ring_iter_74);
    if (__ring_next_74._tag === "none") break;
    const arm = __ring_next_74._0;
    __ring_match171: {
      const __ring_m171 = arm.pattern;
      if (__ring_m171._tag === "Constructor") {
        const name = __ring_m171.name; const qualifier = __ring_m171.qualifier;
    ...
    __ring_match172: {
      const __ring_m172 = enum_info_opt;
  ...
  __ring_match173: {
    const __ring_m173 = enum_info_opt;
  ...
  let __ring_blk43;
  __ring_match174: {
    const __ring_m174 = enum_info_opt;
    if (__ring_m174._tag === "some") {
      const ei = __ring_m174._0;
      __ring_blk43 = ei;
      break __ring_match174;
    }
    if (__ring_m174._tag === "none") {
      __ring_blk43 = panic("LLVM codegen: catch enum_info unreachable");
      break __ring_match174;
    }
    __match_fail(__ring_m174);
  }
  const enum_info = __ring_blk43;
  let __ring_blk44;
  __ring_match175: {
    const __ring_m175 = ctx.current_fn;
    if (__ring_m175._tag === "some") {
      const f = __ring_m175._0;
      __ring_blk44 = f;
      break __ring_match175;
    }
    if (__ring_m175._tag === "none") {
      __ring_blk44 = panic("LLVM codegen: catch arms outside function");
      break __ring_match175;
    }
  ...
  const __ring_iter_75 = __List_Iterable.iter(arms);
  while (true) {
    const __ring_next_75 = __ListIterator_Iterator.next(__ring_iter_75);
    if (__ring_next_75._tag === "none") break;
    const arm = __ring_next_75._0;
    __ring_match176: {
      const __ring_m176 = arm.pattern;
      if (__ring_m176._tag === "Wildcard") {
        has_wildcard = true;
      ...
      if (__ring_m176._tag === "Binding") {
        const name = __ring_m176.name;
        has_wildcard = true;
        LLVMPositionBuilderAtEnd(ctx.builder, catch_default_bb);
        const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, name);
        discard(LLVMBuildStore(ctx.builder, error_val, alloca));
      ...
      if (__ring_m176._tag === "Constructor") {
        const name = __ring_m176.name; const fields = __ring_m176.fields;
        __ring_match177: {
          const __ring_m177 = _Map_get(enum_info.variants, name);
          if (__ring_m177._tag === "some") {
            ...
            const __ring_end76 = List_len(fields);
            for (let i = 0; i < __ring_end76; i++) {
              __ring_match178: {
                const __ring_m178 = List_get(fields, i);
                if (__ring_m178._tag === "some") {
                  const field_pat = __ring_m178._0;
                  __ring_match179: {
                    const __ring_m179 = field_pat;
                    if (__ring_m179._tag === "Binding") {
                      const bname = __ring_m179.name;
      ...
      if (__ring_m176._tag === "NamedConstructor") {
        const name = __ring_m176.name; const named_fields = __ring_m176.fields;
        __ring_match180: {
          const __ring_m180 = _Map_get(enum_info.variants, name);
          if (__ring_m180._tag === "some") {
            const vi = __ring_m180._0;
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `catch.arm.${name}`);
            LLVMAddCase(switch_val, LLVMConstInt(ctx.i64_type, vi.tag, 0), arm_bb);
            LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
            const __ring_end77 = List_len(named_fields);
            for (let i = 0; i < __ring_end77; i++) {
              __ring_match181: {
                const __ring_m181 = List_get(named_fields, i);
                if (__ring_m181._tag === "some") {
                  const nf = __ring_m181._0;
                  let field_idx = i;
                  const __ring_end78 = List_len(vi.field_names);
                  for (let fi = 0; fi < __ring_end78; fi++) {
                    if ((__ring_index(vi.field_names, fi) === nf.name)) {
                      field_idx = fi;
                    }
                  }
                  __ring_match182: {
                    const __ring_m182 = nf.pattern;
                    if (__ring_m182._tag === "Binding") {
                      const bname = __ring_m182.name;
...
function gen_try_catch(ctx, body, arms) {
  ...
  __ring_match183: {
    ...
    if (__ring_m183._tag === "none") {
      __ring_blk45 = panic("LLVM codegen: try-catch outside function");
      break __ring_match183;
    }
    __match_fail(__ring_m183);
  }
  const current_fn = __ring_blk45;
...
function gen_struct_lit(ctx, name, fields, spread) {
  __ring_match184: {
    const __ring_m184 = _Map_get(ctx.struct_types, name);
    if (__ring_m184._tag === "some") {
      const info = __ring_m184._0;
      ...
      while (true) {
        ...
        let field_idx = (-1);
        const __ring_end82 = List_len(info.field_names);
...
function gen_string_interp(ctx, parts) {
  ...
  const drop_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_drop", [ctx.ptr_type], ctx.void_type);
  const drop_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_drop");
  const __ring_iter_83 = __List_Iterable.iter(parts);
  while (true) {
    const __ring_next_83 = __ListIterator_Iterator.next(__ring_iter_83);
    if (__ring_next_83._tag === "none") break;
    const part = __ring_next_83._0;
    __ring_match186: {
      const __ring_m186 = part;
      if (__ring_m186._tag === "Literal") {
      ...
      if (__ring_m186._tag === "Expression") {
        const e = __ring_m186._0;
...
function gen_named_variant_construct(ctx, enum_name, variant_name, fields, spread) {
  __ring_match187: {
    const __ring_m187 = _Map_get(ctx.enum_types, enum_name);
    if (__ring_m187._tag === "some") {
      const enum_info = __ring_m187._0;
      __ring_match188: {
        const __ring_m188 = _Map_get(enum_info.variants, variant_name);
        if (__ring_m188._tag === "some") {
          ...
          __ring_match189: {
            const __ring_m189 = spread;
            if (__ring_m189._tag === "some") {
              const spread_expr = __ring_m189._0;
              let overridden = set_new();
              const __ring_iter_84 = __List_Iterable.iter(fields);
              while (true) {
          ...
          const __ring_end86 = List_len(fields);
          for (let i = 0; i < __ring_end86; i++) {
            __ring_match190: {
              const __ring_m190 = List_get(fields, i);
    ...
    if (__ring_m187._tag === "none") {
      ...
      __ring_match191: {
        const __ring_m191 = _Map_get(ctx.functions, ctor_name);
        if (__ring_m191._tag === "some") {
          const fn_val = __ring_m191._0;
          let args = [];
          ...
          let __ring_blk46;
          __ring_match192: {
            const __ring_m192 = _Map_get(ctx.fn_types, ctor_name);
            ...
            if (__ring_m192._tag === "none") {
              __ring_blk46 = panic(`LLVM codegen: fn type not found for ${ctor_name}`);
              break __ring_match192;
            }
            __match_fail(__ring_m192);
          }
          const fn_ty = __ring_blk46;
...
function emit_match_arm_body(ctx, arm, merge_bb, next_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match193: {
    const __ring_m193 = arm.guard;
    if (__ring_m193._tag === "some") {
      const g = __ring_m193._0;
...
function gen_match_if_else(ctx, scrut_val, scrut_ty, arms, merge_bb, default_bb, current_fn) {
  ...
  const __ring_end89 = total;
  for (let i = 0; i < __ring_end89; i++) {
    __ring_match194: {
      const __ring_m194 = List_get(arms, i);
      if (__ring_m194._tag === "some") {
        const arm = __ring_m194._0;
        const is_last = (i === (total - 1));
        let __ring_blk47;
        __ring_match195: {
          const __ring_m195 = arm.guard;
        ...
        const has_guard = __ring_blk47;
        __ring_match196: {
          const __ring_m196 = arm.pattern;
          if (__ring_m196._tag === "Wildcard") {
            open_block = false;
          ...
          if (__ring_m196._tag === "Literal") {
            const value = __ring_m196.value;
          ...
          if (__ring_m196._tag === "Constructor") {
            const cname = __ring_m196.name; const qualifier = __ring_m196.qualifier; const fields = __ring_m196.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
          ...
          if (__ring_m196._tag === "NamedConstructor") {
            const cname = __ring_m196.name; const qualifier = __ring_m196.qualifier; const nfields = __ring_m196.fields;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, `match.ctor.${cname}`);
            gen_ctor_tag_test(ctx, scrut_val, cname, qualifier, arm_bb, next_bb, current_fn);
            LLVMPositionBuilderAtEnd(ctx.builder, arm_bb);
          ...
          if (__ring_m196._tag === "OrPattern") {
            const patterns = __ring_m196.patterns;
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.or");
            const palts = patterns;
            const nalts = List_len(palts);
            const __ring_end90 = nalts;
            for (let k = 0; k < __ring_end90; k++) {
              __ring_match197: {
                const __ring_m197 = List_get(palts, k);
                if (__ring_m197._tag === "some") {
                  const alt = __ring_m197._0;
                  let __ring_blk48;
                  __ring_match198: {
                    const __ring_m198 = alt;
                    if (__ring_m198._tag === "Constructor") {
                      const an = __ring_m198.name; const aq = __ring_m198.qualifier;
                      __ring_blk48 = Option_some([an, aq]);
                  ...
                  const alt_ref = __ring_blk48;
                  __ring_match199: {
                    const __ring_m199 = alt_ref;
                    if (__ring_m199._tag === "some") {
                      const ar = __ring_m199._0;
                      const __ring_dt3 = ar;
          ...
          if (__ring_m196._tag === "TuplePattern") {
            const elements = __ring_m196.elements;
            const get_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_get", [ctx.ptr_type, ctx.i64_type], ctx.ptr_type);
            const get_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_get");
            const next_bb = (is_last ? default_bb : LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.next"));
            const __ring_end91 = List_len(elements);
            for (let j = 0; j < __ring_end91; j++) {
              __ring_match200: {
                const __ring_m200 = List_get(elements, j);
                if (__ring_m200._tag === "some") {
                  const elem_pat = __ring_m200._0;
                  let __ring_blk49;
                  __ring_match201: {
                    const __ring_m201 = elem_pat;
                    if (__ring_m201._tag === "Constructor") {
                      const cname = __ring_m201.name; const qualifier = __ring_m201.qualifier;
                      __ring_blk49 = Option_some([cname, qualifier]);
                  ...
                  const ctor_ref = __ring_blk49;
                  __ring_match202: {
                    const __ring_m202 = ctor_ref;
                    if (__ring_m202._tag === "some") {
                      const cref = __ring_m202._0;
                      ...
                      const ei = find_enum_by_variant(ctx, cname, qualifier);
                      __ring_match203: {
                        const __ring_m203 = ei;
                        if (__ring_m203._tag === "some") {
                          const enum_info = __ring_m203._0;
                          __ring_match204: {
                            const __ring_m204 = _Map_get(enum_info.variants, cname);
            ...
            const __ring_end92 = List_len(elements);
            for (let j = 0; j < __ring_end92; j++) {
              __ring_match206: {
                const __ring_m206 = List_get(elements, j);
                if (__ring_m206._tag === "some") {
                  const elem_pat = __ring_m206._0;
                  __ring_match207: {
                    const __ring_m207 = elem_pat;
                    if (__ring_m207._tag === "Binding") {
                      const bname = __ring_m207.name;
                      const idx = LLVMConstInt(ctx.i64_type, j, 0);
...
function gen_match_arm_wildcard(ctx, arm, scrut_val, default_bb, merge_bb, phi_vals, phi_bbs) {
  LLVMPositionBuilderAtEnd(ctx.builder, default_bb);
  __ring_match208: {
    const __ring_m208 = arm.pattern;
    if (__ring_m208._tag === "Binding") {
      const bname = __ring_m208.name;
      const alloca = codegen_llvm_ctx$build_entry_alloca(ctx, ctx.ptr_type, bname);
      discard(LLVMBuildStore(ctx.builder, scrut_val, alloca));
      _Map_insert(ctx.named_values, bname, alloca);
...
function gen_match_arm_enum(ctx, arm, scrut_val, enum_name, enum_info, switch_val, merge_bb, current_fn, phi_vals, phi_bbs) {
  __ring_match209: {
    const __ring_m209 = arm.pattern;
    if (__ring_m209._tag === "Constructor") {
      const name = __ring_m209.name; const fields = __ring_m209.fields;
      __ring_match210: {
        const __ring_m210 = _Map_get(enum_info.variants, name);
        if (__ring_m210._tag === "some") {
          const vi = __ring_m210._0;
          ...
          for (let i = 0; i < __ring_end93; i++) {
            __ring_match211: {
              ...
              if (__ring_m211._tag === "some") {
                const field_pat = __ring_m211._0;
                __ring_match212: {
                  const __ring_m212 = field_pat;
    ...
    if (__ring_m209._tag === "NamedConstructor") {
      const name = __ring_m209.name; const named_fields = __ring_m209.fields;
      __ring_match213: {
        const __ring_m213 = _Map_get(enum_info.variants, name);
        if (__ring_m213._tag === "some") {
          ...
          for (let i = 0; i < __ring_end94; i++) {
            __ring_match214: {
              const __ring_m214 = List_get(named_fields, i);
              if (__ring_m214._tag === "some") {
                const nf = __ring_m214._0;
                let field_idx = i;
    ...
    if (__ring_m209._tag === "Wildcard") {
      break __ring_match209;
    }
    if (__ring_m209._tag === "Binding") {
      const bname = __ring_m209.name;
      break __ring_match209;
    }
    if (__ring_m209._tag === "OrPattern") {
      const patterns = __ring_m209.patterns;
      const arm_bb = LLVMAppendBasicBlockInContext(ctx.context, current_fn, "match.arm.or");
      const __ring_iter_96 = __List_Iterable.iter(patterns);
      while (true) {
        const __ring_next_96 = __ListIterator_Iterator.next(__ring_iter_96);
        if (__ring_next_96._tag === "none") break;
        const alt = __ring_next_96._0;
        let __ring_blk50;
        __ring_match216: {
          const __ring_m216 = alt;
          if (__ring_m216._tag === "Constructor") {
            const name = __ring_m216.name;
            __ring_blk50 = Option_some(name);
            break __ring_match216;
          }
          if (__ring_m216._tag === "NamedConstructor") {
            const name = __ring_m216.name;
            __ring_blk50 = Option_some(name);
            break __ring_match216;
          }
        ...
        const alt_name = __ring_blk50;
        __ring_match217: {
          const __ring_m217 = alt_name;
          if (__ring_m217._tag === "some") {
            const an = __ring_m217._0;
            __ring_match218: {
              const __ring_m218 = _Map_get(enum_info.variants, an);
...
function gen_match_expr(ctx, scrutinee, arms, result_ty) {
  let __ring_blk51;
  __ring_match219: {
    const __ring_m219 = ctx.current_fn;
    if (__ring_m219._tag === "some") {
      const f = __ring_m219._0;
      __ring_blk51 = f;
      break __ring_match219;
    }
    if (__ring_m219._tag === "none") {
      __ring_blk51 = panic("LLVM codegen: match expr outside function");
      break __ring_match219;
    }
  ...
  let __ring_blk52;
  __ring_match220: {
    const __ring_m220 = scrut_ty;
    if (__ring_m220._tag === "EnumType") {
      const name = __ring_m220.name;
  ...
  let any_guard = false;
  const __ring_iter_97 = __List_Iterable.iter(arms);
  while (true) {
    const __ring_next_97 = __ListIterator_Iterator.next(__ring_iter_97);
    if (__ring_next_97._tag === "none") break;
    const arm = __ring_next_97._0;
    __ring_match221: {
      const __ring_m221 = arm.guard;
  ...
  __ring_match222: {
    const __ring_m222 = enum_name;
    if (__ring_m222._tag === "some") {
      const ename = __ring_m222._0;
      __ring_match223: {
        const __ring_m223 = _Map_get(ctx.enum_types, ename);
        if (__ring_m223._tag === "some") {
          ...
          let phi_bbs = [];
          let has_wildcard = false;
          const __ring_iter_98 = __List_Iterable.iter(arms);
          while (true) {
            const __ring_next_98 = __ListIterator_Iterator.next(__ring_iter_98);
            if (__ring_next_98._tag === "none") break;
            const arm = __ring_next_98._0;
            let __ring_blk53;
            __ring_match224: {
              const __ring_m224 = arm.pattern;
...
function gen_index_expr(ctx, receiver, index, ty) {
  ...
  let __ring_blk54;
  __ring_match225: {
    const __ring_m225 = types$type_to_builtin_name(recv_type);
    if (__ring_m225._tag === "some") {
      const n = __ring_m225._0;
      __ring_blk54 = n;
      break __ring_match225;
    }
    if (__ring_m225._tag === "none") {
      __ring_blk54 = "Unknown";
      break __ring_match225;
    }
    __match_fail(__ring_m225);
  }
  const type_name = __ring_blk54;
...
function gen_if_expr(ctx, condition, then_branch, else_branch) {
  ...
  __ring_match226: {
    ...
    if (__ring_m226._tag === "none") {
      __ring_blk55 = panic("LLVM codegen: if expr outside function");
      break __ring_match226;
    }
    __match_fail(__ring_m226);
  }
  const current_fn = __ring_blk55;
  ...
  let __ring_blk56;
  __ring_match227: {
    const __ring_m227 = else_branch;
    if (__ring_m227._tag === "some") {
      const eb = __ring_m227._0;
      __ring_blk56 = gen_llvm_expr(ctx, eb);
      break __ring_match227;
    }
    if (__ring_m227._tag === "none") {
      __ring_blk56 = LLVMConstPointerNull(ctx.ptr_type);
      break __ring_match227;
    }
    __match_fail(__ring_m227);
  }
  const else_val = __ring_blk56;
...
function build_handler_evidence(ctx, effect_name, hs) {
  let __ring_blk57;
  __ring_match228: {
    const __ring_m228 = _Map_get(ctx.effect_ops, effect_name);
    if (__ring_m228._tag === "some") {
      const ops = __ring_m228._0;
      __ring_blk57 = List_len(ops);
      break __ring_match228;
    }
    if (__ring_m228._tag === "none") {
      __ring_blk57 = List_len(hs);
      break __ring_match228;
    }
    __match_fail(__ring_m228);
  }
  const n_slots = __ring_blk57;
  ...
  __ring_match229: {
    const __ring_m229 = _Map_get(ctx.effect_ops, effect_name);
    if (__ring_m229._tag === "some") {
      const all_ops = __ring_m229._0;
      const __ring_iter_103 = __List_Iterable.iter(all_ops);
      while (true) {
        const __ring_next_103 = __ListIterator_Iterator.next(__ring_iter_103);
        if (__ring_next_103._tag === "none") break;
        const op = __ring_next_103._0;
        if ((op.has_default ? (!_Set_contains(handled_ops, op.name, __Str_Eq)) : false)) {
          __ring_match230: {
            const __ring_m230 = op.default_body;
            if (__ring_m230._tag === "some") {
              const dbody = __ring_m230._0;
...
function gen_handle_expr(ctx, body, handlers) {
  ...
  const __ring_iter_104 = __List_Iterable.iter(handlers);
  while (true) {
    const __ring_next_104 = __ListIterator_Iterator.next(__ring_iter_104);
    if (__ring_next_104._tag === "none") break;
    const h = __ring_next_104._0;
    __ring_match231: {
      const __ring_m231 = _Map_get(by_effect, h.effect_name);
      if (__ring_m231._tag === "some") {
        const existing = __ring_m231._0;
  ...
  while (true) {
    ...
    __ring_match232: {
      const __ring_m232 = _Map_get(ctx.named_values, ev_name);
      if (__ring_m232._tag === "some") {
        const outer_alloca = __ring_m232._0;
  ...
  if (has_fail_abort) {
    let __ring_blk58;
    __ring_match233: {
      const __ring_m233 = ctx.current_fn;
      if (__ring_m233._tag === "some") {
        const f = __ring_m233._0;
        __ring_blk58 = f;
        break __ring_match233;
      }
      if (__ring_m233._tag === "none") {
        __ring_blk58 = panic("LLVM codegen: handle expr outside function");
        break __ring_match233;
      }
...
function gen_field_access(ctx, receiver, field, ty) {
  ...
  const recv_type = hir$hexpr_type(receiver);
  __ring_match234: {
    const __ring_m234 = recv_type;
    if (__ring_m234._tag === "TupleType") {
      let __ring_blk59;
      __ring_match235: {
        const __ring_m235 = parse_int(field);
        ...
        if (__ring_m235._tag === "none") {
          __ring_blk59 = panic(`LLVM codegen: non-numeric tuple field: ${field}`);
          break __ring_match235;
        }
        __match_fail(__ring_m235);
      }
      const field_idx = __ring_blk59;
      const get_fn = codegen_llvm_ctx$get_or_declare_runtime_fn(ctx, "ring_list_get", [ctx.ptr_type, ctx.i64_type], ctx.ptr_type);
      const get_ty = codegen_llvm_ctx$get_rt_fn_type(ctx, "ring_list_get");
  ...
  let __ring_blk60;
  __ring_match236: {
    const __ring_m236 = recv_type;
    if (__ring_m236._tag === "StructType") {
      const name = __ring_m236.name;
      __ring_blk60 = name;
      break __ring_match236;
    }
    if (__ring_m236._tag === "EnumType") {
      const name = __ring_m236.name;
      __ring_blk60 = name;
      break __ring_match236;
    }
    __ring_blk60 = panic(`LLVM codegen: field access on non-struct type: ${types$type_to_string(recv_type)}, field: ${field}`);
    break __ring_match236;
  }
  const type_name = __ring_blk60;
  __ring_match237: {
    const __ring_m237 = _Map_get(ctx.struct_types, type_name);
    if (__ring_m237._tag === "some") {
      const info = __ring_m237._0;
      let field_idx = (-1);
      const __ring_end109 = List_len(info.field_names);
  ...
  if (((effect_name === "fail") ? (op_name === "raise") : false)) {
    ...
    __ring_match238: {
      ...
      if (__ring_m238._tag === "none") {
        __ring_blk61 = panic("LLVM codegen: effect op outside function");
        break __ring_match238;
      }
      __match_fail(__ring_m238);
    }
    const current_fn_val = __ring_blk61;
    ...
    __ring_match239: {
      ...
      if (__ring_m239._tag === "some") {
        ...
        __ring_blk62 = List_len(ops);
        break __ring_match239;
      }
      if (__ring_m239._tag === "none") {
        __ring_blk62 = (slot_idx + 1);
        break __ring_match239;
      }
      __match_fail(__ring_m239);
    }
    const n_slots = __ring_blk62;
    const idx = ((slot_idx >= 0) ? slot_idx : 0);
    let slot_types = [ctx.i64_type];
    const __ring_end112 = n_slots;
    for (let i = 0; i < __ring_end112; i++) {
      List_push(slot_types, ctx.ptr_type);
    }
    const ev_ty = LLVMStructTypeInContext(ctx.context, slot_types, 0);
...
function gen_mut_arg_llvm(ctx, arg) {
  __ring_match240: {
    const __ring_m240 = arg;
    if (__ring_m240._tag === "Ident") {
      const name = __ring_m240.name; const resolved_name = __ring_m240.resolved_name; const def_id = __ring_m240.def_id;
      if (is_boxed_def(ctx, def_id)) {
        ...
        const lookup_name = __ring_blk63;
        __ring_match242: {
          const __ring_m242 = _Map_get(ctx.named_values, lookup_name);
          if (__ring_m242._tag === "some") {
            const alloca = __ring_m242._0;
          ...
          if (__ring_m242._tag === "none") {
            __ring_match243: {
              const __ring_m243 = _Map_get(ctx.named_values, name);
              if (__ring_m243._tag === "some") {
                const alloca = __ring_m243._0;
                return LLVMBuildLoad2(ctx.builder, ctx.ptr_type, alloca, codegen_llvm_ctx$fresh_name(ctx, "mcell"));
...
function gen_dict_dispatch_call(ctx, callee, args, dd) {
  ...
  __ring_match244: {
    const __ring_m244 = callee;
    if (__ring_m244._tag === "FieldAccess") {
      const receiver = __ring_m244.receiver;
      recv_val = Option_some(gen_llvm_expr(ctx, receiver));
      break __ring_match244;
    }
    __ring_match245: {
      const __ring_m245 = List_get(args, 0);
      if (__ring_m245._tag === "some") {
        const a = __ring_m245._0;
  ...
  let call_args = [];
  __ring_match246: {
    const __ring_m246 = recv_val;
    if (__ring_m246._tag === "some") {
      const rv = __ring_m246._0;
  ...
  const __ring_end113 = List_len(args);
  for (let i = other_arg_start; i < __ring_end113; i++) {
    __ring_match247: {
      const __ring_m247 = List_get(args, i);
      if (__ring_m247._tag === "some") {
        const a = __ring_m247._0;
  ...
  let __ring_blk64;
  __ring_match248: {
    const __ring_m248 = _Map_get(ctx.named_values, dd.dict_param);
    if (__ring_m248._tag === "some") {
      const dict_alloca = __ring_m248._0;
      __ring_blk64 = LLVMBuildLoad2(ctx.builder, ctx.ptr_type, dict_alloca, codegen_llvm_ctx$fresh_name(ctx, "dp"));
      break __ring_match248;
    }
    if (__ring_m248._tag === "none") {
      __ring_blk64 = resolve_static_dict_by_name(ctx, dd.dict_param);
      break __ring_match248;
    }
    __match_fail(__ring_m248);
  }
  const dict_ptr = __ring_blk64;
...
function gen_call(ctx, callee, args, resolved_dicts, dict_dispatch, result_ty, effects) {
  __ring_match249: {
    const __ring_m249 = dict_dispatch;
    if (__ring_m249._tag === "some") {
      const dd = __ring_m249._0;
  ...
  let arg_vals = [];
  let argi = 0;
  const __ring_iter_114 = __List_Iterable.iter(args);
  while (true) {
    const __ring_next_114 = __ListIterator_Iterator.next(__ring_iter_114);
    if (__ring_next_114._tag === "none") break;
    const a = __ring_next_114._0;
    let __ring_blk65;
    __ring_match250: {
      const __ring_m250 = mut_flags;
      if (__ring_m250._tag === "some") {
        const flags = __ring_m250._0;
        let __ring_blk66;
        __ring_match251: {
          const __ring_m251 = List_get(flags, argi);
          if (__ring_m251._tag === "some") {
            const f = __ring_m251._0;
            __ring_blk66 = f;
  ...
  let __ring_blk67;
  __ring_match252: {
    const __ring_m252 = callee;
    if (__ring_m252._tag === "Ident") {
      const name = __ring_m252.name; const resolved_name = __ring_m252.resolved_name;
      let __ring_blk68;
      __ring_match253: {
      ...
      __ring_blk67 = gen_direct_call(ctx, final_name, arg_vals, dict_vals);
      break __ring_match252;
    }
    if (__ring_m252._tag === "FieldAccess") {
      const receiver = __ring_m252.receiver; const field = __ring_m252.field;
      const recv_val = gen_llvm_expr(ctx, receiver);
      const recv_type = hir$hexpr_type(receiver);
      __ring_blk67 = gen_method_call(ctx, recv_val, recv_type, field, arg_vals, dict_vals);
      break __ring_match252;
    }
    const closure_val = gen_llvm_expr(ctx, callee);
    __ring_blk67 = gen_closure_call(ctx, closure_val, arg_vals);
    break __ring_match252;
  }
  const raw = __ring_blk67;
  if (is_unit_type(result_ty)) {
    return LLVMConstPointerNull(ctx.ptr_type);
  }
  return raw;
...
function gen_ord_dispatch_llvm(ctx, op, left, right, dispatch) {
  ...
  let __ring_blk69;
  __ring_match257: {
    const __ring_m257 = op;
    if (__ring_m257._tag === "Lt") {
      __ring_blk69 = 40;
      break __ring_match257;
    }
    if (__ring_m257._tag === "Lte") {
      __ring_blk69 = 41;
      break __ring_match257;
    }
    if (__ring_m257._tag === "Gt") {
      __ring_blk69 = 38;
      break __ring_match257;
    }
    if (__ring_m257._tag === "Gte") {
      __ring_blk69 = 39;
      break __ring_match257;
    }
    __ring_blk69 = 32;
...
function gen_eq_dispatch_llvm(ctx, op, left, right, dispatch) {
  ...
  __ring_match258: {
    const __ring_m258 = op;
    if (__ring_m258._tag === "Neq") {
...
function gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch, result_ty) {
  ...
  const is_ord_op = __ring_blk71;
  if (is_eq_op) {
    __ring_match262: {
      const __ring_m262 = eq_dispatch;
      if (__ring_m262._tag === "some") {
        const d = __ring_m262._0;
        __ring_match263: {
          const __ring_m263 = d;
          if (__ring_m263._tag === "Builtin") {
  ...
  if (is_ord_op) {
    __ring_match264: {
      const __ring_m264 = ord_dispatch;
      if (__ring_m264._tag === "some") {
        const d = __ring_m264._0;
        __ring_match265: {
          const __ring_m265 = d;
          if (__ring_m265._tag === "Builtin") {
...
function gen_llvm_expr(ctx, expr) {
  __ring_match266: {
    const __ring_m266 = expr;
    if (__ring_m266._tag === "IntLit") {
      const value = __ring_m266.value;
      return gen_int_lit(ctx, value);
      break __ring_match266;
    }
    if (__ring_m266._tag === "FloatLit") {
      const value = __ring_m266.value;
      return gen_float_lit(ctx, value);
      break __ring_match266;
    }
    if (__ring_m266._tag === "StrLit") {
      const value = __ring_m266.value;
      return gen_str_lit(ctx, value);
      break __ring_match266;
    }
    if (__ring_m266._tag === "BoolLit") {
      const value = __ring_m266.value;
      return gen_bool_lit(ctx, value);
      break __ring_match266;
    }
    if (__ring_m266._tag === "Ident") {
      const name = __ring_m266.name; const resolved_name = __ring_m266.resolved_name; const def_id = __ring_m266.def_id; const dict_closure_dicts = __ring_m266.dict_closure_dicts; const ty = __ring_m266.ty;
      return gen_ident(ctx, name, resolved_name, def_id, dict_closure_dicts, ty);
      break __ring_match266;
    }
    if (__ring_m266._tag === "BinOp") {
      const op = __ring_m266.op; const left = __ring_m266.left; const right = __ring_m266.right; const eq_dispatch = __ring_m266.eq_dispatch; const ord_dispatch = __ring_m266.ord_dispatch; const ty = __ring_m266.ty;
      return gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch, ty);
      break __ring_match266;
    }
    if (__ring_m266._tag === "UnaryOp") {
      const op = __ring_m266.op; const operand = __ring_m266.operand; const ty = __ring_m266.ty;
      return gen_unaryop(ctx, op, operand, ty);
      break __ring_match266;
    }
    if (__ring_m266._tag === "Call") {
      const callee = __ring_m266.callee; const args = __ring_m266.args; const resolved_dicts = __ring_m266.resolved_dicts; const dict_dispatch = __ring_m266.dict_dispatch; const ty = __ring_m266.ty; const effects = __ring_m266.effects;
      return gen_call(ctx, callee, args, resolved_dicts, dict_dispatch, ty, effects);
      break __ring_match266;
    }
    if (__ring_m266._tag === "DictConstruct") {
      const base_dict = __ring_m266.base_dict; const trait_name = __ring_m266.trait_name; const inner = __ring_m266.inner;
      return build_wrapped_dict(ctx, base_dict, trait_name, inner);
      break __ring_match266;
    }
    if (__ring_m266._tag === "FieldAccess") {
      const receiver = __ring_m266.receiver; const field = __ring_m266.field; const ty = __ring_m266.ty;
      return gen_field_access(ctx, receiver, field, ty);
      break __ring_match266;
    }
    if (__ring_m266._tag === "StructLit") {
      const name = __ring_m266.name; const fields = __ring_m266.fields; const spread = __ring_m266.spread;
      return gen_struct_lit(ctx, name, fields, spread);
      break __ring_match266;
    }
    if (__ring_m266._tag === "Block") {
      const stmts = __ring_m266.stmts; const tail = __ring_m266.tail;
      return gen_block(ctx, stmts, tail);
      break __ring_match266;
    }
    if (__ring_m266._tag === "IfExpr") {
      const condition = __ring_m266.condition; const then_branch = __ring_m266.then_branch; const else_branch = __ring_m266.else_branch;
      return gen_if_expr(ctx, condition, then_branch, else_branch);
      break __ring_match266;
    }
    if (__ring_m266._tag === "StringInterp") {
      const parts = __ring_m266.parts;
      return gen_string_interp(ctx, parts);
      break __ring_match266;
    }
    if (__ring_m266._tag === "Lambda") {
      const params = __ring_m266.params; const return_type = __ring_m266.return_type; const body = __ring_m266.body; const ty = __ring_m266.ty;
      return gen_lambda(ctx, params, return_type, body, ty);
      break __ring_match266;
    }
    if (__ring_m266._tag === "MatchExpr") {
      const scrutinee = __ring_m266.scrutinee; const arms = __ring_m266.arms; const ty = __ring_m266.ty;
      return gen_match_expr(ctx, scrutinee, arms, ty);
      break __ring_match266;
    }
    if (__ring_m266._tag === "NamedVariantConstruct") {
      const enum_name = __ring_m266.enum_name; const variant_name = __ring_m266.variant_name; const fields = __ring_m266.fields; const spread = __ring_m266.spread;
      return gen_named_variant_construct(ctx, enum_name, variant_name, fields, spread);
      break __ring_match266;
    }
    if (__ring_m266._tag === "TryCatch") {
      const body = __ring_m266.body; const arms = __ring_m266.arms;
      return gen_try_catch(ctx, body, arms);
      break __ring_match266;
    }
    if (__ring_m266._tag === "HandleExpr") {
      const body = __ring_m266.body; const handlers = __ring_m266.handlers;
      return gen_handle_expr(ctx, body, handlers);
      break __ring_match266;
    }
    if (__ring_m266._tag === "EffectOp") {
      const effect_name = __ring_m266.effect_name; const op_name = __ring_m266.op_name; const args = __ring_m266.args;
      return gen_effect_op(ctx, effect_name, op_name, args);
      break __ring_match266;
    }
    if (__ring_m266._tag === "RangeExpr") {
      const start = __ring_m266.start; const end = __ring_m266.end; const inclusive = __ring_m266.inclusive;
      return gen_range_expr(ctx, start, end, inclusive);
      break __ring_match266;
    }
    if (__ring_m266._tag === "ListLit") {
      const elements = __ring_m266.elements;
      return gen_list_lit(ctx, elements);
      break __ring_match266;
    }
    if (__ring_m266._tag === "TupleLit") {
      const elements = __ring_m266.elements;
      return gen_tuple_lit(ctx, elements);
      break __ring_match266;
    }
    if (__ring_m266._tag === "IndexExpr") {
      const receiver = __ring_m266.receiver; const index = __ring_m266.index; const ty = __ring_m266.ty;
      return gen_index_expr(ctx, receiver, index, ty);
      break __ring_match266;
    }
    if (__ring_m266._tag === "Clone") {
      const inner = __ring_m266.inner;
      return gen_clone(ctx, inner);
      break __ring_match266;
    }
    if (__ring_m266._tag === "ReturnExpr") {
      const value = __ring_m266.value;
      __ring_match267: {
        const __ring_m267 = value;
        if (__ring_m267._tag === "some") {
          const v = __ring_m267._0;
      ...
      __ring_match268: {
        const __ring_m268 = ctx.current_fn;
        if (__ring_m268._tag === "some") {
          const f = __ring_m268._0;
...
function gen_lambda(ctx, params, return_type, body, ty) {
  ...
  __ring_match269: {
    ...
    if (__ring_m269._tag === "none") {
      __ring_blk72 = panic("LLVM codegen: lambda outside function");
      break __ring_match269;
    }
    __match_fail(__ring_m269);
  }
  const current_fn = __ring_blk72;
  ...
  const __ring_end118 = List_len(captures);
  for (let i = 0; i < __ring_end118; i++) {
    __ring_match270: {
      const __ring_m270 = List_get(captures, i);
      if (__ring_m270._tag === "some") {
        const cap_name = __ring_m270._0;
  ...
  const __ring_end119 = List_len(params);
  for (let i = 0; i < __ring_end119; i++) {
    __ring_match271: {
      const __ring_m271 = List_get(params, i);
      if (__ring_m271._tag === "some") {
        const p = __ring_m271._0;
  ...
  const __ring_end120 = List_len(captures);
  for (let i = 0; i < __ring_end120; i++) {
    __ring_match272: {
      const __ring_m272 = List_get(captures, i);
      if (__ring_m272._tag === "some") {
        const cap_name = __ring_m272._0;
        let __ring_blk73;
        __ring_match273: {
          const __ring_m273 = _Map_get(ctx.named_values, cap_name);
          if (__ring_m273._tag === "some") {
            const alloca = __ring_m273._0;
            __ring_blk73 = LLVMBuildLoad2(ctx.builder, ctx.ptr_type, alloca, codegen_llvm_ctx$fresh_name(ctx, "cv"));
            break __ring_match273;
          }
          if (__ring_m273._tag === "none") {
            __ring_blk73 = LLVMConstPointerNull(ctx.ptr_type);
            break __ring_match273;
          }
          __match_fail(__ring_m273);
        }
        const cap_val = __ring_blk73;
...
function build_default_evidence_all(ctx) {
  let effect_names = [];
  const __ring_iter_121 = __List_Iterable.iter(_Map_entries(ctx.effect_ops));
  while (true) {
  ...
  const __ring_iter_123 = __List_Iterable.iter(effect_names);
  while (true) {
    const __ring_next_123 = __ListIterator_Iterator.next(__ring_iter_123);
    if (__ring_next_123._tag === "none") break;
    const ename = __ring_next_123._0;
    __ring_match274: {
      const __ring_m274 = _Map_get(ctx.effect_ops, ename);
      if (__ring_m274._tag === "some") {
        const ops = __ring_m274._0;
        const n_slots = List_len(ops);
        let slot_types = [ctx.i64_type];
        const __ring_end124 = n_slots;
...
function emit_memoised_dict_getter(ctx, name, build_fn, build_fn_ty) {
  const fname = `ring_dict_init_${name}`;
  __ring_match276: {
    const __ring_m276 = _Map_get(ctx.functions, fname);
    if (__ring_m276._tag === "some") {
      const existing = __ring_m276._0;
      return existing;
