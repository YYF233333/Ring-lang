...
function gen_expr(ctx, expr) {
  __ring_match0: {
    ...
    if (__ring_m0._tag === "Ident") {
      const name = __ring_m0.name; const resolved_name = __ring_m0.resolved_name; const ty = __ring_m0.ty; const dict_closure_dicts = __ring_m0.dict_closure_dicts;
  ...
  __match_fail(__ring_m);
      ...
      __ring_match1: {
        const __ring_m1 = dict_closure_dicts;
        if (__ring_m1._tag === "some") {
          const dicts = __ring_m1._0;
          if ((List_len(dicts) > 0)) {
            __ring_match2: {
              const __ring_m2 = ty;
              if (__ring_m2._tag === "FnType") {
                const params = __ring_m2.params; const effects = __ring_m2.effects;
                let p_names = [""];
                List_clear(p_names);
    ...
    if (__ring_m0._tag === "BinOp") {
      const op = __ring_m0.op; const left = __ring_m0.left; const right = __ring_m0.right; const eq_dispatch = __ring_m0.eq_dispatch; const ord_dispatch = __ring_m0.ord_dispatch; const ty = __ring_m0.ty;
      return gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch);
      break __ring_match0;
    }
    if (__ring_m0._tag === "UnaryOp") {
      const op = __ring_m0.op; const operand = __ring_m0.operand;
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m0._tag === "Call") {
      const callee = __ring_m0.callee; const args = __ring_m0.args; const type_args = __ring_m0.type_args; const resolved_dicts = __ring_m0.resolved_dicts; const dict_dispatch = __ring_m0.dict_dispatch;
      return gen_call(ctx, callee, args, resolved_dicts, dict_dispatch);
      break __ring_match0;
    }
    if (__ring_m0._tag === "FieldAccess") {
      const receiver = __ring_m0.receiver; const field = __ring_m0.field;
      const r = gen_expr(ctx, receiver);
      return `${r}.${field}`;
      break __ring_match0;
    }
    if (__ring_m0._tag === "StructLit") {
      const name = __ring_m0.name; const fields = __ring_m0.fields; const spread = __ring_m0.spread;
      return gen_struct_lit(ctx, name, fields, spread);
      break __ring_match0;
    }
    if (__ring_m0._tag === "NamedVariantConstruct") {
      const enum_name = __ring_m0.enum_name; const variant_name = __ring_m0.variant_name; const fields = __ring_m0.fields; const spread = __ring_m0.spread; const ty = __ring_m0.ty;
    ...
    if (__ring_m0._tag === "StringInterp") {
      const parts = __ring_m0.parts;
      return gen_string_interp(ctx, parts);
      break __ring_match0;
    }
    if (__ring_m0._tag === "TryCatch") {
      const body = __ring_m0.body; const error_binding = __ring_m0.error_binding; const error_type = __ring_m0.error_type; const handler = __ring_m0.handler;
      return gen_try_catch(ctx, body, error_binding, error_type, handler);
      break __ring_match0;
    }
    if (__ring_m0._tag === "HandleExpr") {
      const body = __ring_m0.body; const handlers = __ring_m0.handlers;
      return gen_handle(ctx, body, handlers);
      break __ring_match0;
    }
    if (__ring_m0._tag === "Lambda") {
      const params = __ring_m0.params; const body = __ring_m0.body; const ty = __ring_m0.ty;
      return gen_lambda(ctx, params, body, ty);
      break __ring_match0;
    }
    if (__ring_m0._tag === "EffectOp") {
      const effect_name = __ring_m0.effect_name; const op_name = __ring_m0.op_name; const args = __ring_m0.args;
    ...
    if (__ring_m0._tag === "OptionUnwrap") {
      const inner = __ring_m0.expr;
      return gen_option_unwrap(ctx, inner);
      break __ring_match0;
    }
    if (__ring_m0._tag === "TryBlock") {
      const body = __ring_m0.body;
      return gen_try_block(ctx, body);
      break __ring_match0;
    }
    if (__ring_m0._tag === "OptionOr") {
      const inner = __ring_m0.expr; const default_value = __ring_m0.default_value;
      const e = gen_expr(ctx, inner);
      const d = gen_expr(ctx, default_value);
    ...
    if (__ring_m0._tag === "RangeExpr") {
      const start = __ring_m0.start; const end = __ring_m0.end;
...
function gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch) {
  let eq_result = try_eq_dispatch(ctx, op, left, right, eq_dispatch);
  if ((Str_len(eq_result) > 0)) {
    return eq_result;
  }
  let ord_result = try_ord_dispatch(ctx, op, left, right, ord_dispatch);
  if ((Str_len(ord_result) > 0)) {
    return ord_result;
  }
...
function try_eq_dispatch(ctx, op, left, right, eq_dispatch) {
  __ring_match3: {
    const __ring_m3 = eq_dispatch;
    if (__ring_m3._tag === "some") {
      const dispatch = __ring_m3._0;
...
function try_ord_dispatch(ctx, op, left, right, ord_dispatch) {
  __ring_match4: {
    const __ring_m4 = ord_dispatch;
    if (__ring_m4._tag === "some") {
      const dispatch = __ring_m4._0;
...
function binop_str(op) {
  __ring_match5: {
    const __ring_m5 = op;
    if (__ring_m5._tag === "Add") {
      return "+";
      break __ring_match5;
    }
    if (__ring_m5._tag === "Sub") {
      return "-";
      break __ring_match5;
    }
    if (__ring_m5._tag === "Mul") {
      return "*";
      break __ring_match5;
    }
    if (__ring_m5._tag === "Div") {
      return "/";
      break __ring_match5;
    }
    if (__ring_m5._tag === "Mod") {
      return "%";
      break __ring_match5;
    }
    if (__ring_m5._tag === "Eq") {
      return "===";
      break __ring_match5;
    }
    if (__ring_m5._tag === "Neq") {
      return "!==";
      break __ring_match5;
    }
    if (__ring_m5._tag === "Lt") {
      return "<";
      break __ring_match5;
    }
    if (__ring_m5._tag === "Lte") {
      return "<=";
      break __ring_match5;
    }
    if (__ring_m5._tag === "Gt") {
      return ">";
      break __ring_match5;
    }
    if (__ring_m5._tag === "Gte") {
      return ">=";
      break __ring_match5;
    }
    if (__ring_m5._tag === "And") {
      return "&&";
      break __ring_match5;
    }
    if (__ring_m5._tag === "Or") {
      return "||";
      break __ring_match5;
    }
...
function gen_eq_dispatch(ctx, op, left, right, dispatch) {
  ...
  __ring_match6: {
    const __ring_m6 = dispatch;
    if (__ring_m6._tag === "Builtin") {
      if (is_ne) {
        return `(${l} !== ${r})`;
      } else {
        return `(${l} === ${r})`;
    ...
    if (__ring_m6._tag === "Direct") {
      const dict = __ring_m6.dict; const extra_dicts = __ring_m6.extra_dicts;
    ...
    if (__ring_m6._tag === "Dict") {
      const param = __ring_m6.param;
...
function gen_ord_dispatch(ctx, op, left, right, dispatch) {
  ...
  const r = gen_expr(ctx, right);
  __ring_match7: {
    const __ring_m7 = dispatch;
    if (__ring_m7._tag === "Builtin") {
      const op_str = binop_str(op);
      return `(${l} ${op_str} ${r})`;
      break __ring_match7;
    }
    if (__ring_m7._tag === "Direct") {
      const dict = __ring_m7.dict; const extra_dicts = __ring_m7.extra_dicts;
      const d = codegen_ctx$qualify(ctx, dict);
      const extra = extra_dicts_str(extra_dicts);
    ...
    if (__ring_m7._tag === "Dict") {
      const param = __ring_m7.param;
      const cmp_call = `${param}.cmp(${l}, ${r})`;
      __ring_match9: {
        const __ring_m9 = op;
        if (__ring_m9._tag === "Lt") {
          return `(${cmp_call} < 0)`;
          break __ring_match9;
        }
        if (__ring_m9._tag === "Lte") {
          return `(${cmp_call} <= 0)`;
          break __ring_match9;
        }
        if (__ring_m9._tag === "Gt") {
          return `(${cmp_call} > 0)`;
          break __ring_match9;
        }
        if (__ring_m9._tag === "Gte") {
          return `(${cmp_call} >= 0)`;
          break __ring_match9;
        }
        return `(${l} ${binop_str(op)} ${r})`;
...
function get_callee_evidence_args(ctx, callee_type, callee_name) {
  __ring_match10: {
    const __ring_m10 = callee_type;
    if (__ring_m10._tag === "FnType") {
      const effects = __ring_m10.effects;
  ...
  __ring_match11: {
    const __ring_m11 = callee_name;
    if (__ring_m11._tag === "some") {
      const cn = __ring_m11._0;
      __ring_match12: {
        const __ring_m12 = _Map_get(ctx.local_fn_effects, cn);
        if (__ring_m12._tag === "some") {
          const actual_effects = __ring_m12._0;
          if ((List_len(actual_effects.effects) > 0)) {
            let caller_effect_names = set_new();
            __ring_match13: {
              const __ring_m13 = ctx.current_fn_effects;
              if (__ring_m13._tag === "some") {
                const cfe = __ring_m13._0;
                for (const e of cfe.effects) {
                  _Set_insert(caller_effect_names, callee_eff_name(e));
                }
            ...
            for (const e of actual_effects.effects) {
              if (_Set_contains(caller_effect_names, callee_eff_name(e))) {
                List_push(needed, e);
              }
            }
...
function callee_eff_name(e) {
  __ring_match14: {
    ...
    if (__ring_m14._tag === "CustomEffect") {
...
function gen_call(ctx, callee, args, resolved_dicts, dict_dispatch) {
  __ring_match15: {
    const __ring_m15 = dict_dispatch;
    if (__ring_m15._tag === "some") {
      const dd = __ring_m15._0;
  ...
  __ring_match16: {
    const __ring_m16 = callee;
    if (__ring_m16._tag === "FieldAccess") {
      const receiver = __ring_m16.receiver; const field = __ring_m16.field; const callee_type = __ring_m16.ty;
      const recv_type = get_expr_type(receiver);
      const method = field;
      __ring_match17: {
        const __ring_m17 = recv_type;
        if (__ring_m17._tag === "StructType") {
          const name = __ring_m17.name;
          if ((name === hir$BUILTIN_LIST())) {
            __ring_match18: {
              const __ring_m18 = codegen_ctx$LIST_HOF_JS_METHOD(method);
              if (__ring_m18._tag === "some") {
                const js_method = __ring_m18._0;
                const r = gen_expr(ctx, receiver);
  ...
  __match_fail(__ring_m);
      ...
      __ring_match19: {
        const __ring_m19 = type_name;
        if (__ring_m19._tag === "some") {
          const tn = __ring_m19._0;
          const impl_key = `${codegen_ctx$qualify(ctx, tn)}.${method}`;
          __ring_match20: {
            const __ring_m20 = _Map_get(ctx.impl_methods, impl_key);
            if (__ring_m20._tag === "some") {
              const trait_opt = __ring_m20._0;
  ...
  const dict_str = List_join(dict_parts, ", ");
  const ev_args = get_callee_evidence_args(ctx, get_expr_type(callee), cn);
  let all_parts = [""];
...
function gen_struct_lit(ctx, name, fields, spread) {
  ...
  __ring_match21: {
    const __ring_m21 = _Map_get(ctx.struct_field_order, qname);
    if (__ring_m21._tag === "some") {
      const declared_order = __ring_m21._0;
      let field_map = map_new();
      for (const f of fields) {
        _Map_insert(field_map, f.name, f.value);
      }
      __ring_match22: {
        const __ring_m22 = spread;
        if (__ring_m22._tag === "some") {
          const sp = __ring_m22._0;
        ...
        if (__ring_m22._tag === "none") {
          ...
          for (const fn_ of declared_order) {
            __ring_match23: {
              const __ring_m23 = _Map_get(field_map, fn_);
              if (__ring_m23._tag === "some") {
                const v = __ring_m23._0;
...
function gen_named_variant_construct(ctx, enum_name, variant_name, fields, spread, ty) {
  ...
  __ring_match27: {
    ...
    if (__ring_m27._tag === "EnumType") {
      const variants = __ring_m27.variants;
              ...
              __ring_match29: {
                ...
                if (__ring_m29._tag === "none") {
                  ...
                  for (const n of fnames) {
                    __ring_match30: {
                      const __ring_m30 = _Map_get(field_map, n);
                      if (__ring_m30._tag === "some") {
                        const v_ = __ring_m30._0;
...
function gen_match(ctx, scrutinee, arms) {
  ...
  for (const a of arms) {
    __ring_match32: {
      const __ring_m32 = a.pattern;
      if (__ring_m32._tag === "Wildcard") {
        __ring_match33: {
          const __ring_m33 = a.guard;
    ...
    if (__ring_m36._tag === "some") {
      ...
      __ring_match37: {
        ...
        if (__ring_m37._tag === "IfExpr") {
          const ec = __ring_m37.condition; const et = __ring_m37.then_branch; const ee = __ring_m37.else_branch;
...
function gen_option_unwrap(ctx, inner) {
  const e = gen_expr(ctx, inner);
  ...
  List_push(p, " : ");
  List_push(p, ev);
  List_push(p, ".raise(undefined))(");
  List_push(p, e);
  List_push(p, ")");
  return List_join(p, "");
}

function gen_try_block(ctx, body) {
  ...
  const stag = hir$OPTION_SOME_TAG();
  const ntag = hir$OPTION_NONE_TAG();
  const pf = hir$OPTION_PAYLOAD_FIELD();
...
function gen_try_catch(ctx, body, error_binding, error_type, handler) {
  ...
  ctx.in_try_fail = saved_in_try;
  const handler_js = gen_expr(ctx, handler);
  if ((body_has_fail === false)) {
    return body_js;
  }
  const ev = hir$evidence_param_name("fail");
  const ea = hir$RUNTIME_EFFECT_ABORT();
  const q = "\"";
  __ring_match41: {
    const __ring_m41 = error_binding;
    if (__ring_m41._tag === "some") {
      const binding = __ring_m41._0;
      const sb = codegen_ctx$safe_ident(binding);
      __ring_match42: {
        const __ring_m42 = error_type;
        if (__ring_m42._tag === "some") {
          const et = __ring_m42._0;
          const type_name = codegen_ctx$qualify(ctx, codegen_ctx$safe_ident(et));
          return gen_typed_try_catch(ev, ea, sb, body_js, handler_js, type_name, q);
          break __ring_match42;
        }
        if (__ring_m42._tag === "none") {
          return gen_untyped_try_catch_with_binding(ev, ea, sb, body_js, handler_js, q);
          break __ring_match42;
        }
    ...
    if (__ring_m41._tag === "none") {
      return gen_untyped_try_catch(ev, ea, body_js, handler_js, q);
      break __ring_match41;
    }
...
function gen_typed_try_catch(ev, ea, sb, body_js, handler_js, type_name, q) {
  let p = [""];
  List_clear(p);
  List_push(p, "(function() { const ");
  List_push(p, ev);
  ...
  List_push(p, "fail");
  List_push(p, q);
  List_push(p, " && __ring_e.value instanceof ");
  List_push(p, type_name);
  List_push(p, ") { const ");
  List_push(p, sb);
  List_push(p, " = __ring_e.value; return ");
  List_push(p, handler_js);
  List_push(p, "; } throw __ring_e; } })()");
  return List_join(p, "");
}

function gen_untyped_try_catch_with_binding(ev, ea, sb, body_js, handler_js, q) {
  let p = [""];
  List_clear(p);
  List_push(p, "(function() { const ");
  List_push(p, ev);
...
function gen_untyped_try_catch(ev, ea, body_js, handler_js, q) {
  let p = [""];
  List_clear(p);
  List_push(p, "(function() { const ");
  List_push(p, ev);
  ...
  List_push(p, "fail");
  List_push(p, q);
  List_push(p, ", undefined); } }; try { return ");
  List_push(p, body_js);
  List_push(p, "; } catch (__ring_e) { if (__ring_e instanceof ");
  List_push(p, ea);
  List_push(p, " && __ring_e.effect === ");
...
function has_fail_effect(expr) {
  __ring_match43: {
    ...
    if (__ring_m43._tag === "IntLit") {
      const effects = __ring_m43.effects;
    ...
    if (__ring_m43._tag === "OptionUnwrap") {
      const effects = __ring_m43.effects;
      return check_fail(effects);
      break __ring_match43;
    }
    if (__ring_m43._tag === "TryBlock") {
      const effects = __ring_m43.effects;
      return check_fail(effects);
      break __ring_match43;
    }
    if (__ring_m43._tag === "OptionOr") {
      const effects = __ring_m43.effects;
      return check_fail(effects);
      break __ring_match43;
    }
...
function gen_handle(ctx, body, handlers) {
  ...
  for (const h of handlers) {
    __ring_match45: {
      const __ring_m45 = _Map_get(by_effect, h.effect_name);
      if (__ring_m45._tag === "some") {
        const existing = __ring_m45._0;
...
function gen_handle_body(ctx, expr, ev_params) {
  __ring_match46: {
    const __ring_m46 = expr;
    if (__ring_m46._tag === "Block") {
      const stmts = __ring_m46.stmts; const tail = __ring_m46.tail;
      __ring_match47: {
...
function gen_lambda_capture_evidence(ctx, args, idx) {
  __ring_match49: {
    const __ring_m49 = List_get(args, idx);
    if (__ring_m49._tag === "some") {
      const arg = __ring_m49._0;
      __ring_match50: {
        const __ring_m50 = arg;
        if (__ring_m50._tag === "Lambda") {
          const params = __ring_m50.params; const body = __ring_m50.body;
          let p_names = [""];
          List_clear(p_names);
          for (const p of params) {
            List_push(p_names, codegen_ctx$safe_ident(p.name));
        ...
        const arg_type = get_expr_type(arg);
        __ring_match51: {
          const __ring_m51 = arg_type;
          if (__ring_m51._tag === "FnType") {
            const params = __ring_m51.params;
...
function get_expr_type(e) {
  __ring_match52: {
    const __ring_m52 = e;
    if (__ring_m52._tag === "IntLit") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "FloatLit") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "StrLit") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "BoolLit") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    ...
    if (__ring_m52._tag === "BinOp") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "UnaryOp") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "Call") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    ...
    if (__ring_m52._tag === "StructLit") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "NamedVariantConstruct") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    ...
    if (__ring_m52._tag === "StringInterp") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "TryCatch") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "HandleExpr") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    ...
    if (__ring_m52._tag === "EffectOp") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "OptionUnwrap") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "TryBlock") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "OptionOr") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "RangeExpr") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "ListLit") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
    if (__ring_m52._tag === "TupleLit") {
      const ty = __ring_m52.ty;
      return ty;
      break __ring_match52;
    }
