...
import { emit_block_body as codegen_stmt$emit_block_body, emit_block_in_stmt_context as codegen_stmt$emit_block_in_stmt_context, emit_in_stmt_context as codegen_stmt$emit_in_stmt_context, emit_stmt as codegen_stmt$emit_stmt, gen_pattern_bindings as codegen_stmt$gen_pattern_bindings, gen_pattern_condition as codegen_stmt$gen_pattern_condition, gen_stmt_inline as codegen_stmt$gen_stmt_inline, pattern_is_catchall as codegen_stmt$pattern_is_catchall } from "./codegen_stmt.js";
...
class HofIterShape {
  constructor(container_var, binding, cb_args, result_ctor, result_add) {
    this.container_var = container_var;
    this.binding = binding;
    this.cb_args = cb_args;
    this.result_ctor = result_ctor;
    this.result_add = result_add;
  }
}
...
function binop_str(op) {
  __ring_match6: {
    const __ring_m6 = op;
    if (__ring_m6._tag === "Add") {
      return "+";
      break __ring_match6;
    }
    if (__ring_m6._tag === "Sub") {
      return "-";
      break __ring_match6;
    }
    if (__ring_m6._tag === "Mul") {
      return "*";
      break __ring_match6;
    }
    if (__ring_m6._tag === "Div") {
      return "/";
      break __ring_match6;
    }
    if (__ring_m6._tag === "Mod") {
      return "%";
      break __ring_match6;
    }
    if (__ring_m6._tag === "Eq") {
      return "===";
      break __ring_match6;
    }
    if (__ring_m6._tag === "Neq") {
      return "!==";
      break __ring_match6;
    }
    if (__ring_m6._tag === "Lt") {
      return "<";
      break __ring_match6;
    }
    if (__ring_m6._tag === "Lte") {
      return "<=";
      break __ring_match6;
    }
    if (__ring_m6._tag === "Gt") {
      return ">";
      break __ring_match6;
    }
    if (__ring_m6._tag === "Gte") {
      return ">=";
      break __ring_match6;
    }
    if (__ring_m6._tag === "And") {
      return panic("JS codegen: BinOp::And must be lowered by andor_lower");
      break __ring_match6;
    }
    if (__ring_m6._tag === "Or") {
...
function expr_contains_return(expr) {
  __ring_match7: {
    ...
    if (__ring_m7._tag === "IfExpr") {
      const condition = __ring_m7.condition; const then_branch = __ring_m7.then_branch; const else_branch = __ring_m7.else_branch;
    ...
    if (__ring_m7._tag === "MatchExpr") {
      const scrutinee = __ring_m7.scrutinee; const arms = __ring_m7.arms;
      if (expr_contains_return(scrutinee)) {
        return true;
      }
      const __ring_iter_2 = __List_Iterable.iter(arms);
      while (true) {
        const __ring_next_2 = __ListIterator_Iterator.next(__ring_iter_2);
        if (__ring_next_2._tag === "none") break;
        const arm = __ring_next_2._0;
  ...
  while (true) {
    ...
    __ring_match10: {
      ...
      if (__ring_m10._tag === "IfLet") {
        const then_block = __ring_m10.then_block; const else_block = __ring_m10.else_block;
        if (expr_contains_return(then_block)) {
          return true;
        }
        __ring_match11: {
          const __ring_m11 = else_block;
...
function wrapped_dict_js(d, trait_name, inner_strs) {
  const inner_args = List_join(inner_strs, ", ");
  __ring_match13: {
    const __ring_m13 = trait_name;
    if (__ring_m13 === "Eq") {
...
function dict_ref_to_js(ctx, dr) {
  __ring_match14: {
    const __ring_m14 = dr;
    if (__ring_m14._tag === "Simple") {
      const name = __ring_m14._0;
      return codegen_ctx$qualify(ctx, name);
      break __ring_match14;
    }
    if (__ring_m14._tag === "Static") {
      const name = __ring_m14._0;
      return codegen_ctx$qualify(ctx, name);
      break __ring_match14;
    }
    if (__ring_m14._tag === "Wrapped") {
      const dict = __ring_m14.dict; const trait_name = __ring_m14.trait_name; const inner_dicts = __ring_m14.inner_dicts;
      const d = codegen_ctx$qualify(ctx, dict);
      let inner_strs = [];
      const __ring_iter_4 = __List_Iterable.iter(inner_dicts);
      while (true) {
        const __ring_next_4 = __ListIterator_Iterator.next(__ring_iter_4);
        if (__ring_next_4._tag === "none") break;
        const inner = __ring_next_4._0;
        List_push(inner_strs, dict_ref_to_js(ctx, inner));
      }
      return wrapped_dict_js(d, trait_name, inner_strs);
      break __ring_match14;
    }
...
function get_callee_evidence_args(ctx, callee_type, callee_name) {
  __ring_match15: {
    const __ring_m15 = callee_type;
    if (__ring_m15._tag === "FnType") {
      const effects = __ring_m15.effects;
  ...
  __ring_match16: {
    const __ring_m16 = callee_name;
    if (__ring_m16._tag === "some") {
      const cn = __ring_m16._0;
      __ring_match17: {
        const __ring_m17 = _Map_get(ctx.local_fn_effects, cn);
        if (__ring_m17._tag === "some") {
          const actual_effects = __ring_m17._0;
          if ((List_len(actual_effects.effects) > 0)) {
            let caller_effect_names = set_new();
            __ring_match18: {
              const __ring_m18 = ctx.current_fn_effects;
              if (__ring_m18._tag === "some") {
                const cfe = __ring_m18._0;
                const __ring_iter_5 = __List_Iterable.iter(cfe.effects);
                while (true) {
            ...
            let needed = [];
            const __ring_iter_6 = __List_Iterable.iter(actual_effects.effects);
            while (true) {
...
function gen_hof_collect_expr(sh, element_stmt, receiver, cb) {
  const cv = sh.container_var;
  return `((${cv}, __f) => { const __r = ${sh.result_ctor}; for (const ${sh.binding} of ${cv}) ${element_stmt}; return __r; })(${receiver}, ${cb})`;
}

function map_hof_shape() {
  return new HofIterShape("__m", "[__k, __v]", "__k, __v", "new Map()", "__r.set(__k, __v)");
}

function set_hof_shape() {
  return new HofIterShape("__s", "__x", "__x", "new Set()", "__r.add(__x)");
}
...
function gen_lambda(ctx, params, body, ty) {
  let p_names = [];
  const __ring_iter_8 = __List_Iterable.iter(params);
  while (true) {
  ...
  __ring_match21: {
    const __ring_m21 = ty;
    if (__ring_m21._tag === "FnType") {
      const effects = __ring_m21.effects;
  ...
  if ((List_len(body_lines) === 0)) {
    return `(function(${all_str}) { return ${b}; })`;
  } else {
    let result = [];
    List_push(result, `(function(${all_str}) {`);
    List_extend(result, body_lines);
    List_push(result, `  return ${b};`);
    List_push(result, "})");
    return List_join(result, "\n");
  }
}
...
function gen_handle_body(ctx, expr, ev_params) {
  __ring_match22: {
    ...
    if (__ring_m22._tag === "Block") {
      const stmts = __ring_m22.stmts; const tail = __ring_m22.tail;
      __ring_match23: {
        const __ring_m23 = tail;
        if (__ring_m23._tag === "some") {
          ...
          if ((List_len(stmts) === 0)) {
            ...
            const inner_lines = ctx.lines;
            ctx.lines = saved_lines;
            ctx.indent_level = saved_indent;
            if ((List_len(inner_lines) === 0)) {
              return `(function(${ev_params}) { return ${b}; })(${ev_params})`;
            } else {
              let r = [];
              List_push(r, `(function(${ev_params}) {`);
              List_extend(r, inner_lines);
              List_push(r, `  return ${b};`);
              List_push(r, `})(${ev_params})`);
              return List_join(r, "\n");
            }
          }
...
function gen_handle(ctx, body, handlers) {
  ...
  while (true) {
    ...
    __ring_match24: {
      const __ring_m24 = _Map_get(by_effect, h.effect_name);
  ...
  const __ring_iter_10 = __List_Iterable.iter(sorted_by_effect);
  while (true) {
    ...
    while (true) {
      ...
      const saved_hb = ctx.lines;
      const saved_hbi = ctx.indent_level;
      ctx.lines = [];
      ctx.indent_level = 1;
      const b = gen_expr(ctx, h.body);
      const hb_lines = ctx.lines;
      ctx.lines = saved_hb;
      ...
      if (is_abort) {
        ...
        if ((List_len(hb_lines) > 0)) {
          let hb_parts = [];
          List_push(hb_parts, `${ev_name}.${h.op_name} = (${params_str}) => {`);
          List_extend(hb_parts, hb_lines);
          List_push(hb_parts, `  throw new ${ea}(${q}${effect_name}${q}, ${b});`);
          List_push(hb_parts, "};");
          List_push(ev_decls, List_join(hb_parts, "\n"));
        } else {
    ...
    __ring_match25: {
      const __ring_m25 = _Map_get(ctx.effect_ops, effect_name);
      if (__ring_m25._tag === "some") {
        const all_ops = __ring_m25._0;
        const __ring_iter_13 = __List_Iterable.iter(all_ops);
        while (true) {
          const __ring_next_13 = __ListIterator_Iterator.next(__ring_iter_13);
          if (__ring_next_13._tag === "none") break;
          const op = __ring_next_13._0;
          if ((op.has_default ? (!_Set_contains(handled_op_names, op.name, __Str_Eq)) : false)) {
            __ring_match26: {
              const __ring_m26 = op.default_body;
              if (__ring_m26._tag === "some") {
                const dbody = __ring_m26._0;
                let dparams = [];
                const __ring_iter_14 = __List_Iterable.iter(op.params);
                while (true) {
                ...
                const saved_db = ctx.lines;
                const saved_dbi = ctx.indent_level;
                ctx.lines = [];
                ctx.indent_level = 1;
                const db = gen_expr(ctx, dbody);
                const db_lines = ctx.lines;
                ctx.lines = saved_db;
                ctx.indent_level = saved_dbi;
                if ((List_len(db_lines) > 0)) {
                  let db_parts = [];
                  List_push(db_parts, `${ev_name}.${codegen_ctx$safe_ident(op.name)} = (${dparams_str}) => {`);
                  List_extend(db_parts, db_lines);
                  List_push(db_parts, `  return ${db};`);
                  List_push(db_parts, "};");
                  List_push(ev_decls, List_join(db_parts, "\n"));
                } else {
  ...
  let ev_param_names = [];
  let sorted_by_eff = _Map_entries(by_effect);
  sorted_by_eff.sort((function(a, b) { return ((a[0] < b[0]) ? (-1) : ((a[0] > b[0]) ? 1 : 0)); }));
  const __ring_iter_15 = __List_Iterable.iter(sorted_by_eff);
  while (true) {
  ...
  List_sort(ev_param_names, __Str_Ord);
...
function gen_try_catch(ctx, body, arms) {
  ...
  const saved_lines_body = ctx.lines;
  const saved_indent_body = ctx.indent_level;
  ctx.lines = [];
  ctx.indent_level = 2;
  const body_js = gen_expr(ctx, body);
  const body_extra_lines = ctx.lines;
  ...
  const q = "\"";
  let arm_conds = [];
  let arm_bindings_list = [];
  let arm_body_jss = [];
  let arm_body_lines_list = [];
  let arm_guard_jss = [];
  ...
  while (true) {
    ...
    const saved_a = ctx.lines;
    const saved_ai = ctx.indent_level;
    ctx.lines = [];
    ctx.indent_level = 2;
    const arm_body_js = gen_expr(ctx, arm.body);
    const arm_body_lines = ctx.lines;
    ctx.lines = saved_a;
    ...
    List_push(arm_conds, cond);
    List_push(arm_bindings_list, bindings);
    List_push(arm_body_jss, arm_body_js);
    List_push(arm_body_lines_list, arm_body_lines);
    List_push(arm_guard_jss, guard_js);
  }
  let has_extra = (List_len(body_extra_lines) > 0);
  if ((!has_extra)) {
    const __ring_iter_18 = __List_Iterable.iter(arm_body_lines_list);
    while (true) {
      const __ring_next_18 = __ListIterator_Iterator.next(__ring_iter_18);
      if (__ring_next_18._tag === "none") break;
      const abl = __ring_next_18._0;
      if ((List_len(abl) > 0)) {
        has_extra = true;
      }
    }
  ...
  if (has_extra) {
    let r = [];
    List_push(r, "(function() {");
    List_push(r, `  const ${ev} = { raise: (__ring_err) => { throw new ${ea}(${q}fail${q}, __ring_err); } };`);
    List_push(r, "  try {");
    List_extend(r, body_extra_lines);
    List_push(r, `    return ${body_js};`);
    List_push(r, "  } catch (__ring_e) {");
    List_push(r, `    if (__ring_e instanceof ${ea} && __ring_e.effect === ${q}fail${q}) {`);
    List_push(r, "      const __ring_err = __ring_e.value;");
    const __ring_end19 = List_len(arm_conds);
    for (let i = 0; i < __ring_end19; i++) {
      const lines = __ring_index(arm_body_lines_list, i);
      const cond_s = __ring_index(arm_conds, i);
      const bind_s = __ring_index(arm_bindings_list, i);
      const bodyj_s = __ring_index(arm_body_jss, i);
      const guardj_s = __ring_index(arm_guard_jss, i);
      if ((List_len(lines) > 0)) {
        List_push(r, `      if (${cond_s}${guardj_s}) {`);
        List_push(r, `        ${bind_s}`);
        List_extend(r, lines);
        List_push(r, `        return ${bodyj_s};`);
        List_push(r, "      }");
      } else {
        List_push(r, `      if (${cond_s}${guardj_s}) { ${bind_s}return ${bodyj_s}; }`);
      }
    }
    List_push(r, "      throw __ring_e;");
    List_push(r, "    }");
    List_push(r, "    throw __ring_e;");
    List_push(r, "  }");
    List_push(r, "})()");
  ...
  let arm_js = [];
  const __ring_end20 = List_len(arm_conds);
  for (let i = 0; i < __ring_end20; i++) {
    List_push(arm_js, `if (${__ring_index(arm_conds, i)}${__ring_index(arm_guard_jss, i)}) { ${__ring_index(arm_bindings_list, i)}return ${__ring_index(arm_body_jss, i)}; }`);
  }
  let p = [];
...
function gen_block_as_value(ctx, block) {
  __ring_match29: {
    const __ring_m29 = block;
    if (__ring_m29._tag === "Block") {
      const stmts = __ring_m29.stmts; const tail = __ring_m29.tail;
      __ring_match30: {
        const __ring_m30 = tail;
    ...
    if (__ring_m31._tag === "some") {
      ...
      __ring_match32: {
        ...
        if (__ring_m32._tag === "IfExpr") {
          const ec = __ring_m32.condition; const et = __ring_m32.then_branch; const ee = __ring_m32.else_branch;
  ...
  if (if_expr_contains_return(then_branch, else_branch)) {
    ...
    __ring_match33: {
      ...
      if (__ring_m33._tag === "some") {
        ...
        __ring_match34: {
          const __ring_m34 = eb;
          if (__ring_m34._tag === "IfExpr") {
            const ec = __ring_m34.condition; const et = __ring_m34.then_branch; const ee = __ring_m34.else_branch;
            codegen_ctx$emit(ctx, "}");
    ...
    if (__ring_m35._tag === "some") {
      ...
      __ring_match36: {
        ...
        if (__ring_m36._tag === "IfExpr") {
          const ec = __ring_m36.condition; const et = __ring_m36.then_branch; const ee = __ring_m36.else_branch;
...
function gen_named_variant_construct(ctx, enum_name, variant_name, fields, spread, ty) {
  ...
  __ring_match41: {
    ...
    if (__ring_m41._tag === "EnumType") {
      const variants = __ring_m41.variants;
      ...
      while (true) {
        ...
        if ((v.name === variant_name)) {
          __ring_match42: {
            const __ring_m42 = v.field_names;
            if (__ring_m42._tag === "some") {
              const fnames = __ring_m42._0;
              __ring_match43: {
                ...
                if (__ring_m43._tag === "none") {
                  let args = [];
                  const __ring_iter_28 = __List_Iterable.iter(fnames);
                  while (true) {
                    const __ring_next_28 = __ListIterator_Iterator.next(__ring_iter_28);
                    if (__ring_next_28._tag === "none") break;
                    const n = __ring_next_28._0;
                    __ring_match44: {
                      const __ring_m44 = _Map_get(field_map, n);
                      if (__ring_m44._tag === "some") {
                        const v_ = __ring_m44._0;
...
function gen_spread_struct(ctx, spread, ctor_name, field_order, field_map, use_new) {
  ...
  const is_simple = __ring_blk0;
  if (is_simple) {
    const base = gen_expr(ctx, spread);
    let args = [];
    const __ring_iter_30 = __List_Iterable.iter(field_order);
    while (true) {
      const __ring_next_30 = __ListIterator_Iterator.next(__ring_iter_30);
      if (__ring_next_30._tag === "none") break;
      const fn_ = __ring_next_30._0;
      __ring_match46: {
        const __ring_m46 = _Map_get(field_map, fn_);
        if (__ring_m46._tag === "some") {
          const v = __ring_m46._0;
    ...
    let args = [];
    const __ring_iter_31 = __List_Iterable.iter(field_order);
    while (true) {
      const __ring_next_31 = __ListIterator_Iterator.next(__ring_iter_31);
      if (__ring_next_31._tag === "none") break;
      const fn_ = __ring_next_31._0;
      __ring_match47: {
        const __ring_m47 = _Map_get(field_map, fn_);
...
function gen_struct_lit(ctx, name, fields, spread) {
  ...
  __ring_match48: {
    const __ring_m48 = _Map_get(ctx.struct_field_order, qname);
    if (__ring_m48._tag === "some") {
      const declared_order = __ring_m48._0;
      let field_map = map_new();
      const __ring_iter_32 = __List_Iterable.iter(fields);
      while (true) {
      ...
      __ring_match49: {
        ...
        if (__ring_m49._tag === "none") {
          let args = [];
          const __ring_iter_33 = __List_Iterable.iter(declared_order);
          while (true) {
            const __ring_next_33 = __ListIterator_Iterator.next(__ring_iter_33);
            if (__ring_next_33._tag === "none") break;
            const fn_ = __ring_next_33._0;
            __ring_match50: {
              const __ring_m50 = _Map_get(field_map, fn_);
              if (__ring_m50._tag === "some") {
                const v = __ring_m50._0;
                List_push(args, gen_expr(ctx, v));
...
function gen_mut_arg(ctx, arg) {
  __ring_match52: {
    const __ring_m52 = arg;
    if (__ring_m52._tag === "Ident") {
      const name = __ring_m52.name; const resolved_name = __ring_m52.resolved_name; const def_id = __ring_m52.def_id;
      const is_imported = codegen_ctx$is_imported_name(ctx, name);
      __ring_match53: {
        const __ring_m53 = def_id;
        if (__ring_m53._tag === "some") {
          const did = __ring_m53._0;
          if (((!is_imported) ? _Set_contains(ctx.boxed_vars, did, __Int_Eq) : false)) {
            __ring_match54: {
              const __ring_m54 = resolved_name;
              if (__ring_m54._tag === "some") {
                const rn = __ring_m54._0;
...
function gen_hof_all(ctx, sh, receiver, args) {
  const r = gen_expr(ctx, receiver);
  const cb = gen_lambda_capture_evidence(ctx, args, 0);
  const cv = sh.container_var;
  return `((${cv}, __f) => { for (const ${sh.binding} of ${cv}) if (!__f(${sh.cb_args})) return false; return true; })(${r}, ${cb})`;
}

function gen_hof_any(ctx, sh, receiver, args) {
  const r = gen_expr(ctx, receiver);
  const cb = gen_lambda_capture_evidence(ctx, args, 0);
  const cv = sh.container_var;
  return `((${cv}, __f) => { for (const ${sh.binding} of ${cv}) if (__f(${sh.cb_args})) return true; return false; })(${r}, ${cb})`;
}

function gen_hof_fold(ctx, sh, receiver, args) {
  const r = gen_expr(ctx, receiver);
  const init = gen_first_arg_or_undefined(ctx, args);
  const cb = gen_lambda_capture_evidence(ctx, args, 1);
  const cv = sh.container_var;
  return `((${cv}, __a, __f) => { for (const ${sh.binding} of ${cv}) __a = __f(__a, ${sh.cb_args}); return __a; })(${r}, ${init}, ${cb})`;
}

function gen_hof_filter(ctx, sh, receiver, args) {
  const r = gen_expr(ctx, receiver);
  const cb = gen_lambda_capture_evidence(ctx, args, 0);
  return gen_hof_collect_expr(sh, `if (__f(${sh.cb_args})) ${sh.result_add}`, r, cb);
}
...
function gen_first_arg_or_undefined(ctx, args) {
  __ring_match55: {
    const __ring_m55 = List_get(args, 0);
...
function gen_lambda_capture_evidence(ctx, args, idx) {
  __ring_match56: {
    const __ring_m56 = List_get(args, idx);
    if (__ring_m56._tag === "some") {
      const arg = __ring_m56._0;
      __ring_match57: {
        const __ring_m57 = arg;
        if (__ring_m57._tag === "Lambda") {
          const params = __ring_m57.params; const body = __ring_m57.body;
          let p_names = [];
          ...
          if ((List_len(body_lines) === 0)) {
            ...
            let result = [];
            List_push(result, `(function(${params_str}) {`);
            List_extend(result, body_lines);
            List_push(result, `  return ${b};`);
            List_push(result, "})");
            return List_join(result, "\n");
        ...
        __ring_match58: {
          const __ring_m58 = arg_type;
          if (__ring_m58._tag === "FnType") {
            const params = __ring_m58.params;
            const arity = List_len(params);
            let p_names = [];
            const __ring_end38 = arity;
...
function gen_call(ctx, callee, args, resolved_dicts, dict_dispatch) {
  __ring_match59: {
    const __ring_m59 = dict_dispatch;
    if (__ring_m59._tag === "some") {
      const dd = __ring_m59._0;
      ...
      __ring_match60: {
        ...
        if (__ring_m60._tag === "FieldAccess") {
          ...
          __ring_blk1 = gen_expr(ctx, receiver);
        ...
        __ring_match61: {
          ...
          if (__ring_m61._tag === "some") {
            ...
            skip_first_arg = true;
            __ring_blk2 = gen_expr(ctx, a);
            break __ring_match61;
          }
          if (__ring_m61._tag === "none") {
            __ring_blk2 = gen_expr(ctx, callee);
            break __ring_match61;
          }
          __match_fail(__ring_m61);
        }
        __ring_blk1 = __ring_blk2;
        break __ring_match60;
      }
      const receiver_arg = __ring_blk1;
      let other_args = [];
      let arg_idx = 0;
  ...
  __ring_match62: {
    ...
    if (__ring_m62._tag === "FieldAccess") {
      const receiver = __ring_m62.receiver; const field = __ring_m62.field; const callee_type = __ring_m62.ty;
      ...
      __ring_match63: {
        ...
        if (__ring_m63._tag === "StructType") {
          ...
          if ((name === hir$BUILTIN_LIST)) {
            __ring_match64: {
              const __ring_m64 = codegen_ctx$LIST_HOF_JS_METHOD(method);
              if (__ring_m64._tag === "some") {
                const js_method = __ring_m64._0;
                const r = gen_expr(ctx, receiver);
                const cb = gen_lambda_capture_evidence(ctx, args, 0);
            ...
            if ((method === "find")) {
              return gen_list_find_expr(ctx, receiver, args, "__a[__i]");
            }
            if ((method === "find_index")) {
              return gen_list_find_expr(ctx, receiver, args, "__i");
            }
            if ((method === "sort_by")) {
              const r = gen_expr(ctx, receiver);
              const cb = gen_lambda_capture_evidence(ctx, args, 0);
          ...
          if ((name === hir$BUILTIN_MAP)) {
            ...
            if ((method === "filter")) {
              return gen_hof_filter(ctx, map_hof_shape(), receiver, args);
            }
            if ((method === "fold")) {
              return gen_hof_fold(ctx, map_hof_shape(), receiver, args);
            }
            if ((method === "any")) {
              return gen_hof_any(ctx, map_hof_shape(), receiver, args);
            }
          }
          if ((name === hir$BUILTIN_SET)) {
            if ((method === "filter")) {
              return gen_hof_filter(ctx, set_hof_shape(), receiver, args);
            }
            if ((method === "fold")) {
              return gen_hof_fold(ctx, set_hof_shape(), receiver, args);
            }
            if ((method === "any")) {
              return gen_hof_any(ctx, set_hof_shape(), receiver, args);
            }
            if ((method === "all")) {
              return gen_hof_all(ctx, set_hof_shape(), receiver, args);
            }
          }
      ...
      __ring_match65: {
        const __ring_m65 = type_name;
        if (__ring_m65._tag === "some") {
          const tn = __ring_m65._0;
          const impl_key = `${codegen_ctx$qualify(ctx, tn)}.${method}`;
          __ring_match66: {
            const __ring_m66 = _Map_get(ctx.impl_methods, impl_key);
            if (__ring_m66._tag === "some") {
              const trait_opt = __ring_m66._0;
              let __ring_blk3;
              __ring_match67: {
                const __ring_m67 = trait_opt;
                if (__ring_m67._tag === "some") {
                  const trait_name = __ring_m67._0;
                  const dict = hir$trait_dict_name(codegen_ctx$qualify(ctx, tn), codegen_ctx$safe_ident(trait_name));
                  __ring_blk3 = `${dict}.${codegen_ctx$safe_ident(method)}`;
                  break __ring_match67;
                }
                if (__ring_m67._tag === "none") {
                  __ring_blk3 = `${codegen_ctx$qualify(ctx, tn)}_${codegen_ctx$safe_ident(method)}`;
                  break __ring_match67;
                }
                __match_fail(__ring_m67);
              }
              const fn_name = __ring_blk3;
              const r = gen_expr(ctx, receiver);
              ...
              let arg_strs = [];
              let ufcs_ai = 0;
              const __ring_iter_40 = __List_Iterable.iter(args);
              while (true) {
                ...
                let __ring_blk4;
                __ring_match68: {
                  const __ring_m68 = ufcs_mut_flags;
                  if (__ring_m68._tag === "some") {
                    const flags = __ring_m68._0;
                    let __ring_blk5;
                    __ring_match69: {
                      const __ring_m69 = List_get(flags, (ufcs_ai + 1));
                      if (__ring_m69._tag === "some") {
                        const f = __ring_m69._0;
                        __ring_blk5 = f;
  ...
  return `${r}, ${joined}`;
              ...
              let dict_parts = [];
              const __ring_iter_41 = __List_Iterable.iter(resolved_dicts);
              while (true) {
  ...
  let __ring_blk6;
  __ring_match70: {
    const __ring_m70 = callee;
    if (__ring_m70._tag === "Ident") {
      const name = __ring_m70.name;
      __ring_blk6 = Option_some(name);
      break __ring_match70;
    }
    __ring_blk6 = Option_none;
    break __ring_match70;
  }
  const cn = __ring_blk6;
  let __ring_blk7;
  __ring_match71: {
    const __ring_m71 = cn;
    if (__ring_m71._tag === "some") {
      const cname = __ring_m71._0;
      __ring_blk7 = _Map_get(ctx.fn_mut_params, cname);
  ...
  const mut_flags = __ring_blk7;
  let arg_strs = [];
  let argi = 0;
  const __ring_iter_42 = __List_Iterable.iter(args);
  while (true) {
    ...
    let __ring_blk8;
    __ring_match72: {
      const __ring_m72 = mut_flags;
      if (__ring_m72._tag === "some") {
        const flags = __ring_m72._0;
        let __ring_blk9;
        __ring_match73: {
          const __ring_m73 = List_get(flags, argi);
    ...
    const is_mut_param = __ring_blk8;
    if (is_mut_param) {
      List_push(arg_strs, gen_mut_arg(ctx, a));
    } else {
      List_push(arg_strs, gen_expr(ctx, a));
...
function gen_ord_dispatch(ctx, op, left, right, dispatch) {
  ...
  __ring_match74: {
    const __ring_m74 = dispatch;
    if (__ring_m74._tag === "Builtin") {
      const op_str = binop_str(op);
      return `(${l} ${op_str} ${r})`;
      break __ring_match74;
    }
    if (__ring_m74._tag === "Direct") {
      const dict = __ring_m74.dict; const extra_dicts = __ring_m74.extra_dicts;
      const d = codegen_ctx$qualify(ctx, dict);
    ...
    if (__ring_m74._tag === "Dict") {
      const param = __ring_m74.param;
...
function try_ord_dispatch(ctx, op, left, right, ord_dispatch) {
  __ring_match77: {
    const __ring_m77 = ord_dispatch;
    if (__ring_m77._tag === "some") {
      const dispatch = __ring_m77._0;
...
function gen_eq_dispatch(ctx, op, left, right, dispatch) {
  ...
  __ring_match78: {
    ...
    if (__ring_m78._tag === "Builtin") {
      __ring_match79: {
        const __ring_m79 = hir$hexpr_type(left);
        if (__ring_m79._tag === "TupleType") {
          const elements = __ring_m79.elements;
          if (is_ne) {
...
function try_eq_dispatch(ctx, op, left, right, eq_dispatch) {
  __ring_match80: {
    const __ring_m80 = eq_dispatch;
    if (__ring_m80._tag === "some") {
      const dispatch = __ring_m80._0;
...
function gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch) {
  __ring_match81: {
    const __ring_m81 = try_eq_dispatch(ctx, op, left, right, eq_dispatch);
    if (__ring_m81._tag === "some") {
      const result = __ring_m81._0;
      return result;
  ...
  __ring_match82: {
    const __ring_m82 = try_ord_dispatch(ctx, op, left, right, ord_dispatch);
    if (__ring_m82._tag === "some") {
      const result = __ring_m82._0;
      return result;
  ...
  if (ast$__BinOp_Eq.eq(op, ast$BinOp_Div)) {
    __ring_match83: {
      const __ring_m83 = hir$hexpr_type(left);
  ...
  __ring_match84: {
    ...
    __ring_blk10 = binop_str(op);
    break __ring_match84;
  }
  const js_op = __ring_blk10;
  return `(${l} ${js_op} ${r})`;
}

function gen_expr(ctx, expr) {
  __ring_match85: {
    const __ring_m85 = expr;
    if (__ring_m85._tag === "IntLit") {
      const value = __ring_m85.value;
      return Int_to_str(value);
      break __ring_match85;
    }
    if (__ring_m85._tag === "FloatLit") {
      const value = __ring_m85.value;
      return Float_to_str(value);
      break __ring_match85;
    }
    if (__ring_m85._tag === "StrLit") {
      const value = __ring_m85.value;
      return json_stringify(value);
      break __ring_match85;
    }
    if (__ring_m85._tag === "BoolLit") {
      const value = __ring_m85.value;
      if (value) {
        return "true";
      } else {
    ...
    if (__ring_m85._tag === "DictConstruct") {
      const base_dict = __ring_m85.base_dict; const trait_name = __ring_m85.trait_name; const inner = __ring_m85.inner;
      const d = codegen_ctx$qualify(ctx, base_dict);
      let inner_strs = [];
      const __ring_iter_44 = __List_Iterable.iter(inner);
      while (true) {
        const __ring_next_44 = __ListIterator_Iterator.next(__ring_iter_44);
        if (__ring_next_44._tag === "none") break;
        const i = __ring_next_44._0;
        List_push(inner_strs, dict_ref_to_js(ctx, i));
      }
      return wrapped_dict_js(d, trait_name, inner_strs);
      break __ring_match85;
    }
    if (__ring_m85._tag === "Ident") {
      const name = __ring_m85.name; const resolved_name = __ring_m85.resolved_name; const def_id = __ring_m85.def_id; const ty = __ring_m85.ty; const dict_closure_dicts = __ring_m85.dict_closure_dicts;
      let __ring_blk11;
      __ring_match86: {
        const __ring_m86 = resolved_name;
        if (__ring_m86._tag === "some") {
          const rn = __ring_m86._0;
          __ring_blk11 = codegen_ctx$qualify(ctx, rn);
          break __ring_match86;
        }
        if (__ring_m86._tag === "none") {
          __ring_blk11 = codegen_ctx$qualify(ctx, name);
          break __ring_match86;
        }
        __match_fail(__ring_m86);
      }
      const qname = __ring_blk11;
      const is_imported = codegen_ctx$is_imported_name(ctx, name);
      let __ring_blk12;
      __ring_match87: {
        const __ring_m87 = def_id;
        if (__ring_m87._tag === "some") {
          const did = __ring_m87._0;
          __ring_blk12 = (((!is_imported) ? _Set_contains(ctx.boxed_vars, did, __Int_Eq) : false) ? `${qname}.value` : qname);
      ...
      const boxed_qname = __ring_blk12;
      __ring_match88: {
        const __ring_m88 = dict_closure_dicts;
        if (__ring_m88._tag === "some") {
          const dicts = __ring_m88._0;
          if ((List_len(dicts) > 0)) {
            __ring_match89: {
              const __ring_m89 = ty;
              if (__ring_m89._tag === "FnType") {
                const params = __ring_m89.params; const effects = __ring_m89.effects;
                let p_names = [];
                const __ring_end45 = List_len(params);
    ...
    if (__ring_m85._tag === "BinOp") {
      const op = __ring_m85.op; const left = __ring_m85.left; const right = __ring_m85.right; const eq_dispatch = __ring_m85.eq_dispatch; const ord_dispatch = __ring_m85.ord_dispatch; const ty = __ring_m85.ty;
      return gen_binop(ctx, op, left, right, eq_dispatch, ord_dispatch);
      break __ring_match85;
    }
    if (__ring_m85._tag === "UnaryOp") {
      const op = __ring_m85.op; const operand = __ring_m85.operand;
      const o = gen_expr(ctx, operand);
      let __ring_blk13;
      __ring_match90: {
        const __ring_m90 = op;
        if (__ring_m90._tag === "Neg") {
          __ring_blk13 = "-";
          break __ring_match90;
        }
        if (__ring_m90._tag === "Not") {
          __ring_blk13 = "!";
          break __ring_match90;
        }
        __match_fail(__ring_m90);
      }
      const op_str = __ring_blk13;
      return `(${op_str}${o})`;
      break __ring_match85;
    }
    if (__ring_m85._tag === "Call") {
      const callee = __ring_m85.callee; const args = __ring_m85.args; const type_args = __ring_m85.type_args; const resolved_dicts = __ring_m85.resolved_dicts; const dict_dispatch = __ring_m85.dict_dispatch;
      return gen_call(ctx, callee, args, resolved_dicts, dict_dispatch);
      break __ring_match85;
    }
    if (__ring_m85._tag === "FieldAccess") {
      const receiver = __ring_m85.receiver; const field = __ring_m85.field;
      const r = gen_expr(ctx, receiver);
    ...
    if (__ring_m85._tag === "StructLit") {
      const name = __ring_m85.name; const fields = __ring_m85.fields; const spread = __ring_m85.spread;
      return gen_struct_lit(ctx, name, fields, spread);
      break __ring_match85;
    }
    if (__ring_m85._tag === "NamedVariantConstruct") {
      const enum_name = __ring_m85.enum_name; const variant_name = __ring_m85.variant_name; const fields = __ring_m85.fields; const spread = __ring_m85.spread; const ty = __ring_m85.ty;
      return gen_named_variant_construct(ctx, enum_name, variant_name, fields, spread, ty);
      break __ring_match85;
    }
    if (__ring_m85._tag === "MatchExpr") {
      const scrutinee = __ring_m85.scrutinee; const arms = __ring_m85.arms;
      return gen_match(ctx, scrutinee, arms);
      break __ring_match85;
    }
    if (__ring_m85._tag === "Block") {
      const stmts = __ring_m85.stmts; const tail = __ring_m85.tail;
      return gen_block_expr(ctx, stmts, tail, expr);
      break __ring_match85;
    }
    if (__ring_m85._tag === "IfExpr") {
      const condition = __ring_m85.condition; const then_branch = __ring_m85.then_branch; const else_branch = __ring_m85.else_branch;
      return gen_if(ctx, condition, then_branch, else_branch);
      break __ring_match85;
    }
    if (__ring_m85._tag === "StringInterp") {
      const parts = __ring_m85.parts;
      return gen_string_interp(ctx, parts);
      break __ring_match85;
    }
    if (__ring_m85._tag === "TryCatch") {
      const body = __ring_m85.body; const arms = __ring_m85.arms;
      return gen_try_catch(ctx, body, arms);
      break __ring_match85;
    }
    if (__ring_m85._tag === "HandleExpr") {
      const body = __ring_m85.body; const handlers = __ring_m85.handlers;
      return gen_handle(ctx, body, handlers);
      break __ring_match85;
    }
    if (__ring_m85._tag === "Lambda") {
      const params = __ring_m85.params; const body = __ring_m85.body; const ty = __ring_m85.ty;
      return gen_lambda(ctx, params, body, ty);
      break __ring_match85;
    }
    if (__ring_m85._tag === "EffectOp") {
      const effect_name = __ring_m85.effect_name; const op_name = __ring_m85.op_name; const args = __ring_m85.args;
      const ev_name = hir$evidence_param_name(effect_name);
      let arg_strs = [];
    ...
    if (__ring_m85._tag === "RangeExpr") {
      const start = __ring_m85.start; const end = __ring_m85.end; const inclusive = __ring_m85.inclusive;
    ...
    if (__ring_m85._tag === "ListLit") {
      const elements = __ring_m85.elements;
      let elems = [];
    ...
    if (__ring_m85._tag === "TupleLit") {
      const elements = __ring_m85.elements;
      let elems = [];
      const __ring_iter_48 = __List_Iterable.iter(elements);
      while (true) {
        const __ring_next_48 = __ListIterator_Iterator.next(__ring_iter_48);
        if (__ring_next_48._tag === "none") break;
        const e = __ring_next_48._0;
        List_push(elems, gen_expr(ctx, e));
      }
      const joined = List_join(elems, ", ");
      return `[${joined}]`;
    ...
    if (__ring_m85._tag === "IndexExpr") {
      const receiver = __ring_m85.receiver; const index = __ring_m85.index;
      const r = gen_expr(ctx, receiver);
      const i = gen_expr(ctx, index);
      const recv_ty = hir$hexpr_type(receiver);
      __ring_match91: {
        const __ring_m91 = recv_ty;
        if (__ring_m91._tag === "StructType") {
          const name = __ring_m91.name;
          if ((name === hir$BUILTIN_MAP)) {
    ...
    if (__ring_m85._tag === "Clone") {
      const inner = __ring_m85.inner;
      return gen_expr(ctx, inner);
      break __ring_match85;
    }
    if (__ring_m85._tag === "ReturnExpr") {
      const value = __ring_m85.value;
      __ring_match92: {
        const __ring_m92 = value;
        if (__ring_m92._tag === "some") {
          const v = __ring_m92._0;
          const v_js = gen_expr(ctx, v);
          codegen_ctx$emit(ctx, `return ${v_js};`);
          return "undefined";
          break __ring_match92;
        }
        if (__ring_m92._tag === "none") {
          codegen_ctx$emit(ctx, "return;");
          return "undefined";
          break __ring_match92;
        }
...
function emit_branch_as_assign(ctx, branch, tmp) {
  __ring_match93: {
    const __ring_m93 = branch;
    if (__ring_m93._tag === "Block") {
      const stmts = __ring_m93.stmts; const tail = __ring_m93.tail;
      const __ring_iter_49 = __List_Iterable.iter(stmts);
      while (true) {
        const __ring_next_49 = __ListIterator_Iterator.next(__ring_iter_49);
        if (__ring_next_49._tag === "none") break;
        const stmt = __ring_next_49._0;
        codegen_stmt$emit_stmt(ctx, stmt);
      }
      __ring_match94: {
        const __ring_m94 = tail;
        if (__ring_m94._tag === "some") {
          const t = __ring_m94._0;
    ...
    if (__ring_m93._tag === "ReturnExpr") {
      const value = __ring_m93.value;
      __ring_match95: {
        const __ring_m95 = value;
        if (__ring_m95._tag === "some") {
          const v = __ring_m95._0;
          const v_js = gen_expr(ctx, v);
          return codegen_ctx$emit(ctx, `return ${v_js};`);
...
function __HofIterShape_Eq_eq(self, other) {
  return (self.container_var === other.container_var) && (self.binding === other.binding) && (self.cb_args === other.cb_args) && (self.result_ctor === other.result_ctor) && (self.result_add === other.result_add);
}
const __HofIterShape_Eq = { eq: __HofIterShape_Eq_eq, ne: function(self, other) { return !__HofIterShape_Eq_eq(self, other); } };
...
function __HofIterShape_Clone_clone(self) {
  return new HofIterShape(self.container_var, self.binding, self.cb_args, self.result_ctor, self.result_add);
}
const __HofIterShape_Clone = { clone: __HofIterShape_Clone_clone };
...
function __HofIterShape_Ord_cmp(self, other) {
  var c;
  c = (self.container_var < other.container_var ? -1 : self.container_var > other.container_var ? 1 : 0);
  if (c !== 0) return c;
  c = (self.binding < other.binding ? -1 : self.binding > other.binding ? 1 : 0);
  if (c !== 0) return c;
  c = (self.cb_args < other.cb_args ? -1 : self.cb_args > other.cb_args ? 1 : 0);
  if (c !== 0) return c;
  c = (self.result_ctor < other.result_ctor ? -1 : self.result_ctor > other.result_ctor ? 1 : 0);
  if (c !== 0) return c;
  return (self.result_add < other.result_add ? -1 : self.result_add > other.result_add ? 1 : 0);
}
const __HofIterShape_Ord = { cmp: __HofIterShape_Ord_cmp };
...
function __HofIterShape_Debug_debug(self) {
  return "HofIterShape { " + "container_var: " + String(self.container_var) + ", " + "binding: " + String(self.binding) + ", " + "cb_args: " + String(self.cb_args) + ", " + "result_ctor: " + String(self.result_ctor) + ", " + "result_add: " + String(self.result_add) + " }";
}
const __HofIterShape_Debug = { debug: __HofIterShape_Debug_debug };
...
export { gen_expr, wrapped_dict_js };