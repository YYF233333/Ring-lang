...
function Expr_OptionUnwrap(expr, span) {
  return { _tag: "OptionUnwrap", expr, span };
}
function Expr_TryBlock(body, span) {
  return { _tag: "TryBlock", body, span };
}
...
function Decl_Fn(name, type_params, params, return_type, body, is_pub, is_abstract, span) {
  return { _tag: "Fn", name, type_params, params, return_type, body, is_pub, is_abstract, span };
}
...
function Decl_ExternFn(name, type_params, params, return_type, is_pub, span) {
  return { _tag: "ExternFn", name, type_params, params, return_type, is_pub, span };
}
