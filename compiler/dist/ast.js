...
function TypeExpr_FnType(params, return_type, effects, span) {
  return { _tag: "FnType", params, return_type, effects, span };
}
...
function Pattern_OrPattern(patterns, span) {
  return { _tag: "OrPattern", patterns, span };
}
...
function Expr_IndexExpr(receiver, index, span) {
  return { _tag: "IndexExpr", receiver, index, span };
}
function Expr_ReturnExpr(value, span) {
  return { _tag: "ReturnExpr", value, span };
}
...
class TypeBound {
  constructor(trait_name, type_args, assoc_constraints, span) {
...
function Decl_EffectAlias(name, type_params, effects, is_pub, span) {
  return { _tag: "EffectAlias", name, type_params, effects, is_pub, span };
}
function Decl_Delegate(field, trait_names, span) {
  return { _tag: "Delegate", field, trait_names, span };
}
function Decl_AssocType(name, bounds, value, is_pub, span) {
  return { _tag: "AssocType", name, bounds, value, is_pub, span };
}
