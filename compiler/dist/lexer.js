...
const TokenKind_TkLoop = Object.freeze({ _tag: "TkLoop" });
...
const TokenKind_TkMod = Object.freeze({ _tag: "TkMod" });
const TokenKind_TkSuper = Object.freeze({ _tag: "TkSuper" });
const TokenKind_TkSig = Object.freeze({ _tag: "TkSig" });
const TokenKind_TkRequires = Object.freeze({ _tag: "TkRequires" });
...
const TokenKind_TkPipe = Object.freeze({ _tag: "TkPipe" });
...
const TokenKind_TkStarEq = Object.freeze({ _tag: "TkStarEq" });
const TokenKind_TkSlashEq = Object.freeze({ _tag: "TkSlashEq" });
const TokenKind_TkPercentEq = Object.freeze({ _tag: "TkPercentEq" });
...
function Lexer_lex_punctuation(self, start) {
  ...
  if ((ch === "*")) {
    if ((Lexer_peek(self) === "=")) {
      Lexer_advance(self);
      return Lexer_make_token(self, TokenKind_TkStarEq, "*=", start, Lexer_current_position(self));
    }
  ...
  if ((ch === "/")) {
    if ((Lexer_peek(self) === "=")) {
      Lexer_advance(self);
      return Lexer_make_token(self, TokenKind_TkSlashEq, "/=", start, Lexer_current_position(self));
    }
  ...
  if ((ch === "%")) {
    if ((Lexer_peek(self) === "=")) {
      Lexer_advance(self);
      return Lexer_make_token(self, TokenKind_TkPercentEq, "%=", start, Lexer_current_position(self));
    }
  ...
  if ((ch === "|")) {
    ...
    return Lexer_make_token(self, TokenKind_TkPipe, "|", start, Lexer_current_position(self));
  }
...
function token_kind_value(k) {
  __ring_match12: {
    ...
    if (__ring_m12._tag === "TkLet") {
      return "let";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkMut") {
      return "mut";
      break __ring_match12;
    }
    ...
    if (__ring_m12._tag === "TkHandle") {
      return "handle";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkWith") {
      return "with";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkIf") {
      return "if";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkElse") {
      return "else";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkCatch") {
      return "catch";
      break __ring_match12;
    }
    ...
    if (__ring_m12._tag === "TkReturn") {
      return "return";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkFor") {
      return "for";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkIn") {
      return "in";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkPub") {
      return "pub";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkWhere") {
      return "where";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkTrue") {
      return "true";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkFalse") {
      return "false";
      break __ring_match12;
    }
    ...
    if (__ring_m12._tag === "TkTry") {
      return "try";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkWhile") {
      return "while";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkBreak") {
      return "break";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkContinue") {
      return "continue";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkLoop") {
      return "loop";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkUse") {
      return "use";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkAs") {
      return "as";
      break __ring_match12;
    }
    ...
    if (__ring_m12._tag === "TkRequires") {
      return "requires";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkIntLit") {
      return "int_lit";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkFloatLit") {
      return "float_lit";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkStringLit") {
      return "string_lit";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkStringInterpStart") {
      return "string_interp_start";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkStringInterpMiddle") {
      return "string_interp_middle";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkStringInterpEnd") {
      return "string_interp_end";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkRawStringLit") {
    ...
    if (__ring_m12._tag === "TkPlus") {
      return "+";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkMinus") {
      return "-";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkStar") {
      return "*";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkSlash") {
      return "/";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkPercent") {
      return "%";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkEqEq") {
      return "==";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkBangEq") {
      return "!=";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkLt") {
      return "<";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkGt") {
      return ">";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkLtEq") {
      return "<=";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkGtEq") {
      return ">=";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkAmpAmp") {
      return "&&";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkPipePipe") {
      return "||";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkPipe") {
      return "|";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkBang") {
      return "!";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkEq") {
      return "=";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkPlusEq") {
      return "+=";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkMinusEq") {
      return "-=";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkStarEq") {
      return "*=";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkSlashEq") {
      return "/=";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkPercentEq") {
      return "%=";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkLParen") {
      return "(";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkRParen") {
      return ")";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkLBrace") {
      return "{";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkRBrace") {
      return "}";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkLBracket") {
      return "[";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkRBracket") {
      return "]";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkComma") {
      return ",";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkColon") {
      return ":";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkColonColon") {
      return "::";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkDot") {
      return ".";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkDotDot") {
      return "..";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkDotDotEq") {
      return "..=";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkFatArrow") {
      return "=>";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkArrow") {
      return "->";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkQuestion") {
      return "?";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkSemi") {
      return ";";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkEof") {
      return "eof";
      break __ring_match12;
    }
    if (__ring_m12._tag === "TkError") {
      return "error_token";
      break __ring_match12;
    }
...
function __TokenKind_Clone_clone(self) {
  switch (self._tag) {
    ...
    case "TkLoop": return TokenKind_TkLoop;
    case "TkUse": return TokenKind_TkUse;
    case "TkAs": return TokenKind_TkAs;
    case "TkExtern": return TokenKind_TkExtern;
    case "TkMod": return TokenKind_TkMod;
    case "TkSuper": return TokenKind_TkSuper;
    case "TkSig": return TokenKind_TkSig;
    case "TkRequires": return TokenKind_TkRequires;
    ...
    case "TkPipe": return TokenKind_TkPipe;
    ...
    case "TkStarEq": return TokenKind_TkStarEq;
    case "TkSlashEq": return TokenKind_TkSlashEq;
    case "TkPercentEq": return TokenKind_TkPercentEq;
...
function __TokenKind_Debug_debug(self) {
  switch (self._tag) {
    ...
    case "TkLoop": return "TkLoop";
    case "TkUse": return "TkUse";
    case "TkAs": return "TkAs";
    case "TkExtern": return "TkExtern";
    case "TkMod": return "TkMod";
    case "TkSuper": return "TkSuper";
    case "TkSig": return "TkSig";
    case "TkRequires": return "TkRequires";
    ...
    case "TkPipe": return "TkPipe";
    case "TkBang": return "TkBang";
    case "TkEq": return "TkEq";
    case "TkPlusEq": return "TkPlusEq";
    case "TkMinusEq": return "TkMinusEq";
    case "TkStarEq": return "TkStarEq";
    case "TkSlashEq": return "TkSlashEq";
    case "TkPercentEq": return "TkPercentEq";
