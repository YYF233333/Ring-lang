...
function resolve_var_id(id, sub) {
  __ring_match0: {
    const __ring_m0 = union_find$uf_lookup(sub, id);
...
function infer_stmt(ctx, stmt, subst, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m4._tag === "Var") {
      ...
      __ring_match7: {
        const __ring_m7 = var_scheme;
        if (__ring_m7._tag === "some") {
          const vs = __ring_m7._0;
          __ring_match8: {
            const __ring_m8 = vs.def_id;
    ...
    if (__ring_m4._tag === "Return") {
      ...
      __ring_match9: {
        const __ring_m9 = value;
        if (__ring_m9._tag === "some") {
          const v = __ring_m9._0;
          const r = infer_expr(ctx, v, subst, __ring_ev_fail);
          let s = r.subst;
          __ring_match10: {
            const __ring_m10 = ctx.current_fn_return_type;
            if (__ring_m10._tag === "some") {
              const ret_type = __ring_m10._0;
    ...
    if (__ring_m4._tag === "While") {
      ...
      __ring_match12: {
        const __ring_m12 = body_result;
        if (__ring_m12._tag === "some") {
          const body_r = __ring_m12._0;
          s = body_r.subst;
  ...
  __match_fail(__ring_m);
              ...
              if (((name === hir$BUILTIN_MAP) && (List_len(type_params) >= 2))) {
                ...
                __ring_match14: {
                  const __ring_m14 = [List_get(type_params, 0), List_get(type_params, 1)];
                  if (Array.isArray(__ring_m14) && __ring_m14.length === 2 && __ring_m14[0]._tag === "some" && __ring_m14[1]._tag === "some") {
                    const kt = __ring_m14[0]._0; const vt = __ring_m14[1]._0;
      ...
      __ring_match15: {
        const __ring_m15 = destructure;
        if (__ring_m15._tag === "some") {
          const destr = __ring_m15._0;
          __ring_match16: {
            const __ring_m16 = element_type;
            if (__ring_m16._tag === "TupleType") {
              const type_elems = __ring_m16.elements;
          ...
          while ((di < List_len(destr.names))) {
            __ring_match17: {
              const __ring_m17 = List_get(destr.names, di);
              if (__ring_m17._tag === "some") {
                const dname = __ring_m17._0;
  ...
  return env$TypeEnv_fresh_var(ctx.env);
                ...
                __ring_match18: {
                  const __ring_m18 = dscheme;
                  if (__ring_m18._tag === "some") {
                    const ds = __ring_m18._0;
                    __ring_match19: {
                      const __ring_m19 = [ds.def_id, List_get(destr.spans, di)];
                      if (Array.isArray(__ring_m19) && __ring_m19.length === 2 && __ring_m19[0]._tag === "some" && __ring_m19[1]._tag === "some") {
                        const did = __ring_m19[0]._0; const dspan = __ring_m19[1]._0;
      ...
      __ring_match20: {
        const __ring_m20 = binding_scheme;
        if (__ring_m20._tag === "some") {
          const bs = __ring_m20._0;
          __ring_match21: {
            const __ring_m21 = bs.def_id;
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match22: {
        const __ring_m22 = body_result;
        if (__ring_m22._tag === "some") {
          const body_r = __ring_m22._0;
          s = body_r.subst;
  ...
  return [];
      ...
      __ring_match24: {
        const __ring_m24 = pattern;
        if (__ring_m24._tag === "TuplePattern") {
          const pat_elements = __ring_m24.elements;
          ...
          while ((bi < List_len(pat_elements))) {
            __ring_match25: {
              const __ring_m25 = List_get(pat_elements, bi);
              if (__ring_m25._tag === "some") {
                const p = __ring_m25._0;
  ...
  return infer_block(ctx, then_block, Option_some(s), __ring_ev_fail);
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match29: {
        const __ring_m29 = then_result;
        if (__ring_m29._tag === "some") {
          const then_r = __ring_m29._0;
          s = then_r.subst;
          ...
          __ring_match30: {
            ...
            if (__ring_m30._tag === "some") {
              ...
              env$TypeEnv_pop_scope(ctx.env);
              __ring_match31: {
                const __ring_m31 = else_result;
                if (__ring_m31._tag === "some") {
                  const else_r = __ring_m31._0;
                  s = else_r.subst;
...
function check_assign_target_mutable(ctx, target) {
  __ring_match32: {
    ...
    if (__ring_m32._tag === "Ident") {
      const name = __ring_m32.name; const span = __ring_m32.span;
      const scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match33: {
        const __ring_m33 = scheme;
        if (__ring_m33._tag === "some") {
          const s = __ring_m33._0;
          __ring_match34: {
            const __ring_m34 = s.def_id;
    ...
    if (__ring_m32._tag === "FieldAccess") {
      const receiver = __ring_m32.receiver; const span = __ring_m32.span;
      const root = find_root_expr(receiver);
      __ring_match35: {
        const __ring_m35 = root;
        if (__ring_m35._tag === "Ident") {
          const name = __ring_m35.name; const rspan = __ring_m35.span;
          const scheme = env$TypeEnv_lookup(ctx.env, name);
          __ring_match36: {
...
function infer_expr(ctx, expr, subst, __ring_ev_fail) {
  __ring_match39: {
    ...
    if (__ring_m39._tag === "IntLit") {
      const value = __ring_m39.value; const span = __ring_m39.span;
    ...
    if (__ring_m39._tag === "Ident") {
      const name = __ring_m39.name; const qualifier = __ring_m39.qualifier; const span = __ring_m39.span;
      return infer_ident(ctx, name, span, subst, qualifier);
      break __ring_match39;
    }
    if (__ring_m39._tag === "BinOp") {
      const op = __ring_m39.op; const left = __ring_m39.left; const right = __ring_m39.right; const span = __ring_m39.span;
      return infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail);
      break __ring_match39;
    }
    if (__ring_m39._tag === "UnaryOp") {
      const op = __ring_m39.op; const operand = __ring_m39.operand; const span = __ring_m39.span;
      return infer_unary_op(ctx, op, operand, span, subst, __ring_ev_fail);
      break __ring_match39;
    }
    if (__ring_m39._tag === "Call") {
      const callee = __ring_m39.callee; const args = __ring_m39.args; const span = __ring_m39.span;
      return infer_call(ctx, callee, args, span, subst, __ring_ev_fail);
      break __ring_match39;
    }
    if (__ring_m39._tag === "MethodCall") {
      const receiver = __ring_m39.receiver; const method = __ring_m39.method; const args = __ring_m39.args; const span = __ring_m39.span;
      return infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail);
      break __ring_match39;
    }
    if (__ring_m39._tag === "FieldAccess") {
      const receiver = __ring_m39.receiver; const field = __ring_m39.field; const span = __ring_m39.span;
      return infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail);
      break __ring_match39;
    }
    if (__ring_m39._tag === "StructLit") {
      const name = __ring_m39.name; const qualifier = __ring_m39.qualifier; const fields = __ring_m39.fields; const spread = __ring_m39.spread; const span = __ring_m39.span;
      return infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail);
      break __ring_match39;
    }
    if (__ring_m39._tag === "MatchExpr") {
      const scrutinee = __ring_m39.scrutinee; const arms = __ring_m39.arms; const span = __ring_m39.span;
    ...
    if (__ring_m39._tag === "IfExpr") {
      const condition = __ring_m39.condition; const then_branch = __ring_m39.then_branch; const else_branch = __ring_m39.else_branch; const span = __ring_m39.span;
      return infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail);
      break __ring_match39;
    }
    if (__ring_m39._tag === "StringInterp") {
      const parts = __ring_m39.parts; const span = __ring_m39.span;
      return infer_string_interp(ctx, parts, span, subst, __ring_ev_fail);
      break __ring_match39;
    }
    if (__ring_m39._tag === "CatchExpr") {
      const catch_expr = __ring_m39.expr; const arms = __ring_m39.arms; const span = __ring_m39.span;
      return infer_catch(ctx, catch_expr, arms, span, subst, __ring_ev_fail);
      break __ring_match39;
    }
    if (__ring_m39._tag === "HandleExpr") {
      const body = __ring_m39.body; const handlers = __ring_m39.handlers; const span = __ring_m39.span;
      return infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail);
      break __ring_match39;
    }
    if (__ring_m39._tag === "Lambda") {
      const params = __ring_m39.params; const body = __ring_m39.body; const span = __ring_m39.span;
      return infer_lambda(ctx, params, body, span, subst, Option_none, __ring_ev_fail);
      break __ring_match39;
    }
    if (__ring_m39._tag === "ListLit") {
      const elements = __ring_m39.elements; const span = __ring_m39.span;
      return infer_list_literal(ctx, elements, span, subst, __ring_ev_fail);
      break __ring_match39;
    }
    if (__ring_m39._tag === "TupleLit") {
      const elements = __ring_m39.elements; const span = __ring_m39.span;
      let s = subst;
      let helements = [];
    ...
    if (__ring_m39._tag === "Range") {
      const start = __ring_m39.start; const end = __ring_m39.end; const inclusive = __ring_m39.inclusive; const span = __ring_m39.span;
    ...
    if (__ring_m39._tag === "IndexExpr") {
      const receiver = __ring_m39.receiver; const index = __ring_m39.index; const span = __ring_m39.span;
...
function infer_index_expr(ctx, receiver, index, span, subst, __ring_ev_fail) {
  ...
  __ring_match40: {
    const __ring_m40 = recv_type;
    if (__ring_m40._tag === "StructType") {
      const name = __ring_m40.name; const type_params = __ring_m40.type_params;
...
function infer_ident(ctx, name, span, subst, qualifier) {
  ...
  __ring_match41: {
    ...
    if (__ring_m41._tag === "some") {
      ...
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match42: {
          const __ring_m42 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m42._tag === "some") {
            const prefix = __ring_m42._0;
            if ((prefix === "")) {
  ...
  __ring_match43: {
    ...
    if (__ring_m43._tag === "some") {
      ...
      __ring_match44: {
        const __ring_m44 = mod_scheme;
        if (__ring_m44._tag === "some") {
          const ms = __ring_m44._0;
...
function infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail) {
  ...
  __ring_match50: {
    ...
    if (__ring_m50._tag === "Sub") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "-");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match50;
    }
    if (__ring_m50._tag === "Mul") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "*");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match50;
    }
    if (__ring_m50._tag === "Div") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "/");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match50;
    }
    if (__ring_m50._tag === "Mod") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "%");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match50;
    }
    if (__ring_m50._tag === "Eq") {
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
...
function is_primitive_eq(t) {
  __ring_match52: {
    ...
    if (__ring_m52._tag === "StrType") {
      return true;
      break __ring_match52;
    }
    if (__ring_m52._tag === "BoolType") {
      return true;
      break __ring_match52;
    }
    if (__ring_m52._tag === "UnitType") {
      return true;
      break __ring_match52;
    }
    if (__ring_m52._tag === "NeverType") {
      return true;
      break __ring_match52;
    }
    if (__ring_m52._tag === "AnyType") {
      return true;
      break __ring_match52;
    }
    return false;
...
function resolve_trait_dispatch(ctx, resolved, trait_name, error_code, subst, span, op, is_builtin) {
  ...
  __ring_match55: {
    ...
    if (__ring_m55._tag === "TypeVar") {
      ...
      __ring_match57: {
        ...
        if (__ring_m57._tag === "some") {
          const var_bounds = __ring_m57._0;
    ...
    if (__ring_m55._tag === "StructType") {
      const name = __ring_m55.name; const type_params = __ring_m55.type_params;
...
function resolve_type_to_trait_dict(ctx, t, trait_name) {
  __ring_match59: {
    const __ring_m59 = types$type_to_builtin_name(t);
    if (__ring_m59._tag === "some") {
      const builtin_name = __ring_m59._0;
      __ring_match60: {
        const __ring_m60 = t;
        if (__ring_m60._tag === "StructType") {
  ...
  __ring_match61: {
    ...
    if (__ring_m61._tag === "TypeVar") {
      ...
      __ring_match62: {
        const __ring_m62 = bound;
        if (__ring_m62._tag === "some") {
          const b = __ring_m62._0;
...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match65: {
    const __ring_m65 = expected;
    if (__ring_m65._tag === "FnType") {
      const exp_params = __ring_m65.params;
  ...
  __ring_match66: {
    const __ring_m66 = resolved_callee_type;
    if (__ring_m66._tag === "FnType") {
      const fn_effects = __ring_m66.effects;
  ...
  let resolved_dicts = [];
  __ring_match67: {
    const __ring_m67 = callee;
    if (__ring_m67._tag === "Ident") {
      const callee_name = __ring_m67.name;
      __ring_match68: {
        const __ring_m68 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m68._tag === "some") {
          const callee_scheme = __ring_m68._0;
...
function resolve_arg_dict_closure(ctx, harg, s) {
  __ring_match69: {
    const __ring_m69 = harg;
    if (__ring_m69._tag === "Ident") {
      const name = __ring_m69.name; const resolved_name = __ring_m69.resolved_name; const def_id = __ring_m69.def_id; const ty = __ring_m69.ty; const effects = __ring_m69.effects; const span = __ring_m69.span;
      const arg_scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match70: {
        const __ring_m70 = arg_scheme;
        if (__ring_m70._tag === "some") {
          const as_ = __ring_m70._0;
          ...
          for (const bound of as_.bounds) {
            __ring_match71: {
              const __ring_m71 = _Map_get(var_map, bound.type_var);
              if (__ring_m71._tag === "some") {
                const fresh_var = __ring_m71._0;
...
function resolve_arg_bound_dict(ctx, concrete, trait_name, dicts) {
  __ring_match72: {
    ...
    if (__ring_m72._tag === "TypeVar") {
      ...
      __ring_match73: {
        const __ring_m73 = matching;
        if (__ring_m73._tag === "some") {
          const fb = __ring_m73._0;
    ...
    __ring_match74: {
      const __ring_m74 = types$type_to_builtin_name(concrete);
...
function check_expr_is_let_def(ctx, expr) {
  __ring_match75: {
    ...
    if (__ring_m75._tag === "Ident") {
      const name = __ring_m75.name;
      __ring_match76: {
        const __ring_m76 = env$TypeEnv_lookup(ctx.env, name);
        if (__ring_m76._tag === "some") {
          const s = __ring_m76._0;
          __ring_match77: {
            const __ring_m77 = s.def_id;
            if (__ring_m77._tag === "some") {
              const did = __ring_m77._0;
              return _Set_contains(ctx.env.scope.let_defs, did);
    ...
    if (__ring_m75._tag === "FieldAccess") {
      const inner = __ring_m75.receiver;
...
function check_receiver_mutability(ctx, receiver, recv_type, method, span) {
  ...
  __ring_match78: {
    const __ring_m78 = recv_type;
    if (__ring_m78._tag === "StructType") {
      const name = __ring_m78.name;
    ...
    __ring_match79: {
      const __ring_m79 = types$type_to_builtin_name(recv_type);
      if (__ring_m79._tag === "some") {
        const n = __ring_m79._0;
  ...
  __ring_match80: {
    const __ring_m80 = type_name;
    if (__ring_m80._tag === "some") {
      const tname = __ring_m80._0;
      __ring_match81: {
        const __ring_m81 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m81._tag === "some") {
          const mut_set = __ring_m81._0;
          if (_Set_contains(mut_set, method)) {
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match82: {
    const __ring_m82 = receiver;
    if (__ring_m82._tag === "Ident") {
      const recv_name = __ring_m82.name;
      __ring_match83: {
        const __ring_m83 = _Map_get(ctx.env.types.effects, recv_name);
  ...
  if (Option_is_none(method_type)) {
    __ring_match85: {
      const __ring_m85 = types$type_to_builtin_name(recv_type);
  ...
  if (Option_is_none(method_type)) {
    __ring_match86: {
      const __ring_m86 = types$type_to_builtin_name(recv_type);
      if (__ring_m86._tag === "some") {
        const type_name = __ring_m86._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match87: {
      const __ring_m87 = recv_var_id;
      if (__ring_m87._tag === "some") {
        const rvid = __ring_m87._0;
        for (const fb of ctx.current_fn_bounds) {
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match88: {
              const __ring_m88 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m88._tag === "some") {
                const trait_def = __ring_m88._0;
                ...
                __ring_match89: {
                  ...
                  if (__ring_m89._tag === "some") {
                    const found_method = __ring_m89._0;
    ...
    if (__ring_m90._tag === "some") {
      ...
      __ring_match91: {
        ...
        if (__ring_m91._tag === "FnType") {
          const mt_params = __ring_m91.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match92: {
              const __ring_m92 = List_first(mt_params);
              if (__ring_m92._tag === "some") {
                const first_param = __ring_m92._0;
  ...
  const expected = env$apply_subst(s, expected_raw);
  __ring_match93: {
    const __ring_m93 = expected;
    if (__ring_m93._tag === "FnType") {
      const exp_params = __ring_m93.params;
      return infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
    ...
    if (__ring_m94._tag === "some") {
      ...
      __ring_match95: {
        ...
        if (__ring_m95._tag === "FnType") {
          const mt_params = __ring_m95.params; const mt_ret = __ring_m95.return_type; const mt_effects = __ring_m95.effects;
          let i = 0;
          for (const harg of hargs) {
            if (((i + 1) < List_len(mt_params))) {
              __ring_match96: {
                const __ring_m96 = List_get(mt_params, (i + 1));
                if (__ring_m96._tag === "some") {
                  const expected_param = __ring_m96._0;
  ...
  let resolved_dicts = [];
  __ring_match99: {
    const __ring_m99 = method_scheme;
    if (__ring_m99._tag === "some") {
      const ms = __ring_m99._0;
      if ((List_len(ms.bounds) > 0)) {
        __ring_match100: {
          const __ring_m100 = method_type;
          if (__ring_m100._tag === "some") {
            const mt = __ring_m100._0;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match101: {
    const __ring_m101 = _Map_get(ctx.env.trait_reg.impl_methods, type_name);
    if (__ring_m101._tag === "some") {
      const impl_methods = __ring_m101._0;
      __ring_match102: {
        const __ring_m102 = _Map_get(impl_methods, method);
        if (__ring_m102._tag === "some") {
          const scheme = __ring_m102._0;
...
function lookup_trait_method(ctx, type_name, method, span) {
  ...
  for (const impl_entry of ctx.env.trait_reg.trait_impls) {
    if ((impl_entry.target_type_name === type_name)) {
      __ring_match103: {
        const __ring_m103 = _Map_get(ctx.env.trait_reg.traits, impl_entry.trait_name);
        if (__ring_m103._tag === "some") {
          const trait_def = __ring_m103._0;
          const tm = ((__a) => { const __i = __a.findIndex((function(m) { return (m.name === method); })); return __i >= 0 ? { _tag: "some", _0: __a[__i] } : { _tag: "none" }; })(trait_def.methods);
          __ring_match104: {
            const __ring_m104 = tm;
            if (__ring_m104._tag === "some") {
              const found_method = __ring_m104._0;
              __ring_match105: {
                const __ring_m105 = found_trait_name;
                if (__ring_m105._tag === "some") {
                  const prev_trait = __ring_m105._0;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match106: {
    const __ring_m106 = effect_def_opt;
  ...
  if ((List_len(args) !== List_len(op.params))) {
    const _ = infer_ctx$type_error(ctx.sink, codes$E0301, `Effect operation '${effect_name}.${op_name}' expects ${Int_to_str(List_len(op.params))} argument(s), got ${Int_to_str(List_len(args))}`, span, diagnostics$DiagnosticContext_TypeMismatch(`${Int_to_str(List_len(op.params))} args`, `${Int_to_str(List_len(args))} args`, Option_none));
  }
  let s = subst;
  let effects = types$EMPTY_ROW;
  let hargs = [];
  ...
  for (const arg of args) {
    ...
    List_push(hargs, ar.hexpr);
    __ring_match108: {
      const __ring_m108 = List_get(op.params, i);
      if (__ring_m108._tag === "some") {
        const param_type = __ring_m108._0;
  ...
  __ring_match109: {
    const __ring_m109 = effect_def.built_in_kind;
    if (__ring_m109._tag === "some") {
      const bik = __ring_m109._0;
      __ring_match110: {
        const __ring_m110 = bik;
        if (__ring_m110._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match110;
        }
        if (__ring_m110._tag === "BkFail") {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match111: {
    ...
    if (__ring_m111._tag === "StructType") {
      ...
      __ring_match112: {
        const __ring_m112 = _Map_get(ctx.env.types.structs, name);
        if (__ring_m112._tag === "some") {
          const struct_def = __ring_m112._0;
          ...
          __ring_match113: {
            ...
            if (__ring_m113._tag === "some") {
              const found_field = __ring_m113._0;
              let inst_map = map_new();
              let fi = 0;
              while (((fi < List_len(struct_def.type_param_vars)) && (fi < List_len(type_params)))) {
                __ring_match114: {
                  const __ring_m114 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m114) && __ring_m114.length === 2 && __ring_m114[0]._tag === "some" && __ring_m114[1]._tag === "some") {
                    const var_id = __ring_m114[0]._0; const tp = __ring_m114[1]._0;
    ...
    if (__ring_m111._tag === "RecordType") {
      const rec_fields = __ring_m111.fields; const tail = __ring_m111.tail;
    ...
    if (__ring_m111._tag === "TupleType") {
      const elements = __ring_m111.elements;
      __ring_match117: {
        const __ring_m117 = parse_int(field);
        ...
        if (__ring_m117._tag === "some") {
          ...
          __ring_match118: {
            const __ring_m118 = List_get(elements, i);
            if (__ring_m118._tag === "some") {
              const t = __ring_m118._0;
              field_type = t;
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  ...
  __ring_match119: {
    ...
    if (__ring_m119._tag === "some") {
      ...
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match120: {
          const __ring_m120 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m120._tag === "some") {
            const prefix = __ring_m120._0;
            if ((prefix === "")) {
              resolved_qualifier = Option_none;
            } else {
              resolved_qualifier = Option_some(prefix);
  ...
  __ring_match123: {
    ...
    if (__ring_m123._tag === "some") {
      ...
      __ring_match124: {
        const __ring_m124 = _Map_get(ctx.env.types.enums, q);
        if (__ring_m124._tag === "some") {
          const enum_def = __ring_m124._0;
          if (enum_def.variants.some((function(v) { return (v.name === name); }))) {
  ...
  __ring_match126: {
    const __ring_m126 = variant_enum;
    if (__ring_m126._tag === "some") {
      const ve = __ring_m126._0;
      __ring_match127: {
        const __ring_m127 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m127._tag === "some") {
          const enum_def = __ring_m127._0;
          ...
          __ring_match128: {
            const __ring_m128 = variant;
            if (__ring_m128._tag === "some") {
              const v = __ring_m128._0;
              __ring_match129: {
                const __ring_m129 = v.field_names;
  ...
  __ring_match130: {
    const __ring_m130 = struct_def_opt;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match131: {
      const __ring_m131 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m131._tag === "some") {
        const var_id = __ring_m131._0;
  ...
  for (const field of fields) {
    ...
    __ring_match133: {
      const __ring_m133 = def_field;
      if (__ring_m133._tag === "some") {
        const df = __ring_m133._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  ...
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match134: {
      const __ring_m134 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m134._tag === "some") {
        const var_id = __ring_m134._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  let hspread = Option_none;
  __ring_match135: {
    const __ring_m135 = spread;
    if (__ring_m135._tag === "some") {
      const sp = __ring_m135._0;
      const sr = infer_expr(ctx, sp, s, __ring_ev_fail);
      s = sr.subst;
      const me = infer_ctx$merge_effects(ctx.env, effects, sr.effects, s, __ring_ev_fail);
      effects = me[0];
  ...
  for (const field of fields) {
    ...
    __ring_match136: {
      const __ring_m136 = field_idx;
      if (__ring_m136._tag === "some") {
        const idx = __ring_m136._0;
        __ring_match137: {
          const __ring_m137 = List_get(variant.fields, idx);
          if (__ring_m137._tag === "some") {
            const ftype = __ring_m137._0;
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match138: {
    ...
    if (__ring_m138._tag === "Binding") {
      const pat_name = __ring_m138.name; const pspan = __ring_m138.span;
      __ring_match139: {
        const __ring_m139 = _Map_get(ctx.env.types.variant_to_enum, pat_name);
        if (__ring_m139._tag === "some") {
          const ve = __ring_m139._0;
          __ring_match140: {
            const __ring_m140 = _Map_get(ctx.env.types.enums, ve);
            if (__ring_m140._tag === "some") {
              const edef = __ring_m140._0;
  ...
  __ring_match142: {
    const __ring_m142 = arm.guard;
    if (__ring_m142._tag === "some") {
      const g = __ring_m142._0;
  ...
  __ring_match144: {
    const __ring_m144 = missing;
    if (__ring_m144._tag === "some") {
      const m = __ring_m144._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  let result_type = types$UNIT;
  __ring_match145: {
    const __ring_m145 = else_branch;
    if (__ring_m145._tag === "some") {
      const eb = __ring_m145._0;
      __ring_match146: {
        const __ring_m146 = eb;
        ...
        if (__ring_m146._tag === "IfExpr") {
          const ec = __ring_m146.condition; const etb = __ring_m146.then_branch; const eeb = __ring_m146.else_branch; const espan = __ring_m146.span;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  for (const part of parts) {
    __ring_match147: {
      const __ring_m147 = part;
      if (__ring_m147._tag === "LitPart") {
        const str_val = __ring_m147._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match147;
      }
      if (__ring_m147._tag === "ExprPart") {
        const expr = __ring_m147._0;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  for (const eff of effects.effects) {
    __ring_match148: {
      const __ring_m148 = eff;
      if (__ring_m148._tag === "FailEffect") {
        const et = __ring_m148.error_type;
        if (found_fail) {
  ...
  let guard_hexpr = Option_none;
  __ring_match149: {
    const __ring_m149 = arm.guard;
    if (__ring_m149._tag === "some") {
      const g = __ring_m149._0;
      const gr = infer_expr(ctx, g, s, __ring_ev_fail);
      s = gr.subst;
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(gr.hexpr), types$BOOL, s, arm.span);
      const me = infer_ctx$merge_effects(ctx.env, effects, gr.effects, s, __ring_ev_fail);
  ...
  __ring_match151: {
    const __ring_m151 = missing;
    if (__ring_m151._tag === "some") {
      const m = __ring_m151._0;
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match153: {
      const __ring_m153 = handler.resume_name;
  ...
  __match_fail(__ring_m);
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match154: {
      const __ring_m154 = handler_body_result;
      if (__ring_m154._tag === "some") {
        const hbr = __ring_m154._0;
        s = hbr.subst;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match155: {
      const __ring_m155 = expected_param_types;
      if (__ring_m155._tag === "some") {
        const epts = __ring_m155._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match156: {
            const __ring_m156 = List_get(epts, pi);
            if (__ring_m156._tag === "some") {
              const expected_t = __ring_m156._0;
    ...
    __ring_match157: {
      const __ring_m157 = lam_scheme;
      if (__ring_m157._tag === "some") {
        const ls = __ring_m157._0;
        __ring_match158: {
          const __ring_m158 = ls.def_id;
