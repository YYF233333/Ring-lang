...
function cancel_local_mut_effects(ctx, effects, callee_params, callee_effects, hargs, param_offset, s) {
                    ...
                    __ring_match9: {
                      ...
                      if (__ring_m9._tag === "Ident" && __ring_m9.def_id._tag === "some") {
                        ...
                        if ((!_Set_contains(ctx.env.scope.mut_param_defs, did, __Int_Eq))) {
                          List_push(cancel_types.value, resolved_st);
                        }
                        break __ring_match9;
                      }
                      break __ring_match9;
  ...
  if ((List_len(cancel_types.value) === 0)) {
    return effects;
  }
  const filtered = effects.effects.filter((function(e) {
  let __ring_blk0;
  __ring_match10: {
    const __ring_m10 = e;
    if (__ring_m10._tag === "MutEffect") {
      ...
      const resolved_st = env$apply_subst(s, state_type);
      __ring_blk0 = (!cancel_types.value.some((function(ct) { return types$types_equal(ct, resolved_st); })));
...
function infer_ident(ctx, name, span, subst, qualifier) {
  ...
  __ring_match30: {
    const __ring_m30 = qualifier;
    if (__ring_m30._tag === "some") {
      const q = __ring_m30._0;
      if (((q === "self") ? true : Str_starts_with(q, "super"))) {
        __ring_match31: {
          const __ring_m31 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m31._tag === "some") {
            const prefix = __ring_m31._0;
            if ((prefix === "")) {
      ...
      __ring_match33: {
        ...
        if (__ring_m33._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match34: {
              const __ring_m34 = full_scheme;
              if (__ring_m34._tag === "some") {
                const fs = __ring_m34._0;
  ...
  const scheme = env$TypeEnv_lookup(ctx.env, name);
  __ring_match35: {
    const __ring_m35 = scheme;
    if (__ring_m35._tag === "none") {
      __ring_match36: {
        const __ring_m36 = resolved_qualifier;
        if (__ring_m36._tag === "some") {
          const q = __ring_m36._0;
    ...
    if (__ring_m35._tag === "some") {
      ...
      __ring_match37: {
        ...
        if (__ring_m37._tag === "some") {
          ...
          if (_Set_contains(ctx.env.scope.mutable_vars, did, __Int_Eq)) {
            __ring_match38: {
              const __ring_m38 = _Map_get(ctx.var_lambda_depth, did);
              if (__ring_m38._tag === "some") {
                const def_depth = __ring_m38._0;
      ...
      let __ring_blk1;
      __ring_match39: {
        const __ring_m39 = _Map_get(ctx.use_aliases, name);
        if (__ring_m39._tag === "some") {
          const qualified = __ring_m39._0;
          __ring_blk1 = qualified;
      ...
      const actual_name = __ring_blk1;
      __ring_match40: {
        const __ring_m40 = resolved_qualifier;
        if (__ring_m40._tag === "some") {
          const q = __ring_m40._0;
          __ring_match41: {
            const __ring_m41 = _Map_get(ctx.env.types.enums, q);
            if (__ring_m41._tag === "some") {
              const enum_def = __ring_m41._0;
      ...
      __ring_match42: {
        const __ring_m42 = enum_name;
        if (__ring_m42._tag === "some") {
          const en = __ring_m42._0;
...
function is_value_type(t) {
  __ring_match43: {
    const __ring_m43 = t;
    if (__ring_m43._tag === "IntType") {
      return true;
      break __ring_match43;
    }
    if (__ring_m43._tag === "FloatType") {
      return true;
      break __ring_match43;
    }
    if (__ring_m43._tag === "BoolType") {
      return true;
      break __ring_match43;
    }
    if (__ring_m43._tag === "StrType") {
      return true;
      break __ring_match43;
    }
    return false;
...
function resolve_arg_bound_dict(ctx, concrete, trait_name, dicts) {
  __ring_match44: {
    ...
    if (__ring_m44._tag === "TypeVar") {
      ...
      __ring_match45: {
        const __ring_m45 = matching;
        if (__ring_m45._tag === "some") {
          const fb = __ring_m45._0;
    ...
    __ring_match46: {
      const __ring_m46 = types$type_to_builtin_name(concrete);
      if (__ring_m46._tag === "some") {
        const prim_name = __ring_m46._0;
...
function resolve_arg_dict_closure(ctx, harg, s) {
  __ring_match47: {
    const __ring_m47 = harg;
    if (__ring_m47._tag === "Ident") {
      const name = __ring_m47.name; const resolved_name = __ring_m47.resolved_name; const def_id = __ring_m47.def_id; const ty = __ring_m47.ty; const effects = __ring_m47.effects; const span = __ring_m47.span;
      const arg_scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match48: {
        const __ring_m48 = arg_scheme;
        if (__ring_m48._tag === "some") {
          const as_ = __ring_m48._0;
          if ((List_len(as_.bounds) === 0)) {
            return harg;
          }
          const var_map = infer_ctx$build_scheme_var_map(as_, ty);
          let dicts = [];
          const __ring_iter_3 = __List_Iterable.iter(as_.bounds);
          while (true) {
            ...
            __ring_match49: {
              const __ring_m49 = _Map_get(var_map, bound.type_var);
              if (__ring_m49._tag === "some") {
                const fresh_var = __ring_m49._0;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match54: {
    const __ring_m54 = _Map_get(ctx.env.trait_reg.impl_methods, type_name);
    if (__ring_m54._tag === "some") {
      const impl_methods = __ring_m54._0;
      __ring_match55: {
        const __ring_m55 = _Map_get(impl_methods, method);
...
function lookup_trait_method(ctx, type_name, method, span) {
  ...
  __ring_match56: {
    const __ring_m56 = _Map_get(ctx.env.trait_reg.trait_impls, type_name);
    if (__ring_m56._tag === "some") {
      const type_impls = __ring_m56._0;
      const __ring_iter_4 = __List_Iterable.iter(type_impls);
      while (true) {
        const __ring_next_4 = __ListIterator_Iterator.next(__ring_iter_4);
        if (__ring_next_4._tag === "none") break;
        const impl_entry = __ring_next_4._0;
        __ring_match57: {
          const __ring_m57 = _Map_get(ctx.env.trait_reg.traits, impl_entry.trait_name);
          if (__ring_m57._tag === "some") {
            const trait_def = __ring_m57._0;
            ...
            __ring_match58: {
              ...
              if (__ring_m58._tag === "some") {
                const found_method = __ring_m58._0;
                __ring_match59: {
                  const __ring_m59 = found_trait_name;
                  if (__ring_m59._tag === "some") {
                    const prev_trait = __ring_m59._0;
...
function resolve_var_id(id, sub) {
  __ring_match60: {
    const __ring_m60 = union_find$uf_lookup(sub, id);
    if (__ring_m60._tag === "some") {
      const resolved = __ring_m60._0;
      __ring_match61: {
        const __ring_m61 = resolved;
        if (__ring_m61._tag === "TypeVar") {
          const new_id = __ring_m61.id;
...
function rewrite_bare_enum_bindings(env, pattern) {
  __ring_match62: {
    const __ring_m62 = pattern;
    if (__ring_m62._tag === "Binding") {
      const name = __ring_m62.name; const span = __ring_m62.span;
      __ring_match63: {
        const __ring_m63 = _Map_get(env.types.variant_to_enum, name);
        if (__ring_m63._tag === "some") {
          const ve = __ring_m63._0;
          __ring_match64: {
            const __ring_m64 = _Map_get(env.types.enums, ve);
            if (__ring_m64._tag === "some") {
              const edef = __ring_m64._0;
              const v = env$lookup_variant(edef, name);
              __ring_match65: {
                const __ring_m65 = v;
                if (__ring_m65._tag === "some") {
                  const found_v = __ring_m65._0;
    ...
    if (__ring_m62._tag === "TuplePattern") {
      const elements = __ring_m62.elements; const span = __ring_m62.span;
      let new_elems = [];
    ...
    if (__ring_m62._tag === "Constructor") {
      const name = __ring_m62.name; const qualifier = __ring_m62.qualifier; const fields = __ring_m62.fields; const span = __ring_m62.span;
      let new_fields = [];
    ...
    if (__ring_m62._tag === "NamedConstructor") {
      const name = __ring_m62.name; const qualifier = __ring_m62.qualifier; const fields = __ring_m62.fields; const rest = __ring_m62.rest; const span = __ring_m62.span;
      let new_fields = [];
    ...
    if (__ring_m62._tag === "OrPattern") {
      const patterns = __ring_m62.patterns; const span = __ring_m62.span;
      let new_pats = [];
      const __ring_iter_8 = __List_Iterable.iter(patterns);
      while (true) {
        const __ring_next_8 = __ListIterator_Iterator.next(__ring_iter_8);
        if (__ring_next_8._tag === "none") break;
        const p = __ring_next_8._0;
...
function infer_numeric_op(ctx, left, right, s, span, op_str) {
  ...
  __ring_match66: {
    ...
    if (__ring_m66._tag === "TypeVar") {
      ...
      const __ring_iter_9 = __List_Iterable.iter(sorted_tp_scope);
      while (true) {
        ...
        __ring_match67: {
          const __ring_m67 = tp_type;
          if (__ring_m67._tag === "TypeVar") {
            const tp_id = __ring_m67.id;
...
function is_primitive_eq(t) {
  __ring_match68: {
    ...
    if (__ring_m68._tag === "BoolType") {
      return true;
      break __ring_match68;
    }
    if (__ring_m68._tag === "UnitType") {
      return true;
      break __ring_match68;
    }
    if (__ring_m68._tag === "NeverType") {
      return true;
      break __ring_match68;
    }
    if (__ring_m68._tag === "AnyType") {
      return true;
      break __ring_match68;
    }
    return false;
  ...
  __ring_match78: {
    ...
    if (__ring_m77._tag === "EnumType") {
      ...
      if (env$has_impl(ctx.env.trait_reg, name, trait_name)) {
        ...
        return hir$TraitDispatch_Direct(hir$trait_dict_name(name, trait_name), __ring_blk3);
      }
      const _ = infer_ctx$type_error(ctx.sink, error_code, `Type '${types$type_to_string(resolved)}' does not implement ${trait_name}, cannot use '${op}'`, span, diagnostics$DiagnosticContext_TraitError(`type '${types$type_to_string(resolved)}' does not implement ${trait_name}`));
      return hir$TraitDispatch_Builtin;
      break __ring_match77;
...
function is_primitive_ord(t) {
  __ring_match83: {
    const __ring_m83 = t;
    if (__ring_m83._tag === "IntType") {
      return true;
      break __ring_match83;
    }
    if (__ring_m83._tag === "FloatType") {
      return true;
      break __ring_match83;
    }
    if (__ring_m83._tag === "StrType") {
      return true;
      break __ring_match83;
    }
    if (__ring_m83._tag === "BoolType") {
      return true;
      break __ring_match83;
    }
    return false;
...
function infer_index_expr(ctx, receiver, index, span, subst, __ring_ev_fail) {
  ...
  __ring_match84: {
    const __ring_m84 = recv_type;
    if (__ring_m84._tag === "StructType") {
      const name = __ring_m84.name; const type_params = __ring_m84.type_params;
    ...
    if (__ring_m84._tag === "StrType") {
      s = infer_ctx$unify_at(ctx.sink, ctx.env, idx_type, types$INT, s, span);
      result_ty = types$STR;
      break __ring_match84;
    }
    if (__ring_m84._tag === "ErrorType") {
      result_ty = types$Type_ErrorType;
      break __ring_match84;
    }
    const _ = infer_ctx$type_error(ctx.sink, codes$E0306, `Type '${types$type_to_string(recv_type)}' does not support indexing`, span, diagnostics$DiagnosticContext_OtherContext(Option_some("only List, Map, and Str support subscript operator []")));
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  while (true) {
    ...
    const handler = __ring_next_12._0;
    ...
    __ring_match85: {
      const __ring_m85 = effect_def;
      if (__ring_m85._tag === "some") {
        const ed = __ring_m85._0;
        const __ring_iter_13 = __List_Iterable.iter(ed.type_param_vars);
        while (true) {
          const __ring_next_13 = __ListIterator_Iterator.next(__ring_iter_13);
          if (__ring_next_13._tag === "none") break;
          const tpv = __ring_next_13._0;
    ...
    __ring_match86: {
      const __ring_m86 = effect_def;
      if (__ring_m86._tag === "some") {
        const ed = __ring_m86._0;
    ...
    let hparams = [];
    let hi = 0;
    const __ring_iter_14 = __List_Iterable.iter(handler.params);
    while (true) {
      ...
      let __ring_blk4;
      __ring_match87: {
        const __ring_m87 = p.type_annotation;
        if (__ring_m87._tag === "some") {
          const ta = __ring_m87._0;
          __ring_blk4 = infer_ctx$resolve_type_expr(ctx, ta);
          break __ring_match87;
        }
        if (__ring_m87._tag === "none") {
          let __ring_blk5;
          __ring_match88: {
            const __ring_m88 = op_def;
            if (__ring_m88._tag === "some") {
              const od = __ring_m88._0;
              let __ring_blk6;
              __ring_match89: {
                const __ring_m89 = List_get(od.params, hi);
                if (__ring_m89._tag === "some") {
                  const odt = __ring_m89._0;
                  __ring_blk6 = env$apply_subst_map(handler_inst_map, odt);
            ...
            if (__ring_m88._tag === "none") {
              __ring_blk5 = env$TypeEnv_fresh_var(ctx.env);
              break __ring_match88;
            }
            __match_fail(__ring_m88);
          }
          __ring_blk4 = __ring_blk5;
          break __ring_match87;
        }
        __match_fail(__ring_m87);
      }
      const pt = __ring_blk4;
      env$TypeEnv_bind_mono(ctx.env, p.name, pt);
      List_push(hparams, new hir$HParam(p.name, pt, Option_none, false));
      hi = (hi + 1);
    }
    __ring_match90: {
      const __ring_m90 = handler.resume_name;
      if (__ring_m90._tag === "some") {
        const rn = __ring_m90._0;
        let __ring_blk7;
        __ring_match91: {
          const __ring_m91 = op_def;
          if (__ring_m91._tag === "some") {
            const od = __ring_m91._0;
            __ring_blk7 = env$apply_subst_map(handler_inst_map, od.return_type);
        ...
        const resume_param = __ring_blk7;
    ...
    __ring_match92: {
      const __ring_m92 = handler_body_result;
      if (__ring_m92._tag === "some") {
        const hbr = __ring_m92._0;
        s = hbr.subst;
  ...
  const __ring_iter_15 = __List_Iterable.iter(resolved_effects.effects);
  while (true) {
    ...
    __ring_match93: {
      const __ring_m93 = e;
      if (__ring_m93._tag === "IoEffect") {
        __ring_blk8 = (!_Set_contains(handled_effects, "io", __Str_Eq));
        break __ring_match93;
      }
      if (__ring_m93._tag === "CustomEffect") {
        const name = __ring_m93.name;
        __ring_blk8 = (!_Set_contains(handled_effects, name, __Str_Eq));
        break __ring_match93;
      }
      if (__ring_m93._tag === "FailEffect") {
        __ring_blk8 = (!_Set_contains(handled_effects, "fail", __Str_Eq));
        break __ring_match93;
      }
      if (__ring_m93._tag === "MutEffect") {
        __ring_blk8 = (!_Set_contains(handled_effects, "mut", __Str_Eq));
        break __ring_match93;
      }
      __match_fail(__ring_m93);
    }
    const should_keep = __ring_blk8;
    if (should_keep) {
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  const __ring_iter_16 = __List_Iterable.iter(effects.effects);
  while (true) {
    const __ring_next_16 = __ListIterator_Iterator.next(__ring_iter_16);
    if (__ring_next_16._tag === "none") break;
    const eff = __ring_next_16._0;
    __ring_match94: {
      const __ring_m94 = eff;
      if (__ring_m94._tag === "FailEffect") {
        const et = __ring_m94.error_type;
        if (found_fail) {
  ...
  let __ring_blk9;
  __ring_match95: {
    const __ring_m95 = resolved_row.tail;
  ...
  const has_open_tail = __ring_blk9;
  ...
  __ring_match96: {
    const __ring_m96 = arm.guard;
    if (__ring_m96._tag === "some") {
      const g = __ring_m96._0;
  ...
  __ring_match98: {
    const __ring_m98 = missing;
    if (__ring_m98._tag === "some") {
      const m = __ring_m98._0;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  let hparts = [];
  const __ring_iter_18 = __List_Iterable.iter(parts);
  while (true) {
    const __ring_next_18 = __ListIterator_Iterator.next(__ring_iter_18);
    if (__ring_next_18._tag === "none") break;
    const part = __ring_next_18._0;
    __ring_match99: {
      const __ring_m99 = part;
      if (__ring_m99._tag === "LitPart") {
        const str_val = __ring_m99._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match99;
      }
      if (__ring_m99._tag === "ExprPart") {
        const expr = __ring_m99._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  __ring_match100: {
    const __ring_m100 = else_branch;
    if (__ring_m100._tag === "some") {
      const eb = __ring_m100._0;
      __ring_match101: {
        const __ring_m101 = eb;
        if (__ring_m101._tag === "Block") {
        ...
        if (__ring_m101._tag === "IfExpr") {
          const ec = __ring_m101.condition; const etb = __ring_m101.then_branch; const eeb = __ring_m101.else_branch; const espan = __ring_m101.span;
...
function infer_stmt(ctx, stmt, subst, __ring_ev_fail) {
  __ring_match102: {
    const __ring_m102 = stmt;
    if (__ring_m102._tag === "Let") {
      const name = __ring_m102.name; const name_span = __ring_m102.name_span; const type_annotation = __ring_m102.type_annotation; const init = __ring_m102.init; const span = __ring_m102.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      let var_type = hir$hexpr_type(init_r.hexpr);
      __ring_match103: {
        const __ring_m103 = type_annotation;
        if (__ring_m103._tag === "some") {
          const ta = __ring_m103._0;
      ...
      let __ring_blk10;
      __ring_match104: {
        const __ring_m104 = bound_scheme;
        if (__ring_m104._tag === "some") {
          const bs = __ring_m104._0;
          let __ring_blk11;
          __ring_match105: {
            const __ring_m105 = bs.def_id;
            if (__ring_m105._tag === "some") {
              const did = __ring_m105._0;
      ...
      const bound_def_id = __ring_blk10;
    ...
    if (__ring_m102._tag === "Var") {
      const name = __ring_m102.name; const name_span = __ring_m102.name_span; const type_annotation = __ring_m102.type_annotation; const init = __ring_m102.init; const span = __ring_m102.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      let var_type = hir$hexpr_type(init_r.hexpr);
      __ring_match106: {
        const __ring_m106 = type_annotation;
        if (__ring_m106._tag === "some") {
          const ta = __ring_m106._0;
          const annotated = infer_ctx$resolve_type_expr(ctx, ta);
          const notes = [new diagnostics$DiagnosticNote(`expected '${types$type_to_string(annotated)}' because variable '${name}' is declared with this type`, Option_some(name_span)), new diagnostics$DiagnosticNote(`initializer has type '${types$type_to_string(env$apply_subst(s, var_type))}'`, Option_some(hir$hexpr_span(init_r.hexpr)))];
          s = infer_ctx$unify_at_noted(ctx.sink, ctx.env, var_type, annotated, s, span, notes);
          var_type = env$apply_subst(s, annotated);
      ...
      __ring_match107: {
        const __ring_m107 = var_scheme;
        if (__ring_m107._tag === "some") {
          const vs = __ring_m107._0;
          __ring_match108: {
            const __ring_m108 = vs.def_id;
            if (__ring_m108._tag === "some") {
              const did = __ring_m108._0;
              env$TypeEnv_record_def_span(ctx.env, did, name_span);
    ...
    if (__ring_m102._tag === "Assign") {
      const target = __ring_m102.target; const value = __ring_m102.value; const span = __ring_m102.span;
    ...
    if (__ring_m102._tag === "ExprStmt") {
      const expr = __ring_m102.expr; const span = __ring_m102.span;
      const r = infer_expr(ctx, expr, subst, __ring_ev_fail);
      return new StmtResult(hir$HStmt_ExprStmt(r.hexpr, span), r.subst, r.effects);
      break __ring_match102;
    }
    if (__ring_m102._tag === "Return") {
      const value = __ring_m102.value; const span = __ring_m102.span;
      __ring_match109: {
        const __ring_m109 = value;
        if (__ring_m109._tag === "some") {
          const v = __ring_m109._0;
          const r = infer_expr(ctx, v, subst, __ring_ev_fail);
          let s = r.subst;
          __ring_match110: {
            const __ring_m110 = ctx.current_fn_return_type;
            if (__ring_m110._tag === "some") {
              const ret_type = __ring_m110._0;
        ...
        if (__ring_m109._tag === "none") {
          let s = subst;
          __ring_match111: {
            const __ring_m111 = ctx.current_fn_return_type;
            if (__ring_m111._tag === "some") {
              const ret_type = __ring_m111._0;
    ...
    if (__ring_m102._tag === "While") {
      const condition = __ring_m102.condition; const body = __ring_m102.body; const span = __ring_m102.span;
      const cond_r = infer_expr(ctx, condition, subst, __ring_ev_fail);
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match112: {
        const __ring_m112 = body_result;
        if (__ring_m112._tag === "some") {
          const body_r = __ring_m112._0;
          s = body_r.subst;
    ...
    if (__ring_m102._tag === "ForIn") {
      const binding = __ring_m102.binding; const binding_span = __ring_m102.binding_span; const destructure = __ring_m102.destructure; const iterable = __ring_m102.iterable; const body = __ring_m102.body; const span = __ring_m102.span;
      ...
      let __ring_blk12;
      __ring_match113: {
        const __ring_m113 = iter_type;
        if (__ring_m113._tag === "EnumType") {
          const name = __ring_m113.name;
          __ring_blk12 = (name === hir$BUILTIN_RANGE);
          break __ring_match113;
        }
        __ring_blk12 = false;
        break __ring_match113;
      }
      const is_range = __ring_blk12;
      if (is_range) {
        __ring_match114: {
          const __ring_m114 = iter_type;
          if (__ring_m114._tag === "EnumType") {
            const type_params = __ring_m114.type_params;
            let __ring_blk13;
            __ring_match115: {
              const __ring_m115 = List_first(type_params);
              ...
              if (__ring_m115._tag === "none") {
                __ring_blk13 = types$INT;
                break __ring_match115;
              }
              __match_fail(__ring_m115);
            }
            element_type = __ring_blk13;
        ...
        __ring_match116: {
          const __ring_m116 = type_name;
          if (__ring_m116._tag === "some") {
            const tn = __ring_m116._0;
            const iterable_impl = env$find_impl(ctx.env.trait_reg, tn, "Iterable");
            __ring_match117: {
              const __ring_m117 = iterable_impl;
              if (__ring_m117._tag === "some") {
                const impl_entry = __ring_m117._0;
                iterable_type_name = Option_some(tn);
                __ring_match118: {
                  const __ring_m118 = _Map_get(impl_entry.assoc_types, "Iter");
                  if (__ring_m118._tag === "some") {
                    const iter_assoc_ty = __ring_m118._0;
                    let __ring_blk14;
                    __ring_match119: {
                      const __ring_m119 = iter_type;
                      if (__ring_m119._tag === "StructType") {
                        const tps = __ring_m119.type_params;
                        __ring_blk14 = tps;
                        break __ring_match119;
                      }
                      if (__ring_m119._tag === "EnumType") {
                        const tps = __ring_m119.type_params;
                        __ring_blk14 = tps;
                        break __ring_match119;
                      }
                    ...
                    const concrete_type_params = __ring_blk14;
                    const concrete_iter_name = types$type_to_builtin_name(iter_assoc_ty);
                    __ring_match120: {
                      const __ring_m120 = concrete_iter_name;
                      if (__ring_m120._tag === "some") {
                        const itn = __ring_m120._0;
                        ...
                        __ring_match121: {
                          const __ring_m121 = iterator_impl;
                          if (__ring_m121._tag === "some") {
                            const iter_impl_entry = __ring_m121._0;
                            __ring_match122: {
                              const __ring_m122 = _Map_get(iter_impl_entry.assoc_types, "Item");
                              if (__ring_m122._tag === "some") {
                                const item_assoc_ty = __ring_m122._0;
                                const item_name = types$type_to_builtin_name(item_assoc_ty);
                                __ring_match123: {
                                  const __ring_m123 = item_assoc_ty;
                                  if (__ring_m123._tag === "TypeVar") {
                                    let __ring_blk15;
                                    __ring_match124: {
                                      const __ring_m124 = List_first(concrete_type_params);
                                      if (__ring_m124._tag === "some") {
                                        const ct = __ring_m124._0;
                                        __ring_blk15 = ct;
                                        break __ring_match124;
                                      }
                                      if (__ring_m124._tag === "none") {
                                        __ring_blk15 = element_type;
                                        break __ring_match124;
                                      }
                                      __match_fail(__ring_m124);
                                    }
                                    element_type = __ring_blk15;
                                    break __ring_match123;
                                  }
                                  if (__ring_m123._tag === "TupleType") {
                                    const elements = __ring_m123.elements;
                                    let concrete_elems = [];
                                    let ei = 0;
                                    const __ring_iter_19 = __List_Iterable.iter(elements);
                                    while (true) {
                                      const __ring_next_19 = __ListIterator_Iterator.next(__ring_iter_19);
                                      if (__ring_next_19._tag === "none") break;
                                      const elem = __ring_next_19._0;
                                      __ring_match125: {
                                        const __ring_m125 = elem;
                                        if (__ring_m125._tag === "TypeVar") {
                                          __ring_match126: {
                                            const __ring_m126 = List_get(concrete_type_params, ei);
                                            if (__ring_m126._tag === "some") {
                                              const ct = __ring_m126._0;
      ...
      __ring_match127: {
        const __ring_m127 = destructure;
        if (__ring_m127._tag === "some") {
          const destr = __ring_m127._0;
          __ring_match128: {
            const __ring_m128 = element_type;
            if (__ring_m128._tag === "TupleType") {
              const type_elems = __ring_m128.elements;
          ...
          while ((di < List_len(destr.names))) {
            __ring_match129: {
              const __ring_m129 = List_get(destr.names, di);
              if (__ring_m129._tag === "some") {
                const dname = __ring_m129._0;
                let __ring_blk16;
                __ring_match130: {
                  const __ring_m130 = element_type;
                  if (__ring_m130._tag === "TupleType") {
                    const type_elems = __ring_m130.elements;
                    let __ring_blk17;
                    __ring_match131: {
                      const __ring_m131 = List_get(type_elems, di);
                      if (__ring_m131._tag === "some") {
                        const et = __ring_m131._0;
                        __ring_blk17 = et;
                ...
                const elem_t = __ring_blk16;
                env$TypeEnv_bind_mono(ctx.env, dname, elem_t);
                const dscheme = env$TypeEnv_lookup(ctx.env, dname);
                __ring_match132: {
                  const __ring_m132 = dscheme;
                  if (__ring_m132._tag === "some") {
                    const ds = __ring_m132._0;
                    __ring_match133: {
                      const __ring_m133 = [ds.def_id, List_get(destr.spans, di)];
                      if (Array.isArray(__ring_m133) && __ring_m133.length === 2 && __ring_m133[0]._tag === "some" && __ring_m133[1]._tag === "some") {
                        const did = __ring_m133[0]._0; const dspan = __ring_m133[1]._0;
      ...
      __ring_match134: {
        const __ring_m134 = binding_scheme;
        if (__ring_m134._tag === "some") {
          const bs = __ring_m134._0;
          __ring_match135: {
            const __ring_m135 = bs.def_id;
            if (__ring_m135._tag === "some") {
              const did = __ring_m135._0;
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match136: {
        const __ring_m136 = body_result;
        if (__ring_m136._tag === "some") {
          const body_r = __ring_m136._0;
          s = body_r.subst;
          const me = infer_ctx$merge_effects(ctx.env, iter_r.effects, body_r.effects, s, __ring_ev_fail);
          let __ring_blk18;
          __ring_match137: {
            const __ring_m137 = binding_scheme;
            if (__ring_m137._tag === "some") {
              const bs = __ring_m137._0;
              __ring_blk18 = bs.def_id;
              break __ring_match137;
            }
            if (__ring_m137._tag === "none") {
              __ring_blk18 = Option_none;
              break __ring_match137;
            }
            __match_fail(__ring_m137);
          }
          return new StmtResult(hir$HStmt_ForIn(binding, binding_span, __ring_blk18, hdestructure, iter_r.hexpr, body_r.hexpr, iterable_type_name, iter_type_name, span), me[1], me[0]);
    ...
    if (__ring_m102._tag === "Break") {
      const span = __ring_m102.span;
      if ((ctx.loop_depth === 0)) {
    ...
    if (__ring_m102._tag === "LetDestructure") {
      const pattern = __ring_m102.pattern; const init = __ring_m102.init; const span = __ring_m102.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      const init_type = env$apply_subst(s, hir$hexpr_type(init_r.hexpr));
      __ring_match138: {
        const __ring_m138 = init_type;
        if (__ring_m138._tag === "TupleType") {
      ...
      let __ring_blk19;
      __ring_match139: {
        const __ring_m139 = init_type;
        if (__ring_m139._tag === "TupleType") {
          const elements = __ring_m139.elements;
          __ring_blk19 = elements;
          break __ring_match139;
        }
        __ring_blk19 = [];
        break __ring_match139;
      }
      const tuple_elements = __ring_blk19;
      __ring_match140: {
        const __ring_m140 = pattern;
        if (__ring_m140._tag === "TuplePattern") {
          const pat_elements = __ring_m140.elements;
          ...
          while ((bi < List_len(pat_elements))) {
            __ring_match141: {
              const __ring_m141 = List_get(pat_elements, bi);
              if (__ring_m141._tag === "some") {
                const p = __ring_m141._0;
                let __ring_blk20;
                __ring_match142: {
                  const __ring_m142 = List_get(tuple_elements, bi);
                  if (__ring_m142._tag === "some") {
                    const et = __ring_m142._0;
                    __ring_blk20 = et;
                    break __ring_match142;
                  }
                  if (__ring_m142._tag === "none") {
                    __ring_blk20 = types$UNIT;
                    break __ring_match142;
                  }
                  __match_fail(__ring_m142);
                }
                const elem_type = __ring_blk20;
                __ring_match143: {
                  const __ring_m143 = p;
                  if (__ring_m143._tag === "Binding") {
                    const name = __ring_m143.name; const pspan = __ring_m143.span;
                    env$TypeEnv_bind_mono(ctx.env, name, elem_type);
                    const bscheme = env$TypeEnv_lookup(ctx.env, name);
                    __ring_match144: {
                      const __ring_m144 = bscheme;
                      if (__ring_m144._tag === "some") {
                        const bs = __ring_m144._0;
                        __ring_match145: {
                          const __ring_m145 = bs.def_id;
                          if (__ring_m145._tag === "some") {
                            const did = __ring_m145._0;
    ...
    if (__ring_m102._tag === "IfLet") {
      const pattern = __ring_m102.pattern; const expr = __ring_m102.expr; const then_block = __ring_m102.then_block; const else_block = __ring_m102.else_block; const span = __ring_m102.span;
      const expr_r = infer_expr(ctx, expr, subst, __ring_ev_fail);
      let s = expr_r.subst;
  ...
  return infer_block(ctx, then_block, Option_some(s), __ring_ev_fail);
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match146: {
        const __ring_m146 = then_result;
        if (__ring_m146._tag === "some") {
          const then_r = __ring_m146._0;
          s = then_r.subst;
          ...
          __ring_match147: {
            ...
            if (__ring_m147._tag === "some") {
              ...
              env$TypeEnv_pop_scope(ctx.env);
              __ring_match148: {
                const __ring_m148 = else_result;
                if (__ring_m148._tag === "some") {
                  const else_r = __ring_m148._0;
                  s = else_r.subst;
...
function infer_block(ctx, body, initial_subst, __ring_ev_fail) {
  __ring_match149: {
    const __ring_m149 = body;
    if (__ring_m149._tag === "Block") {
      const stmts = __ring_m149.stmts; const tail = __ring_m149.tail; const span = __ring_m149.span;
      let __ring_blk21;
      __ring_match150: {
        const __ring_m150 = initial_subst;
        ...
        if (__ring_m150._tag === "none") {
          __ring_blk21 = ctx.subst;
          break __ring_match150;
        }
        __match_fail(__ring_m150);
      }
      let subst = __ring_blk21;
      let effects = types$EMPTY_ROW;
      let hstmts = [];
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  let guard_hexpr = Option_none;
  __ring_match152: {
    const __ring_m152 = arm.guard;
    if (__ring_m152._tag === "some") {
      const g = __ring_m152._0;
      const gr = infer_expr(ctx, g, s, __ring_ev_fail);
      s = gr.subst;
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(gr.hexpr), types$BOOL, s, arm.span);
      const me = infer_ctx$merge_effects(ctx.env, effects, gr.effects, s, __ring_ev_fail);
  ...
  __ring_match154: {
    const __ring_m154 = missing;
    if (__ring_m154._tag === "some") {
      const m = __ring_m154._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  let __ring_blk22;
  __ring_match155: {
    const __ring_m155 = variant.field_names;
    if (__ring_m155._tag === "some") {
      const fn_ = __ring_m155._0;
      __ring_blk22 = fn_;
  ...
  const field_names = __ring_blk22;
  let inst_map = map_new();
  let type_param_types = [];
  let tpi = 0;
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match156: {
      const __ring_m156 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m156._tag === "some") {
        const var_id = __ring_m156._0;
  ...
  while (true) {
    ...
    __ring_match158: {
      const __ring_m158 = field_idx;
      if (__ring_m158._tag === "some") {
        const idx = __ring_m158._0;
        __ring_match159: {
          const __ring_m159 = List_get(variant.fields, idx);
          if (__ring_m159._tag === "some") {
            const ftype = __ring_m159._0;
  ...
  if (Option_is_none(spread)) {
    ...
    const __ring_iter_23 = __List_Iterable.iter(fields);
    while (true) {
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  let resolved_qualifier = qualifier;
  __ring_match160: {
    const __ring_m160 = qualifier;
    if (__ring_m160._tag === "some") {
      const q = __ring_m160._0;
      if (((q === "self") ? true : Str_starts_with(q, "super"))) {
        __ring_match161: {
          const __ring_m161 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m161._tag === "some") {
            const prefix = __ring_m161._0;
            if ((prefix === "")) {
              resolved_qualifier = Option_none;
            } else {
              resolved_qualifier = Option_some(prefix);
  ...
  __ring_match165: {
    const __ring_m165 = resolved_qualifier;
    if (__ring_m165._tag === "some") {
      const q = __ring_m165._0;
      __ring_match166: {
        const __ring_m166 = _Map_get(ctx.env.types.enums, q);
        if (__ring_m166._tag === "some") {
          const enum_def = __ring_m166._0;
          if (_Map_contains_key(enum_def.variant_index, name)) {
        ...
        if (__ring_m166._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match167: {
              const __ring_m167 = _Map_get(ctx.env.types.enums, full_q);
              if (__ring_m167._tag === "some") {
                const enum_def = __ring_m167._0;
                if (_Map_contains_key(enum_def.variant_index, name)) {
                  variant_enum = Option_some(enum_def.name);
                }
  ...
  if ((Option_is_none(variant_enum) ? Option_is_some(resolved_qualifier) : false)) {
    __ring_match168: {
      const __ring_m168 = resolved_qualifier;
      if (__ring_m168._tag === "some") {
        const q = __ring_m168._0;
        const _ = infer_ctx$type_error(ctx.sink, codes$E0201, `'${q}' has no variant '${name}'`, span, diagnostics$DiagnosticContext_UndefinedVariable(name, Option_none));
  ...
  __ring_match169: {
    const __ring_m169 = variant_enum;
    if (__ring_m169._tag === "some") {
      const ve = __ring_m169._0;
      __ring_match170: {
        const __ring_m170 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m170._tag === "some") {
          const enum_def = __ring_m170._0;
          const variant = env$lookup_variant(enum_def, name);
          __ring_match171: {
            const __ring_m171 = variant;
            if (__ring_m171._tag === "some") {
              const v = __ring_m171._0;
              __ring_match172: {
                const __ring_m172 = v.field_names;
  ...
  __ring_match173: {
    const __ring_m173 = struct_def_opt;
  ...
  let __ring_blk23;
  __ring_match174: {
    const __ring_m174 = struct_def_opt;
    if (__ring_m174._tag === "some") {
      const sd = __ring_m174._0;
      __ring_blk23 = sd;
      break __ring_match174;
    }
    if (__ring_m174._tag === "none") {
      __ring_blk23 = panic("unreachable: struct_def_opt after none early return");
      break __ring_match174;
    }
    __match_fail(__ring_m174);
  }
  const struct_def = __ring_blk23;
  let inst_map = map_new();
  let type_param_types = [];
  let tpi = 0;
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match175: {
      const __ring_m175 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m175._tag === "some") {
        const var_id = __ring_m175._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  let hspread = Option_none;
  __ring_match176: {
    const __ring_m176 = spread;
    if (__ring_m176._tag === "some") {
      const sp = __ring_m176._0;
      const sr = infer_expr(ctx, sp, s, __ring_ev_fail);
      s = sr.subst;
      const me = infer_ctx$merge_effects(ctx.env, effects, sr.effects, s, __ring_ev_fail);
      effects = me[0];
      s = me[1];
      let spread_fields = [];
      const __ring_iter_25 = __List_Iterable.iter(struct_def.fields);
      while (true) {
  ...
  while (true) {
    ...
    __ring_match177: {
      const __ring_m177 = def_field;
      if (__ring_m177._tag === "some") {
        const df = __ring_m177._0;
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match178: {
    ...
    if (__ring_m178._tag === "StructType") {
      const name = __ring_m178.name; const type_params = __ring_m178.type_params;
      __ring_match179: {
        const __ring_m179 = _Map_get(ctx.env.types.structs, name);
        if (__ring_m179._tag === "some") {
          const struct_def = __ring_m179._0;
          ...
          __ring_match180: {
            ...
            if (__ring_m180._tag === "some") {
              const found_field = __ring_m180._0;
              let inst_map = map_new();
              let fi = 0;
              while (((fi < List_len(struct_def.type_param_vars)) ? (fi < List_len(type_params)) : false)) {
                __ring_match181: {
                  const __ring_m181 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m181) && __ring_m181.length === 2 && __ring_m181[0]._tag === "some" && __ring_m181[1]._tag === "some") {
                    const var_id = __ring_m181[0]._0; const tp = __ring_m181[1]._0;
    ...
    if (__ring_m178._tag === "RecordType") {
      const rec_fields = __ring_m178.fields; const tail = __ring_m178.tail;
    ...
    if (__ring_m178._tag === "TupleType") {
      const elements = __ring_m178.elements;
      __ring_match184: {
        const __ring_m184 = parse_int(field);
        ...
        if (__ring_m184._tag === "some") {
          ...
          __ring_match185: {
            const __ring_m185 = List_get(elements, i);
            if (__ring_m185._tag === "some") {
              const t = __ring_m185._0;
              field_type = t;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match186: {
    const __ring_m186 = effect_def_opt;
  ...
  let __ring_blk24;
  __ring_match187: {
    const __ring_m187 = effect_def_opt;
    if (__ring_m187._tag === "some") {
      const ed = __ring_m187._0;
      __ring_blk24 = ed;
      break __ring_match187;
    }
    if (__ring_m187._tag === "none") {
      __ring_blk24 = panic("unreachable: effect_def_opt after none early return");
      break __ring_match187;
    }
    __match_fail(__ring_m187);
  }
  const effect_def = __ring_blk24;
  ...
  let __ring_blk25;
  __ring_match189: {
    const __ring_m189 = op_opt;
    if (__ring_m189._tag === "some") {
      const o = __ring_m189._0;
      __ring_blk25 = o;
      break __ring_match189;
    }
    if (__ring_m189._tag === "none") {
      __ring_blk25 = panic("unreachable: op_opt after none early return");
      break __ring_match189;
    }
    __match_fail(__ring_m189);
  }
  const op = __ring_blk25;
  let inst_map = map_new();
  let inst_type_args = [];
  let tpi = 0;
  const __ring_iter_29 = __List_Iterable.iter(effect_def.type_param_vars);
  while (true) {
  ...
  while (true) {
    ...
    __ring_match190: {
      const __ring_m190 = List_get(inst_params, i);
      if (__ring_m190._tag === "some") {
        const param_type = __ring_m190._0;
  ...
  __ring_match191: {
    const __ring_m191 = effect_def.built_in_kind;
    if (__ring_m191._tag === "some") {
      const bik = __ring_m191._0;
      __ring_match192: {
        const __ring_m192 = bik;
        if (__ring_m192._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match192;
        }
        if (__ring_m192._tag === "BkFail") {
          let __ring_blk26;
          __ring_match193: {
            const __ring_m193 = List_first(hargs);
            if (__ring_m193._tag === "some") {
              const h = __ring_m193._0;
              __ring_blk26 = h;
              break __ring_match193;
            }
            if (__ring_m193._tag === "none") {
              __ring_blk26 = panic("unreachable: hargs.first() after len > 0 check");
              break __ring_match193;
            }
            __match_fail(__ring_m193);
          }
          const error_type = ((List_len(hargs) > 0) ? env$apply_subst(s, hir$hexpr_type(__ring_blk26)) : types$UNIT);
          eff = types$Effect_FailEffect(error_type);
          break __ring_match192;
        }
        if (__ring_m192._tag === "BkMut") {
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match194: {
    const __ring_m194 = receiver;
    if (__ring_m194._tag === "Ident") {
      const recv_name = __ring_m194.name; const qualifier = __ring_m194.qualifier;
      let __ring_blk27;
      __ring_match195: {
        const __ring_m195 = qualifier;
        if (__ring_m195._tag === "some") {
          const q = __ring_m195._0;
          __ring_blk27 = `${q}::${recv_name}`;
          break __ring_match195;
        }
        if (__ring_m195._tag === "none") {
          __ring_blk27 = recv_name;
          break __ring_match195;
        }
        __match_fail(__ring_m195);
      }
      const full_effect_name = __ring_blk27;
      __ring_match196: {
        const __ring_m196 = _Map_get(ctx.env.types.effects, full_effect_name);
  ...
  if (is_mut_method_call(ctx, recv_type, method)) {
    __ring_match197: {
      const __ring_m197 = get_expr_def_id(ctx, receiver);
      if (__ring_m197._tag === "some") {
        const did = __ring_m197._0;
        if (_Set_contains(ctx.env.scope.mut_param_defs, did, __Int_Eq)) {
  ...
  if (Option_is_none(method_type)) {
    __ring_match199: {
      const __ring_m199 = types$type_to_builtin_name(recv_type);
      if (__ring_m199._tag === "some") {
        const prim_name = __ring_m199._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match200: {
      const __ring_m200 = types$type_to_builtin_name(recv_type);
      if (__ring_m200._tag === "some") {
        const type_name = __ring_m200._0;
  ...
  let __ring_blk28;
  __ring_match201: {
    const __ring_m201 = recv_raw_type;
    if (__ring_m201._tag === "TypeVar") {
      const id = __ring_m201.id;
      __ring_blk28 = Option_some(resolve_var_id(id, s));
      break __ring_match201;
    }
    __ring_blk28 = Option_none;
    break __ring_match201;
  }
  const recv_var_id = __ring_blk28;
  if (Option_is_none(method_type)) {
    __ring_match202: {
      const __ring_m202 = recv_var_id;
      if (__ring_m202._tag === "some") {
        const rvid = __ring_m202._0;
        const __ring_iter_32 = __List_Iterable.iter(ctx.current_fn_bounds);
        while (true) {
          const __ring_next_32 = __ListIterator_Iterator.next(__ring_iter_32);
          if (__ring_next_32._tag === "none") break;
          const fb = __ring_next_32._0;
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match203: {
              const __ring_m203 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m203._tag === "some") {
                const trait_def = __ring_m203._0;
                const tm = ((__a) => { const __i = __a.findIndex((function(m) { return (m.name === method); })); return __i >= 0 ? { _tag: "some", _0: __a[__i] } : { _tag: "none" }; })(trait_def.methods);
                __ring_match204: {
                  const __ring_m204 = tm;
                  if (__ring_m204._tag === "some") {
                    const found_method = __ring_m204._0;
  ...
  __ring_match205: {
    const __ring_m205 = method_type;
    if (__ring_m205._tag === "some") {
      const mt = __ring_m205._0;
      __ring_match206: {
        const __ring_m206 = mt;
        if (__ring_m206._tag === "FnType") {
          const mt_params = __ring_m206.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match207: {
              const __ring_m207 = List_first(mt_params);
              if (__ring_m207._tag === "some") {
                const first_param = __ring_m207._0;
  ...
  while (true) {
    ...
    const arg = __ring_next_33._0;
    let __ring_blk29;
    __ring_match208: {
      const __ring_m208 = arg;
      if (__ring_m208._tag === "Lambda") {
        const lparams = __ring_m208.params; const lbody = __ring_m208.body; const lspan = __ring_m208.span;
        let __ring_blk30;
        __ring_match209: {
          const __ring_m209 = method_type;
          if (__ring_m209._tag === "some") {
            const mt = __ring_m209._0;
            let __ring_blk31;
            __ring_match210: {
              const __ring_m210 = mt;
              if (__ring_m210._tag === "FnType") {
                const mt_params = __ring_m210.params;
                let __ring_blk32;
                __ring_match211: {
                  const __ring_m211 = List_get(mt_params, (ai + 1));
                  if (__ring_m211._tag === "some") {
                    const expected_raw = __ring_m211._0;
                    const expected = env$apply_subst(s, expected_raw);
                    let __ring_blk33;
                    __ring_match212: {
                      const __ring_m212 = expected;
                      if (__ring_m212._tag === "FnType") {
                        const exp_params = __ring_m212.params;
                        __ring_blk33 = infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
                        break __ring_match212;
                      }
                      __ring_blk33 = infer_expr(ctx, arg, s, __ring_ev_fail);
                      break __ring_match212;
                    }
                  ...
                  if (__ring_m211._tag === "none") {
                    __ring_blk32 = infer_expr(ctx, arg, s, __ring_ev_fail);
                    break __ring_match211;
                  }
                  __match_fail(__ring_m211);
                }
                __ring_blk31 = (((ai + 1) < List_len(mt_params)) ? __ring_blk32 : infer_expr(ctx, arg, s, __ring_ev_fail));
                break __ring_match210;
              }
              __ring_blk31 = infer_expr(ctx, arg, s, __ring_ev_fail);
              break __ring_match210;
            }
          ...
          if (__ring_m209._tag === "none") {
            __ring_blk30 = infer_expr(ctx, arg, s, __ring_ev_fail);
            break __ring_match209;
          }
      ...
      __ring_blk29 = infer_expr(ctx, arg, s, __ring_ev_fail);
      break __ring_match208;
    }
    let ar = __ring_blk29;
    s = ar.subst;
  ...
  __ring_match213: {
    const __ring_m213 = method_type;
    if (__ring_m213._tag === "some") {
      const mt = __ring_m213._0;
      __ring_match214: {
        const __ring_m214 = mt;
        if (__ring_m214._tag === "FnType") {
          const mt_params = __ring_m214.params; const mt_ret = __ring_m214.return_type; const mt_effects = __ring_m214.effects;
          let i = 0;
          const __ring_iter_34 = __List_Iterable.iter(hargs);
          while (true) {
            const __ring_next_34 = __ListIterator_Iterator.next(__ring_iter_34);
            if (__ring_next_34._tag === "none") break;
            const harg = __ring_next_34._0;
            if (((i + 1) < List_len(mt_params))) {
              __ring_match215: {
                const __ring_m215 = List_get(mt_params, (i + 1));
                if (__ring_m215._tag === "some") {
                  const expected_param = __ring_m215._0;
        ...
        __ring_match216: {
          const __ring_m216 = recv_type;
          if (__ring_m216._tag === "TypeVar") {
    ...
    if (__ring_m213._tag === "none") {
      __ring_match217: {
        const __ring_m217 = recv_type;
        if (__ring_m217._tag === "TypeVar") {
  ...
  let resolved_dicts = [];
  __ring_match218: {
    const __ring_m218 = method_scheme;
    if (__ring_m218._tag === "some") {
      const ms = __ring_m218._0;
      if ((List_len(ms.bounds) > 0)) {
        __ring_match219: {
          const __ring_m219 = method_type;
          if (__ring_m219._tag === "some") {
            const mt = __ring_m219._0;
  ...
  let __ring_blk34;
  __ring_match220: {
    const __ring_m220 = method_type;
    if (__ring_m220._tag === "some") {
      const mt = __ring_m220._0;
      __ring_blk34 = mt;
  ...
  const callee_type = __ring_blk34;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  while (true) {
    ...
    let __ring_blk35;
    __ring_match221: {
      const __ring_m221 = p.type_annotation;
      if (__ring_m221._tag === "some") {
        const ta = __ring_m221._0;
        __ring_blk35 = infer_ctx$resolve_type_expr(ctx, ta);
    ...
    const pt = __ring_blk35;
    __ring_match222: {
      const __ring_m222 = expected_param_types;
      if (__ring_m222._tag === "some") {
        const epts = __ring_m222._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match223: {
            const __ring_m223 = List_get(epts, pi);
            if (__ring_m223._tag === "some") {
              const expected_t = __ring_m223._0;
    ...
    __ring_match224: {
      const __ring_m224 = lam_scheme;
      if (__ring_m224._tag === "some") {
        const ls = __ring_m224._0;
        __ring_match225: {
          const __ring_m225 = ls.def_id;
          if (__ring_m225._tag === "some") {
            const did = __ring_m225._0;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match226: {
    const __ring_m226 = body_result;
    if (__ring_m226._tag === "some") {
      const body_r = __ring_m226._0;
      s = body_r.subst;
      let applied_params = [];
...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  let __ring_blk36;
  __ring_match227: {
    const __ring_m227 = resolved_callee;
    if (__ring_m227._tag === "FnType") {
      __ring_blk36 = Option_some(resolved_callee);
      break __ring_match227;
    }
    __ring_blk36 = Option_none;
    break __ring_match227;
  }
  const callee_fn_type = __ring_blk36;
  let hargs = [];
  let arg_types = [];
  let ai = 0;
  ...
  while (true) {
    ...
    __ring_match228: {
      ...
      if (__ring_m228._tag === "Lambda") {
        const lparams = __ring_m228.params; const lbody = __ring_m228.body; const lspan = __ring_m228.span;
        let __ring_blk38;
        __ring_match229: {
          const __ring_m229 = callee_fn_type;
          if (__ring_m229._tag === "some") {
            const cft = __ring_m229._0;
            let __ring_blk39;
            __ring_match230: {
              const __ring_m230 = cft;
              if (__ring_m230._tag === "FnType") {
                const cft_params = __ring_m230.params;
                let __ring_blk40;
                __ring_match231: {
                  const __ring_m231 = List_get(cft_params, ai);
                  if (__ring_m231._tag === "some") {
                    const expected_raw = __ring_m231._0;
                    const expected = env$apply_subst(s, expected_raw);
                    let __ring_blk41;
                    __ring_match232: {
                      const __ring_m232 = expected;
                      if (__ring_m232._tag === "FnType") {
                        const exp_params = __ring_m232.params;
                        __ring_blk41 = infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
                        break __ring_match232;
                      }
                      __ring_blk41 = infer_expr(ctx, arg, s, __ring_ev_fail);
                      break __ring_match232;
                    }
                    __ring_blk40 = __ring_blk41;
                    break __ring_match231;
                  }
                  if (__ring_m231._tag === "none") {
                    __ring_blk40 = infer_expr(ctx, arg, s, __ring_ev_fail);
                    break __ring_match231;
                  }
                  __match_fail(__ring_m231);
                }
                __ring_blk39 = ((ai < List_len(cft_params)) ? __ring_blk40 : infer_expr(ctx, arg, s, __ring_ev_fail));
                break __ring_match230;
              }
              __ring_blk39 = infer_expr(ctx, arg, s, __ring_ev_fail);
              break __ring_match230;
            }
            __ring_blk38 = __ring_blk39;
            break __ring_match229;
          }
          if (__ring_m229._tag === "none") {
            __ring_blk38 = infer_expr(ctx, arg, s, __ring_ev_fail);
            break __ring_match229;
          }
      ...
      __ring_blk37 = infer_expr(ctx, arg, s, __ring_ev_fail);
      break __ring_match228;
    }
    let ar = __ring_blk37;
    s = ar.subst;
  ...
  let __ring_blk42;
  __ring_match233: {
    const __ring_m233 = callee;
    if (__ring_m233._tag === "Ident") {
      const cn = __ring_m233.name;
      __ring_blk42 = Option_some(cn);
      break __ring_match233;
    }
    __ring_blk42 = Option_none;
    break __ring_match233;
  }
  const callee_name_for_defaults = __ring_blk42;
  __ring_match234: {
    const __ring_m234 = callee_name_for_defaults;
    if (__ring_m234._tag === "some") {
      const cn = __ring_m234._0;
      __ring_match235: {
        const __ring_m235 = _Map_get(ctx.fn_defaults, cn);
        if (__ring_m235._tag === "some") {
          const defaults = __ring_m235._0;
          __ring_match236: {
            const __ring_m236 = _Map_get(ctx.fn_min_arity, cn);
            if (__ring_m236._tag === "some") {
              const min_ar = __ring_m236._0;
              ...
              if (((List_len(args) < total_arity) ? (List_len(args) >= min_ar) : false)) {
                ...
                while ((di < List_len(defaults))) {
                  __ring_match237: {
                    const __ring_m237 = List_get(defaults, di);
                    if (__ring_m237._tag === "some") {
                      const dh = __ring_m237._0;
                      List_push(hargs, dh);
  ...
  let __ring_blk43;
  __ring_match238: {
    const __ring_m238 = callee;
    if (__ring_m238._tag === "Ident") {
      const cn = __ring_m238.name;
      __ring_blk43 = cn;
      break __ring_match238;
    }
    __ring_blk43 = "<expression>";
    break __ring_match238;
  }
  const callee_name_for_note = __ring_blk43;
  ...
  __ring_match239: {
    const __ring_m239 = resolved_callee_type;
    if (__ring_m239._tag === "FnType") {
      const callee_params = __ring_m239.params; const fn_effects = __ring_m239.effects;
  ...
  __ring_match240: {
    ...
    if (__ring_m240._tag === "Ident") {
      const callee_name = __ring_m240.name;
      __ring_match241: {
        const __ring_m241 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m241._tag === "some") {
          const callee_scheme = __ring_m241._0;
  ...
  __ring_match242: {
    const __ring_m242 = callee;
    if (__ring_m242._tag === "Ident") {
      const callee_name = __ring_m242.name;
      __ring_match243: {
        const __ring_m243 = _Map_get(ctx.fn_mut_params, callee_name);
        if (__ring_m243._tag === "some") {
          const mut_flags = __ring_m243._0;
          let mi = 0;
          while (((mi < List_len(mut_flags)) ? (mi < List_len(args)) : false)) {
            __ring_match244: {
              const __ring_m244 = [List_get(mut_flags, mi), List_get(hargs, mi)];
              if (Array.isArray(__ring_m244) && __ring_m244.length === 2 && __ring_m244[0]._tag === "some" && __ring_m244[1]._tag === "some") {
                const is_mut = __ring_m244[0]._0; const harg = __ring_m244[1]._0;
                if (is_mut) {
                  __ring_match245: {
                    const __ring_m245 = harg;
                    if (__ring_m245._tag === "Ident" && __ring_m245.def_id._tag === "some") {
                      const arg_did = __ring_m245.def_id._0;
                      if (_Set_contains(ctx.env.scope.mutable_vars, arg_did, __Int_Eq)) {
                        __ring_match246: {
                          const __ring_m246 = resolved_callee_type;
                          if (__ring_m246._tag === "FnType") {
                            const fn_params = __ring_m246.params;
                            __ring_match247: {
                              const __ring_m247 = List_get(fn_params, mi);
                              if (__ring_m247._tag === "some") {
                                const pt = __ring_m247._0;
                                const resolved_pt = env$apply_subst(s, pt);
...
function infer_expr(ctx, expr, subst, __ring_ev_fail) {
  __ring_match250: {
    const __ring_m250 = expr;
    if (__ring_m250._tag === "IntLit") {
      const value = __ring_m250.value; const span = __ring_m250.span;
    ...
    if (__ring_m250._tag === "FloatLit") {
      const value = __ring_m250.value; const span = __ring_m250.span;
      return new infer_ctx$InferResult(hir$HExpr_FloatLit(value, types$FLOAT, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match250;
    }
    if (__ring_m250._tag === "StrLit") {
      const value = __ring_m250.value; const span = __ring_m250.span;
      return new infer_ctx$InferResult(hir$HExpr_StrLit(value, types$STR, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match250;
    }
    if (__ring_m250._tag === "BoolLit") {
      const value = __ring_m250.value; const span = __ring_m250.span;
      return new infer_ctx$InferResult(hir$HExpr_BoolLit(value, types$BOOL, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match250;
    }
    if (__ring_m250._tag === "Ident") {
      const name = __ring_m250.name; const qualifier = __ring_m250.qualifier; const span = __ring_m250.span;
      return infer_ident(ctx, name, span, subst, qualifier);
      break __ring_match250;
    }
    if (__ring_m250._tag === "BinOp") {
      const op = __ring_m250.op; const left = __ring_m250.left; const right = __ring_m250.right; const span = __ring_m250.span;
      return infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail);
      break __ring_match250;
    }
    if (__ring_m250._tag === "UnaryOp") {
      const op = __ring_m250.op; const operand = __ring_m250.operand; const span = __ring_m250.span;
      return infer_unary_op(ctx, op, operand, span, subst);
      break __ring_match250;
    }
    if (__ring_m250._tag === "Call") {
      const callee = __ring_m250.callee; const args = __ring_m250.args; const span = __ring_m250.span;
      return infer_call(ctx, callee, args, span, subst, __ring_ev_fail);
      break __ring_match250;
    }
    if (__ring_m250._tag === "MethodCall") {
      const receiver = __ring_m250.receiver; const method = __ring_m250.method; const args = __ring_m250.args; const span = __ring_m250.span;
      return infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail);
      break __ring_match250;
    }
    if (__ring_m250._tag === "FieldAccess") {
      const receiver = __ring_m250.receiver; const field = __ring_m250.field; const span = __ring_m250.span;
      return infer_field_access(ctx, receiver, field, span, subst);
      break __ring_match250;
    }
    if (__ring_m250._tag === "StructLit") {
      const name = __ring_m250.name; const qualifier = __ring_m250.qualifier; const fields = __ring_m250.fields; const spread = __ring_m250.spread; const span = __ring_m250.span;
      return infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail);
      break __ring_match250;
    }
    if (__ring_m250._tag === "MatchExpr") {
      const scrutinee = __ring_m250.scrutinee; const arms = __ring_m250.arms; const span = __ring_m250.span;
      return infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail);
      break __ring_match250;
    }
    if (__ring_m250._tag === "Block") {
      return infer_block(ctx, expr, Option_some(subst), __ring_ev_fail);
      break __ring_match250;
    }
    if (__ring_m250._tag === "IfExpr") {
      const condition = __ring_m250.condition; const then_branch = __ring_m250.then_branch; const else_branch = __ring_m250.else_branch; const span = __ring_m250.span;
      return infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail);
      break __ring_match250;
    }
    if (__ring_m250._tag === "StringInterp") {
      const parts = __ring_m250.parts; const span = __ring_m250.span;
      return infer_string_interp(ctx, parts, span, subst, __ring_ev_fail);
      break __ring_match250;
    }
    if (__ring_m250._tag === "CatchExpr") {
      const catch_expr = __ring_m250.expr; const arms = __ring_m250.arms; const span = __ring_m250.span;
      return infer_catch(ctx, catch_expr, arms, span, subst, __ring_ev_fail);
      break __ring_match250;
    }
    if (__ring_m250._tag === "HandleExpr") {
      const body = __ring_m250.body; const handlers = __ring_m250.handlers; const span = __ring_m250.span;
      return infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail);
      break __ring_match250;
    }
    if (__ring_m250._tag === "Lambda") {
      const params = __ring_m250.params; const body = __ring_m250.body; const span = __ring_m250.span;
      return infer_lambda(ctx, params, body, span, subst, Option_none, __ring_ev_fail);
      break __ring_match250;
    }
    if (__ring_m250._tag === "ListLit") {
      const elements = __ring_m250.elements; const span = __ring_m250.span;
      return infer_list_literal(ctx, elements, span, subst, __ring_ev_fail);
      break __ring_match250;
    }
    if (__ring_m250._tag === "TupleLit") {
      const elements = __ring_m250.elements; const span = __ring_m250.span;
      let s = subst;
      let helements = [];
      let combined_effects = types$EMPTY_ROW;
    ...
    if (__ring_m250._tag === "Range") {
      const start = __ring_m250.start; const end = __ring_m250.end; const inclusive = __ring_m250.inclusive; const span = __ring_m250.span;
    ...
    if (__ring_m250._tag === "IndexExpr") {
      const receiver = __ring_m250.receiver; const index = __ring_m250.index; const span = __ring_m250.span;
      return infer_index_expr(ctx, receiver, index, span, subst, __ring_ev_fail);
      break __ring_match250;
    }
    if (__ring_m250._tag === "ReturnExpr") {
      const value = __ring_m250.value; const span = __ring_m250.span;
      __ring_match251: {
        const __ring_m251 = value;
        if (__ring_m251._tag === "some") {
          const v = __ring_m251._0;
          const r = infer_expr(ctx, v, subst, __ring_ev_fail);
          let s = r.subst;
          __ring_match252: {
            const __ring_m252 = ctx.current_fn_return_type;
            if (__ring_m252._tag === "some") {
              const ret_type = __ring_m252._0;
              const return_notes = [new diagnostics$DiagnosticNote(`function return type is '${types$type_to_string(env$apply_subst(s, ret_type))}'`, Option_none), new diagnostics$DiagnosticNote(`return value has type '${types$type_to_string(env$apply_subst(s, hir$hexpr_type(r.hexpr)))}'`, Option_some(hir$hexpr_span(r.hexpr)))];
              s = infer_ctx$unify_at_noted(ctx.sink, ctx.env, hir$hexpr_type(r.hexpr), ret_type, s, span, return_notes);
        ...
        if (__ring_m251._tag === "none") {
          let s = subst;
          __ring_match253: {
            const __ring_m253 = ctx.current_fn_return_type;
            if (__ring_m253._tag === "some") {
              const ret_type = __ring_m253._0;
              s = infer_ctx$unify_at(ctx.sink, ctx.env, types$UNIT, ret_type, s, span);
...
function infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail) {
  ...
  __ring_match254: {
    const __ring_m254 = op;
    if (__ring_m254._tag === "Add") {
    ...
    if (__ring_m254._tag === "Sub") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "-");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match254;
    }
    if (__ring_m254._tag === "Mul") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "*");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match254;
    }
    if (__ring_m254._tag === "Div") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "/");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match254;
    }
    if (__ring_m254._tag === "Mod") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "%");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match254;
    }
    if ((__ring_m254._tag === "Eq") || (__ring_m254._tag === "Neq")) {
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      result_type = types$BOOL;
      ...
      let __ring_blk44;
      __ring_match255: {
        const __ring_m255 = op;
        if (__ring_m255._tag === "Eq") {
          __ring_blk44 = "==";
    ...
    if ((__ring_m254._tag === "Lt") || (__ring_m254._tag === "Lte") || (__ring_m254._tag === "Gt") || (__ring_m254._tag === "Gte")) {
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      result_type = types$BOOL;
      const resolved = env$apply_subst(s, hir$hexpr_type(lr.hexpr));
      let __ring_blk45;
