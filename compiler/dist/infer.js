...
function resolve_var_id(id, sub) {
  __ring_match6: {
    const __ring_m6 = union_find$uf_lookup(sub, id);
    if (__ring_m6._tag === "some") {
      const resolved = __ring_m6._0;
      __ring_match7: {
        const __ring_m7 = resolved;
        if (__ring_m7._tag === "TypeVar") {
          const new_id = __ring_m7.id;
...
function infer_block(ctx, body, initial_subst, __ring_ev_fail) {
  __ring_match8: {
    ...
    if (__ring_m8._tag === "Block") {
      const stmts = __ring_m8.stmts; const tail = __ring_m8.tail; const span = __ring_m8.span;
      let subst = (function() {
...
function infer_stmt(ctx, stmt, subst, __ring_ev_fail) {
  __ring_match10: {
    ...
    if (__ring_m10._tag === "Let") {
      const name = __ring_m10.name; const name_span = __ring_m10.name_span; const type_annotation = __ring_m10.type_annotation; const init = __ring_m10.init; const span = __ring_m10.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      let var_type = hir$hexpr_type(init_r.hexpr);
      __ring_match11: {
        const __ring_m11 = type_annotation;
        if (__ring_m11._tag === "some") {
          const ta = __ring_m11._0;
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m10._tag === "Var") {
      ...
      __ring_match13: {
        const __ring_m13 = var_scheme;
        if (__ring_m13._tag === "some") {
          const vs = __ring_m13._0;
          __ring_match14: {
            const __ring_m14 = vs.def_id;
    ...
    if (__ring_m10._tag === "Return") {
      ...
      __ring_match15: {
        ...
        if (__ring_m15._tag === "some") {
          ...
          let s = r.subst;
          __ring_match16: {
            const __ring_m16 = ctx.current_fn_return_type;
            if (__ring_m16._tag === "some") {
              const ret_type = __ring_m16._0;
    ...
    if (__ring_m10._tag === "While") {
      ...
      __ring_match18: {
        const __ring_m18 = body_result;
        if (__ring_m18._tag === "some") {
          const body_r = __ring_m18._0;
          s = body_r.subst;
    ...
    if (__ring_m10._tag === "ForIn") {
      const binding = __ring_m10.binding; const binding_span = __ring_m10.binding_span; const destructure = __ring_m10.destructure; const iterable = __ring_m10.iterable; const body = __ring_m10.body; const span = __ring_m10.span;
      ...
      __ring_match19: {
        const __ring_m19 = iter_type;
        if (__ring_m19._tag === "EnumType") {
          const name = __ring_m19.name; const type_params = __ring_m19.type_params;
  ...
  __match_fail(__ring_m);
              ...
              if (((name === hir$BUILTIN_MAP) && (List_len(type_params) >= 2))) {
                ...
                __ring_match20: {
                  const __ring_m20 = [List_get(type_params, 0), List_get(type_params, 1)];
                  if (Array.isArray(__ring_m20) && __ring_m20.length === 2 && __ring_m20[0]._tag === "some" && __ring_m20[1]._tag === "some") {
                    const kt = __ring_m20[0]._0; const vt = __ring_m20[1]._0;
      ...
      __ring_match21: {
        ...
        if (__ring_m21._tag === "some") {
          const destr = __ring_m21._0;
          __ring_match22: {
            const __ring_m22 = element_type;
            if (__ring_m22._tag === "TupleType") {
              const type_elems = __ring_m22.elements;
          ...
          while ((di < List_len(destr.names))) {
            __ring_match23: {
              const __ring_m23 = List_get(destr.names, di);
              if (__ring_m23._tag === "some") {
                const dname = __ring_m23._0;
  ...
  return env$TypeEnv_fresh_var(ctx.env);
      ...
      __ring_match26: {
        const __ring_m26 = binding_scheme;
        if (__ring_m26._tag === "some") {
          const bs = __ring_m26._0;
          __ring_match27: {
            const __ring_m27 = bs.def_id;
            if (__ring_m27._tag === "some") {
              const did = __ring_m27._0;
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match28: {
        const __ring_m28 = body_result;
        if (__ring_m28._tag === "some") {
          const body_r = __ring_m28._0;
          s = body_r.subst;
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m10._tag === "LetDestructure") {
      const pattern = __ring_m10.pattern; const init = __ring_m10.init; const span = __ring_m10.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      const init_type = env$apply_subst(s, hir$hexpr_type(init_r.hexpr));
      __ring_match29: {
        const __ring_m29 = init_type;
        if (__ring_m29._tag === "TupleType") {
  ...
  return [];
      ...
      __ring_match30: {
        const __ring_m30 = pattern;
        if (__ring_m30._tag === "TuplePattern") {
          const pat_elements = __ring_m30.elements;
          ...
          while ((bi < List_len(pat_elements))) {
            __ring_match31: {
              const __ring_m31 = List_get(pat_elements, bi);
              if (__ring_m31._tag === "some") {
                const p = __ring_m31._0;
  ...
  __match_fail(__ring_m);
                ...
                __ring_match32: {
                  ...
                  if (__ring_m32._tag === "Binding") {
                    const name = __ring_m32.name; const pspan = __ring_m32.span;
                    env$TypeEnv_bind_mono(ctx.env, name, elem_type);
                    const bscheme = env$TypeEnv_lookup(ctx.env, name);
                    __ring_match33: {
                      const __ring_m33 = bscheme;
                      if (__ring_m33._tag === "some") {
                        const bs = __ring_m33._0;
                        __ring_match34: {
                          const __ring_m34 = bs.def_id;
                          if (__ring_m34._tag === "some") {
                            const did = __ring_m34._0;
  ...
  return infer_block(ctx, then_block, Option_some(s), __ring_ev_fail);
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match35: {
        const __ring_m35 = then_result;
        if (__ring_m35._tag === "some") {
          const then_r = __ring_m35._0;
          s = then_r.subst;
          ...
          __ring_match36: {
            ...
            if (__ring_m36._tag === "some") {
              ...
              env$TypeEnv_pop_scope(ctx.env);
              __ring_match37: {
                const __ring_m37 = else_result;
                if (__ring_m37._tag === "some") {
                  const else_r = __ring_m37._0;
                  s = else_r.subst;
...
function check_assign_target_mutable(ctx, target) {
  __ring_match38: {
    ...
    if (__ring_m38._tag === "Ident") {
      const name = __ring_m38.name; const span = __ring_m38.span;
    ...
    if (__ring_m38._tag === "FieldAccess") {
      const receiver = __ring_m38.receiver; const span = __ring_m38.span;
      const root = find_root_expr(receiver);
      __ring_match41: {
        const __ring_m41 = root;
        if (__ring_m41._tag === "Ident") {
          const name = __ring_m41.name; const rspan = __ring_m41.span;
          const scheme = env$TypeEnv_lookup(ctx.env, name);
          __ring_match42: {
    ...
    if (__ring_m38._tag === "IndexExpr") {
      ...
      const root = find_root_expr(receiver);
      __ring_match44: {
        const __ring_m44 = root;
        if (__ring_m44._tag === "Ident") {
          const name = __ring_m44.name; const rspan = __ring_m44.span;
          const scheme = env$TypeEnv_lookup(ctx.env, name);
          __ring_match45: {
            ...
            if (__ring_m45._tag === "some") {
              ...
              __ring_match46: {
                const __ring_m46 = s.def_id;
                if (__ring_m46._tag === "some") {
                  const did = __ring_m46._0;
                  if ((!_Set_contains(ctx.env.scope.mutable_vars, did, __Int_Eq))) {
...
function find_root_expr(e) {
  __ring_match47: {
    ...
    if (__ring_m47._tag === "FieldAccess") {
      const receiver = __ring_m47.receiver;
      return find_root_expr(receiver);
      break __ring_match47;
    }
    if (__ring_m47._tag === "IndexExpr") {
      const receiver = __ring_m47.receiver;
      return find_root_expr(receiver);
      break __ring_match47;
    }
...
function infer_expr(ctx, expr, subst, __ring_ev_fail) {
  __ring_match48: {
    ...
    if (__ring_m48._tag === "IntLit") {
      const value = __ring_m48.value; const span = __ring_m48.span;
    ...
    if (__ring_m48._tag === "Ident") {
      const name = __ring_m48.name; const qualifier = __ring_m48.qualifier; const span = __ring_m48.span;
      return infer_ident(ctx, name, span, subst, qualifier);
      break __ring_match48;
    }
    if (__ring_m48._tag === "BinOp") {
      const op = __ring_m48.op; const left = __ring_m48.left; const right = __ring_m48.right; const span = __ring_m48.span;
      return infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail);
      break __ring_match48;
    }
    if (__ring_m48._tag === "UnaryOp") {
      const op = __ring_m48.op; const operand = __ring_m48.operand; const span = __ring_m48.span;
      return infer_unary_op(ctx, op, operand, span, subst, __ring_ev_fail);
      break __ring_match48;
    }
    if (__ring_m48._tag === "Call") {
      const callee = __ring_m48.callee; const args = __ring_m48.args; const span = __ring_m48.span;
      return infer_call(ctx, callee, args, span, subst, __ring_ev_fail);
      break __ring_match48;
    }
    if (__ring_m48._tag === "MethodCall") {
      const receiver = __ring_m48.receiver; const method = __ring_m48.method; const args = __ring_m48.args; const span = __ring_m48.span;
      return infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail);
      break __ring_match48;
    }
    if (__ring_m48._tag === "FieldAccess") {
      const receiver = __ring_m48.receiver; const field = __ring_m48.field; const span = __ring_m48.span;
      return infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail);
      break __ring_match48;
    }
    if (__ring_m48._tag === "StructLit") {
      const name = __ring_m48.name; const qualifier = __ring_m48.qualifier; const fields = __ring_m48.fields; const spread = __ring_m48.spread; const span = __ring_m48.span;
      return infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail);
      break __ring_match48;
    }
    if (__ring_m48._tag === "MatchExpr") {
      const scrutinee = __ring_m48.scrutinee; const arms = __ring_m48.arms; const span = __ring_m48.span;
    ...
    if (__ring_m48._tag === "IfExpr") {
      const condition = __ring_m48.condition; const then_branch = __ring_m48.then_branch; const else_branch = __ring_m48.else_branch; const span = __ring_m48.span;
      return infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail);
      break __ring_match48;
    }
    if (__ring_m48._tag === "StringInterp") {
      const parts = __ring_m48.parts; const span = __ring_m48.span;
      return infer_string_interp(ctx, parts, span, subst, __ring_ev_fail);
      break __ring_match48;
    }
    if (__ring_m48._tag === "CatchExpr") {
      const catch_expr = __ring_m48.expr; const arms = __ring_m48.arms; const span = __ring_m48.span;
      return infer_catch(ctx, catch_expr, arms, span, subst, __ring_ev_fail);
      break __ring_match48;
    }
    if (__ring_m48._tag === "HandleExpr") {
      const body = __ring_m48.body; const handlers = __ring_m48.handlers; const span = __ring_m48.span;
      return infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail);
      break __ring_match48;
    }
    if (__ring_m48._tag === "Lambda") {
      const params = __ring_m48.params; const body = __ring_m48.body; const span = __ring_m48.span;
      return infer_lambda(ctx, params, body, span, subst, Option_none, __ring_ev_fail);
      break __ring_match48;
    }
    if (__ring_m48._tag === "ListLit") {
      const elements = __ring_m48.elements; const span = __ring_m48.span;
    ...
    if (__ring_m48._tag === "Range") {
      const start = __ring_m48.start; const end = __ring_m48.end; const inclusive = __ring_m48.inclusive; const span = __ring_m48.span;
    ...
    if (__ring_m48._tag === "IndexExpr") {
      const receiver = __ring_m48.receiver; const index = __ring_m48.index; const span = __ring_m48.span;
...
function infer_ident(ctx, name, span, subst, qualifier) {
  ...
  __ring_match50: {
    const __ring_m50 = qualifier;
    if (__ring_m50._tag === "some") {
      const q = __ring_m50._0;
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match51: {
          const __ring_m51 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
      ...
      __ring_match53: {
        ...
        if (__ring_m53._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match54: {
              const __ring_m54 = full_scheme;
              if (__ring_m54._tag === "some") {
                const fs = __ring_m54._0;
  ...
  __ring_match55: {
    ...
    if (__ring_m55._tag === "none") {
      __ring_match56: {
        const __ring_m56 = resolved_qualifier;
  ...
  __match_fail(__ring_m);
      ...
      __ring_match59: {
        const __ring_m59 = enum_name;
        if (__ring_m59._tag === "some") {
          const en = __ring_m59._0;
...
function infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail) {
  ...
  __ring_match60: {
    ...
    if (__ring_m60._tag === "Sub") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "-");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match60;
    }
    if (__ring_m60._tag === "Mul") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "*");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match60;
    }
    if (__ring_m60._tag === "Div") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "/");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match60;
    }
    if (__ring_m60._tag === "Mod") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "%");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match60;
    }
...
function infer_numeric_op(ctx, left, right, s, span, op_str) {
  ...
  __ring_match61: {
    ...
    if (__ring_m61._tag === "IntType") {
      return types$INT;
      break __ring_match61;
    }
    if (__ring_m61._tag === "FloatType") {
      return types$FLOAT;
      break __ring_match61;
    }
...
function is_primitive_eq(t) {
  __ring_match63: {
    const __ring_m63 = t;
    if (__ring_m63._tag === "IntType") {
      return true;
      break __ring_match63;
    }
    if (__ring_m63._tag === "FloatType") {
      return true;
      break __ring_match63;
    }
    if (__ring_m63._tag === "StrType") {
      return true;
      break __ring_match63;
    }
    if (__ring_m63._tag === "BoolType") {
      return true;
      break __ring_match63;
    }
    if (__ring_m63._tag === "UnitType") {
      return true;
      break __ring_match63;
    }
    if (__ring_m63._tag === "NeverType") {
      return true;
      break __ring_match63;
    }
    if (__ring_m63._tag === "AnyType") {
      return true;
      break __ring_match63;
    }
    return false;
...
function is_primitive_ord(t) {
  __ring_match64: {
    ...
    if (__ring_m64._tag === "StrType") {
      return true;
      break __ring_match64;
    }
    if (__ring_m64._tag === "BoolType") {
      return true;
      break __ring_match64;
    }
    return false;
...
function resolve_trait_dispatch(ctx, resolved, trait_name, error_code, subst, span, op, is_builtin) {
  ...
  __ring_match67: {
    const __ring_m67 = bound_resolved;
    if (__ring_m67._tag === "TypeVar") {
      const bid = __ring_m67.id;
      return (bid === id);
    ...
    break __ring_match67;
      ...
      __ring_match68: {
        const __ring_m68 = bound;
        if (__ring_m68._tag === "some") {
          const b = __ring_m68._0;
      ...
      __ring_match69: {
        const __ring_m69 = _Map_get(ctx.env.scope.var_bounds, id);
        if (__ring_m69._tag === "some") {
          const var_bounds = __ring_m69._0;
...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match77: {
    const __ring_m77 = expected;
    if (__ring_m77._tag === "FnType") {
      const exp_params = __ring_m77.params;
  ...
  __ring_match78: {
    const __ring_m78 = resolved_callee_type;
    if (__ring_m78._tag === "FnType") {
      const fn_effects = __ring_m78.effects;
  ...
  let resolved_dicts = [];
  __ring_match79: {
    const __ring_m79 = callee;
    if (__ring_m79._tag === "Ident") {
      const callee_name = __ring_m79.name;
      __ring_match80: {
        const __ring_m80 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m80._tag === "some") {
          const callee_scheme = __ring_m80._0;
...
function resolve_arg_dict_closure(ctx, harg, s) {
  __ring_match81: {
    const __ring_m81 = harg;
    if (__ring_m81._tag === "Ident") {
      const name = __ring_m81.name; const resolved_name = __ring_m81.resolved_name; const def_id = __ring_m81.def_id; const ty = __ring_m81.ty; const effects = __ring_m81.effects; const span = __ring_m81.span;
      const arg_scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match82: {
        const __ring_m82 = arg_scheme;
        if (__ring_m82._tag === "some") {
          const as_ = __ring_m82._0;
          ...
          for (const bound of as_.bounds) {
            __ring_match83: {
              const __ring_m83 = _Map_get(var_map, bound.type_var);
              if (__ring_m83._tag === "some") {
                const fresh_var = __ring_m83._0;
...
function resolve_arg_bound_dict(ctx, concrete, trait_name, dicts) {
  __ring_match84: {
    ...
    if (__ring_m84._tag === "TypeVar") {
      ...
      __ring_match85: {
        const __ring_m85 = matching;
        if (__ring_m85._tag === "some") {
          const fb = __ring_m85._0;
    ...
    __ring_match86: {
      const __ring_m86 = types$type_to_builtin_name(concrete);
      if (__ring_m86._tag === "some") {
        const prim_name = __ring_m86._0;
...
function check_expr_is_let_def(ctx, expr) {
  __ring_match87: {
    const __ring_m87 = expr;
    if (__ring_m87._tag === "Ident") {
      const name = __ring_m87.name;
      __ring_match88: {
        const __ring_m88 = env$TypeEnv_lookup(ctx.env, name);
        if (__ring_m88._tag === "some") {
          const s = __ring_m88._0;
          __ring_match89: {
            const __ring_m89 = s.def_id;
            if (__ring_m89._tag === "some") {
              const did = __ring_m89._0;
    ...
    if (__ring_m87._tag === "FieldAccess") {
      const inner = __ring_m87.receiver;
...
function is_mut_method_call(ctx, recv_type, method) {
  ...
  __ring_match94: {
    const __ring_m94 = type_name;
    if (__ring_m94._tag === "some") {
      const tname = __ring_m94._0;
      __ring_match95: {
        const __ring_m95 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m95._tag === "some") {
          const mut_set = __ring_m95._0;
...
function check_receiver_mutability(ctx, receiver, recv_type, method, span) {
  ...
  __ring_match96: {
    ...
    if (__ring_m96._tag === "EnumType") {
      const name = __ring_m96.name;
      type_name = Option_some(name);
      break __ring_match96;
    }
    __ring_match97: {
      const __ring_m97 = types$type_to_builtin_name(recv_type);
      if (__ring_m97._tag === "some") {
        const n = __ring_m97._0;
        type_name = Option_some(n);
  ...
  __ring_match98: {
    const __ring_m98 = type_name;
    if (__ring_m98._tag === "some") {
      const tname = __ring_m98._0;
      __ring_match99: {
        const __ring_m99 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m99._tag === "some") {
          const mut_set = __ring_m99._0;
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  ...
  if (is_mut_method_call(ctx, recv_type, method)) {
    __ring_match102: {
      const __ring_m102 = get_expr_def_id(ctx, receiver);
      if (__ring_m102._tag === "some") {
        const did = __ring_m102._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match104: {
      ...
      if (__ring_m104._tag === "some") {
        const prim_name = __ring_m104._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match105: {
      ...
      if (__ring_m105._tag === "some") {
        const type_name = __ring_m105._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match106: {
      const __ring_m106 = recv_var_id;
      if (__ring_m106._tag === "some") {
        const rvid = __ring_m106._0;
        for (const fb of ctx.current_fn_bounds) {
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match107: {
              const __ring_m107 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m107._tag === "some") {
                const trait_def = __ring_m107._0;
                ...
                __ring_match108: {
                  const __ring_m108 = tm;
                  if (__ring_m108._tag === "some") {
                    const found_method = __ring_m108._0;
  ...
  __ring_match109: {
    const __ring_m109 = method_type;
    if (__ring_m109._tag === "some") {
      const mt = __ring_m109._0;
      __ring_match110: {
        const __ring_m110 = mt;
        if (__ring_m110._tag === "FnType") {
          const mt_params = __ring_m110.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match111: {
              const __ring_m111 = List_first(mt_params);
              if (__ring_m111._tag === "some") {
                const first_param = __ring_m111._0;
  ...
  const expected = env$apply_subst(s, expected_raw);
  __ring_match112: {
    const __ring_m112 = expected;
    if (__ring_m112._tag === "FnType") {
      const exp_params = __ring_m112.params;
      return infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
  ...
  __ring_match113: {
    const __ring_m113 = method_type;
    if (__ring_m113._tag === "some") {
      const mt = __ring_m113._0;
      __ring_match114: {
        const __ring_m114 = mt;
        if (__ring_m114._tag === "FnType") {
          const mt_params = __ring_m114.params; const mt_ret = __ring_m114.return_type; const mt_effects = __ring_m114.effects;
          let i = 0;
          for (const harg of hargs) {
            if (((i + 1) < List_len(mt_params))) {
              __ring_match115: {
                const __ring_m115 = List_get(mt_params, (i + 1));
                if (__ring_m115._tag === "some") {
                  const expected_param = __ring_m115._0;
  ...
  let resolved_dicts = [];
  __ring_match118: {
    const __ring_m118 = method_scheme;
    if (__ring_m118._tag === "some") {
      const ms = __ring_m118._0;
      if ((List_len(ms.bounds) > 0)) {
        __ring_match119: {
          const __ring_m119 = method_type;
          if (__ring_m119._tag === "some") {
            const mt = __ring_m119._0;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match120: {
    const __ring_m120 = _Map_get(ctx.env.trait_reg.impl_methods, type_name);
    if (__ring_m120._tag === "some") {
      const impl_methods = __ring_m120._0;
      __ring_match121: {
        const __ring_m121 = _Map_get(impl_methods, method);
        if (__ring_m121._tag === "some") {
          const scheme = __ring_m121._0;
...
function lookup_trait_method(ctx, type_name, method, span) {
  ...
  for (const impl_entry of ctx.env.trait_reg.trait_impls) {
    if ((impl_entry.target_type_name === type_name)) {
      __ring_match122: {
        const __ring_m122 = _Map_get(ctx.env.trait_reg.traits, impl_entry.trait_name);
        if (__ring_m122._tag === "some") {
          ...
          __ring_match123: {
            ...
            if (__ring_m123._tag === "some") {
              ...
              __ring_match124: {
                const __ring_m124 = found_trait_name;
                if (__ring_m124._tag === "some") {
                  const prev_trait = __ring_m124._0;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match125: {
    const __ring_m125 = effect_def_opt;
  ...
  for (const arg of args) {
    ...
    List_push(hargs, ar.hexpr);
    __ring_match127: {
      const __ring_m127 = List_get(inst_params, i);
      if (__ring_m127._tag === "some") {
        const param_type = __ring_m127._0;
  ...
  __ring_match128: {
    ...
    if (__ring_m128._tag === "some") {
      const bik = __ring_m128._0;
      __ring_match129: {
        const __ring_m129 = bik;
        if (__ring_m129._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match129;
        }
        if (__ring_m129._tag === "BkFail") {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match130: {
        ...
        if (__ring_m131._tag === "some") {
          ...
          __ring_match132: {
            ...
            if (__ring_m132._tag === "some") {
              const found_field = __ring_m132._0;
              let inst_map = map_new();
              let fi = 0;
              while (((fi < List_len(struct_def.type_param_vars)) && (fi < List_len(type_params)))) {
                __ring_match133: {
                  const __ring_m133 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m133) && __ring_m133.length === 2 && __ring_m133[0]._tag === "some" && __ring_m133[1]._tag === "some") {
                    const var_id = __ring_m133[0]._0; const tp = __ring_m133[1]._0;
    ...
    if (__ring_m130._tag === "RecordType") {
      const rec_fields = __ring_m130.fields; const tail = __ring_m130.tail;
    ...
    if (__ring_m130._tag === "TupleType") {
      ...
      __ring_match136: {
        const __ring_m136 = parse_int(field);
        ...
        if (__ring_m136._tag === "some") {
          ...
          __ring_match137: {
            const __ring_m137 = List_get(elements, i);
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  let resolved_qualifier = qualifier;
  __ring_match138: {
    const __ring_m138 = qualifier;
    if (__ring_m138._tag === "some") {
      const q = __ring_m138._0;
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match139: {
          const __ring_m139 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m139._tag === "some") {
            const prefix = __ring_m139._0;
            if ((prefix === "")) {
              resolved_qualifier = Option_none;
            } else {
              resolved_qualifier = Option_some(prefix);
  ...
  __ring_match140: {
    const __ring_m140 = resolved_qualifier;
    if (__ring_m140._tag === "some") {
      const q = __ring_m140._0;
      const qualified_name = `${q}::${name}`;
      const mod_struct = _Map_get(ctx.env.types.structs, qualified_name);
      __ring_match141: {
        const __ring_m141 = mod_struct;
  ...
  __ring_match143: {
    const __ring_m143 = resolved_qualifier;
    if (__ring_m143._tag === "some") {
      const q = __ring_m143._0;
      __ring_match144: {
        const __ring_m144 = _Map_get(ctx.env.types.enums, q);
        ...
        if (__ring_m144._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match145: {
              const __ring_m145 = _Map_get(ctx.env.types.enums, full_q);
              if (__ring_m145._tag === "some") {
                const enum_def = __ring_m145._0;
                if (enum_def.variants.some((function(v) { return (v.name === name); }))) {
                  variant_enum = Option_some(enum_def.name);
                }
  ...
  if ((Option_is_none(variant_enum) && Option_is_some(resolved_qualifier))) {
    __ring_match146: {
      const __ring_m146 = resolved_qualifier;
      if (__ring_m146._tag === "some") {
        const q = __ring_m146._0;
        const _ = infer_ctx$type_error(ctx.sink, codes$E0201, `'${q}' has no variant '${name}'`, span, diagnostics$DiagnosticContext_UndefinedVariable(name, Option_none));
  ...
  __ring_match147: {
    const __ring_m147 = variant_enum;
    if (__ring_m147._tag === "some") {
      const ve = __ring_m147._0;
      __ring_match148: {
        const __ring_m148 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m148._tag === "some") {
          const enum_def = __ring_m148._0;
          ...
          __ring_match149: {
            const __ring_m149 = variant;
            if (__ring_m149._tag === "some") {
              const v = __ring_m149._0;
              __ring_match150: {
                const __ring_m150 = v.field_names;
  ...
  __ring_match151: {
    const __ring_m151 = struct_def_opt;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match152: {
      const __ring_m152 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m152._tag === "some") {
        const var_id = __ring_m152._0;
  ...
  for (const field of fields) {
    ...
    __ring_match154: {
      const __ring_m154 = def_field;
      if (__ring_m154._tag === "some") {
        const df = __ring_m154._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  ...
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match155: {
      const __ring_m155 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m155._tag === "some") {
        const var_id = __ring_m155._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  for (const field of fields) {
    ...
    __ring_match157: {
      const __ring_m157 = field_idx;
      if (__ring_m157._tag === "some") {
        const idx = __ring_m157._0;
        __ring_match158: {
          const __ring_m158 = List_get(variant.fields, idx);
          if (__ring_m158._tag === "some") {
            const ftype = __ring_m158._0;
...
function rewrite_bare_enum_bindings(env, pattern) {
  __ring_match159: {
    const __ring_m159 = pattern;
    if (__ring_m159._tag === "Binding") {
      const name = __ring_m159.name; const span = __ring_m159.span;
      __ring_match160: {
        const __ring_m160 = _Map_get(env.types.variant_to_enum, name);
        if (__ring_m160._tag === "some") {
          const ve = __ring_m160._0;
          __ring_match161: {
            const __ring_m161 = _Map_get(env.types.enums, ve);
            if (__ring_m161._tag === "some") {
              const edef = __ring_m161._0;
    ...
    if (__ring_m159._tag === "TuplePattern") {
      const elements = __ring_m159.elements; const span = __ring_m159.span;
      let new_elems = [];
    ...
    if (__ring_m159._tag === "Constructor") {
      const name = __ring_m159.name; const qualifier = __ring_m159.qualifier; const fields = __ring_m159.fields; const span = __ring_m159.span;
      let new_fields = [];
      for (const f of fields) {
    ...
    if (__ring_m159._tag === "NamedConstructor") {
      const name = __ring_m159.name; const qualifier = __ring_m159.qualifier; const fields = __ring_m159.fields; const rest = __ring_m159.rest; const span = __ring_m159.span;
      let new_fields = [];
      for (const f of fields) {
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match165: {
    const __ring_m165 = missing;
    if (__ring_m165._tag === "some") {
      const m = __ring_m165._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  let result_type = types$UNIT;
  __ring_match166: {
    const __ring_m166 = else_branch;
    if (__ring_m166._tag === "some") {
      const eb = __ring_m166._0;
      __ring_match167: {
        const __ring_m167 = eb;
        ...
        if (__ring_m167._tag === "IfExpr") {
          const ec = __ring_m167.condition; const etb = __ring_m167.then_branch; const eeb = __ring_m167.else_branch; const espan = __ring_m167.span;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  for (const part of parts) {
    __ring_match168: {
      const __ring_m168 = part;
      if (__ring_m168._tag === "LitPart") {
        const str_val = __ring_m168._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match168;
      }
      if (__ring_m168._tag === "ExprPart") {
        const expr = __ring_m168._0;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  for (const eff of effects.effects) {
    __ring_match169: {
      const __ring_m169 = eff;
      if (__ring_m169._tag === "FailEffect") {
        const et = __ring_m169.error_type;
        if (found_fail) {
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  for (const handler of handlers) {
    ...
    __ring_match173: {
      const __ring_m173 = effect_def;
      if (__ring_m173._tag === "some") {
        const ed = __ring_m173._0;
    ...
    __ring_match174: {
      const __ring_m174 = effect_def;
      if (__ring_m174._tag === "some") {
        const ed = __ring_m174._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match175: {
      const __ring_m175 = handler.resume_name;
      if (__ring_m175._tag === "some") {
        const rn = __ring_m175._0;
  ...
  __match_fail(__ring_m);
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match176: {
      const __ring_m176 = handler_body_result;
      if (__ring_m176._tag === "some") {
        const hbr = __ring_m176._0;
        s = hbr.subst;
