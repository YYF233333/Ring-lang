...
function is_interpolatable_type(t) {
  __ring_match6: {
    const __ring_m6 = t;
    ...
    if (__ring_m6._tag === "TypeVar") {
      return true;
      break __ring_match6;
    }
    if (__ring_m6._tag === "ErrorType") {
      return true;
      break __ring_match6;
    }
    return false;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  let __ring_blk0;
  __ring_match9: {
    const __ring_m9 = variant.field_names;
    if (__ring_m9._tag === "some") {
      const fn_ = __ring_m9._0;
      __ring_blk0 = fn_;
      break __ring_match9;
    }
  ...
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match10: {
      const __ring_m10 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m10._tag === "some") {
        const var_id = __ring_m10._0;
  ...
  __ring_match11: {
    const __ring_m11 = spread;
    if (__ring_m11._tag === "some") {
      const sp = __ring_m11._0;
  ...
  while (true) {
    ...
    __ring_match12: {
      const __ring_m12 = field_idx;
      if (__ring_m12._tag === "some") {
        const idx = __ring_m12._0;
        __ring_match13: {
          const __ring_m13 = List_get(variant.fields, idx);
          if (__ring_m13._tag === "some") {
            const ftype = __ring_m13._0;
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  ...
  __ring_match14: {
    const __ring_m14 = qualifier;
    if (__ring_m14._tag === "some") {
      const q = __ring_m14._0;
      if (((q === "self") ? true : Str_starts_with(q, "super"))) {
        __ring_match15: {
          const __ring_m15 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m15._tag === "some") {
            const prefix = __ring_m15._0;
            if ((prefix === "")) {
  ...
  __ring_match19: {
    ...
    if (__ring_m19._tag === "some") {
      ...
      __ring_match20: {
        const __ring_m20 = _Map_get(ctx.env.types.enums, q);
        ...
        if (__ring_m20._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match21: {
              const __ring_m21 = _Map_get(ctx.env.types.enums, full_q);
              if (__ring_m21._tag === "some") {
                const enum_def = __ring_m21._0;
                if (_Map_contains_key(enum_def.variant_index, name)) {
                  variant_enum = Option_some(enum_def.name);
                }
  ...
  __ring_match23: {
    const __ring_m23 = variant_enum;
    if (__ring_m23._tag === "some") {
      const ve = __ring_m23._0;
      __ring_match24: {
        const __ring_m24 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m24._tag === "some") {
          const enum_def = __ring_m24._0;
          const variant = env$lookup_variant(enum_def, name);
          __ring_match25: {
            const __ring_m25 = variant;
  ...
  let __ring_blk1;
  __ring_match28: {
    const __ring_m28 = struct_def_opt;
    if (__ring_m28._tag === "some") {
      const sd = __ring_m28._0;
      __ring_blk1 = sd;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match29: {
      const __ring_m29 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m29._tag === "some") {
        const var_id = __ring_m29._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  while (true) {
    ...
    __ring_match31: {
      const __ring_m31 = def_field;
      if (__ring_m31._tag === "some") {
        const df = __ring_m31._0;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  while (true) {
    ...
    __ring_match32: {
      const __ring_m32 = part;
      if (__ring_m32._tag === "LitPart") {
        const str_val = __ring_m32._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match32;
      }
      if (__ring_m32._tag === "ExprPart") {
        const expr = __ring_m32._0;
        ...
        if ((is_interpolatable_type(resolved) === false)) {
          const _ = infer_ctx$type_error(ctx.sink, codes$E0309, `string interpolation requires Str, Int, Float, or Bool, got ${types$type_to_string(resolved)}`, hir$hexpr_span(r.hexpr), diagnostics$DiagnosticContext_TypeMismatch("Str | Int | Float | Bool", types$type_to_string(resolved), Option_none));
        }
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  let __ring_blk2;
  __ring_match34: {
    const __ring_m34 = effect_def_opt;
    if (__ring_m34._tag === "some") {
      const ed = __ring_m34._0;
      __ring_blk2 = ed;
  ...
  let __ring_blk3;
  __ring_match36: {
    const __ring_m36 = op_opt;
    if (__ring_m36._tag === "some") {
      const o = __ring_m36._0;
      __ring_blk3 = o;
  ...
  while (true) {
    ...
    __ring_match37: {
      const __ring_m37 = List_get(inst_params, i);
      if (__ring_m37._tag === "some") {
        const param_type = __ring_m37._0;
  ...
  __ring_match38: {
    const __ring_m38 = effect_def.built_in_kind;
    if (__ring_m38._tag === "some") {
      const bik = __ring_m38._0;
      __ring_match39: {
        const __ring_m39 = bik;
        if (__ring_m39._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match39;
        }
        if (__ring_m39._tag === "BkFail") {
          let __ring_blk4;
          __ring_match40: {
            const __ring_m40 = List_first(hargs);
            if (__ring_m40._tag === "some") {
              const h = __ring_m40._0;
              __ring_blk4 = h;
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match41: {
    const __ring_m41 = receiver;
    if (__ring_m41._tag === "Ident") {
      const recv_name = __ring_m41.name; const qualifier = __ring_m41.qualifier;
      let __ring_blk5;
      __ring_match42: {
      ...
      __ring_match43: {
        const __ring_m43 = _Map_get(ctx.env.types.effects, full_effect_name);
  ...
  if (infer_helpers$is_mut_method_call(ctx, recv_type, method)) {
    __ring_match44: {
      const __ring_m44 = infer_helpers$get_expr_def_id(ctx, receiver);
  ...
  __ring_match45: {
    const __ring_m45 = recv_type;
    if (__ring_m45._tag === "StructType") {
  ...
  if (Option_is_none(method_type)) {
    __ring_match47: {
      const __ring_m47 = types$type_to_builtin_name(recv_type);
      if (__ring_m47._tag === "some") {
        const type_name = __ring_m47._0;
  ...
  let __ring_blk6;
  __ring_match48: {
    const __ring_m48 = recv_raw_type;
    if (__ring_m48._tag === "TypeVar") {
      const id = __ring_m48.id;
  ...
  if (Option_is_none(method_type)) {
    __ring_match49: {
      const __ring_m49 = recv_var_id;
      if (__ring_m49._tag === "some") {
        const rvid = __ring_m49._0;
        ...
        while (true) {
          ...
          if ((infer_helpers$resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match50: {
              const __ring_m50 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m50._tag === "some") {
                const trait_def = __ring_m50._0;
                ...
                __ring_match51: {
                  ...
                  if (__ring_m51._tag === "some") {
                    const found_method = __ring_m51._0;
  ...
  __ring_match52: {
    const __ring_m52 = method_type;
    if (__ring_m52._tag === "some") {
      const mt = __ring_m52._0;
      __ring_match53: {
        const __ring_m53 = mt;
        if (__ring_m53._tag === "FnType") {
          const mt_params = __ring_m53.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match54: {
              const __ring_m54 = List_first(mt_params);
              if (__ring_m54._tag === "some") {
                const first_param = __ring_m54._0;
  ...
  while (true) {
    ...
    __ring_match55: {
      ...
      if (__ring_m55._tag === "Lambda") {
        const lparams = __ring_m55.params; const lbody = __ring_m55.body; const lspan = __ring_m55.span;
        let __ring_blk8;
        __ring_match56: {
          const __ring_m56 = method_type;
          if (__ring_m56._tag === "some") {
            const mt = __ring_m56._0;
            let __ring_blk9;
            __ring_match57: {
              const __ring_m57 = mt;
              if (__ring_m57._tag === "FnType") {
                const mt_params = __ring_m57.params;
                let __ring_blk10;
                __ring_match58: {
                  const __ring_m58 = List_get(mt_params, (ai + 1));
                  if (__ring_m58._tag === "some") {
                    const expected_raw = __ring_m58._0;
                    const expected = env$apply_subst(s, expected_raw);
                    let __ring_blk11;
                    __ring_match59: {
                      const __ring_m59 = expected;
                      if (__ring_m59._tag === "FnType") {
                        const exp_params = __ring_m59.params;
  ...
  __ring_match60: {
    const __ring_m60 = method_type;
    if (__ring_m60._tag === "some") {
      const mt = __ring_m60._0;
      __ring_match61: {
        const __ring_m61 = mt;
        if (__ring_m61._tag === "FnType") {
          const mt_params = __ring_m61.params; const mt_ret = __ring_m61.return_type; const mt_effects = __ring_m61.effects;
          let i = 0;
          ...
          while (true) {
            ...
            if (((i + 1) < List_len(mt_params))) {
              __ring_match62: {
                const __ring_m62 = List_get(mt_params, (i + 1));
                if (__ring_m62._tag === "some") {
                  const expected_param = __ring_m62._0;
  ...
  let resolved_dicts = [];
  __ring_match65: {
    const __ring_m65 = method_scheme;
    if (__ring_m65._tag === "some") {
      const ms = __ring_m65._0;
  ...
  let __ring_blk12;
  __ring_match67: {
    const __ring_m67 = method_type;
    if (__ring_m67._tag === "some") {
      const mt = __ring_m67._0;
      __ring_blk12 = mt;
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  effects = me[0];
  s = me[1];
  const arm_body_resolved = env$apply_subst(s, hir$hexpr_type(body_r.hexpr));
  let __ring_blk13;
  __ring_match69: {
    const __ring_m69 = arm_body_resolved;
    if (__ring_m69._tag === "NeverType") {
      __ring_blk13 = true;
  ...
  const arm_is_never = __ring_blk13;
  if ((arm_is_never ? has_non_never_arm : false)) {
  } else {
  ...
  __ring_match71: {
    const __ring_m71 = missing;
    if (__ring_m71._tag === "some") {
      const m = __ring_m71._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  let result_type = types$UNIT;
  __ring_match73: {
    const __ring_m73 = else_branch;
    if (__ring_m73._tag === "some") {
      const eb = __ring_m73._0;
      __ring_match74: {
        const __ring_m74 = eb;
        if (__ring_m74._tag === "Block") {
        ...
        if (__ring_m74._tag === "IfExpr") {
          const ec = __ring_m74.condition; const etb = __ring_m74.then_branch; const eeb = __ring_m74.else_branch; const espan = __ring_m74.span;
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  while (true) {
    ...
    __ring_match75: {
      const __ring_m75 = effect_def;
      if (__ring_m75._tag === "some") {
        const ed = __ring_m75._0;
    ...
    __ring_match76: {
      const __ring_m76 = effect_def;
      if (__ring_m76._tag === "some") {
        const ed = __ring_m76._0;
    ...
    while (true) {
      ...
      let __ring_blk14;
      __ring_match77: {
        const __ring_m77 = p.type_annotation;
        if (__ring_m77._tag === "some") {
          const ta = __ring_m77._0;
          __ring_blk14 = infer_ctx$resolve_type_expr(ctx, ta);
          break __ring_match77;
        }
        if (__ring_m77._tag === "none") {
          let __ring_blk15;
          __ring_match78: {
            const __ring_m78 = op_def;
            if (__ring_m78._tag === "some") {
              const od = __ring_m78._0;
              let __ring_blk16;
              __ring_match79: {
                const __ring_m79 = List_get(od.params, hi);
                if (__ring_m79._tag === "some") {
                  const odt = __ring_m79._0;
                  __ring_blk16 = env$apply_subst_map(handler_inst_map, odt);
      ...
      const pt = __ring_blk14;
      env$TypeEnv_bind_mono(ctx.env, p.name, pt);
      List_push(hparams, new hir$HParam(p.name, pt, Option_none, false));
      hi = (hi + 1);
    }
    __ring_match80: {
      const __ring_m80 = handler.resume_name;
      if (__ring_m80._tag === "some") {
        const rn = __ring_m80._0;
        let __ring_blk17;
        __ring_match81: {
          const __ring_m81 = op_def;
          if (__ring_m81._tag === "some") {
            const od = __ring_m81._0;
            __ring_blk17 = env$apply_subst_map(handler_inst_map, od.return_type);
        ...
        const resume_param = __ring_blk17;
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match82: {
      const __ring_m82 = handler_body_result;
      if (__ring_m82._tag === "some") {
        const hbr = __ring_m82._0;
        s = hbr.subst;
  ...
  while (true) {
    ...
    __ring_match83: {
      const __ring_m83 = e;
      if (__ring_m83._tag === "IoEffect") {
        __ring_blk18 = (!_Set_contains(handled_effects, "io", __Str_Eq));
        break __ring_match83;
      }
      if (__ring_m83._tag === "CustomEffect") {
        const name = __ring_m83.name;
        __ring_blk18 = (!_Set_contains(handled_effects, name, __Str_Eq));
        break __ring_match83;
      }
      if (__ring_m83._tag === "FailEffect") {
        __ring_blk18 = (!_Set_contains(handled_effects, "fail", __Str_Eq));
        break __ring_match83;
      }
      if (__ring_m83._tag === "MutEffect") {
        __ring_blk18 = (!_Set_contains(handled_effects, "mut", __Str_Eq));
        break __ring_match83;
      }
      __match_fail(__ring_m83);
    }
    const should_keep = __ring_blk18;
    if (should_keep) {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match84: {
    ...
    if (__ring_m84._tag === "StructType") {
      ...
      __ring_match85: {
        const __ring_m85 = _Map_get(ctx.env.types.structs, name);
        if (__ring_m85._tag === "some") {
          const struct_def = __ring_m85._0;
          ...
          __ring_match86: {
            ...
            if (__ring_m86._tag === "some") {
              ...
              while (((fi < List_len(struct_def.type_param_vars)) ? (fi < List_len(type_params)) : false)) {
                __ring_match87: {
                  const __ring_m87 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m87) && __ring_m87.length === 2 && __ring_m87[0]._tag === "some" && __ring_m87[1]._tag === "some") {
                    const var_id = __ring_m87[0]._0; const tp = __ring_m87[1]._0;
    ...
    if (__ring_m84._tag === "RecordType") {
      const rec_fields = __ring_m84.fields; const tail = __ring_m84.tail;
    ...
    if (__ring_m84._tag === "TupleType") {
      ...
      __ring_match90: {
        const __ring_m90 = parse_int(field);
        ...
        if (__ring_m90._tag === "some") {
          ...
          __ring_match91: {
            const __ring_m91 = List_get(elements, i);
            if (__ring_m91._tag === "some") {
              const t = __ring_m91._0;
              field_type = t;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  while (true) {
    ...
    __ring_match92: {
      const __ring_m92 = eff;
      if (__ring_m92._tag === "FailEffect") {
        const et = __ring_m92.error_type;
        if (found_fail) {
  ...
  let __ring_blk19;
  __ring_match93: {
    const __ring_m93 = resolved_row.tail;
  ...
  const has_open_tail = __ring_blk19;
  ...
  let guard_hexpr = Option_none;
  __ring_match94: {
    const __ring_m94 = arm.guard;
    if (__ring_m94._tag === "some") {
      const g = __ring_m94._0;
      const gr = infer_expr(ctx, g, s, __ring_ev_fail);
      s = gr.subst;
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(gr.hexpr), types$BOOL, s, arm.span);
      const me = infer_ctx$merge_effects(ctx.env, effects, gr.effects, s, __ring_ev_fail);
  ...
  __ring_match96: {
    const __ring_m96 = missing;
    if (__ring_m96._tag === "some") {
      const m = __ring_m96._0;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  while (true) {
    ...
    let __ring_blk20;
    __ring_match97: {
      const __ring_m97 = p.type_annotation;
      if (__ring_m97._tag === "some") {
        const ta = __ring_m97._0;
        __ring_blk20 = infer_ctx$resolve_type_expr(ctx, ta);
    ...
    const pt = __ring_blk20;
    __ring_match98: {
      const __ring_m98 = expected_param_types;
      if (__ring_m98._tag === "some") {
        const epts = __ring_m98._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match99: {
            const __ring_m99 = List_get(epts, pi);
            if (__ring_m99._tag === "some") {
              const expected_t = __ring_m99._0;
    ...
    __ring_match100: {
      const __ring_m100 = lam_scheme;
      if (__ring_m100._tag === "some") {
        const ls = __ring_m100._0;
        __ring_match101: {
          const __ring_m101 = ls.def_id;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match102: {
    const __ring_m102 = body_result;
    if (__ring_m102._tag === "some") {
      const body_r = __ring_m102._0;
      s = body_r.subst;
      let applied_params = [];
...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  let __ring_blk21;
  __ring_match103: {
    const __ring_m103 = resolved_callee;
    if (__ring_m103._tag === "FnType") {
      __ring_blk21 = Option_some(resolved_callee);
      break __ring_match103;
    }
    __ring_blk21 = Option_none;
    break __ring_match103;
  }
  const callee_fn_type = __ring_blk21;
  let hargs = [];
  let arg_types = [];
  let ai = 0;
  ...
  while (true) {
    ...
    let __ring_blk22;
    __ring_match104: {
      const __ring_m104 = arg;
      if (__ring_m104._tag === "Lambda") {
        const lparams = __ring_m104.params; const lbody = __ring_m104.body; const lspan = __ring_m104.span;
        let __ring_blk23;
        __ring_match105: {
          const __ring_m105 = callee_fn_type;
          if (__ring_m105._tag === "some") {
            const cft = __ring_m105._0;
            let __ring_blk24;
            __ring_match106: {
              const __ring_m106 = cft;
              if (__ring_m106._tag === "FnType") {
                const cft_params = __ring_m106.params;
                let __ring_blk25;
                __ring_match107: {
                  const __ring_m107 = List_get(cft_params, ai);
                  if (__ring_m107._tag === "some") {
                    const expected_raw = __ring_m107._0;
                    const expected = env$apply_subst(s, expected_raw);
                    let __ring_blk26;
                    __ring_match108: {
                      const __ring_m108 = expected;
                      if (__ring_m108._tag === "FnType") {
                        const exp_params = __ring_m108.params;
                        __ring_blk26 = infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
                ...
                __ring_blk24 = ((ai < List_len(cft_params)) ? __ring_blk25 : infer_expr(ctx, arg, s, __ring_ev_fail));
  ...
  let __ring_blk27;
  __ring_match109: {
    const __ring_m109 = callee;
    if (__ring_m109._tag === "Ident") {
      const cn = __ring_m109.name;
      __ring_blk27 = Option_some(cn);
      break __ring_match109;
    }
    __ring_blk27 = Option_none;
    break __ring_match109;
  }
  const callee_name_for_defaults = __ring_blk27;
  __ring_match110: {
    const __ring_m110 = callee_name_for_defaults;
    if (__ring_m110._tag === "some") {
      const cn = __ring_m110._0;
      __ring_match111: {
        const __ring_m111 = _Map_get(ctx.fn_defaults, cn);
        if (__ring_m111._tag === "some") {
          const defaults = __ring_m111._0;
          __ring_match112: {
            const __ring_m112 = _Map_get(ctx.fn_min_arity, cn);
            if (__ring_m112._tag === "some") {
              const min_ar = __ring_m112._0;
              ...
              if (((List_len(args) < total_arity) ? (List_len(args) >= min_ar) : false)) {
                ...
                while ((di < List_len(defaults))) {
                  __ring_match113: {
                    const __ring_m113 = List_get(defaults, di);
                    if (__ring_m113._tag === "some") {
                      const dh = __ring_m113._0;
                      List_push(hargs, dh);
  ...
  __ring_match114: {
    ...
    if (__ring_m114._tag === "Ident") {
      const cn = __ring_m114.name;
      __ring_blk28 = cn;
      break __ring_match114;
    }
    __ring_blk28 = "<expression>";
    break __ring_match114;
  }
  const callee_name_for_note = __ring_blk28;
  ...
  __ring_match115: {
    const __ring_m115 = resolved_callee_type;
    if (__ring_m115._tag === "FnType") {
      const callee_params = __ring_m115.params; const fn_effects = __ring_m115.effects;
  ...
  __ring_match116: {
    ...
    if (__ring_m116._tag === "Ident") {
      ...
      __ring_match117: {
        const __ring_m117 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m117._tag === "some") {
          const callee_scheme = __ring_m117._0;
  ...
  __ring_match118: {
    const __ring_m118 = callee;
    if (__ring_m118._tag === "Ident") {
      const callee_name = __ring_m118.name;
      __ring_match119: {
        const __ring_m119 = _Map_get(ctx.fn_mut_params, callee_name);
        if (__ring_m119._tag === "some") {
          const mut_flags = __ring_m119._0;
          let mi = 0;
          while (((mi < List_len(mut_flags)) ? (mi < List_len(args)) : false)) {
            __ring_match120: {
              const __ring_m120 = [List_get(mut_flags, mi), List_get(hargs, mi)];
              if (Array.isArray(__ring_m120) && __ring_m120.length === 2 && __ring_m120[0]._tag === "some" && __ring_m120[1]._tag === "some") {
                const is_mut = __ring_m120[0]._0; const harg = __ring_m120[1]._0;
                if (is_mut) {
                  __ring_match121: {
                    const __ring_m121 = harg;
                    if (__ring_m121._tag === "Ident" && __ring_m121.def_id._tag === "some") {
                      const arg_did = __ring_m121.def_id._0;
                      if (_Set_contains(ctx.env.scope.mutable_vars, arg_did, __Int_Eq)) {
                        __ring_match122: {
                          const __ring_m122 = resolved_callee_type;
                          if (__ring_m122._tag === "FnType") {
                            const fn_params = __ring_m122.params;
                            __ring_match123: {
                              const __ring_m123 = List_get(fn_params, mi);
                              if (__ring_m123._tag === "some") {
                                const pt = __ring_m123._0;
...
function infer_stmt(ctx, stmt, subst, __ring_ev_fail) {
  __ring_match124: {
    const __ring_m124 = stmt;
    if (__ring_m124._tag === "Let") {
      const name = __ring_m124.name; const name_span = __ring_m124.name_span; const type_annotation = __ring_m124.type_annotation; const init = __ring_m124.init; const span = __ring_m124.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      let var_type = hir$hexpr_type(init_r.hexpr);
      __ring_match125: {
        const __ring_m125 = type_annotation;
        if (__ring_m125._tag === "some") {
          const ta = __ring_m125._0;
      ...
      let __ring_blk29;
      __ring_match126: {
        const __ring_m126 = bound_scheme;
        if (__ring_m126._tag === "some") {
          const bs = __ring_m126._0;
          let __ring_blk30;
          __ring_match127: {
            const __ring_m127 = bs.def_id;
            if (__ring_m127._tag === "some") {
              const did = __ring_m127._0;
              env$TypeEnv_record_def_span(ctx.env, did, name_span);
              _Set_insert(ctx.env.scope.let_defs, did);
              _Map_insert(ctx.var_lambda_depth, did, ctx.lambda_depth);
              __ring_blk30 = Option_some(did);
      ...
      const bound_def_id = __ring_blk29;
    ...
    if (__ring_m124._tag === "Var") {
      const name = __ring_m124.name; const name_span = __ring_m124.name_span; const type_annotation = __ring_m124.type_annotation; const init = __ring_m124.init; const span = __ring_m124.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      let var_type = hir$hexpr_type(init_r.hexpr);
      __ring_match128: {
        const __ring_m128 = type_annotation;
        if (__ring_m128._tag === "some") {
          const ta = __ring_m128._0;
          const annotated = infer_ctx$resolve_type_expr(ctx, ta);
          const notes = [new diagnostics$DiagnosticNote(`expected '${types$type_to_string(annotated)}' because variable '${name}' is declared with this type`, Option_some(name_span)), new diagnostics$DiagnosticNote(`initializer has type '${types$type_to_string(env$apply_subst(s, var_type))}'`, Option_some(hir$hexpr_span(init_r.hexpr)))];
          s = infer_ctx$unify_at_noted(ctx.sink, ctx.env, var_type, annotated, s, span, notes);
          var_type = env$apply_subst(s, annotated);
      ...
      __ring_match129: {
        const __ring_m129 = var_scheme;
        if (__ring_m129._tag === "some") {
          const vs = __ring_m129._0;
          __ring_match130: {
            const __ring_m130 = vs.def_id;
            if (__ring_m130._tag === "some") {
              const did = __ring_m130._0;
              env$TypeEnv_record_def_span(ctx.env, did, name_span);
              _Set_insert(ctx.env.scope.mutable_vars, did);
              _Map_insert(ctx.var_lambda_depth, did, ctx.lambda_depth);
    ...
    if (__ring_m124._tag === "Assign") {
      const target = __ring_m124.target; const value = __ring_m124.value; const span = __ring_m124.span;
      ...
      let effects = me[0];
      __ring_match131: {
        const __ring_m131 = infer_helpers$get_assign_target_root_def_id(ctx, target);
        if (__ring_m131._tag === "some") {
          const did = __ring_m131._0;
          if (_Set_contains(ctx.env.scope.mutable_vars, did, __Int_Eq)) {
            __ring_match132: {
              const __ring_m132 = _Map_get(ctx.var_lambda_depth, did);
              if (__ring_m132._tag === "some") {
                const def_depth = __ring_m132._0;
    ...
    if (__ring_m124._tag === "ExprStmt") {
      const expr = __ring_m124.expr; const span = __ring_m124.span;
    ...
    if (__ring_m124._tag === "Return") {
      const value = __ring_m124.value; const span = __ring_m124.span;
      __ring_match133: {
        const __ring_m133 = value;
        if (__ring_m133._tag === "some") {
          const v = __ring_m133._0;
          const r = infer_expr(ctx, v, subst, __ring_ev_fail);
          let s = r.subst;
          __ring_match134: {
            const __ring_m134 = ctx.current_fn_return_type;
            if (__ring_m134._tag === "some") {
              const ret_type = __ring_m134._0;
        ...
        if (__ring_m133._tag === "none") {
          let s = subst;
          __ring_match135: {
            const __ring_m135 = ctx.current_fn_return_type;
            if (__ring_m135._tag === "some") {
              const ret_type = __ring_m135._0;
    ...
    if (__ring_m124._tag === "While") {
      const condition = __ring_m124.condition; const body = __ring_m124.body; const span = __ring_m124.span;
      const cond_r = infer_expr(ctx, condition, subst, __ring_ev_fail);
    ...
    if (__ring_m124._tag === "ForIn") {
      const binding = __ring_m124.binding; const binding_span = __ring_m124.binding_span; const destructure = __ring_m124.destructure; const iterable = __ring_m124.iterable; const body = __ring_m124.body; const span = __ring_m124.span;
      ...
      let __ring_blk31;
      __ring_match137: {
        const __ring_m137 = iter_type;
        if (__ring_m137._tag === "EnumType") {
          const name = __ring_m137.name;
          __ring_blk31 = (name === hir$BUILTIN_RANGE);
          break __ring_match137;
        }
        __ring_blk31 = false;
        break __ring_match137;
      }
      const is_range = __ring_blk31;
      if (is_range) {
        __ring_match138: {
          const __ring_m138 = iter_type;
          if (__ring_m138._tag === "EnumType") {
            const type_params = __ring_m138.type_params;
            let __ring_blk32;
            __ring_match139: {
              const __ring_m139 = List_first(type_params);
              ...
              if (__ring_m139._tag === "none") {
                __ring_blk32 = types$INT;
                break __ring_match139;
              }
              __match_fail(__ring_m139);
            }
            element_type = __ring_blk32;
        ...
        __ring_match140: {
          const __ring_m140 = type_name;
          if (__ring_m140._tag === "some") {
            const tn = __ring_m140._0;
            const iterable_impl = env$find_impl(ctx.env.trait_reg, tn, "Iterable");
            __ring_match141: {
              const __ring_m141 = iterable_impl;
              if (__ring_m141._tag === "some") {
                const impl_entry = __ring_m141._0;
                iterable_type_name = Option_some(tn);
                __ring_match142: {
                  const __ring_m142 = _Map_get(impl_entry.assoc_types, "Iter");
                  if (__ring_m142._tag === "some") {
                    const iter_assoc_ty = __ring_m142._0;
                    let __ring_blk33;
                    __ring_match143: {
                      const __ring_m143 = iter_type;
                      if (__ring_m143._tag === "StructType") {
                        const tps = __ring_m143.type_params;
                        __ring_blk33 = tps;
                        break __ring_match143;
                      }
                      if (__ring_m143._tag === "EnumType") {
                        const tps = __ring_m143.type_params;
                        __ring_blk33 = tps;
                        break __ring_match143;
                      }
                    ...
                    const concrete_type_params = __ring_blk33;
                    const concrete_iter_name = types$type_to_builtin_name(iter_assoc_ty);
                    __ring_match144: {
                      const __ring_m144 = concrete_iter_name;
                      if (__ring_m144._tag === "some") {
                        const itn = __ring_m144._0;
                        ...
                        __ring_match145: {
                          const __ring_m145 = iterator_impl;
                          if (__ring_m145._tag === "some") {
                            const iter_impl_entry = __ring_m145._0;
                            __ring_match146: {
                              const __ring_m146 = _Map_get(iter_impl_entry.assoc_types, "Item");
                              if (__ring_m146._tag === "some") {
                                const item_assoc_ty = __ring_m146._0;
                                const item_name = types$type_to_builtin_name(item_assoc_ty);
                                __ring_match147: {
                                  const __ring_m147 = item_assoc_ty;
                                  if (__ring_m147._tag === "TypeVar") {
                                    let __ring_blk34;
                                    __ring_match148: {
                                      const __ring_m148 = List_first(concrete_type_params);
                                  ...
                                  if (__ring_m147._tag === "TupleType") {
                                    ...
                                    while (true) {
                                      ...
                                      __ring_match149: {
                                        const __ring_m149 = elem;
                                        if (__ring_m149._tag === "TypeVar") {
                                          __ring_match150: {
                                            const __ring_m150 = List_get(concrete_type_params, ei);
                                            if (__ring_m150._tag === "some") {
                                              const ct = __ring_m150._0;
      ...
      __ring_match151: {
        const __ring_m151 = destructure;
        if (__ring_m151._tag === "some") {
          const destr = __ring_m151._0;
          __ring_match152: {
          ...
          while ((di < List_len(destr.names))) {
            __ring_match153: {
              const __ring_m153 = List_get(destr.names, di);
              if (__ring_m153._tag === "some") {
                const dname = __ring_m153._0;
                let __ring_blk35;
                __ring_match154: {
                  const __ring_m154 = element_type;
                  if (__ring_m154._tag === "TupleType") {
                    const type_elems = __ring_m154.elements;
                    let __ring_blk36;
                    __ring_match155: {
                      const __ring_m155 = List_get(type_elems, di);
                      if (__ring_m155._tag === "some") {
                        const et = __ring_m155._0;
                        __ring_blk36 = et;
      ...
      __ring_match158: {
        const __ring_m158 = binding_scheme;
        if (__ring_m158._tag === "some") {
          const bs = __ring_m158._0;
          __ring_match159: {
            const __ring_m159 = bs.def_id;
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match160: {
        const __ring_m160 = body_result;
        if (__ring_m160._tag === "some") {
          const body_r = __ring_m160._0;
          s = body_r.subst;
          const me = infer_ctx$merge_effects(ctx.env, iter_r.effects, body_r.effects, s, __ring_ev_fail);
          let __ring_blk37;
          __ring_match161: {
            const __ring_m161 = binding_scheme;
            if (__ring_m161._tag === "some") {
              const bs = __ring_m161._0;
              __ring_blk37 = bs.def_id;
              break __ring_match161;
            }
            if (__ring_m161._tag === "none") {
              __ring_blk37 = Option_none;
              break __ring_match161;
            }
            __match_fail(__ring_m161);
          }
          return new infer_helpers$StmtResult(hir$HStmt_ForIn(binding, binding_span, __ring_blk37, hdestructure, iter_r.hexpr, body_r.hexpr, iterable_type_name, iter_type_name, span), me[1], me[0]);
    ...
    if (__ring_m124._tag === "Break") {
      const span = __ring_m124.span;
      if ((ctx.loop_depth === 0)) {
    ...
    if (__ring_m124._tag === "LetDestructure") {
      const pattern = __ring_m124.pattern; const init = __ring_m124.init; const span = __ring_m124.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      const init_type = env$apply_subst(s, hir$hexpr_type(init_r.hexpr));
      __ring_match162: {
        const __ring_m162 = init_type;
        if (__ring_m162._tag === "TupleType") {
      ...
      let __ring_blk38;
      __ring_match163: {
        const __ring_m163 = init_type;
        if (__ring_m163._tag === "TupleType") {
          const elements = __ring_m163.elements;
          __ring_blk38 = elements;
          break __ring_match163;
        }
        __ring_blk38 = [];
        break __ring_match163;
      }
      const tuple_elements = __ring_blk38;
      __ring_match164: {
        const __ring_m164 = pattern;
        if (__ring_m164._tag === "TuplePattern") {
          const pat_elements = __ring_m164.elements;
          ...
          while ((bi < List_len(pat_elements))) {
            __ring_match165: {
              const __ring_m165 = List_get(pat_elements, bi);
              if (__ring_m165._tag === "some") {
                const p = __ring_m165._0;
                let __ring_blk39;
                __ring_match166: {
                  const __ring_m166 = List_get(tuple_elements, bi);
                  if (__ring_m166._tag === "some") {
                    const et = __ring_m166._0;
                    __ring_blk39 = et;
                    break __ring_match166;
                  }
                  if (__ring_m166._tag === "none") {
                    __ring_blk39 = types$UNIT;
                    break __ring_match166;
                  }
                  __match_fail(__ring_m166);
                }
                const elem_type = __ring_blk39;
                __ring_match167: {
                  const __ring_m167 = p;
                  if (__ring_m167._tag === "Binding") {
                    const name = __ring_m167.name; const pspan = __ring_m167.span;
                    env$TypeEnv_bind_mono(ctx.env, name, elem_type);
                    const bscheme = env$TypeEnv_lookup(ctx.env, name);
                    __ring_match168: {
                      const __ring_m168 = bscheme;
                      if (__ring_m168._tag === "some") {
                        const bs = __ring_m168._0;
                        __ring_match169: {
                          const __ring_m169 = bs.def_id;
    ...
    if (__ring_m124._tag === "IfLet") {
      const pattern = __ring_m124.pattern; const expr = __ring_m124.expr; const then_block = __ring_m124.then_block; const else_block = __ring_m124.else_block; const span = __ring_m124.span;
      const expr_r = infer_expr(ctx, expr, subst, __ring_ev_fail);
      let s = expr_r.subst;
  ...
  return infer_block(ctx, then_block, Option_some(s), __ring_ev_fail);
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match170: {
        const __ring_m170 = then_result;
        if (__ring_m170._tag === "some") {
          const then_r = __ring_m170._0;
          s = then_r.subst;
          ...
          __ring_match171: {
            const __ring_m171 = else_block;
            if (__ring_m171._tag === "some") {
              const eb = __ring_m171._0;
              env$TypeEnv_push_scope(ctx.env);
              ...
              env$TypeEnv_pop_scope(ctx.env);
              __ring_match172: {
                const __ring_m172 = else_result;
                if (__ring_m172._tag === "some") {
                  const else_r = __ring_m172._0;
                  s = else_r.subst;
...
function infer_block(ctx, body, initial_subst, __ring_ev_fail) {
  __ring_match173: {
    const __ring_m173 = body;
    if (__ring_m173._tag === "Block") {
      const stmts = __ring_m173.stmts; const tail = __ring_m173.tail; const span = __ring_m173.span;
      let __ring_blk40;
      __ring_match174: {
        const __ring_m174 = initial_subst;
        ...
        if (__ring_m174._tag === "none") {
          __ring_blk40 = ctx.subst;
          break __ring_match174;
        }
        __match_fail(__ring_m174);
      }
      let subst = __ring_blk40;
      let effects = types$EMPTY_ROW;
      let hstmts = [];
...
function infer_expr(ctx, expr, subst, __ring_ev_fail) {
  __ring_match176: {
    const __ring_m176 = expr;
    if (__ring_m176._tag === "IntLit") {
      const value = __ring_m176.value; const span = __ring_m176.span;
    ...
    if (__ring_m176._tag === "FloatLit") {
      const value = __ring_m176.value; const span = __ring_m176.span;
      return new infer_ctx$InferResult(hir$HExpr_FloatLit(value, types$FLOAT, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match176;
    }
    if (__ring_m176._tag === "StrLit") {
      const value = __ring_m176.value; const span = __ring_m176.span;
      return new infer_ctx$InferResult(hir$HExpr_StrLit(value, types$STR, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match176;
    }
    if (__ring_m176._tag === "BoolLit") {
      const value = __ring_m176.value; const span = __ring_m176.span;
      return new infer_ctx$InferResult(hir$HExpr_BoolLit(value, types$BOOL, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match176;
    }
    if (__ring_m176._tag === "Ident") {
      const name = __ring_m176.name; const qualifier = __ring_m176.qualifier; const span = __ring_m176.span;
      return infer_helpers$infer_ident(ctx, name, span, subst, qualifier);
      break __ring_match176;
    }
    if (__ring_m176._tag === "BinOp") {
      const op = __ring_m176.op; const left = __ring_m176.left; const right = __ring_m176.right; const span = __ring_m176.span;
      return infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail);
      break __ring_match176;
    }
    if (__ring_m176._tag === "UnaryOp") {
      const op = __ring_m176.op; const operand = __ring_m176.operand; const span = __ring_m176.span;
      return infer_unary_op(ctx, op, operand, span, subst);
      break __ring_match176;
    }
    if (__ring_m176._tag === "Call") {
      const callee = __ring_m176.callee; const args = __ring_m176.args; const span = __ring_m176.span;
      return infer_call(ctx, callee, args, span, subst, __ring_ev_fail);
      break __ring_match176;
    }
    if (__ring_m176._tag === "MethodCall") {
      const receiver = __ring_m176.receiver; const method = __ring_m176.method; const args = __ring_m176.args; const span = __ring_m176.span;
      return infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail);
      break __ring_match176;
    }
    if (__ring_m176._tag === "FieldAccess") {
      const receiver = __ring_m176.receiver; const field = __ring_m176.field; const span = __ring_m176.span;
      return infer_field_access(ctx, receiver, field, span, subst);
      break __ring_match176;
    }
    if (__ring_m176._tag === "StructLit") {
      const name = __ring_m176.name; const qualifier = __ring_m176.qualifier; const fields = __ring_m176.fields; const spread = __ring_m176.spread; const span = __ring_m176.span;
      return infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail);
      break __ring_match176;
    }
    if (__ring_m176._tag === "MatchExpr") {
      const scrutinee = __ring_m176.scrutinee; const arms = __ring_m176.arms; const span = __ring_m176.span;
      return infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail);
      break __ring_match176;
    }
    if (__ring_m176._tag === "Block") {
      return infer_block(ctx, expr, Option_some(subst), __ring_ev_fail);
      break __ring_match176;
    }
    if (__ring_m176._tag === "IfExpr") {
      const condition = __ring_m176.condition; const then_branch = __ring_m176.then_branch; const else_branch = __ring_m176.else_branch; const span = __ring_m176.span;
      return infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail);
      break __ring_match176;
    }
    if (__ring_m176._tag === "StringInterp") {
      const parts = __ring_m176.parts; const span = __ring_m176.span;
      return infer_string_interp(ctx, parts, span, subst, __ring_ev_fail);
      break __ring_match176;
    }
    if (__ring_m176._tag === "CatchExpr") {
      const catch_expr = __ring_m176.expr; const arms = __ring_m176.arms; const span = __ring_m176.span;
      return infer_catch(ctx, catch_expr, arms, span, subst, __ring_ev_fail);
      break __ring_match176;
    }
    if (__ring_m176._tag === "HandleExpr") {
      const body = __ring_m176.body; const handlers = __ring_m176.handlers; const span = __ring_m176.span;
      return infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail);
      break __ring_match176;
    }
    if (__ring_m176._tag === "Lambda") {
      const params = __ring_m176.params; const body = __ring_m176.body; const span = __ring_m176.span;
      return infer_lambda(ctx, params, body, span, subst, Option_none, __ring_ev_fail);
      break __ring_match176;
    }
    if (__ring_m176._tag === "ListLit") {
      const elements = __ring_m176.elements; const span = __ring_m176.span;
      return infer_list_literal(ctx, elements, span, subst, __ring_ev_fail);
      break __ring_match176;
    }
    if (__ring_m176._tag === "TupleLit") {
      const elements = __ring_m176.elements; const span = __ring_m176.span;
      let s = subst;
      let helements = [];
      let combined_effects = types$EMPTY_ROW;
    ...
    if (__ring_m176._tag === "Range") {
      const start = __ring_m176.start; const end = __ring_m176.end; const inclusive = __ring_m176.inclusive; const span = __ring_m176.span;
    ...
    if (__ring_m176._tag === "IndexExpr") {
      const receiver = __ring_m176.receiver; const index = __ring_m176.index; const span = __ring_m176.span;
      return infer_index_expr(ctx, receiver, index, span, subst, __ring_ev_fail);
      break __ring_match176;
    }
    if (__ring_m176._tag === "ReturnExpr") {
      const value = __ring_m176.value; const span = __ring_m176.span;
      __ring_match177: {
        const __ring_m177 = value;
        if (__ring_m177._tag === "some") {
          const v = __ring_m177._0;
          const r = infer_expr(ctx, v, subst, __ring_ev_fail);
          let s = r.subst;
          __ring_match178: {
            const __ring_m178 = ctx.current_fn_return_type;
            if (__ring_m178._tag === "some") {
              const ret_type = __ring_m178._0;
              const return_notes = [new diagnostics$DiagnosticNote(`function return type is '${types$type_to_string(env$apply_subst(s, ret_type))}'`, Option_none), new diagnostics$DiagnosticNote(`return value has type '${types$type_to_string(env$apply_subst(s, hir$hexpr_type(r.hexpr)))}'`, Option_some(hir$hexpr_span(r.hexpr)))];
              s = infer_ctx$unify_at_noted(ctx.sink, ctx.env, hir$hexpr_type(r.hexpr), ret_type, s, span, return_notes);
        ...
        if (__ring_m177._tag === "none") {
          let s = subst;
          __ring_match179: {
            const __ring_m179 = ctx.current_fn_return_type;
            if (__ring_m179._tag === "some") {
              const ret_type = __ring_m179._0;
              s = infer_ctx$unify_at(ctx.sink, ctx.env, types$UNIT, ret_type, s, span);
...
function infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail) {
  ...
  __ring_match180: {
    ...
    if (__ring_m180._tag === "Sub") {
      result_type = infer_helpers$infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "-");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match180;
    }
    if (__ring_m180._tag === "Mul") {
      result_type = infer_helpers$infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "*");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match180;
    }
    if (__ring_m180._tag === "Div") {
      result_type = infer_helpers$infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "/");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match180;
    }
    if (__ring_m180._tag === "Mod") {
      result_type = infer_helpers$infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "%");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match180;
    }
    if ((__ring_m180._tag === "Eq") || (__ring_m180._tag === "Neq")) {
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      result_type = types$BOOL;
      ...
      let __ring_blk41;
      __ring_match181: {
        const __ring_m181 = op;
        if (__ring_m181._tag === "Eq") {
          __ring_blk41 = "==";
    ...
    if ((__ring_m180._tag === "Lt") || (__ring_m180._tag === "Lte") || (__ring_m180._tag === "Gt") || (__ring_m180._tag === "Gte")) {
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      result_type = types$BOOL;
      const resolved = env$apply_subst(s, hir$hexpr_type(lr.hexpr));
      let __ring_blk42;
      __ring_match182: {
        const __ring_m182 = op;
        if (__ring_m182._tag === "Lt") {
          __ring_blk42 = "<";
          break __ring_match182;
        }
        if (__ring_m182._tag === "Lte") {
          __ring_blk42 = "<=";
          break __ring_match182;
        }
        if (__ring_m182._tag === "Gt") {
          __ring_blk42 = ">";
          break __ring_match182;
        }
        __ring_blk42 = ">=";
