...
function infer_ident(ctx, name, span, subst, qualifier) {
  ...
  __ring_match44: {
    ...
    if (__ring_m44._tag === "none") {
      __ring_match45: {
        const __ring_m45 = resolved_qualifier;
  ...
  __match_fail(__ring_m);
      ...
      __ring_match46: {
        ...
        if (__ring_m46._tag === "some") {
          ...
          __ring_match47: {
            const __ring_m47 = _Map_get(ctx.env.types.enums, q);
            if (__ring_m47._tag === "some") {
              const enum_def = __ring_m47._0;
      ...
      __ring_match48: {
        const __ring_m48 = enum_name;
        if (__ring_m48._tag === "some") {
          const en = __ring_m48._0;
...
function infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail) {
  ...
  __ring_match49: {
    ...
    if (__ring_m49._tag === "Sub") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "-");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match49;
    }
    if (__ring_m49._tag === "Mul") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "*");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match49;
    }
    if (__ring_m49._tag === "Div") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "/");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match49;
    }
    if (__ring_m49._tag === "Mod") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "%");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match49;
    }
...
function is_primitive_eq(t) {
  __ring_match51: {
    ...
    if (__ring_m51._tag === "UnitType") {
      return true;
      break __ring_match51;
    }
    if (__ring_m51._tag === "NeverType") {
      return true;
      break __ring_match51;
    }
    if (__ring_m51._tag === "AnyType") {
      return true;
      break __ring_match51;
    }
    return false;
...
function resolve_trait_dispatch(ctx, resolved, trait_name, error_code, subst, span, op, is_builtin) {
  ...
  __ring_match54: {
    ...
    if (__ring_m54._tag === "TypeVar") {
      ...
      __ring_match55: {
        const __ring_m55 = bound;
        if (__ring_m55._tag === "some") {
          const b = __ring_m55._0;
      ...
      __ring_match56: {
        const __ring_m56 = _Map_get(ctx.env.scope.var_bounds, id);
        if (__ring_m56._tag === "some") {
          const var_bounds = __ring_m56._0;
...
function resolve_trait_extra_dicts(ctx, type_args, subst, trait_name) {
  ...
  for (const arg of type_args) {
    ...
    __ring_match57: {
      const __ring_m57 = dict;
      if (__ring_m57._tag === "some") {
        const d = __ring_m57._0;
        List_push(dicts, d);
...
function resolve_type_to_trait_dict(ctx, t, trait_name) {
  __ring_match58: {
    const __ring_m58 = types$type_to_builtin_name(t);
    if (__ring_m58._tag === "some") {
      const builtin_name = __ring_m58._0;
      __ring_match59: {
        const __ring_m59 = t;
  ...
  __ring_match60: {
    ...
    if (__ring_m60._tag === "TypeVar") {
      ...
      __ring_match61: {
        const __ring_m61 = bound;
        if (__ring_m61._tag === "some") {
          const b = __ring_m61._0;
...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match64: {
    const __ring_m64 = expected;
    if (__ring_m64._tag === "FnType") {
      const exp_params = __ring_m64.params;
  ...
  __ring_match65: {
    const __ring_m65 = resolved_callee_type;
    if (__ring_m65._tag === "FnType") {
      const fn_effects = __ring_m65.effects;
  ...
  let resolved_dicts = [];
  __ring_match66: {
    const __ring_m66 = callee;
    if (__ring_m66._tag === "Ident") {
      const callee_name = __ring_m66.name;
      __ring_match67: {
        const __ring_m67 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m67._tag === "some") {
          const callee_scheme = __ring_m67._0;
...
function resolve_arg_dict_closure(ctx, harg, s) {
  __ring_match68: {
    const __ring_m68 = harg;
    if (__ring_m68._tag === "Ident") {
      const name = __ring_m68.name; const resolved_name = __ring_m68.resolved_name; const def_id = __ring_m68.def_id; const ty = __ring_m68.ty; const effects = __ring_m68.effects; const span = __ring_m68.span;
      const arg_scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match69: {
        const __ring_m69 = arg_scheme;
        if (__ring_m69._tag === "some") {
          const as_ = __ring_m69._0;
          ...
          for (const bound of as_.bounds) {
            __ring_match70: {
              const __ring_m70 = _Map_get(var_map, bound.type_var);
              if (__ring_m70._tag === "some") {
                const fresh_var = __ring_m70._0;
...
function resolve_arg_bound_dict(ctx, concrete, trait_name, dicts) {
  __ring_match71: {
    const __ring_m71 = concrete;
    if (__ring_m71._tag === "StructType") {
      const name = __ring_m71.name;
    ...
    if (__ring_m71._tag === "TypeVar") {
      ...
      __ring_match72: {
        const __ring_m72 = matching;
        if (__ring_m72._tag === "some") {
          const fb = __ring_m72._0;
    ...
    __ring_match73: {
      const __ring_m73 = types$type_to_builtin_name(concrete);
...
function check_expr_is_let_def(ctx, expr) {
  __ring_match74: {
    const __ring_m74 = expr;
    if (__ring_m74._tag === "Ident") {
      const name = __ring_m74.name;
      __ring_match75: {
        const __ring_m75 = env$TypeEnv_lookup(ctx.env, name);
    ...
    if (__ring_m74._tag === "FieldAccess") {
      const inner = __ring_m74.receiver;
...
function check_receiver_mutability(ctx, receiver, recv_type, method, span) {
  ...
  __ring_match77: {
    ...
    __ring_match78: {
      const __ring_m78 = types$type_to_builtin_name(recv_type);
      if (__ring_m78._tag === "some") {
        const n = __ring_m78._0;
  ...
  __ring_match79: {
    const __ring_m79 = type_name;
    if (__ring_m79._tag === "some") {
      const tname = __ring_m79._0;
      __ring_match80: {
        const __ring_m80 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m80._tag === "some") {
          const mut_set = __ring_m80._0;
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match81: {
    const __ring_m81 = receiver;
    if (__ring_m81._tag === "Ident") {
      const recv_name = __ring_m81.name;
      __ring_match82: {
        const __ring_m82 = _Map_get(ctx.env.types.effects, recv_name);
  ...
  if (Option_is_none(method_type)) {
    __ring_match84: {
      const __ring_m84 = types$type_to_builtin_name(recv_type);
      if (__ring_m84._tag === "some") {
        const prim_name = __ring_m84._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match86: {
      const __ring_m86 = recv_var_id;
      if (__ring_m86._tag === "some") {
        const rvid = __ring_m86._0;
        for (const fb of ctx.current_fn_bounds) {
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match87: {
              const __ring_m87 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m87._tag === "some") {
                ...
                __ring_match88: {
                  ...
                  if (__ring_m88._tag === "some") {
                    const found_method = __ring_m88._0;
    ...
    if (__ring_m89._tag === "some") {
      ...
      __ring_match90: {
        ...
        if (__ring_m90._tag === "FnType") {
          const mt_params = __ring_m90.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match91: {
              const __ring_m91 = List_first(mt_params);
              if (__ring_m91._tag === "some") {
                const first_param = __ring_m91._0;
  ...
  const expected = env$apply_subst(s, expected_raw);
  __ring_match92: {
    const __ring_m92 = expected;
    if (__ring_m92._tag === "FnType") {
      const exp_params = __ring_m92.params;
      return infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
  ...
  __ring_match93: {
    const __ring_m93 = method_type;
    if (__ring_m93._tag === "some") {
      const mt = __ring_m93._0;
      __ring_match94: {
        const __ring_m94 = mt;
        if (__ring_m94._tag === "FnType") {
          const mt_params = __ring_m94.params; const mt_ret = __ring_m94.return_type; const mt_effects = __ring_m94.effects;
          let i = 0;
          for (const harg of hargs) {
            if (((i + 1) < List_len(mt_params))) {
              __ring_match95: {
                const __ring_m95 = List_get(mt_params, (i + 1));
                if (__ring_m95._tag === "some") {
                  const expected_param = __ring_m95._0;
  ...
  let resolved_dicts = [];
  __ring_match98: {
    const __ring_m98 = method_scheme;
    if (__ring_m98._tag === "some") {
      const ms = __ring_m98._0;
      if ((List_len(ms.bounds) > 0)) {
        __ring_match99: {
          const __ring_m99 = method_type;
          if (__ring_m99._tag === "some") {
            const mt = __ring_m99._0;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match100: {
    const __ring_m100 = _Map_get(ctx.env.trait_reg.impl_methods, type_name);
    if (__ring_m100._tag === "some") {
      const impl_methods = __ring_m100._0;
      __ring_match101: {
        const __ring_m101 = _Map_get(impl_methods, method);
        if (__ring_m101._tag === "some") {
          const scheme = __ring_m101._0;
...
function lookup_trait_method(ctx, type_name, method, span) {
  ...
  for (const impl_entry of ctx.env.trait_reg.trait_impls) {
    if ((impl_entry.target_type_name === type_name)) {
      __ring_match102: {
        const __ring_m102 = _Map_get(ctx.env.trait_reg.traits, impl_entry.trait_name);
        if (__ring_m102._tag === "some") {
          const trait_def = __ring_m102._0;
          const tm = ((__a) => { const __i = __a.findIndex((function(m) { return (m.name === method); })); return __i >= 0 ? { _tag: "some", _0: __a[__i] } : { _tag: "none" }; })(trait_def.methods);
          __ring_match103: {
            const __ring_m103 = tm;
            if (__ring_m103._tag === "some") {
              const found_method = __ring_m103._0;
              __ring_match104: {
                const __ring_m104 = found_trait_name;
                if (__ring_m104._tag === "some") {
                  const prev_trait = __ring_m104._0;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match105: {
    const __ring_m105 = effect_def_opt;
  ...
  for (const arg of args) {
    ...
    List_push(hargs, ar.hexpr);
    __ring_match107: {
      const __ring_m107 = List_get(op.params, i);
      if (__ring_m107._tag === "some") {
        const param_type = __ring_m107._0;
  ...
  __ring_match108: {
    const __ring_m108 = effect_def.built_in_kind;
    if (__ring_m108._tag === "some") {
      const bik = __ring_m108._0;
      __ring_match109: {
        const __ring_m109 = bik;
        if (__ring_m109._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match109;
        }
        if (__ring_m109._tag === "BkFail") {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match110: {
    ...
    if (__ring_m110._tag === "StructType") {
      ...
      __ring_match111: {
        ...
        if (__ring_m111._tag === "some") {
          const struct_def = __ring_m111._0;
          ...
          __ring_match112: {
            ...
            if (__ring_m112._tag === "some") {
              const found_field = __ring_m112._0;
              let inst_map = map_new();
              let fi = 0;
              while (((fi < List_len(struct_def.type_param_vars)) && (fi < List_len(type_params)))) {
                __ring_match113: {
                  const __ring_m113 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m113) && __ring_m113.length === 2 && __ring_m113[0]._tag === "some" && __ring_m113[1]._tag === "some") {
                    const var_id = __ring_m113[0]._0; const tp = __ring_m113[1]._0;
    ...
    if (__ring_m110._tag === "RecordType") {
      const rec_fields = __ring_m110.fields; const tail = __ring_m110.tail;
    ...
    if (__ring_m110._tag === "TupleType") {
      const elements = __ring_m110.elements;
      __ring_match116: {
        const __ring_m116 = parse_int(field);
        ...
        if (__ring_m116._tag === "some") {
          ...
          __ring_match117: {
            const __ring_m117 = List_get(elements, i);
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  let resolved_qualifier = qualifier;
  __ring_match118: {
    const __ring_m118 = qualifier;
    if (__ring_m118._tag === "some") {
      const q = __ring_m118._0;
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match119: {
          const __ring_m119 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m119._tag === "some") {
            const prefix = __ring_m119._0;
            if ((prefix === "")) {
              resolved_qualifier = Option_none;
            } else {
              resolved_qualifier = Option_some(prefix);
  ...
  __ring_match120: {
    const __ring_m120 = resolved_qualifier;
    if (__ring_m120._tag === "some") {
      const q = __ring_m120._0;
      const qualified_name = `${q}::${name}`;
      const mod_struct = _Map_get(ctx.env.types.structs, qualified_name);
      __ring_match121: {
        const __ring_m121 = mod_struct;
  ...
  __ring_match122: {
    const __ring_m122 = resolved_qualifier;
    if (__ring_m122._tag === "some") {
      const q = __ring_m122._0;
      __ring_match123: {
        const __ring_m123 = _Map_get(ctx.env.types.enums, q);
        if (__ring_m123._tag === "some") {
          const enum_def = __ring_m123._0;
          if (enum_def.variants.some((function(v) { return (v.name === name); }))) {
  ...
  if ((Option_is_none(variant_enum) && Option_is_some(resolved_qualifier))) {
    __ring_match124: {
      const __ring_m124 = resolved_qualifier;
      if (__ring_m124._tag === "some") {
        const q = __ring_m124._0;
        const _ = infer_ctx$type_error(ctx.sink, codes$E0201, `'${q}' has no variant '${name}'`, span, diagnostics$DiagnosticContext_UndefinedVariable(name, Option_none));
  ...
  __ring_match125: {
    const __ring_m125 = variant_enum;
    if (__ring_m125._tag === "some") {
      const ve = __ring_m125._0;
      __ring_match126: {
        const __ring_m126 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m126._tag === "some") {
          ...
          __ring_match127: {
            const __ring_m127 = variant;
            if (__ring_m127._tag === "some") {
              const v = __ring_m127._0;
              __ring_match128: {
                const __ring_m128 = v.field_names;
  ...
  __ring_match129: {
    const __ring_m129 = struct_def_opt;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match130: {
      const __ring_m130 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m130._tag === "some") {
        const var_id = __ring_m130._0;
  ...
  for (const field of fields) {
    ...
    __ring_match132: {
      const __ring_m132 = def_field;
      if (__ring_m132._tag === "some") {
        const df = __ring_m132._0;
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match137: {
    const __ring_m137 = arm.pattern;
    if (__ring_m137._tag === "Binding") {
      const pat_name = __ring_m137.name; const pspan = __ring_m137.span;
      __ring_match138: {
        const __ring_m138 = _Map_get(ctx.env.types.variant_to_enum, pat_name);
        if (__ring_m138._tag === "some") {
          const ve = __ring_m138._0;
          __ring_match139: {
            const __ring_m139 = _Map_get(ctx.env.types.enums, ve);
            if (__ring_m139._tag === "some") {
              const edef = __ring_m139._0;
  ...
  __ring_match143: {
    const __ring_m143 = missing;
    if (__ring_m143._tag === "some") {
      const m = __ring_m143._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  let result_type = types$UNIT;
  __ring_match144: {
    const __ring_m144 = else_branch;
    if (__ring_m144._tag === "some") {
      const eb = __ring_m144._0;
      __ring_match145: {
        const __ring_m145 = eb;
        if (__ring_m145._tag === "Block") {
        ...
        if (__ring_m145._tag === "IfExpr") {
          const ec = __ring_m145.condition; const etb = __ring_m145.then_branch; const eeb = __ring_m145.else_branch; const espan = __ring_m145.span;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  for (const part of parts) {
    __ring_match146: {
      const __ring_m146 = part;
      if (__ring_m146._tag === "LitPart") {
        const str_val = __ring_m146._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match146;
      }
      if (__ring_m146._tag === "ExprPart") {
        const expr = __ring_m146._0;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  for (const eff of effects.effects) {
    __ring_match147: {
      const __ring_m147 = eff;
      if (__ring_m147._tag === "FailEffect") {
        const et = __ring_m147.error_type;
        if (found_fail) {
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  for (const handler of handlers) {
    ...
    __ring_match150: {
      const __ring_m150 = effect_def;
      if (__ring_m150._tag === "some") {
        const ed = __ring_m150._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match151: {
      const __ring_m151 = handler.resume_name;
      if (__ring_m151._tag === "some") {
        const rn = __ring_m151._0;
  ...
  __match_fail(__ring_m);
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match152: {
      const __ring_m152 = handler_body_result;
      if (__ring_m152._tag === "some") {
        const hbr = __ring_m152._0;
        s = hbr.subst;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match153: {
      const __ring_m153 = expected_param_types;
      if (__ring_m153._tag === "some") {
        const epts = __ring_m153._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match154: {
            const __ring_m154 = List_get(epts, pi);
            if (__ring_m154._tag === "some") {
              const expected_t = __ring_m154._0;
    ...
    __ring_match155: {
      const __ring_m155 = lam_scheme;
      if (__ring_m155._tag === "some") {
        const ls = __ring_m155._0;
        __ring_match156: {
          const __ring_m156 = ls.def_id;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match157: {
    const __ring_m157 = body_result;
    if (__ring_m157._tag === "some") {
      const body_r = __ring_m157._0;
      s = body_r.subst;
      let applied_params = [];
