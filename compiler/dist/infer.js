...
function cancel_local_mut_effects(ctx, effects, callee_params, callee_effects, hargs, param_offset, s) {
  ...
  const filtered = effects.effects.filter((function(e) { return (function() {
  const __ring_m = e;
  if (__ring_m._tag === "MutEffect") { const state_type = __ring_m.state_type; return (function() {
  const resolved_st = env$apply_subst(s, state_type);
  return (!cancel_types.value.some((function(ct) { return types$types_equal(ct, resolved_st); })));
})(); }
  return true;
})(); }));
...
function find_root_expr(e) {
  __ring_match10: {
    ...
    if (__ring_m10._tag === "FieldAccess") {
      const receiver = __ring_m10.receiver;
...
function check_assign_target_mutable(ctx, target) {
  __ring_match11: {
    const __ring_m11 = target;
    if (__ring_m11._tag === "Ident") {
      const name = __ring_m11.name; const span = __ring_m11.span;
      const scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match12: {
        const __ring_m12 = scheme;
        if (__ring_m12._tag === "some") {
          const s = __ring_m12._0;
          __ring_match13: {
            const __ring_m13 = s.def_id;
            if (__ring_m13._tag === "some") {
              const did = __ring_m13._0;
    ...
    if (__ring_m11._tag === "FieldAccess") {
      const receiver = __ring_m11.receiver; const span = __ring_m11.span;
      const root = find_root_expr(receiver);
      __ring_match14: {
        const __ring_m14 = root;
        if (__ring_m14._tag === "Ident") {
          const name = __ring_m14.name; const rspan = __ring_m14.span;
          const scheme = env$TypeEnv_lookup(ctx.env, name);
          __ring_match15: {
            const __ring_m15 = scheme;
            if (__ring_m15._tag === "some") {
              const s = __ring_m15._0;
              __ring_match16: {
                const __ring_m16 = s.def_id;
                if (__ring_m16._tag === "some") {
                  const did = __ring_m16._0;
                  if ((!_Set_contains(ctx.env.scope.mutable_vars, did, __Int_Eq))) {
    ...
    if (__ring_m11._tag === "IndexExpr") {
      ...
      const root = find_root_expr(receiver);
      __ring_match17: {
        const __ring_m17 = root;
        if (__ring_m17._tag === "Ident") {
          const name = __ring_m17.name; const rspan = __ring_m17.span;
          const scheme = env$TypeEnv_lookup(ctx.env, name);
          __ring_match18: {
            const __ring_m18 = scheme;
            if (__ring_m18._tag === "some") {
              const s = __ring_m18._0;
              __ring_match19: {
                const __ring_m19 = s.def_id;
                if (__ring_m19._tag === "some") {
                  const did = __ring_m19._0;
                  if ((!_Set_contains(ctx.env.scope.mutable_vars, did, __Int_Eq))) {
...
function check_expr_is_let_def(ctx, expr) {
  __ring_match20: {
    const __ring_m20 = expr;
    if (__ring_m20._tag === "Ident") {
      const name = __ring_m20.name;
      __ring_match21: {
        const __ring_m21 = env$TypeEnv_lookup(ctx.env, name);
        if (__ring_m21._tag === "some") {
          const s = __ring_m21._0;
          __ring_match22: {
            const __ring_m22 = s.def_id;
    ...
    if (__ring_m20._tag === "FieldAccess") {
      const inner = __ring_m20.receiver;
...
function check_receiver_mutability(ctx, receiver, recv_type, method, span) {
  ...
  __ring_match23: {
    ...
    __ring_match24: {
      const __ring_m24 = types$type_to_builtin_name(recv_type);
      if (__ring_m24._tag === "some") {
        const n = __ring_m24._0;
  ...
  __ring_match25: {
    ...
    if (__ring_m25._tag === "some") {
      const tname = __ring_m25._0;
      __ring_match26: {
        const __ring_m26 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m26._tag === "some") {
          const mut_set = __ring_m26._0;
...
function get_expr_def_id(ctx, expr) {
  __ring_match27: {
    const __ring_m27 = expr;
    if (__ring_m27._tag === "Ident") {
      const name = __ring_m27.name;
      __ring_match28: {
        const __ring_m28 = env$TypeEnv_lookup(ctx.env, name);
...
function infer_ident(ctx, name, span, subst, qualifier) {
  ...
  __ring_match29: {
    const __ring_m29 = qualifier;
    if (__ring_m29._tag === "some") {
      const q = __ring_m29._0;
      if (((q === "self") ? true : Str_starts_with(q, "super"))) {
        __ring_match30: {
          const __ring_m30 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m30._tag === "some") {
            const prefix = __ring_m30._0;
            if ((prefix === "")) {
      ...
      __ring_match32: {
        ...
        if (__ring_m32._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match33: {
              const __ring_m33 = full_scheme;
              if (__ring_m33._tag === "some") {
                const fs = __ring_m33._0;
    ...
    if (__ring_m34._tag === "some") {
      ...
      __ring_match36: {
        ...
        if (__ring_m36._tag === "some") {
          ...
          if (_Set_contains(ctx.env.scope.mutable_vars, did, __Int_Eq)) {
            __ring_match37: {
              const __ring_m37 = _Map_get(ctx.var_lambda_depth, did);
              if (__ring_m37._tag === "some") {
                const def_depth = __ring_m37._0;
  ...
  __match_fail(__ring_m);
      ...
      __ring_match38: {
        const __ring_m38 = resolved_qualifier;
        if (__ring_m38._tag === "some") {
          const q = __ring_m38._0;
          __ring_match39: {
            const __ring_m39 = _Map_get(ctx.env.types.enums, q);
            if (__ring_m39._tag === "some") {
              const enum_def = __ring_m39._0;
      ...
      __ring_match40: {
        const __ring_m40 = enum_name;
        if (__ring_m40._tag === "some") {
          const en = __ring_m40._0;
...
function is_value_type(t) {
  __ring_match41: {
    const __ring_m41 = t;
    if (__ring_m41._tag === "IntType") {
      return true;
      break __ring_match41;
    }
    if (__ring_m41._tag === "FloatType") {
      return true;
      break __ring_match41;
    }
    if (__ring_m41._tag === "BoolType") {
      return true;
      break __ring_match41;
    }
...
function resolve_arg_bound_dict(ctx, concrete, trait_name, dicts) {
  __ring_match42: {
    const __ring_m42 = concrete;
    if (__ring_m42._tag === "StructType") {
    ...
    if (__ring_m42._tag === "TypeVar") {
      ...
      __ring_match43: {
        const __ring_m43 = matching;
        if (__ring_m43._tag === "some") {
          const fb = __ring_m43._0;
    ...
    __ring_match44: {
      const __ring_m44 = types$type_to_builtin_name(concrete);
      if (__ring_m44._tag === "some") {
        const prim_name = __ring_m44._0;
...
function resolve_arg_dict_closure(ctx, harg, s) {
  __ring_match45: {
    const __ring_m45 = harg;
    if (__ring_m45._tag === "Ident") {
      const name = __ring_m45.name; const resolved_name = __ring_m45.resolved_name; const def_id = __ring_m45.def_id; const ty = __ring_m45.ty; const effects = __ring_m45.effects; const span = __ring_m45.span;
      const arg_scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match46: {
        const __ring_m46 = arg_scheme;
        if (__ring_m46._tag === "some") {
          const as_ = __ring_m46._0;
          ...
          while (true) {
            ...
            __ring_match47: {
              const __ring_m47 = _Map_get(var_map, bound.type_var);
              if (__ring_m47._tag === "some") {
                const fresh_var = __ring_m47._0;
...
function is_mut_method_call(ctx, recv_type, method) {
  let type_name = Option_none;
  __ring_match48: {
    const __ring_m48 = recv_type;
    if (__ring_m48._tag === "StructType") {
      const name = __ring_m48.name;
      type_name = Option_some(name);
      break __ring_match48;
    }
    if (__ring_m48._tag === "EnumType") {
      const name = __ring_m48.name;
      type_name = Option_some(name);
      break __ring_match48;
    }
    __ring_match49: {
      const __ring_m49 = types$type_to_builtin_name(recv_type);
      if (__ring_m49._tag === "some") {
        const n = __ring_m49._0;
        type_name = Option_some(n);
  ...
  __ring_match50: {
    const __ring_m50 = type_name;
    if (__ring_m50._tag === "some") {
      const tname = __ring_m50._0;
      __ring_match51: {
        const __ring_m51 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m51._tag === "some") {
          const mut_set = __ring_m51._0;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match52: {
    const __ring_m52 = _Map_get(ctx.env.trait_reg.impl_methods, type_name);
    if (__ring_m52._tag === "some") {
      const impl_methods = __ring_m52._0;
      __ring_match53: {
        const __ring_m53 = _Map_get(impl_methods, method);
        if (__ring_m53._tag === "some") {
          const scheme = __ring_m53._0;
...
function lookup_trait_method(ctx, type_name, method, span) {
  ...
  __ring_match54: {
    const __ring_m54 = _Map_get(ctx.env.trait_reg.trait_impls, type_name);
    if (__ring_m54._tag === "some") {
      const type_impls = __ring_m54._0;
      ...
      while (true) {
        ...
        __ring_match55: {
          const __ring_m55 = _Map_get(ctx.env.trait_reg.traits, impl_entry.trait_name);
          if (__ring_m55._tag === "some") {
            ...
            __ring_match56: {
              ...
              if (__ring_m56._tag === "some") {
                const found_method = __ring_m56._0;
                __ring_match57: {
                  const __ring_m57 = found_trait_name;
                  if (__ring_m57._tag === "some") {
                    const prev_trait = __ring_m57._0;
...
function resolve_var_id(id, sub) {
  __ring_match58: {
    const __ring_m58 = union_find$uf_lookup(sub, id);
    if (__ring_m58._tag === "some") {
      const resolved = __ring_m58._0;
      __ring_match59: {
        const __ring_m59 = resolved;
        if (__ring_m59._tag === "TypeVar") {
          const new_id = __ring_m59.id;
...
function rewrite_bare_enum_bindings(env, pattern) {
  __ring_match60: {
    const __ring_m60 = pattern;
    if (__ring_m60._tag === "Binding") {
      const name = __ring_m60.name; const span = __ring_m60.span;
      __ring_match61: {
        const __ring_m61 = _Map_get(env.types.variant_to_enum, name);
        if (__ring_m61._tag === "some") {
          const ve = __ring_m61._0;
          __ring_match62: {
            const __ring_m62 = _Map_get(env.types.enums, ve);
            if (__ring_m62._tag === "some") {
              const edef = __ring_m62._0;
              const v = env$lookup_variant(edef, name);
              __ring_match63: {
                const __ring_m63 = v;
                if (__ring_m63._tag === "some") {
                  const found_v = __ring_m63._0;
    ...
    if (__ring_m60._tag === "TuplePattern") {
      const elements = __ring_m60.elements; const span = __ring_m60.span;
      let new_elems = [];
    ...
    if (__ring_m60._tag === "Constructor") {
      const name = __ring_m60.name; const qualifier = __ring_m60.qualifier; const fields = __ring_m60.fields; const span = __ring_m60.span;
      let new_fields = [];
    ...
    if (__ring_m60._tag === "NamedConstructor") {
      const name = __ring_m60.name; const qualifier = __ring_m60.qualifier; const fields = __ring_m60.fields; const rest = __ring_m60.rest; const span = __ring_m60.span;
      let new_fields = [];
    ...
    if (__ring_m60._tag === "OrPattern") {
      const patterns = __ring_m60.patterns; const span = __ring_m60.span;
      let new_pats = [];
...
function infer_numeric_op(ctx, left, right, s, span, op_str) {
  ...
  __ring_match64: {
    const __ring_m64 = resolved;
    if (__ring_m64._tag === "TypeVar") {
      const tv_id = __ring_m64.id;
      ...
      while (true) {
        ...
        __ring_match65: {
          const __ring_m65 = tp_type;
          if (__ring_m65._tag === "TypeVar") {
            const tp_id = __ring_m65.id;
    ...
    if (__ring_m64._tag === "IntType") {
      return types$INT;
      break __ring_match64;
    }
    if (__ring_m64._tag === "FloatType") {
      return types$FLOAT;
      break __ring_match64;
    }
...
function is_primitive_eq(t) {
  __ring_match66: {
    ...
    if (__ring_m66._tag === "BoolType") {
      return true;
      break __ring_match66;
    }
    if (__ring_m66._tag === "UnitType") {
      return true;
      break __ring_match66;
    }
    if (__ring_m66._tag === "NeverType") {
      return true;
      break __ring_match66;
    }
    if (__ring_m66._tag === "AnyType") {
      return true;
      break __ring_match66;
    }
    return false;
...
function resolve_type_to_dict_ref(ctx, t, subst, trait_name) {
  __ring_match68: {
    const __ring_m68 = types$type_to_builtin_name(t);
    if (__ring_m68._tag === "some") {
      const builtin_name = __ring_m68._0;
      __ring_match69: {
        const __ring_m69 = t;
  ...
  __ring_match70: {
    ...
    if (__ring_m70._tag === "TypeVar") {
      ...
      __ring_match71: {
        const __ring_m71 = bound;
        if (__ring_m71._tag === "some") {
          const b = __ring_m71._0;
    ...
    if (__ring_m70._tag === "StructType") {
      ...
      if (env$has_impl(ctx.env.trait_reg, name, trait_name)) {
        if ((List_len(type_params) > 0)) {
          ...
          __ring_match72: {
            const __ring_m72 = inner;
            if (__ring_m72._tag === "some") {
              const inner_dicts = __ring_m72._0;
    ...
    if (__ring_m70._tag === "EnumType") {
      const name = __ring_m70.name; const type_params = __ring_m70.type_params;
      if (env$has_impl(ctx.env.trait_reg, name, trait_name)) {
        if ((List_len(type_params) > 0)) {
          const inner = resolve_trait_extra_dicts(ctx, type_params, subst, trait_name);
          __ring_match73: {
            const __ring_m73 = inner;
            if (__ring_m73._tag === "some") {
              const inner_dicts = __ring_m73._0;
              return Option_some(hir$DictRef_Wrapped(hir$trait_dict_name(name, trait_name), trait_name, inner_dicts));
...
function resolve_trait_extra_dicts(ctx, type_args, subst, trait_name) {
  ...
  while (true) {
    ...
    __ring_match74: {
      const __ring_m74 = dict;
      if (__ring_m74._tag === "some") {
        const d = __ring_m74._0;
        List_push(dicts, d);
...
function resolve_trait_dispatch(ctx, resolved, trait_name, error_code, subst, span, op, is_builtin) {
  ...
  __ring_match76: {
    const __ring_m76 = bound_resolved;
    if (__ring_m76._tag === "TypeVar") {
      const bid = __ring_m76.id;
      return (bid === id);
    ...
    break __ring_match76;
      ...
      __ring_match78: {
        const __ring_m78 = _Map_get(ctx.env.scope.var_bounds, id);
        if (__ring_m78._tag === "some") {
          const var_bounds = __ring_m78._0;
    ...
    if (__ring_m75._tag === "StructType") {
      const name = __ring_m75.name; const type_params = __ring_m75.type_params;
      if (env$has_impl(ctx.env.trait_reg, name, trait_name)) {
...
function is_primitive_ord(t) {
  __ring_match79: {
    ...
    if (__ring_m79._tag === "StrType") {
      return true;
      break __ring_match79;
    }
    if (__ring_m79._tag === "BoolType") {
      return true;
      break __ring_match79;
    }
    return false;
...
function infer_index_expr(ctx, receiver, index, span, subst, __ring_ev_fail) {
  ...
  __ring_match80: {
    ...
    if (__ring_m80._tag === "StrType") {
      s = infer_ctx$unify_at(ctx.sink, ctx.env, idx_type, types$INT, s, span);
      result_ty = types$STR;
      break __ring_match80;
    }
    if (__ring_m80._tag === "ErrorType") {
      result_ty = types$Type_ErrorType;
      break __ring_match80;
    }
    const _ = infer_ctx$type_error(ctx.sink, codes$E0306, `Type '${types$type_to_string(recv_type)}' does not support indexing`, span, diagnostics$DiagnosticContext_OtherContext(Option_some("only List, Map, and Str support subscript operator []")));
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  while (true) {
    ...
    __ring_match81: {
      const __ring_m81 = effect_def;
      if (__ring_m81._tag === "some") {
        const ed = __ring_m81._0;
    ...
    __ring_match82: {
      const __ring_m82 = effect_def;
      if (__ring_m82._tag === "some") {
        const ed = __ring_m82._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match83: {
      const __ring_m83 = handler.resume_name;
      if (__ring_m83._tag === "some") {
        const rn = __ring_m83._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match84: {
      const __ring_m84 = handler_body_result;
      if (__ring_m84._tag === "some") {
        const hbr = __ring_m84._0;
        s = hbr.subst;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  while (true) {
    ...
    __ring_match85: {
      const __ring_m85 = eff;
      if (__ring_m85._tag === "FailEffect") {
        const et = __ring_m85.error_type;
        if (found_fail) {
  ...
  const has_open_tail = (function() {
  const __ring_m = resolved_row.tail;
  ...
  __ring_match86: {
    const __ring_m86 = arm.guard;
    if (__ring_m86._tag === "some") {
      const g = __ring_m86._0;
  ...
  __ring_match88: {
    const __ring_m88 = missing;
    if (__ring_m88._tag === "some") {
      const m = __ring_m88._0;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  while (true) {
    ...
    __ring_match89: {
      ...
      if (__ring_m89._tag === "LitPart") {
        const str_val = __ring_m89._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match89;
      }
      if (__ring_m89._tag === "ExprPart") {
        const expr = __ring_m89._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  __ring_match90: {
    const __ring_m90 = else_branch;
    if (__ring_m90._tag === "some") {
      const eb = __ring_m90._0;
      __ring_match91: {
        const __ring_m91 = eb;
        if (__ring_m91._tag === "Block") {
        ...
        if (__ring_m91._tag === "IfExpr") {
          const ec = __ring_m91.condition; const etb = __ring_m91.then_branch; const eeb = __ring_m91.else_branch; const espan = __ring_m91.span;
...
function infer_stmt(ctx, stmt, subst, __ring_ev_fail) {
  __ring_match92: {
    const __ring_m92 = stmt;
    if (__ring_m92._tag === "Let") {
      const name = __ring_m92.name; const name_span = __ring_m92.name_span; const type_annotation = __ring_m92.type_annotation; const init = __ring_m92.init; const span = __ring_m92.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      let var_type = hir$hexpr_type(init_r.hexpr);
      __ring_match93: {
        const __ring_m93 = type_annotation;
        if (__ring_m93._tag === "some") {
          const ta = __ring_m93._0;
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m92._tag === "Var") {
      const name = __ring_m92.name; const name_span = __ring_m92.name_span; const type_annotation = __ring_m92.type_annotation; const init = __ring_m92.init; const span = __ring_m92.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      let var_type = hir$hexpr_type(init_r.hexpr);
      __ring_match94: {
        const __ring_m94 = type_annotation;
        if (__ring_m94._tag === "some") {
          const ta = __ring_m94._0;
          const annotated = infer_ctx$resolve_type_expr(ctx, ta);
          const notes = [new diagnostics$DiagnosticNote(`expected '${types$type_to_string(annotated)}' because variable '${name}' is declared with this type`, Option_some(name_span)), new diagnostics$DiagnosticNote(`initializer has type '${types$type_to_string(env$apply_subst(s, var_type))}'`, Option_some(hir$hexpr_span(init_r.hexpr)))];
          s = infer_ctx$unify_at_noted(ctx.sink, ctx.env, var_type, annotated, s, span, notes);
          var_type = env$apply_subst(s, annotated);
      ...
      __ring_match95: {
        const __ring_m95 = var_scheme;
        if (__ring_m95._tag === "some") {
          const vs = __ring_m95._0;
          __ring_match96: {
            const __ring_m96 = vs.def_id;
            if (__ring_m96._tag === "some") {
              const did = __ring_m96._0;
              env$TypeEnv_record_def_span(ctx.env, did, name_span);
    ...
    if (__ring_m92._tag === "Assign") {
      const target = __ring_m92.target; const value = __ring_m92.value; const span = __ring_m92.span;
    ...
    if (__ring_m92._tag === "ExprStmt") {
      const expr = __ring_m92.expr; const span = __ring_m92.span;
      const r = infer_expr(ctx, expr, subst, __ring_ev_fail);
      return new StmtResult(hir$HStmt_ExprStmt(r.hexpr, span), r.subst, r.effects);
      break __ring_match92;
    }
    if (__ring_m92._tag === "Return") {
      const value = __ring_m92.value; const span = __ring_m92.span;
      __ring_match97: {
        const __ring_m97 = value;
        if (__ring_m97._tag === "some") {
          const v = __ring_m97._0;
          const r = infer_expr(ctx, v, subst, __ring_ev_fail);
          let s = r.subst;
          __ring_match98: {
            const __ring_m98 = ctx.current_fn_return_type;
            if (__ring_m98._tag === "some") {
              const ret_type = __ring_m98._0;
        ...
        if (__ring_m97._tag === "none") {
          let s = subst;
          __ring_match99: {
            const __ring_m99 = ctx.current_fn_return_type;
            if (__ring_m99._tag === "some") {
              const ret_type = __ring_m99._0;
    ...
    if (__ring_m92._tag === "While") {
      const condition = __ring_m92.condition; const body = __ring_m92.body; const span = __ring_m92.span;
      const cond_r = infer_expr(ctx, condition, subst, __ring_ev_fail);
    ...
    if (__ring_m92._tag === "ForIn") {
      const binding = __ring_m92.binding; const binding_span = __ring_m92.binding_span; const destructure = __ring_m92.destructure; const iterable = __ring_m92.iterable; const body = __ring_m92.body; const span = __ring_m92.span;
  ...
  return false;
      ...
      if (is_range) {
        __ring_match101: {
          const __ring_m101 = iter_type;
          if (__ring_m101._tag === "EnumType") {
            const type_params = __ring_m101.type_params;
  ...
  __match_fail(__ring_m);
        ...
        __ring_match102: {
          const __ring_m102 = type_name;
          if (__ring_m102._tag === "some") {
            const tn = __ring_m102._0;
            const iterable_impl = env$find_impl(ctx.env.trait_reg, tn, "Iterable");
            __ring_match103: {
              const __ring_m103 = iterable_impl;
              if (__ring_m103._tag === "some") {
                const impl_entry = __ring_m103._0;
                iterable_type_name = Option_some(tn);
                __ring_match104: {
                  const __ring_m104 = _Map_get(impl_entry.assoc_types, "Iter");
                  if (__ring_m104._tag === "some") {
                    const iter_assoc_ty = __ring_m104._0;
                    const concrete_type_params = (function() {
  const __ring_m = iter_type;
  if (__ring_m._tag === "StructType") { const tps = __ring_m.type_params; return tps; }
  if (__ring_m._tag === "EnumType") { const tps = __ring_m.type_params; return tps; }
  return [];
})();
                    const concrete_iter_name = types$type_to_builtin_name(iter_assoc_ty);
                    __ring_match105: {
                      const __ring_m105 = concrete_iter_name;
                      if (__ring_m105._tag === "some") {
                        const itn = __ring_m105._0;
                        ...
                        __ring_match106: {
                          const __ring_m106 = iterator_impl;
                          if (__ring_m106._tag === "some") {
                            const iter_impl_entry = __ring_m106._0;
                            __ring_match107: {
                              const __ring_m107 = _Map_get(iter_impl_entry.assoc_types, "Item");
                              if (__ring_m107._tag === "some") {
                                const item_assoc_ty = __ring_m107._0;
                                const item_name = types$type_to_builtin_name(item_assoc_ty);
                                __ring_match108: {
                                  const __ring_m108 = item_assoc_ty;
                                  if (__ring_m108._tag === "TypeVar") {
                                    element_type = (function() {
  const __ring_m = List_first(concrete_type_params);
  if (__ring_m._tag === "some") { const ct = __ring_m._0; return ct; }
  if (__ring_m._tag === "none") { return element_type; }
  __match_fail(__ring_m);
})();
                                    break __ring_match108;
                                  }
                                  if (__ring_m108._tag === "TupleType") {
                                    ...
                                    while (true) {
                                      ...
                                      __ring_match109: {
                                        const __ring_m109 = elem;
                                        if (__ring_m109._tag === "TypeVar") {
                                          __ring_match110: {
                                            const __ring_m110 = List_get(concrete_type_params, ei);
                                            if (__ring_m110._tag === "some") {
                                              const ct = __ring_m110._0;
      ...
      __ring_match111: {
        const __ring_m111 = destructure;
        if (__ring_m111._tag === "some") {
          const destr = __ring_m111._0;
          __ring_match112: {
            const __ring_m112 = element_type;
            if (__ring_m112._tag === "TupleType") {
              const type_elems = __ring_m112.elements;
          ...
          while ((di < List_len(destr.names))) {
            __ring_match113: {
              const __ring_m113 = List_get(destr.names, di);
              if (__ring_m113._tag === "some") {
                const dname = __ring_m113._0;
  ...
  return env$TypeEnv_fresh_var(ctx.env);
                ...
                __ring_match114: {
                  const __ring_m114 = dscheme;
                  if (__ring_m114._tag === "some") {
                    const ds = __ring_m114._0;
                    __ring_match115: {
                      const __ring_m115 = [ds.def_id, List_get(destr.spans, di)];
                      if (Array.isArray(__ring_m115) && __ring_m115.length === 2 && __ring_m115[0]._tag === "some" && __ring_m115[1]._tag === "some") {
                        const did = __ring_m115[0]._0; const dspan = __ring_m115[1]._0;
      ...
      __ring_match116: {
        const __ring_m116 = binding_scheme;
        if (__ring_m116._tag === "some") {
          const bs = __ring_m116._0;
          __ring_match117: {
            const __ring_m117 = bs.def_id;
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match118: {
        const __ring_m118 = body_result;
        if (__ring_m118._tag === "some") {
          const body_r = __ring_m118._0;
          s = body_r.subst;
  ...
  if (__ring_m._tag === "none") { return Option_none; }
  __match_fail(__ring_m);
})(), hdestructure, iter_r.hexpr, body_r.hexpr, iterable_type_name, iter_type_name, span), me[1], me[0]);
    ...
    if (__ring_m92._tag === "Break") {
      const span = __ring_m92.span;
      if ((ctx.loop_depth === 0)) {
    ...
    if (__ring_m92._tag === "LetDestructure") {
      const pattern = __ring_m92.pattern; const init = __ring_m92.init; const span = __ring_m92.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      const init_type = env$apply_subst(s, hir$hexpr_type(init_r.hexpr));
      __ring_match119: {
        const __ring_m119 = init_type;
        if (__ring_m119._tag === "TupleType") {
  ...
  return [];
      ...
      __ring_match120: {
        const __ring_m120 = pattern;
        if (__ring_m120._tag === "TuplePattern") {
          const pat_elements = __ring_m120.elements;
          ...
          while ((bi < List_len(pat_elements))) {
            __ring_match121: {
              const __ring_m121 = List_get(pat_elements, bi);
              if (__ring_m121._tag === "some") {
                const p = __ring_m121._0;
  ...
  __match_fail(__ring_m);
                ...
                __ring_match122: {
                  ...
                  if (__ring_m122._tag === "Binding") {
                    const name = __ring_m122.name; const pspan = __ring_m122.span;
                    env$TypeEnv_bind_mono(ctx.env, name, elem_type);
                    const bscheme = env$TypeEnv_lookup(ctx.env, name);
                    __ring_match123: {
                      const __ring_m123 = bscheme;
                      if (__ring_m123._tag === "some") {
                        const bs = __ring_m123._0;
                        __ring_match124: {
                          const __ring_m124 = bs.def_id;
    ...
    if (__ring_m92._tag === "IfLet") {
      const pattern = __ring_m92.pattern; const expr = __ring_m92.expr; const then_block = __ring_m92.then_block; const else_block = __ring_m92.else_block; const span = __ring_m92.span;
      const expr_r = infer_expr(ctx, expr, subst, __ring_ev_fail);
      let s = expr_r.subst;
  ...
  return infer_block(ctx, then_block, Option_some(s), __ring_ev_fail);
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match125: {
        const __ring_m125 = then_result;
        if (__ring_m125._tag === "some") {
          const then_r = __ring_m125._0;
          s = then_r.subst;
          ...
          __ring_match126: {
            ...
            if (__ring_m126._tag === "some") {
              ...
              env$TypeEnv_pop_scope(ctx.env);
              __ring_match127: {
                const __ring_m127 = else_result;
                if (__ring_m127._tag === "some") {
                  const else_r = __ring_m127._0;
                  s = else_r.subst;
...
function infer_block(ctx, body, initial_subst, __ring_ev_fail) {
  __ring_match128: {
    const __ring_m128 = body;
    if (__ring_m128._tag === "Block") {
      const stmts = __ring_m128.stmts; const tail = __ring_m128.tail; const span = __ring_m128.span;
      let subst = (function() {
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match132: {
    const __ring_m132 = missing;
    if (__ring_m132._tag === "some") {
      const m = __ring_m132._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  ...
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match133: {
      const __ring_m133 = List_get(enum_def.type_param_vars, tpi);
  ...
  while (true) {
    ...
    __ring_match135: {
      const __ring_m135 = field_idx;
      if (__ring_m135._tag === "some") {
        const idx = __ring_m135._0;
        __ring_match136: {
          const __ring_m136 = List_get(variant.fields, idx);
          if (__ring_m136._tag === "some") {
            const ftype = __ring_m136._0;
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  let resolved_qualifier = qualifier;
  __ring_match137: {
    const __ring_m137 = qualifier;
    if (__ring_m137._tag === "some") {
      const q = __ring_m137._0;
      if (((q === "self") ? true : Str_starts_with(q, "super"))) {
        __ring_match138: {
          const __ring_m138 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m138._tag === "some") {
            const prefix = __ring_m138._0;
            if ((prefix === "")) {
              resolved_qualifier = Option_none;
            } else {
              resolved_qualifier = Option_some(prefix);
  ...
  __ring_match139: {
    const __ring_m139 = resolved_qualifier;
    if (__ring_m139._tag === "some") {
      const q = __ring_m139._0;
      const qualified_name = `${q}::${name}`;
      const mod_struct = _Map_get(ctx.env.types.structs, qualified_name);
      __ring_match140: {
        const __ring_m140 = mod_struct;
  ...
  __ring_match142: {
    const __ring_m142 = resolved_qualifier;
    if (__ring_m142._tag === "some") {
      const q = __ring_m142._0;
      __ring_match143: {
        const __ring_m143 = _Map_get(ctx.env.types.enums, q);
        if (__ring_m143._tag === "some") {
          const enum_def = __ring_m143._0;
          if (_Map_contains_key(enum_def.variant_index, name)) {
        ...
        if (__ring_m143._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match144: {
              const __ring_m144 = _Map_get(ctx.env.types.enums, full_q);
              if (__ring_m144._tag === "some") {
                const enum_def = __ring_m144._0;
                if (_Map_contains_key(enum_def.variant_index, name)) {
                  variant_enum = Option_some(enum_def.name);
                }
  ...
  if ((Option_is_none(variant_enum) ? Option_is_some(resolved_qualifier) : false)) {
    __ring_match145: {
      const __ring_m145 = resolved_qualifier;
      if (__ring_m145._tag === "some") {
        const q = __ring_m145._0;
        const _ = infer_ctx$type_error(ctx.sink, codes$E0201, `'${q}' has no variant '${name}'`, span, diagnostics$DiagnosticContext_UndefinedVariable(name, Option_none));
  ...
  __ring_match146: {
    const __ring_m146 = variant_enum;
    if (__ring_m146._tag === "some") {
      const ve = __ring_m146._0;
      __ring_match147: {
        const __ring_m147 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m147._tag === "some") {
          const enum_def = __ring_m147._0;
          const variant = env$lookup_variant(enum_def, name);
          __ring_match148: {
            const __ring_m148 = variant;
            if (__ring_m148._tag === "some") {
              const v = __ring_m148._0;
              __ring_match149: {
                const __ring_m149 = v.field_names;
  ...
  __ring_match150: {
    const __ring_m150 = struct_def_opt;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match151: {
      const __ring_m151 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m151._tag === "some") {
        const var_id = __ring_m151._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  while (true) {
    ...
    __ring_match153: {
      const __ring_m153 = def_field;
      if (__ring_m153._tag === "some") {
        const df = __ring_m153._0;
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match154: {
    ...
    if (__ring_m154._tag === "StructType") {
      const name = __ring_m154.name; const type_params = __ring_m154.type_params;
      __ring_match155: {
        const __ring_m155 = _Map_get(ctx.env.types.structs, name);
        if (__ring_m155._tag === "some") {
          const struct_def = __ring_m155._0;
              ...
              while (((fi < List_len(struct_def.type_param_vars)) ? (fi < List_len(type_params)) : false)) {
                __ring_match157: {
                  ...
                  if (Array.isArray(__ring_m157) && __ring_m157.length === 2 && __ring_m157[0]._tag === "some" && __ring_m157[1]._tag === "some") {
                    const var_id = __ring_m157[0]._0; const tp = __ring_m157[1]._0;
    ...
    if (__ring_m154._tag === "RecordType") {
      const rec_fields = __ring_m154.fields; const tail = __ring_m154.tail;
    ...
    if (__ring_m154._tag === "TupleType") {
      const elements = __ring_m154.elements;
      __ring_match160: {
        const __ring_m160 = parse_int(field);
        ...
        if (__ring_m160._tag === "some") {
          ...
          __ring_match161: {
            const __ring_m161 = List_get(elements, i);
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match162: {
    const __ring_m162 = effect_def_opt;
  ...
  while (true) {
    ...
    __ring_match164: {
      const __ring_m164 = List_get(inst_params, i);
      if (__ring_m164._tag === "some") {
        const param_type = __ring_m164._0;
  ...
  __ring_match165: {
    const __ring_m165 = effect_def.built_in_kind;
    if (__ring_m165._tag === "some") {
      const bik = __ring_m165._0;
      __ring_match166: {
        const __ring_m166 = bik;
        if (__ring_m166._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match166;
        }
        if (__ring_m166._tag === "BkFail") {
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match167: {
    const __ring_m167 = receiver;
    if (__ring_m167._tag === "Ident") {
      const recv_name = __ring_m167.name; const qualifier = __ring_m167.qualifier;
  ...
  __match_fail(__ring_m);
      ...
      __ring_match168: {
        const __ring_m168 = _Map_get(ctx.env.types.effects, full_effect_name);
  ...
  if (is_mut_method_call(ctx, recv_type, method)) {
    __ring_match169: {
      const __ring_m169 = get_expr_def_id(ctx, receiver);
      if (__ring_m169._tag === "some") {
        const did = __ring_m169._0;
        if (_Set_contains(ctx.env.scope.mut_param_defs, did, __Int_Eq)) {
  ...
  __ring_match170: {
    const __ring_m170 = recv_type;
    if (__ring_m170._tag === "StructType") {
  ...
  if (Option_is_none(method_type)) {
    __ring_match171: {
      const __ring_m171 = types$type_to_builtin_name(recv_type);
      if (__ring_m171._tag === "some") {
        const prim_name = __ring_m171._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match172: {
      const __ring_m172 = types$type_to_builtin_name(recv_type);
      if (__ring_m172._tag === "some") {
        const type_name = __ring_m172._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match173: {
      const __ring_m173 = recv_var_id;
      if (__ring_m173._tag === "some") {
        const rvid = __ring_m173._0;
        ...
        while (true) {
          ...
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match174: {
              const __ring_m174 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m174._tag === "some") {
                const trait_def = __ring_m174._0;
                const tm = ((__a) => { const __i = __a.findIndex((function(m) { return (m.name === method); })); return __i >= 0 ? { _tag: "some", _0: __a[__i] } : { _tag: "none" }; })(trait_def.methods);
                __ring_match175: {
                  const __ring_m175 = tm;
                  if (__ring_m175._tag === "some") {
                    const found_method = __ring_m175._0;
  ...
  __ring_match176: {
    const __ring_m176 = method_type;
    if (__ring_m176._tag === "some") {
      const mt = __ring_m176._0;
      __ring_match177: {
        const __ring_m177 = mt;
        if (__ring_m177._tag === "FnType") {
          const mt_params = __ring_m177.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match178: {
              const __ring_m178 = List_first(mt_params);
              if (__ring_m178._tag === "some") {
                const first_param = __ring_m178._0;
  ...
  __ring_match179: {
    const __ring_m179 = expected;
    if (__ring_m179._tag === "FnType") {
      const exp_params = __ring_m179.params;
  ...
  __ring_match180: {
    const __ring_m180 = method_type;
    if (__ring_m180._tag === "some") {
      const mt = __ring_m180._0;
      __ring_match181: {
        const __ring_m181 = mt;
        if (__ring_m181._tag === "FnType") {
          const mt_params = __ring_m181.params; const mt_ret = __ring_m181.return_type; const mt_effects = __ring_m181.effects;
          let i = 0;
          ...
          while (true) {
            ...
            if (((i + 1) < List_len(mt_params))) {
              __ring_match182: {
                const __ring_m182 = List_get(mt_params, (i + 1));
                if (__ring_m182._tag === "some") {
                  const expected_param = __ring_m182._0;
  ...
  let resolved_dicts = [];
  __ring_match185: {
    const __ring_m185 = method_scheme;
    if (__ring_m185._tag === "some") {
      const ms = __ring_m185._0;
      if ((List_len(ms.bounds) > 0)) {
        __ring_match186: {
          const __ring_m186 = method_type;
          if (__ring_m186._tag === "some") {
            const mt = __ring_m186._0;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match187: {
      const __ring_m187 = expected_param_types;
      if (__ring_m187._tag === "some") {
        const epts = __ring_m187._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match188: {
            const __ring_m188 = List_get(epts, pi);
            if (__ring_m188._tag === "some") {
              const expected_t = __ring_m188._0;
    ...
    __ring_match189: {
      const __ring_m189 = lam_scheme;
      if (__ring_m189._tag === "some") {
        const ls = __ring_m189._0;
        __ring_match190: {
          const __ring_m190 = ls.def_id;
          if (__ring_m190._tag === "some") {
            const did = __ring_m190._0;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match191: {
    const __ring_m191 = body_result;
    if (__ring_m191._tag === "some") {
      const body_r = __ring_m191._0;
      s = body_r.subst;
      let applied_params = [];
...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  const expected = env$apply_subst(s, expected_raw);
  __ring_match192: {
    const __ring_m192 = expected;
    if (__ring_m192._tag === "FnType") {
      const exp_params = __ring_m192.params;
      return infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
  ...
  const callee_name_for_defaults = (function() {
  const __ring_m = callee;
  if (__ring_m._tag === "Ident") { const cn = __ring_m.name; return Option_some(cn); }
  return Option_none;
})();
  __ring_match193: {
    const __ring_m193 = callee_name_for_defaults;
    if (__ring_m193._tag === "some") {
      const cn = __ring_m193._0;
      __ring_match194: {
        const __ring_m194 = _Map_get(ctx.fn_defaults, cn);
        if (__ring_m194._tag === "some") {
          const defaults = __ring_m194._0;
          __ring_match195: {
            const __ring_m195 = _Map_get(ctx.fn_min_arity, cn);
            if (__ring_m195._tag === "some") {
              const min_ar = __ring_m195._0;
              ...
              if (((List_len(args) < total_arity) ? (List_len(args) >= min_ar) : false)) {
                ...
                while ((di < List_len(defaults))) {
                  __ring_match196: {
                    const __ring_m196 = List_get(defaults, di);
                    if (__ring_m196._tag === "some") {
                      const dh = __ring_m196._0;
                      List_push(hargs, dh);
  ...
  __ring_match197: {
    const __ring_m197 = resolved_callee_type;
    if (__ring_m197._tag === "FnType") {
      const callee_params = __ring_m197.params; const fn_effects = __ring_m197.effects;
  ...
  __ring_match198: {
    ...
    if (__ring_m198._tag === "Ident") {
      const callee_name = __ring_m198.name;
      __ring_match199: {
        const __ring_m199 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m199._tag === "some") {
          const callee_scheme = __ring_m199._0;
  ...
  __ring_match200: {
    ...
    if (__ring_m200._tag === "Ident") {
      const callee_name = __ring_m200.name;
      __ring_match201: {
        const __ring_m201 = _Map_get(ctx.fn_mut_params, callee_name);
        if (__ring_m201._tag === "some") {
          const mut_flags = __ring_m201._0;
          let mi = 0;
          while (((mi < List_len(mut_flags)) ? (mi < List_len(args)) : false)) {
            __ring_match202: {
              const __ring_m202 = [List_get(mut_flags, mi), List_get(hargs, mi)];
              if (Array.isArray(__ring_m202) && __ring_m202.length === 2 && __ring_m202[0]._tag === "some" && __ring_m202[1]._tag === "some") {
                const is_mut = __ring_m202[0]._0; const harg = __ring_m202[1]._0;
                if (is_mut) {
                  __ring_match203: {
                    const __ring_m203 = harg;
                    if (__ring_m203._tag === "Ident" && __ring_m203.def_id._tag === "some") {
                      const arg_did = __ring_m203.def_id._0;
                      if (_Set_contains(ctx.env.scope.mutable_vars, arg_did, __Int_Eq)) {
                        __ring_match204: {
                          const __ring_m204 = resolved_callee_type;
                          if (__ring_m204._tag === "FnType") {
                            const fn_params = __ring_m204.params;
                            __ring_match205: {
                              const __ring_m205 = List_get(fn_params, mi);
                              if (__ring_m205._tag === "some") {
                                const pt = __ring_m205._0;
                                const resolved_pt = env$apply_subst(s, pt);
...
function infer_expr(ctx, expr, subst, __ring_ev_fail) {
  __ring_match208: {
    const __ring_m208 = expr;
    if (__ring_m208._tag === "IntLit") {
      const value = __ring_m208.value; const span = __ring_m208.span;
    ...
    if (__ring_m208._tag === "FloatLit") {
      const value = __ring_m208.value; const span = __ring_m208.span;
      return new infer_ctx$InferResult(hir$HExpr_FloatLit(value, types$FLOAT, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match208;
    }
    if (__ring_m208._tag === "StrLit") {
      const value = __ring_m208.value; const span = __ring_m208.span;
      return new infer_ctx$InferResult(hir$HExpr_StrLit(value, types$STR, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match208;
    }
    if (__ring_m208._tag === "BoolLit") {
      const value = __ring_m208.value; const span = __ring_m208.span;
      return new infer_ctx$InferResult(hir$HExpr_BoolLit(value, types$BOOL, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match208;
    }
    if (__ring_m208._tag === "Ident") {
      const name = __ring_m208.name; const qualifier = __ring_m208.qualifier; const span = __ring_m208.span;
      return infer_ident(ctx, name, span, subst, qualifier);
      break __ring_match208;
    }
    if (__ring_m208._tag === "BinOp") {
      const op = __ring_m208.op; const left = __ring_m208.left; const right = __ring_m208.right; const span = __ring_m208.span;
      return infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail);
      break __ring_match208;
    }
    if (__ring_m208._tag === "UnaryOp") {
      const op = __ring_m208.op; const operand = __ring_m208.operand; const span = __ring_m208.span;
      return infer_unary_op(ctx, op, operand, span, subst);
      break __ring_match208;
    }
    if (__ring_m208._tag === "Call") {
      const callee = __ring_m208.callee; const args = __ring_m208.args; const span = __ring_m208.span;
      return infer_call(ctx, callee, args, span, subst, __ring_ev_fail);
      break __ring_match208;
    }
    if (__ring_m208._tag === "MethodCall") {
      const receiver = __ring_m208.receiver; const method = __ring_m208.method; const args = __ring_m208.args; const span = __ring_m208.span;
      return infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail);
      break __ring_match208;
    }
    if (__ring_m208._tag === "FieldAccess") {
      const receiver = __ring_m208.receiver; const field = __ring_m208.field; const span = __ring_m208.span;
      return infer_field_access(ctx, receiver, field, span, subst);
      break __ring_match208;
    }
    if (__ring_m208._tag === "StructLit") {
      const name = __ring_m208.name; const qualifier = __ring_m208.qualifier; const fields = __ring_m208.fields; const spread = __ring_m208.spread; const span = __ring_m208.span;
      return infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail);
      break __ring_match208;
    }
    if (__ring_m208._tag === "MatchExpr") {
      const scrutinee = __ring_m208.scrutinee; const arms = __ring_m208.arms; const span = __ring_m208.span;
      return infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail);
      break __ring_match208;
    }
    if (__ring_m208._tag === "Block") {
      return infer_block(ctx, expr, Option_some(subst), __ring_ev_fail);
      break __ring_match208;
    }
    if (__ring_m208._tag === "IfExpr") {
      const condition = __ring_m208.condition; const then_branch = __ring_m208.then_branch; const else_branch = __ring_m208.else_branch; const span = __ring_m208.span;
      return infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail);
      break __ring_match208;
    }
    if (__ring_m208._tag === "StringInterp") {
      const parts = __ring_m208.parts; const span = __ring_m208.span;
      return infer_string_interp(ctx, parts, span, subst, __ring_ev_fail);
      break __ring_match208;
    }
    if (__ring_m208._tag === "CatchExpr") {
      const catch_expr = __ring_m208.expr; const arms = __ring_m208.arms; const span = __ring_m208.span;
      return infer_catch(ctx, catch_expr, arms, span, subst, __ring_ev_fail);
      break __ring_match208;
    }
    if (__ring_m208._tag === "HandleExpr") {
      const body = __ring_m208.body; const handlers = __ring_m208.handlers; const span = __ring_m208.span;
      return infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail);
      break __ring_match208;
    }
    if (__ring_m208._tag === "Lambda") {
      const params = __ring_m208.params; const body = __ring_m208.body; const span = __ring_m208.span;
      return infer_lambda(ctx, params, body, span, subst, Option_none, __ring_ev_fail);
      break __ring_match208;
    }
    if (__ring_m208._tag === "ListLit") {
      const elements = __ring_m208.elements; const span = __ring_m208.span;
      return infer_list_literal(ctx, elements, span, subst, __ring_ev_fail);
      break __ring_match208;
    }
    if (__ring_m208._tag === "TupleLit") {
      const elements = __ring_m208.elements; const span = __ring_m208.span;
      let s = subst;
      let helements = [];
      let combined_effects = types$EMPTY_ROW;
    ...
    if (__ring_m208._tag === "Range") {
      const start = __ring_m208.start; const end = __ring_m208.end; const inclusive = __ring_m208.inclusive; const span = __ring_m208.span;
    ...
    if (__ring_m208._tag === "IndexExpr") {
      const receiver = __ring_m208.receiver; const index = __ring_m208.index; const span = __ring_m208.span;
      return infer_index_expr(ctx, receiver, index, span, subst, __ring_ev_fail);
      break __ring_match208;
    }
    if (__ring_m208._tag === "ReturnExpr") {
      const value = __ring_m208.value; const span = __ring_m208.span;
      __ring_match209: {
        const __ring_m209 = value;
        if (__ring_m209._tag === "some") {
          const v = __ring_m209._0;
          const r = infer_expr(ctx, v, subst, __ring_ev_fail);
          let s = r.subst;
          __ring_match210: {
            const __ring_m210 = ctx.current_fn_return_type;
            if (__ring_m210._tag === "some") {
              const ret_type = __ring_m210._0;
              const return_notes = [new diagnostics$DiagnosticNote(`function return type is '${types$type_to_string(env$apply_subst(s, ret_type))}'`, Option_none), new diagnostics$DiagnosticNote(`return value has type '${types$type_to_string(env$apply_subst(s, hir$hexpr_type(r.hexpr)))}'`, Option_some(hir$hexpr_span(r.hexpr)))];
              s = infer_ctx$unify_at_noted(ctx.sink, ctx.env, hir$hexpr_type(r.hexpr), ret_type, s, span, return_notes);
        ...
        if (__ring_m209._tag === "none") {
          let s = subst;
          __ring_match211: {
            const __ring_m211 = ctx.current_fn_return_type;
            if (__ring_m211._tag === "some") {
              const ret_type = __ring_m211._0;
              s = infer_ctx$unify_at(ctx.sink, ctx.env, types$UNIT, ret_type, s, span);
...
function infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail) {
  ...
  __ring_match212: {
    const __ring_m212 = op;
    if (__ring_m212._tag === "Add") {
    ...
    if (__ring_m212._tag === "Sub") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "-");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match212;
    }
    if (__ring_m212._tag === "Mul") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "*");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match212;
    }
    if (__ring_m212._tag === "Div") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "/");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match212;
    }
    if (__ring_m212._tag === "Mod") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "%");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match212;
    }
    if ((__ring_m212._tag === "Eq") || (__ring_m212._tag === "Neq")) {
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      result_type = types$BOOL;
  ...
  return "!=";
    ...
    if ((__ring_m212._tag === "Lt") || (__ring_m212._tag === "Lte") || (__ring_m212._tag === "Gt") || (__ring_m212._tag === "Gte")) {
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      result_type = types$BOOL;
      const resolved = env$apply_subst(s, hir$hexpr_type(lr.hexpr));
      const op_sym = (function() {
