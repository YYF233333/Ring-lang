...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match96: {
    const __ring_m96 = effect_def_opt;
  ...
  for (const arg of args) {
    ...
    List_push(hargs, ar.hexpr);
    __ring_match98: {
      const __ring_m98 = List_get(op.params, i);
      if (__ring_m98._tag === "some") {
        const param_type = __ring_m98._0;
  ...
  __ring_match99: {
    const __ring_m99 = effect_def.built_in_kind;
    if (__ring_m99._tag === "some") {
      const bik = __ring_m99._0;
      __ring_match100: {
        const __ring_m100 = bik;
        if (__ring_m100._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match100;
        }
        if (__ring_m100._tag === "BkFail") {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match101: {
    ...
    if (__ring_m101._tag === "StructType") {
      const name = __ring_m101.name; const type_params = __ring_m101.type_params;
      __ring_match102: {
        const __ring_m102 = _Map_get(ctx.env.types.structs, name);
        if (__ring_m102._tag === "some") {
          const struct_def = __ring_m102._0;
          ...
          __ring_match103: {
            ...
            if (__ring_m103._tag === "some") {
              const found_field = __ring_m103._0;
              const inst_map = map_new();
              let fi = 0;
              while (((fi < List_len(struct_def.type_param_vars)) && (fi < List_len(type_params)))) {
                __ring_match104: {
                  const __ring_m104 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m104) && __ring_m104.length === 2 && __ring_m104[0]._tag === "some" && __ring_m104[1]._tag === "some") {
                    const var_id = __ring_m104[0]._0; const tp = __ring_m104[1]._0;
    ...
    if (__ring_m101._tag === "RecordType") {
      const rec_fields = __ring_m101.fields; const tail = __ring_m101.tail;
    ...
    if (__ring_m101._tag === "TupleType") {
      const elements = __ring_m101.elements;
      __ring_match107: {
        const __ring_m107 = parse_int(field);
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  ...
  __ring_match111: {
    const __ring_m111 = qualifier;
    if (__ring_m111._tag === "some") {
      const q = __ring_m111._0;
      __ring_match112: {
        const __ring_m112 = _Map_get(ctx.env.types.enums, q);
  ...
  __ring_match114: {
    const __ring_m114 = variant_enum;
    if (__ring_m114._tag === "some") {
      const ve = __ring_m114._0;
      __ring_match115: {
        const __ring_m115 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m115._tag === "some") {
          const enum_def = __ring_m115._0;
          ...
          __ring_match116: {
            const __ring_m116 = variant;
            if (__ring_m116._tag === "some") {
              const v = __ring_m116._0;
              __ring_match117: {
                const __ring_m117 = v.field_names;
  ...
  __ring_match118: {
    const __ring_m118 = struct_def_opt;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match119: {
      const __ring_m119 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m119._tag === "some") {
        const var_id = __ring_m119._0;
  ...
  for (const field of fields) {
    ...
    __ring_match121: {
      const __ring_m121 = def_field;
      if (__ring_m121._tag === "some") {
        const df = __ring_m121._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  ...
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match122: {
      const __ring_m122 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m122._tag === "some") {
        const var_id = __ring_m122._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  let hspread = Option_none;
  __ring_match123: {
    const __ring_m123 = spread;
    if (__ring_m123._tag === "some") {
      const sp = __ring_m123._0;
      const sr = infer_expr(ctx, sp, s, __ring_ev_fail);
      s = sr.subst;
      const me = infer_ctx$merge_effects(ctx.env, effects, sr.effects, s, __ring_ev_fail);
      effects = me[0];
  ...
  for (const field of fields) {
    ...
    __ring_match124: {
      const __ring_m124 = field_idx;
      if (__ring_m124._tag === "some") {
        const idx = __ring_m124._0;
        __ring_match125: {
          const __ring_m125 = List_get(variant.fields, idx);
          if (__ring_m125._tag === "some") {
            const ftype = __ring_m125._0;
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match126: {
    ...
    if (__ring_m126._tag === "Binding") {
      const pat_name = __ring_m126.name; const pspan = __ring_m126.span;
      __ring_match127: {
        const __ring_m127 = _Map_get(ctx.env.types.variant_to_enum, pat_name);
        if (__ring_m127._tag === "some") {
          const ve = __ring_m127._0;
          __ring_match128: {
            const __ring_m128 = _Map_get(ctx.env.types.enums, ve);
            if (__ring_m128._tag === "some") {
              const edef = __ring_m128._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  let result_type = types$UNIT;
  __ring_match133: {
    const __ring_m133 = else_branch;
    if (__ring_m133._tag === "some") {
      const eb = __ring_m133._0;
      __ring_match134: {
        const __ring_m134 = eb;
        if (__ring_m134._tag === "Block") {
        ...
        if (__ring_m134._tag === "IfExpr") {
          const ec = __ring_m134.condition; const etb = __ring_m134.then_branch; const eeb = __ring_m134.else_branch; const espan = __ring_m134.span;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  for (const part of parts) {
    __ring_match135: {
      ...
      if (__ring_m135._tag === "LitPart") {
        const str_val = __ring_m135._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match135;
      }
      if (__ring_m135._tag === "ExprPart") {
        const expr = __ring_m135._0;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  for (const eff of effects.effects) {
    __ring_match136: {
      const __ring_m136 = eff;
      if (__ring_m136._tag === "FailEffect") {
        const et = __ring_m136.error_type;
        error_type = et;
  ...
  let guard_hexpr = Option_none;
  __ring_match137: {
    const __ring_m137 = arm.guard;
    if (__ring_m137._tag === "some") {
      const g = __ring_m137._0;
      const gr = infer_expr(ctx, g, s, __ring_ev_fail);
      s = gr.subst;
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(gr.hexpr), types$BOOL, s, arm.span);
      const me = infer_ctx$merge_effects(ctx.env, effects, gr.effects, s, __ring_ev_fail);
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  for (const handler of handlers) {
    ...
    __ring_match142: {
      const __ring_m142 = effect_def;
      if (__ring_m142._tag === "some") {
        const ed = __ring_m142._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match143: {
      const __ring_m143 = handler.resume_name;
      if (__ring_m143._tag === "some") {
        const rn = __ring_m143._0;
  ...
  __match_fail(__ring_m);
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match144: {
      const __ring_m144 = handler_body_result;
      if (__ring_m144._tag === "some") {
        const hbr = __ring_m144._0;
        s = hbr.subst;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match145: {
      const __ring_m145 = expected_param_types;
      if (__ring_m145._tag === "some") {
        const epts = __ring_m145._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match146: {
            const __ring_m146 = List_get(epts, pi);
            if (__ring_m146._tag === "some") {
              const expected_t = __ring_m146._0;
    ...
    __ring_match147: {
      const __ring_m147 = lam_scheme;
      if (__ring_m147._tag === "some") {
        const ls = __ring_m147._0;
        __ring_match148: {
          const __ring_m148 = ls.def_id;
          if (__ring_m148._tag === "some") {
            const did = __ring_m148._0;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match149: {
    const __ring_m149 = body_result;
    if (__ring_m149._tag === "some") {
      const body_r = __ring_m149._0;
      s = body_r.subst;
      let applied_params = [];
