...
function cancel_local_mut_effects(ctx, effects, callee_params, callee_effects, hargs, param_offset, s) {
  ...
  for (const eff of callee_effects.effects) {
    __ring_match7: {
      const __ring_m7 = eff;
      if (__ring_m7._tag === "MutEffect") {
        const state_type = __ring_m7.state_type;
        const resolved_st = env$apply_subst(s, state_type);
        let pi = param_offset;
        let ai = 0;
        while ((ai < List_len(hargs))) {
          __ring_match8: {
            const __ring_m8 = List_get(callee_params, pi);
            if (__ring_m8._tag === "some") {
              const pt = __ring_m8._0;
              const resolved_pt = env$apply_subst(s, pt);
              if (types$types_equal(resolved_pt, resolved_st)) {
                __ring_match9: {
                  const __ring_m9 = List_get(hargs, ai);
                  if (__ring_m9._tag === "some") {
                    const harg = __ring_m9._0;
                    __ring_match10: {
                      const __ring_m10 = harg;
                      if (__ring_m10._tag === "Ident" && __ring_m10.def_id._tag === "some") {
                        const did = __ring_m10.def_id._0;
  ...
  __ring_match11: {
    const __ring_m11 = e;
    if (__ring_m11._tag === "MutEffect") {
      const state_type = __ring_m11.state_type;
      const resolved_st = env$apply_subst(s, state_type);
  ...
  const filtered = effects.effects.filter((function(e) { return __ring_blk0; }));
  return new types$EffectRow(filtered, effects.tail);
}

function resolve_var_id(id, sub) {
  __ring_match12: {
    const __ring_m12 = union_find$uf_lookup(sub, id);
    if (__ring_m12._tag === "some") {
      const resolved = __ring_m12._0;
      __ring_match13: {
        const __ring_m13 = resolved;
        if (__ring_m13._tag === "TypeVar") {
          const new_id = __ring_m13.id;
...
function infer_block(ctx, body, initial_subst, __ring_ev_fail) {
  __ring_match14: {
    ...
    if (__ring_m14._tag === "Block") {
      const stmts = __ring_m14.stmts; const tail = __ring_m14.tail; const span = __ring_m14.span;
      let __ring_blk1;
      __ring_match15: {
        const __ring_m15 = initial_subst;
        if (__ring_m15._tag === "some") {
          const s = __ring_m15._0;
          __ring_blk1 = s;
          break __ring_match15;
        }
        if (__ring_m15._tag === "none") {
          __ring_blk1 = ctx.subst;
          break __ring_match15;
        }
        __match_fail(__ring_m15);
      }
      let subst = __ring_blk1;
...
function infer_stmt(ctx, stmt, subst, __ring_ev_fail) {
  __ring_match17: {
    const __ring_m17 = stmt;
    if (__ring_m17._tag === "Let") {
      const name = __ring_m17.name; const name_span = __ring_m17.name_span; const type_annotation = __ring_m17.type_annotation; const init = __ring_m17.init; const span = __ring_m17.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      let var_type = hir$hexpr_type(init_r.hexpr);
      __ring_match18: {
        const __ring_m18 = type_annotation;
        if (__ring_m18._tag === "some") {
          const ta = __ring_m18._0;
      ...
      let __ring_blk2;
      __ring_match19: {
        const __ring_m19 = bound_scheme;
        if (__ring_m19._tag === "some") {
          const bs = __ring_m19._0;
          let __ring_blk3;
          __ring_match20: {
            const __ring_m20 = bs.def_id;
    ...
    if (__ring_m17._tag === "Var") {
      ...
      __ring_match22: {
        const __ring_m22 = var_scheme;
        if (__ring_m22._tag === "some") {
          const vs = __ring_m22._0;
          __ring_match23: {
            const __ring_m23 = vs.def_id;
    ...
    if (__ring_m17._tag === "Assign") {
      const target = __ring_m17.target; const value = __ring_m17.value; const span = __ring_m17.span;
    ...
    if (__ring_m17._tag === "ExprStmt") {
      const expr = __ring_m17.expr; const span = __ring_m17.span;
      const r = infer_expr(ctx, expr, subst, __ring_ev_fail);
      return new StmtResult(hir$HStmt_ExprStmt(r.hexpr, span), r.subst, r.effects);
      break __ring_match17;
    }
    if (__ring_m17._tag === "Return") {
      const value = __ring_m17.value; const span = __ring_m17.span;
      __ring_match24: {
        ...
        if (__ring_m24._tag === "some") {
          ...
          let s = r.subst;
          __ring_match25: {
            const __ring_m25 = ctx.current_fn_return_type;
            if (__ring_m25._tag === "some") {
              const ret_type = __ring_m25._0;
        ...
        if (__ring_m24._tag === "none") {
          let s = subst;
          __ring_match26: {
            const __ring_m26 = ctx.current_fn_return_type;
            if (__ring_m26._tag === "some") {
              const ret_type = __ring_m26._0;
    ...
    if (__ring_m17._tag === "While") {
      const condition = __ring_m17.condition; const body = __ring_m17.body; const span = __ring_m17.span;
      ...
      __ring_match27: {
        const __ring_m27 = body_result;
        if (__ring_m27._tag === "some") {
          const body_r = __ring_m27._0;
          s = body_r.subst;
    ...
    if (__ring_m17._tag === "ForIn") {
      const binding = __ring_m17.binding; const binding_span = __ring_m17.binding_span; const destructure = __ring_m17.destructure; const iterable = __ring_m17.iterable; const body = __ring_m17.body; const span = __ring_m17.span;
      ...
      __ring_match28: {
        ...
        if (__ring_m28._tag === "EnumType") {
          ...
          if (((name === hir$BUILTIN_RANGE) && (List_len(type_params) > 0))) {
            let __ring_blk4;
            __ring_match29: {
              const __ring_m29 = List_first(type_params);
              if (__ring_m29._tag === "some") {
                const t = __ring_m29._0;
                __ring_blk4 = t;
                break __ring_match29;
              }
              if (__ring_m29._tag === "none") {
                __ring_blk4 = types$INT;
                break __ring_match29;
              }
              __match_fail(__ring_m29);
            }
            element_type = __ring_blk4;
          } else {
        ...
        if (__ring_m28._tag === "StructType") {
          ...
          if (((name === hir$BUILTIN_LIST) && (List_len(type_params) > 0))) {
            let __ring_blk5;
            __ring_match30: {
              const __ring_m30 = List_first(type_params);
              if (__ring_m30._tag === "some") {
                const t = __ring_m30._0;
                __ring_blk5 = t;
                break __ring_match30;
              }
              if (__ring_m30._tag === "none") {
                __ring_blk5 = element_type;
                break __ring_match30;
              }
              __match_fail(__ring_m30);
            }
            element_type = __ring_blk5;
          } else {
            if (((name === hir$BUILTIN_SET) && (List_len(type_params) > 0))) {
              let __ring_blk6;
              __ring_match31: {
                const __ring_m31 = List_first(type_params);
                ...
                if (__ring_m31._tag === "none") {
                  __ring_blk6 = element_type;
                  break __ring_match31;
                }
                __match_fail(__ring_m31);
              }
              element_type = __ring_blk6;
            } else {
              if (((name === hir$BUILTIN_MAP) && (List_len(type_params) >= 2))) {
                ...
                __ring_match32: {
                  const __ring_m32 = [List_get(type_params, 0), List_get(type_params, 1)];
                  if (Array.isArray(__ring_m32) && __ring_m32.length === 2 && __ring_m32[0]._tag === "some" && __ring_m32[1]._tag === "some") {
                    const kt = __ring_m32[0]._0; const vt = __ring_m32[1]._0;
      ...
      __ring_match33: {
        const __ring_m33 = destructure;
        if (__ring_m33._tag === "some") {
          const destr = __ring_m33._0;
          __ring_match34: {
            const __ring_m34 = element_type;
          ...
          while ((di < List_len(destr.names))) {
            __ring_match35: {
              const __ring_m35 = List_get(destr.names, di);
              if (__ring_m35._tag === "some") {
                const dname = __ring_m35._0;
                let __ring_blk7;
                __ring_match36: {
                  const __ring_m36 = element_type;
                  if (__ring_m36._tag === "TupleType") {
                    const type_elems = __ring_m36.elements;
                    let __ring_blk8;
                    __ring_match37: {
                      const __ring_m37 = List_get(type_elems, di);
                      if (__ring_m37._tag === "some") {
                        const et = __ring_m37._0;
                        __ring_blk8 = et;
                ...
                const elem_t = __ring_blk7;
                env$TypeEnv_bind_mono(ctx.env, dname, elem_t);
                const dscheme = env$TypeEnv_lookup(ctx.env, dname);
                __ring_match38: {
                  const __ring_m38 = dscheme;
                  if (__ring_m38._tag === "some") {
                    const ds = __ring_m38._0;
                    __ring_match39: {
                      const __ring_m39 = [ds.def_id, List_get(destr.spans, di)];
                      if (Array.isArray(__ring_m39) && __ring_m39.length === 2 && __ring_m39[0]._tag === "some" && __ring_m39[1]._tag === "some") {
                        const did = __ring_m39[0]._0; const dspan = __ring_m39[1]._0;
      ...
      __ring_match40: {
        const __ring_m40 = binding_scheme;
        if (__ring_m40._tag === "some") {
          const bs = __ring_m40._0;
          __ring_match41: {
            const __ring_m41 = bs.def_id;
      ...
      __ring_match42: {
        ...
        if (__ring_m42._tag === "some") {
          ...
          return new StmtResult(hir$HStmt_ForIn(binding, binding_span, __ring_blk9, hdestructure, iter_r.hexpr, body_r.hexpr, span), me[1], me[0]);
    ...
    if (__ring_m17._tag === "LetDestructure") {
      const pattern = __ring_m17.pattern; const init = __ring_m17.init; const span = __ring_m17.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      const init_type = env$apply_subst(s, hir$hexpr_type(init_r.hexpr));
      __ring_match44: {
        const __ring_m44 = init_type;
        if (__ring_m44._tag === "TupleType") {
      ...
      let __ring_blk10;
      __ring_match45: {
        const __ring_m45 = init_type;
        if (__ring_m45._tag === "TupleType") {
          const elements = __ring_m45.elements;
          __ring_blk10 = elements;
          break __ring_match45;
        }
        __ring_blk10 = [];
        break __ring_match45;
      }
      const tuple_elements = __ring_blk10;
      __ring_match46: {
        const __ring_m46 = pattern;
        if (__ring_m46._tag === "TuplePattern") {
          const pat_elements = __ring_m46.elements;
          ...
          while ((bi < List_len(pat_elements))) {
            __ring_match47: {
              const __ring_m47 = List_get(pat_elements, bi);
              if (__ring_m47._tag === "some") {
                const p = __ring_m47._0;
                let __ring_blk11;
                __ring_match48: {
                  const __ring_m48 = List_get(tuple_elements, bi);
                  if (__ring_m48._tag === "some") {
                    const et = __ring_m48._0;
                    __ring_blk11 = et;
                    break __ring_match48;
                  }
                  if (__ring_m48._tag === "none") {
                    __ring_blk11 = types$UNIT;
                    break __ring_match48;
                  }
                  __match_fail(__ring_m48);
                }
                const elem_type = __ring_blk11;
                __ring_match49: {
                  const __ring_m49 = p;
                  if (__ring_m49._tag === "Binding") {
                    const name = __ring_m49.name; const pspan = __ring_m49.span;
                    env$TypeEnv_bind_mono(ctx.env, name, elem_type);
                    const bscheme = env$TypeEnv_lookup(ctx.env, name);
                    __ring_match50: {
                      const __ring_m50 = bscheme;
                      if (__ring_m50._tag === "some") {
                        const bs = __ring_m50._0;
                        __ring_match51: {
                          const __ring_m51 = bs.def_id;
    ...
    if (__ring_m17._tag === "IfLet") {
      const pattern = __ring_m17.pattern; const expr = __ring_m17.expr; const then_block = __ring_m17.then_block; const else_block = __ring_m17.else_block; const span = __ring_m17.span;
  ...
  return infer_block(ctx, then_block, Option_some(s), __ring_ev_fail);
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match52: {
        const __ring_m52 = then_result;
        if (__ring_m52._tag === "some") {
          const then_r = __ring_m52._0;
          s = then_r.subst;
          ...
          __ring_match53: {
            ...
            if (__ring_m53._tag === "some") {
              ...
              env$TypeEnv_pop_scope(ctx.env);
              __ring_match54: {
                const __ring_m54 = else_result;
                if (__ring_m54._tag === "some") {
                  const else_r = __ring_m54._0;
                  s = else_r.subst;
...
function check_assign_target_mutable(ctx, target) {
  __ring_match55: {
    const __ring_m55 = target;
    if (__ring_m55._tag === "Ident") {
      const name = __ring_m55.name; const span = __ring_m55.span;
      const scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match56: {
        const __ring_m56 = scheme;
        if (__ring_m56._tag === "some") {
          const s = __ring_m56._0;
          __ring_match57: {
            const __ring_m57 = s.def_id;
    ...
    if (__ring_m55._tag === "FieldAccess") {
      const receiver = __ring_m55.receiver; const span = __ring_m55.span;
      const root = find_root_expr(receiver);
      __ring_match58: {
        const __ring_m58 = root;
        if (__ring_m58._tag === "Ident") {
          const name = __ring_m58.name; const rspan = __ring_m58.span;
          const scheme = env$TypeEnv_lookup(ctx.env, name);
          __ring_match59: {
            const __ring_m59 = scheme;
            if (__ring_m59._tag === "some") {
              const s = __ring_m59._0;
              __ring_match60: {
                const __ring_m60 = s.def_id;
                if (__ring_m60._tag === "some") {
                  const did = __ring_m60._0;
                  if ((!_Set_contains(ctx.env.scope.mutable_vars, did, __Int_Eq))) {
    ...
    if (__ring_m55._tag === "IndexExpr") {
      ...
      const root = find_root_expr(receiver);
      __ring_match61: {
        const __ring_m61 = root;
        if (__ring_m61._tag === "Ident") {
          const name = __ring_m61.name; const rspan = __ring_m61.span;
          const scheme = env$TypeEnv_lookup(ctx.env, name);
          __ring_match62: {
            const __ring_m62 = scheme;
            if (__ring_m62._tag === "some") {
              const s = __ring_m62._0;
              __ring_match63: {
                const __ring_m63 = s.def_id;
                if (__ring_m63._tag === "some") {
                  const did = __ring_m63._0;
                  if ((!_Set_contains(ctx.env.scope.mutable_vars, did, __Int_Eq))) {
...
function find_root_expr(e) {
  __ring_match64: {
    const __ring_m64 = e;
    if (__ring_m64._tag === "FieldAccess") {
      const receiver = __ring_m64.receiver;
      return find_root_expr(receiver);
      break __ring_match64;
    }
    if (__ring_m64._tag === "IndexExpr") {
      const receiver = __ring_m64.receiver;
      return find_root_expr(receiver);
      break __ring_match64;
    }
...
function infer_expr(ctx, expr, subst, __ring_ev_fail) {
  __ring_match65: {
    const __ring_m65 = expr;
    if (__ring_m65._tag === "IntLit") {
      const value = __ring_m65.value; const span = __ring_m65.span;
    ...
    if (__ring_m65._tag === "FloatLit") {
      const value = __ring_m65.value; const span = __ring_m65.span;
      return new infer_ctx$InferResult(hir$HExpr_FloatLit(value, types$FLOAT, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match65;
    }
    if (__ring_m65._tag === "StrLit") {
      const value = __ring_m65.value; const span = __ring_m65.span;
      return new infer_ctx$InferResult(hir$HExpr_StrLit(value, types$STR, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match65;
    }
    if (__ring_m65._tag === "BoolLit") {
      const value = __ring_m65.value; const span = __ring_m65.span;
      return new infer_ctx$InferResult(hir$HExpr_BoolLit(value, types$BOOL, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match65;
    }
    if (__ring_m65._tag === "Ident") {
      const name = __ring_m65.name; const qualifier = __ring_m65.qualifier; const span = __ring_m65.span;
      return infer_ident(ctx, name, span, subst, qualifier);
      break __ring_match65;
    }
    if (__ring_m65._tag === "BinOp") {
      const op = __ring_m65.op; const left = __ring_m65.left; const right = __ring_m65.right; const span = __ring_m65.span;
      return infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail);
      break __ring_match65;
    }
    if (__ring_m65._tag === "UnaryOp") {
      const op = __ring_m65.op; const operand = __ring_m65.operand; const span = __ring_m65.span;
      return infer_unary_op(ctx, op, operand, span, subst, __ring_ev_fail);
      break __ring_match65;
    }
    if (__ring_m65._tag === "Call") {
      const callee = __ring_m65.callee; const args = __ring_m65.args; const span = __ring_m65.span;
      return infer_call(ctx, callee, args, span, subst, __ring_ev_fail);
      break __ring_match65;
    }
    if (__ring_m65._tag === "MethodCall") {
      const receiver = __ring_m65.receiver; const method = __ring_m65.method; const args = __ring_m65.args; const span = __ring_m65.span;
      return infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail);
      break __ring_match65;
    }
    if (__ring_m65._tag === "FieldAccess") {
      const receiver = __ring_m65.receiver; const field = __ring_m65.field; const span = __ring_m65.span;
      return infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail);
      break __ring_match65;
    }
    if (__ring_m65._tag === "StructLit") {
      const name = __ring_m65.name; const qualifier = __ring_m65.qualifier; const fields = __ring_m65.fields; const spread = __ring_m65.spread; const span = __ring_m65.span;
      return infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail);
      break __ring_match65;
    }
    if (__ring_m65._tag === "MatchExpr") {
      const scrutinee = __ring_m65.scrutinee; const arms = __ring_m65.arms; const span = __ring_m65.span;
      return infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail);
      break __ring_match65;
    }
    if (__ring_m65._tag === "Block") {
      return infer_block(ctx, expr, Option_some(subst), __ring_ev_fail);
      break __ring_match65;
    }
    if (__ring_m65._tag === "IfExpr") {
      const condition = __ring_m65.condition; const then_branch = __ring_m65.then_branch; const else_branch = __ring_m65.else_branch; const span = __ring_m65.span;
      return infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail);
      break __ring_match65;
    }
    if (__ring_m65._tag === "StringInterp") {
      const parts = __ring_m65.parts; const span = __ring_m65.span;
      return infer_string_interp(ctx, parts, span, subst, __ring_ev_fail);
      break __ring_match65;
    }
    if (__ring_m65._tag === "CatchExpr") {
      const catch_expr = __ring_m65.expr; const arms = __ring_m65.arms; const span = __ring_m65.span;
      return infer_catch(ctx, catch_expr, arms, span, subst, __ring_ev_fail);
      break __ring_match65;
    }
    if (__ring_m65._tag === "HandleExpr") {
      const body = __ring_m65.body; const handlers = __ring_m65.handlers; const span = __ring_m65.span;
      return infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail);
      break __ring_match65;
    }
    if (__ring_m65._tag === "Lambda") {
      const params = __ring_m65.params; const body = __ring_m65.body; const span = __ring_m65.span;
      return infer_lambda(ctx, params, body, span, subst, Option_none, __ring_ev_fail);
      break __ring_match65;
    }
    if (__ring_m65._tag === "ListLit") {
    ...
    if (__ring_m65._tag === "Range") {
      const start = __ring_m65.start; const end = __ring_m65.end; const inclusive = __ring_m65.inclusive; const span = __ring_m65.span;
    ...
    if (__ring_m65._tag === "IndexExpr") {
      const receiver = __ring_m65.receiver; const index = __ring_m65.index; const span = __ring_m65.span;
...
function infer_index_expr(ctx, receiver, index, span, subst, __ring_ev_fail) {
  ...
  __ring_match66: {
    const __ring_m66 = recv_type;
    if (__ring_m66._tag === "StructType") {
      const name = __ring_m66.name; const type_params = __ring_m66.type_params;
    ...
    if (__ring_m66._tag === "StrType") {
      s = infer_ctx$unify_at(ctx.sink, ctx.env, idx_type, types$INT, s, span);
      result_ty = types$STR;
      break __ring_match66;
    }
    if (__ring_m66._tag === "ErrorType") {
      result_ty = types$Type_ErrorType;
      break __ring_match66;
    }
    const _ = infer_ctx$type_error(ctx.sink, codes$E0306, `Type '${types$type_to_string(recv_type)}' does not support indexing`, span, diagnostics$DiagnosticContext_OtherContext(Option_some("only List, Map, and Str support subscript operator []")));
...
function infer_ident(ctx, name, span, subst, qualifier) {
  ...
  __ring_match67: {
    const __ring_m67 = qualifier;
    if (__ring_m67._tag === "some") {
      const q = __ring_m67._0;
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match68: {
          const __ring_m68 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m68._tag === "some") {
            const prefix = __ring_m68._0;
            if ((prefix === "")) {
      ...
      __ring_match70: {
        ...
        if (__ring_m70._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match71: {
              const __ring_m71 = full_scheme;
              if (__ring_m71._tag === "some") {
                const fs = __ring_m71._0;
  ...
  const scheme = env$TypeEnv_lookup(ctx.env, name);
  __ring_match72: {
    const __ring_m72 = scheme;
    if (__ring_m72._tag === "none") {
      __ring_match73: {
        const __ring_m73 = resolved_qualifier;
        if (__ring_m73._tag === "some") {
          const q = __ring_m73._0;
    ...
    if (__ring_m72._tag === "some") {
      ...
      __ring_match74: {
        ...
        if (__ring_m74._tag === "some") {
          ...
          if (_Set_contains(ctx.env.scope.mutable_vars, did, __Int_Eq)) {
            __ring_match75: {
              const __ring_m75 = _Map_get(ctx.var_lambda_depth, did);
              if (__ring_m75._tag === "some") {
                const def_depth = __ring_m75._0;
      ...
      let __ring_blk12;
      __ring_match76: {
        const __ring_m76 = _Map_get(ctx.use_aliases, name);
        if (__ring_m76._tag === "some") {
          const qualified = __ring_m76._0;
          __ring_blk12 = qualified;
      ...
      const actual_name = __ring_blk12;
      __ring_match77: {
        const __ring_m77 = resolved_qualifier;
        if (__ring_m77._tag === "some") {
          const q = __ring_m77._0;
          __ring_match78: {
            const __ring_m78 = _Map_get(ctx.env.types.enums, q);
      ...
      __ring_match79: {
        const __ring_m79 = enum_name;
        if (__ring_m79._tag === "some") {
          const en = __ring_m79._0;
...
function infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail) {
  ...
  __ring_match80: {
    ...
    if (__ring_m80._tag === "Sub") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "-");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match80;
    }
    if (__ring_m80._tag === "Mul") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "*");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match80;
    }
    if (__ring_m80._tag === "Div") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "/");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match80;
    }
    if (__ring_m80._tag === "Mod") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "%");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match80;
    }
    if (__ring_m80._tag === "Eq") {
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
...
function infer_numeric_op(ctx, left, right, s, span, op_str) {
  ...
  __ring_match81: {
    ...
    if (__ring_m81._tag === "IntType") {
      return types$INT;
      break __ring_match81;
    }
    if (__ring_m81._tag === "FloatType") {
      return types$FLOAT;
      break __ring_match81;
    }
...
function is_primitive_eq(t) {
  __ring_match83: {
    ...
    if (__ring_m83._tag === "UnitType") {
      return true;
      break __ring_match83;
    }
    if (__ring_m83._tag === "NeverType") {
      return true;
      break __ring_match83;
    }
    if (__ring_m83._tag === "AnyType") {
      return true;
      break __ring_match83;
    }
    return false;
...
function is_primitive_ord(t) {
  __ring_match84: {
    const __ring_m84 = t;
    if (__ring_m84._tag === "IntType") {
      return true;
      break __ring_match84;
    }
    if (__ring_m84._tag === "FloatType") {
      return true;
      break __ring_match84;
    }
...
function resolve_trait_dispatch(ctx, resolved, trait_name, error_code, subst, span, op, is_builtin) {
  ...
  __ring_match86: {
    const __ring_m86 = resolved;
    if (__ring_m86._tag === "TypeVar") {
      const id = __ring_m86.id;
  ...
  __ring_match87: {
    const __ring_m87 = bound_resolved;
    if (__ring_m87._tag === "TypeVar") {
      const bid = __ring_m87.id;
      return (bid === id);
    ...
    break __ring_match87;
      ...
      __ring_match88: {
        const __ring_m88 = bound;
        if (__ring_m88._tag === "some") {
          const b = __ring_m88._0;
      ...
      __ring_match89: {
        const __ring_m89 = _Map_get(ctx.env.scope.var_bounds, id);
        if (__ring_m89._tag === "some") {
          const var_bounds = __ring_m89._0;
    ...
    if (__ring_m86._tag === "StructType") {
      const name = __ring_m86.name; const type_params = __ring_m86.type_params;
      if (ctx.env.trait_reg.trait_impls.some((function(i) { return ((i.target_type_name === name) && (i.trait_name === trait_name)); }))) {
        ...
        let __ring_blk13;
        __ring_match90: {
          const __ring_m90 = extra_dicts;
          if (__ring_m90._tag === "some") {
            const d = __ring_m90._0;
            __ring_blk13 = d;
        ...
        return hir$TraitDispatch_Direct(hir$trait_dict_name(name, trait_name), __ring_blk13);
      }
    ...
    if (__ring_m86._tag === "EnumType") {
      ...
      if (ctx.env.trait_reg.trait_impls.some((function(i) { return ((i.target_type_name === name) && (i.trait_name === trait_name)); }))) {
        ...
        let __ring_blk14;
        __ring_match91: {
          const __ring_m91 = extra_dicts;
          if (__ring_m91._tag === "some") {
            const d = __ring_m91._0;
            __ring_blk14 = d;
        ...
        return hir$TraitDispatch_Direct(hir$trait_dict_name(name, trait_name), __ring_blk14);
      }
      const _ = infer_ctx$type_error(ctx.sink, error_code, `Type '${types$type_to_string(resolved)}' does not implement ${trait_name}, cannot use '${op}'`, span, diagnostics$DiagnosticContext_TraitError(`type '${types$type_to_string(resolved)}' does not implement ${trait_name}`));
      return hir$TraitDispatch_Builtin;
      break __ring_match86;
...
function resolve_trait_extra_dicts(ctx, type_args, subst, trait_name) {
  ...
  for (const arg of type_args) {
    ...
    __ring_match92: {
      const __ring_m92 = dict;
      if (__ring_m92._tag === "some") {
        const d = __ring_m92._0;
        List_push(dicts, d);
...
function resolve_type_to_dict_ref(ctx, t, subst, trait_name) {
  __ring_match93: {
    const __ring_m93 = types$type_to_builtin_name(t);
    if (__ring_m93._tag === "some") {
      const builtin_name = __ring_m93._0;
      __ring_match94: {
        const __ring_m94 = t;
        ...
        return Option_some(hir$DictRef_Simple(hir$trait_dict_name(builtin_name, trait_name)));
        break __ring_match94;
      }
  ...
  __ring_match95: {
    const __ring_m95 = t;
    if (__ring_m95._tag === "TypeVar") {
      const id = __ring_m95.id;
      ...
      __ring_match96: {
        const __ring_m96 = bound;
        if (__ring_m96._tag === "some") {
          const b = __ring_m96._0;
    ...
    if (__ring_m95._tag === "StructType") {
      ...
      if (ctx.env.trait_reg.trait_impls.some((function(i) { return ((i.target_type_name === name) && (i.trait_name === trait_name)); }))) {
        if ((List_len(type_params) > 0)) {
          ...
          __ring_match97: {
            const __ring_m97 = inner;
            if (__ring_m97._tag === "some") {
              const inner_dicts = __ring_m97._0;
            ...
            if (__ring_m97._tag === "none") {
              return Option_some(hir$DictRef_Simple(hir$trait_dict_name(name, trait_name)));
              break __ring_match97;
            }
    ...
    if (__ring_m95._tag === "EnumType") {
      const name = __ring_m95.name; const type_params = __ring_m95.type_params;
      if (ctx.env.trait_reg.trait_impls.some((function(i) { return ((i.target_type_name === name) && (i.trait_name === trait_name)); }))) {
        if ((List_len(type_params) > 0)) {
          const inner = resolve_trait_extra_dicts(ctx, type_params, subst, trait_name);
          __ring_match98: {
            const __ring_m98 = inner;
            if (__ring_m98._tag === "some") {
              const inner_dicts = __ring_m98._0;
              return Option_some(hir$DictRef_Wrapped(hir$trait_dict_name(name, trait_name), trait_name, inner_dicts));
  ...
  __ring_match99: {
    ...
    if (__ring_m99._tag === "Neg") {
      ...
      __ring_match100: {
        ...
        if (__ring_m100._tag === "IntType") {
          result_type = types$INT;
          break __ring_match100;
        }
        if (__ring_m100._tag === "FloatType") {
...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  let __ring_blk15;
  __ring_match101: {
    const __ring_m101 = env$apply_subst(s, hir$hexpr_type(callee_r.hexpr));
    if (__ring_m101._tag === "FnType") {
      __ring_blk15 = Option_some(env$apply_subst(s, hir$hexpr_type(callee_r.hexpr)));
      break __ring_match101;
    }
    __ring_blk15 = Option_none;
    break __ring_match101;
  }
  const callee_fn_type = __ring_blk15;
  let hargs = [];
  let arg_types = [];
  let ai = 0;
  for (const arg of args) {
    ...
    __ring_match102: {
      ...
      if (__ring_m102._tag === "Lambda") {
        ...
        __ring_match103: {
              ...
              if (__ring_m104._tag === "FnType") {
                ...
                __ring_match105: {
                  ...
                  if (__ring_m105._tag === "some") {
                    ...
                    __ring_match106: {
                      ...
                      if (__ring_m106._tag === "FnType") {
                        ...
                        __ring_blk20 = infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
                        break __ring_match106;
                      }
                      __ring_blk20 = infer_expr(ctx, arg, s, __ring_ev_fail);
                      break __ring_match106;
                    }
                  ...
                  if (__ring_m105._tag === "none") {
                    __ring_blk19 = infer_expr(ctx, arg, s, __ring_ev_fail);
                    break __ring_match105;
                  }
                  __match_fail(__ring_m105);
                }
                __ring_blk18 = ((ai < List_len(cft_params)) ? __ring_blk19 : infer_expr(ctx, arg, s, __ring_ev_fail));
                break __ring_match104;
              }
              __ring_blk18 = infer_expr(ctx, arg, s, __ring_ev_fail);
              break __ring_match104;
            }
          ...
          if (__ring_m103._tag === "none") {
            __ring_blk17 = infer_expr(ctx, arg, s, __ring_ev_fail);
            break __ring_match103;
          }
      ...
      __ring_blk16 = infer_expr(ctx, arg, s, __ring_ev_fail);
      break __ring_match102;
    }
    let ar = __ring_blk16;
    s = ar.subst;
  ...
  __ring_match107: {
    const __ring_m107 = resolved_callee_type;
    if (__ring_m107._tag === "FnType") {
      const callee_params = __ring_m107.params; const fn_effects = __ring_m107.effects;
  ...
  let resolved_dicts = [];
  __ring_match108: {
    const __ring_m108 = callee;
    if (__ring_m108._tag === "Ident") {
      const callee_name = __ring_m108.name;
      __ring_match109: {
        const __ring_m109 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m109._tag === "some") {
          const callee_scheme = __ring_m109._0;
  ...
  __ring_match110: {
    const __ring_m110 = callee;
    if (__ring_m110._tag === "Ident") {
      const callee_name = __ring_m110.name;
      __ring_match111: {
        const __ring_m111 = _Map_get(ctx.fn_mut_params, callee_name);
        if (__ring_m111._tag === "some") {
          const mut_flags = __ring_m111._0;
          let mi = 0;
          while (((mi < List_len(mut_flags)) && (mi < List_len(args)))) {
            __ring_match112: {
              const __ring_m112 = [List_get(mut_flags, mi), List_get(hargs, mi)];
              if (Array.isArray(__ring_m112) && __ring_m112.length === 2 && __ring_m112[0]._tag === "some" && __ring_m112[1]._tag === "some") {
                const is_mut = __ring_m112[0]._0; const harg = __ring_m112[1]._0;
                if (is_mut) {
                  __ring_match113: {
                    const __ring_m113 = harg;
                    if (__ring_m113._tag === "Ident" && __ring_m113.def_id._tag === "some") {
                      const arg_did = __ring_m113.def_id._0;
                      if (_Set_contains(ctx.env.scope.mutable_vars, arg_did, __Int_Eq)) {
                        __ring_match114: {
                          const __ring_m114 = resolved_callee_type;
                          if (__ring_m114._tag === "FnType") {
                            const fn_params = __ring_m114.params;
                            __ring_match115: {
                              const __ring_m115 = List_get(fn_params, mi);
                              if (__ring_m115._tag === "some") {
                                const pt = __ring_m115._0;
                                const resolved_pt = env$apply_subst(s, pt);
...
function resolve_arg_dict_closure(ctx, harg, s) {
  __ring_match116: {
    const __ring_m116 = harg;
    if (__ring_m116._tag === "Ident") {
      const name = __ring_m116.name; const resolved_name = __ring_m116.resolved_name; const def_id = __ring_m116.def_id; const ty = __ring_m116.ty; const effects = __ring_m116.effects; const span = __ring_m116.span;
      const arg_scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match117: {
        const __ring_m117 = arg_scheme;
        if (__ring_m117._tag === "some") {
          const as_ = __ring_m117._0;
          ...
          for (const bound of as_.bounds) {
            __ring_match118: {
              const __ring_m118 = _Map_get(var_map, bound.type_var);
              if (__ring_m118._tag === "some") {
                const fresh_var = __ring_m118._0;
...
function resolve_arg_bound_dict(ctx, concrete, trait_name, dicts) {
  __ring_match119: {
    const __ring_m119 = concrete;
    if (__ring_m119._tag === "StructType") {
      const name = __ring_m119.name;
    ...
    if (__ring_m119._tag === "TypeVar") {
      const id = __ring_m119.id;
      ...
      __ring_match120: {
        const __ring_m120 = matching;
        if (__ring_m120._tag === "some") {
          const fb = __ring_m120._0;
    ...
    __ring_match121: {
      const __ring_m121 = types$type_to_builtin_name(concrete);
      if (__ring_m121._tag === "some") {
        const prim_name = __ring_m121._0;
...
function check_expr_is_let_def(ctx, expr) {
  __ring_match122: {
    const __ring_m122 = expr;
    if (__ring_m122._tag === "Ident") {
      const name = __ring_m122.name;
      __ring_match123: {
        const __ring_m123 = env$TypeEnv_lookup(ctx.env, name);
        if (__ring_m123._tag === "some") {
          const s = __ring_m123._0;
          __ring_match124: {
            const __ring_m124 = s.def_id;
    ...
    if (__ring_m122._tag === "FieldAccess") {
      const inner = __ring_m122.receiver;
...
function get_expr_def_id(ctx, expr) {
  __ring_match125: {
    const __ring_m125 = expr;
    if (__ring_m125._tag === "Ident") {
      const name = __ring_m125.name;
      __ring_match126: {
        const __ring_m126 = env$TypeEnv_lookup(ctx.env, name);
        if (__ring_m126._tag === "some") {
          const s = __ring_m126._0;
          return s.def_id;
...
function is_mut_method_call(ctx, recv_type, method) {
  ...
  __ring_match127: {
    ...
    __ring_match128: {
      const __ring_m128 = types$type_to_builtin_name(recv_type);
      if (__ring_m128._tag === "some") {
        const n = __ring_m128._0;
  ...
  __ring_match129: {
    const __ring_m129 = type_name;
    if (__ring_m129._tag === "some") {
      const tname = __ring_m129._0;
      __ring_match130: {
        const __ring_m130 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m130._tag === "some") {
          const mut_set = __ring_m130._0;
...
function check_receiver_mutability(ctx, receiver, recv_type, method, span) {
  let type_name = Option_none;
  __ring_match131: {
    const __ring_m131 = recv_type;
    if (__ring_m131._tag === "StructType") {
      const name = __ring_m131.name;
      type_name = Option_some(name);
      break __ring_match131;
    }
    if (__ring_m131._tag === "EnumType") {
      const name = __ring_m131.name;
      type_name = Option_some(name);
      break __ring_match131;
    }
    __ring_match132: {
      const __ring_m132 = types$type_to_builtin_name(recv_type);
      if (__ring_m132._tag === "some") {
        const n = __ring_m132._0;
        type_name = Option_some(n);
  ...
  __ring_match133: {
    const __ring_m133 = type_name;
    if (__ring_m133._tag === "some") {
      const tname = __ring_m133._0;
      __ring_match134: {
        const __ring_m134 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m134._tag === "some") {
          const mut_set = __ring_m134._0;
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match135: {
    const __ring_m135 = receiver;
    if (__ring_m135._tag === "Ident") {
      const recv_name = __ring_m135.name; const qualifier = __ring_m135.qualifier;
      let __ring_blk21;
      __ring_match136: {
        const __ring_m136 = qualifier;
        if (__ring_m136._tag === "some") {
          const q = __ring_m136._0;
          __ring_blk21 = `${q}::${recv_name}`;
          break __ring_match136;
        }
        if (__ring_m136._tag === "none") {
          __ring_blk21 = recv_name;
          break __ring_match136;
        }
        __match_fail(__ring_m136);
      }
      const full_effect_name = __ring_blk21;
      __ring_match137: {
        const __ring_m137 = _Map_get(ctx.env.types.effects, full_effect_name);
  ...
  if (is_mut_method_call(ctx, recv_type, method)) {
    __ring_match138: {
      const __ring_m138 = get_expr_def_id(ctx, receiver);
  ...
  if (Option_is_none(method_type)) {
    __ring_match140: {
      const __ring_m140 = types$type_to_builtin_name(recv_type);
      if (__ring_m140._tag === "some") {
        const prim_name = __ring_m140._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match141: {
      ...
      if (__ring_m141._tag === "some") {
        const type_name = __ring_m141._0;
  ...
  let __ring_blk22;
  __ring_match142: {
    const __ring_m142 = recv_raw_type;
    if (__ring_m142._tag === "TypeVar") {
      const id = __ring_m142.id;
      __ring_blk22 = Option_some(resolve_var_id(id, s));
      break __ring_match142;
    }
    __ring_blk22 = Option_none;
    break __ring_match142;
  }
  const recv_var_id = __ring_blk22;
  if (Option_is_none(method_type)) {
    __ring_match143: {
      const __ring_m143 = recv_var_id;
      if (__ring_m143._tag === "some") {
        const rvid = __ring_m143._0;
        for (const fb of ctx.current_fn_bounds) {
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match144: {
              const __ring_m144 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m144._tag === "some") {
                const trait_def = __ring_m144._0;
                ...
                __ring_match145: {
                  const __ring_m145 = tm;
                  if (__ring_m145._tag === "some") {
                    const found_method = __ring_m145._0;
  ...
  __ring_match146: {
    ...
    if (__ring_m146._tag === "some") {
      ...
      __ring_match147: {
        const __ring_m147 = mt;
        if (__ring_m147._tag === "FnType") {
          const mt_params = __ring_m147.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match148: {
              const __ring_m148 = List_first(mt_params);
              if (__ring_m148._tag === "some") {
                const first_param = __ring_m148._0;
  ...
  for (const arg of args) {
    let __ring_blk23;
    __ring_match149: {
      const __ring_m149 = arg;
      if (__ring_m149._tag === "Lambda") {
        const lparams = __ring_m149.params; const lbody = __ring_m149.body; const lspan = __ring_m149.span;
        let __ring_blk24;
        __ring_match150: {
          const __ring_m150 = method_type;
          if (__ring_m150._tag === "some") {
            const mt = __ring_m150._0;
            let __ring_blk25;
            __ring_match151: {
              const __ring_m151 = mt;
              if (__ring_m151._tag === "FnType") {
                const mt_params = __ring_m151.params;
                let __ring_blk26;
                __ring_match152: {
                  const __ring_m152 = List_get(mt_params, (ai + 1));
                  if (__ring_m152._tag === "some") {
                    const expected_raw = __ring_m152._0;
                    const expected = env$apply_subst(s, expected_raw);
                    let __ring_blk27;
                    __ring_match153: {
                      const __ring_m153 = expected;
                      if (__ring_m153._tag === "FnType") {
                        const exp_params = __ring_m153.params;
                        __ring_blk27 = infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
                ...
                __ring_blk25 = (((ai + 1) < List_len(mt_params)) ? __ring_blk26 : infer_expr(ctx, arg, s, __ring_ev_fail));
  ...
  __ring_match154: {
    const __ring_m154 = method_type;
    if (__ring_m154._tag === "some") {
      const mt = __ring_m154._0;
      __ring_match155: {
        const __ring_m155 = mt;
        if (__ring_m155._tag === "FnType") {
          const mt_params = __ring_m155.params; const mt_ret = __ring_m155.return_type; const mt_effects = __ring_m155.effects;
          let i = 0;
          for (const harg of hargs) {
            if (((i + 1) < List_len(mt_params))) {
              __ring_match156: {
                const __ring_m156 = List_get(mt_params, (i + 1));
                if (__ring_m156._tag === "some") {
                  const expected_param = __ring_m156._0;
  ...
  let resolved_dicts = [];
  __ring_match159: {
    const __ring_m159 = method_scheme;
    if (__ring_m159._tag === "some") {
      const ms = __ring_m159._0;
      if ((List_len(ms.bounds) > 0)) {
        __ring_match160: {
          const __ring_m160 = method_type;
          if (__ring_m160._tag === "some") {
            const mt = __ring_m160._0;
  ...
  let __ring_blk28;
  __ring_match161: {
    const __ring_m161 = method_type;
    if (__ring_m161._tag === "some") {
      const mt = __ring_m161._0;
      __ring_blk28 = mt;
      break __ring_match161;
    }
    if (__ring_m161._tag === "none") {
      __ring_blk28 = env$TypeEnv_fresh_var(ctx.env);
      break __ring_match161;
    }
    __match_fail(__ring_m161);
  }
  const callee_type = __ring_blk28;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match162: {
    const __ring_m162 = _Map_get(ctx.env.trait_reg.impl_methods, type_name);
    if (__ring_m162._tag === "some") {
      const impl_methods = __ring_m162._0;
      __ring_match163: {
        const __ring_m163 = _Map_get(impl_methods, method);
        if (__ring_m163._tag === "some") {
          const scheme = __ring_m163._0;
...
function lookup_trait_method(ctx, type_name, method, span) {
  ...
  for (const impl_entry of ctx.env.trait_reg.trait_impls) {
    if ((impl_entry.target_type_name === type_name)) {
      __ring_match164: {
        const __ring_m164 = _Map_get(ctx.env.trait_reg.traits, impl_entry.trait_name);
        if (__ring_m164._tag === "some") {
          const trait_def = __ring_m164._0;
          const tm = ((__a) => { const __i = __a.findIndex((function(m) { return (m.name === method); })); return __i >= 0 ? { _tag: "some", _0: __a[__i] } : { _tag: "none" }; })(trait_def.methods);
          __ring_match165: {
            const __ring_m165 = tm;
            if (__ring_m165._tag === "some") {
              const found_method = __ring_m165._0;
              __ring_match166: {
                const __ring_m166 = found_trait_name;
                if (__ring_m166._tag === "some") {
                  const prev_trait = __ring_m166._0;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match167: {
    const __ring_m167 = effect_def_opt;
  ...
  let __ring_blk29;
  __ring_match168: {
    const __ring_m168 = effect_def_opt;
    if (__ring_m168._tag === "some") {
      const ed = __ring_m168._0;
      __ring_blk29 = ed;
      break __ring_match168;
    }
    if (__ring_m168._tag === "none") {
      __ring_blk29 = panic("unreachable: effect_def_opt after none early return");
      break __ring_match168;
    }
    __match_fail(__ring_m168);
  }
  const effect_def = __ring_blk29;
  ...
  let __ring_blk30;
  __ring_match170: {
    const __ring_m170 = op_opt;
    if (__ring_m170._tag === "some") {
      const o = __ring_m170._0;
      __ring_blk30 = o;
      break __ring_match170;
    }
    if (__ring_m170._tag === "none") {
      __ring_blk30 = panic("unreachable: op_opt after none early return");
      break __ring_match170;
    }
    __match_fail(__ring_m170);
  }
  const op = __ring_blk30;
  ...
  for (const arg of args) {
    ...
    List_push(hargs, ar.hexpr);
    __ring_match171: {
      const __ring_m171 = List_get(inst_params, i);
      if (__ring_m171._tag === "some") {
        const param_type = __ring_m171._0;
  ...
  __ring_match172: {
    const __ring_m172 = effect_def.built_in_kind;
    if (__ring_m172._tag === "some") {
      const bik = __ring_m172._0;
      __ring_match173: {
        const __ring_m173 = bik;
        if (__ring_m173._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match173;
        }
        if (__ring_m173._tag === "BkFail") {
          let __ring_blk31;
          __ring_match174: {
            const __ring_m174 = List_first(hargs);
            if (__ring_m174._tag === "some") {
              const h = __ring_m174._0;
              __ring_blk31 = h;
              break __ring_match174;
            }
            if (__ring_m174._tag === "none") {
              __ring_blk31 = panic("unreachable: hargs.first() after len > 0 check");
              break __ring_match174;
            }
            __match_fail(__ring_m174);
          }
          const error_type = ((List_len(hargs) > 0) ? env$apply_subst(s, hir$hexpr_type(__ring_blk31)) : types$UNIT);
          eff = types$Effect_FailEffect(error_type);
          break __ring_match173;
        }
        if (__ring_m173._tag === "BkMut") {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match175: {
    const __ring_m175 = recv_type;
    if (__ring_m175._tag === "StructType") {
      const name = __ring_m175.name; const type_params = __ring_m175.type_params;
      __ring_match176: {
        const __ring_m176 = _Map_get(ctx.env.types.structs, name);
        if (__ring_m176._tag === "some") {
          const struct_def = __ring_m176._0;
          ...
          __ring_match177: {
            ...
            if (__ring_m177._tag === "some") {
              const found_field = __ring_m177._0;
              let inst_map = map_new();
              let fi = 0;
              while (((fi < List_len(struct_def.type_param_vars)) && (fi < List_len(type_params)))) {
                __ring_match178: {
                  const __ring_m178 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m178) && __ring_m178.length === 2 && __ring_m178[0]._tag === "some" && __ring_m178[1]._tag === "some") {
                    const var_id = __ring_m178[0]._0; const tp = __ring_m178[1]._0;
    ...
    if (__ring_m175._tag === "RecordType") {
      const rec_fields = __ring_m175.fields; const tail = __ring_m175.tail;
    ...
    if (__ring_m175._tag === "TupleType") {
      ...
      __ring_match181: {
        ...
        if (__ring_m181._tag === "some") {
          ...
          __ring_match182: {
            const __ring_m182 = List_get(elements, i);
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  let resolved_qualifier = qualifier;
  __ring_match183: {
    const __ring_m183 = qualifier;
    if (__ring_m183._tag === "some") {
      const q = __ring_m183._0;
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match184: {
          const __ring_m184 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m184._tag === "some") {
            const prefix = __ring_m184._0;
            if ((prefix === "")) {
              resolved_qualifier = Option_none;
            } else {
              resolved_qualifier = Option_some(prefix);
  ...
  __ring_match185: {
    const __ring_m185 = resolved_qualifier;
    if (__ring_m185._tag === "some") {
      const q = __ring_m185._0;
      const qualified_name = `${q}::${name}`;
      const mod_struct = _Map_get(ctx.env.types.structs, qualified_name);
      __ring_match186: {
        const __ring_m186 = mod_struct;
  ...
  __ring_match188: {
    const __ring_m188 = resolved_qualifier;
    if (__ring_m188._tag === "some") {
      const q = __ring_m188._0;
      __ring_match189: {
        const __ring_m189 = _Map_get(ctx.env.types.enums, q);
        if (__ring_m189._tag === "some") {
          const enum_def = __ring_m189._0;
          if (enum_def.variants.some((function(v) { return (v.name === name); }))) {
        ...
        if (__ring_m189._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match190: {
              const __ring_m190 = _Map_get(ctx.env.types.enums, full_q);
              if (__ring_m190._tag === "some") {
                const enum_def = __ring_m190._0;
                if (enum_def.variants.some((function(v) { return (v.name === name); }))) {
                  variant_enum = Option_some(enum_def.name);
                }
  ...
  if ((Option_is_none(variant_enum) && Option_is_some(resolved_qualifier))) {
    __ring_match191: {
      const __ring_m191 = resolved_qualifier;
      if (__ring_m191._tag === "some") {
        const q = __ring_m191._0;
        const _ = infer_ctx$type_error(ctx.sink, codes$E0201, `'${q}' has no variant '${name}'`, span, diagnostics$DiagnosticContext_UndefinedVariable(name, Option_none));
  ...
  __ring_match192: {
    const __ring_m192 = variant_enum;
    if (__ring_m192._tag === "some") {
      const ve = __ring_m192._0;
      __ring_match193: {
        const __ring_m193 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m193._tag === "some") {
          const enum_def = __ring_m193._0;
          ...
          __ring_match194: {
            const __ring_m194 = variant;
            if (__ring_m194._tag === "some") {
              const v = __ring_m194._0;
              __ring_match195: {
                const __ring_m195 = v.field_names;
  ...
  __ring_match196: {
    const __ring_m196 = struct_def_opt;
  ...
  let __ring_blk32;
  __ring_match197: {
    const __ring_m197 = struct_def_opt;
    if (__ring_m197._tag === "some") {
      const sd = __ring_m197._0;
      __ring_blk32 = sd;
      break __ring_match197;
    }
    if (__ring_m197._tag === "none") {
      __ring_blk32 = panic("unreachable: struct_def_opt after none early return");
      break __ring_match197;
    }
    __match_fail(__ring_m197);
  }
  const struct_def = __ring_blk32;
  let inst_map = map_new();
  let type_param_types = [];
  let tpi = 0;
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match198: {
      const __ring_m198 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m198._tag === "some") {
        const var_id = __ring_m198._0;
  ...
  __ring_match199: {
    const __ring_m199 = spread;
    if (__ring_m199._tag === "some") {
      const sp = __ring_m199._0;
  ...
  for (const field of fields) {
    ...
    __ring_match200: {
      const __ring_m200 = def_field;
      if (__ring_m200._tag === "some") {
        const df = __ring_m200._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  let __ring_blk33;
  __ring_match201: {
    const __ring_m201 = variant.field_names;
    if (__ring_m201._tag === "some") {
      const fn_ = __ring_m201._0;
      __ring_blk33 = fn_;
  ...
  const field_names = __ring_blk33;
  let inst_map = map_new();
  let type_param_types = [];
  let tpi = 0;
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match202: {
      const __ring_m202 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m202._tag === "some") {
        const var_id = __ring_m202._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  let hspread = Option_none;
  __ring_match203: {
    const __ring_m203 = spread;
    if (__ring_m203._tag === "some") {
      const sp = __ring_m203._0;
      const sr = infer_expr(ctx, sp, s, __ring_ev_fail);
      s = sr.subst;
      const me = infer_ctx$merge_effects(ctx.env, effects, sr.effects, s, __ring_ev_fail);
      effects = me[0];
  ...
  for (const field of fields) {
    ...
    __ring_match204: {
      const __ring_m204 = field_idx;
      if (__ring_m204._tag === "some") {
        const idx = __ring_m204._0;
        __ring_match205: {
          const __ring_m205 = List_get(variant.fields, idx);
          if (__ring_m205._tag === "some") {
            const ftype = __ring_m205._0;
...
function rewrite_bare_enum_bindings(env, pattern) {
  __ring_match206: {
    const __ring_m206 = pattern;
    if (__ring_m206._tag === "Binding") {
      const name = __ring_m206.name; const span = __ring_m206.span;
      __ring_match207: {
        const __ring_m207 = _Map_get(env.types.variant_to_enum, name);
        if (__ring_m207._tag === "some") {
          const ve = __ring_m207._0;
          __ring_match208: {
            const __ring_m208 = _Map_get(env.types.enums, ve);
            if (__ring_m208._tag === "some") {
              const edef = __ring_m208._0;
    ...
    if (__ring_m206._tag === "TuplePattern") {
      const elements = __ring_m206.elements; const span = __ring_m206.span;
      let new_elems = [];
    ...
    if (__ring_m206._tag === "Constructor") {
      const name = __ring_m206.name; const qualifier = __ring_m206.qualifier; const fields = __ring_m206.fields; const span = __ring_m206.span;
      let new_fields = [];
      for (const f of fields) {
    ...
    if (__ring_m206._tag === "NamedConstructor") {
      const name = __ring_m206.name; const qualifier = __ring_m206.qualifier; const fields = __ring_m206.fields; const rest = __ring_m206.rest; const span = __ring_m206.span;
      let new_fields = [];
      for (const f of fields) {
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match212: {
    const __ring_m212 = missing;
    if (__ring_m212._tag === "some") {
      const m = __ring_m212._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  let result_type = types$UNIT;
  __ring_match213: {
    const __ring_m213 = else_branch;
    if (__ring_m213._tag === "some") {
      const eb = __ring_m213._0;
      __ring_match214: {
        const __ring_m214 = eb;
        ...
        if (__ring_m214._tag === "IfExpr") {
          const ec = __ring_m214.condition; const etb = __ring_m214.then_branch; const eeb = __ring_m214.else_branch; const espan = __ring_m214.span;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  for (const part of parts) {
    __ring_match215: {
      const __ring_m215 = part;
      if (__ring_m215._tag === "LitPart") {
        const str_val = __ring_m215._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match215;
      }
      if (__ring_m215._tag === "ExprPart") {
        const expr = __ring_m215._0;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  for (const eff of effects.effects) {
    __ring_match216: {
      const __ring_m216 = eff;
      if (__ring_m216._tag === "FailEffect") {
        const et = __ring_m216.error_type;
        if (found_fail) {
  ...
  let __ring_blk34;
  __ring_match217: {
    const __ring_m217 = resolved_row.tail;
  ...
  const has_open_tail = __ring_blk34;
  ...
  __ring_match220: {
    const __ring_m220 = missing;
    if (__ring_m220._tag === "some") {
      const m = __ring_m220._0;
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  for (const handler of handlers) {
    ...
    __ring_match221: {
      const __ring_m221 = effect_def;
      if (__ring_m221._tag === "some") {
        const ed = __ring_m221._0;
    ...
    __ring_match222: {
      const __ring_m222 = effect_def;
      if (__ring_m222._tag === "some") {
        const ed = __ring_m222._0;
    ...
    for (const p of handler.params) {
      let __ring_blk35;
      __ring_match223: {
        const __ring_m223 = p.type_annotation;
        if (__ring_m223._tag === "some") {
          const ta = __ring_m223._0;
        ...
        if (__ring_m223._tag === "none") {
          let __ring_blk36;
          __ring_match224: {
            const __ring_m224 = op_def;
            if (__ring_m224._tag === "some") {
              const od = __ring_m224._0;
              let __ring_blk37;
              __ring_match225: {
                const __ring_m225 = List_get(od.params, hi);
                if (__ring_m225._tag === "some") {
                  const odt = __ring_m225._0;
                  __ring_blk37 = env$apply_subst_map(handler_inst_map, odt);
            ...
            if (__ring_m224._tag === "none") {
              __ring_blk36 = env$TypeEnv_fresh_var(ctx.env);
              break __ring_match224;
            }
    ...
    __ring_match226: {
      const __ring_m226 = handler.resume_name;
      if (__ring_m226._tag === "some") {
        const rn = __ring_m226._0;
        let __ring_blk38;
        __ring_match227: {
          const __ring_m227 = op_def;
          if (__ring_m227._tag === "some") {
            const od = __ring_m227._0;
            __ring_blk38 = env$apply_subst_map(handler_inst_map, od.return_type);
        ...
        const resume_param = __ring_blk38;
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match228: {
      const __ring_m228 = handler_body_result;
      if (__ring_m228._tag === "some") {
        const hbr = __ring_m228._0;
        s = hbr.subst;
  ...
  for (const e of resolved_effects.effects) {
    ...
    __ring_match229: {
      const __ring_m229 = e;
      if (__ring_m229._tag === "IoEffect") {
        __ring_blk39 = (!_Set_contains(handled_effects, "io", __Str_Eq));
        break __ring_match229;
      }
      if (__ring_m229._tag === "CustomEffect") {
        const name = __ring_m229.name;
        __ring_blk39 = (!_Set_contains(handled_effects, name, __Str_Eq));
        break __ring_match229;
      }
      if (__ring_m229._tag === "FailEffect") {
        __ring_blk39 = (!_Set_contains(handled_effects, "fail", __Str_Eq));
        break __ring_match229;
      }
      if (__ring_m229._tag === "MutEffect") {
        __ring_blk39 = (!_Set_contains(handled_effects, "mut", __Str_Eq));
        break __ring_match229;
      }
      __match_fail(__ring_m229);
    }
    const should_keep = __ring_blk39;
    if (should_keep) {
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  for (const p of params) {
    let __ring_blk40;
    __ring_match230: {
      const __ring_m230 = p.type_annotation;
      if (__ring_m230._tag === "some") {
        const ta = __ring_m230._0;
        __ring_blk40 = infer_ctx$resolve_type_expr(ctx, ta);
        break __ring_match230;
      }
      if (__ring_m230._tag === "none") {
        __ring_blk40 = env$TypeEnv_fresh_var(ctx.env);
        break __ring_match230;
      }
      __match_fail(__ring_m230);
    }
    const pt = __ring_blk40;
    __ring_match231: {
      const __ring_m231 = expected_param_types;
      if (__ring_m231._tag === "some") {
        const epts = __ring_m231._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match232: {
            const __ring_m232 = List_get(epts, pi);
            if (__ring_m232._tag === "some") {
              const expected_t = __ring_m232._0;
    ...
    __ring_match233: {
      const __ring_m233 = lam_scheme;
      if (__ring_m233._tag === "some") {
        const ls = __ring_m233._0;
        __ring_match234: {
          const __ring_m234 = ls.def_id;
          if (__ring_m234._tag === "some") {
            const did = __ring_m234._0;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match235: {
    const __ring_m235 = body_result;
    if (__ring_m235._tag === "some") {
      const body_r = __ring_m235._0;
      s = body_r.subst;
      let applied_params = [];
