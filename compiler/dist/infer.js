...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match61: {
    const __ring_m61 = expected;
    if (__ring_m61._tag === "FnType") {
      const exp_params = __ring_m61.params;
  ...
  __ring_match62: {
    const __ring_m62 = resolved_callee_type;
    if (__ring_m62._tag === "FnType") {
      const fn_effects = __ring_m62.effects;
  ...
  let resolved_dicts = [];
  __ring_match63: {
    const __ring_m63 = callee;
    if (__ring_m63._tag === "Ident") {
      const callee_name = __ring_m63.name;
      __ring_match64: {
        const __ring_m64 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m64._tag === "some") {
          const callee_scheme = __ring_m64._0;
...
function resolve_arg_dict_closure(ctx, harg, s) {
  __ring_match65: {
    const __ring_m65 = harg;
    if (__ring_m65._tag === "Ident") {
      const name = __ring_m65.name; const resolved_name = __ring_m65.resolved_name; const def_id = __ring_m65.def_id; const ty = __ring_m65.ty; const effects = __ring_m65.effects; const span = __ring_m65.span;
      const arg_scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match66: {
        const __ring_m66 = arg_scheme;
        if (__ring_m66._tag === "some") {
          const as_ = __ring_m66._0;
          ...
          for (const bound of as_.bounds) {
            __ring_match67: {
              const __ring_m67 = _Map_get(var_map, bound.type_var);
              if (__ring_m67._tag === "some") {
                const fresh_var = __ring_m67._0;
...
function resolve_arg_bound_dict(ctx, concrete, trait_name, dicts) {
  __ring_match68: {
    ...
    if (__ring_m68._tag === "TypeVar") {
      ...
      __ring_match69: {
        const __ring_m69 = matching;
        if (__ring_m69._tag === "some") {
          const fb = __ring_m69._0;
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match73: {
    const __ring_m73 = recv_type;
    if (__ring_m73._tag === "StructType") {
      const name = __ring_m73.name;
  ...
  if (Option_is_none(method_type)) {
    __ring_match76: {
      const __ring_m76 = recv_var_id;
      if (__ring_m76._tag === "some") {
        const rvid = __ring_m76._0;
              ...
              if (__ring_m77._tag === "some") {
                ...
                __ring_match78: {
                  ...
                  if (__ring_m78._tag === "some") {
                    const found_method = __ring_m78._0;
  ...
  __ring_match79: {
    const __ring_m79 = method_type;
    if (__ring_m79._tag === "some") {
      const mt = __ring_m79._0;
      __ring_match80: {
        const __ring_m80 = mt;
        if (__ring_m80._tag === "FnType") {
          const mt_params = __ring_m80.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match81: {
              const __ring_m81 = List_first(mt_params);
              if (__ring_m81._tag === "some") {
                const first_param = __ring_m81._0;
  ...
  const expected = env$apply_subst(s, expected_raw);
  __ring_match82: {
    const __ring_m82 = expected;
    if (__ring_m82._tag === "FnType") {
      const exp_params = __ring_m82.params;
      return infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
  ...
  __ring_match83: {
    const __ring_m83 = method_type;
    if (__ring_m83._tag === "some") {
      const mt = __ring_m83._0;
      __ring_match84: {
        const __ring_m84 = mt;
        if (__ring_m84._tag === "FnType") {
          const mt_params = __ring_m84.params; const mt_ret = __ring_m84.return_type; const mt_effects = __ring_m84.effects;
          let i = 0;
          for (const harg of hargs) {
            if (((i + 1) < List_len(mt_params))) {
              __ring_match85: {
                const __ring_m85 = List_get(mt_params, (i + 1));
                if (__ring_m85._tag === "some") {
                  const expected_param = __ring_m85._0;
  ...
  let resolved_dicts = [];
  __ring_match88: {
    const __ring_m88 = method_scheme;
    if (__ring_m88._tag === "some") {
      const ms = __ring_m88._0;
      if ((List_len(ms.bounds) > 0)) {
        __ring_match89: {
          const __ring_m89 = method_type;
          if (__ring_m89._tag === "some") {
            const mt = __ring_m89._0;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match90: {
    ...
    if (__ring_m90._tag === "some") {
      ...
      __ring_match91: {
        const __ring_m91 = _Map_get(impl_methods, method);
        if (__ring_m91._tag === "some") {
          const scheme = __ring_m91._0;
        ...
        if (__ring_m92._tag === "some") {
          ...
          __ring_match93: {
            ...
            if (__ring_m93._tag === "some") {
              const found_method = __ring_m93._0;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  for (const arg of args) {
    ...
    List_push(hargs, ar.hexpr);
    __ring_match94: {
      const __ring_m94 = List_get(op.params, i);
      if (__ring_m94._tag === "some") {
        const param_type = __ring_m94._0;
  ...
  __ring_match95: {
    const __ring_m95 = effect_def.built_in_kind;
    if (__ring_m95._tag === "some") {
      const bik = __ring_m95._0;
      __ring_match96: {
        const __ring_m96 = bik;
        if (__ring_m96._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match96;
        }
        if (__ring_m96._tag === "BkFail") {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match97: {
    const __ring_m97 = recv_type;
    if (__ring_m97._tag === "StructType") {
      const name = __ring_m97.name; const type_params = __ring_m97.type_params;
      __ring_match98: {
        const __ring_m98 = _Map_get(ctx.env.structs, name);
        if (__ring_m98._tag === "some") {
          const struct_def = __ring_m98._0;
    ...
    if (__ring_m97._tag === "RecordType") {
      const rec_fields = __ring_m97.fields; const tail = __ring_m97.tail;
    ...
    if (__ring_m97._tag === "TupleType") {
      const elements = __ring_m97.elements;
      __ring_match103: {
        const __ring_m103 = parse_int(field);
        ...
        if (__ring_m103._tag === "some") {
          ...
          __ring_match104: {
            const __ring_m104 = List_get(elements, i);
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  ...
  __ring_match105: {
    const __ring_m105 = qualifier;
    if (__ring_m105._tag === "some") {
      const q = __ring_m105._0;
      __ring_match106: {
        const __ring_m106 = _Map_get(ctx.env.enums, q);
  ...
  if ((Option_is_none(variant_enum) && Option_is_some(qualifier))) {
    __ring_match107: {
      const __ring_m107 = qualifier;
      if (__ring_m107._tag === "some") {
        const q = __ring_m107._0;
        infer_ctx$type_error(ctx.sink, codes$E0201, `'${q}' has no variant '${name}'`, span, diagnostics$DiagnosticContext_UndefinedVariable(name, Option_none), __ring_ev_fail);
  ...
  __ring_match108: {
    const __ring_m108 = variant_enum;
    if (__ring_m108._tag === "some") {
      const ve = __ring_m108._0;
      __ring_match109: {
        const __ring_m109 = _Map_get(ctx.env.enums, ve);
        if (__ring_m109._tag === "some") {
          ...
          __ring_match110: {
            const __ring_m110 = variant;
            if (__ring_m110._tag === "some") {
              const v = __ring_m110._0;
              __ring_match111: {
                const __ring_m111 = v.field_names;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match112: {
      const __ring_m112 = List_get(struct_def.type_param_vars, tpi);
  ...
  for (const field of fields) {
    ...
    __ring_match114: {
      const __ring_m114 = def_field;
      if (__ring_m114._tag === "some") {
        const df = __ring_m114._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  ...
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match115: {
      const __ring_m115 = List_get(enum_def.type_param_vars, tpi);
  ...
  for (const field of fields) {
    ...
    __ring_match117: {
      const __ring_m117 = field_idx;
      if (__ring_m117._tag === "some") {
        const idx = __ring_m117._0;
        __ring_match118: {
          const __ring_m118 = List_get(variant.fields, idx);
          if (__ring_m118._tag === "some") {
            const ftype = __ring_m118._0;
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match119: {
    const __ring_m119 = arm.pattern;
    if (__ring_m119._tag === "Binding") {
      const pat_name = __ring_m119.name; const pspan = __ring_m119.span;
      __ring_match120: {
        const __ring_m120 = _Map_get(ctx.env.variant_to_enum, pat_name);
        if (__ring_m120._tag === "some") {
          const ve = __ring_m120._0;
          __ring_match121: {
            const __ring_m121 = _Map_get(ctx.env.enums, ve);
            if (__ring_m121._tag === "some") {
              const edef = __ring_m121._0;
  ...
  __ring_match125: {
    const __ring_m125 = missing;
    if (__ring_m125._tag === "some") {
      const m = __ring_m125._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  let result_type = types$UNIT;
  __ring_match126: {
    const __ring_m126 = else_branch;
    if (__ring_m126._tag === "some") {
      const eb = __ring_m126._0;
      __ring_match127: {
        const __ring_m127 = eb;
        if (__ring_m127._tag === "Block") {
        ...
        if (__ring_m127._tag === "IfExpr") {
          const ec = __ring_m127.condition; const etb = __ring_m127.then_branch; const eeb = __ring_m127.else_branch; const espan = __ring_m127.span;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  for (const part of parts) {
    __ring_match128: {
      const __ring_m128 = part;
      if (__ring_m128._tag === "LitPart") {
        const str_val = __ring_m128._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match128;
      }
      if (__ring_m128._tag === "ExprPart") {
        const expr = __ring_m128._0;
...
function check_decl(ctx, decl, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m143._tag === "Const") {
      const name = __ring_m143.name; const type_annotation = __ring_m143.type_annotation; const init = __ring_m143.init; const is_pub = __ring_m143.is_pub; const span = __ring_m143.span;
...
function check_const_decl(ctx, name, type_annotation, init, is_pub, span, __ring_ev_fail) {
  ...
  __ring_match144: {
    const __ring_m144 = type_annotation;
    if (__ring_m144._tag === "some") {
      const texpr = __ring_m144._0;
  ...
  const init_r = infer_expr(ctx, init, ctx.subst, __ring_ev_fail);
  let s = init_r.subst;
  let init_ty = hir$hexpr_type(init_r.hexpr);
  __ring_match145: {
    const __ring_m145 = expected_ty;
    if (__ring_m145._tag === "some") {
      const ann_ty = __ring_m145._0;
...
function check_impl_decl(ctx, target_type, type_params, trait_name, methods, span, __ring_ev_fail) {
  ...
  for (const method of methods) {
    __ring_match146: {
      ...
      if (__ring_m146._tag === "ExternFn") {
        const name = __ring_m146.name; const mtps = __ring_m146.type_params; const params = __ring_m146.params; const return_type = __ring_m146.return_type; const is_pub = __ring_m146.is_pub; const mspan = __ring_m146.span;
        List_push(hmethods, check_extern_fn_decl(ctx, name, mtps, params, is_pub, mspan));
        break __ring_match146;
      }
      if (__ring_m146._tag === "Fn") {
        const name = __ring_m146.name; const mtps = __ring_m146.type_params; const params = __ring_m146.params; const return_type = __ring_m146.return_type; const body = __ring_m146.body; const is_pub = __ring_m146.is_pub; const mspan = __ring_m146.span;
...
function check_trait_decl(ctx, name, type_params, ast_methods, is_pub, span, __ring_ev_fail) {
  ...
  if ((List_len(trait_def.methods) > 0)) {
    __ring_match147: {
      const __ring_m147 = List_first(trait_def.methods);
      if (__ring_m147._tag === "some") {
        const first_method = __ring_m147._0;
        __ring_match148: {
          const __ring_m148 = first_method.ty;
          if (__ring_m148._tag === "FnType") {
            const fps = __ring_m148.params;
            if ((List_len(fps) > 0)) {
              __ring_match149: {
                const __ring_m149 = List_first(fps);
                if (__ring_m149._tag === "some") {
                  const fp = __ring_m149._0;
                  self_var = fp;
  ...
  __match_fail(__ring_m);
    ...
    if (m.has_default) {
      __ring_match150: {
        const __ring_m150 = ast_method;
        if (__ring_m150._tag === "some") {
          const am = __ring_m150._0;
          __ring_match151: {
            const __ring_m151 = am;
            if (__ring_m151._tag === "Fn") {
              const abody = __ring_m151.body;
...
function check_trait_default_body(ctx, trait_name, self_var, hparams, body, __ring_ev_fail) {
  ...
  __ring_match152: {
    const __ring_m152 = self_var;
    if (__ring_m152._tag === "TypeVar") {
      const id = __ring_m152.id;
  ...
  for (const p of hparams) {
    ...
    if (p.is_mutable) {
      __ring_match153: {
        const __ring_m153 = env$TypeEnv_lookup(ctx.env, p.name);
        if (__ring_m153._tag === "some") {
          const ps = __ring_m153._0;
          __ring_match154: {
            const __ring_m154 = ps.def_id;
            if (__ring_m154._tag === "some") {
              const did = __ring_m154._0;
              _Set_insert(ctx.env.mutable_vars, did);
    ...
    if (((!_Map_contains_key(saved_tp_scope, tpname)) && (!_Set_contains(declared_names, tpname)))) {
      __ring_match158: {
        ...
        if (__ring_m158._tag === "TypeVar") {
          const resolved = env$apply_subst(ctx.subst, tv);
          __ring_match159: {
            const __ring_m159 = resolved;
            if (__ring_m159._tag === "TypeVar") {
              const rid = __ring_m159.id;
...
function check_fn_decl(ctx, name, type_params, params, return_type, body, is_pub, span, self_type, __ring_ev_fail) {
  ...
  for (const tp of type_params) {
    __ring_match160: {
      const __ring_m160 = _Map_get(ctx.type_param_scope, tp.name);
      if (__ring_m160._tag === "some") {
        const tv = __ring_m160._0;
        __ring_match161: {
          const __ring_m161 = tv;
          if (__ring_m161._tag === "TypeVar") {
            const id = __ring_m161.id;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match162: {
      const __ring_m162 = param_scheme;
      if (__ring_m162._tag === "some") {
        const ps = __ring_m162._0;
        __ring_match163: {
          const __ring_m163 = ps.def_id;
  ...
  __ring_match164: {
    const __ring_m164 = fn_def_id;
    if (__ring_m164._tag === "some") {
      const did = __ring_m164._0;
...
function check_one_decl(ctx, decl, hdecls, __ring_ev_fail) {
  ...
  List_push(hdecls, hd);
  __ring_match165: {
    const __ring_m165 = hd;
    if (__ring_m165._tag === "Fn") {
      const name = __ring_m165.name; const effects = __ring_m165.effects;
