...
function infer_stmt(ctx, stmt, subst, __ring_ev_fail) {
    ...
    if (__ring_m15._tag === "ForIn") {
      ...
      __ring_match24: {
        ...
        if (__ring_m24._tag === "EnumType") {
          const name = __ring_m24.name; const type_params = __ring_m24.type_params;
  ...
  __match_fail(__ring_m);
              ...
              if (((name === hir$BUILTIN_MAP) && (List_len(type_params) >= 2))) {
                ...
                __ring_match25: {
                  const __ring_m25 = [List_get(type_params, 0), List_get(type_params, 1)];
                  if (Array.isArray(__ring_m25) && __ring_m25.length === 2 && __ring_m25[0]._tag === "some" && __ring_m25[1]._tag === "some") {
                    const kt = __ring_m25[0]._0; const vt = __ring_m25[1]._0;
      ...
      __ring_match26: {
        const __ring_m26 = destructure;
        if (__ring_m26._tag === "some") {
          const destr = __ring_m26._0;
          __ring_match27: {
            const __ring_m27 = element_type;
            if (__ring_m27._tag === "TupleType") {
              const type_elems = __ring_m27.elements;
          ...
          while ((di < List_len(destr.names))) {
            __ring_match28: {
              const __ring_m28 = List_get(destr.names, di);
              if (__ring_m28._tag === "some") {
                const dname = __ring_m28._0;
  ...
  return env$TypeEnv_fresh_var(ctx.env);
                ...
                __ring_match29: {
                  const __ring_m29 = dscheme;
                  if (__ring_m29._tag === "some") {
                    const ds = __ring_m29._0;
                    __ring_match30: {
                      const __ring_m30 = [ds.def_id, List_get(destr.spans, di)];
                      if (Array.isArray(__ring_m30) && __ring_m30.length === 2 && __ring_m30[0]._tag === "some" && __ring_m30[1]._tag === "some") {
                        const did = __ring_m30[0]._0; const dspan = __ring_m30[1]._0;
      ...
      __ring_match31: {
        const __ring_m31 = binding_scheme;
        if (__ring_m31._tag === "some") {
          const bs = __ring_m31._0;
          __ring_match32: {
            const __ring_m32 = bs.def_id;
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match33: {
        const __ring_m33 = body_result;
        if (__ring_m33._tag === "some") {
          const body_r = __ring_m33._0;
          s = body_r.subst;
  ...
  return [];
      ...
      __ring_match35: {
        const __ring_m35 = pattern;
        if (__ring_m35._tag === "TuplePattern") {
          const pat_elements = __ring_m35.elements;
          ...
          while ((bi < List_len(pat_elements))) {
            __ring_match36: {
              const __ring_m36 = List_get(pat_elements, bi);
  ...
  __match_fail(__ring_m);
                ...
                __ring_match37: {
                  const __ring_m37 = p;
                  if (__ring_m37._tag === "Binding") {
                    const name = __ring_m37.name; const pspan = __ring_m37.span;
                    env$TypeEnv_bind_mono(ctx.env, name, elem_type);
                    const bscheme = env$TypeEnv_lookup(ctx.env, name);
                    __ring_match38: {
                      const __ring_m38 = bscheme;
                      if (__ring_m38._tag === "some") {
                        const bs = __ring_m38._0;
                        __ring_match39: {
                          const __ring_m39 = bs.def_id;
                          if (__ring_m39._tag === "some") {
                            const did = __ring_m39._0;
  ...
  return infer_block(ctx, then_block, Option_some(s), __ring_ev_fail);
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match40: {
        const __ring_m40 = then_result;
        if (__ring_m40._tag === "some") {
          const then_r = __ring_m40._0;
          s = then_r.subst;
          ...
          __ring_match41: {
            ...
            if (__ring_m41._tag === "some") {
              ...
              env$TypeEnv_pop_scope(ctx.env);
              __ring_match42: {
                const __ring_m42 = else_result;
                if (__ring_m42._tag === "some") {
                  const else_r = __ring_m42._0;
                  s = else_r.subst;
...
function check_assign_target_mutable(ctx, target) {
  __ring_match43: {
    const __ring_m43 = target;
    if (__ring_m43._tag === "Ident") {
      const name = __ring_m43.name; const span = __ring_m43.span;
      const scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match44: {
        const __ring_m44 = scheme;
        if (__ring_m44._tag === "some") {
          const s = __ring_m44._0;
          __ring_match45: {
            const __ring_m45 = s.def_id;
            if (__ring_m45._tag === "some") {
              const did = __ring_m45._0;
    ...
    if (__ring_m43._tag === "FieldAccess") {
      const receiver = __ring_m43.receiver; const span = __ring_m43.span;
      const root = find_root_expr(receiver);
      __ring_match46: {
        const __ring_m46 = root;
        if (__ring_m46._tag === "Ident") {
          const name = __ring_m46.name; const rspan = __ring_m46.span;
          const scheme = env$TypeEnv_lookup(ctx.env, name);
          __ring_match47: {
            const __ring_m47 = scheme;
            if (__ring_m47._tag === "some") {
              const s = __ring_m47._0;
              __ring_match48: {
                const __ring_m48 = s.def_id;
                if (__ring_m48._tag === "some") {
                  const did = __ring_m48._0;
                  if ((!_Set_contains(ctx.env.scope.mutable_vars, did, __Int_Eq))) {
    ...
    if (__ring_m43._tag === "IndexExpr") {
      ...
      const root = find_root_expr(receiver);
      __ring_match49: {
        const __ring_m49 = root;
        if (__ring_m49._tag === "Ident") {
          const name = __ring_m49.name; const rspan = __ring_m49.span;
          const scheme = env$TypeEnv_lookup(ctx.env, name);
          __ring_match50: {
            const __ring_m50 = scheme;
            if (__ring_m50._tag === "some") {
              const s = __ring_m50._0;
              __ring_match51: {
                const __ring_m51 = s.def_id;
...
function find_root_expr(e) {
  __ring_match52: {
    const __ring_m52 = e;
    if (__ring_m52._tag === "FieldAccess") {
      const receiver = __ring_m52.receiver;
      return find_root_expr(receiver);
      break __ring_match52;
    }
    if (__ring_m52._tag === "IndexExpr") {
      const receiver = __ring_m52.receiver;
      return find_root_expr(receiver);
      break __ring_match52;
    }
...
function infer_expr(ctx, expr, subst, __ring_ev_fail) {
  __ring_match53: {
    ...
    if (__ring_m53._tag === "FloatLit") {
      const value = __ring_m53.value; const span = __ring_m53.span;
      return new infer_ctx$InferResult(hir$HExpr_FloatLit(value, types$FLOAT, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match53;
    }
    if (__ring_m53._tag === "StrLit") {
      const value = __ring_m53.value; const span = __ring_m53.span;
      return new infer_ctx$InferResult(hir$HExpr_StrLit(value, types$STR, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match53;
    }
    if (__ring_m53._tag === "BoolLit") {
      const value = __ring_m53.value; const span = __ring_m53.span;
      return new infer_ctx$InferResult(hir$HExpr_BoolLit(value, types$BOOL, types$EMPTY_ROW, span), subst, types$EMPTY_ROW);
      break __ring_match53;
    }
    if (__ring_m53._tag === "Ident") {
      const name = __ring_m53.name; const qualifier = __ring_m53.qualifier; const span = __ring_m53.span;
      return infer_ident(ctx, name, span, subst, qualifier);
      break __ring_match53;
    }
    if (__ring_m53._tag === "BinOp") {
      const op = __ring_m53.op; const left = __ring_m53.left; const right = __ring_m53.right; const span = __ring_m53.span;
      return infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail);
      break __ring_match53;
    }
    if (__ring_m53._tag === "UnaryOp") {
      const op = __ring_m53.op; const operand = __ring_m53.operand; const span = __ring_m53.span;
      return infer_unary_op(ctx, op, operand, span, subst, __ring_ev_fail);
      break __ring_match53;
    }
    if (__ring_m53._tag === "Call") {
      const callee = __ring_m53.callee; const args = __ring_m53.args; const span = __ring_m53.span;
      return infer_call(ctx, callee, args, span, subst, __ring_ev_fail);
      break __ring_match53;
    }
    if (__ring_m53._tag === "MethodCall") {
      const receiver = __ring_m53.receiver; const method = __ring_m53.method; const args = __ring_m53.args; const span = __ring_m53.span;
      return infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail);
      break __ring_match53;
    }
    if (__ring_m53._tag === "FieldAccess") {
      const receiver = __ring_m53.receiver; const field = __ring_m53.field; const span = __ring_m53.span;
      return infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail);
      break __ring_match53;
    }
    if (__ring_m53._tag === "StructLit") {
      const name = __ring_m53.name; const qualifier = __ring_m53.qualifier; const fields = __ring_m53.fields; const spread = __ring_m53.spread; const span = __ring_m53.span;
      return infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail);
      break __ring_match53;
    }
    if (__ring_m53._tag === "MatchExpr") {
      const scrutinee = __ring_m53.scrutinee; const arms = __ring_m53.arms; const span = __ring_m53.span;
    ...
    if (__ring_m53._tag === "IfExpr") {
      const condition = __ring_m53.condition; const then_branch = __ring_m53.then_branch; const else_branch = __ring_m53.else_branch; const span = __ring_m53.span;
      return infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail);
      break __ring_match53;
    }
    if (__ring_m53._tag === "StringInterp") {
      const parts = __ring_m53.parts; const span = __ring_m53.span;
      return infer_string_interp(ctx, parts, span, subst, __ring_ev_fail);
      break __ring_match53;
    }
    if (__ring_m53._tag === "CatchExpr") {
      const catch_expr = __ring_m53.expr; const arms = __ring_m53.arms; const span = __ring_m53.span;
      return infer_catch(ctx, catch_expr, arms, span, subst, __ring_ev_fail);
      break __ring_match53;
    }
    if (__ring_m53._tag === "HandleExpr") {
      const body = __ring_m53.body; const handlers = __ring_m53.handlers; const span = __ring_m53.span;
      return infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail);
      break __ring_match53;
    }
    if (__ring_m53._tag === "Lambda") {
      const params = __ring_m53.params; const body = __ring_m53.body; const span = __ring_m53.span;
      return infer_lambda(ctx, params, body, span, subst, Option_none, __ring_ev_fail);
      break __ring_match53;
    }
    if (__ring_m53._tag === "ListLit") {
    ...
    if (__ring_m53._tag === "Range") {
      const start = __ring_m53.start; const end = __ring_m53.end; const inclusive = __ring_m53.inclusive; const span = __ring_m53.span;
    ...
    if (__ring_m53._tag === "IndexExpr") {
      const receiver = __ring_m53.receiver; const index = __ring_m53.index; const span = __ring_m53.span;
...
function infer_index_expr(ctx, receiver, index, span, subst, __ring_ev_fail) {
  ...
  __ring_match54: {
    ...
    if (__ring_m54._tag === "StructType") {
      const name = __ring_m54.name; const type_params = __ring_m54.type_params;
...
function infer_ident(ctx, name, span, subst, qualifier) {
  ...
  __ring_match55: {
    const __ring_m55 = qualifier;
    if (__ring_m55._tag === "some") {
      const q = __ring_m55._0;
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match56: {
          const __ring_m56 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m56._tag === "some") {
            const prefix = __ring_m56._0;
            if ((prefix === "")) {
  ...
  __ring_match57: {
    const __ring_m57 = resolved_qualifier;
    if (__ring_m57._tag === "some") {
      ...
      __ring_match58: {
        const __ring_m58 = mod_scheme;
        if (__ring_m58._tag === "some") {
          const ms = __ring_m58._0;
        ...
        if (__ring_m58._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match59: {
              const __ring_m59 = full_scheme;
              if (__ring_m59._tag === "some") {
                const fs = __ring_m59._0;
  ...
  const scheme = env$TypeEnv_lookup(ctx.env, name);
  __ring_match60: {
    const __ring_m60 = scheme;
    if (__ring_m60._tag === "none") {
      __ring_match61: {
        const __ring_m61 = resolved_qualifier;
        if (__ring_m61._tag === "some") {
          const q = __ring_m61._0;
    ...
    if (__ring_m60._tag === "some") {
      ...
      __ring_match62: {
        ...
        if (__ring_m62._tag === "some") {
          ...
          if (_Set_contains(ctx.env.scope.mutable_vars, did, __Int_Eq)) {
            __ring_match63: {
              const __ring_m63 = _Map_get(ctx.var_lambda_depth, did);
              if (__ring_m63._tag === "some") {
                const def_depth = __ring_m63._0;
  ...
  __match_fail(__ring_m);
      ...
      __ring_match64: {
        const __ring_m64 = resolved_qualifier;
        if (__ring_m64._tag === "some") {
          const q = __ring_m64._0;
          __ring_match65: {
      ...
      __ring_match66: {
        const __ring_m66 = enum_name;
        if (__ring_m66._tag === "some") {
          const en = __ring_m66._0;
...
function infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail) {
  ...
  __ring_match67: {
    ...
    if (__ring_m67._tag === "Sub") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "-");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match67;
    }
    if (__ring_m67._tag === "Mul") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "*");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match67;
    }
    if (__ring_m67._tag === "Div") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "/");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match67;
    }
    if (__ring_m67._tag === "Mod") {
      result_type = infer_numeric_op(ctx, lr.hexpr, rr.hexpr, s, span, "%");
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(lr.hexpr), hir$hexpr_type(rr.hexpr), s, span);
      break __ring_match67;
    }
...
function is_primitive_eq(t) {
  __ring_match70: {
    ...
    if (__ring_m70._tag === "UnitType") {
      return true;
      break __ring_match70;
    }
    if (__ring_m70._tag === "NeverType") {
      return true;
      break __ring_match70;
    }
    if (__ring_m70._tag === "AnyType") {
      return true;
      break __ring_match70;
    }
    return false;
...
function resolve_trait_dispatch(ctx, resolved, trait_name, error_code, subst, span, op, is_builtin) {
  ...
  __ring_match74: {
    const __ring_m74 = bound_resolved;
    if (__ring_m74._tag === "TypeVar") {
      const bid = __ring_m74.id;
      return (bid === id);
    ...
    break __ring_match74;
      ...
      __ring_match75: {
        const __ring_m75 = bound;
        if (__ring_m75._tag === "some") {
          const b = __ring_m75._0;
      ...
      __ring_match76: {
        const __ring_m76 = _Map_get(ctx.env.scope.var_bounds, id);
        if (__ring_m76._tag === "some") {
          const var_bounds = __ring_m76._0;
...
function resolve_type_to_dict_ref(ctx, t, subst, trait_name) {
  __ring_match78: {
    const __ring_m78 = types$type_to_builtin_name(t);
    if (__ring_m78._tag === "some") {
      const builtin_name = __ring_m78._0;
      __ring_match79: {
        const __ring_m79 = t;
        if (__ring_m79._tag === "StructType") {
          break __ring_match79;
        }
        if (__ring_m79._tag === "EnumType") {
          break __ring_match79;
        }
  ...
  __ring_match80: {
    ...
    if (__ring_m80._tag === "TypeVar") {
      ...
      __ring_match81: {
        const __ring_m81 = bound;
        if (__ring_m81._tag === "some") {
          const b = __ring_m81._0;
    ...
    if (__ring_m80._tag === "StructType") {
      ...
      if (ctx.env.trait_reg.trait_impls.some((function(i) { return ((i.target_type_name === name) && (i.trait_name === trait_name)); }))) {
        if ((List_len(type_params) > 0)) {
          ...
          __ring_match82: {
            const __ring_m82 = inner;
            if (__ring_m82._tag === "some") {
              const inner_dicts = __ring_m82._0;
    ...
    if (__ring_m80._tag === "EnumType") {
      ...
      if (ctx.env.trait_reg.trait_impls.some((function(i) { return ((i.target_type_name === name) && (i.trait_name === trait_name)); }))) {
        if ((List_len(type_params) > 0)) {
          const inner = resolve_trait_extra_dicts(ctx, type_params, subst, trait_name);
          __ring_match83: {
            const __ring_m83 = inner;
            if (__ring_m83._tag === "some") {
              const inner_dicts = __ring_m83._0;
              return Option_some(hir$DictRef_Wrapped(hir$trait_dict_name(name, trait_name), trait_name, inner_dicts));
...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match86: {
    const __ring_m86 = expected;
    if (__ring_m86._tag === "FnType") {
      const exp_params = __ring_m86.params;
  ...
  __ring_match87: {
    const __ring_m87 = resolved_callee_type;
    if (__ring_m87._tag === "FnType") {
      const callee_params = __ring_m87.params; const fn_effects = __ring_m87.effects;
  ...
  let resolved_dicts = [];
  __ring_match88: {
    const __ring_m88 = callee;
    if (__ring_m88._tag === "Ident") {
      const callee_name = __ring_m88.name;
      __ring_match89: {
        const __ring_m89 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m89._tag === "some") {
          const callee_scheme = __ring_m89._0;
  ...
  __ring_match90: {
    const __ring_m90 = callee;
    if (__ring_m90._tag === "Ident") {
      const callee_name = __ring_m90.name;
      __ring_match91: {
        const __ring_m91 = _Map_get(ctx.fn_mut_params, callee_name);
        if (__ring_m91._tag === "some") {
          const mut_flags = __ring_m91._0;
          let mi = 0;
          while (((mi < List_len(mut_flags)) && (mi < List_len(args)))) {
            __ring_match92: {
              const __ring_m92 = [List_get(mut_flags, mi), List_get(hargs, mi)];
              if (Array.isArray(__ring_m92) && __ring_m92.length === 2 && __ring_m92[0]._tag === "some" && __ring_m92[1]._tag === "some") {
                const is_mut = __ring_m92[0]._0; const harg = __ring_m92[1]._0;
                if (is_mut) {
                  __ring_match93: {
                    const __ring_m93 = harg;
                    if (__ring_m93._tag === "Ident" && __ring_m93.def_id._tag === "some") {
                      const arg_did = __ring_m93.def_id._0;
                      if (_Set_contains(ctx.env.scope.mutable_vars, arg_did, __Int_Eq)) {
                        __ring_match94: {
                          const __ring_m94 = resolved_callee_type;
                          if (__ring_m94._tag === "FnType") {
                            const fn_params = __ring_m94.params;
                            __ring_match95: {
                              const __ring_m95 = List_get(fn_params, mi);
                              if (__ring_m95._tag === "some") {
                                const pt = __ring_m95._0;
                                const resolved_pt = env$apply_subst(s, pt);
...
function resolve_arg_dict_closure(ctx, harg, s) {
  __ring_match96: {
    const __ring_m96 = harg;
    if (__ring_m96._tag === "Ident") {
      const name = __ring_m96.name; const resolved_name = __ring_m96.resolved_name; const def_id = __ring_m96.def_id; const ty = __ring_m96.ty; const effects = __ring_m96.effects; const span = __ring_m96.span;
      const arg_scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match97: {
        const __ring_m97 = arg_scheme;
        if (__ring_m97._tag === "some") {
          const as_ = __ring_m97._0;
          ...
          for (const bound of as_.bounds) {
            __ring_match98: {
              const __ring_m98 = _Map_get(var_map, bound.type_var);
              if (__ring_m98._tag === "some") {
                const fresh_var = __ring_m98._0;
...
function resolve_arg_bound_dict(ctx, concrete, trait_name, dicts) {
  __ring_match99: {
    const __ring_m99 = concrete;
    if (__ring_m99._tag === "StructType") {
      const name = __ring_m99.name;
    ...
    if (__ring_m99._tag === "TypeVar") {
      ...
      __ring_match100: {
        const __ring_m100 = matching;
        if (__ring_m100._tag === "some") {
          const fb = __ring_m100._0;
    ...
    __ring_match101: {
      const __ring_m101 = types$type_to_builtin_name(concrete);
      if (__ring_m101._tag === "some") {
        const prim_name = __ring_m101._0;
...
function check_expr_is_let_def(ctx, expr) {
  __ring_match102: {
    const __ring_m102 = expr;
    if (__ring_m102._tag === "Ident") {
      const name = __ring_m102.name;
      __ring_match103: {
        const __ring_m103 = env$TypeEnv_lookup(ctx.env, name);
        if (__ring_m103._tag === "some") {
          const s = __ring_m103._0;
          __ring_match104: {
            const __ring_m104 = s.def_id;
            if (__ring_m104._tag === "some") {
              const did = __ring_m104._0;
    ...
    if (__ring_m102._tag === "FieldAccess") {
      const inner = __ring_m102.receiver;
...
function get_expr_def_id(ctx, expr) {
  __ring_match105: {
    const __ring_m105 = expr;
    if (__ring_m105._tag === "Ident") {
      const name = __ring_m105.name;
      __ring_match106: {
        const __ring_m106 = env$TypeEnv_lookup(ctx.env, name);
        if (__ring_m106._tag === "some") {
          const s = __ring_m106._0;
          return s.def_id;
...
function is_mut_method_call(ctx, recv_type, method) {
  ...
  __ring_match107: {
    ...
    __ring_match108: {
      const __ring_m108 = types$type_to_builtin_name(recv_type);
      if (__ring_m108._tag === "some") {
        const n = __ring_m108._0;
  ...
  __ring_match109: {
    const __ring_m109 = type_name;
    if (__ring_m109._tag === "some") {
      const tname = __ring_m109._0;
      __ring_match110: {
        const __ring_m110 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m110._tag === "some") {
          const mut_set = __ring_m110._0;
...
function check_receiver_mutability(ctx, receiver, recv_type, method, span) {
  ...
  __ring_match113: {
    const __ring_m113 = type_name;
    if (__ring_m113._tag === "some") {
      const tname = __ring_m113._0;
      __ring_match114: {
        const __ring_m114 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m114._tag === "some") {
          const mut_set = __ring_m114._0;
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match115: {
    const __ring_m115 = receiver;
    if (__ring_m115._tag === "Ident") {
      const recv_name = __ring_m115.name; const qualifier = __ring_m115.qualifier;
  ...
  __match_fail(__ring_m);
      ...
      __ring_match116: {
        const __ring_m116 = _Map_get(ctx.env.types.effects, full_effect_name);
  ...
  if (is_mut_method_call(ctx, recv_type, method)) {
    __ring_match117: {
      const __ring_m117 = get_expr_def_id(ctx, receiver);
  ...
  if (Option_is_none(method_type)) {
    __ring_match119: {
      const __ring_m119 = types$type_to_builtin_name(recv_type);
      if (__ring_m119._tag === "some") {
        const prim_name = __ring_m119._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match120: {
      ...
      if (__ring_m120._tag === "some") {
        const type_name = __ring_m120._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match121: {
      const __ring_m121 = recv_var_id;
      if (__ring_m121._tag === "some") {
        const rvid = __ring_m121._0;
        for (const fb of ctx.current_fn_bounds) {
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match122: {
              const __ring_m122 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m122._tag === "some") {
                const trait_def = __ring_m122._0;
                ...
                __ring_match123: {
                  const __ring_m123 = tm;
                  if (__ring_m123._tag === "some") {
                    const found_method = __ring_m123._0;
  ...
  __ring_match124: {
    const __ring_m124 = method_type;
    if (__ring_m124._tag === "some") {
      const mt = __ring_m124._0;
      __ring_match125: {
        const __ring_m125 = mt;
        if (__ring_m125._tag === "FnType") {
          const mt_params = __ring_m125.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match126: {
              const __ring_m126 = List_first(mt_params);
              if (__ring_m126._tag === "some") {
                const first_param = __ring_m126._0;
  ...
  const expected = env$apply_subst(s, expected_raw);
  __ring_match127: {
    const __ring_m127 = expected;
    if (__ring_m127._tag === "FnType") {
      const exp_params = __ring_m127.params;
      return infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
  ...
  __ring_match128: {
    const __ring_m128 = method_type;
    if (__ring_m128._tag === "some") {
      const mt = __ring_m128._0;
      __ring_match129: {
        const __ring_m129 = mt;
        if (__ring_m129._tag === "FnType") {
          const mt_params = __ring_m129.params; const mt_ret = __ring_m129.return_type; const mt_effects = __ring_m129.effects;
          let i = 0;
          for (const harg of hargs) {
            if (((i + 1) < List_len(mt_params))) {
              __ring_match130: {
                const __ring_m130 = List_get(mt_params, (i + 1));
                if (__ring_m130._tag === "some") {
                  const expected_param = __ring_m130._0;
  ...
  let resolved_dicts = [];
  __ring_match133: {
    const __ring_m133 = method_scheme;
    if (__ring_m133._tag === "some") {
      const ms = __ring_m133._0;
      if ((List_len(ms.bounds) > 0)) {
        __ring_match134: {
          const __ring_m134 = method_type;
          if (__ring_m134._tag === "some") {
            const mt = __ring_m134._0;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match135: {
    const __ring_m135 = _Map_get(ctx.env.trait_reg.impl_methods, type_name);
    if (__ring_m135._tag === "some") {
      const impl_methods = __ring_m135._0;
      __ring_match136: {
        const __ring_m136 = _Map_get(impl_methods, method);
        if (__ring_m136._tag === "some") {
          const scheme = __ring_m136._0;
...
function lookup_trait_method(ctx, type_name, method, span) {
  ...
  for (const impl_entry of ctx.env.trait_reg.trait_impls) {
    if ((impl_entry.target_type_name === type_name)) {
      __ring_match137: {
        const __ring_m137 = _Map_get(ctx.env.trait_reg.traits, impl_entry.trait_name);
        if (__ring_m137._tag === "some") {
          const trait_def = __ring_m137._0;
          const tm = ((__a) => { const __i = __a.findIndex((function(m) { return (m.name === method); })); return __i >= 0 ? { _tag: "some", _0: __a[__i] } : { _tag: "none" }; })(trait_def.methods);
          __ring_match138: {
            const __ring_m138 = tm;
            if (__ring_m138._tag === "some") {
              const found_method = __ring_m138._0;
              __ring_match139: {
                const __ring_m139 = found_trait_name;
                if (__ring_m139._tag === "some") {
                  const prev_trait = __ring_m139._0;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match140: {
    const __ring_m140 = effect_def_opt;
  ...
  for (const arg of args) {
    ...
    List_push(hargs, ar.hexpr);
    __ring_match142: {
      const __ring_m142 = List_get(inst_params, i);
      if (__ring_m142._tag === "some") {
        const param_type = __ring_m142._0;
  ...
  __ring_match143: {
    const __ring_m143 = effect_def.built_in_kind;
    if (__ring_m143._tag === "some") {
      const bik = __ring_m143._0;
      __ring_match144: {
        const __ring_m144 = bik;
        if (__ring_m144._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match144;
        }
        if (__ring_m144._tag === "BkFail") {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match145: {
    ...
    if (__ring_m145._tag === "StructType") {
      const name = __ring_m145.name; const type_params = __ring_m145.type_params;
      __ring_match146: {
        const __ring_m146 = _Map_get(ctx.env.types.structs, name);
        if (__ring_m146._tag === "some") {
          const struct_def = __ring_m146._0;
          ...
          __ring_match147: {
            ...
            if (__ring_m147._tag === "some") {
              const found_field = __ring_m147._0;
              let inst_map = map_new();
              let fi = 0;
              while (((fi < List_len(struct_def.type_param_vars)) && (fi < List_len(type_params)))) {
                __ring_match148: {
                  const __ring_m148 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m148) && __ring_m148.length === 2 && __ring_m148[0]._tag === "some" && __ring_m148[1]._tag === "some") {
                    const var_id = __ring_m148[0]._0; const tp = __ring_m148[1]._0;
    ...
    if (__ring_m145._tag === "RecordType") {
      const rec_fields = __ring_m145.fields; const tail = __ring_m145.tail;
    ...
    if (__ring_m145._tag === "TupleType") {
      ...
      __ring_match151: {
        const __ring_m151 = parse_int(field);
        ...
        if (__ring_m151._tag === "some") {
          ...
          __ring_match152: {
            const __ring_m152 = List_get(elements, i);
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  let resolved_qualifier = qualifier;
  __ring_match153: {
    const __ring_m153 = qualifier;
    if (__ring_m153._tag === "some") {
      const q = __ring_m153._0;
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match154: {
          const __ring_m154 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m154._tag === "some") {
            const prefix = __ring_m154._0;
            if ((prefix === "")) {
              resolved_qualifier = Option_none;
            } else {
              resolved_qualifier = Option_some(prefix);
  ...
  __ring_match155: {
    const __ring_m155 = resolved_qualifier;
    if (__ring_m155._tag === "some") {
      const q = __ring_m155._0;
      const qualified_name = `${q}::${name}`;
      const mod_struct = _Map_get(ctx.env.types.structs, qualified_name);
      __ring_match156: {
        const __ring_m156 = mod_struct;
  ...
  __ring_match158: {
    const __ring_m158 = resolved_qualifier;
    if (__ring_m158._tag === "some") {
      const q = __ring_m158._0;
      __ring_match159: {
        const __ring_m159 = _Map_get(ctx.env.types.enums, q);
        if (__ring_m159._tag === "some") {
          const enum_def = __ring_m159._0;
          if (enum_def.variants.some((function(v) { return (v.name === name); }))) {
        ...
        if (__ring_m159._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match160: {
              const __ring_m160 = _Map_get(ctx.env.types.enums, full_q);
  ...
  if ((Option_is_none(variant_enum) && Option_is_some(resolved_qualifier))) {
    __ring_match161: {
      const __ring_m161 = resolved_qualifier;
      if (__ring_m161._tag === "some") {
        const q = __ring_m161._0;
        const _ = infer_ctx$type_error(ctx.sink, codes$E0201, `'${q}' has no variant '${name}'`, span, diagnostics$DiagnosticContext_UndefinedVariable(name, Option_none));
  ...
  __ring_match162: {
    const __ring_m162 = variant_enum;
    if (__ring_m162._tag === "some") {
      const ve = __ring_m162._0;
      __ring_match163: {
        const __ring_m163 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m163._tag === "some") {
          const enum_def = __ring_m163._0;
          ...
          __ring_match164: {
            const __ring_m164 = variant;
            if (__ring_m164._tag === "some") {
              const v = __ring_m164._0;
              __ring_match165: {
                const __ring_m165 = v.field_names;
  ...
  __ring_match166: {
    const __ring_m166 = struct_def_opt;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match167: {
      const __ring_m167 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m167._tag === "some") {
        const var_id = __ring_m167._0;
  ...
  __ring_match168: {
    const __ring_m168 = spread;
    if (__ring_m168._tag === "some") {
      const sp = __ring_m168._0;
  ...
  for (const field of fields) {
    ...
    __ring_match169: {
      const __ring_m169 = def_field;
      if (__ring_m169._tag === "some") {
        const df = __ring_m169._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  ...
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match170: {
      const __ring_m170 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m170._tag === "some") {
        const var_id = __ring_m170._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  let hspread = Option_none;
  __ring_match171: {
    const __ring_m171 = spread;
    if (__ring_m171._tag === "some") {
      const sp = __ring_m171._0;
      const sr = infer_expr(ctx, sp, s, __ring_ev_fail);
      s = sr.subst;
      const me = infer_ctx$merge_effects(ctx.env, effects, sr.effects, s, __ring_ev_fail);
      effects = me[0];
  ...
  for (const field of fields) {
    ...
    __ring_match172: {
      const __ring_m172 = field_idx;
      if (__ring_m172._tag === "some") {
        const idx = __ring_m172._0;
        __ring_match173: {
          const __ring_m173 = List_get(variant.fields, idx);
          if (__ring_m173._tag === "some") {
            const ftype = __ring_m173._0;
...
function rewrite_bare_enum_bindings(env, pattern) {
  __ring_match174: {
    const __ring_m174 = pattern;
    if (__ring_m174._tag === "Binding") {
      const name = __ring_m174.name; const span = __ring_m174.span;
      __ring_match175: {
        const __ring_m175 = _Map_get(env.types.variant_to_enum, name);
        if (__ring_m175._tag === "some") {
          const ve = __ring_m175._0;
          __ring_match176: {
            const __ring_m176 = _Map_get(env.types.enums, ve);
            if (__ring_m176._tag === "some") {
              const edef = __ring_m176._0;
    ...
    if (__ring_m174._tag === "TuplePattern") {
    ...
    if (__ring_m174._tag === "Constructor") {
      const name = __ring_m174.name; const qualifier = __ring_m174.qualifier; const fields = __ring_m174.fields; const span = __ring_m174.span;
      let new_fields = [];
      for (const f of fields) {
    ...
    if (__ring_m174._tag === "NamedConstructor") {
      const name = __ring_m174.name; const qualifier = __ring_m174.qualifier; const fields = __ring_m174.fields; const rest = __ring_m174.rest; const span = __ring_m174.span;
      let new_fields = [];
      for (const f of fields) {
    ...
    if (__ring_m174._tag === "OrPattern") {
      const patterns = __ring_m174.patterns; const span = __ring_m174.span;
      let new_pats = [];
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match178: {
    const __ring_m178 = arm.guard;
    if (__ring_m178._tag === "some") {
      const g = __ring_m178._0;
  ...
  __ring_match180: {
    const __ring_m180 = missing;
    if (__ring_m180._tag === "some") {
      const m = __ring_m180._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  let result_type = types$UNIT;
  __ring_match181: {
    const __ring_m181 = else_branch;
    if (__ring_m181._tag === "some") {
      const eb = __ring_m181._0;
      __ring_match182: {
        const __ring_m182 = eb;
        if (__ring_m182._tag === "Block") {
        ...
        if (__ring_m182._tag === "IfExpr") {
          const ec = __ring_m182.condition; const etb = __ring_m182.then_branch; const eeb = __ring_m182.else_branch; const espan = __ring_m182.span;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  for (const part of parts) {
    __ring_match183: {
      const __ring_m183 = part;
      if (__ring_m183._tag === "LitPart") {
        const str_val = __ring_m183._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match183;
      }
      if (__ring_m183._tag === "ExprPart") {
        const expr = __ring_m183._0;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  for (const eff of effects.effects) {
    __ring_match184: {
      const __ring_m184 = eff;
      if (__ring_m184._tag === "FailEffect") {
        const et = __ring_m184.error_type;
        if (found_fail) {
  ...
  let guard_hexpr = Option_none;
  __ring_match185: {
    const __ring_m185 = arm.guard;
    if (__ring_m185._tag === "some") {
      const g = __ring_m185._0;
      const gr = infer_expr(ctx, g, s, __ring_ev_fail);
      s = gr.subst;
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(gr.hexpr), types$BOOL, s, arm.span);
      const me = infer_ctx$merge_effects(ctx.env, effects, gr.effects, s, __ring_ev_fail);
  ...
  __ring_match187: {
    const __ring_m187 = missing;
    if (__ring_m187._tag === "some") {
      const m = __ring_m187._0;
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  for (const handler of handlers) {
    ...
    __ring_match188: {
      const __ring_m188 = effect_def;
      if (__ring_m188._tag === "some") {
        const ed = __ring_m188._0;
    ...
    __ring_match189: {
      const __ring_m189 = effect_def;
      if (__ring_m189._tag === "some") {
        const ed = __ring_m189._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match190: {
      const __ring_m190 = handler.resume_name;
      if (__ring_m190._tag === "some") {
        const rn = __ring_m190._0;
  ...
  __match_fail(__ring_m);
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match191: {
      const __ring_m191 = handler_body_result;
      if (__ring_m191._tag === "some") {
        const hbr = __ring_m191._0;
        s = hbr.subst;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match192: {
      const __ring_m192 = expected_param_types;
      if (__ring_m192._tag === "some") {
        const epts = __ring_m192._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match193: {
            const __ring_m193 = List_get(epts, pi);
            if (__ring_m193._tag === "some") {
              const expected_t = __ring_m193._0;
    ...
    __ring_match194: {
      const __ring_m194 = lam_scheme;
      if (__ring_m194._tag === "some") {
        const ls = __ring_m194._0;
        __ring_match195: {
          const __ring_m195 = ls.def_id;
          if (__ring_m195._tag === "some") {
            const did = __ring_m195._0;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match196: {
    const __ring_m196 = body_result;
    if (__ring_m196._tag === "some") {
      const body_r = __ring_m196._0;
      s = body_r.subst;
      let applied_params = [];
