...
function infer_block(ctx, body, initial_subst, __ring_ev_fail) {
  __ring_match9: {
    ...
    if (__ring_m9._tag === "Block") {
      const stmts = __ring_m9.stmts; const tail = __ring_m9.tail; const span = __ring_m9.span;
      let subst = (function() {
...
function infer_stmt(ctx, stmt, subst, __ring_ev_fail) {
  __ring_match11: {
    ...
    if (__ring_m11._tag === "Let") {
      const name = __ring_m11.name; const name_span = __ring_m11.name_span; const type_annotation = __ring_m11.type_annotation; const init = __ring_m11.init; const span = __ring_m11.span;
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m11._tag === "Var") {
      ...
      let var_type = hir$hexpr_type(init_r.hexpr);
      __ring_match13: {
        const __ring_m13 = type_annotation;
        if (__ring_m13._tag === "some") {
          const ta = __ring_m13._0;
          const annotated = infer_ctx$resolve_type_expr(ctx, ta);
          s = infer_ctx$unify_at(ctx.sink, ctx.env, var_type, annotated, s, span);
          var_type = env$apply_subst(s, annotated);
      ...
      __ring_match14: {
        const __ring_m14 = var_scheme;
        if (__ring_m14._tag === "some") {
          const vs = __ring_m14._0;
          __ring_match15: {
            const __ring_m15 = vs.def_id;
            if (__ring_m15._tag === "some") {
              const did = __ring_m15._0;
              env$TypeEnv_record_def_span(ctx.env, did, name_span);
    ...
    if (__ring_m11._tag === "Return") {
      ...
      __ring_match16: {
        const __ring_m16 = value;
        if (__ring_m16._tag === "some") {
          const v = __ring_m16._0;
          const r = infer_expr(ctx, v, subst, __ring_ev_fail);
          let s = r.subst;
          __ring_match17: {
            const __ring_m17 = ctx.current_fn_return_type;
            if (__ring_m17._tag === "some") {
              const ret_type = __ring_m17._0;
        ...
        if (__ring_m16._tag === "none") {
          let s = subst;
          __ring_match18: {
            const __ring_m18 = ctx.current_fn_return_type;
            if (__ring_m18._tag === "some") {
              const ret_type = __ring_m18._0;
    ...
    if (__ring_m11._tag === "While") {
      ...
      __ring_match19: {
        const __ring_m19 = body_result;
        if (__ring_m19._tag === "some") {
          const body_r = __ring_m19._0;
          s = body_r.subst;
    ...
    if (__ring_m11._tag === "ForIn") {
      const binding = __ring_m11.binding; const binding_span = __ring_m11.binding_span; const destructure = __ring_m11.destructure; const iterable = __ring_m11.iterable; const body = __ring_m11.body; const span = __ring_m11.span;
  ...
  __match_fail(__ring_m);
              ...
              if (((name === hir$BUILTIN_MAP) && (List_len(type_params) >= 2))) {
                ...
                __ring_match21: {
                  const __ring_m21 = [List_get(type_params, 0), List_get(type_params, 1)];
                  if (Array.isArray(__ring_m21) && __ring_m21.length === 2 && __ring_m21[0]._tag === "some" && __ring_m21[1]._tag === "some") {
                    const kt = __ring_m21[0]._0; const vt = __ring_m21[1]._0;
      ...
      __ring_match22: {
        ...
        if (__ring_m22._tag === "some") {
          const destr = __ring_m22._0;
          __ring_match23: {
            const __ring_m23 = element_type;
            if (__ring_m23._tag === "TupleType") {
              const type_elems = __ring_m23.elements;
          ...
          while ((di < List_len(destr.names))) {
            __ring_match24: {
              const __ring_m24 = List_get(destr.names, di);
              if (__ring_m24._tag === "some") {
                const dname = __ring_m24._0;
  ...
  return env$TypeEnv_fresh_var(ctx.env);
      ...
      __ring_match27: {
        const __ring_m27 = binding_scheme;
        if (__ring_m27._tag === "some") {
          const bs = __ring_m27._0;
          __ring_match28: {
            const __ring_m28 = bs.def_id;
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match29: {
        const __ring_m29 = body_result;
        if (__ring_m29._tag === "some") {
          const body_r = __ring_m29._0;
          s = body_r.subst;
  ...
  __match_fail(__ring_m);
    ...
    if (__ring_m11._tag === "LetDestructure") {
      const pattern = __ring_m11.pattern; const init = __ring_m11.init; const span = __ring_m11.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      const init_type = env$apply_subst(s, hir$hexpr_type(init_r.hexpr));
      __ring_match30: {
        const __ring_m30 = init_type;
  ...
  return [];
      ...
      __ring_match31: {
        ...
        if (__ring_m31._tag === "TuplePattern") {
          const pat_elements = __ring_m31.elements;
          ...
          while ((bi < List_len(pat_elements))) {
            __ring_match32: {
              const __ring_m32 = List_get(pat_elements, bi);
              if (__ring_m32._tag === "some") {
                const p = __ring_m32._0;
  ...
  __match_fail(__ring_m);
                ...
                __ring_match33: {
                  const __ring_m33 = p;
                  if (__ring_m33._tag === "Binding") {
                    const name = __ring_m33.name; const pspan = __ring_m33.span;
                    env$TypeEnv_bind_mono(ctx.env, name, elem_type);
                    const bscheme = env$TypeEnv_lookup(ctx.env, name);
                    __ring_match34: {
                      const __ring_m34 = bscheme;
                      if (__ring_m34._tag === "some") {
                        const bs = __ring_m34._0;
                        __ring_match35: {
                          const __ring_m35 = bs.def_id;
  ...
  return infer_block(ctx, then_block, Option_some(s), __ring_ev_fail);
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match36: {
        const __ring_m36 = then_result;
        if (__ring_m36._tag === "some") {
          const then_r = __ring_m36._0;
          s = then_r.subst;
          ...
          __ring_match37: {
            ...
            if (__ring_m37._tag === "some") {
              ...
              env$TypeEnv_pop_scope(ctx.env);
              __ring_match38: {
                const __ring_m38 = else_result;
                if (__ring_m38._tag === "some") {
                  const else_r = __ring_m38._0;
                  s = else_r.subst;
...
function check_assign_target_mutable(ctx, target) {
  __ring_match39: {
    ...
    if (__ring_m39._tag === "Ident") {
      const name = __ring_m39.name; const span = __ring_m39.span;
      const scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match40: {
        const __ring_m40 = scheme;
        if (__ring_m40._tag === "some") {
          const s = __ring_m40._0;
          __ring_match41: {
            const __ring_m41 = s.def_id;
    ...
    if (__ring_m39._tag === "FieldAccess") {
      const receiver = __ring_m39.receiver; const span = __ring_m39.span;
      const root = find_root_expr(receiver);
      __ring_match42: {
        const __ring_m42 = root;
        if (__ring_m42._tag === "Ident") {
          const name = __ring_m42.name; const rspan = __ring_m42.span;
          const scheme = env$TypeEnv_lookup(ctx.env, name);
          __ring_match43: {
    ...
    if (__ring_m39._tag === "IndexExpr") {
      ...
      const root = find_root_expr(receiver);
      __ring_match45: {
        const __ring_m45 = root;
        if (__ring_m45._tag === "Ident") {
          const name = __ring_m45.name; const rspan = __ring_m45.span;
          const scheme = env$TypeEnv_lookup(ctx.env, name);
          __ring_match46: {
...
function find_root_expr(e) {
  __ring_match48: {
    ...
    if (__ring_m48._tag === "FieldAccess") {
      const receiver = __ring_m48.receiver;
      return find_root_expr(receiver);
      break __ring_match48;
    }
    if (__ring_m48._tag === "IndexExpr") {
      const receiver = __ring_m48.receiver;
      return find_root_expr(receiver);
      break __ring_match48;
    }
...
function infer_expr(ctx, expr, subst, __ring_ev_fail) {
  __ring_match49: {
    ...
    if (__ring_m49._tag === "IntLit") {
      const value = __ring_m49.value; const span = __ring_m49.span;
    ...
    if (__ring_m49._tag === "Ident") {
      const name = __ring_m49.name; const qualifier = __ring_m49.qualifier; const span = __ring_m49.span;
      return infer_ident(ctx, name, span, subst, qualifier);
      break __ring_match49;
    }
    if (__ring_m49._tag === "BinOp") {
      const op = __ring_m49.op; const left = __ring_m49.left; const right = __ring_m49.right; const span = __ring_m49.span;
      return infer_bin_op(ctx, op, left, right, span, subst, __ring_ev_fail);
      break __ring_match49;
    }
    if (__ring_m49._tag === "UnaryOp") {
      const op = __ring_m49.op; const operand = __ring_m49.operand; const span = __ring_m49.span;
      return infer_unary_op(ctx, op, operand, span, subst, __ring_ev_fail);
      break __ring_match49;
    }
    if (__ring_m49._tag === "Call") {
      const callee = __ring_m49.callee; const args = __ring_m49.args; const span = __ring_m49.span;
      return infer_call(ctx, callee, args, span, subst, __ring_ev_fail);
      break __ring_match49;
    }
    if (__ring_m49._tag === "MethodCall") {
      const receiver = __ring_m49.receiver; const method = __ring_m49.method; const args = __ring_m49.args; const span = __ring_m49.span;
      return infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail);
      break __ring_match49;
    }
    if (__ring_m49._tag === "FieldAccess") {
      const receiver = __ring_m49.receiver; const field = __ring_m49.field; const span = __ring_m49.span;
      return infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail);
      break __ring_match49;
    }
    if (__ring_m49._tag === "StructLit") {
      const name = __ring_m49.name; const qualifier = __ring_m49.qualifier; const fields = __ring_m49.fields; const spread = __ring_m49.spread; const span = __ring_m49.span;
      return infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail);
      break __ring_match49;
    }
    if (__ring_m49._tag === "MatchExpr") {
      const scrutinee = __ring_m49.scrutinee; const arms = __ring_m49.arms; const span = __ring_m49.span;
    ...
    if (__ring_m49._tag === "IfExpr") {
      const condition = __ring_m49.condition; const then_branch = __ring_m49.then_branch; const else_branch = __ring_m49.else_branch; const span = __ring_m49.span;
      return infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail);
      break __ring_match49;
    }
    if (__ring_m49._tag === "StringInterp") {
      const parts = __ring_m49.parts; const span = __ring_m49.span;
      return infer_string_interp(ctx, parts, span, subst, __ring_ev_fail);
      break __ring_match49;
    }
    if (__ring_m49._tag === "CatchExpr") {
      const catch_expr = __ring_m49.expr; const arms = __ring_m49.arms; const span = __ring_m49.span;
      return infer_catch(ctx, catch_expr, arms, span, subst, __ring_ev_fail);
      break __ring_match49;
    }
    if (__ring_m49._tag === "HandleExpr") {
      const body = __ring_m49.body; const handlers = __ring_m49.handlers; const span = __ring_m49.span;
      return infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail);
      break __ring_match49;
    }
    if (__ring_m49._tag === "Lambda") {
      const params = __ring_m49.params; const body = __ring_m49.body; const span = __ring_m49.span;
      return infer_lambda(ctx, params, body, span, subst, Option_none, __ring_ev_fail);
      break __ring_match49;
    }
    if (__ring_m49._tag === "ListLit") {
      const elements = __ring_m49.elements; const span = __ring_m49.span;
    ...
    if (__ring_m49._tag === "Range") {
      const start = __ring_m49.start; const end = __ring_m49.end; const inclusive = __ring_m49.inclusive; const span = __ring_m49.span;
    ...
    if (__ring_m49._tag === "IndexExpr") {
      const receiver = __ring_m49.receiver; const index = __ring_m49.index; const span = __ring_m49.span;
...
function infer_ident(ctx, name, span, subst, qualifier) {
  ...
  __ring_match51: {
    const __ring_m51 = qualifier;
    if (__ring_m51._tag === "some") {
      const q = __ring_m51._0;
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match52: {
          const __ring_m52 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m52._tag === "some") {
            const prefix = __ring_m52._0;
            if ((prefix === "")) {
      ...
      __ring_match54: {
        ...
        if (__ring_m54._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match55: {
              const __ring_m55 = full_scheme;
              if (__ring_m55._tag === "some") {
                const fs = __ring_m55._0;
  ...
  __ring_match56: {
    ...
    if (__ring_m56._tag === "some") {
      ...
      __ring_match58: {
        const __ring_m58 = s.def_id;
        if (__ring_m58._tag === "some") {
          const did = __ring_m58._0;
          if (_Set_contains(ctx.env.scope.mutable_vars, did, __Int_Eq)) {
            __ring_match59: {
              const __ring_m59 = _Map_get(ctx.var_lambda_depth, did);
              if (__ring_m59._tag === "some") {
                const def_depth = __ring_m59._0;
  ...
  __match_fail(__ring_m);
      ...
      __ring_match60: {
        const __ring_m60 = resolved_qualifier;
      ...
      __ring_match62: {
        const __ring_m62 = enum_name;
        if (__ring_m62._tag === "some") {
          const en = __ring_m62._0;
...
function is_primitive_ord(t) {
  __ring_match67: {
    ...
    if (__ring_m67._tag === "FloatType") {
      return true;
      break __ring_match67;
    }
    if (__ring_m67._tag === "StrType") {
      return true;
      break __ring_match67;
    }
...
function resolve_trait_dispatch(ctx, resolved, trait_name, error_code, subst, span, op, is_builtin) {
  ...
  __ring_match70: {
    const __ring_m70 = bound_resolved;
    if (__ring_m70._tag === "TypeVar") {
      const bid = __ring_m70.id;
      return (bid === id);
    ...
    break __ring_match70;
      ...
      __ring_match72: {
        const __ring_m72 = _Map_get(ctx.env.scope.var_bounds, id);
        if (__ring_m72._tag === "some") {
          const var_bounds = __ring_m72._0;
    ...
    if (__ring_m69._tag === "StructType") {
      const name = __ring_m69.name; const type_params = __ring_m69.type_params;
...
function resolve_trait_extra_dicts(ctx, type_args, subst, trait_name) {
  ...
  for (const arg of type_args) {
    ...
    __ring_match73: {
      const __ring_m73 = dict;
      if (__ring_m73._tag === "some") {
        const d = __ring_m73._0;
        List_push(dicts, d);
...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match80: {
    const __ring_m80 = expected;
    if (__ring_m80._tag === "FnType") {
      const exp_params = __ring_m80.params;
  ...
  __ring_match81: {
    const __ring_m81 = resolved_callee_type;
    if (__ring_m81._tag === "FnType") {
      const fn_effects = __ring_m81.effects;
  ...
  __ring_match82: {
    ...
    if (__ring_m82._tag === "Ident") {
      const callee_name = __ring_m82.name;
      __ring_match83: {
        const __ring_m83 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m83._tag === "some") {
          const callee_scheme = __ring_m83._0;
  ...
  __ring_match84: {
    const __ring_m84 = callee;
    if (__ring_m84._tag === "Ident") {
      const callee_name = __ring_m84.name;
      __ring_match85: {
        const __ring_m85 = _Map_get(ctx.fn_mut_params, callee_name);
        if (__ring_m85._tag === "some") {
          const mut_flags = __ring_m85._0;
          let mi = 0;
          while (((mi < List_len(mut_flags)) && (mi < List_len(args)))) {
            __ring_match86: {
              const __ring_m86 = [List_get(mut_flags, mi), List_get(hargs, mi)];
              if (Array.isArray(__ring_m86) && __ring_m86.length === 2 && __ring_m86[0]._tag === "some" && __ring_m86[1]._tag === "some") {
                const is_mut = __ring_m86[0]._0; const harg = __ring_m86[1]._0;
                if (is_mut) {
                  __ring_match87: {
                    const __ring_m87 = harg;
                    if (__ring_m87._tag === "Ident" && __ring_m87.def_id._tag === "some") {
                      const arg_did = __ring_m87.def_id._0;
                      if (_Set_contains(ctx.env.scope.mutable_vars, arg_did, __Int_Eq)) {
                        __ring_match88: {
                          const __ring_m88 = resolved_callee_type;
                          if (__ring_m88._tag === "FnType") {
                            const fn_params = __ring_m88.params;
                            __ring_match89: {
                              const __ring_m89 = List_get(fn_params, mi);
                              if (__ring_m89._tag === "some") {
                                const pt = __ring_m89._0;
...
function resolve_arg_dict_closure(ctx, harg, s) {
  __ring_match90: {
    const __ring_m90 = harg;
    if (__ring_m90._tag === "Ident") {
      const name = __ring_m90.name; const resolved_name = __ring_m90.resolved_name; const def_id = __ring_m90.def_id; const ty = __ring_m90.ty; const effects = __ring_m90.effects; const span = __ring_m90.span;
      const arg_scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match91: {
        const __ring_m91 = arg_scheme;
        if (__ring_m91._tag === "some") {
          const as_ = __ring_m91._0;
          ...
          for (const bound of as_.bounds) {
            __ring_match92: {
              const __ring_m92 = _Map_get(var_map, bound.type_var);
              if (__ring_m92._tag === "some") {
                const fresh_var = __ring_m92._0;
...
function resolve_arg_bound_dict(ctx, concrete, trait_name, dicts) {
  __ring_match93: {
    const __ring_m93 = concrete;
    if (__ring_m93._tag === "StructType") {
    ...
    if (__ring_m93._tag === "TypeVar") {
      ...
      __ring_match94: {
        const __ring_m94 = matching;
        if (__ring_m94._tag === "some") {
          const fb = __ring_m94._0;
    ...
    __ring_match95: {
      const __ring_m95 = types$type_to_builtin_name(concrete);
      if (__ring_m95._tag === "some") {
        const prim_name = __ring_m95._0;
...
function check_expr_is_let_def(ctx, expr) {
  __ring_match96: {
    const __ring_m96 = expr;
    if (__ring_m96._tag === "Ident") {
      const name = __ring_m96.name;
      __ring_match97: {
        const __ring_m97 = env$TypeEnv_lookup(ctx.env, name);
        if (__ring_m97._tag === "some") {
          const s = __ring_m97._0;
          __ring_match98: {
            const __ring_m98 = s.def_id;
            if (__ring_m98._tag === "some") {
              const did = __ring_m98._0;
    ...
    if (__ring_m96._tag === "FieldAccess") {
      const inner = __ring_m96.receiver;
...
function get_expr_def_id(ctx, expr) {
  __ring_match99: {
    const __ring_m99 = expr;
    if (__ring_m99._tag === "Ident") {
      const name = __ring_m99.name;
      __ring_match100: {
        const __ring_m100 = env$TypeEnv_lookup(ctx.env, name);
...
function is_mut_method_call(ctx, recv_type, method) {
  ...
  __ring_match101: {
    ...
    __ring_match102: {
      const __ring_m102 = types$type_to_builtin_name(recv_type);
      if (__ring_m102._tag === "some") {
        const n = __ring_m102._0;
  ...
  __ring_match103: {
    const __ring_m103 = type_name;
    if (__ring_m103._tag === "some") {
      const tname = __ring_m103._0;
      __ring_match104: {
        const __ring_m104 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m104._tag === "some") {
          const mut_set = __ring_m104._0;
...
function check_receiver_mutability(ctx, receiver, recv_type, method, span) {
  let type_name = Option_none;
  __ring_match105: {
    const __ring_m105 = recv_type;
    if (__ring_m105._tag === "StructType") {
      const name = __ring_m105.name;
      type_name = Option_some(name);
      break __ring_match105;
    }
    if (__ring_m105._tag === "EnumType") {
      const name = __ring_m105.name;
      type_name = Option_some(name);
      break __ring_match105;
    }
    __ring_match106: {
      const __ring_m106 = types$type_to_builtin_name(recv_type);
      if (__ring_m106._tag === "some") {
        const n = __ring_m106._0;
        type_name = Option_some(n);
  ...
  __ring_match107: {
    const __ring_m107 = type_name;
    if (__ring_m107._tag === "some") {
      const tname = __ring_m107._0;
      __ring_match108: {
        const __ring_m108 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m108._tag === "some") {
          const mut_set = __ring_m108._0;
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match109: {
    const __ring_m109 = receiver;
    if (__ring_m109._tag === "Ident") {
      const recv_name = __ring_m109.name; const qualifier = __ring_m109.qualifier;
  ...
  __match_fail(__ring_m);
      ...
      __ring_match110: {
        const __ring_m110 = _Map_get(ctx.env.types.effects, full_effect_name);
  ...
  if (is_mut_method_call(ctx, recv_type, method)) {
    __ring_match111: {
      const __ring_m111 = get_expr_def_id(ctx, receiver);
      if (__ring_m111._tag === "some") {
        const did = __ring_m111._0;
  ...
  __ring_match112: {
    const __ring_m112 = recv_type;
    if (__ring_m112._tag === "StructType") {
      const name = __ring_m112.name;
      const r = lookup_impl_method(ctx, name, method);
      method_type = r.method_type;
      method_scheme = r.method_scheme;
      break __ring_match112;
    }
    if (__ring_m112._tag === "EnumType") {
      const name = __ring_m112.name;
      const r = lookup_impl_method(ctx, name, method);
      method_type = r.method_type;
      method_scheme = r.method_scheme;
  ...
  if (Option_is_none(method_type)) {
    __ring_match113: {
      ...
      if (__ring_m113._tag === "some") {
        const prim_name = __ring_m113._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match114: {
      const __ring_m114 = types$type_to_builtin_name(recv_type);
      if (__ring_m114._tag === "some") {
        const type_name = __ring_m114._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match115: {
      const __ring_m115 = recv_var_id;
      if (__ring_m115._tag === "some") {
        const rvid = __ring_m115._0;
        for (const fb of ctx.current_fn_bounds) {
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match116: {
              const __ring_m116 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m116._tag === "some") {
                const trait_def = __ring_m116._0;
                ...
                __ring_match117: {
                  const __ring_m117 = tm;
                  if (__ring_m117._tag === "some") {
                    const found_method = __ring_m117._0;
  ...
  __ring_match118: {
    const __ring_m118 = method_type;
    if (__ring_m118._tag === "some") {
      const mt = __ring_m118._0;
      __ring_match119: {
        const __ring_m119 = mt;
        if (__ring_m119._tag === "FnType") {
          const mt_params = __ring_m119.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match120: {
              const __ring_m120 = List_first(mt_params);
              if (__ring_m120._tag === "some") {
                const first_param = __ring_m120._0;
  ...
  const expected = env$apply_subst(s, expected_raw);
  __ring_match121: {
    const __ring_m121 = expected;
    if (__ring_m121._tag === "FnType") {
      const exp_params = __ring_m121.params;
      return infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
  ...
  __ring_match122: {
    const __ring_m122 = method_type;
    if (__ring_m122._tag === "some") {
      const mt = __ring_m122._0;
      __ring_match123: {
        const __ring_m123 = mt;
        if (__ring_m123._tag === "FnType") {
          const mt_params = __ring_m123.params; const mt_ret = __ring_m123.return_type; const mt_effects = __ring_m123.effects;
          let i = 0;
          for (const harg of hargs) {
            if (((i + 1) < List_len(mt_params))) {
              __ring_match124: {
                const __ring_m124 = List_get(mt_params, (i + 1));
                if (__ring_m124._tag === "some") {
                  const expected_param = __ring_m124._0;
  ...
  let resolved_dicts = [];
  __ring_match127: {
    const __ring_m127 = method_scheme;
    if (__ring_m127._tag === "some") {
      const ms = __ring_m127._0;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match129: {
    const __ring_m129 = _Map_get(ctx.env.trait_reg.impl_methods, type_name);
    if (__ring_m129._tag === "some") {
      const impl_methods = __ring_m129._0;
      __ring_match130: {
        const __ring_m130 = _Map_get(impl_methods, method);
        if (__ring_m130._tag === "some") {
          const scheme = __ring_m130._0;
...
function lookup_trait_method(ctx, type_name, method, span) {
  ...
  for (const impl_entry of ctx.env.trait_reg.trait_impls) {
    if ((impl_entry.target_type_name === type_name)) {
      __ring_match131: {
        const __ring_m131 = _Map_get(ctx.env.trait_reg.traits, impl_entry.trait_name);
        if (__ring_m131._tag === "some") {
          const trait_def = __ring_m131._0;
          const tm = ((__a) => { const __i = __a.findIndex((function(m) { return (m.name === method); })); return __i >= 0 ? { _tag: "some", _0: __a[__i] } : { _tag: "none" }; })(trait_def.methods);
          __ring_match132: {
            const __ring_m132 = tm;
            if (__ring_m132._tag === "some") {
              const found_method = __ring_m132._0;
              __ring_match133: {
                const __ring_m133 = found_trait_name;
                if (__ring_m133._tag === "some") {
                  const prev_trait = __ring_m133._0;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match134: {
    const __ring_m134 = effect_def_opt;
  ...
  for (const arg of args) {
    ...
    List_push(hargs, ar.hexpr);
    __ring_match136: {
      const __ring_m136 = List_get(inst_params, i);
      if (__ring_m136._tag === "some") {
        const param_type = __ring_m136._0;
  ...
  __ring_match137: {
    const __ring_m137 = effect_def.built_in_kind;
    if (__ring_m137._tag === "some") {
      const bik = __ring_m137._0;
      __ring_match138: {
        const __ring_m138 = bik;
        if (__ring_m138._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match138;
        }
        if (__ring_m138._tag === "BkFail") {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match139: {
    ...
    if (__ring_m139._tag === "StructType") {
      ...
      __ring_match140: {
        const __ring_m140 = _Map_get(ctx.env.types.structs, name);
        if (__ring_m140._tag === "some") {
          const struct_def = __ring_m140._0;
          ...
          __ring_match141: {
            ...
            if (__ring_m141._tag === "some") {
              const found_field = __ring_m141._0;
              let inst_map = map_new();
              let fi = 0;
              while (((fi < List_len(struct_def.type_param_vars)) && (fi < List_len(type_params)))) {
                __ring_match142: {
                  const __ring_m142 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m142) && __ring_m142.length === 2 && __ring_m142[0]._tag === "some" && __ring_m142[1]._tag === "some") {
                    const var_id = __ring_m142[0]._0; const tp = __ring_m142[1]._0;
    ...
    if (__ring_m139._tag === "RecordType") {
      const rec_fields = __ring_m139.fields; const tail = __ring_m139.tail;
    ...
    if (__ring_m139._tag === "TupleType") {
      ...
      __ring_match145: {
        const __ring_m145 = parse_int(field);
        ...
        if (__ring_m145._tag === "some") {
          ...
          __ring_match146: {
            const __ring_m146 = List_get(elements, i);
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  let resolved_qualifier = qualifier;
  __ring_match147: {
    const __ring_m147 = qualifier;
    if (__ring_m147._tag === "some") {
      const q = __ring_m147._0;
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match148: {
          const __ring_m148 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m148._tag === "some") {
            const prefix = __ring_m148._0;
            if ((prefix === "")) {
              resolved_qualifier = Option_none;
            } else {
              resolved_qualifier = Option_some(prefix);
  ...
  __ring_match149: {
    const __ring_m149 = resolved_qualifier;
    if (__ring_m149._tag === "some") {
      const q = __ring_m149._0;
      const qualified_name = `${q}::${name}`;
      const mod_struct = _Map_get(ctx.env.types.structs, qualified_name);
      __ring_match150: {
        const __ring_m150 = mod_struct;
  ...
  __ring_match152: {
    const __ring_m152 = resolved_qualifier;
    if (__ring_m152._tag === "some") {
      const q = __ring_m152._0;
      __ring_match153: {
        const __ring_m153 = _Map_get(ctx.env.types.enums, q);
        if (__ring_m153._tag === "some") {
          const enum_def = __ring_m153._0;
          if (enum_def.variants.some((function(v) { return (v.name === name); }))) {
        ...
        if (__ring_m153._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match154: {
              const __ring_m154 = _Map_get(ctx.env.types.enums, full_q);
              if (__ring_m154._tag === "some") {
                const enum_def = __ring_m154._0;
                if (enum_def.variants.some((function(v) { return (v.name === name); }))) {
                  variant_enum = Option_some(enum_def.name);
                }
  ...
  __ring_match156: {
    const __ring_m156 = variant_enum;
    if (__ring_m156._tag === "some") {
      const ve = __ring_m156._0;
      __ring_match157: {
        const __ring_m157 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m157._tag === "some") {
          const enum_def = __ring_m157._0;
          ...
          __ring_match158: {
            const __ring_m158 = variant;
            if (__ring_m158._tag === "some") {
              const v = __ring_m158._0;
              __ring_match159: {
                const __ring_m159 = v.field_names;
  ...
  __ring_match160: {
    const __ring_m160 = struct_def_opt;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match161: {
      const __ring_m161 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m161._tag === "some") {
        const var_id = __ring_m161._0;
  ...
  __ring_match162: {
    const __ring_m162 = spread;
    if (__ring_m162._tag === "some") {
      const sp = __ring_m162._0;
  ...
  for (const field of fields) {
    ...
    __ring_match163: {
      const __ring_m163 = def_field;
      if (__ring_m163._tag === "some") {
        const df = __ring_m163._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  ...
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match164: {
      const __ring_m164 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m164._tag === "some") {
        const var_id = __ring_m164._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  let hspread = Option_none;
  __ring_match165: {
    const __ring_m165 = spread;
    if (__ring_m165._tag === "some") {
      const sp = __ring_m165._0;
      const sr = infer_expr(ctx, sp, s, __ring_ev_fail);
      s = sr.subst;
      const me = infer_ctx$merge_effects(ctx.env, effects, sr.effects, s, __ring_ev_fail);
      effects = me[0];
  ...
  for (const field of fields) {
    ...
    __ring_match166: {
      const __ring_m166 = field_idx;
      if (__ring_m166._tag === "some") {
        const idx = __ring_m166._0;
        __ring_match167: {
          const __ring_m167 = List_get(variant.fields, idx);
          if (__ring_m167._tag === "some") {
            const ftype = __ring_m167._0;
...
function rewrite_bare_enum_bindings(env, pattern) {
  __ring_match168: {
    const __ring_m168 = pattern;
    if (__ring_m168._tag === "Binding") {
      const name = __ring_m168.name; const span = __ring_m168.span;
      __ring_match169: {
        const __ring_m169 = _Map_get(env.types.variant_to_enum, name);
        if (__ring_m169._tag === "some") {
          const ve = __ring_m169._0;
          __ring_match170: {
            const __ring_m170 = _Map_get(env.types.enums, ve);
            if (__ring_m170._tag === "some") {
              const edef = __ring_m170._0;
    ...
    if (__ring_m168._tag === "TuplePattern") {
      const elements = __ring_m168.elements; const span = __ring_m168.span;
      let new_elems = [];
    ...
    if (__ring_m168._tag === "Constructor") {
      const name = __ring_m168.name; const qualifier = __ring_m168.qualifier; const fields = __ring_m168.fields; const span = __ring_m168.span;
      let new_fields = [];
      for (const f of fields) {
    ...
    if (__ring_m168._tag === "NamedConstructor") {
      const name = __ring_m168.name; const qualifier = __ring_m168.qualifier; const fields = __ring_m168.fields; const rest = __ring_m168.rest; const span = __ring_m168.span;
      let new_fields = [];
      for (const f of fields) {
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match172: {
    const __ring_m172 = arm.guard;
    if (__ring_m172._tag === "some") {
      const g = __ring_m172._0;
  ...
  __ring_match174: {
    const __ring_m174 = missing;
    if (__ring_m174._tag === "some") {
      const m = __ring_m174._0;
    ...
    if (__ring_m175._tag === "some") {
      ...
      __ring_match176: {
        ...
        if (__ring_m176._tag === "IfExpr") {
          const ec = __ring_m176.condition; const etb = __ring_m176.then_branch; const eeb = __ring_m176.else_branch; const espan = __ring_m176.span;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  for (const part of parts) {
    __ring_match177: {
      const __ring_m177 = part;
      if (__ring_m177._tag === "LitPart") {
        const str_val = __ring_m177._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match177;
      }
      if (__ring_m177._tag === "ExprPart") {
        const expr = __ring_m177._0;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  for (const eff of effects.effects) {
    __ring_match178: {
      const __ring_m178 = eff;
      if (__ring_m178._tag === "FailEffect") {
        const et = __ring_m178.error_type;
        if (found_fail) {
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  for (const handler of handlers) {
    ...
    __ring_match182: {
      const __ring_m182 = effect_def;
      if (__ring_m182._tag === "some") {
        const ed = __ring_m182._0;
    ...
    __ring_match183: {
      const __ring_m183 = effect_def;
      if (__ring_m183._tag === "some") {
        const ed = __ring_m183._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match184: {
      const __ring_m184 = handler.resume_name;
      if (__ring_m184._tag === "some") {
        const rn = __ring_m184._0;
  ...
  __match_fail(__ring_m);
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match185: {
      const __ring_m185 = handler_body_result;
      if (__ring_m185._tag === "some") {
        const hbr = __ring_m185._0;
        s = hbr.subst;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match186: {
      const __ring_m186 = expected_param_types;
      if (__ring_m186._tag === "some") {
        const epts = __ring_m186._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match187: {
            const __ring_m187 = List_get(epts, pi);
            if (__ring_m187._tag === "some") {
              const expected_t = __ring_m187._0;
    ...
    __ring_match188: {
      const __ring_m188 = lam_scheme;
      if (__ring_m188._tag === "some") {
        const ls = __ring_m188._0;
        __ring_match189: {
          const __ring_m189 = ls.def_id;
          if (__ring_m189._tag === "some") {
            const did = __ring_m189._0;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match190: {
    const __ring_m190 = body_result;
    if (__ring_m190._tag === "some") {
      const body_r = __ring_m190._0;
      s = body_r.subst;
      let applied_params = [];
