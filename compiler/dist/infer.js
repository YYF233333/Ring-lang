...
function resolve_arg_bound_dict(ctx, concrete, trait_name, dicts) {
  __ring_match31: {
    ...
    __ring_match33: {
      const __ring_m33 = types$type_to_builtin_name(concrete);
      if (__ring_m33._tag === "some") {
        const prim_name = __ring_m33._0;
...
function resolve_arg_dict_closure(ctx, harg, s) {
  __ring_match34: {
    const __ring_m34 = harg;
    if (__ring_m34._tag === "Ident") {
      const name = __ring_m34.name; const resolved_name = __ring_m34.resolved_name; const def_id = __ring_m34.def_id; const ty = __ring_m34.ty; const effects = __ring_m34.effects; const span = __ring_m34.span;
      const arg_scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match35: {
        const __ring_m35 = arg_scheme;
        if (__ring_m35._tag === "some") {
          const as_ = __ring_m35._0;
...
function infer_ident(ctx, name, span, subst, qualifier) {
  ...
  __ring_match37: {
    const __ring_m37 = qualifier;
    if (__ring_m37._tag === "some") {
      const q = __ring_m37._0;
      if (((q === "self") ? true : Str_starts_with(q, "super"))) {
        __ring_match38: {
          const __ring_m38 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m38._tag === "some") {
            const prefix = __ring_m38._0;
            if ((prefix === "")) {
  ...
  __ring_match39: {
    ...
    if (__ring_m39._tag === "some") {
      ...
      __ring_match40: {
        const __ring_m40 = mod_scheme;
        if (__ring_m40._tag === "some") {
          const ms = __ring_m40._0;
        ...
        if (__ring_m40._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match41: {
              const __ring_m41 = full_scheme;
              if (__ring_m41._tag === "some") {
                const fs = __ring_m41._0;
  ...
  __ring_match42: {
    ...
    if (__ring_m42._tag === "some") {
      ...
      __ring_match44: {
        const __ring_m44 = s.def_id;
        if (__ring_m44._tag === "some") {
          const did = __ring_m44._0;
          if (_Set_contains(ctx.env.scope.mutable_vars, did, __Int_Eq)) {
            __ring_match45: {
              const __ring_m45 = _Map_get(ctx.var_lambda_depth, did);
              if (__ring_m45._tag === "some") {
                const def_depth = __ring_m45._0;
      ...
      let __ring_blk1;
      __ring_match46: {
        const __ring_m46 = _Map_get(ctx.use_aliases, name);
        if (__ring_m46._tag === "some") {
          const qualified = __ring_m46._0;
      ...
      __ring_match47: {
        ...
        if (__ring_m47._tag === "some") {
          ...
          __ring_match48: {
            const __ring_m48 = _Map_get(ctx.env.types.enums, q);
      ...
      __ring_match49: {
        const __ring_m49 = enum_name;
        if (__ring_m49._tag === "some") {
          const en = __ring_m49._0;
...
function rewrite_bare_enum_bindings(env, pattern) {
  __ring_match50: {
    const __ring_m50 = pattern;
    if (__ring_m50._tag === "Binding") {
      const name = __ring_m50.name; const span = __ring_m50.span;
      __ring_match51: {
        const __ring_m51 = _Map_get(env.types.variant_to_enum, name);
        if (__ring_m51._tag === "some") {
          const ve = __ring_m51._0;
          __ring_match52: {
            const __ring_m52 = _Map_get(env.types.enums, ve);
            if (__ring_m52._tag === "some") {
              const edef = __ring_m52._0;
              const v = env$lookup_variant(edef, name);
              __ring_match53: {
                const __ring_m53 = v;
                if (__ring_m53._tag === "some") {
                  const found_v = __ring_m53._0;
    ...
    if (__ring_m50._tag === "TuplePattern") {
      const elements = __ring_m50.elements; const span = __ring_m50.span;
      let new_elems = [];
      ...
      while (true) {
        ...
        const elem = __ring_next_4._0;
        List_push(new_elems, rewrite_bare_enum_bindings(env, elem));
      }
      return ast$Pattern_TuplePattern(new_elems, span);
      break __ring_match50;
    }
    if (__ring_m50._tag === "Constructor") {
      const name = __ring_m50.name; const qualifier = __ring_m50.qualifier; const fields = __ring_m50.fields; const span = __ring_m50.span;
      let new_fields = [];
    ...
    if (__ring_m50._tag === "NamedConstructor") {
      const name = __ring_m50.name; const qualifier = __ring_m50.qualifier; const fields = __ring_m50.fields; const rest = __ring_m50.rest; const span = __ring_m50.span;
      let new_fields = [];
    ...
    if (__ring_m50._tag === "OrPattern") {
      const patterns = __ring_m50.patterns; const span = __ring_m50.span;
      let new_pats = [];
      const __ring_iter_7 = __List_Iterable.iter(patterns);
      while (true) {
...
function is_mut_method_call(ctx, recv_type, method) {
  let type_name = Option_none;
  __ring_match54: {
    const __ring_m54 = recv_type;
    if (__ring_m54._tag === "StructType") {
      const name = __ring_m54.name;
      type_name = Option_some(name);
      break __ring_match54;
    }
    if (__ring_m54._tag === "EnumType") {
      const name = __ring_m54.name;
      type_name = Option_some(name);
      break __ring_match54;
    }
    __ring_match55: {
      const __ring_m55 = types$type_to_builtin_name(recv_type);
      if (__ring_m55._tag === "some") {
        const n = __ring_m55._0;
        type_name = Option_some(n);
  ...
  __ring_match56: {
    const __ring_m56 = type_name;
    if (__ring_m56._tag === "some") {
      const tname = __ring_m56._0;
      __ring_match57: {
        const __ring_m57 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m57._tag === "some") {
          const mut_set = __ring_m57._0;
...
function resolve_var_id(id, sub) {
  __ring_match64: {
    const __ring_m64 = union_find$uf_lookup(sub, id);
    if (__ring_m64._tag === "some") {
      const resolved = __ring_m64._0;
      __ring_match65: {
        const __ring_m65 = resolved;
        if (__ring_m65._tag === "TypeVar") {
          const new_id = __ring_m65.id;
...
function is_primitive_ord(t) {
  __ring_match69: {
    ...
    if (__ring_m69._tag === "StrType") {
      return true;
      break __ring_match69;
    }
    if (__ring_m69._tag === "BoolType") {
      return true;
      break __ring_match69;
    }
    return false;
...
function resolve_type_to_dict_ref(ctx, t, subst, trait_name) {
  __ring_match71: {
    const __ring_m71 = types$type_to_builtin_name(t);
    if (__ring_m71._tag === "some") {
      const builtin_name = __ring_m71._0;
      __ring_match72: {
        const __ring_m72 = t;
  ...
  __ring_match73: {
    ...
    if (__ring_m73._tag === "TypeVar") {
      ...
      __ring_match74: {
        const __ring_m74 = bound;
        if (__ring_m74._tag === "some") {
          const b = __ring_m74._0;
    ...
    if (__ring_m73._tag === "StructType") {
      const name = __ring_m73.name; const type_params = __ring_m73.type_params;
      if (env$has_impl(ctx.env.trait_reg, name, trait_name)) {
    ...
    if (__ring_m73._tag === "EnumType") {
      ...
      if (env$has_impl(ctx.env.trait_reg, name, trait_name)) {
        if ((List_len(type_params) > 0)) {
          const inner = resolve_trait_extra_dicts(ctx, type_params, subst, trait_name);
          __ring_match76: {
            const __ring_m76 = inner;
            if (__ring_m76._tag === "some") {
              const inner_dicts = __ring_m76._0;
              return Option_some(hir$DictRef_Wrapped(hir$trait_dict_name(name, trait_name), trait_name, inner_dicts));
...
function resolve_trait_extra_dicts(ctx, type_args, subst, trait_name) {
  ...
  while (true) {
    ...
    __ring_match77: {
      const __ring_m77 = dict;
      if (__ring_m77._tag === "some") {
        const d = __ring_m77._0;
        List_push(dicts, d);
...
function resolve_trait_dispatch(ctx, resolved, trait_name, error_code, subst, span, op, is_builtin) {
  ...
  __ring_match78: {
    const __ring_m78 = resolved;
    if (__ring_m78._tag === "TypeVar") {
      const id = __ring_m78.id;
  ...
  __ring_match79: {
    const __ring_m79 = bound_resolved;
    if (__ring_m79._tag === "TypeVar") {
      const bid = __ring_m79.id;
      return (bid === id);
    ...
    break __ring_match79;
      ...
      __ring_match80: {
        const __ring_m80 = bound;
        if (__ring_m80._tag === "some") {
          const b = __ring_m80._0;
      ...
      __ring_match81: {
        const __ring_m81 = _Map_get(ctx.env.scope.var_bounds, id);
        if (__ring_m81._tag === "some") {
          const var_bounds = __ring_m81._0;
    ...
    if (__ring_m78._tag === "StructType") {
      const name = __ring_m78.name; const type_params = __ring_m78.type_params;
      if (env$has_impl(ctx.env.trait_reg, name, trait_name)) {
    ...
    if (__ring_m78._tag === "EnumType") {
      const name = __ring_m78.name; const type_params = __ring_m78.type_params;
      if (env$has_impl(ctx.env.trait_reg, name, trait_name)) {
        const extra_dicts = resolve_trait_extra_dicts(ctx, type_params, subst, trait_name);
        let __ring_blk3;
        __ring_match83: {
          const __ring_m83 = extra_dicts;
          if (__ring_m83._tag === "some") {
            const d = __ring_m83._0;
            __ring_blk3 = d;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  let __ring_blk4;
  __ring_match86: {
    const __ring_m86 = variant.field_names;
    if (__ring_m86._tag === "some") {
      const fn_ = __ring_m86._0;
      __ring_blk4 = fn_;
  ...
  const field_names = __ring_blk4;
  let inst_map = map_new();
  let type_param_types = [];
  let tpi = 0;
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match87: {
      const __ring_m87 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m87._tag === "some") {
        const var_id = __ring_m87._0;
  ...
  __ring_match88: {
    const __ring_m88 = spread;
    if (__ring_m88._tag === "some") {
      const sp = __ring_m88._0;
  ...
  while (true) {
    ...
    __ring_match89: {
      const __ring_m89 = field_idx;
      if (__ring_m89._tag === "some") {
        const idx = __ring_m89._0;
        __ring_match90: {
          const __ring_m90 = List_get(variant.fields, idx);
          if (__ring_m90._tag === "some") {
            const ftype = __ring_m90._0;
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  ...
  __ring_match91: {
    ...
    if (__ring_m91._tag === "some") {
      ...
      if (((q === "self") ? true : Str_starts_with(q, "super"))) {
        __ring_match92: {
          const __ring_m92 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m92._tag === "some") {
            const prefix = __ring_m92._0;
            if ((prefix === "")) {
              resolved_qualifier = Option_none;
            } else {
              resolved_qualifier = Option_some(prefix);
  ...
  __ring_match96: {
    ...
    if (__ring_m96._tag === "some") {
      ...
      __ring_match97: {
        const __ring_m97 = _Map_get(ctx.env.types.enums, q);
        if (__ring_m97._tag === "some") {
          const enum_def = __ring_m97._0;
          if (_Map_contains_key(enum_def.variant_index, name)) {
        ...
        if (__ring_m97._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match98: {
              const __ring_m98 = _Map_get(ctx.env.types.enums, full_q);
              if (__ring_m98._tag === "some") {
                const enum_def = __ring_m98._0;
                if (_Map_contains_key(enum_def.variant_index, name)) {
                  variant_enum = Option_some(enum_def.name);
                }
  ...
  __ring_match104: {
    const __ring_m104 = struct_def_opt;
  ...
  let __ring_blk5;
  __ring_match105: {
    const __ring_m105 = struct_def_opt;
    if (__ring_m105._tag === "some") {
      const sd = __ring_m105._0;
      __ring_blk5 = sd;
      break __ring_match105;
    }
    if (__ring_m105._tag === "none") {
      __ring_blk5 = panic("unreachable: struct_def_opt after none early return");
      break __ring_match105;
    }
    __match_fail(__ring_m105);
  }
  const struct_def = __ring_blk5;
  let inst_map = map_new();
  let type_param_types = [];
  let tpi = 0;
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match106: {
      const __ring_m106 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m106._tag === "some") {
        const var_id = __ring_m106._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  let hspread = Option_none;
  __ring_match107: {
    const __ring_m107 = spread;
    if (__ring_m107._tag === "some") {
      const sp = __ring_m107._0;
      const sr = infer_expr(ctx, sp, s, __ring_ev_fail);
      s = sr.subst;
      const me = infer_ctx$merge_effects(ctx.env, effects, sr.effects, s, __ring_ev_fail);
      effects = me[0];
      s = me[1];
      let spread_fields = [];
      const __ring_iter_14 = __List_Iterable.iter(struct_def.fields);
      while (true) {
  ...
  while (true) {
    ...
    __ring_match108: {
      const __ring_m108 = def_field;
      if (__ring_m108._tag === "some") {
        const df = __ring_m108._0;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  while (true) {
    ...
    __ring_match109: {
      const __ring_m109 = part;
      if (__ring_m109._tag === "LitPart") {
        const str_val = __ring_m109._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match109;
      }
      if (__ring_m109._tag === "ExprPart") {
        const expr = __ring_m109._0;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match110: {
    const __ring_m110 = effect_def_opt;
  ...
  let __ring_blk6;
  __ring_match111: {
    const __ring_m111 = effect_def_opt;
    if (__ring_m111._tag === "some") {
      const ed = __ring_m111._0;
      __ring_blk6 = ed;
      break __ring_match111;
    }
    if (__ring_m111._tag === "none") {
      __ring_blk6 = panic("unreachable: effect_def_opt after none early return");
      break __ring_match111;
    }
    __match_fail(__ring_m111);
  }
  const effect_def = __ring_blk6;
  ...
  let __ring_blk7;
  __ring_match113: {
    const __ring_m113 = op_opt;
    if (__ring_m113._tag === "some") {
      const o = __ring_m113._0;
      __ring_blk7 = o;
      break __ring_match113;
    }
    if (__ring_m113._tag === "none") {
      __ring_blk7 = panic("unreachable: op_opt after none early return");
      break __ring_match113;
    }
    __match_fail(__ring_m113);
  }
  const op = __ring_blk7;
  let inst_map = map_new();
  let inst_type_args = [];
  let tpi = 0;
  const __ring_iter_19 = __List_Iterable.iter(effect_def.type_param_vars);
  while (true) {
    const __ring_next_19 = __ListIterator_Iterator.next(__ring_iter_19);
    if (__ring_next_19._tag === "none") break;
    const tpv = __ring_next_19._0;
  ...
  while (true) {
    ...
    __ring_match114: {
      const __ring_m114 = List_get(inst_params, i);
      if (__ring_m114._tag === "some") {
        const param_type = __ring_m114._0;
  ...
  __ring_match115: {
    const __ring_m115 = effect_def.built_in_kind;
    if (__ring_m115._tag === "some") {
      const bik = __ring_m115._0;
      __ring_match116: {
        const __ring_m116 = bik;
        if (__ring_m116._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match116;
        }
        if (__ring_m116._tag === "BkFail") {
          let __ring_blk8;
          __ring_match117: {
            const __ring_m117 = List_first(hargs);
            if (__ring_m117._tag === "some") {
              const h = __ring_m117._0;
              __ring_blk8 = h;
              break __ring_match117;
            }
            if (__ring_m117._tag === "none") {
              __ring_blk8 = panic("unreachable: hargs.first() after len > 0 check");
              break __ring_match117;
            }
            __match_fail(__ring_m117);
          }
          const error_type = ((List_len(hargs) > 0) ? env$apply_subst(s, hir$hexpr_type(__ring_blk8)) : types$UNIT);
          eff = types$Effect_FailEffect(error_type);
          break __ring_match116;
        }
        if (__ring_m116._tag === "BkMut") {
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match118: {
    const __ring_m118 = receiver;
    if (__ring_m118._tag === "Ident") {
      const recv_name = __ring_m118.name; const qualifier = __ring_m118.qualifier;
      let __ring_blk9;
      __ring_match119: {
        const __ring_m119 = qualifier;
        if (__ring_m119._tag === "some") {
          const q = __ring_m119._0;
          __ring_blk9 = `${q}::${recv_name}`;
          break __ring_match119;
        }
        if (__ring_m119._tag === "none") {
          __ring_blk9 = recv_name;
          break __ring_match119;
        }
        __match_fail(__ring_m119);
      }
      const full_effect_name = __ring_blk9;
      __ring_match120: {
        const __ring_m120 = _Map_get(ctx.env.types.effects, full_effect_name);
  ...
  if (is_mut_method_call(ctx, recv_type, method)) {
    __ring_match121: {
      const __ring_m121 = get_expr_def_id(ctx, receiver);
  ...
  if (Option_is_none(method_type)) {
    __ring_match123: {
      const __ring_m123 = types$type_to_builtin_name(recv_type);
      if (__ring_m123._tag === "some") {
        const prim_name = __ring_m123._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match124: {
      ...
      if (__ring_m124._tag === "some") {
        const type_name = __ring_m124._0;
  ...
  let __ring_blk10;
  __ring_match125: {
    const __ring_m125 = recv_raw_type;
    if (__ring_m125._tag === "TypeVar") {
      const id = __ring_m125.id;
      __ring_blk10 = Option_some(resolve_var_id(id, s));
      break __ring_match125;
    }
    __ring_blk10 = Option_none;
    break __ring_match125;
  }
  const recv_var_id = __ring_blk10;
  if (Option_is_none(method_type)) {
    __ring_match126: {
      const __ring_m126 = recv_var_id;
      if (__ring_m126._tag === "some") {
        const rvid = __ring_m126._0;
        const __ring_iter_22 = __List_Iterable.iter(ctx.current_fn_bounds);
        while (true) {
          const __ring_next_22 = __ListIterator_Iterator.next(__ring_iter_22);
          if (__ring_next_22._tag === "none") break;
          const fb = __ring_next_22._0;
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match127: {
              const __ring_m127 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m127._tag === "some") {
                const trait_def = __ring_m127._0;
                const tm = ((__a) => { const __i = __a.findIndex((function(m) { return (m.name === method); })); return __i >= 0 ? { _tag: "some", _0: __a[__i] } : { _tag: "none" }; })(trait_def.methods);
                __ring_match128: {
                  const __ring_m128 = tm;
                  if (__ring_m128._tag === "some") {
                    const found_method = __ring_m128._0;
  ...
  __ring_match129: {
    const __ring_m129 = method_type;
    if (__ring_m129._tag === "some") {
      const mt = __ring_m129._0;
      __ring_match130: {
        const __ring_m130 = mt;
        if (__ring_m130._tag === "FnType") {
          const mt_params = __ring_m130.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match131: {
              const __ring_m131 = List_first(mt_params);
              if (__ring_m131._tag === "some") {
                const first_param = __ring_m131._0;
  ...
  while (true) {
    ...
    let __ring_blk11;
    __ring_match132: {
      const __ring_m132 = arg;
      if (__ring_m132._tag === "Lambda") {
        const lparams = __ring_m132.params; const lbody = __ring_m132.body; const lspan = __ring_m132.span;
        let __ring_blk12;
        __ring_match133: {
          const __ring_m133 = method_type;
          if (__ring_m133._tag === "some") {
            const mt = __ring_m133._0;
            let __ring_blk13;
            __ring_match134: {
              const __ring_m134 = mt;
              if (__ring_m134._tag === "FnType") {
                const mt_params = __ring_m134.params;
                let __ring_blk14;
                __ring_match135: {
                  const __ring_m135 = List_get(mt_params, (ai + 1));
                  if (__ring_m135._tag === "some") {
                    const expected_raw = __ring_m135._0;
                    const expected = env$apply_subst(s, expected_raw);
                    let __ring_blk15;
                    __ring_match136: {
                      const __ring_m136 = expected;
                      if (__ring_m136._tag === "FnType") {
                        const exp_params = __ring_m136.params;
                        __ring_blk15 = infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
                        break __ring_match136;
                      }
                      __ring_blk15 = infer_expr(ctx, arg, s, __ring_ev_fail);
                      break __ring_match136;
                    }
                ...
                __ring_blk13 = (((ai + 1) < List_len(mt_params)) ? __ring_blk14 : infer_expr(ctx, arg, s, __ring_ev_fail));
                break __ring_match134;
              }
              __ring_blk13 = infer_expr(ctx, arg, s, __ring_ev_fail);
              break __ring_match134;
            }
            __ring_blk12 = __ring_blk13;
  ...
  __ring_match137: {
    const __ring_m137 = method_type;
    if (__ring_m137._tag === "some") {
      const mt = __ring_m137._0;
      __ring_match138: {
        const __ring_m138 = mt;
        if (__ring_m138._tag === "FnType") {
          const mt_params = __ring_m138.params; const mt_ret = __ring_m138.return_type; const mt_effects = __ring_m138.effects;
          let i = 0;
          const __ring_iter_24 = __List_Iterable.iter(hargs);
          while (true) {
            const __ring_next_24 = __ListIterator_Iterator.next(__ring_iter_24);
            if (__ring_next_24._tag === "none") break;
            const harg = __ring_next_24._0;
            if (((i + 1) < List_len(mt_params))) {
              __ring_match139: {
                const __ring_m139 = List_get(mt_params, (i + 1));
                if (__ring_m139._tag === "some") {
                  const expected_param = __ring_m139._0;
    ...
    if (__ring_m137._tag === "none") {
      __ring_match141: {
        const __ring_m141 = recv_type;
        if (__ring_m141._tag === "TypeVar") {
  ...
  let resolved_dicts = [];
  __ring_match142: {
    const __ring_m142 = method_scheme;
    if (__ring_m142._tag === "some") {
      const ms = __ring_m142._0;
      if ((List_len(ms.bounds) > 0)) {
        __ring_match143: {
          const __ring_m143 = method_type;
          if (__ring_m143._tag === "some") {
            const mt = __ring_m143._0;
  ...
  let __ring_blk16;
  __ring_match144: {
    const __ring_m144 = method_type;
    if (__ring_m144._tag === "some") {
      const mt = __ring_m144._0;
      __ring_blk16 = mt;
  ...
  const callee_type = __ring_blk16;
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match147: {
    const __ring_m147 = missing;
    if (__ring_m147._tag === "some") {
      const m = __ring_m147._0;
...
function infer_index_expr(ctx, receiver, index, span, subst, __ring_ev_fail) {
  ...
  __ring_match148: {
    const __ring_m148 = recv_type;
    if (__ring_m148._tag === "StructType") {
      const name = __ring_m148.name; const type_params = __ring_m148.type_params;
    ...
    if (__ring_m148._tag === "StrType") {
      s = infer_ctx$unify_at(ctx.sink, ctx.env, idx_type, types$INT, s, span);
      result_ty = types$STR;
      break __ring_match148;
    }
    if (__ring_m148._tag === "ErrorType") {
      result_ty = types$Type_ErrorType;
      break __ring_match148;
    }
    const _ = infer_ctx$type_error(ctx.sink, codes$E0306, `Type '${types$type_to_string(recv_type)}' does not support indexing`, span, diagnostics$DiagnosticContext_OtherContext(Option_some("only List, Map, and Str support subscript operator []")));
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  let result_type = types$UNIT;
  __ring_match149: {
    const __ring_m149 = else_branch;
    if (__ring_m149._tag === "some") {
      const eb = __ring_m149._0;
      __ring_match150: {
        const __ring_m150 = eb;
        if (__ring_m150._tag === "Block") {
        ...
        if (__ring_m150._tag === "IfExpr") {
          const ec = __ring_m150.condition; const etb = __ring_m150.then_branch; const eeb = __ring_m150.else_branch; const espan = __ring_m150.span;
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  while (true) {
    ...
    __ring_match152: {
      const __ring_m152 = effect_def;
      if (__ring_m152._tag === "some") {
        const ed = __ring_m152._0;
    ...
    let hparams = [];
    let hi = 0;
    const __ring_iter_29 = __List_Iterable.iter(handler.params);
    while (true) {
      ...
      let __ring_blk17;
      __ring_match153: {
        const __ring_m153 = p.type_annotation;
        if (__ring_m153._tag === "some") {
          const ta = __ring_m153._0;
          __ring_blk17 = infer_ctx$resolve_type_expr(ctx, ta);
          break __ring_match153;
        }
        if (__ring_m153._tag === "none") {
          let __ring_blk18;
          __ring_match154: {
            const __ring_m154 = op_def;
            if (__ring_m154._tag === "some") {
              const od = __ring_m154._0;
              let __ring_blk19;
              __ring_match155: {
                const __ring_m155 = List_get(od.params, hi);
                if (__ring_m155._tag === "some") {
                  const odt = __ring_m155._0;
                  __ring_blk19 = env$apply_subst_map(handler_inst_map, odt);
      ...
      if (__ring_m156._tag === "some") {
        ...
        __ring_match157: {
          ...
          if (__ring_m157._tag === "some") {
            ...
            __ring_blk20 = env$apply_subst_map(handler_inst_map, od.return_type);
            break __ring_match157;
          }
          if (__ring_m157._tag === "none") {
            __ring_blk20 = env$TypeEnv_fresh_var(ctx.env);
            break __ring_match157;
          }
          __match_fail(__ring_m157);
        }
        const resume_param = __ring_blk20;
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match158: {
      const __ring_m158 = handler_body_result;
      if (__ring_m158._tag === "some") {
        const hbr = __ring_m158._0;
        s = hbr.subst;
  ...
  const __ring_iter_30 = __List_Iterable.iter(resolved_effects.effects);
  while (true) {
    const __ring_next_30 = __ListIterator_Iterator.next(__ring_iter_30);
    if (__ring_next_30._tag === "none") break;
    const e = __ring_next_30._0;
    let __ring_blk21;
    __ring_match159: {
      const __ring_m159 = e;
      if (__ring_m159._tag === "IoEffect") {
        __ring_blk21 = (!_Set_contains(handled_effects, "io", __Str_Eq));
        break __ring_match159;
      }
      if (__ring_m159._tag === "CustomEffect") {
        const name = __ring_m159.name;
        __ring_blk21 = (!_Set_contains(handled_effects, name, __Str_Eq));
        break __ring_match159;
      }
      if (__ring_m159._tag === "FailEffect") {
        __ring_blk21 = (!_Set_contains(handled_effects, "fail", __Str_Eq));
        break __ring_match159;
      }
      if (__ring_m159._tag === "MutEffect") {
        __ring_blk21 = (!_Set_contains(handled_effects, "mut", __Str_Eq));
        break __ring_match159;
      }
      __match_fail(__ring_m159);
    }
    const should_keep = __ring_blk21;
    if (should_keep) {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match160: {
    const __ring_m160 = recv_type;
    if (__ring_m160._tag === "StructType") {
      const name = __ring_m160.name; const type_params = __ring_m160.type_params;
      __ring_match161: {
        const __ring_m161 = _Map_get(ctx.env.types.structs, name);
        if (__ring_m161._tag === "some") {
          const struct_def = __ring_m161._0;
          ...
          __ring_match162: {
            ...
            if (__ring_m162._tag === "some") {
              const found_field = __ring_m162._0;
              let inst_map = map_new();
              let fi = 0;
              while (((fi < List_len(struct_def.type_param_vars)) ? (fi < List_len(type_params)) : false)) {
                __ring_match163: {
                  const __ring_m163 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m163) && __ring_m163.length === 2 && __ring_m163[0]._tag === "some" && __ring_m163[1]._tag === "some") {
                    const var_id = __ring_m163[0]._0; const tp = __ring_m163[1]._0;
    ...
    if (__ring_m160._tag === "RecordType") {
      const rec_fields = __ring_m160.fields; const tail = __ring_m160.tail;
    ...
    if (__ring_m160._tag === "TupleType") {
      const elements = __ring_m160.elements;
      __ring_match166: {
        const __ring_m166 = parse_int(field);
        ...
        if (__ring_m166._tag === "some") {
          ...
          __ring_match167: {
            const __ring_m167 = List_get(elements, i);
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  const __ring_iter_31 = __List_Iterable.iter(effects.effects);
  while (true) {
    const __ring_next_31 = __ListIterator_Iterator.next(__ring_iter_31);
    if (__ring_next_31._tag === "none") break;
    const eff = __ring_next_31._0;
    __ring_match168: {
      const __ring_m168 = eff;
      if (__ring_m168._tag === "FailEffect") {
        const et = __ring_m168.error_type;
        if (found_fail) {
  ...
  let __ring_blk22;
  __ring_match169: {
    const __ring_m169 = resolved_row.tail;
  ...
  const has_open_tail = __ring_blk22;
  ...
  __ring_match172: {
    const __ring_m172 = missing;
    if (__ring_m172._tag === "some") {
      const m = __ring_m172._0;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  let param_types = [];
  let pi = 0;
  const __ring_iter_33 = __List_Iterable.iter(params);
  while (true) {
    ...
    let __ring_blk23;
    __ring_match173: {
      const __ring_m173 = p.type_annotation;
      if (__ring_m173._tag === "some") {
        const ta = __ring_m173._0;
        __ring_blk23 = infer_ctx$resolve_type_expr(ctx, ta);
        break __ring_match173;
      }
      if (__ring_m173._tag === "none") {
        __ring_blk23 = env$TypeEnv_fresh_var(ctx.env);
        break __ring_match173;
      }
      __match_fail(__ring_m173);
    }
    const pt = __ring_blk23;
    __ring_match174: {
      const __ring_m174 = expected_param_types;
      if (__ring_m174._tag === "some") {
        const epts = __ring_m174._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match175: {
            const __ring_m175 = List_get(epts, pi);
            if (__ring_m175._tag === "some") {
              const expected_t = __ring_m175._0;
    ...
    __ring_match176: {
      const __ring_m176 = lam_scheme;
      if (__ring_m176._tag === "some") {
        const ls = __ring_m176._0;
        __ring_match177: {
          const __ring_m177 = ls.def_id;
          if (__ring_m177._tag === "some") {
            const did = __ring_m177._0;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match178: {
    const __ring_m178 = body_result;
    if (__ring_m178._tag === "some") {
      const body_r = __ring_m178._0;
      s = body_r.subst;
      let applied_params = [];
      const __ring_iter_34 = __List_Iterable.iter(param_types);
      while (true) {
        const __ring_next_34 = __ListIterator_Iterator.next(__ring_iter_34);
        if (__ring_next_34._tag === "none") break;
        const pt = __ring_next_34._0;
...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  let __ring_blk24;
  __ring_match179: {
    const __ring_m179 = resolved_callee;
    if (__ring_m179._tag === "FnType") {
      __ring_blk24 = Option_some(resolved_callee);
      break __ring_match179;
    }
    __ring_blk24 = Option_none;
    break __ring_match179;
  }
  const callee_fn_type = __ring_blk24;
  let hargs = [];
  let arg_types = [];
  let ai = 0;
  ...
  while (true) {
    ...
    const arg = __ring_next_36._0;
    let __ring_blk25;
    __ring_match180: {
      const __ring_m180 = arg;
      if (__ring_m180._tag === "Lambda") {
        const lparams = __ring_m180.params; const lbody = __ring_m180.body; const lspan = __ring_m180.span;
        let __ring_blk26;
        __ring_match181: {
          const __ring_m181 = callee_fn_type;
          if (__ring_m181._tag === "some") {
            const cft = __ring_m181._0;
            let __ring_blk27;
            __ring_match182: {
              const __ring_m182 = cft;
              if (__ring_m182._tag === "FnType") {
                const cft_params = __ring_m182.params;
                let __ring_blk28;
                __ring_match183: {
                  const __ring_m183 = List_get(cft_params, ai);
                  if (__ring_m183._tag === "some") {
                    const expected_raw = __ring_m183._0;
                    const expected = env$apply_subst(s, expected_raw);
                    let __ring_blk29;
                    __ring_match184: {
                      const __ring_m184 = expected;
                      if (__ring_m184._tag === "FnType") {
                        const exp_params = __ring_m184.params;
                        __ring_blk29 = infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
                ...
                __ring_blk27 = ((ai < List_len(cft_params)) ? __ring_blk28 : infer_expr(ctx, arg, s, __ring_ev_fail));
  ...
  let __ring_blk30;
  __ring_match185: {
    const __ring_m185 = callee;
    if (__ring_m185._tag === "Ident") {
      const cn = __ring_m185.name;
      __ring_blk30 = Option_some(cn);
      break __ring_match185;
    }
    __ring_blk30 = Option_none;
    break __ring_match185;
  }
  const callee_name_for_defaults = __ring_blk30;
  __ring_match186: {
    const __ring_m186 = callee_name_for_defaults;
    if (__ring_m186._tag === "some") {
      const cn = __ring_m186._0;
      __ring_match187: {
        const __ring_m187 = _Map_get(ctx.fn_defaults, cn);
        if (__ring_m187._tag === "some") {
          const defaults = __ring_m187._0;
          __ring_match188: {
            const __ring_m188 = _Map_get(ctx.fn_min_arity, cn);
            if (__ring_m188._tag === "some") {
              const min_ar = __ring_m188._0;
              ...
              if (((List_len(args) < total_arity) ? (List_len(args) >= min_ar) : false)) {
                ...
                while ((di < List_len(defaults))) {
                  __ring_match189: {
                    const __ring_m189 = List_get(defaults, di);
                    if (__ring_m189._tag === "some") {
                      const dh = __ring_m189._0;
                      List_push(hargs, dh);
  ...
  __ring_match190: {
    ...
    if (__ring_m190._tag === "Ident") {
      const cn = __ring_m190.name;
      __ring_blk31 = cn;
      break __ring_match190;
    }
    __ring_blk31 = "<expression>";
    break __ring_match190;
  }
  const callee_name_for_note = __ring_blk31;
  ...
  __ring_match191: {
    const __ring_m191 = resolved_callee_type;
    if (__ring_m191._tag === "FnType") {
      const callee_params = __ring_m191.params; const fn_effects = __ring_m191.effects;
  ...
  __ring_match192: {
    ...
    if (__ring_m192._tag === "Ident") {
      const callee_name = __ring_m192.name;
      __ring_match193: {
        const __ring_m193 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m193._tag === "some") {
          const callee_scheme = __ring_m193._0;
  ...
  __ring_match194: {
    const __ring_m194 = callee;
    if (__ring_m194._tag === "Ident") {
      const callee_name = __ring_m194.name;
      __ring_match195: {
        const __ring_m195 = _Map_get(ctx.fn_mut_params, callee_name);
        if (__ring_m195._tag === "some") {
          const mut_flags = __ring_m195._0;
          let mi = 0;
          while (((mi < List_len(mut_flags)) ? (mi < List_len(args)) : false)) {
            __ring_match196: {
              const __ring_m196 = [List_get(mut_flags, mi), List_get(hargs, mi)];
              if (Array.isArray(__ring_m196) && __ring_m196.length === 2 && __ring_m196[0]._tag === "some" && __ring_m196[1]._tag === "some") {
                const is_mut = __ring_m196[0]._0; const harg = __ring_m196[1]._0;
                if (is_mut) {
                  __ring_match197: {
                    const __ring_m197 = harg;
                    if (__ring_m197._tag === "Ident" && __ring_m197.def_id._tag === "some") {
                      const arg_did = __ring_m197.def_id._0;
                      if (_Set_contains(ctx.env.scope.mutable_vars, arg_did, __Int_Eq)) {
                        __ring_match198: {
                          const __ring_m198 = resolved_callee_type;
                          if (__ring_m198._tag === "FnType") {
                            const fn_params = __ring_m198.params;
                            __ring_match199: {
                              const __ring_m199 = List_get(fn_params, mi);
                              if (__ring_m199._tag === "some") {
                                const pt = __ring_m199._0;
                                const resolved_pt = env$apply_subst(s, pt);
...
function infer_stmt(ctx, stmt, subst, __ring_ev_fail) {
  __ring_match200: {
    const __ring_m200 = stmt;
    if (__ring_m200._tag === "Let") {
      const name = __ring_m200.name; const name_span = __ring_m200.name_span; const type_annotation = __ring_m200.type_annotation; const init = __ring_m200.init; const span = __ring_m200.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      let var_type = hir$hexpr_type(init_r.hexpr);
      __ring_match201: {
        const __ring_m201 = type_annotation;
        if (__ring_m201._tag === "some") {
          const ta = __ring_m201._0;
      ...
      let __ring_blk32;
      __ring_match202: {
        const __ring_m202 = bound_scheme;
        if (__ring_m202._tag === "some") {
          const bs = __ring_m202._0;
          let __ring_blk33;
          __ring_match203: {
            const __ring_m203 = bs.def_id;
            if (__ring_m203._tag === "some") {
              const did = __ring_m203._0;
              env$TypeEnv_record_def_span(ctx.env, did, name_span);
              _Set_insert(ctx.env.scope.let_defs, did);
              _Map_insert(ctx.var_lambda_depth, did, ctx.lambda_depth);
              __ring_blk33 = Option_some(did);
      ...
      const bound_def_id = __ring_blk32;
    ...
    if (__ring_m200._tag === "Var") {
      ...
      __ring_match205: {
        const __ring_m205 = var_scheme;
        if (__ring_m205._tag === "some") {
          const vs = __ring_m205._0;
          __ring_match206: {
            const __ring_m206 = vs.def_id;
    ...
    if (__ring_m200._tag === "Assign") {
      const target = __ring_m200.target; const value = __ring_m200.value; const span = __ring_m200.span;
    ...
    if (__ring_m200._tag === "ExprStmt") {
      const expr = __ring_m200.expr; const span = __ring_m200.span;
      const r = infer_expr(ctx, expr, subst, __ring_ev_fail);
      return new StmtResult(hir$HStmt_ExprStmt(r.hexpr, span), r.subst, r.effects);
      break __ring_match200;
    }
    if (__ring_m200._tag === "Return") {
      const value = __ring_m200.value; const span = __ring_m200.span;
      __ring_match207: {
        const __ring_m207 = value;
        if (__ring_m207._tag === "some") {
          const v = __ring_m207._0;
          const r = infer_expr(ctx, v, subst, __ring_ev_fail);
          let s = r.subst;
          __ring_match208: {
            const __ring_m208 = ctx.current_fn_return_type;
            if (__ring_m208._tag === "some") {
              const ret_type = __ring_m208._0;
        ...
        if (__ring_m207._tag === "none") {
          let s = subst;
          __ring_match209: {
            const __ring_m209 = ctx.current_fn_return_type;
            if (__ring_m209._tag === "some") {
              const ret_type = __ring_m209._0;
    ...
    if (__ring_m200._tag === "While") {
      const condition = __ring_m200.condition; const body = __ring_m200.body; const span = __ring_m200.span;
      const cond_r = infer_expr(ctx, condition, subst, __ring_ev_fail);
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match210: {
        const __ring_m210 = body_result;
        if (__ring_m210._tag === "some") {
          const body_r = __ring_m210._0;
          s = body_r.subst;
    ...
    if (__ring_m200._tag === "ForIn") {
      const binding = __ring_m200.binding; const binding_span = __ring_m200.binding_span; const destructure = __ring_m200.destructure; const iterable = __ring_m200.iterable; const body = __ring_m200.body; const span = __ring_m200.span;
      ...
      let __ring_blk34;
      __ring_match211: {
        const __ring_m211 = iter_type;
        if (__ring_m211._tag === "EnumType") {
          const name = __ring_m211.name;
          __ring_blk34 = (name === hir$BUILTIN_RANGE);
          break __ring_match211;
        }
        __ring_blk34 = false;
        break __ring_match211;
      }
      const is_range = __ring_blk34;
      if (is_range) {
        __ring_match212: {
          const __ring_m212 = iter_type;
          if (__ring_m212._tag === "EnumType") {
            const type_params = __ring_m212.type_params;
            let __ring_blk35;
            __ring_match213: {
              const __ring_m213 = List_first(type_params);
              ...
              if (__ring_m213._tag === "none") {
                __ring_blk35 = types$INT;
                break __ring_match213;
              }
              __match_fail(__ring_m213);
            }
            element_type = __ring_blk35;
        ...
        __ring_match214: {
          const __ring_m214 = type_name;
          if (__ring_m214._tag === "some") {
            const tn = __ring_m214._0;
            const iterable_impl = env$find_impl(ctx.env.trait_reg, tn, "Iterable");
            __ring_match215: {
              const __ring_m215 = iterable_impl;
              if (__ring_m215._tag === "some") {
                const impl_entry = __ring_m215._0;
                iterable_type_name = Option_some(tn);
                __ring_match216: {
                  const __ring_m216 = _Map_get(impl_entry.assoc_types, "Iter");
                  if (__ring_m216._tag === "some") {
                    const iter_assoc_ty = __ring_m216._0;
                    let __ring_blk36;
                    __ring_match217: {
                      const __ring_m217 = iter_type;
                      if (__ring_m217._tag === "StructType") {
                        const tps = __ring_m217.type_params;
                        __ring_blk36 = tps;
                    ...
                    const concrete_type_params = __ring_blk36;
                    const concrete_iter_name = types$type_to_builtin_name(iter_assoc_ty);
                    __ring_match218: {
                      const __ring_m218 = concrete_iter_name;
                      if (__ring_m218._tag === "some") {
                        const itn = __ring_m218._0;
                        ...
                        __ring_match219: {
                          const __ring_m219 = iterator_impl;
                          if (__ring_m219._tag === "some") {
                            const iter_impl_entry = __ring_m219._0;
                            __ring_match220: {
                              const __ring_m220 = _Map_get(iter_impl_entry.assoc_types, "Item");
                              if (__ring_m220._tag === "some") {
                                const item_assoc_ty = __ring_m220._0;
                                const item_name = types$type_to_builtin_name(item_assoc_ty);
                                __ring_match221: {
                                  const __ring_m221 = item_assoc_ty;
                                  if (__ring_m221._tag === "TypeVar") {
                                    let __ring_blk37;
                                    __ring_match222: {
                                      const __ring_m222 = List_first(concrete_type_params);
                                      if (__ring_m222._tag === "some") {
                                        const ct = __ring_m222._0;
                                        __ring_blk37 = ct;
                                        break __ring_match222;
                                      }
                                      if (__ring_m222._tag === "none") {
                                        __ring_blk37 = element_type;
                                        break __ring_match222;
                                      }
                                      __match_fail(__ring_m222);
                                    }
                                    element_type = __ring_blk37;
                                    break __ring_match221;
                                  }
                                  if (__ring_m221._tag === "TupleType") {
                                    const elements = __ring_m221.elements;
                                    let concrete_elems = [];
                                    let ei = 0;
                                    ...
                                    while (true) {
                                      ...
                                      const elem = __ring_next_38._0;
                                      __ring_match223: {
                                        const __ring_m223 = elem;
                                        if (__ring_m223._tag === "TypeVar") {
                                          __ring_match224: {
                                            const __ring_m224 = List_get(concrete_type_params, ei);
                                            if (__ring_m224._tag === "some") {
                                              const ct = __ring_m224._0;
      ...
      __ring_match225: {
        const __ring_m225 = destructure;
        if (__ring_m225._tag === "some") {
          const destr = __ring_m225._0;
          __ring_match226: {
            const __ring_m226 = element_type;
            if (__ring_m226._tag === "TupleType") {
              const type_elems = __ring_m226.elements;
          ...
          while ((di < List_len(destr.names))) {
            __ring_match227: {
              const __ring_m227 = List_get(destr.names, di);
              if (__ring_m227._tag === "some") {
                const dname = __ring_m227._0;
                let __ring_blk38;
                __ring_match228: {
                  const __ring_m228 = element_type;
                  if (__ring_m228._tag === "TupleType") {
                    const type_elems = __ring_m228.elements;
                    let __ring_blk39;
                    __ring_match229: {
                      const __ring_m229 = List_get(type_elems, di);
                      if (__ring_m229._tag === "some") {
                        const et = __ring_m229._0;
                        __ring_blk39 = et;
                        break __ring_match229;
                      }
                      if (__ring_m229._tag === "none") {
                        __ring_blk39 = env$TypeEnv_fresh_var(ctx.env);
                        break __ring_match229;
                      }
                ...
                const elem_t = __ring_blk38;
                env$TypeEnv_bind_mono(ctx.env, dname, elem_t);
                const dscheme = env$TypeEnv_lookup(ctx.env, dname);
                __ring_match230: {
                  const __ring_m230 = dscheme;
                  if (__ring_m230._tag === "some") {
                    const ds = __ring_m230._0;
                    __ring_match231: {
                      const __ring_m231 = [ds.def_id, List_get(destr.spans, di)];
                      if (Array.isArray(__ring_m231) && __ring_m231.length === 2 && __ring_m231[0]._tag === "some" && __ring_m231[1]._tag === "some") {
                        const did = __ring_m231[0]._0; const dspan = __ring_m231[1]._0;
      ...
      __ring_match232: {
        const __ring_m232 = binding_scheme;
        if (__ring_m232._tag === "some") {
          const bs = __ring_m232._0;
          __ring_match233: {
            const __ring_m233 = bs.def_id;
            if (__ring_m233._tag === "some") {
              const did = __ring_m233._0;
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match234: {
        const __ring_m234 = body_result;
        if (__ring_m234._tag === "some") {
          const body_r = __ring_m234._0;
          s = body_r.subst;
          const me = infer_ctx$merge_effects(ctx.env, iter_r.effects, body_r.effects, s, __ring_ev_fail);
          let __ring_blk40;
          __ring_match235: {
            const __ring_m235 = binding_scheme;
            if (__ring_m235._tag === "some") {
              const bs = __ring_m235._0;
              __ring_blk40 = bs.def_id;
              break __ring_match235;
            }
            if (__ring_m235._tag === "none") {
              __ring_blk40 = Option_none;
              break __ring_match235;
            }
            __match_fail(__ring_m235);
          }
          return new StmtResult(hir$HStmt_ForIn(binding, binding_span, __ring_blk40, hdestructure, iter_r.hexpr, body_r.hexpr, iterable_type_name, iter_type_name, span), me[1], me[0]);
    ...
    if (__ring_m200._tag === "Break") {
      const span = __ring_m200.span;
      if ((ctx.loop_depth === 0)) {
    ...
    if (__ring_m200._tag === "LetDestructure") {
      const pattern = __ring_m200.pattern; const init = __ring_m200.init; const span = __ring_m200.span;
      const init_r = infer_expr(ctx, init, subst, __ring_ev_fail);
      let s = init_r.subst;
      const init_type = env$apply_subst(s, hir$hexpr_type(init_r.hexpr));
      __ring_match236: {
        const __ring_m236 = init_type;
        if (__ring_m236._tag === "TupleType") {
      ...
      let __ring_blk41;
      __ring_match237: {
        const __ring_m237 = init_type;
        if (__ring_m237._tag === "TupleType") {
          const elements = __ring_m237.elements;
          __ring_blk41 = elements;
          break __ring_match237;
        }
        __ring_blk41 = [];
        break __ring_match237;
      }
      const tuple_elements = __ring_blk41;
      __ring_match238: {
        const __ring_m238 = pattern;
        if (__ring_m238._tag === "TuplePattern") {
          const pat_elements = __ring_m238.elements;
          ...
          while ((bi < List_len(pat_elements))) {
            __ring_match239: {
              const __ring_m239 = List_get(pat_elements, bi);
              if (__ring_m239._tag === "some") {
                const p = __ring_m239._0;
                let __ring_blk42;
                __ring_match240: {
                  const __ring_m240 = List_get(tuple_elements, bi);
                  if (__ring_m240._tag === "some") {
                    const et = __ring_m240._0;
                    __ring_blk42 = et;
                    break __ring_match240;
                  }
                  if (__ring_m240._tag === "none") {
                    __ring_blk42 = types$UNIT;
                    break __ring_match240;
                  }
                  __match_fail(__ring_m240);
                }
                const elem_type = __ring_blk42;
                __ring_match241: {
                  const __ring_m241 = p;
                  if (__ring_m241._tag === "Binding") {
                    const name = __ring_m241.name; const pspan = __ring_m241.span;
                    env$TypeEnv_bind_mono(ctx.env, name, elem_type);
                    const bscheme = env$TypeEnv_lookup(ctx.env, name);
                    __ring_match242: {
                      const __ring_m242 = bscheme;
                      if (__ring_m242._tag === "some") {
                        const bs = __ring_m242._0;
                        __ring_match243: {
                          const __ring_m243 = bs.def_id;
                          if (__ring_m243._tag === "some") {
                            const did = __ring_m243._0;
    ...
    if (__ring_m200._tag === "IfLet") {
      const pattern = __ring_m200.pattern; const expr = __ring_m200.expr; const then_block = __ring_m200.then_block; const else_block = __ring_m200.else_block; const span = __ring_m200.span;
      const expr_r = infer_expr(ctx, expr, subst, __ring_ev_fail);
      let s = expr_r.subst;
  ...
  return infer_block(ctx, then_block, Option_some(s), __ring_ev_fail);
      ...
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match244: {
        const __ring_m244 = then_result;
        if (__ring_m244._tag === "some") {
          const then_r = __ring_m244._0;
          s = then_r.subst;
          ...
          __ring_match245: {
            const __ring_m245 = else_block;
            if (__ring_m245._tag === "some") {
              const eb = __ring_m245._0;
              env$TypeEnv_push_scope(ctx.env);
              ...
              env$TypeEnv_pop_scope(ctx.env);
              __ring_match246: {
                const __ring_m246 = else_result;
                if (__ring_m246._tag === "some") {
                  const else_r = __ring_m246._0;
                  s = else_r.subst;
...
function infer_block(ctx, body, initial_subst, __ring_ev_fail) {
  __ring_match247: {
    const __ring_m247 = body;
    if (__ring_m247._tag === "Block") {
      const stmts = __ring_m247.stmts; const tail = __ring_m247.tail; const span = __ring_m247.span;
      let __ring_blk43;
      __ring_match248: {
        const __ring_m248 = initial_subst;
        if (__ring_m248._tag === "some") {
          const s = __ring_m248._0;
          __ring_blk43 = s;
          break __ring_match248;
        }
        if (__ring_m248._tag === "none") {
          __ring_blk43 = ctx.subst;
          break __ring_match248;
        }
        __match_fail(__ring_m248);
      }
      let subst = __ring_blk43;
      let effects = types$EMPTY_ROW;
      let hstmts = [];
      const __ring_iter_39 = __List_Iterable.iter(stmts);
      while (true) {
        const __ring_next_39 = __ListIterator_Iterator.next(__ring_iter_39);
        if (__ring_next_39._tag === "none") break;
        const stmt = __ring_next_39._0;
      ...
      __ring_match249: {
        const __ring_m249 = tail;
        if (__ring_m249._tag === "some") {
          const t = __ring_m249._0;
