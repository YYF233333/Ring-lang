...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  for (const eff of effects.effects) {
    __ring_match128: {
      const __ring_m128 = eff;
      if (__ring_m128._tag === "FailEffect") {
        const et = __ring_m128.error_type;
        error_type = et;
  ...
  let guard_hexpr = Option_none;
  __ring_match129: {
    const __ring_m129 = arm.guard;
    if (__ring_m129._tag === "some") {
      const g = __ring_m129._0;
      const gr = infer_expr(ctx, g, s, __ring_ev_fail);
      s = gr.subst;
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(gr.hexpr), types$BOOL(), s, arm.span);
      const me = infer_ctx$merge_effects(ctx.env, effects, gr.effects, s, __ring_ev_fail);
  ...
  s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(body_r.hexpr), result_type, s, arm.span);
  __ring_match130: {
    const __ring_m130 = arm.pattern;
    if (__ring_m130._tag === "Wildcard") {
      __ring_match131: {
        const __ring_m131 = arm.guard;
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  for (const handler of handlers) {
    ...
    __ring_match134: {
      const __ring_m134 = effect_def;
      if (__ring_m134._tag === "some") {
        const ed = __ring_m134._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match135: {
      const __ring_m135 = handler.resume_name;
  ...
  __match_fail(__ring_m);
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match136: {
      const __ring_m136 = handler_body_result;
      if (__ring_m136._tag === "some") {
        const hbr = __ring_m136._0;
        s = hbr.subst;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match137: {
      const __ring_m137 = expected_param_types;
      if (__ring_m137._tag === "some") {
        const epts = __ring_m137._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match138: {
            const __ring_m138 = List_get(epts, pi);
            if (__ring_m138._tag === "some") {
              const expected_t = __ring_m138._0;
    ...
    __ring_match139: {
      const __ring_m139 = lam_scheme;
      if (__ring_m139._tag === "some") {
        const ls = __ring_m139._0;
        __ring_match140: {
          const __ring_m140 = ls.def_id;
          if (__ring_m140._tag === "some") {
            const did = __ring_m140._0;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match141: {
    const __ring_m141 = body_result;
    if (__ring_m141._tag === "some") {
      const body_r = __ring_m141._0;
      s = body_r.subst;
      let applied_params = [];
...
function check_decl(ctx, decl, __ring_ev_fail) {
  __ring_match142: {
    const __ring_m142 = decl;
    if (__ring_m142._tag === "Struct") {
      const name = __ring_m142.name; const type_params = __ring_m142.type_params; const is_pub = __ring_m142.is_pub; const span = __ring_m142.span;
      return check_struct_decl(ctx, name, type_params, is_pub, span);
      break __ring_match142;
    }
    if (__ring_m142._tag === "Enum") {
      const name = __ring_m142.name; const type_params = __ring_m142.type_params; const is_pub = __ring_m142.is_pub; const span = __ring_m142.span;
      return check_enum_decl(ctx, name, type_params, is_pub, span);
      break __ring_match142;
    }
    if (__ring_m142._tag === "Effect") {
      const name = __ring_m142.name; const type_params = __ring_m142.type_params; const ops = __ring_m142.ops; const is_pub = __ring_m142.is_pub; const span = __ring_m142.span;
      return check_effect_decl(ctx, name, type_params, ops, is_pub, span);
      break __ring_match142;
    }
    if (__ring_m142._tag === "Impl") {
      const target_type = __ring_m142.target_type; const type_params = __ring_m142.type_params; const trait_name = __ring_m142.trait_name; const methods = __ring_m142.methods; const span = __ring_m142.span;
      return check_impl_decl(ctx, target_type, type_params, trait_name, methods, span, __ring_ev_fail);
      break __ring_match142;
    }
    if (__ring_m142._tag === "Fn") {
      const name = __ring_m142.name; const type_params = __ring_m142.type_params; const params = __ring_m142.params; const return_type = __ring_m142.return_type; const body = __ring_m142.body; const is_pub = __ring_m142.is_pub; const span = __ring_m142.span;
      return check_fn_decl(ctx, name, type_params, params, return_type, body, is_pub, span, Option_none, __ring_ev_fail);
      break __ring_match142;
    }
    if (__ring_m142._tag === "Test") {
      const description = __ring_m142.description; const body = __ring_m142.body; const span = __ring_m142.span;
      return check_test_decl(ctx, description, body, span, __ring_ev_fail);
      break __ring_match142;
    }
    if (__ring_m142._tag === "Trait") {
      const name = __ring_m142.name; const type_params = __ring_m142.type_params; const methods = __ring_m142.methods; const is_pub = __ring_m142.is_pub; const span = __ring_m142.span;
      return check_trait_decl(ctx, name, type_params, methods, is_pub, span, __ring_ev_fail);
      break __ring_match142;
    }
    if (__ring_m142._tag === "ExternFn") {
      const name = __ring_m142.name; const type_params = __ring_m142.type_params; const params = __ring_m142.params; const return_type = __ring_m142.return_type; const is_pub = __ring_m142.is_pub; const span = __ring_m142.span;
      return check_extern_fn_decl(ctx, name, type_params, params, is_pub, span);
      break __ring_match142;
    }
    if (__ring_m142._tag === "ExternType") {
      const name = __ring_m142.name; const type_params = __ring_m142.type_params; const is_pub = __ring_m142.is_pub; const span = __ring_m142.span;
      return hir$HDecl_ExternType(name, type_params, is_pub, span);
      break __ring_match142;
    }
    if (__ring_m142._tag === "TypeAlias") {
      const name = __ring_m142.name; const is_pub = __ring_m142.is_pub; const span = __ring_m142.span;
  ...
  for (const method of methods) {
    __ring_match143: {
      ...
      if (__ring_m143._tag === "ExternFn") {
        const name = __ring_m143.name; const mtps = __ring_m143.type_params; const params = __ring_m143.params; const return_type = __ring_m143.return_type; const is_pub = __ring_m143.is_pub; const mspan = __ring_m143.span;
        List_push(hmethods, check_extern_fn_decl(ctx, name, mtps, params, is_pub, mspan));
        break __ring_match143;
      }
      if (__ring_m143._tag === "Fn") {
        const name = __ring_m143.name; const mtps = __ring_m143.type_params; const params = __ring_m143.params; const return_type = __ring_m143.return_type; const body = __ring_m143.body; const is_pub = __ring_m143.is_pub; const mspan = __ring_m143.span;
...
function check_trait_decl(ctx, name, type_params, ast_methods, is_pub, span, __ring_ev_fail) {
  ...
  if ((List_len(trait_def.methods) > 0)) {
    __ring_match144: {
      const __ring_m144 = List_first(trait_def.methods);
      if (__ring_m144._tag === "some") {
        const first_method = __ring_m144._0;
        __ring_match145: {
          const __ring_m145 = first_method.ty;
          if (__ring_m145._tag === "FnType") {
            const fps = __ring_m145.params;
            if ((List_len(fps) > 0)) {
              __ring_match146: {
                const __ring_m146 = List_first(fps);
                if (__ring_m146._tag === "some") {
                  const fp = __ring_m146._0;
                  self_var = fp;
  ...
  __match_fail(__ring_m);
    ...
    if (m.has_default) {
      __ring_match147: {
        const __ring_m147 = ast_method;
        if (__ring_m147._tag === "some") {
          const am = __ring_m147._0;
          __ring_match148: {
            const __ring_m148 = am;
            if (__ring_m148._tag === "Fn") {
              const abody = __ring_m148.body;
...
function check_trait_default_body(ctx, trait_name, self_var, hparams, body, __ring_ev_fail) {
  ...
  __ring_match149: {
    const __ring_m149 = self_var;
    if (__ring_m149._tag === "TypeVar") {
      const id = __ring_m149.id;
  ...
  for (const p of hparams) {
    ...
    if (p.is_mutable) {
      __ring_match150: {
        const __ring_m150 = env$TypeEnv_lookup(ctx.env, p.name);
        if (__ring_m150._tag === "some") {
          const ps = __ring_m150._0;
          __ring_match151: {
            const __ring_m151 = ps.def_id;
...
function check_fn_body(ctx, type_params, hparams, expected_ret, body, saved_tp_scope, span, __ring_ev_fail) {
  ...
  for (const tp of type_params) {
    __ring_match152: {
      const __ring_m152 = _Map_get(ctx.type_param_scope, tp.name);
      if (__ring_m152._tag === "some") {
        const tv = __ring_m152._0;
        __ring_match153: {
...
function check_fn_decl(ctx, name, type_params, params, return_type, body, is_pub, span, self_type, __ring_ev_fail) {
  ...
  for (const tp of type_params) {
    __ring_match157: {
      const __ring_m157 = _Map_get(ctx.type_param_scope, tp.name);
      if (__ring_m157._tag === "some") {
        const tv = __ring_m157._0;
        __ring_match158: {
          const __ring_m158 = tv;
          if (__ring_m158._tag === "TypeVar") {
            const id = __ring_m158.id;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match159: {
      const __ring_m159 = param_scheme;
      if (__ring_m159._tag === "some") {
        const ps = __ring_m159._0;
        __ring_match160: {
          const __ring_m160 = ps.def_id;
          if (__ring_m160._tag === "some") {
            const did = __ring_m160._0;
            env$TypeEnv_record_def_span(ctx.env, did, p.span);
            if (p.is_mutable) {
              _Set_insert(ctx.env.mutable_vars, did);
            }
...
function check(ctx, program, __ring_ev_fail) {
  ...
  List_push(hdecls, hd);
  __ring_match162: {
    const __ring_m162 = hd;
    if (__ring_m162._tag === "Fn") {
      const name = __ring_m162.name; const effects = __ring_m162.effects;
