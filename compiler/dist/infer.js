...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  for (const arg of args) {
    ...
    List_push(hargs, ar.hexpr);
    __ring_match108: {
      const __ring_m108 = List_get(inst_params, i);
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  for (const handler of handlers) {
    ...
    __ring_match153: {
      const __ring_m153 = effect_def;
      if (__ring_m153._tag === "some") {
        const ed = __ring_m153._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match154: {
      const __ring_m154 = handler.resume_name;
  ...
  __match_fail(__ring_m);
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match155: {
      const __ring_m155 = handler_body_result;
      if (__ring_m155._tag === "some") {
        const hbr = __ring_m155._0;
        s = hbr.subst;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match156: {
      const __ring_m156 = expected_param_types;
      if (__ring_m156._tag === "some") {
        const epts = __ring_m156._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match157: {
            const __ring_m157 = List_get(epts, pi);
            if (__ring_m157._tag === "some") {
              const expected_t = __ring_m157._0;
    ...
    __ring_match158: {
      const __ring_m158 = lam_scheme;
      if (__ring_m158._tag === "some") {
        const ls = __ring_m158._0;
        __ring_match159: {
          const __ring_m159 = ls.def_id;
