...
function infer_ident(ctx, name, span, subst, qualifier) {
  __ring_match41: {
    ...
    if (__ring_m41._tag === "some") {
      ...
      __ring_match42: {
        const __ring_m42 = mod_scheme;
        if (__ring_m42._tag === "some") {
          const ms = __ring_m42._0;
    ...
    if (__ring_m43._tag === "some") {
      ...
      __ring_match45: {
        ...
        if (__ring_m45._tag === "some") {
          ...
          __ring_match46: {
            const __ring_m46 = _Map_get(ctx.env.types.enums, q);
...
function is_primitive_eq(t) {
  __ring_match50: {
    ...
    if (__ring_m50._tag === "NeverType") {
      return true;
      break __ring_match50;
    }
    if (__ring_m50._tag === "AnyType") {
      return true;
      break __ring_match50;
    }
    return false;
...
function resolve_trait_dispatch(ctx, resolved, trait_name, error_code, subst, span, op, is_builtin) {
  ...
  __ring_match53: {
    ...
    if (__ring_m53._tag === "TypeVar") {
      ...
      __ring_match55: {
        const __ring_m55 = _Map_get(ctx.env.scope.var_bounds, id);
...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match63: {
    const __ring_m63 = expected;
    if (__ring_m63._tag === "FnType") {
      const exp_params = __ring_m63.params;
  ...
  __ring_match64: {
    const __ring_m64 = resolved_callee_type;
    if (__ring_m64._tag === "FnType") {
      const fn_effects = __ring_m64.effects;
  ...
  let resolved_dicts = [];
  __ring_match65: {
    const __ring_m65 = callee;
    if (__ring_m65._tag === "Ident") {
      const callee_name = __ring_m65.name;
      __ring_match66: {
        const __ring_m66 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m66._tag === "some") {
          const callee_scheme = __ring_m66._0;
...
function resolve_arg_bound_dict(ctx, concrete, trait_name, dicts) {
  __ring_match70: {
    ...
    if (__ring_m70._tag === "TypeVar") {
      ...
      __ring_match71: {
        const __ring_m71 = matching;
        if (__ring_m71._tag === "some") {
          const fb = __ring_m71._0;
    ...
    __ring_match72: {
      const __ring_m72 = types$type_to_builtin_name(concrete);
      if (__ring_m72._tag === "some") {
        const prim_name = __ring_m72._0;
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match73: {
    const __ring_m73 = receiver;
    if (__ring_m73._tag === "Ident") {
      const recv_name = __ring_m73.name;
      __ring_match74: {
        const __ring_m74 = _Map_get(ctx.env.types.effects, recv_name);
  ...
  if (Option_is_none(method_type)) {
    __ring_match77: {
      const __ring_m77 = types$type_to_builtin_name(recv_type);
      if (__ring_m77._tag === "some") {
        const type_name = __ring_m77._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match78: {
      const __ring_m78 = recv_var_id;
      if (__ring_m78._tag === "some") {
        const rvid = __ring_m78._0;
        for (const fb of ctx.current_fn_bounds) {
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match79: {
              const __ring_m79 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m79._tag === "some") {
                const trait_def = __ring_m79._0;
                ...
                __ring_match80: {
                  ...
                  if (__ring_m80._tag === "some") {
                    const found_method = __ring_m80._0;
  ...
  __ring_match81: {
    const __ring_m81 = method_type;
    if (__ring_m81._tag === "some") {
      const mt = __ring_m81._0;
      __ring_match82: {
        const __ring_m82 = mt;
        if (__ring_m82._tag === "FnType") {
          const mt_params = __ring_m82.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match83: {
              const __ring_m83 = List_first(mt_params);
              if (__ring_m83._tag === "some") {
                const first_param = __ring_m83._0;
  ...
  const expected = env$apply_subst(s, expected_raw);
  __ring_match84: {
    const __ring_m84 = expected;
    if (__ring_m84._tag === "FnType") {
      const exp_params = __ring_m84.params;
      return infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
  ...
  __ring_match85: {
    const __ring_m85 = method_type;
    if (__ring_m85._tag === "some") {
      const mt = __ring_m85._0;
      __ring_match86: {
        const __ring_m86 = mt;
        if (__ring_m86._tag === "FnType") {
          const mt_params = __ring_m86.params; const mt_ret = __ring_m86.return_type; const mt_effects = __ring_m86.effects;
          let i = 0;
          for (const harg of hargs) {
            if (((i + 1) < List_len(mt_params))) {
              __ring_match87: {
                const __ring_m87 = List_get(mt_params, (i + 1));
                if (__ring_m87._tag === "some") {
                  const expected_param = __ring_m87._0;
  ...
  let resolved_dicts = [];
  __ring_match90: {
    const __ring_m90 = method_scheme;
    if (__ring_m90._tag === "some") {
      const ms = __ring_m90._0;
      if ((List_len(ms.bounds) > 0)) {
        __ring_match91: {
          const __ring_m91 = method_type;
          if (__ring_m91._tag === "some") {
            const mt = __ring_m91._0;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match92: {
    const __ring_m92 = _Map_get(ctx.env.trait_reg.impl_methods, type_name);
    if (__ring_m92._tag === "some") {
      const impl_methods = __ring_m92._0;
      __ring_match93: {
        const __ring_m93 = _Map_get(impl_methods, method);
        if (__ring_m93._tag === "some") {
          const scheme = __ring_m93._0;
...
function lookup_trait_method(ctx, type_name, method, span) {
  ...
  for (const impl_entry of ctx.env.trait_reg.trait_impls) {
    if ((impl_entry.target_type_name === type_name)) {
      __ring_match94: {
        const __ring_m94 = _Map_get(ctx.env.trait_reg.traits, impl_entry.trait_name);
        if (__ring_m94._tag === "some") {
          ...
          __ring_match95: {
            ...
            if (__ring_m95._tag === "some") {
              ...
              __ring_match96: {
                const __ring_m96 = found_trait_name;
                if (__ring_m96._tag === "some") {
                  const prev_trait = __ring_m96._0;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match97: {
    const __ring_m97 = effect_def_opt;
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match102: {
    ...
    if (__ring_m102._tag === "StructType") {
      ...
      __ring_match103: {
        const __ring_m103 = _Map_get(ctx.env.types.structs, name);
    ...
    if (__ring_m102._tag === "TupleType") {
      ...
      __ring_match108: {
        const __ring_m108 = parse_int(field);
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  ...
  __ring_match112: {
    ...
    if (__ring_m112._tag === "some") {
      ...
      __ring_match113: {
        const __ring_m113 = _Map_get(ctx.env.types.enums, q);
        if (__ring_m113._tag === "some") {
          const enum_def = __ring_m113._0;
          if (enum_def.variants.some((function(v) { return (v.name === name); }))) {
  ...
  __ring_match115: {
    const __ring_m115 = variant_enum;
    if (__ring_m115._tag === "some") {
      const ve = __ring_m115._0;
      __ring_match116: {
        const __ring_m116 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m116._tag === "some") {
          const enum_def = __ring_m116._0;
          ...
          __ring_match117: {
            const __ring_m117 = variant;
            if (__ring_m117._tag === "some") {
              const v = __ring_m117._0;
              __ring_match118: {
                const __ring_m118 = v.field_names;
  ...
  __ring_match119: {
    const __ring_m119 = struct_def_opt;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match120: {
      const __ring_m120 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m120._tag === "some") {
        const var_id = __ring_m120._0;
  ...
  __ring_match121: {
    const __ring_m121 = spread;
    if (__ring_m121._tag === "some") {
      const sp = __ring_m121._0;
  ...
  for (const field of fields) {
    ...
    __ring_match122: {
      const __ring_m122 = def_field;
      if (__ring_m122._tag === "some") {
        const df = __ring_m122._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  ...
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match123: {
      const __ring_m123 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m123._tag === "some") {
        const var_id = __ring_m123._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  let hspread = Option_none;
  __ring_match124: {
    const __ring_m124 = spread;
    if (__ring_m124._tag === "some") {
      const sp = __ring_m124._0;
      const sr = infer_expr(ctx, sp, s, __ring_ev_fail);
      s = sr.subst;
      const me = infer_ctx$merge_effects(ctx.env, effects, sr.effects, s, __ring_ev_fail);
      effects = me[0];
  ...
  for (const field of fields) {
    ...
    __ring_match125: {
      const __ring_m125 = field_idx;
      if (__ring_m125._tag === "some") {
        const idx = __ring_m125._0;
        __ring_match126: {
          const __ring_m126 = List_get(variant.fields, idx);
          if (__ring_m126._tag === "some") {
            const ftype = __ring_m126._0;
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match127: {
    const __ring_m127 = arm.pattern;
    if (__ring_m127._tag === "Binding") {
      const pat_name = __ring_m127.name; const pspan = __ring_m127.span;
      __ring_match128: {
        const __ring_m128 = _Map_get(ctx.env.types.variant_to_enum, pat_name);
        if (__ring_m128._tag === "some") {
          const ve = __ring_m128._0;
          __ring_match129: {
            const __ring_m129 = _Map_get(ctx.env.types.enums, ve);
            if (__ring_m129._tag === "some") {
              const edef = __ring_m129._0;
  ...
  __ring_match133: {
    const __ring_m133 = missing;
    if (__ring_m133._tag === "some") {
      const m = __ring_m133._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  let result_type = types$UNIT;
  __ring_match134: {
    const __ring_m134 = else_branch;
    if (__ring_m134._tag === "some") {
      const eb = __ring_m134._0;
      __ring_match135: {
        const __ring_m135 = eb;
        ...
        if (__ring_m135._tag === "IfExpr") {
          const ec = __ring_m135.condition; const etb = __ring_m135.then_branch; const eeb = __ring_m135.else_branch; const espan = __ring_m135.span;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  for (const part of parts) {
    __ring_match136: {
      const __ring_m136 = part;
      if (__ring_m136._tag === "LitPart") {
        const str_val = __ring_m136._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match136;
      }
      if (__ring_m136._tag === "ExprPart") {
        const expr = __ring_m136._0;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  for (const eff of effects.effects) {
    __ring_match137: {
      const __ring_m137 = eff;
      if (__ring_m137._tag === "FailEffect") {
        const et = __ring_m137.error_type;
        if (found_fail) {
  ...
  let guard_hexpr = Option_none;
  __ring_match138: {
    const __ring_m138 = arm.guard;
    if (__ring_m138._tag === "some") {
      const g = __ring_m138._0;
      const gr = infer_expr(ctx, g, s, __ring_ev_fail);
      s = gr.subst;
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(gr.hexpr), types$BOOL, s, arm.span);
      const me = infer_ctx$merge_effects(ctx.env, effects, gr.effects, s, __ring_ev_fail);
  ...
  s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(body_r.hexpr), result_type, s, arm.span);
  __ring_match139: {
    const __ring_m139 = arm.pattern;
    if (__ring_m139._tag === "Wildcard") {
      __ring_match140: {
        const __ring_m140 = arm.guard;
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  for (const handler of handlers) {
    ...
    __ring_match143: {
      const __ring_m143 = effect_def;
      if (__ring_m143._tag === "some") {
        const ed = __ring_m143._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match144: {
      const __ring_m144 = handler.resume_name;
  ...
  __match_fail(__ring_m);
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match145: {
      const __ring_m145 = handler_body_result;
      if (__ring_m145._tag === "some") {
        const hbr = __ring_m145._0;
        s = hbr.subst;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match146: {
      const __ring_m146 = expected_param_types;
      if (__ring_m146._tag === "some") {
        const epts = __ring_m146._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match147: {
            const __ring_m147 = List_get(epts, pi);
            if (__ring_m147._tag === "some") {
              const expected_t = __ring_m147._0;
    ...
    __ring_match148: {
      const __ring_m148 = lam_scheme;
      if (__ring_m148._tag === "some") {
        const ls = __ring_m148._0;
        __ring_match149: {
          const __ring_m149 = ls.def_id;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match150: {
    const __ring_m150 = body_result;
    if (__ring_m150._tag === "some") {
      const body_r = __ring_m150._0;
      s = body_r.subst;
      let applied_params = [];
