...
function check_receiver_mutability(ctx, receiver, recv_type, method, span) {
  ...
  __ring_match90: {
    ...
    __ring_match91: {
      const __ring_m91 = types$type_to_builtin_name(recv_type);
  ...
  __ring_match92: {
    const __ring_m92 = type_name;
    if (__ring_m92._tag === "some") {
      const tname = __ring_m92._0;
      __ring_match93: {
        const __ring_m93 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m93._tag === "some") {
          const mut_set = __ring_m93._0;
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match94: {
    const __ring_m94 = receiver;
    if (__ring_m94._tag === "Ident") {
      const recv_name = __ring_m94.name;
      __ring_match95: {
        const __ring_m95 = _Map_get(ctx.env.types.effects, recv_name);
  ...
  if (Option_is_none(method_type)) {
    __ring_match98: {
      const __ring_m98 = types$type_to_builtin_name(recv_type);
      if (__ring_m98._tag === "some") {
        const type_name = __ring_m98._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match99: {
      const __ring_m99 = recv_var_id;
      if (__ring_m99._tag === "some") {
        const rvid = __ring_m99._0;
        for (const fb of ctx.current_fn_bounds) {
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match100: {
              const __ring_m100 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m100._tag === "some") {
                ...
                __ring_match101: {
                  const __ring_m101 = tm;
                  if (__ring_m101._tag === "some") {
                    const found_method = __ring_m101._0;
    ...
    if (__ring_m102._tag === "some") {
      ...
      __ring_match103: {
        ...
        if (__ring_m103._tag === "FnType") {
          const mt_params = __ring_m103.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match104: {
              const __ring_m104 = List_first(mt_params);
              if (__ring_m104._tag === "some") {
                const first_param = __ring_m104._0;
  ...
  const expected = env$apply_subst(s, expected_raw);
  __ring_match105: {
    const __ring_m105 = expected;
    if (__ring_m105._tag === "FnType") {
      const exp_params = __ring_m105.params;
      return infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
  ...
  __ring_match106: {
    const __ring_m106 = method_type;
    if (__ring_m106._tag === "some") {
      const mt = __ring_m106._0;
      __ring_match107: {
        const __ring_m107 = mt;
        if (__ring_m107._tag === "FnType") {
          const mt_params = __ring_m107.params; const mt_ret = __ring_m107.return_type; const mt_effects = __ring_m107.effects;
          let i = 0;
          for (const harg of hargs) {
            if (((i + 1) < List_len(mt_params))) {
              __ring_match108: {
                const __ring_m108 = List_get(mt_params, (i + 1));
                if (__ring_m108._tag === "some") {
                  const expected_param = __ring_m108._0;
  ...
  let resolved_dicts = [];
  __ring_match111: {
    const __ring_m111 = method_scheme;
    if (__ring_m111._tag === "some") {
      const ms = __ring_m111._0;
      if ((List_len(ms.bounds) > 0)) {
        __ring_match112: {
          const __ring_m112 = method_type;
          if (__ring_m112._tag === "some") {
            const mt = __ring_m112._0;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match113: {
    const __ring_m113 = _Map_get(ctx.env.trait_reg.impl_methods, type_name);
    if (__ring_m113._tag === "some") {
      const impl_methods = __ring_m113._0;
      __ring_match114: {
        const __ring_m114 = _Map_get(impl_methods, method);
        if (__ring_m114._tag === "some") {
          const scheme = __ring_m114._0;
...
function lookup_trait_method(ctx, type_name, method, span) {
  ...
  for (const impl_entry of ctx.env.trait_reg.trait_impls) {
    if ((impl_entry.target_type_name === type_name)) {
      __ring_match115: {
        const __ring_m115 = _Map_get(ctx.env.trait_reg.traits, impl_entry.trait_name);
        if (__ring_m115._tag === "some") {
          const trait_def = __ring_m115._0;
          const tm = ((__a) => { const __i = __a.findIndex((function(m) { return (m.name === method); })); return __i >= 0 ? { _tag: "some", _0: __a[__i] } : { _tag: "none" }; })(trait_def.methods);
          __ring_match116: {
            const __ring_m116 = tm;
            if (__ring_m116._tag === "some") {
              const found_method = __ring_m116._0;
              __ring_match117: {
                const __ring_m117 = found_trait_name;
                if (__ring_m117._tag === "some") {
                  const prev_trait = __ring_m117._0;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match118: {
    const __ring_m118 = effect_def_opt;
  ...
  for (const arg of args) {
    ...
    List_push(hargs, ar.hexpr);
    __ring_match120: {
      const __ring_m120 = List_get(inst_params, i);
      if (__ring_m120._tag === "some") {
        const param_type = __ring_m120._0;
  ...
  __ring_match121: {
    const __ring_m121 = effect_def.built_in_kind;
    if (__ring_m121._tag === "some") {
      const bik = __ring_m121._0;
      __ring_match122: {
        const __ring_m122 = bik;
        if (__ring_m122._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match122;
        }
        if (__ring_m122._tag === "BkFail") {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match123: {
    const __ring_m123 = recv_type;
    if (__ring_m123._tag === "StructType") {
      const name = __ring_m123.name; const type_params = __ring_m123.type_params;
      __ring_match124: {
        const __ring_m124 = _Map_get(ctx.env.types.structs, name);
        if (__ring_m124._tag === "some") {
          const struct_def = __ring_m124._0;
          ...
          __ring_match125: {
            ...
            if (__ring_m125._tag === "some") {
              const found_field = __ring_m125._0;
              let inst_map = map_new();
              let fi = 0;
              while (((fi < List_len(struct_def.type_param_vars)) && (fi < List_len(type_params)))) {
                __ring_match126: {
                  const __ring_m126 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m126) && __ring_m126.length === 2 && __ring_m126[0]._tag === "some" && __ring_m126[1]._tag === "some") {
                    const var_id = __ring_m126[0]._0; const tp = __ring_m126[1]._0;
    ...
    if (__ring_m123._tag === "RecordType") {
      const rec_fields = __ring_m123.fields; const tail = __ring_m123.tail;
      ...
      __ring_match127: {
        ...
        if (__ring_m127._tag === "some") {
          const found_field = __ring_m127._0;
    ...
    if (__ring_m123._tag === "TupleType") {
      ...
      __ring_match129: {
        const __ring_m129 = parse_int(field);
        ...
        if (__ring_m129._tag === "some") {
          ...
          __ring_match130: {
            const __ring_m130 = List_get(elements, i);
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  let resolved_qualifier = qualifier;
  __ring_match131: {
    const __ring_m131 = qualifier;
    if (__ring_m131._tag === "some") {
      const q = __ring_m131._0;
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match132: {
          const __ring_m132 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m132._tag === "some") {
            const prefix = __ring_m132._0;
            if ((prefix === "")) {
              resolved_qualifier = Option_none;
            } else {
              resolved_qualifier = Option_some(prefix);
  ...
  __ring_match136: {
    const __ring_m136 = resolved_qualifier;
    if (__ring_m136._tag === "some") {
      const q = __ring_m136._0;
      __ring_match137: {
        const __ring_m137 = _Map_get(ctx.env.types.enums, q);
        ...
        if (__ring_m137._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match138: {
              const __ring_m138 = _Map_get(ctx.env.types.enums, full_q);
              if (__ring_m138._tag === "some") {
                const enum_def = __ring_m138._0;
                if (enum_def.variants.some((function(v) { return (v.name === name); }))) {
                  variant_enum = Option_some(enum_def.name);
                }
  ...
  __ring_match140: {
    const __ring_m140 = variant_enum;
    if (__ring_m140._tag === "some") {
      const ve = __ring_m140._0;
      __ring_match141: {
        const __ring_m141 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m141._tag === "some") {
          const enum_def = __ring_m141._0;
          ...
          __ring_match142: {
            const __ring_m142 = variant;
            if (__ring_m142._tag === "some") {
              const v = __ring_m142._0;
              __ring_match143: {
                const __ring_m143 = v.field_names;
  ...
  __ring_match144: {
    const __ring_m144 = struct_def_opt;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match145: {
      const __ring_m145 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m145._tag === "some") {
        const var_id = __ring_m145._0;
  ...
  __ring_match146: {
    const __ring_m146 = spread;
    if (__ring_m146._tag === "some") {
      const sp = __ring_m146._0;
  ...
  for (const field of fields) {
    ...
    __ring_match147: {
      const __ring_m147 = def_field;
      if (__ring_m147._tag === "some") {
        const df = __ring_m147._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  ...
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match148: {
      const __ring_m148 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m148._tag === "some") {
        const var_id = __ring_m148._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  let hspread = Option_none;
  __ring_match149: {
    const __ring_m149 = spread;
    if (__ring_m149._tag === "some") {
      const sp = __ring_m149._0;
      const sr = infer_expr(ctx, sp, s, __ring_ev_fail);
      s = sr.subst;
      const me = infer_ctx$merge_effects(ctx.env, effects, sr.effects, s, __ring_ev_fail);
      effects = me[0];
  ...
  for (const field of fields) {
    ...
    __ring_match150: {
      const __ring_m150 = field_idx;
      if (__ring_m150._tag === "some") {
        const idx = __ring_m150._0;
        __ring_match151: {
          const __ring_m151 = List_get(variant.fields, idx);
          if (__ring_m151._tag === "some") {
            const ftype = __ring_m151._0;
...
function rewrite_bare_enum_bindings(env, pattern) {
  __ring_match152: {
    const __ring_m152 = pattern;
    if (__ring_m152._tag === "Binding") {
      const name = __ring_m152.name; const span = __ring_m152.span;
      __ring_match153: {
        const __ring_m153 = _Map_get(env.types.variant_to_enum, name);
        if (__ring_m153._tag === "some") {
          const ve = __ring_m153._0;
          __ring_match154: {
            const __ring_m154 = _Map_get(env.types.enums, ve);
            if (__ring_m154._tag === "some") {
              const edef = __ring_m154._0;
    ...
    if (__ring_m152._tag === "TuplePattern") {
      const elements = __ring_m152.elements; const span = __ring_m152.span;
      let new_elems = [];
    ...
    if (__ring_m152._tag === "Constructor") {
      const name = __ring_m152.name; const qualifier = __ring_m152.qualifier; const fields = __ring_m152.fields; const span = __ring_m152.span;
      let new_fields = [];
      for (const f of fields) {
    ...
    if (__ring_m152._tag === "NamedConstructor") {
      const name = __ring_m152.name; const qualifier = __ring_m152.qualifier; const fields = __ring_m152.fields; const rest = __ring_m152.rest; const span = __ring_m152.span;
      let new_fields = [];
      for (const f of fields) {
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match158: {
    const __ring_m158 = missing;
    if (__ring_m158._tag === "some") {
      const m = __ring_m158._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  let result_type = types$UNIT;
  __ring_match159: {
    const __ring_m159 = else_branch;
    if (__ring_m159._tag === "some") {
      const eb = __ring_m159._0;
      __ring_match160: {
        const __ring_m160 = eb;
        if (__ring_m160._tag === "Block") {
        ...
        if (__ring_m160._tag === "IfExpr") {
          const ec = __ring_m160.condition; const etb = __ring_m160.then_branch; const eeb = __ring_m160.else_branch; const espan = __ring_m160.span;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  for (const part of parts) {
    __ring_match161: {
      ...
      if (__ring_m161._tag === "LitPart") {
        const str_val = __ring_m161._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match161;
      }
      if (__ring_m161._tag === "ExprPart") {
        const expr = __ring_m161._0;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  for (const eff of effects.effects) {
    __ring_match162: {
      const __ring_m162 = eff;
      if (__ring_m162._tag === "FailEffect") {
        const et = __ring_m162.error_type;
        if (found_fail) {
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  for (const handler of handlers) {
    ...
    __ring_match166: {
      const __ring_m166 = effect_def;
      if (__ring_m166._tag === "some") {
        const ed = __ring_m166._0;
    ...
    __ring_match167: {
      const __ring_m167 = effect_def;
      if (__ring_m167._tag === "some") {
        const ed = __ring_m167._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match168: {
      const __ring_m168 = handler.resume_name;
  ...
  __match_fail(__ring_m);
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match169: {
      const __ring_m169 = handler_body_result;
      if (__ring_m169._tag === "some") {
        const hbr = __ring_m169._0;
        s = hbr.subst;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match170: {
      const __ring_m170 = expected_param_types;
      if (__ring_m170._tag === "some") {
        const epts = __ring_m170._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match171: {
            const __ring_m171 = List_get(epts, pi);
            if (__ring_m171._tag === "some") {
              const expected_t = __ring_m171._0;
    ...
    __ring_match172: {
      const __ring_m172 = lam_scheme;
      if (__ring_m172._tag === "some") {
        const ls = __ring_m172._0;
        __ring_match173: {
          const __ring_m173 = ls.def_id;
          if (__ring_m173._tag === "some") {
            const did = __ring_m173._0;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match174: {
    const __ring_m174 = body_result;
    if (__ring_m174._tag === "some") {
      const body_r = __ring_m174._0;
      s = body_r.subst;
      let applied_params = [];
