...
})()); } catch (__ring_e) { if (__ring_e instanceof __EffectAbort && __ring_e.effect === "fail") { const __ring_err = __ring_e.value; if (true) { return Option_none; } } throw __ring_e; } })();
      env$TypeEnv_pop_scope(ctx.env);
      __ring_match30: {
...
function check_trait_default_body(ctx, trait_name, self_var, hparams, body, __ring_ev_fail) {
  ...
  const body_result = (function() { const __ring_ev_fail = { raise: (__ring_err) => { throw new __EffectAbort("fail", __ring_err); } }; try { return Option_some(infer_block(ctx, body, Option_none, __ring_ev_fail)); } catch (__ring_e) { if (__ring_e instanceof __EffectAbort && __ring_e.effect === "fail") { const __ring_err = __ring_e.value; if (true) { return Option_none; } } throw __ring_e; } })();
  env$TypeEnv_pop_scope(ctx.env);
...
function check(ctx, program, __ring_ev_fail) {
  ...
  for (const decl of program.decls) {
    const result = Option_some(check_one_decl(ctx, decl, hdecls, __ring_ev_fail));
  }
