...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match83: {
    const __ring_m83 = resolved_callee_type;
    if (__ring_m83._tag === "FnType") {
      const fn_effects = __ring_m83.effects;
  ...
  __ring_match84: {
    ...
    if (__ring_m84._tag === "Ident") {
      ...
      __ring_match85: {
        const __ring_m85 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m85._tag === "some") {
          const callee_scheme = __ring_m85._0;
  ...
  __ring_match86: {
    const __ring_m86 = callee;
    if (__ring_m86._tag === "Ident") {
      const callee_name = __ring_m86.name;
      __ring_match87: {
        const __ring_m87 = _Map_get(ctx.fn_mut_params, callee_name);
        if (__ring_m87._tag === "some") {
          const mut_flags = __ring_m87._0;
          let mi = 0;
          while (((mi < List_len(mut_flags)) && (mi < List_len(args)))) {
            __ring_match88: {
              const __ring_m88 = [List_get(mut_flags, mi), List_get(hargs, mi)];
              if (Array.isArray(__ring_m88) && __ring_m88.length === 2 && __ring_m88[0]._tag === "some" && __ring_m88[1]._tag === "some") {
                const is_mut = __ring_m88[0]._0; const harg = __ring_m88[1]._0;
                if (is_mut) {
                  __ring_match89: {
                    const __ring_m89 = harg;
                    if (__ring_m89._tag === "Ident" && __ring_m89.def_id._tag === "some") {
                      const arg_did = __ring_m89.def_id._0;
                      if (_Set_contains(ctx.env.scope.mutable_vars, arg_did, __Int_Eq)) {
                        __ring_match90: {
                          const __ring_m90 = resolved_callee_type;
                          if (__ring_m90._tag === "FnType") {
                            const fn_params = __ring_m90.params;
                            __ring_match91: {
                              const __ring_m91 = List_get(fn_params, mi);
                              if (__ring_m91._tag === "some") {
                                const pt = __ring_m91._0;
...
function resolve_arg_dict_closure(ctx, harg, s) {
  __ring_match92: {
    const __ring_m92 = harg;
    if (__ring_m92._tag === "Ident") {
      const name = __ring_m92.name; const resolved_name = __ring_m92.resolved_name; const def_id = __ring_m92.def_id; const ty = __ring_m92.ty; const effects = __ring_m92.effects; const span = __ring_m92.span;
      const arg_scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match93: {
        const __ring_m93 = arg_scheme;
        if (__ring_m93._tag === "some") {
          const as_ = __ring_m93._0;
          ...
          for (const bound of as_.bounds) {
            __ring_match94: {
              const __ring_m94 = _Map_get(var_map, bound.type_var);
              if (__ring_m94._tag === "some") {
                const fresh_var = __ring_m94._0;
...
function resolve_arg_bound_dict(ctx, concrete, trait_name, dicts) {
  __ring_match95: {
    const __ring_m95 = concrete;
    if (__ring_m95._tag === "StructType") {
      const name = __ring_m95.name;
    ...
    if (__ring_m95._tag === "TypeVar") {
      ...
      __ring_match96: {
        const __ring_m96 = matching;
        if (__ring_m96._tag === "some") {
          const fb = __ring_m96._0;
    ...
    __ring_match97: {
      const __ring_m97 = types$type_to_builtin_name(concrete);
      if (__ring_m97._tag === "some") {
        const prim_name = __ring_m97._0;
...
function check_expr_is_let_def(ctx, expr) {
  __ring_match98: {
    const __ring_m98 = expr;
    if (__ring_m98._tag === "Ident") {
      const name = __ring_m98.name;
      __ring_match99: {
        const __ring_m99 = env$TypeEnv_lookup(ctx.env, name);
        if (__ring_m99._tag === "some") {
          const s = __ring_m99._0;
          __ring_match100: {
            const __ring_m100 = s.def_id;
            if (__ring_m100._tag === "some") {
              const did = __ring_m100._0;
    ...
    if (__ring_m98._tag === "FieldAccess") {
      const inner = __ring_m98.receiver;
...
function get_expr_def_id(ctx, expr) {
  __ring_match101: {
    const __ring_m101 = expr;
    if (__ring_m101._tag === "Ident") {
      const name = __ring_m101.name;
      __ring_match102: {
        const __ring_m102 = env$TypeEnv_lookup(ctx.env, name);
        if (__ring_m102._tag === "some") {
          const s = __ring_m102._0;
          return s.def_id;
...
function is_mut_method_call(ctx, recv_type, method) {
  ...
  __ring_match103: {
    ...
    __ring_match104: {
      const __ring_m104 = types$type_to_builtin_name(recv_type);
      if (__ring_m104._tag === "some") {
        const n = __ring_m104._0;
  ...
  __ring_match105: {
    const __ring_m105 = type_name;
    if (__ring_m105._tag === "some") {
      const tname = __ring_m105._0;
      __ring_match106: {
        const __ring_m106 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m106._tag === "some") {
          const mut_set = __ring_m106._0;
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match111: {
    const __ring_m111 = receiver;
    if (__ring_m111._tag === "Ident") {
      const recv_name = __ring_m111.name; const qualifier = __ring_m111.qualifier;
  ...
  __match_fail(__ring_m);
      ...
      __ring_match112: {
        const __ring_m112 = _Map_get(ctx.env.types.effects, full_effect_name);
  ...
  if (is_mut_method_call(ctx, recv_type, method)) {
    __ring_match113: {
      const __ring_m113 = get_expr_def_id(ctx, receiver);
      if (__ring_m113._tag === "some") {
        const did = __ring_m113._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match115: {
      ...
      if (__ring_m115._tag === "some") {
        const prim_name = __ring_m115._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match116: {
      ...
      if (__ring_m116._tag === "some") {
        const type_name = __ring_m116._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match117: {
      const __ring_m117 = recv_var_id;
      if (__ring_m117._tag === "some") {
        const rvid = __ring_m117._0;
        for (const fb of ctx.current_fn_bounds) {
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match118: {
              const __ring_m118 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m118._tag === "some") {
                const trait_def = __ring_m118._0;
                ...
                __ring_match119: {
                  const __ring_m119 = tm;
                  if (__ring_m119._tag === "some") {
                    const found_method = __ring_m119._0;
  ...
  __ring_match120: {
    const __ring_m120 = method_type;
    if (__ring_m120._tag === "some") {
      const mt = __ring_m120._0;
      __ring_match121: {
        const __ring_m121 = mt;
        if (__ring_m121._tag === "FnType") {
          const mt_params = __ring_m121.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match122: {
              const __ring_m122 = List_first(mt_params);
              if (__ring_m122._tag === "some") {
                const first_param = __ring_m122._0;
  ...
  const expected = env$apply_subst(s, expected_raw);
  __ring_match123: {
    const __ring_m123 = expected;
    if (__ring_m123._tag === "FnType") {
      const exp_params = __ring_m123.params;
      return infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
    ...
    if (__ring_m124._tag === "some") {
      ...
      __ring_match125: {
        ...
        if (__ring_m125._tag === "FnType") {
          const mt_params = __ring_m125.params; const mt_ret = __ring_m125.return_type; const mt_effects = __ring_m125.effects;
          let i = 0;
          for (const harg of hargs) {
            if (((i + 1) < List_len(mt_params))) {
              __ring_match126: {
                const __ring_m126 = List_get(mt_params, (i + 1));
                if (__ring_m126._tag === "some") {
                  const expected_param = __ring_m126._0;
  ...
  let resolved_dicts = [];
  __ring_match129: {
    const __ring_m129 = method_scheme;
    if (__ring_m129._tag === "some") {
      const ms = __ring_m129._0;
      if ((List_len(ms.bounds) > 0)) {
        __ring_match130: {
          const __ring_m130 = method_type;
          if (__ring_m130._tag === "some") {
            const mt = __ring_m130._0;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match131: {
    const __ring_m131 = _Map_get(ctx.env.trait_reg.impl_methods, type_name);
    if (__ring_m131._tag === "some") {
      const impl_methods = __ring_m131._0;
      __ring_match132: {
        const __ring_m132 = _Map_get(impl_methods, method);
        if (__ring_m132._tag === "some") {
          const scheme = __ring_m132._0;
...
function lookup_trait_method(ctx, type_name, method, span) {
  ...
  for (const impl_entry of ctx.env.trait_reg.trait_impls) {
    if ((impl_entry.target_type_name === type_name)) {
      __ring_match133: {
        const __ring_m133 = _Map_get(ctx.env.trait_reg.traits, impl_entry.trait_name);
        if (__ring_m133._tag === "some") {
          const trait_def = __ring_m133._0;
          const tm = ((__a) => { const __i = __a.findIndex((function(m) { return (m.name === method); })); return __i >= 0 ? { _tag: "some", _0: __a[__i] } : { _tag: "none" }; })(trait_def.methods);
          __ring_match134: {
            const __ring_m134 = tm;
            if (__ring_m134._tag === "some") {
              const found_method = __ring_m134._0;
              __ring_match135: {
                const __ring_m135 = found_trait_name;
                if (__ring_m135._tag === "some") {
                  const prev_trait = __ring_m135._0;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match136: {
    const __ring_m136 = effect_def_opt;
  ...
  for (const arg of args) {
    ...
    List_push(hargs, ar.hexpr);
    __ring_match138: {
      const __ring_m138 = List_get(inst_params, i);
      if (__ring_m138._tag === "some") {
        const param_type = __ring_m138._0;
  ...
  __ring_match139: {
    const __ring_m139 = effect_def.built_in_kind;
    if (__ring_m139._tag === "some") {
      const bik = __ring_m139._0;
      __ring_match140: {
        const __ring_m140 = bik;
        if (__ring_m140._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match140;
        }
        if (__ring_m140._tag === "BkFail") {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match141: {
    ...
    if (__ring_m141._tag === "StructType") {
      ...
      __ring_match142: {
        const __ring_m142 = _Map_get(ctx.env.types.structs, name);
        if (__ring_m142._tag === "some") {
          const struct_def = __ring_m142._0;
          ...
          __ring_match143: {
            ...
            if (__ring_m143._tag === "some") {
              ...
              while (((fi < List_len(struct_def.type_param_vars)) && (fi < List_len(type_params)))) {
                __ring_match144: {
                  const __ring_m144 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m144) && __ring_m144.length === 2 && __ring_m144[0]._tag === "some" && __ring_m144[1]._tag === "some") {
                    const var_id = __ring_m144[0]._0; const tp = __ring_m144[1]._0;
    ...
    if (__ring_m141._tag === "RecordType") {
      const rec_fields = __ring_m141.fields; const tail = __ring_m141.tail;
    ...
    if (__ring_m141._tag === "TupleType") {
      const elements = __ring_m141.elements;
      __ring_match147: {
        const __ring_m147 = parse_int(field);
        ...
        if (__ring_m147._tag === "some") {
          ...
          __ring_match148: {
            const __ring_m148 = List_get(elements, i);
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  let resolved_qualifier = qualifier;
  __ring_match149: {
    const __ring_m149 = qualifier;
    if (__ring_m149._tag === "some") {
      const q = __ring_m149._0;
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match150: {
          const __ring_m150 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m150._tag === "some") {
            const prefix = __ring_m150._0;
            if ((prefix === "")) {
              resolved_qualifier = Option_none;
            } else {
              resolved_qualifier = Option_some(prefix);
  ...
  __ring_match151: {
    const __ring_m151 = resolved_qualifier;
    if (__ring_m151._tag === "some") {
      const q = __ring_m151._0;
      const qualified_name = `${q}::${name}`;
      const mod_struct = _Map_get(ctx.env.types.structs, qualified_name);
      __ring_match152: {
        const __ring_m152 = mod_struct;
  ...
  __ring_match154: {
    const __ring_m154 = resolved_qualifier;
    if (__ring_m154._tag === "some") {
      const q = __ring_m154._0;
      __ring_match155: {
        const __ring_m155 = _Map_get(ctx.env.types.enums, q);
        if (__ring_m155._tag === "some") {
          const enum_def = __ring_m155._0;
          if (enum_def.variants.some((function(v) { return (v.name === name); }))) {
        ...
        if (__ring_m155._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match156: {
              const __ring_m156 = _Map_get(ctx.env.types.enums, full_q);
              if (__ring_m156._tag === "some") {
                const enum_def = __ring_m156._0;
                if (enum_def.variants.some((function(v) { return (v.name === name); }))) {
                  variant_enum = Option_some(enum_def.name);
                }
  ...
  if ((Option_is_none(variant_enum) && Option_is_some(resolved_qualifier))) {
    __ring_match157: {
      const __ring_m157 = resolved_qualifier;
      if (__ring_m157._tag === "some") {
        const q = __ring_m157._0;
        const _ = infer_ctx$type_error(ctx.sink, codes$E0201, `'${q}' has no variant '${name}'`, span, diagnostics$DiagnosticContext_UndefinedVariable(name, Option_none));
  ...
  __ring_match158: {
    const __ring_m158 = variant_enum;
    if (__ring_m158._tag === "some") {
      const ve = __ring_m158._0;
      __ring_match159: {
        const __ring_m159 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m159._tag === "some") {
          ...
          __ring_match160: {
            const __ring_m160 = variant;
            if (__ring_m160._tag === "some") {
              const v = __ring_m160._0;
              __ring_match161: {
                const __ring_m161 = v.field_names;
  ...
  __ring_match162: {
    const __ring_m162 = struct_def_opt;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match163: {
      const __ring_m163 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m163._tag === "some") {
        const var_id = __ring_m163._0;
  ...
  __ring_match164: {
    const __ring_m164 = spread;
    if (__ring_m164._tag === "some") {
      const sp = __ring_m164._0;
  ...
  for (const field of fields) {
    ...
    __ring_match165: {
      const __ring_m165 = def_field;
      if (__ring_m165._tag === "some") {
        const df = __ring_m165._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  ...
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match166: {
      const __ring_m166 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m166._tag === "some") {
        const var_id = __ring_m166._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  let hspread = Option_none;
  __ring_match167: {
    const __ring_m167 = spread;
    if (__ring_m167._tag === "some") {
      const sp = __ring_m167._0;
      const sr = infer_expr(ctx, sp, s, __ring_ev_fail);
      s = sr.subst;
      const me = infer_ctx$merge_effects(ctx.env, effects, sr.effects, s, __ring_ev_fail);
      effects = me[0];
  ...
  for (const field of fields) {
    ...
    __ring_match168: {
      const __ring_m168 = field_idx;
      if (__ring_m168._tag === "some") {
        const idx = __ring_m168._0;
        __ring_match169: {
          const __ring_m169 = List_get(variant.fields, idx);
          if (__ring_m169._tag === "some") {
            const ftype = __ring_m169._0;
...
function rewrite_bare_enum_bindings(env, pattern) {
  __ring_match170: {
    const __ring_m170 = pattern;
    if (__ring_m170._tag === "Binding") {
      const name = __ring_m170.name; const span = __ring_m170.span;
      __ring_match171: {
        const __ring_m171 = _Map_get(env.types.variant_to_enum, name);
        if (__ring_m171._tag === "some") {
          const ve = __ring_m171._0;
          __ring_match172: {
            const __ring_m172 = _Map_get(env.types.enums, ve);
            if (__ring_m172._tag === "some") {
              const edef = __ring_m172._0;
    ...
    if (__ring_m170._tag === "TuplePattern") {
      const elements = __ring_m170.elements; const span = __ring_m170.span;
      let new_elems = [];
    ...
    if (__ring_m170._tag === "Constructor") {
      const name = __ring_m170.name; const qualifier = __ring_m170.qualifier; const fields = __ring_m170.fields; const span = __ring_m170.span;
      let new_fields = [];
      for (const f of fields) {
    ...
    if (__ring_m170._tag === "NamedConstructor") {
      const name = __ring_m170.name; const qualifier = __ring_m170.qualifier; const fields = __ring_m170.fields; const rest = __ring_m170.rest; const span = __ring_m170.span;
      let new_fields = [];
      for (const f of fields) {
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match174: {
    const __ring_m174 = arm.guard;
    if (__ring_m174._tag === "some") {
      const g = __ring_m174._0;
  ...
  __ring_match176: {
    const __ring_m176 = missing;
    if (__ring_m176._tag === "some") {
      const m = __ring_m176._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  __ring_match177: {
    ...
    if (__ring_m177._tag === "some") {
      ...
      __ring_match178: {
        const __ring_m178 = eb;
        if (__ring_m178._tag === "Block") {
        ...
        if (__ring_m178._tag === "IfExpr") {
          const ec = __ring_m178.condition; const etb = __ring_m178.then_branch; const eeb = __ring_m178.else_branch; const espan = __ring_m178.span;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  for (const part of parts) {
    __ring_match179: {
      const __ring_m179 = part;
      if (__ring_m179._tag === "LitPart") {
        const str_val = __ring_m179._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match179;
      }
      if (__ring_m179._tag === "ExprPart") {
        const expr = __ring_m179._0;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  for (const eff of effects.effects) {
    __ring_match180: {
      const __ring_m180 = eff;
      if (__ring_m180._tag === "FailEffect") {
        const et = __ring_m180.error_type;
        if (found_fail) {
  ...
  __ring_match183: {
    const __ring_m183 = missing;
    if (__ring_m183._tag === "some") {
      const m = __ring_m183._0;
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  for (const handler of handlers) {
    ...
    __ring_match184: {
      const __ring_m184 = effect_def;
      if (__ring_m184._tag === "some") {
        const ed = __ring_m184._0;
    ...
    __ring_match185: {
      const __ring_m185 = effect_def;
      if (__ring_m185._tag === "some") {
        const ed = __ring_m185._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match186: {
      const __ring_m186 = handler.resume_name;
  ...
  __match_fail(__ring_m);
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match187: {
      const __ring_m187 = handler_body_result;
      if (__ring_m187._tag === "some") {
        const hbr = __ring_m187._0;
        s = hbr.subst;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match188: {
      const __ring_m188 = expected_param_types;
      if (__ring_m188._tag === "some") {
        const epts = __ring_m188._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match189: {
            const __ring_m189 = List_get(epts, pi);
            if (__ring_m189._tag === "some") {
              const expected_t = __ring_m189._0;
    ...
    __ring_match190: {
      const __ring_m190 = lam_scheme;
      if (__ring_m190._tag === "some") {
        const ls = __ring_m190._0;
        __ring_match191: {
          const __ring_m191 = ls.def_id;
          if (__ring_m191._tag === "some") {
            const did = __ring_m191._0;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match192: {
    const __ring_m192 = body_result;
    if (__ring_m192._tag === "some") {
      const body_r = __ring_m192._0;
      s = body_r.subst;
      let applied_params = [];
