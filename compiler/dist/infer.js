...
function is_primitive_eq(t) {
  __ring_match62: {
    ...
    if (__ring_m62._tag === "UnitType") {
      return true;
      break __ring_match62;
    }
    if (__ring_m62._tag === "NeverType") {
      return true;
      break __ring_match62;
    }
    if (__ring_m62._tag === "AnyType") {
      return true;
      break __ring_match62;
    }
    return false;
...
function resolve_trait_dispatch(ctx, resolved, trait_name, error_code, subst, span, op, is_builtin) {
  ...
  __ring_match66: {
    const __ring_m66 = bound_resolved;
    if (__ring_m66._tag === "TypeVar") {
      const bid = __ring_m66.id;
      return (bid === id);
    ...
    break __ring_match66;
      ...
      __ring_match67: {
        const __ring_m67 = bound;
        if (__ring_m67._tag === "some") {
          const b = __ring_m67._0;
      ...
      __ring_match68: {
        const __ring_m68 = _Map_get(ctx.env.scope.var_bounds, id);
        if (__ring_m68._tag === "some") {
          const var_bounds = __ring_m68._0;
    ...
    if (__ring_m65._tag === "StructType") {
      const name = __ring_m65.name; const type_params = __ring_m65.type_params;
  ...
  __ring_match74: {
    ...
    if (__ring_m74._tag === "Neg") {
      ...
      __ring_match75: {
        ...
        if (__ring_m75._tag === "IntType") {
          result_type = types$INT;
          break __ring_match75;
        }
        if (__ring_m75._tag === "FloatType") {
...
function infer_call(ctx, callee, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match76: {
    const __ring_m76 = expected;
    if (__ring_m76._tag === "FnType") {
      const exp_params = __ring_m76.params;
  ...
  __ring_match77: {
    const __ring_m77 = resolved_callee_type;
    if (__ring_m77._tag === "FnType") {
      const fn_effects = __ring_m77.effects;
  ...
  let resolved_dicts = [];
  __ring_match78: {
    const __ring_m78 = callee;
    if (__ring_m78._tag === "Ident") {
      const callee_name = __ring_m78.name;
      __ring_match79: {
        const __ring_m79 = env$TypeEnv_lookup(ctx.env, callee_name);
        if (__ring_m79._tag === "some") {
          const callee_scheme = __ring_m79._0;
...
function resolve_arg_dict_closure(ctx, harg, s) {
  __ring_match80: {
    const __ring_m80 = harg;
    if (__ring_m80._tag === "Ident") {
      const name = __ring_m80.name; const resolved_name = __ring_m80.resolved_name; const def_id = __ring_m80.def_id; const ty = __ring_m80.ty; const effects = __ring_m80.effects; const span = __ring_m80.span;
      const arg_scheme = env$TypeEnv_lookup(ctx.env, name);
      __ring_match81: {
        const __ring_m81 = arg_scheme;
        if (__ring_m81._tag === "some") {
          const as_ = __ring_m81._0;
          ...
          for (const bound of as_.bounds) {
            __ring_match82: {
              const __ring_m82 = _Map_get(var_map, bound.type_var);
              if (__ring_m82._tag === "some") {
                const fresh_var = __ring_m82._0;
...
function resolve_arg_bound_dict(ctx, concrete, trait_name, dicts) {
  __ring_match83: {
    ...
    if (__ring_m83._tag === "TypeVar") {
      ...
      __ring_match84: {
        const __ring_m84 = matching;
        if (__ring_m84._tag === "some") {
          const fb = __ring_m84._0;
    ...
    __ring_match85: {
      const __ring_m85 = types$type_to_builtin_name(concrete);
      if (__ring_m85._tag === "some") {
        const prim_name = __ring_m85._0;
...
function check_expr_is_let_def(ctx, expr) {
  __ring_match86: {
    const __ring_m86 = expr;
    if (__ring_m86._tag === "Ident") {
      const name = __ring_m86.name;
      __ring_match87: {
        const __ring_m87 = env$TypeEnv_lookup(ctx.env, name);
        if (__ring_m87._tag === "some") {
          const s = __ring_m87._0;
          __ring_match88: {
            const __ring_m88 = s.def_id;
            if (__ring_m88._tag === "some") {
              const did = __ring_m88._0;
    ...
    if (__ring_m86._tag === "FieldAccess") {
      const inner = __ring_m86.receiver;
...
function check_receiver_mutability(ctx, receiver, recv_type, method, span) {
  ...
  __ring_match89: {
    const __ring_m89 = recv_type;
    if (__ring_m89._tag === "StructType") {
      const name = __ring_m89.name;
      type_name = Option_some(name);
      break __ring_match89;
    }
    if (__ring_m89._tag === "EnumType") {
      const name = __ring_m89.name;
      type_name = Option_some(name);
      break __ring_match89;
    }
    __ring_match90: {
      const __ring_m90 = types$type_to_builtin_name(recv_type);
      if (__ring_m90._tag === "some") {
        const n = __ring_m90._0;
  ...
  __ring_match91: {
    const __ring_m91 = type_name;
    if (__ring_m91._tag === "some") {
      const tname = __ring_m91._0;
      __ring_match92: {
        const __ring_m92 = _Map_get(ctx.env.trait_reg.mut_methods, tname);
        if (__ring_m92._tag === "some") {
          const mut_set = __ring_m92._0;
...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match93: {
    const __ring_m93 = receiver;
    if (__ring_m93._tag === "Ident") {
      const recv_name = __ring_m93.name;
      __ring_match94: {
        const __ring_m94 = _Map_get(ctx.env.types.effects, recv_name);
  ...
  if (Option_is_none(method_type)) {
    __ring_match96: {
      const __ring_m96 = types$type_to_builtin_name(recv_type);
      if (__ring_m96._tag === "some") {
        const prim_name = __ring_m96._0;
  ...
  if (Option_is_none(method_type)) {
    __ring_match98: {
      const __ring_m98 = recv_var_id;
      if (__ring_m98._tag === "some") {
        const rvid = __ring_m98._0;
        for (const fb of ctx.current_fn_bounds) {
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match99: {
              const __ring_m99 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m99._tag === "some") {
                const trait_def = __ring_m99._0;
                ...
                __ring_match100: {
                  const __ring_m100 = tm;
                  if (__ring_m100._tag === "some") {
                    const found_method = __ring_m100._0;
  ...
  __ring_match101: {
    const __ring_m101 = method_type;
    if (__ring_m101._tag === "some") {
      const mt = __ring_m101._0;
      __ring_match102: {
        const __ring_m102 = mt;
        if (__ring_m102._tag === "FnType") {
          const mt_params = __ring_m102.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match103: {
              const __ring_m103 = List_first(mt_params);
              if (__ring_m103._tag === "some") {
                const first_param = __ring_m103._0;
  ...
  const expected = env$apply_subst(s, expected_raw);
  __ring_match104: {
    const __ring_m104 = expected;
    if (__ring_m104._tag === "FnType") {
      const exp_params = __ring_m104.params;
      return infer_lambda(ctx, lparams, lbody, lspan, s, Option_some(exp_params), __ring_ev_fail);
  ...
  __ring_match105: {
    const __ring_m105 = method_type;
    if (__ring_m105._tag === "some") {
      const mt = __ring_m105._0;
      __ring_match106: {
        const __ring_m106 = mt;
        if (__ring_m106._tag === "FnType") {
          const mt_params = __ring_m106.params; const mt_ret = __ring_m106.return_type; const mt_effects = __ring_m106.effects;
          let i = 0;
          for (const harg of hargs) {
            if (((i + 1) < List_len(mt_params))) {
              __ring_match107: {
                const __ring_m107 = List_get(mt_params, (i + 1));
                if (__ring_m107._tag === "some") {
                  const expected_param = __ring_m107._0;
  ...
  let resolved_dicts = [];
  __ring_match110: {
    const __ring_m110 = method_scheme;
    if (__ring_m110._tag === "some") {
      const ms = __ring_m110._0;
      if ((List_len(ms.bounds) > 0)) {
        __ring_match111: {
          const __ring_m111 = method_type;
          if (__ring_m111._tag === "some") {
            const mt = __ring_m111._0;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match112: {
    const __ring_m112 = _Map_get(ctx.env.trait_reg.impl_methods, type_name);
    if (__ring_m112._tag === "some") {
      const impl_methods = __ring_m112._0;
      __ring_match113: {
        const __ring_m113 = _Map_get(impl_methods, method);
...
function lookup_trait_method(ctx, type_name, method, span) {
  ...
  for (const impl_entry of ctx.env.trait_reg.trait_impls) {
    if ((impl_entry.target_type_name === type_name)) {
      __ring_match114: {
        const __ring_m114 = _Map_get(ctx.env.trait_reg.traits, impl_entry.trait_name);
        if (__ring_m114._tag === "some") {
          const trait_def = __ring_m114._0;
          const tm = ((__a) => { const __i = __a.findIndex((function(m) { return (m.name === method); })); return __i >= 0 ? { _tag: "some", _0: __a[__i] } : { _tag: "none" }; })(trait_def.methods);
          __ring_match115: {
            const __ring_m115 = tm;
            if (__ring_m115._tag === "some") {
              const found_method = __ring_m115._0;
              __ring_match116: {
                const __ring_m116 = found_trait_name;
                if (__ring_m116._tag === "some") {
                  const prev_trait = __ring_m116._0;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match117: {
    const __ring_m117 = effect_def_opt;
  ...
  for (const arg of args) {
    ...
    List_push(hargs, ar.hexpr);
    __ring_match119: {
      const __ring_m119 = List_get(inst_params, i);
      if (__ring_m119._tag === "some") {
        const param_type = __ring_m119._0;
  ...
  __ring_match120: {
    const __ring_m120 = effect_def.built_in_kind;
    if (__ring_m120._tag === "some") {
      const bik = __ring_m120._0;
      __ring_match121: {
        const __ring_m121 = bik;
        if (__ring_m121._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match121;
        }
        if (__ring_m121._tag === "BkFail") {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match122: {
    ...
    if (__ring_m122._tag === "StructType") {
      ...
      __ring_match123: {
        const __ring_m123 = _Map_get(ctx.env.types.structs, name);
        if (__ring_m123._tag === "some") {
          const struct_def = __ring_m123._0;
          ...
          __ring_match124: {
            ...
            if (__ring_m124._tag === "some") {
              const found_field = __ring_m124._0;
              let inst_map = map_new();
              let fi = 0;
              while (((fi < List_len(struct_def.type_param_vars)) && (fi < List_len(type_params)))) {
                __ring_match125: {
                  const __ring_m125 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m125) && __ring_m125.length === 2 && __ring_m125[0]._tag === "some" && __ring_m125[1]._tag === "some") {
                    const var_id = __ring_m125[0]._0; const tp = __ring_m125[1]._0;
    ...
    if (__ring_m122._tag === "RecordType") {
      const rec_fields = __ring_m122.fields; const tail = __ring_m122.tail;
    ...
    if (__ring_m122._tag === "TupleType") {
      const elements = __ring_m122.elements;
      __ring_match128: {
        const __ring_m128 = parse_int(field);
        ...
        if (__ring_m128._tag === "some") {
          ...
          __ring_match129: {
            const __ring_m129 = List_get(elements, i);
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  ...
  __ring_match130: {
    ...
    if (__ring_m130._tag === "some") {
      ...
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match131: {
          const __ring_m131 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m131._tag === "some") {
            const prefix = __ring_m131._0;
            if ((prefix === "")) {
              resolved_qualifier = Option_none;
            } else {
              resolved_qualifier = Option_some(prefix);
  ...
  __ring_match135: {
    ...
    if (__ring_m135._tag === "some") {
      ...
      __ring_match136: {
        const __ring_m136 = _Map_get(ctx.env.types.enums, q);
        if (__ring_m136._tag === "some") {
          const enum_def = __ring_m136._0;
          if (enum_def.variants.some((function(v) { return (v.name === name); }))) {
        ...
        if (__ring_m136._tag === "none") {
          if ((List_len(ctx.mod_path_stack) > 0)) {
            ...
            __ring_match137: {
              const __ring_m137 = _Map_get(ctx.env.types.enums, full_q);
  ...
  if ((Option_is_none(variant_enum) && Option_is_some(resolved_qualifier))) {
    __ring_match138: {
      const __ring_m138 = resolved_qualifier;
  ...
  __ring_match139: {
    const __ring_m139 = variant_enum;
    if (__ring_m139._tag === "some") {
      const ve = __ring_m139._0;
      __ring_match140: {
        const __ring_m140 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m140._tag === "some") {
          const enum_def = __ring_m140._0;
          ...
          __ring_match141: {
            const __ring_m141 = variant;
            if (__ring_m141._tag === "some") {
              const v = __ring_m141._0;
              __ring_match142: {
                const __ring_m142 = v.field_names;
  ...
  __ring_match143: {
    const __ring_m143 = struct_def_opt;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match144: {
      const __ring_m144 = List_get(struct_def.type_param_vars, tpi);
  ...
  for (const field of fields) {
    ...
    __ring_match146: {
      const __ring_m146 = def_field;
      if (__ring_m146._tag === "some") {
        const df = __ring_m146._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  ...
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match147: {
      const __ring_m147 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m147._tag === "some") {
        const var_id = __ring_m147._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  let hspread = Option_none;
  __ring_match148: {
    const __ring_m148 = spread;
    if (__ring_m148._tag === "some") {
      const sp = __ring_m148._0;
      const sr = infer_expr(ctx, sp, s, __ring_ev_fail);
      s = sr.subst;
      const me = infer_ctx$merge_effects(ctx.env, effects, sr.effects, s, __ring_ev_fail);
      effects = me[0];
  ...
  for (const field of fields) {
    ...
    __ring_match149: {
      const __ring_m149 = field_idx;
      if (__ring_m149._tag === "some") {
        const idx = __ring_m149._0;
        __ring_match150: {
          const __ring_m150 = List_get(variant.fields, idx);
          if (__ring_m150._tag === "some") {
            const ftype = __ring_m150._0;
...
function rewrite_bare_enum_bindings(env, pattern) {
  __ring_match151: {
    const __ring_m151 = pattern;
    if (__ring_m151._tag === "Binding") {
      const name = __ring_m151.name; const span = __ring_m151.span;
      __ring_match152: {
        const __ring_m152 = _Map_get(env.types.variant_to_enum, name);
        if (__ring_m152._tag === "some") {
          const ve = __ring_m152._0;
          __ring_match153: {
            const __ring_m153 = _Map_get(env.types.enums, ve);
            if (__ring_m153._tag === "some") {
              const edef = __ring_m153._0;
    ...
    if (__ring_m151._tag === "TuplePattern") {
      const elements = __ring_m151.elements; const span = __ring_m151.span;
      let new_elems = [];
    ...
    if (__ring_m151._tag === "Constructor") {
      const name = __ring_m151.name; const qualifier = __ring_m151.qualifier; const fields = __ring_m151.fields; const span = __ring_m151.span;
      let new_fields = [];
      for (const f of fields) {
    ...
    if (__ring_m151._tag === "NamedConstructor") {
      const name = __ring_m151.name; const qualifier = __ring_m151.qualifier; const fields = __ring_m151.fields; const rest = __ring_m151.rest; const span = __ring_m151.span;
      let new_fields = [];
      for (const f of fields) {
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  let result_type = types$UNIT;
  __ring_match158: {
    const __ring_m158 = else_branch;
    if (__ring_m158._tag === "some") {
      const eb = __ring_m158._0;
      __ring_match159: {
        const __ring_m159 = eb;
        if (__ring_m159._tag === "Block") {
        ...
        if (__ring_m159._tag === "IfExpr") {
          const ec = __ring_m159.condition; const etb = __ring_m159.then_branch; const eeb = __ring_m159.else_branch; const espan = __ring_m159.span;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  for (const part of parts) {
    __ring_match160: {
      const __ring_m160 = part;
      if (__ring_m160._tag === "LitPart") {
        const str_val = __ring_m160._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match160;
      }
      if (__ring_m160._tag === "ExprPart") {
        const expr = __ring_m160._0;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  for (const eff of effects.effects) {
    __ring_match161: {
      const __ring_m161 = eff;
      if (__ring_m161._tag === "FailEffect") {
        const et = __ring_m161.error_type;
        if (found_fail) {
  ...
  let guard_hexpr = Option_none;
  __ring_match162: {
    const __ring_m162 = arm.guard;
    if (__ring_m162._tag === "some") {
      const g = __ring_m162._0;
      const gr = infer_expr(ctx, g, s, __ring_ev_fail);
      s = gr.subst;
      s = infer_ctx$unify_at(ctx.sink, ctx.env, hir$hexpr_type(gr.hexpr), types$BOOL, s, arm.span);
      const me = infer_ctx$merge_effects(ctx.env, effects, gr.effects, s, __ring_ev_fail);
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  for (const handler of handlers) {
    ...
    __ring_match165: {
      const __ring_m165 = effect_def;
      if (__ring_m165._tag === "some") {
        const ed = __ring_m165._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match167: {
      const __ring_m167 = handler.resume_name;
  ...
  __match_fail(__ring_m);
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match168: {
      const __ring_m168 = handler_body_result;
      if (__ring_m168._tag === "some") {
        const hbr = __ring_m168._0;
        s = hbr.subst;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match169: {
      const __ring_m169 = expected_param_types;
      if (__ring_m169._tag === "some") {
        const epts = __ring_m169._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match170: {
            const __ring_m170 = List_get(epts, pi);
            if (__ring_m170._tag === "some") {
              const expected_t = __ring_m170._0;
    ...
    __ring_match171: {
      const __ring_m171 = lam_scheme;
      if (__ring_m171._tag === "some") {
        const ls = __ring_m171._0;
        __ring_match172: {
          const __ring_m172 = ls.def_id;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match173: {
    const __ring_m173 = body_result;
    if (__ring_m173._tag === "some") {
      const body_r = __ring_m173._0;
      s = body_r.subst;
      let applied_params = [];
