...
function infer_method_call(ctx, receiver, method, args, span, subst, __ring_ev_fail) {
  __ring_match75: {
    const __ring_m75 = receiver;
    if (__ring_m75._tag === "Ident") {
      const recv_name = __ring_m75.name;
      __ring_match76: {
        const __ring_m76 = _Map_get(ctx.env.types.effects, recv_name);
  ...
  if (Option_is_none(method_type)) {
    __ring_match80: {
      const __ring_m80 = recv_var_id;
      if (__ring_m80._tag === "some") {
        const rvid = __ring_m80._0;
        for (const fb of ctx.current_fn_bounds) {
          if ((resolve_var_id(fb.type_param_var_id, s) === rvid)) {
            __ring_match81: {
              const __ring_m81 = _Map_get(ctx.env.trait_reg.traits, fb.trait_name);
              if (__ring_m81._tag === "some") {
                const trait_def = __ring_m81._0;
                ...
                __ring_match82: {
                  ...
                  if (__ring_m82._tag === "some") {
                    const found_method = __ring_m82._0;
    ...
    if (__ring_m83._tag === "some") {
      ...
      __ring_match84: {
        ...
        if (__ring_m84._tag === "FnType") {
          const mt_params = __ring_m84.params;
          if ((List_len(mt_params) > 0)) {
            __ring_match85: {
              const __ring_m85 = List_first(mt_params);
              if (__ring_m85._tag === "some") {
                const first_param = __ring_m85._0;
  ...
  __ring_match87: {
    const __ring_m87 = method_type;
    if (__ring_m87._tag === "some") {
      const mt = __ring_m87._0;
      __ring_match88: {
        const __ring_m88 = mt;
        if (__ring_m88._tag === "FnType") {
          const mt_params = __ring_m88.params; const mt_ret = __ring_m88.return_type; const mt_effects = __ring_m88.effects;
          let i = 0;
          for (const harg of hargs) {
            if (((i + 1) < List_len(mt_params))) {
              __ring_match89: {
                const __ring_m89 = List_get(mt_params, (i + 1));
                if (__ring_m89._tag === "some") {
                  const expected_param = __ring_m89._0;
  ...
  let resolved_dicts = [];
  __ring_match92: {
    const __ring_m92 = method_scheme;
    if (__ring_m92._tag === "some") {
      const ms = __ring_m92._0;
...
function lookup_impl_method(ctx, type_name, method) {
  __ring_match94: {
    const __ring_m94 = _Map_get(ctx.env.trait_reg.impl_methods, type_name);
    if (__ring_m94._tag === "some") {
      const impl_methods = __ring_m94._0;
      __ring_match95: {
        const __ring_m95 = _Map_get(impl_methods, method);
...
function lookup_trait_method(ctx, type_name, method, span) {
  ...
  for (const impl_entry of ctx.env.trait_reg.trait_impls) {
    if ((impl_entry.target_type_name === type_name)) {
      __ring_match96: {
        const __ring_m96 = _Map_get(ctx.env.trait_reg.traits, impl_entry.trait_name);
        if (__ring_m96._tag === "some") {
          ...
          __ring_match97: {
            ...
            if (__ring_m97._tag === "some") {
              ...
              __ring_match98: {
                const __ring_m98 = found_trait_name;
                if (__ring_m98._tag === "some") {
                  const prev_trait = __ring_m98._0;
...
function infer_effect_op(ctx, effect_name, op_name, args, span, subst, __ring_ev_fail) {
  ...
  __ring_match99: {
    const __ring_m99 = effect_def_opt;
  ...
  for (const arg of args) {
    ...
    List_push(hargs, ar.hexpr);
    __ring_match101: {
      const __ring_m101 = List_get(op.params, i);
      if (__ring_m101._tag === "some") {
        const param_type = __ring_m101._0;
  ...
  __ring_match102: {
    const __ring_m102 = effect_def.built_in_kind;
    if (__ring_m102._tag === "some") {
      const bik = __ring_m102._0;
      __ring_match103: {
        const __ring_m103 = bik;
        if (__ring_m103._tag === "BkIo") {
          eff = types$Effect_IoEffect;
          break __ring_match103;
        }
        if (__ring_m103._tag === "BkFail") {
...
function infer_field_access(ctx, receiver, field, span, subst, __ring_ev_fail) {
  ...
  __ring_match104: {
    ...
    if (__ring_m104._tag === "StructType") {
      const name = __ring_m104.name; const type_params = __ring_m104.type_params;
      __ring_match105: {
        const __ring_m105 = _Map_get(ctx.env.types.structs, name);
          ...
          __ring_match106: {
            ...
            if (__ring_m106._tag === "some") {
              ...
              while (((fi < List_len(struct_def.type_param_vars)) && (fi < List_len(type_params)))) {
                __ring_match107: {
                  const __ring_m107 = [List_get(struct_def.type_param_vars, fi), List_get(type_params, fi)];
                  if (Array.isArray(__ring_m107) && __ring_m107.length === 2 && __ring_m107[0]._tag === "some" && __ring_m107[1]._tag === "some") {
                    const var_id = __ring_m107[0]._0; const tp = __ring_m107[1]._0;
    ...
    if (__ring_m104._tag === "RecordType") {
      const rec_fields = __ring_m104.fields; const tail = __ring_m104.tail;
    ...
    if (__ring_m104._tag === "TupleType") {
      ...
      __ring_match110: {
        const __ring_m110 = parse_int(field);
        ...
        if (__ring_m110._tag === "some") {
          ...
          __ring_match111: {
            const __ring_m111 = List_get(elements, i);
...
function infer_struct_lit(ctx, name, fields, spread, span, subst, qualifier, __ring_ev_fail) {
  let resolved_qualifier = qualifier;
  __ring_match112: {
    const __ring_m112 = qualifier;
    if (__ring_m112._tag === "some") {
      const q = __ring_m112._0;
      if (((q === "self") || Str_starts_with(q, "super"))) {
        __ring_match113: {
          const __ring_m113 = infer_ctx$resolve_relative_qualifier(q, ctx.mod_path_stack);
          if (__ring_m113._tag === "some") {
            const prefix = __ring_m113._0;
            if ((prefix === "")) {
              resolved_qualifier = Option_none;
            } else {
              resolved_qualifier = Option_some(prefix);
  ...
  __ring_match114: {
    const __ring_m114 = resolved_qualifier;
    if (__ring_m114._tag === "some") {
      const q = __ring_m114._0;
      const qualified_name = `${q}::${name}`;
      const mod_struct = _Map_get(ctx.env.types.structs, qualified_name);
      __ring_match115: {
        const __ring_m115 = mod_struct;
  ...
  __ring_match116: {
    const __ring_m116 = resolved_qualifier;
    if (__ring_m116._tag === "some") {
      const q = __ring_m116._0;
      __ring_match117: {
        const __ring_m117 = _Map_get(ctx.env.types.enums, q);
  ...
  if ((Option_is_none(variant_enum) && Option_is_some(resolved_qualifier))) {
    __ring_match118: {
      const __ring_m118 = resolved_qualifier;
  ...
  __ring_match119: {
    const __ring_m119 = variant_enum;
    if (__ring_m119._tag === "some") {
      const ve = __ring_m119._0;
      __ring_match120: {
        const __ring_m120 = _Map_get(ctx.env.types.enums, ve);
        if (__ring_m120._tag === "some") {
          const enum_def = __ring_m120._0;
          ...
          __ring_match121: {
            const __ring_m121 = variant;
            if (__ring_m121._tag === "some") {
              const v = __ring_m121._0;
              __ring_match122: {
                const __ring_m122 = v.field_names;
  ...
  __ring_match123: {
    const __ring_m123 = struct_def_opt;
  ...
  while ((tpi < List_len(struct_def.type_param_vars))) {
    __ring_match124: {
      const __ring_m124 = List_get(struct_def.type_param_vars, tpi);
      if (__ring_m124._tag === "some") {
        const var_id = __ring_m124._0;
  ...
  __ring_match125: {
    const __ring_m125 = spread;
    if (__ring_m125._tag === "some") {
      const sp = __ring_m125._0;
  ...
  for (const field of fields) {
    ...
    __ring_match126: {
      const __ring_m126 = def_field;
      if (__ring_m126._tag === "some") {
        const df = __ring_m126._0;
...
function infer_named_variant_construct(ctx, enum_name, variant_name, variant, enum_def, fields, spread, span, subst, __ring_ev_fail) {
  ...
  while ((tpi < List_len(enum_def.type_param_vars))) {
    __ring_match127: {
      const __ring_m127 = List_get(enum_def.type_param_vars, tpi);
      if (__ring_m127._tag === "some") {
        const var_id = __ring_m127._0;
        const tv = env$TypeEnv_fresh_var(ctx.env);
        _Map_insert(inst_map, var_id, tv);
        List_push(type_param_types, tv);
  ...
  for (const field of fields) {
    ...
    __ring_match129: {
      const __ring_m129 = field_idx;
      if (__ring_m129._tag === "some") {
        const idx = __ring_m129._0;
        __ring_match130: {
          const __ring_m130 = List_get(variant.fields, idx);
          if (__ring_m130._tag === "some") {
            const ftype = __ring_m130._0;
...
function infer_match(ctx, scrutinee, arms, span, subst, __ring_ev_fail) {
  ...
  __ring_match131: {
    ...
    if (__ring_m131._tag === "Binding") {
      const pat_name = __ring_m131.name; const pspan = __ring_m131.span;
      __ring_match132: {
        const __ring_m132 = _Map_get(ctx.env.types.variant_to_enum, pat_name);
        if (__ring_m132._tag === "some") {
          const ve = __ring_m132._0;
          __ring_match133: {
            const __ring_m133 = _Map_get(ctx.env.types.enums, ve);
            if (__ring_m133._tag === "some") {
              const edef = __ring_m133._0;
  ...
  __ring_match137: {
    const __ring_m137 = missing;
    if (__ring_m137._tag === "some") {
      const m = __ring_m137._0;
...
function infer_if(ctx, condition, then_branch, else_branch, span, subst, __ring_ev_fail) {
  ...
  let result_type = types$UNIT;
  __ring_match138: {
    const __ring_m138 = else_branch;
    if (__ring_m138._tag === "some") {
      const eb = __ring_m138._0;
      __ring_match139: {
        const __ring_m139 = eb;
        if (__ring_m139._tag === "Block") {
        ...
        if (__ring_m139._tag === "IfExpr") {
          const ec = __ring_m139.condition; const etb = __ring_m139.then_branch; const eeb = __ring_m139.else_branch; const espan = __ring_m139.span;
...
function infer_string_interp(ctx, parts, span, subst, __ring_ev_fail) {
  ...
  for (const part of parts) {
    __ring_match140: {
      ...
      if (__ring_m140._tag === "LitPart") {
        const str_val = __ring_m140._0;
        List_push(hparts, hir$HStringInterpPart_Literal(str_val));
        break __ring_match140;
      }
      if (__ring_m140._tag === "ExprPart") {
        const expr = __ring_m140._0;
...
function infer_catch(ctx, expr, arms, span, subst, __ring_ev_fail) {
  ...
  for (const eff of effects.effects) {
    __ring_match141: {
      const __ring_m141 = eff;
      if (__ring_m141._tag === "FailEffect") {
        const et = __ring_m141.error_type;
        if (found_fail) {
...
function infer_handle(ctx, body, handlers, span, subst, __ring_ev_fail) {
  ...
  for (const handler of handlers) {
    ...
    __ring_match147: {
      const __ring_m147 = effect_def;
      if (__ring_m147._tag === "some") {
        const ed = __ring_m147._0;
  ...
  __match_fail(__ring_m);
    ...
    __ring_match148: {
      const __ring_m148 = handler.resume_name;
      if (__ring_m148._tag === "some") {
        const rn = __ring_m148._0;
  ...
  __match_fail(__ring_m);
    ...
    env$TypeEnv_pop_scope(ctx.env);
    __ring_match149: {
      const __ring_m149 = handler_body_result;
      if (__ring_m149._tag === "some") {
        const hbr = __ring_m149._0;
        s = hbr.subst;
...
function infer_lambda(ctx, params, body, span, subst, expected_param_types, __ring_ev_fail) {
  ...
  __match_fail(__ring_m);
    ...
    __ring_match150: {
      const __ring_m150 = expected_param_types;
      if (__ring_m150._tag === "some") {
        const epts = __ring_m150._0;
        if (Option_is_none(p.type_annotation)) {
          __ring_match151: {
            const __ring_m151 = List_get(epts, pi);
            if (__ring_m151._tag === "some") {
              const expected_t = __ring_m151._0;
    ...
    __ring_match152: {
      const __ring_m152 = lam_scheme;
      if (__ring_m152._tag === "some") {
        const ls = __ring_m152._0;
        __ring_match153: {
          const __ring_m153 = ls.def_id;
  ...
  env$TypeEnv_pop_scope(ctx.env);
  __ring_match154: {
    const __ring_m154 = body_result;
    if (__ring_m154._tag === "some") {
      const body_r = __ring_m154._0;
      s = body_r.subst;
      let applied_params = [];
