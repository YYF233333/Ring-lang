...
function uf_find(uf, id) {
  __ring_match0: {
    const __ring_m0 = _Map_get(uf.parent, id);
    if (__ring_m0._tag === "none") {
      return id;
      break __ring_match0;
    }
    if (__ring_m0._tag === "some") {
      const p = __ring_m0._0;
      if ((p === id)) {
        return id;
      }
...
function uf_union(uf, a, b) {
  ...
  if ((rank_a < rank_b)) {
    ...
    __ring_match1: {
      const __ring_m1 = _Map_get(uf.types, ra);
      if (__ring_m1._tag === "some") {
        const ty = __ring_m1._0;
        __ring_match2: {
          const __ring_m2 = _Map_get(uf.types, rb);
    ...
    __ring_match3: {
      ...
      if (__ring_m3._tag === "some") {
        const ty = __ring_m3._0;
        __ring_match4: {
          const __ring_m4 = _Map_get(uf.types, ra);
