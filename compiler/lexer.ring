...
pub enum TokenKind {
    // Keywords
    TkFn, TkLet, TkVar, TkStruct, TkEnum, TkMatch,
    TkImpl, TkEffect, TkHandle, TkWith,
    TkIf, TkElse, TkOr, TkCatch, TkTest, TkReturn,
