...
### #187 verify_rc ReturnExpr 未检查 enclosing owned bindings 的 drop [medium] [mechanical] [open]
...
### #195 emit_struct_debug_fn 缺少 field_idx < 0 guard [low] [mechanical] [open]
...
### #196 emit_derived_debug_llvm 无条件创建 trait dict [low] [mechanical] [open]
...
### #203 get_builtin_typeid 死代码 [low] [mechanical] [open]
