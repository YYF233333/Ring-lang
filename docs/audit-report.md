...
已修复项以删除线标记。53 项中 15 项已修复（#1-5, #9, #11, #13, #15, #17-18, #25, C1-C3 已在 2026-05-22 修复）。
...
| 51 | 4 个错误码缺负向测试覆盖 | 回归保护不完整 | E0101（Unexpected token）/E0207（Duplicate definition）/E0403（Unhandled effect）/E0706（Use ordering）无对应测试文件 |
