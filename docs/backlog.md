...
> **queued**（2026-06-13）：B-080 已合并提交（验收通过：alloc-stats tid0/tid2 归零、290s vs 492s = 41% 加速、ASan ×3 clean），主仓阻塞已解除。**✅ 已同步（2026-06-13 Discussion）**：design.md §7.11 premise 修正已落账（codegen-drop 已记为首选/原则修法）；本 spec Part 1 已 A 化（见下）。
