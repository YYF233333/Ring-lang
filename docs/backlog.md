...
### B-074 ESM extern type/fn 跨模块导入缺陷 [bugfix] [P3] [M] [judgment] [doing]
...
### B-091 boxed mut-cell 闭包捕获 UAF（LLVM）[bugfix] [P1] [L] [judgment] [doing]
...
### B-078 清理 B-066 parser workaround（string literal → import）[refactor] [P3] [S] [mechanical] [doing]
