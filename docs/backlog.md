...
**D7 — And/Or lower 成 if-else（And/Or-cond 双臂 box 收口；2026-06-12 Discussion 拍板 = 路线 (b) lower，否决 (a) cond 位 post-unbox drop——只消臂 box 不消臂内临时，半套）[L-XL]**：
