...
**D9 — 门① 收尾（interp/join SB 收口 + Type::UnitType 单例化）[next，2026-06-13 Discussion 拍板；设计真值 = design.md §7.11「门① 收尾」]**：
